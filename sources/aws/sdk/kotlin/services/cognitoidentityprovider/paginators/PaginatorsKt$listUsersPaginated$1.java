...
public final class PaginatorsKt$listUsersPaginated$1 extends SuspendLambda implements Function2<FlowCollector<? super ListActivity>, Continuation<? super Unit>, Object> {
    final /* synthetic */ IntentService $initialRequest;
    final /* synthetic */ BinaryOperator $this_listUsersPaginated;
    int I$0;
    ...
    public PaginatorsKt$listUsersPaginated$1(IntentService intentService, BinaryOperator binaryOperator, Continuation<? super PaginatorsKt$listUsersPaginated$1> continuation) {
        super(2, continuation);
        this.$initialRequest = intentService;
        this.$this_listUsersPaginated = binaryOperator;
    }
    ...
    public final Object invoke(@NotNull FlowCollector<? super ListActivity> flowCollector, Continuation<? super Unit> continuation) {
    ...
    */
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            listActivity = (ListActivity) obj;
            ?? EZpvd = listActivity.EZpvd();
            ...
            this.I$0 = i;
            this.label = 2;
            if (flowCollector.emit(listActivity, this) == objCopydefault) {
        ...
        if (i == 0) {
            IntentService.ActionBar actionBar = new IntentService.ActionBar(this.$initialRequest);
            actionBar.KWHzl((String) objectRef.element);
            IntentService intentServiceEZpvd = actionBar.EZpvd();
            BinaryOperator binaryOperator = this.$this_listUsersPaginated;
            this.L$0 = flowCollector;
            this.L$1 = objectRef;
            this.label = 1;
            obj = binaryOperator.KWHzl(intentServiceEZpvd, this);
            if (obj == objCopydefault) {
                return objCopydefault;
            }
            listActivity = (ListActivity) obj;
            ?? EZpvd2 = listActivity.EZpvd();
