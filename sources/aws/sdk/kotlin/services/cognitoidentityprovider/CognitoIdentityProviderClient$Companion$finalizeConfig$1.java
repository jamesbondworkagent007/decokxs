...
public final class CognitoIdentityProviderClient$Companion$finalizeConfig$1 extends ContinuationImpl {
    ...
    final /* synthetic */ BinaryOperator.Application this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CognitoIdentityProviderClient$Companion$finalizeConfig$1(BinaryOperator.Application application, Continuation<? super CognitoIdentityProviderClient$Companion$finalizeConfig$1> continuation) {
        super(continuation);
