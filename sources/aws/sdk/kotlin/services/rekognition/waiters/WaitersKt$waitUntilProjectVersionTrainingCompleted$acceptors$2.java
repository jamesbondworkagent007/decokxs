...
public final class WaitersKt$waitUntilProjectVersionTrainingCompleted$acceptors$2 extends Lambda implements Function1<ListAdapter, Boolean> {
    public static final WaitersKt$waitUntilProjectVersionTrainingCompleted$acceptors$2 INSTANCE = new WaitersKt$waitUntilProjectVersionTrainingCompleted$acceptors$2();

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public WaitersKt$waitUntilProjectVersionTrainingCompleted$acceptors$2() {
        super(1);
    }
    ...
    public final Boolean invoke(@NotNull ListAdapter listAdapter) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                if (Intrinsics.EZpvd(it.next(), (Object) "TRAINING_FAILED")) {
                    z = true;
                    break;
                }
            }
