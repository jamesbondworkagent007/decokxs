...
public final class IdempotentParameterMismatchException extends RekognitionException {
    public static final TaskDescription Companion = new TaskDescription(null);
    private final String code;
    private final String logref;
    private final String message;

    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 aws.sdk.kotlin.services.rekognition.model.IdempotentParameterMismatchException$StateListAnimator) A[MD:(aws.sdk.kotlin.services.rekognition.model.IdempotentParameterMismatchException$StateListAnimator):void (m)] call: aws.sdk.kotlin.services.rekognition.model.IdempotentParameterMismatchException.<init>(aws.sdk.kotlin.services.rekognition.model.IdempotentParameterMismatchException$StateListAnimator):void type: THIS */
    ...
    private IdempotentParameterMismatchException(StateListAnimator stateListAnimator) {
        ...
        this.logref = stateListAnimator.OLrzqt();
        this.message = stateListAnimator.KWHzl();
        getSdkErrorMetadata().OLrzqt().OLrzqt(C52562wQ.EZpvd.copydefault(), ServiceException.ErrorType.Client);
    }

    public static final class TaskDescription {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: aws.sdk.kotlin.services.rekognition.model.IdempotentParameterMismatchException.TaskDescription.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd((Object) this.code, (Object) idempotentParameterMismatchException.code) && Intrinsics.EZpvd((Object) this.logref, (Object) idempotentParameterMismatchException.logref) && Intrinsics.EZpvd((Object) getMessage(), (Object) idempotentParameterMismatchException.getMessage());
    }
    ...
    public static /* synthetic */ IdempotentParameterMismatchException copy$default(IdempotentParameterMismatchException idempotentParameterMismatchException, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            function1 = new Function1<StateListAnimator, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.model.IdempotentParameterMismatchException.copy.1
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final class StateListAnimator {
        ...
        public StateListAnimator(@NotNull IdempotentParameterMismatchException idempotentParameterMismatchException) {
            ...
            this.OLrzqt = idempotentParameterMismatchException.getCode();
            this.AEQbTJ = idempotentParameterMismatchException.getLogref();
            this.copydefault = idempotentParameterMismatchException.getMessage();
        }

        public final IdempotentParameterMismatchException copydefault() {
