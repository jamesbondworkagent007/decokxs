...
public final class InvalidIdentityPoolConfigurationExceptionDeserializer$deserialize$1 extends ContinuationImpl {
    ...
    public InvalidIdentityPoolConfigurationExceptionDeserializer$deserialize$1(Path path, Continuation<? super InvalidIdentityPoolConfigurationExceptionDeserializer$deserialize$1> continuation) {
        super(continuation);
        this.this$0 = path;
    }
