...
public final class ZoneRules implements Serializable {
    ...
    public ZoneOffsetTransition previousTransition(Instant instant) {
        ...
        if (iFindYear2 > 1800) {
            ...
            for (long jMin = Math.min(epochSecond2 - 31104000, (Clock.systemUTC().millis() / 1000) + 31968000); 86400 * epochDay <= jMin; jMin -= 7776000) {
    ...
    private Object getOffsetInfo(LocalDateTime localDateTime) {
        ...
        if (this.timeZone != null) {
            ...
            if (zoneOffsetTransitionArrFindTransitionArray.length == 0) {
                return offsetFromMillis(this.timeZone.getOffset(localDateTime.copydefault(this.standardOffsets[0]) * 1000));
            }
    ...
    private ZoneOffsetTransition[] findTransitionArray(int i) {
        ...
        long jCopydefault = LocalDateTime.of(i - 1, 12, 31, 0, 0).copydefault(this.standardOffsets[0]);
        long j3 = 1000;
        int offset = this.timeZone.getOffset(jCopydefault * 1000);
        long j4 = 31968000 + jCopydefault;
        ZoneOffsetTransition[] zoneOffsetTransitionArr3 = NO_TRANSITIONS;
        while (jCopydefault < j4) {
            long j5 = 7776000 + jCopydefault;
            long j6 = jCopydefault;
            if (offset != this.timeZone.getOffset(j5 * j3)) {
                jCopydefault = j6;
                while (j5 - jCopydefault > 1) {
                    long j7 = j4;
                    long jFloorDiv = Math.floorDiv(j5 + jCopydefault, 2L);
                    long j8 = j5;
                    if (this.timeZone.getOffset(jFloorDiv * 1000) == offset) {
                        jCopydefault = jFloorDiv;
                        j5 = j8;
                    } else {
                        j5 = jFloorDiv;
                    }
                ...
                long j9 = j5;
                j2 = j3;
                if (this.timeZone.getOffset(jCopydefault * j2) == offset) {
                    jCopydefault = j9;
                }
                ZoneOffset zoneOffsetOffsetFromMillis = offsetFromMillis(offset);
                int offset2 = this.timeZone.getOffset(jCopydefault * j2);
                ZoneOffset zoneOffsetOffsetFromMillis2 = offsetFromMillis(offset2);
                if (findYear(jCopydefault, zoneOffsetOffsetFromMillis2) == i) {
                    ...
                    zoneOffsetTransitionArr4[zoneOffsetTransitionArr4.length - 1] = new ZoneOffsetTransition(jCopydefault, zoneOffsetOffsetFromMillis, zoneOffsetOffsetFromMillis2);
                    offset = offset2;
