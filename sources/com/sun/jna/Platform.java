    ...
    static {
        ...
        if (property.startsWith("Linux")) {
            ...
            if (property.startsWith("Solaris") || property.startsWith("SunOS")) {
                ...
                i = property.equalsIgnoreCase("dragonflybsd") ? 12 : -1;
            }
            osType = i;
        }
        try {
        ...
        MATH_LIBRARY_NAME = i2 != 2 ? i2 == 6 ? "coredll" : DateFormat.MINUTE : "msvcrt";
        String canonicalArchitecture = getCanonicalArchitecture(System.getProperty("os.arch"), i2);
        ARCH = canonicalArchitecture;
        HAS_DLL_CALLBACKS = i2 == 2 && !canonicalArchitecture.startsWith("aarch");
