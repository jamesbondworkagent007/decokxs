...
public class Pointer {
    ...
    public int hashCode() {
        long j = this.peer;
        return (int) ((j >>> 32) + (j & BodyPartID.bodyIdMax));
    }
    ...
    public static final Pointer createConstant(int i) {
        return new Opaque(((long) i) & BodyPartID.bodyIdMax);
    }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:56:0x008d */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0095, code lost:
    
        if (r5.peer == r1.peer) goto L84;
     */
    ...
    /* JADX WARN: Type inference failed for: r5v28, types: [com.sun.jna.Structure] */
    /* JADX WARN: Type inference failed for: r8v15, types: [java.lang.Object] */
    /* JADX WARN: Type inference failed for: r8v9, types: [com.sun.jna.NativeMapped, java.lang.Object] */
    /*
    ...
    */
        ...
        if (!Structure.class.isAssignableFrom(cls)) {
            ...
            if (cls == WString.class) {
                ...
                if (pointer4 != null) {
                    ...
                    if (directBufferPointer == null || !directBufferPointer.equals(pointer4)) {
                ...
                ?? r8 = (NativeMapped) obj;
                if (r8 != 0) {
                    FromNative = r8.fromNative(getValue(j, r8.nativeType(), null), new FromNativeContext(cls));
    ...
    public String dump(long j, int i) {
        StringWriter stringWriter = new StringWriter((i * 2) + 13 + ((i / 4) * 4));
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            printWriter.print(Integer.toHexString(b & UnsignedBytes.MAX_VALUE));
            if (i3 == 3 && i2 < i - 1) {
                printWriter.println("]");
            }
        }
