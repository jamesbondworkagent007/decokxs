...
public final class d3 implements v2 {
    ...
    public List<String> a() {
        return TextUtils.isEmpty(this.f157a.getMessage()) ? r.a() : yDY.gEmmrt("metrics_category", "metrics_name", "err_underlying_code");
    }
    ...
    public void a(@NotNull JSONObject jSONObject) throws JSONException {
        ...
        this.f157a.printStackTrace(new PrintWriter(stringWriter));
        String message = this.f157a.getMessage();
        if (message == null) {
            message = "unknown";
        }
