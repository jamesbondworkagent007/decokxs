...
public final class GetJsonRpcRecordsByTopic {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final GetJsonRpcRecordsByTopic copy(long j, @NotNull String str, @NotNull String str2, @NotNull String str3, String str4, TransportType transportType) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        Intrinsics.checkNotNullParameter(str3, "");
        return new GetJsonRpcRecordsByTopic(j, str, str2, str3, str4, transportType);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.request_id == getJsonRpcRecordsByTopic.request_id && Intrinsics.EZpvd((Object) this.topic, (Object) getJsonRpcRecordsByTopic.topic) && Intrinsics.EZpvd((Object) this.method, (Object) getJsonRpcRecordsByTopic.method) && Intrinsics.EZpvd((Object) this.body, (Object) getJsonRpcRecordsByTopic.body) && Intrinsics.EZpvd((Object) this.response, (Object) getJsonRpcRecordsByTopic.response) && this.transport_type == getJsonRpcRecordsByTopic.transport_type;
    }
    ...
    public String toString() {
        return "GetJsonRpcRecordsByTopic(request_id=" + this.request_id + ", topic=" + this.topic + ", method=" + this.method + ", body=" + this.body + ", response=" + this.response + ", transport_type=" + this.transport_type + ")";
    }

    public GetJsonRpcRecordsByTopic(long j, @NotNull String str, @NotNull String str2, @NotNull String str3, String str4, TransportType transportType) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        Intrinsics.checkNotNullParameter(str3, "");
        this.request_id = j;
