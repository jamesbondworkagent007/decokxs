...
public final class KeyServerHttpResponse_RegisterIdentityJsonAdapter extends JsonAdapter<KeyServerHttpResponse.RegisterIdentity> {
    ...
    public String toString() {
        ...
        sb.append("KeyServerHttpResponse.RegisterIdentity");
        sb.append(')');
    ...
    public KeyServerHttpResponse.RegisterIdentity fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson != null) {
            return new KeyServerHttpResponse.RegisterIdentity(strFromJson, errorFromJson, strFromJson2);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, KeyServerHttpResponse.RegisterIdentity registerIdentity) throws IOException {
