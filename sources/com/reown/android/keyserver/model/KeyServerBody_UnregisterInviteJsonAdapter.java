...
public final class KeyServerBody_UnregisterInviteJsonAdapter extends JsonAdapter<KeyServerBody.UnregisterInvite> {
    ...
    public String toString() {
        ...
        sb.append("KeyServerBody.UnregisterInvite");
        sb.append(')');
    ...
    public KeyServerBody.UnregisterInvite fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson != null) {
            return new KeyServerBody.UnregisterInvite(strFromJson);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, KeyServerBody.UnregisterInvite unregisterInvite) throws IOException {
