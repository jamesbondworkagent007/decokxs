...
public final class KeyServerBody_RegisterInviteJsonAdapter extends JsonAdapter<KeyServerBody.RegisterInvite> {
    ...
    public String toString() {
        ...
        sb.append("KeyServerBody.RegisterInvite");
        sb.append(')');
    ...
    public KeyServerBody.RegisterInvite fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson != null) {
            return new KeyServerBody.RegisterInvite(strFromJson);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, KeyServerBody.RegisterInvite registerInvite) throws IOException {
