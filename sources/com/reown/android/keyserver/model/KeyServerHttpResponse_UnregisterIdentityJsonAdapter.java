...
public final class KeyServerHttpResponse_UnregisterIdentityJsonAdapter extends JsonAdapter<KeyServerHttpResponse.UnregisterIdentity> {
    ...
    public String toString() {
        ...
        sb.append("KeyServerHttpResponse.UnregisterIdentity");
        sb.append(')');
    ...
    public KeyServerHttpResponse.UnregisterIdentity fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson != null) {
            return new KeyServerHttpResponse.UnregisterIdentity(strFromJson, errorFromJson, strFromJson2);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, KeyServerHttpResponse.UnregisterIdentity unregisterIdentity) throws IOException {
