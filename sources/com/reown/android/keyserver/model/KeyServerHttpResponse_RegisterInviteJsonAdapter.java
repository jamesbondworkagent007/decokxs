...
public final class KeyServerHttpResponse_RegisterInviteJsonAdapter extends JsonAdapter<KeyServerHttpResponse.RegisterInvite> {
    ...
    public String toString() {
        ...
        sb.append("KeyServerHttpResponse.RegisterInvite");
        sb.append(')');
    ...
    public KeyServerHttpResponse.RegisterInvite fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson != null) {
            return new KeyServerHttpResponse.RegisterInvite(strFromJson, errorFromJson, strFromJson2);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, KeyServerHttpResponse.RegisterInvite registerInvite) throws IOException {
