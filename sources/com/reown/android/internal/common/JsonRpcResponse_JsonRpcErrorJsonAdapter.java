...
public final class JsonRpcResponse_JsonRpcErrorJsonAdapter extends JsonAdapter<JsonRpcResponse.JsonRpcError> {
    ...
    public JsonRpcResponse_JsonRpcErrorJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<JsonRpcResponse.Error> jsonAdapterAdapter3 = moshi.adapter(JsonRpcResponse.Error.class, yEE.copydefault(), Constants.IPC_BUNDLE_KEY_SEND_ERROR);
    ...
    public JsonRpcResponse.JsonRpcError fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = null;
        String strFromJson = null;
        JsonRpcResponse.Error errorFromJson = null;
        int i = -1;
        ...
        if (i == -3) {
            if (lFromJson != null) {
                ...
                if (errorFromJson != null) {
                    return new JsonRpcResponse.JsonRpcError(jLongValue, strFromJson, errorFromJson);
                }
        ...
        Constructor<JsonRpcResponse.JsonRpcError> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = JsonRpcResponse.JsonRpcError.class.getDeclaredConstructor(Long.TYPE, String.class, JsonRpcResponse.Error.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        if (errorFromJson != null) {
            JsonRpcResponse.JsonRpcError jsonRpcErrorNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, errorFromJson, Integer.valueOf(i), null);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, JsonRpcResponse.JsonRpcError jsonRpcError) throws IOException {
