...
public final class AccountHasNoIdentityStored extends WalletConnectException {
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 java.lang.String) A[MD:(java.lang.String):void (m)] call: com.reown.android.internal.common.exception.AccountHasNoIdentityStored.<init>(java.lang.String):void type: THIS */
    ...
    public AccountHasNoIdentityStored(String str) {
        super("AccountId: " + AccountId.m7216toStringimpl(str) + " has no identity stored");
