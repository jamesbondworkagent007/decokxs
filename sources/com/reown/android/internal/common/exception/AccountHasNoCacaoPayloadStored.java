...
public final class AccountHasNoCacaoPayloadStored extends WalletConnectException {
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 java.lang.String) A[MD:(java.lang.String):void (m)] call: com.reown.android.internal.common.exception.AccountHasNoCacaoPayloadStored.<init>(java.lang.String):void type: THIS */
    ...
    public AccountHasNoCacaoPayloadStored(String str) {
        super("AccountId: " + AccountId.m7216toStringimpl(str) + " has no message stored");
