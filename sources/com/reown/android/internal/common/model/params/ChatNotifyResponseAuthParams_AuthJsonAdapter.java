...
public final class ChatNotifyResponseAuthParams_AuthJsonAdapter extends JsonAdapter<ChatNotifyResponseAuthParams.Auth> {
    ...
    public String toString() {
        ...
        sb.append("ChatNotifyResponseAuthParams.Auth");
        sb.append(')');
    ...
    public ChatNotifyResponseAuthParams.Auth fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson != null) {
            return new ChatNotifyResponseAuthParams.Auth(strFromJson);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, ChatNotifyResponseAuthParams.Auth auth) throws IOException {
