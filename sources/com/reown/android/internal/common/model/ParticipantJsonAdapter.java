...
public final class ParticipantJsonAdapter extends JsonAdapter<Participant> {
    ...
    public Participant fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (appMetaDataFromJson != null) {
            return new Participant(strFromJson, appMetaDataFromJson);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, Participant participant) throws IOException {
