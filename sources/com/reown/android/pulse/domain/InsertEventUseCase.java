...
public final class InsertEventUseCase implements InsertEventUseCaseInterface {
    ...
    public InsertEventUseCase(@NotNull EventsRepository eventsRepository, @NotNull Logger logger) {
    ...
    /* JADX INFO: renamed from: com.reown.android.pulse.domain.InsertEventUseCase$invoke$2, reason: invalid class name */
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, @NotNull Continuation<?> continuation) {
            return InsertEventUseCase.this.new AnonymousClass2(this.$props, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            try {
                if (i == 0) {
                    ...
                    EventsRepository eventsRepository = InsertEventUseCase.this.eventsRepository;
                ...
                InsertEventUseCase.this.logger.error("Inserting event " + this.$props.getType() + " error: " + e);
            }
