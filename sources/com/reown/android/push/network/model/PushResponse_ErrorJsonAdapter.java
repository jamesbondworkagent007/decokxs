...
public final class PushResponse_ErrorJsonAdapter extends JsonAdapter<PushResponse.Error> {
    ...
    public PushResponse.Error fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson2 != null) {
            return new PushResponse.Error(strFromJson, strFromJson2);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, PushResponse.Error error) throws IOException {
