...
public final class PairingParams_DeleteParamsJsonAdapter extends JsonAdapter<PairingParams.DeleteParams> {
    ...
    public PairingParams.DeleteParams fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -2) {
            ...
            if (strFromJson != null) {
                return new PairingParams.DeleteParams(iIntValue, strFromJson);
            }
            JsonDataException jsonDataExceptionMissingProperty = Util.missingProperty("message", "message", jsonReader);
            Intrinsics.checkNotNullExpressionValue(jsonDataExceptionMissingProperty, "");
            throw jsonDataExceptionMissingProperty;
        }
        Constructor<PairingParams.DeleteParams> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            Class cls = Integer.TYPE;
            declaredConstructor = PairingParams.DeleteParams.class.getDeclaredConstructor(cls, String.class, cls, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (strFromJson != null) {
            PairingParams.DeleteParams deleteParamsNewInstance = declaredConstructor.newInstance(numFromJson, strFromJson, Integer.valueOf(i), null);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, PairingParams.DeleteParams deleteParams) throws IOException {
