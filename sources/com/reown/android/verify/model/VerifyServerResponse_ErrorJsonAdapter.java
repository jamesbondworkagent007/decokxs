...
public final class VerifyServerResponse_ErrorJsonAdapter extends JsonAdapter<VerifyServerResponse.Error> {
    ...
    public String toString() {
        ...
        sb.append("VerifyServerResponse.Error");
        sb.append(')');
    ...
    public VerifyServerResponse.Error fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (strFromJson2 != null) {
            return new VerifyServerResponse.Error(strFromJson, strFromJson2);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, VerifyServerResponse.Error error) throws IOException {
