...
public final class RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter extends JsonAdapter<RelayDTO.Subscribe.Result.JsonRpcError> {
    ...
    public RelayDTO.Subscribe.Result.JsonRpcError fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -2) {
            ...
            if (lFromJson != null) {
                return new RelayDTO.Subscribe.Result.JsonRpcError(strFromJson, errorFromJson, lFromJson.longValue());
            }
        ...
        Constructor<RelayDTO.Subscribe.Result.JsonRpcError> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Subscribe.Result.JsonRpcError.class.getDeclaredConstructor(String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[4] = null;
        RelayDTO.Subscribe.Result.JsonRpcError jsonRpcErrorNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Subscribe.Result.JsonRpcError jsonRpcError) throws IOException {
