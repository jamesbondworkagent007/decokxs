...
public final class RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter extends JsonAdapter<RelayDTO.Unsubscribe.Result.JsonRpcError> {
    ...
    public RelayDTO.Unsubscribe.Result.JsonRpcError fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -2) {
            ...
            if (lFromJson != null) {
                return new RelayDTO.Unsubscribe.Result.JsonRpcError(strFromJson, errorFromJson, lFromJson.longValue());
            }
        ...
        Constructor<RelayDTO.Unsubscribe.Result.JsonRpcError> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Unsubscribe.Result.JsonRpcError.class.getDeclaredConstructor(String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[4] = null;
        RelayDTO.Unsubscribe.Result.JsonRpcError jsonRpcErrorNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Unsubscribe.Result.JsonRpcError jsonRpcError) throws IOException {
