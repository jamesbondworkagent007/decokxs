...
public final class RelayDTO_Unsubscribe_RequestJsonAdapter extends JsonAdapter<RelayDTO.Unsubscribe.Request> {
    ...
    public RelayDTO_Unsubscribe_RequestJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<RelayDTO.Unsubscribe.Request.Params> jsonAdapterAdapter3 = moshi.adapter(RelayDTO.Unsubscribe.Request.Params.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
    ...
    public RelayDTO.Unsubscribe.Request fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        RelayDTO.Unsubscribe.Request.Params paramsFromJson = null;
        ...
        if (i == -8) {
            ...
            if (paramsFromJson != null) {
                return new RelayDTO.Unsubscribe.Request(jLongValue, strFromJson, strFromJson2, paramsFromJson);
            }
        ...
        Constructor<RelayDTO.Unsubscribe.Request> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Unsubscribe.Request.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, RelayDTO.Unsubscribe.Request.Params.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[5] = null;
        RelayDTO.Unsubscribe.Request requestNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Unsubscribe.Request request) throws IOException {
