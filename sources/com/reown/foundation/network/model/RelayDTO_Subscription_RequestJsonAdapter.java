...
public final class RelayDTO_Subscription_RequestJsonAdapter extends JsonAdapter<RelayDTO.Subscription.Request> {
    ...
    public RelayDTO_Subscription_RequestJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<RelayDTO.Subscription.Request.Params> jsonAdapterAdapter3 = moshi.adapter(RelayDTO.Subscription.Request.Params.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
    ...
    public RelayDTO.Subscription.Request fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        RelayDTO.Subscription.Request.Params paramsFromJson = null;
        ...
        if (i == -8) {
            ...
            if (paramsFromJson != null) {
                return new RelayDTO.Subscription.Request(jLongValue, strFromJson, strFromJson2, paramsFromJson);
            }
        ...
        Constructor<RelayDTO.Subscription.Request> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Subscription.Request.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, RelayDTO.Subscription.Request.Params.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[5] = null;
        RelayDTO.Subscription.Request requestNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Subscription.Request request) throws IOException {
