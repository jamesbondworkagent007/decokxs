...
public final class RelayDTO_Unsubscribe_Result_AcknowledgementJsonAdapter extends JsonAdapter<RelayDTO.Unsubscribe.Result.Acknowledgement> {
    ...
    public RelayDTO.Unsubscribe.Result.Acknowledgement fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -3) {
            if (lFromJson != null) {
                ...
                if (boolFromJson != null) {
                    return new RelayDTO.Unsubscribe.Result.Acknowledgement(jLongValue, strFromJson, boolFromJson.booleanValue());
                }
        ...
        Constructor<RelayDTO.Unsubscribe.Result.Acknowledgement> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Unsubscribe.Result.Acknowledgement.class.getDeclaredConstructor(Long.TYPE, String.class, Boolean.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        if (lFromJson != null) {
            ...
            objArr[4] = null;
            RelayDTO.Unsubscribe.Result.Acknowledgement acknowledgementNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Unsubscribe.Result.Acknowledgement acknowledgement) throws IOException {
