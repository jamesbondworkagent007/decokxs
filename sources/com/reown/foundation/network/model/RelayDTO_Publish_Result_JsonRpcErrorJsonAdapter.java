...
public final class RelayDTO_Publish_Result_JsonRpcErrorJsonAdapter extends JsonAdapter<RelayDTO.Publish.Result.JsonRpcError> {
    ...
    public RelayDTO.Publish.Result.JsonRpcError fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -2) {
            ...
            if (lFromJson != null) {
                return new RelayDTO.Publish.Result.JsonRpcError(strFromJson, errorFromJson, lFromJson.longValue());
            }
        ...
        Constructor<RelayDTO.Publish.Result.JsonRpcError> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Publish.Result.JsonRpcError.class.getDeclaredConstructor(String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[4] = null;
        RelayDTO.Publish.Result.JsonRpcError jsonRpcErrorNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Publish.Result.JsonRpcError jsonRpcError) throws IOException {
