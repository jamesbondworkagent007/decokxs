...
public final class RelayDTO_Subscription_Result_AcknowledgementJsonAdapter extends JsonAdapter<RelayDTO.Subscription.Result.Acknowledgement> {
    ...
    public RelayDTO.Subscription.Result.Acknowledgement fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -3) {
            if (lFromJson != null) {
                ...
                if (boolFromJson != null) {
                    return new RelayDTO.Subscription.Result.Acknowledgement(jLongValue, strFromJson, boolFromJson.booleanValue());
                }
        ...
        Constructor<RelayDTO.Subscription.Result.Acknowledgement> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Subscription.Result.Acknowledgement.class.getDeclaredConstructor(Long.TYPE, String.class, Boolean.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        if (lFromJson != null) {
            ...
            objArr[4] = null;
            RelayDTO.Subscription.Result.Acknowledgement acknowledgementNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Subscription.Result.Acknowledgement acknowledgement) throws IOException {
