...
public final class RelayDTO_Subscribe_RequestJsonAdapter extends JsonAdapter<RelayDTO.Subscribe.Request> {
    ...
    public RelayDTO_Subscribe_RequestJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<RelayDTO.Subscribe.Request.Params> jsonAdapterAdapter3 = moshi.adapter(RelayDTO.Subscribe.Request.Params.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
    ...
    public RelayDTO.Subscribe.Request fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        RelayDTO.Subscribe.Request.Params paramsFromJson = null;
        ...
        if (i == -8) {
            ...
            if (paramsFromJson != null) {
                return new RelayDTO.Subscribe.Request(jLongValue, strFromJson, strFromJson2, paramsFromJson);
            }
        ...
        Constructor<RelayDTO.Subscribe.Request> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Subscribe.Request.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, RelayDTO.Subscribe.Request.Params.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[5] = null;
        RelayDTO.Subscribe.Request requestNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Subscribe.Request request) throws IOException {
