...
public final class RelayDTO_BatchSubscribe_Result_JsonRpcErrorJsonAdapter extends JsonAdapter<RelayDTO.BatchSubscribe.Result.JsonRpcError> {
    ...
    public String toString() {
        ...
        sb.append("RelayDTO.BatchSubscribe.Result.JsonRpcError");
        sb.append(')');
    ...
    public RelayDTO.BatchSubscribe.Result.JsonRpcError fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -2) {
            ...
            if (lFromJson != null) {
                return new RelayDTO.BatchSubscribe.Result.JsonRpcError(strFromJson, errorFromJson, lFromJson.longValue());
            }
        ...
        Constructor<RelayDTO.BatchSubscribe.Result.JsonRpcError> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.BatchSubscribe.Result.JsonRpcError.class.getDeclaredConstructor(String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[4] = null;
        RelayDTO.BatchSubscribe.Result.JsonRpcError jsonRpcErrorNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.BatchSubscribe.Result.JsonRpcError jsonRpcError) throws IOException {
