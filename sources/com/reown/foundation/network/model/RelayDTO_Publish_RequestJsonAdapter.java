...
public final class RelayDTO_Publish_RequestJsonAdapter extends JsonAdapter<RelayDTO.Publish.Request> {
    ...
    public RelayDTO_Publish_RequestJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<RelayDTO.Publish.Request.Params> jsonAdapterAdapter3 = moshi.adapter(RelayDTO.Publish.Request.Params.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
    ...
    public RelayDTO.Publish.Request fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        RelayDTO.Publish.Request.Params paramsFromJson = null;
        ...
        if (i == -8) {
            ...
            if (paramsFromJson != null) {
                return new RelayDTO.Publish.Request(jLongValue, strFromJson, strFromJson2, paramsFromJson);
            }
        ...
        Constructor<RelayDTO.Publish.Request> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = RelayDTO.Publish.Request.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, RelayDTO.Publish.Request.Params.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        objArr[5] = null;
        RelayDTO.Publish.Request requestNewInstance = declaredConstructor.newInstance(objArr);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, RelayDTO.Publish.Request request) throws IOException {
