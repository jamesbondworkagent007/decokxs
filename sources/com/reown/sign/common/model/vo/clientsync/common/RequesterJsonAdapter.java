...
public final class RequesterJsonAdapter extends JsonAdapter<Requester> {
    ...
    public Requester fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (appMetaDataFromJson != null) {
            return new Requester(strFromJson, appMetaDataFromJson);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, Requester requester) throws IOException {
