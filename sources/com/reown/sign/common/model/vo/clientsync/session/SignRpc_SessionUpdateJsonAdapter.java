...
public final class SignRpc_SessionUpdateJsonAdapter extends JsonAdapter<SignRpc.SessionUpdate> {
    ...
    public SignRpc_SessionUpdateJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.UpdateNamespacesParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.UpdateNamespacesParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
        Intrinsics.checkNotNullExpressionValue(jsonAdapterAdapter3, "");
        this.updateNamespacesParamsAdapter = jsonAdapterAdapter3;
    }
    ...
    public SignRpc.SessionUpdate fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.UpdateNamespacesParams updateNamespacesParamsFromJson = null;
        int i = -1;
        while (jsonReader.hasNext()) {
            ...
            if (iSelectName == -1) {
                ...
                i &= -5;
            } else if (iSelectName == 3 && (updateNamespacesParamsFromJson = this.updateNamespacesParamsAdapter.fromJson(jsonReader)) == null) {
        ...
        if (i == -8) {
            ...
            if (updateNamespacesParamsFromJson != null) {
                return new SignRpc.SessionUpdate(jLongValue, strFromJson, strFromJson2, updateNamespacesParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionUpdate> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionUpdate.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.UpdateNamespacesParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (updateNamespacesParamsFromJson != null) {
            SignRpc.SessionUpdate sessionUpdateNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, updateNamespacesParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionUpdateNewInstance, "");
            return sessionUpdateNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionUpdate sessionUpdate) throws IOException {
