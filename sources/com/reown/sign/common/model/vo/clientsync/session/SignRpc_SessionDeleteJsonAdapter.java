...
public final class SignRpc_SessionDeleteJsonAdapter extends JsonAdapter<SignRpc.SessionDelete> {
    public volatile Constructor<SignRpc.SessionDelete> constructorRef;
    public final JsonAdapter<SignParams.DeleteParams> deleteParamsAdapter;
    ...
    public SignRpc_SessionDeleteJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.DeleteParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.DeleteParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
    ...
    public SignRpc.SessionDelete fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.DeleteParams deleteParamsFromJson = null;
        int i = -1;
        ...
        if (i == -8) {
            ...
            if (deleteParamsFromJson != null) {
                return new SignRpc.SessionDelete(jLongValue, strFromJson, strFromJson2, deleteParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionDelete> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionDelete.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.DeleteParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (deleteParamsFromJson != null) {
            SignRpc.SessionDelete sessionDeleteNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, deleteParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionDeleteNewInstance, "");
            return sessionDeleteNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionDelete sessionDelete) throws IOException {
