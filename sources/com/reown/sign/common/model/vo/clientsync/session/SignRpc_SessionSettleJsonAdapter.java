...
public final class SignRpc_SessionSettleJsonAdapter extends JsonAdapter<SignRpc.SessionSettle> {
    public volatile Constructor<SignRpc.SessionSettle> constructorRef;
    public final JsonAdapter<Long> longAdapter;
    public final JsonReader.Options options;
    public final JsonAdapter<SignParams.SessionSettleParams> sessionSettleParamsAdapter;
    ...
    public SignRpc_SessionSettleJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.SessionSettleParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.SessionSettleParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
        Intrinsics.checkNotNullExpressionValue(jsonAdapterAdapter3, "");
        this.sessionSettleParamsAdapter = jsonAdapterAdapter3;
    }
    ...
    public SignRpc.SessionSettle fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.SessionSettleParams sessionSettleParamsFromJson = null;
        int i = -1;
        while (jsonReader.hasNext()) {
            ...
            if (iSelectName == -1) {
                ...
                i &= -5;
            } else if (iSelectName == 3 && (sessionSettleParamsFromJson = this.sessionSettleParamsAdapter.fromJson(jsonReader)) == null) {
        ...
        if (i == -8) {
            ...
            if (sessionSettleParamsFromJson != null) {
                return new SignRpc.SessionSettle(jLongValue, strFromJson, strFromJson2, sessionSettleParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionSettle> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionSettle.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.SessionSettleParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (sessionSettleParamsFromJson != null) {
            SignRpc.SessionSettle sessionSettleNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, sessionSettleParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionSettleNewInstance, "");
            return sessionSettleNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionSettle sessionSettle) throws IOException {
