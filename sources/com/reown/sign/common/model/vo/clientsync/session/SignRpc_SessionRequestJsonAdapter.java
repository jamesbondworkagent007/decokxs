...
public final class SignRpc_SessionRequestJsonAdapter extends JsonAdapter<SignRpc.SessionRequest> {
    public volatile Constructor<SignRpc.SessionRequest> constructorRef;
    public final JsonAdapter<Long> longAdapter;
    public final JsonReader.Options options;
    public final JsonAdapter<SignParams.SessionRequestParams> sessionRequestParamsAdapter;
    ...
    public SignRpc_SessionRequestJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.SessionRequestParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.SessionRequestParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
        Intrinsics.checkNotNullExpressionValue(jsonAdapterAdapter3, "");
        this.sessionRequestParamsAdapter = jsonAdapterAdapter3;
    }
    ...
    public SignRpc.SessionRequest fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.SessionRequestParams sessionRequestParamsFromJson = null;
        int i = -1;
        while (jsonReader.hasNext()) {
            ...
            if (iSelectName == -1) {
                ...
                i &= -5;
            } else if (iSelectName == 3 && (sessionRequestParamsFromJson = this.sessionRequestParamsAdapter.fromJson(jsonReader)) == null) {
        ...
        if (i == -8) {
            ...
            if (sessionRequestParamsFromJson != null) {
                return new SignRpc.SessionRequest(jLongValue, strFromJson, strFromJson2, sessionRequestParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionRequest> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionRequest.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.SessionRequestParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (sessionRequestParamsFromJson != null) {
            SignRpc.SessionRequest sessionRequestNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, sessionRequestParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionRequestNewInstance, "");
            return sessionRequestNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionRequest sessionRequest) throws IOException {
