...
public final class SignRpc_SessionEventJsonAdapter extends JsonAdapter<SignRpc.SessionEvent> {
    public volatile Constructor<SignRpc.SessionEvent> constructorRef;
    public final JsonAdapter<SignParams.EventParams> eventParamsAdapter;
    ...
    public SignRpc_SessionEventJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.EventParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.EventParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
        Intrinsics.checkNotNullExpressionValue(jsonAdapterAdapter3, "");
        this.eventParamsAdapter = jsonAdapterAdapter3;
    }
    ...
    public SignRpc.SessionEvent fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.EventParams eventParamsFromJson = null;
        int i = -1;
        while (jsonReader.hasNext()) {
            ...
            if (iSelectName == -1) {
                ...
                i &= -5;
            } else if (iSelectName == 3 && (eventParamsFromJson = this.eventParamsAdapter.fromJson(jsonReader)) == null) {
        ...
        if (i == -8) {
            ...
            if (eventParamsFromJson != null) {
                return new SignRpc.SessionEvent(jLongValue, strFromJson, strFromJson2, eventParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionEvent> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionEvent.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.EventParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (eventParamsFromJson != null) {
            SignRpc.SessionEvent sessionEventNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, eventParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionEventNewInstance, "");
            return sessionEventNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionEvent sessionEvent) throws IOException {
