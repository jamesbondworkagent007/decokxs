...
public final class SignRpc_SessionExtendJsonAdapter extends JsonAdapter<SignRpc.SessionExtend> {
    public volatile Constructor<SignRpc.SessionExtend> constructorRef;
    public final JsonAdapter<SignParams.ExtendParams> extendParamsAdapter;
    ...
    public SignRpc_SessionExtendJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.ExtendParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.ExtendParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
        Intrinsics.checkNotNullExpressionValue(jsonAdapterAdapter3, "");
        this.extendParamsAdapter = jsonAdapterAdapter3;
    }
    ...
    public SignRpc.SessionExtend fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.ExtendParams extendParamsFromJson = null;
        int i = -1;
        while (jsonReader.hasNext()) {
            ...
            if (iSelectName == -1) {
                ...
                i &= -5;
            } else if (iSelectName == 3 && (extendParamsFromJson = this.extendParamsAdapter.fromJson(jsonReader)) == null) {
        ...
        if (i == -8) {
            ...
            if (extendParamsFromJson != null) {
                return new SignRpc.SessionExtend(jLongValue, strFromJson, strFromJson2, extendParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionExtend> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionExtend.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.ExtendParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (extendParamsFromJson != null) {
            SignRpc.SessionExtend sessionExtendNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, extendParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionExtendNewInstance, "");
            return sessionExtendNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionExtend sessionExtend) throws IOException {
