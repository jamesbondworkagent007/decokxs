...
public final class SignRpc_SessionAuthenticateJsonAdapter extends JsonAdapter<SignRpc.SessionAuthenticate> {
    public volatile Constructor<SignRpc.SessionAuthenticate> constructorRef;
    public final JsonAdapter<Long> longAdapter;
    public final JsonReader.Options options;
    public final JsonAdapter<SignParams.SessionAuthenticateParams> sessionAuthenticateParamsAdapter;
    ...
    public SignRpc_SessionAuthenticateJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.SessionAuthenticateParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.SessionAuthenticateParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
        Intrinsics.checkNotNullExpressionValue(jsonAdapterAdapter3, "");
        this.sessionAuthenticateParamsAdapter = jsonAdapterAdapter3;
    }

    public String toString() {
        StringBuilder sb = new StringBuilder(49);
        sb.append("GeneratedJsonAdapter(");
        sb.append("SignRpc.SessionAuthenticate");
        sb.append(')');
    ...
    public SignRpc.SessionAuthenticate fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.SessionAuthenticateParams sessionAuthenticateParamsFromJson = null;
        int i = -1;
        while (jsonReader.hasNext()) {
            ...
            if (iSelectName == -1) {
                ...
                i &= -5;
            } else if (iSelectName == 3 && (sessionAuthenticateParamsFromJson = this.sessionAuthenticateParamsAdapter.fromJson(jsonReader)) == null) {
        ...
        if (i == -8) {
            ...
            if (sessionAuthenticateParamsFromJson != null) {
                return new SignRpc.SessionAuthenticate(jLongValue, strFromJson, strFromJson2, sessionAuthenticateParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionAuthenticate> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionAuthenticate.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.SessionAuthenticateParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (sessionAuthenticateParamsFromJson != null) {
            SignRpc.SessionAuthenticate sessionAuthenticateNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, sessionAuthenticateParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionAuthenticateNewInstance, "");
            return sessionAuthenticateNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionAuthenticate sessionAuthenticate) throws IOException {
