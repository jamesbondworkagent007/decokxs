...
public final class SessionParticipantJsonAdapter extends JsonAdapter<SessionParticipant> {
    ...
    public SessionParticipant fromJson(@NotNull JsonReader jsonReader) throws IOException {
        ...
        if (appMetaDataFromJson != null) {
            return new SessionParticipant(strFromJson, appMetaDataFromJson);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SessionParticipant sessionParticipant) throws IOException {
