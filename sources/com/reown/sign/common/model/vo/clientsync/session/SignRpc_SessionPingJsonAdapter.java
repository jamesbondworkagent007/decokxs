...
public final class SignRpc_SessionPingJsonAdapter extends JsonAdapter<SignRpc.SessionPing> {
    public volatile Constructor<SignRpc.SessionPing> constructorRef;
    public final JsonAdapter<Long> longAdapter;
    public final JsonReader.Options options;
    public final JsonAdapter<SignParams.PingParams> pingParamsAdapter;
    ...
    public SignRpc_SessionPingJsonAdapter(@NotNull Moshi moshi) {
        ...
        JsonAdapter<SignParams.PingParams> jsonAdapterAdapter3 = moshi.adapter(SignParams.PingParams.class, yEE.copydefault(), MetricsSQLiteCacheKt.METRICS_PARAMS);
    ...
    public SignRpc.SessionPing fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(jsonReader, "");
        jsonReader.beginObject();
        Long lFromJson = 0L;
        String strFromJson = null;
        String strFromJson2 = null;
        SignParams.PingParams pingParamsFromJson = null;
        int i = -1;
        ...
        if (i == -8) {
            ...
            if (pingParamsFromJson != null) {
                return new SignRpc.SessionPing(jLongValue, strFromJson, strFromJson2, pingParamsFromJson);
            }
        ...
        Constructor<SignRpc.SessionPing> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = SignRpc.SessionPing.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, SignParams.PingParams.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
            this.constructorRef = declaredConstructor;
            Intrinsics.checkNotNullExpressionValue(declaredConstructor, "");
        }
        if (pingParamsFromJson != null) {
            SignRpc.SessionPing sessionPingNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, pingParamsFromJson, Integer.valueOf(i), null);
            Intrinsics.checkNotNullExpressionValue(sessionPingNewInstance, "");
            return sessionPingNewInstance;
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, SignRpc.SessionPing sessionPing) throws IOException {
