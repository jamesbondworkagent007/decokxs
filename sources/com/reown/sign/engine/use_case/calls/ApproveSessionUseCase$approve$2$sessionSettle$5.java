...
public final class ApproveSessionUseCase$approve$2$sessionSettle$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ApproveSessionUseCase$approve$2$sessionSettle$5(ApproveSessionUseCase approveSessionUseCase, List<String> list, Topic topic, Continuation<? super ApproveSessionUseCase$approve$2$sessionSettle$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, @NotNull Continuation<?> continuation) {
        return new ApproveSessionUseCase$approve$2$sessionSettle$5(this.this$0, this.$trace, this.$pairingTopic, continuation);
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ApproveSessionUseCase$approve$2$sessionSettle$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.reown.sign.engine.use_case.calls.ApproveSessionUseCase$approve$2$sessionSettle$5$1, reason: invalid class name */
