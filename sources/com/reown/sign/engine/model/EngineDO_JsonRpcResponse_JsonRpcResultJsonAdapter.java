...
public final class EngineDO_JsonRpcResponse_JsonRpcResultJsonAdapter extends JsonAdapter<EngineDO.JsonRpcResponse.JsonRpcResult> {
    public volatile Constructor<EngineDO.JsonRpcResponse.JsonRpcResult> constructorRef;
    ...
    public EngineDO.JsonRpcResponse.JsonRpcResult fromJson(@NotNull JsonReader jsonReader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, InvocationTargetException {
        ...
        if (i == -3) {
            if (lFromJson != null) {
                ...
                if (strFromJson2 != null) {
                    return new EngineDO.JsonRpcResponse.JsonRpcResult(jLongValue, strFromJson, strFromJson2);
                }
        ...
        Constructor<EngineDO.JsonRpcResponse.JsonRpcResult> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = EngineDO.JsonRpcResponse.JsonRpcResult.class.getDeclaredConstructor(Long.TYPE, String.class, String.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER);
        ...
        if (strFromJson2 != null) {
            EngineDO.JsonRpcResponse.JsonRpcResult jsonRpcResultNewInstance = declaredConstructor.newInstance(lFromJson, strFromJson, strFromJson2, Integer.valueOf(i), null);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(@NotNull JsonWriter jsonWriter, EngineDO.JsonRpcResponse.JsonRpcResult jsonRpcResult) throws IOException {
