...
public final class GetListOfSessionDaos {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final GetListOfSessionDaos copy(long j, @NotNull String str, long j2, @NotNull String str2, String str3, String str4, @NotNull String str5, String str6, boolean z, @NotNull String str7, Map<String, String> map, TransportType transportType) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.id == getListOfSessionDaos.id && Intrinsics.EZpvd((Object) this.topic, (Object) getListOfSessionDaos.topic) && this.expiry == getListOfSessionDaos.expiry && Intrinsics.EZpvd((Object) this.relay_protocol, (Object) getListOfSessionDaos.relay_protocol) && Intrinsics.EZpvd((Object) this.relay_data, (Object) getListOfSessionDaos.relay_data) && Intrinsics.EZpvd((Object) this.controller_key, (Object) getListOfSessionDaos.controller_key) && Intrinsics.EZpvd((Object) this.self_participant, (Object) getListOfSessionDaos.self_participant) && Intrinsics.EZpvd((Object) this.peer_participant, (Object) getListOfSessionDaos.peer_participant) && this.is_acknowledged == getListOfSessionDaos.is_acknowledged && Intrinsics.EZpvd((Object) this.pairingTopic, (Object) getListOfSessionDaos.pairingTopic) && Intrinsics.EZpvd(this.properties, getListOfSessionDaos.properties) && this.transport_type == getListOfSessionDaos.transport_type;
    }
    ...
    public String toString() {
        return "GetListOfSessionDaos(id=" + this.id + ", topic=" + this.topic + ", expiry=" + this.expiry + ", relay_protocol=" + this.relay_protocol + ", relay_data=" + this.relay_data + ", controller_key=" + this.controller_key + ", self_participant=" + this.self_participant + ", peer_participant=" + this.peer_participant + ", is_acknowledged=" + this.is_acknowledged + ", pairingTopic=" + this.pairingTopic + ", properties=" + this.properties + ", transport_type=" + this.transport_type + ")";
    }

    public GetListOfSessionDaos(long j, @NotNull String str, long j2, @NotNull String str2, String str3, String str4, @NotNull String str5, String str6, boolean z, @NotNull String str7, Map<String, String> map, TransportType transportType) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        Intrinsics.checkNotNullParameter(str5, "");
        Intrinsics.checkNotNullParameter(str7, "");
