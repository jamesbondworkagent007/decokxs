...
public class JavaTimeZone extends TimeZone {
    ...
    public static JavaTimeZone createTimeZone(String str) {
        ...
        java.util.TimeZone timeZoneOLrzqt = treeSet.contains(str) ? yCN.OLrzqt(str) : null;
        if (timeZoneOLrzqt == null) {
        ...
        return new JavaTimeZone(timeZoneOLrzqt, str);
    }
        ...
        synchronized (this.javacal) {
            if (z) {
                ...
                if (i13 != i8 || i7 != i9 || i6 != i10 || i4 != i11 || i2 != i12) {
                    int i14 = Math.abs(i8 - i13) > 1 ? 1 : i8 - iArr2[4];
                    Calendar calendar = this.javacal;
                    calendar.setTimeInMillis((calendar.getTimeInMillis() - ((long) ((((((((((((i14 * 24) + i9) - i7) * 60) + i10) - i6) * 60) + i11) - i4) * 1000) + i12) - i2))) - 1);
                }
            } else {
    ...
    public TimeZone mo6319cloneAsThawed() {
        JavaTimeZone javaTimeZone = (JavaTimeZone) super.mo6319cloneAsThawed();
