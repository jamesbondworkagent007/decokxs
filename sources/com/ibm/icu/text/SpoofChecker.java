...
public class SpoofChecker {
    ...
    public static class CheckResult {
        ...
        public String toString() {
            ...
            sb.append(", numerics: ");
            sb.append(this.numerics.KWHzl(false));
            sb.append(", position: ");
    ...
    public boolean equals(Object obj) {
        ...
        Activity activity2 = spoofChecker.valueOf;
        if ((activity != activity2 && activity != null && !activity.equals(activity2)) || this.djBIcL != spoofChecker.djBIcL) {
            return false;
        }
        Set<ULocale> set = this.AhwBna;
        Set<ULocale> set2 = spoofChecker.AhwBna;
        if (set != set2 && set != null && !set.equals(set2)) {
            return false;
        }
        UnicodeSet unicodeSet = this.AEQbTJ;
        UnicodeSet unicodeSet2 = spoofChecker.AEQbTJ;
        return (unicodeSet == unicodeSet2 || unicodeSet == null || unicodeSet.equals(unicodeSet2)) && this.gEmmrt == spoofChecker.gEmmrt;
    }
    ...
    public int hashCode() {
        ...
        return (((i ^ iHashCode) ^ iHashCode2) ^ this.AEQbTJ.hashCode()) ^ this.gEmmrt.ordinal();
    }
    ...
    public static class Activity {
        ...
        public static final class ActionBar implements C7024abY.ActionBar {
            private ActionBar() {
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (Arrays.equals(this.OLrzqt, activity.OLrzqt) && Arrays.equals(this.KWHzl, activity.KWHzl)) {
                return C7045acS.AEQbTJ(this.AEQbTJ, activity.AEQbTJ) || (str = this.AEQbTJ) == null || str.equals(activity.AEQbTJ);
            }
            return false;
        }

        public int hashCode() {
            return (Arrays.hashCode(this.OLrzqt) ^ Arrays.hashCode(this.KWHzl)) ^ this.AEQbTJ.hashCode();
        }
    }
    ...
    public static class ScriptSet extends BitSet {
        ...
        public void and(int i) {
            clear(0, i);
            clear(i + 1, CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256);
        }

        public void setAll() {
            set(0, CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256);
        }
