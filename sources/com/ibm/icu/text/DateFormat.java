...
public abstract class DateFormat extends UFormat {
    ...
    @Deprecated
    public static final List<String> DATE_SKELETONS = Arrays.asList(YEAR, QUARTER, ABBR_QUARTER, YEAR_QUARTER, YEAR_ABBR_QUARTER, MONTH, ABBR_MONTH, "M", "yMMMM", YEAR_ABBR_MONTH, YEAR_NUM_MONTH, DAY, YEAR_MONTH_DAY, "yMMMd", YEAR_NUM_MONTH_DAY, WEEKDAY, "E", "yMMMMEEEEd", YEAR_ABBR_MONTH_WEEKDAY_DAY, YEAR_NUM_MONTH_WEEKDAY_DAY, MONTH_DAY, ABBR_MONTH_DAY, NUM_MONTH_DAY, MONTH_WEEKDAY_DAY, ABBR_MONTH_WEEKDAY_DAY, NUM_MONTH_WEEKDAY_DAY);
    ...
    public Date parse(String str) throws ParseException {
        ...
        throw new ParseException("Unparseable date: \"" + str + ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR, parsePosition.getErrorIndex());
    }
    ...
    public static final DateFormat getInstanceForSkeleton(String str, ULocale uLocale) {
        return new SimpleDateFormat(DateTimePatternGenerator.KWHzl(uLocale).EZpvd(str), uLocale);
    }
    ...
    public static final DateFormat getInstanceForSkeleton(Calendar calendar, String str, ULocale uLocale) {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DateTimePatternGenerator.KWHzl(uLocale).EZpvd(str), uLocale);
