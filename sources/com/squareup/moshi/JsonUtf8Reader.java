...
final class JsonUtf8Reader extends JsonReader {
    ...
    */
    ...
    public void skipValue() throws IOException {
        ...
        int i2 = this.stackSize - 1;
        iArr[i2] = iArr[i2] + 1;
        this.pathNames[i2] = AbstractJsonLexerKt.NULL;
    }
    ...
    */
    public BufferedSource nextSource() throws IOException {
        ...
        ByteString byteString2 = JsonValueSource.STATE_END_OF_JSON;
        if (iDoPeek == 3) {
            buffer.writeUtf8("[");
            ...
            if (iDoPeek == 9) {
                buffer.writeUtf8(ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR);
                byteString2 = JsonValueSource.STATE_DOUBLE_QUOTED;
            } else if (iDoPeek == 8) {
                buffer.writeUtf8("'");
                byteString2 = JsonValueSource.STATE_SINGLE_QUOTED;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0035, code lost:
        ...
        if (r5.source.request(2) != false) goto L19;
     */
