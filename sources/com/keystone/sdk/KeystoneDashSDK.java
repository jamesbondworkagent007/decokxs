...
public final class KeystoneDashSDK extends KeystoneChainSDK {
    public final UREncoder generateSignRequest(@NotNull KeystoneSignRequest<CashTx> keystoneSignRequest) {
        Intrinsics.checkNotNullParameter(keystoneSignRequest, "");
        String strGenerateKeystoneSignRequest = getNative$library_release().generateKeystoneSignRequest(keystoneSignRequest.getRequestId(), KeystoneChainSDK.CoinType.DASH.getValue(), KeystoneBaseSDK.toJson$default(this, keystoneSignRequest.getSignData(), null, 2, null), keystoneSignRequest.getXfp(), keystoneSignRequest.getOrigin(), getTimestamp());
