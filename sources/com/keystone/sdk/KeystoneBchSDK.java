...
public final class KeystoneBchSDK extends KeystoneChainSDK {
    public final UREncoder generateSignRequest(@NotNull KeystoneSignRequest<CashTx> keystoneSignRequest) {
        ...
        String strGenerateKeystoneSignRequest = getNative$library_release().generateKeystoneSignRequest(keystoneSignRequest.getRequestId(), KeystoneChainSDK.CoinType.BCH.getValue(), KeystoneBaseSDK.toJson$default(this, keystoneSignRequest.getSignData(), null, 2, null), keystoneSignRequest.getXfp(), keystoneSignRequest.getOrigin(), getTimestamp());
