...
public final class SmoothScrollTimerTask extends TimerTask {
    ...
    public final void run() {
        ...
        if (!this.wheelView.isLoop()) {
            ...
            float f = -this.wheelView.getInitPosition();
            float itemsCount = (this.wheelView.getItemsCount() - 1) - this.wheelView.getInitPosition();
            if (this.wheelView.getTotalScrollY() <= f * itemHeight || this.wheelView.getTotalScrollY() >= itemsCount * itemHeight) {
