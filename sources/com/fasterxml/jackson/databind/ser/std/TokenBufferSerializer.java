...
@VK
public class TokenBufferSerializer extends StdSerializer<YA> {
    ...
    public void serialize(YA ya, JsonGenerator jsonGenerator, VI vi) throws IOException {
        ya.KWHzl(jsonGenerator);
    }
    ...
    @Override // o.VD
    public final void serializeWithType(YA ya, JsonGenerator jsonGenerator, VI vi, AbstractC5601Xz abstractC5601Xz) throws IOException {
        WritableTypeId writableTypeIdAEQbTJ = abstractC5601Xz.AEQbTJ(jsonGenerator, abstractC5601Xz.AEQbTJ(ya, JsonToken.VALUE_EMBEDDED_OBJECT));
        serialize(ya, jsonGenerator, vi);
