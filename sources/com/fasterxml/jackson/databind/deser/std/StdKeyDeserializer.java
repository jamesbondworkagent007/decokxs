...
@VK
public class StdKeyDeserializer extends VC implements Serializable {
    ...
    public Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
        ...
        try {
            ...
            if (C5619Yr.AkhnZx(this._keyClass) && deserializationContext.getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
                return null;
            }
            return deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation", new Object[0]);
        } catch (Exception e) {
            return deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation, problem: (%s) %s", e.getClass().getName(), C5619Yr.EZpvd((Throwable) e));
        }
    }
    ...
    public double _parseDouble(String str) throws IllegalArgumentException {
        return C5522Uy.copydefault(str);
    }

    public Object _weirdKey(DeserializationContext deserializationContext, String str, Exception exc) throws IOException {
        return deserializationContext.handleWeirdKey(this._keyClass, str, "problem: %s", C5619Yr.EZpvd((Throwable) exc));
    }
    ...
    public static final class StringKD extends StdKeyDeserializer {
        ...
        @Override // com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer, o.VC
        public Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
            return str;
        }
    ...
    public static final class DelegatingKD extends VC implements Serializable {
        private static final long serialVersionUID = 1;
        protected final AbstractC5548Vy<?> _delegate;
        protected final Class<?> _keyClass;
        ...
        public DelegatingKD(Class<?> cls, AbstractC5548Vy<?> abstractC5548Vy) {
            this._keyClass = cls;
            this._delegate = abstractC5548Vy;
        }
        ...
        public final Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            YA yaBufferForInputBuffering = deserializationContext.bufferForInputBuffering();
            yaBufferForInputBuffering.AhwBna(str);
            try {
                JsonParser jsonParserFIwbmz = yaBufferForInputBuffering.fIwbmz();
                jsonParserFIwbmz.RcXXUw();
                Object objDeserialize = this._delegate.deserialize(jsonParserFIwbmz, deserializationContext);
