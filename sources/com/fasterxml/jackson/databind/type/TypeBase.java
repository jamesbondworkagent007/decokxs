...
public abstract class TypeBase extends JavaType implements VF {
    ...
    public void serializeWithType(JsonGenerator jsonGenerator, VI vi, AbstractC5601Xz abstractC5601Xz) throws IOException {
        ...
        abstractC5601Xz.AEQbTJ(jsonGenerator, writableTypeId);
        serialize(jsonGenerator, vi);
        abstractC5601Xz.copydefault(jsonGenerator, writableTypeId);
    }

    @Override // o.VF
    public void serialize(JsonGenerator jsonGenerator, VI vi) throws IOException {
        jsonGenerator.AhwBna(toCanonical());
    }
