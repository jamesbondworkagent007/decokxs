    ...
    public void renderLegend(Canvas canvas) {
        ...
        if (this.mLegend.isEnabled()) {
            ...
            if (i2 == 1) {
                ...
                f2 = lineSpacing;
                f3 = fContentLeft + (direction == legendDirection2 ? xOffset : -xOffset);
                if (orientation == legendOrientation) {
                    double d2 = f3;
            ...
            if (i3 != 1) {
                ...
                while (i5 < entries.length) {
                    ...
                    if (z2) {
                        ...
                        fCalcTextWidth = direction == legendDirection3 ? f3 + f17 : f3 - (fConvertDpToPixel5 - f17);
                        float f18 = f16 + fCalcTextHeight;
                        f12 = fCalcTextHeight;
                        f13 = f14;
                        f11 = f3;
                        legendDirection = direction;
                        drawForm(canvas, fCalcTextWidth, f18, legendEntry2, this.mLegend);
                    ...
                    if (legendEntry.label != null) {
                        ...
                        float f19 = fCalcTextWidth;
                        if (!z) {
                            drawLabel(canvas, f19, f16 + f, legendEntry.label);
                        } else {
                            f16 += f + f2;
                            drawLabel(canvas, f19, f16 + f, legendEntry.label);
                        }
            ...
            while (i7 < length) {
                ...
                if (z3) {
                    ...
                    drawForm(canvas, f25, f5 + fCalcTextHeight, legendEntry3, this.mLegend);
                    f4 = direction == Legend.LegendDirection.LEFT_TO_RIGHT ? f25 + fConvertDpToPixel6 : f25;
                } else {
                    list = calculatedLabelBreakPoints;
                    list2 = calculatedLineSizes;
                    i = i7;
