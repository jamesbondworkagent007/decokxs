...
public class YAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float fCalcTextHeight = Utils.calcTextHeight(this.mAxisLabelPaint, ExifInterface.GPS_MEASUREMENT_IN_PROGRESS) / 2.5f;
            ...
            drawYLabels(canvas, f, transformedPositions, fCalcTextHeight + yOffset);
        }
    }
    ...
    public float[] getTransformedPositions() {
        ...
        if (length != i) {
            this.mGetTransformedPositionsBuffer = new float[i];
        }
