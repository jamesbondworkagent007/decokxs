...
public class HorizontalBarChartRenderer extends BarChartRenderer {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v87, resolved type: T */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.github.mikephil.charting.renderer.BarChartRenderer, com.github.mikephil.charting.renderer.DataRenderer
                    ...
                    if (iBarDataSet.isStacked()) {
                            ...
                            if (yVals == null) {
                                ...
                                if (this.mViewPortHandler.isInBoundsX(barBuffer2.buffer[length]) && this.mViewPortHandler.isInBoundsBottom(barBuffer2.buffer[i8])) {
                                    ...
                                    if (iBarDataSet.isDrawValuesEnabled()) {
                                        ...
                                        float f12 = barEntry2.getY() >= 0.0f ? f9 : f10;
                                        float f13 = barBuffer2.buffer[i8] + fCalcTextHeight;
                                        f = fCalcTextHeight;
                                        fArr = yVals;
                                        barEntry = barEntry2;
                                        i2 = i7;
                                        drawValue(canvas, barLabel, f11 + f12, f13, valueTextColor);
                                    } else {
                                        i2 = i7;
                                        f = fCalcTextHeight;
                                        fArr = yVals;
                                    ...
                                    if (barEntry.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                        ...
                                        Utils.drawImage(canvas, icon, (int) (f14 + f9 + mPPointF.x), (int) (barBuffer2.buffer[i8] + mPPointF.y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                    }
                                }
                            } else {
                                i2 = i7;
                                ...
                                while (i11 < length2) {
                                    ...
                                    if (this.mViewPortHandler.isInBoundsX(f23) && this.mViewPortHandler.isInBoundsBottom(f24)) {
                                        if (iBarDataSet.isDrawValuesEnabled()) {
                                            ...
                                            fArr2 = fArr3;
                                            f3 = f23;
                                            drawValue(canvas, barStackedLabel, f23, f24 + f, valueTextColor);
                                        } else {
                                            f2 = f24;
                                            i3 = i11;
                                            fArr2 = fArr3;
                        ...
                        while (i13 < barBuffer2.buffer.length * this.mAnimator.getPhaseX()) {
                            ...
                            if (this.mViewPortHandler.isInBoundsX(barBuffer2.buffer[i13]) && this.mViewPortHandler.isInBoundsBottom(barBuffer2.buffer[i14])) {
                                ...
                                float f30 = f28;
                                if (iBarDataSet.isDrawValuesEnabled()) {
                                    float f31 = barBuffer2.buffer[i13 + 2];
                                    ...
                                    drawValue(canvas, barLabel2, f31 + f32, f26 + fCalcTextHeight, iBarDataSet.getValueTextColor(i13 / 2));
                                } else {
                                    i4 = i13;
                                    list2 = dataSets;
                                    i5 = i6;
                                ...
                                if (barEntry3.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                    ...
                                    float f33 = barBuffer.buffer[i4 + 2];
                                    if (y < 0.0f) {
                                        f29 = f5;
                                    }
                                    Utils.drawImage(canvas, icon3, (int) (f33 + f29 + mPPointF2.x), (int) (f26 + mPPointF2.y), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                }
                            } else {
                                i4 = i13;
                                barBuffer = barBuffer2;
