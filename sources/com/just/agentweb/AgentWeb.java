...
public final class AgentWeb {
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        if (this.mWebCreator.getWebParentLayout() instanceof WebParentLayout) {
            ...
            webParentLayout.setColorValue(agentBuilder.whiteBackgroundColor, agentBuilder.titleColor);
    ...
    private void doSafeCheck() {
        ...
        if (webSecurityLogicImpl == null) {
            webSecurityLogicImpl = WebSecurityLogicImpl.getInstance();
    ...
    private WebCreator configWebCreator(BaseIndicatorView baseIndicatorView, int i, ViewGroup.LayoutParams layoutParams, int i2, int i3, WebView webView, IWebLayout iWebLayout) {
        ...
        if (this.mEnableIndicator) {
            return new DefaultWebCreator(this.mActivity, this.mViewGroup, layoutParams, i, i2, i3, webView, iWebLayout);
        }
        return new DefaultWebCreator(this.mActivity, this.mViewGroup, layoutParams, i, webView, iWebLayout);
    }
    ...
    public static final class AgentBuilder {
        ...
        private int whiteBackgroundColor = 0;
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setWhiteBackground(int i) {
            this.mAgentBuilder.whiteBackgroundColor = i;
            return this;
        }

        public CommonBuilder setTitleColor(int i) {
            this.mAgentBuilder.titleColor = i;
            return this;
        }
    }
