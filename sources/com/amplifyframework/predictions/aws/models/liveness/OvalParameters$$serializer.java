...
public final class OvalParameters$$serializer implements GeneratedSerializer<OvalParameters> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amplifyframework.predictions.aws.models.liveness.OvalParameters", ovalParameters$$serializer, 4);
        ...
        pluginGeneratedSerialDescriptor.addElement("CenterX", false);
        pluginGeneratedSerialDescriptor.addElement("CenterY", false);
    ...
    public OvalParameters deserialize(@NotNull Decoder decoder) {
        float f;
        ...
        return new OvalParameters(i, f, f3, f2, fDecodeFloatElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(@NotNull Encoder encoder, @NotNull OvalParameters ovalParameters) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(ovalParameters, "");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        OvalParameters.write$Self(ovalParameters, compositeEncoderBeginStructure, descriptor2);
