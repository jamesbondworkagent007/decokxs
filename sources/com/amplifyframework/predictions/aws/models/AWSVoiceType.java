...
public enum AWSVoiceType implements VoiceType {
    ...
    public static AWSVoiceType fromVoice(@Nullable VoiceType voiceType) {
        if (voiceType == null) {
            return UNKNOWN;
        }
        if (voiceType instanceof AWSVoiceType) {
            return (AWSVoiceType) voiceType;
        }
        return fromName(voiceType.getName());
    }

    public static AWSVoiceType fromName(@Nullable String str) {
        if (str == null) {
            return UNKNOWN;
        }
