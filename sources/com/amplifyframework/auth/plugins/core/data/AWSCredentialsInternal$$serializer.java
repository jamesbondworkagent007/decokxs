...
public final class AWSCredentialsInternal$$serializer implements GeneratedSerializer<AWSCredentialsInternal> {
    ...
    public AWSCredentialsInternal deserialize(@NotNull Decoder decoder) {
        ...
        return new AWSCredentialsInternal(i, str3, str2, str, l, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(@NotNull Encoder encoder, @NotNull AWSCredentialsInternal aWSCredentialsInternal) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(aWSCredentialsInternal, "");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        AWSCredentialsInternal.write$Self(aWSCredentialsInternal, compositeEncoderBeginStructure, descriptor2);
