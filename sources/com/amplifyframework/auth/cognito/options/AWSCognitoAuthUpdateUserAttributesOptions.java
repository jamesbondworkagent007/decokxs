...
public final class AWSCognitoAuthUpdateUserAttributesOptions extends AuthUpdateUserAttributesOptions {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.amplifyframework.auth.cognito.options.AWSCognitoAuthUpdateUserAttributesOptions */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final AWSCognitoAuthUpdateUserAttributesOptions copy(@NotNull Map<String, String> map) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof AWSCognitoAuthUpdateUserAttributesOptions) && Intrinsics.EZpvd(this.metadata, ((AWSCognitoAuthUpdateUserAttributesOptions) obj).metadata);
    }
    ...
    public AWSCognitoAuthUpdateUserAttributesOptions(@NotNull Map<String, String> map) {
        Intrinsics.checkNotNullParameter(map, "");
        this.metadata = map;
    }

    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.amplifyframework.auth.cognito.options.AWSCognitoAuthUpdateUserAttributesOptions.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final AWSCognitoAuthUpdateUserAttributesOptions invoke(@NotNull Function1<? super CognitoBuilder, Unit> function1) {
    ...
    public static final class CognitoBuilder extends AuthUpdateUserAttributesOptions.Builder<CognitoBuilder> {
        ...
        /* JADX DEBUG: Method merged with bridge method: getThis()Lcom/amplifyframework/auth/options/AuthUpdateUserAttributesOptions$Builder; */
        ...
        /* JADX DEBUG: Method merged with bridge method: build()Lcom/amplifyframework/auth/options/AuthUpdateUserAttributesOptions; */
        @Override // com.amplifyframework.auth.options.AuthUpdateUserAttributesOptions.Builder
