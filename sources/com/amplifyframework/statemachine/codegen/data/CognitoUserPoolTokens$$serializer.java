...
public final class CognitoUserPoolTokens$$serializer implements GeneratedSerializer<CognitoUserPoolTokens> {
    ...
    public CognitoUserPoolTokens deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Long l;
        String str2;
        ...
        return new CognitoUserPoolTokens(i, str3, str2, str, l, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(@NotNull Encoder encoder, @NotNull CognitoUserPoolTokens cognitoUserPoolTokens) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(cognitoUserPoolTokens, "");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        CognitoUserPoolTokens.write$Self(cognitoUserPoolTokens, compositeEncoderBeginStructure, descriptor2);
