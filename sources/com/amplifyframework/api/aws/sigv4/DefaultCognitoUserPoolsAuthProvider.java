...
public final class DefaultCognitoUserPoolsAuthProvider implements CognitoUserPoolsAuthProvider {
    ...
    private void fetchToken() throws ApiException {
        synchronized (this) {
            ...
            this.credentialsProvider.getAccessToken(new Consumer() { // from class: com.amplifyframework.api.aws.sigv4.DefaultCognitoUserPoolsAuthProvider$$ExternalSyntheticLambda0
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // com.amplifyframework.core.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$fetchToken$0(semaphore, (String) obj);
                }
            }, new Consumer() { // from class: com.amplifyframework.api.aws.sigv4.DefaultCognitoUserPoolsAuthProvider$$ExternalSyntheticLambda1
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // com.amplifyframework.core.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$fetchToken$1(semaphore, (Exception) obj);
                }
            });
            try {
                semaphore.acquire();
                ...
                throw new ApiException("Interrupted waiting for Cognito Userpools token.", e, "Sorry, we don't have a suggested fix for this error yet.");
            }
        }
    }
    ...
    private void fetchUser() throws ApiException {
        synchronized (this) {
            final Semaphore semaphore = new Semaphore(0);
            Amplify.Auth.getCurrentUser(new Consumer() { // from class: com.amplifyframework.api.aws.sigv4.DefaultCognitoUserPoolsAuthProvider$$ExternalSyntheticLambda2
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // com.amplifyframework.core.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$fetchUser$2(semaphore, (AuthUser) obj);
                }
            }, new Consumer() { // from class: com.amplifyframework.api.aws.sigv4.DefaultCognitoUserPoolsAuthProvider$$ExternalSyntheticLambda3
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // com.amplifyframework.core.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$fetchUser$3(semaphore, (AuthException) obj);
                }
            });
            try {
                semaphore.acquire();
                ...
                throw new ApiException("Interrupted waiting for Cognito Username.", e, "Sorry, we don't have a suggested fix for this error yet.");
            }
        }
    }
