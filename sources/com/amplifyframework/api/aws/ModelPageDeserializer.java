...
public final class ModelPageDeserializer<M extends Model> implements JsonDeserializer<ModelPage<? extends M>> {
    ...
    public ModelPage<M> deserialize(@NotNull JsonElement jsonElement, @NotNull Type type, @NotNull JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        Intrinsics.checkNotNullParameter(jsonElement, "");
        Intrinsics.checkNotNullParameter(type, "");
        Intrinsics.checkNotNullParameter(jsonDeserializationContext, "");
        return new ApiModelPage(LazyTypeDeserializersKt.deserializeItems(jsonElement, type, jsonDeserializationContext), LazyTypeDeserializersKt.deserializeNextToken(jsonElement));
    }

    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.amplifyframework.api.aws.ModelPageDeserializer.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
