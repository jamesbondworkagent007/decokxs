...
public class LayerParser {
    ...
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.of(DateFormat.DAY, IEncryptorType.DEFAULT_ENCRYPTOR);
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        if (fNextDouble2 > 0.0f) {
            ...
            z = z2;
            arrayList5.add(new Keyframe(lottieComposition, fValueOf, fValueOf, null, 0.0f, Float.valueOf(fNextDouble2)));
            f = 0.0f;
        } else {
            arrayList = arrayList2;
            z = z2;
        ...
        arrayList5.add(new Keyframe(lottieComposition, fValueOf2, fValueOf2, null, fNextDouble2, Float.valueOf(endFrame)));
        ...
        if (z) {
            ...
            animatableTransform3.setAutoOrient(z);
            animatableTransform = animatableTransform3;
        } else {
            animatableTransform = animatableTransform2;
        }
        return new Layer(arrayList3, lottieComposition, strNextString2, jNextInt, layerType, jNextInt2, strNextString, arrayList, animatableTransform, iNextInt, iNextInt2, color, fNextDouble, fNextDouble3, fNextDouble4, fNextDouble5, documentData, animatableTextProperties, arrayList5, matteType2, animatableFloatValue, zNextBoolean, blurEffect, dropShadowEffect, lBlendMode2);
    }
