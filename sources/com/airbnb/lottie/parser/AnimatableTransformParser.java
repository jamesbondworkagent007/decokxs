...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of(IEncryptorType.DEFAULT_ENCRYPTOR, TtmlNode.TAG_P, DateFormat.SECOND, "rz", "r", "o", "so", "eo", "sk", "sa");
