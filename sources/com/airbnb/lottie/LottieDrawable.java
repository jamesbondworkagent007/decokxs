...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
        ...
        try {
            ...
            if (invalidateSelfOnMainThread && this.isDirty) {
                if (this.mainThreadHandler == null) {
                    ...
                    this.invalidateSelfRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda12
                        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[IF]}, finally: {[IF, SGET, IGET, INVOKE, IF, IGET, INVOKE, INVOKE, IGET, INVOKE, CMP_L] complete} */
