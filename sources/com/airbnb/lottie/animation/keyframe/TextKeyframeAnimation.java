...
public class TextKeyframeAnimation extends KeyframeAnimation<DocumentData> {
    ...
    public DocumentData getValue(Keyframe<DocumentData> keyframe, float f) {
        ...
        return (DocumentData) lottieValueCallback.getValueInternal(f2, fFloatValue, documentData2, documentData3 == null ? documentData2 : documentData3, f, getInterpolatedCurrentKeyframeProgress(), getProgress());
    }
