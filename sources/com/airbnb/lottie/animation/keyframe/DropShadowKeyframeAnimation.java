...
public class DropShadowKeyframeAnimation implements BaseKeyframeAnimation.AnimationListener {
    ...
    public void applyTo(Paint paint) {
        if (this.isDirty) {
            ...
            paint.setShadowLayer(this.radius.getValue().floatValue(), fSin * fFloatValue, fCos * fFloatValue, Color.argb(Math.round(this.opacity.getValue().floatValue()), Color.red(iIntValue), Color.green(iIntValue), Color.blue(iIntValue)));
        }
    }
