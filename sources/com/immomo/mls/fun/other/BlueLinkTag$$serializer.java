...
public final /* synthetic */ class BlueLinkTag$$serializer implements GeneratedSerializer<BlueLinkTag> {
    public static final int $stable;
    public static final BlueLinkTag$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BlueLinkTag$$serializer() {
    }
    ...
    static {
        BlueLinkTag$$serializer blueLinkTag$$serializer = new BlueLinkTag$$serializer();
        INSTANCE = blueLinkTag$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.immomo.mls.fun.other.BlueLinkTag", blueLinkTag$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = BlueLinkTag.$childSerializers;
    ...
    public final BlueLinkTag deserialize(@NotNull Decoder decoder) {
        ...
        return new BlueLinkTag(i, str, str3, strDecodeStringElement, str4, str2, list, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BlueLinkTag blueLinkTag) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(blueLinkTag, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BlueLinkTag.write$Self$MLN_mlnservics(blueLinkTag, compositeEncoderBeginStructure, serialDescriptor);
