...
public class CryptoAccount extends RegistryItem {
    ...
    public C5211Iz toCbor() {
        ...
        while (it.hasNext()) {
            ...
            c5211IzDjBIcL.EZpvd(RegistryType.CRYPTO_OUTPUT.getTag().intValue());
            c5205It.EZpvd(cbor);
        }
    ...
    public static CryptoAccount fromCbor(C5211Iz c5211Iz) {
        IE ie = (IE) c5211Iz;
        ...
        return new CryptoAccount(bArrBigIntegerToBytes, arrayList);
    }
}
