...
public final class ChannelPaymentMethodUseCase$getBuySellChannelPaymentMethods$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends List<? extends Channel>, ? extends OKServerException>>, Object> {
    ...
    public ChannelPaymentMethodUseCase$getBuySellChannelPaymentMethods$2(lyG lyg, TradeType tradeType, boolean z, String str, String str2, String str3, String str4, Integer num, String str5, String str6, boolean z2, Continuation<? super ChannelPaymentMethodUseCase$getBuySellChannelPaymentMethods$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChannelPaymentMethodUseCase$getBuySellChannelPaymentMethods$2(this.this$0, this.$tradeType, this.$shouldApplyCached, this.$baseAmount, this.$baseCurrency, this.$quoteAmount, this.$quoteCurrency, this.$standard, this.$chainIndex, this.$tokenAddress, this.$includeFundingBalance, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends List<Channel>, OKServerException>> continuation) {
        return ((ChannelPaymentMethodUseCase$getBuySellChannelPaymentMethods$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            Boolean boolKWHzl2 = C56443yFo.KWHzl(this.$includeFundingBalance);
            this.label = 1;
            channelPaymentMethods$default = InterfaceC31764mDa.ActionBar.getChannelPaymentMethods$default(interfaceC31764mDa, null, null, numAEQbTJ, str, str2, str3, str4, type, num, null, null, boolKWHzl, str5, str6, boolKWHzl2, this, 1539, null);
