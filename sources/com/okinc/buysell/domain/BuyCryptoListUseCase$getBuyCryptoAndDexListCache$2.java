...
public final class BuyCryptoListUseCase$getBuyCryptoAndDexListCache$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends CryptoListModel, ? extends OKServerException>>, Object> {
    ...
    public BuyCryptoListUseCase$getBuyCryptoAndDexListCache$2(lyD lyd, int i, Continuation<? super BuyCryptoListUseCase$getBuyCryptoAndDexListCache$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BuyCryptoListUseCase$getBuyCryptoAndDexListCache$2(this.this$0, this.$ttl, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<CryptoListModel, OKServerException>> continuation) {
        return ((BuyCryptoListUseCase$getBuyCryptoAndDexListCache$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC31764mDa.AEQbTJ(str, "FIRST_CACHE", numAEQbTJ, 1, "all", this);
