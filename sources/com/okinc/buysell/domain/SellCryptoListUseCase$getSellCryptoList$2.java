...
public final class SellCryptoListUseCase$getSellCryptoList$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends List<? extends CurrencyToken>, ? extends OKServerException>>, Object> {
    ...
    public SellCryptoListUseCase$getSellCryptoList$2(C31656lzd c31656lzd, String str, boolean z, Continuation<? super SellCryptoListUseCase$getSellCryptoList$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SellCryptoListUseCase$getSellCryptoList$2(this.this$0, this.$selectedCurrency, this.$withCache, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends List<CurrencyToken>, OKServerException>> continuation) {
        return ((SellCryptoListUseCase$getSellCryptoList$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = InterfaceC31764mDa.ActionBar.getSellCryptoList$default(interfaceC31764mDa, str, null, z, boolKWHzl, this, 2, null);
