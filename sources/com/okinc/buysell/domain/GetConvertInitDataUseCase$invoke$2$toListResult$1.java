...
public final class GetConvertInitDataUseCase$invoke$2$toListResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends ConvertCurrencyBean>>, Object> {
    ...
    public GetConvertInitDataUseCase$invoke$2$toListResult$1(lyU lyu, String str, String str2, Continuation<? super GetConvertInitDataUseCase$invoke$2$toListResult$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GetConvertInitDataUseCase$invoke$2$toListResult$1(this.this$0, this.$from, this.$valuationUnit, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<ConvertCurrencyBean>> continuation) {
        return ((GetConvertInitDataUseCase$invoke$2$toListResult$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = lyV.invoke$default(lyv, false, str, str2, this, 1, null);
