...
public final class CryptoListBehavior extends CoordinatorLayout.Behavior<RecyclerView> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CryptoListBehavior(@NotNull Context context, @NotNull AttributeSet attributeSet) {
    ...
    public boolean layoutDependsOn(@NotNull CoordinatorLayout coordinatorLayout, @NotNull RecyclerView recyclerView, @NotNull View view) {
        ...
        return view.getId() == C31351lsQ.Application.DNMMPQ;
    }
