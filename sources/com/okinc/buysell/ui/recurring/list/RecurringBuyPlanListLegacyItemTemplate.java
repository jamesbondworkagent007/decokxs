...
public final class RecurringBuyPlanListLegacyItemTemplate extends C43318rmy<C30273lSg, AbstractC31591lwt> {
    public final Function1<C30273lSg, Unit> AEQbTJ;

    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: kotlin.jvm.functions.Function1<? super o.lSg, kotlin.Unit> */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public RecurringBuyPlanListLegacyItemTemplate(@NotNull Function1<? super C30273lSg, Unit> function1) {
    ...
    public void onBindViewHolder(@NotNull C43312rms<AbstractC31591lwt> c43312rms, @NotNull final C30273lSg c30273lSg) {
        String strOLrzqt;
        Intrinsics.checkNotNullParameter(c43312rms, "");
        Intrinsics.checkNotNullParameter(c30273lSg, "");
        super.onBindViewHolder((C43312rms) c43312rms, c30273lSg);
        ...
        if (abstractC31591lwt != null) {
            ...
            C33054mpH.loadUrl$default(imageView, c30273lSg.EZpvd(), null, 0, 0, 14, null);
            TextView textView = abstractC31591lwt.AEQbTJ;
            Context context = abstractC31591lwt.getRoot().getContext();
            Intrinsics.checkNotNullExpressionValue(context, "");
            textView.setText(C33069mpW.KWHzl(context, C31351lsQ.Activity.YFmri, (Map<String, ? extends Object>) C56424yEw.gEmmrt(C56390yDp.OLrzqt("fiatAmount", c30273lSg.AEQbTJ()), C56390yDp.OLrzqt(OtcExtraKeys.TRADING_CRYPTO_CURRENCY_DEEPLINK, c30273lSg.copydefault()))));
            abstractC31591lwt.copydefault.setText(c30273lSg.KWHzl());
            boolean z = c30273lSg.AYXKKw() || c30273lSg.AhwBna();
            if (z || (strOLrzqt = c30273lSg.OLrzqt()) == null || strOLrzqt.length() == 0) {
                ...
                abstractC31591lwt.OLrzqt.setText(c30273lSg.OLrzqt());
            }
            if (z) {
                ...
                if (c43316rmw != null) {
                    ...
                    recurringBuyPlanTagArr[1] = c30273lSg.AhwBna() ? RecurringBuyPlanTag.PAUSED : null;
            ...
            abstractC31591lwt.getRoot().setOnClickListener(new View.OnClickListener() { // from class: o.lSc
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // android.view.View.OnClickListener
                public final void onClick(android.view.View view) {
                    RecurringBuyPlanListLegacyItemTemplate.copydefault(this.AEQbTJ, c30273lSg, view);
                }
            });
        }
    }

    public static final void copydefault(RecurringBuyPlanListLegacyItemTemplate recurringBuyPlanListLegacyItemTemplate, C30273lSg c30273lSg, View view) {
        recurringBuyPlanListLegacyItemTemplate.AEQbTJ.invoke(c30273lSg);
    }
    ...
    private final void copydefault(RecyclerView recyclerView) {
        ...
        c43316rmw.register(RecurringBuyPlanTag.class, new TaskDescription());
        recyclerView.setAdapter(c43316rmw);
    }

    public static final class TaskDescription extends C43318rmy<RecurringBuyPlanTag, AbstractC31560lwN> {
