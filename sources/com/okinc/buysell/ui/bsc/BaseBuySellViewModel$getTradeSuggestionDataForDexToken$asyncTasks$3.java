...
public final class BaseBuySellViewModel$getTradeSuggestionDataForDexToken$asyncTasks$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends List<? extends DexBaseTokenBean>, ? extends OKServerException>>, Object> {
    ...
    public BaseBuySellViewModel$getTradeSuggestionDataForDexToken$asyncTasks$3(BaseBuySellViewModel baseBuySellViewModel, CurrencyToken currencyToken, Continuation<? super BaseBuySellViewModel$getTradeSuggestionDataForDexToken$asyncTasks$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BaseBuySellViewModel$getTradeSuggestionDataForDexToken$asyncTasks$3(this.this$0, this.$baseCurrencyToken, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends List<DexBaseTokenBean>, OKServerException>> continuation) {
        return ((BaseBuySellViewModel$getTradeSuggestionDataForDexToken$asyncTasks$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC31764mDa.KWHzl(chainIndex, tokenAddress, this);
