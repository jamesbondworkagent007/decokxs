...
public final class BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1(StateFlow<? extends Map<String, FairPriceTickerData>> stateFlow, BuySellCryptoListViewModel buySellCryptoListViewModel, Continuation<? super BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1 buySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1 = new BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1(this.$flow, this.this$0, continuation);
        buySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1.L$0 = obj;
        return buySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.buysell.ui.bsc.cryptolist.BuySellCryptoListViewModel$fetchCefiTokensLivePriceForPopularList$1$1, reason: invalid class name */
        ...
        */
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                if (!map.isEmpty()) {
                    List<CryptoListItem> list = this.this$0.values;
                    ...
                    this.this$0.values = arrayList;
                    if (!this.this$0.AkhnZx()) {
                        mHA.OLrzqt.OLrzqt(this.this$0.OLrzqt, this.this$0.values);
                    }
                }
