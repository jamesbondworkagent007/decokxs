...
public final class BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1(StateFlow<? extends Map<String, DexPriceTickerData>> stateFlow, BuySellCryptoListViewModel buySellCryptoListViewModel, Continuation<? super BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1(this.$flow, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.buysell.ui.bsc.cryptolist.BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<Map<String, ? extends DexPriceTickerData>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: com.okinc.buysell.ui.bsc.cryptolist.BuySellCryptoListViewModel$fetchDexLivePriceForPopularList$1$1$TaskDescription */
                ...
                if (!map.isEmpty()) {
                    ...
                    for (CryptoListItem cryptoListItemKWHzl : list) {
                        ...
                        if (cryptoListItemKWHzl instanceof CryptoListItem.BuyDexListItem) {
                            ...
                            int i2 = TaskDescription.KWHzl[((DexUtils.Trend) pairEZpvd.getSecond()).ordinal()];
                            if (i2 == 1) {
