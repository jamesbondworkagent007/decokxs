...
public final class BuySellSearchHistoryBehavior extends CoordinatorLayout.Behavior<ConstraintLayout> {
    ...
    public BuySellSearchHistoryBehavior(@NotNull Context context, @NotNull AttributeSet attributeSet) {
