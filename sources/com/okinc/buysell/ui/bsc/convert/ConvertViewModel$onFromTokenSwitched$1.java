...
public final class ConvertViewModel$onFromTokenSwitched$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ConvertViewModel$onFromTokenSwitched$1(ConvertViewModel convertViewModel, ConvertCurrencyBean convertCurrencyBean, ConvertCurrencyBean convertCurrencyBean2, Continuation<? super ConvertViewModel$onFromTokenSwitched$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ConvertViewModel$onFromTokenSwitched$1(this.this$0, this.$fromCcy, this.$toCcy, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ConvertViewModel$onFromTokenSwitched$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = lyH.invoke$default(newProxyInstance, false, ccy, ccy2, isoCode, this, 1, null);
        ...
        this.this$0.EZpvd(this.$fromCcy, c31394ltG.OLrzqt());
        this.this$0.copydefault(c31394ltG.KWHzl());
        mHA mha = mHA.OLrzqt;
        ...
        convertViewModel2.copydefault(new Pair<>(convertViewModel2.fetchVPNInfo(), this.this$0.ejfBZ()));
