...
public final class CurrencySelectionViewModel$getCurrencyFetchTasks$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends CryptoListModel, ? extends OKServerException>>, Object> {
    int label;
    final /* synthetic */ CurrencySelectionViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CurrencySelectionViewModel$getCurrencyFetchTasks$2(CurrencySelectionViewModel currencySelectionViewModel, Continuation<? super CurrencySelectionViewModel$getCurrencyFetchTasks$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CurrencySelectionViewModel$getCurrencyFetchTasks$2(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<CryptoListModel, OKServerException>> continuation) {
        return ((CurrencySelectionViewModel$getCurrencyFetchTasks$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
