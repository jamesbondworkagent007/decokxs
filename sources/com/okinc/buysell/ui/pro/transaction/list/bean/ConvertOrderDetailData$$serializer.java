...
public final /* synthetic */ class ConvertOrderDetailData$$serializer implements GeneratedSerializer<ConvertOrderDetailData> {
    public static final int $stable;
    public static final ConvertOrderDetailData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConvertOrderDetailData$$serializer() {
    }
    ...
    static {
        ConvertOrderDetailData$$serializer convertOrderDetailData$$serializer = new ConvertOrderDetailData$$serializer();
        INSTANCE = convertOrderDetailData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.buysell.ui.pro.transaction.list.bean.ConvertOrderDetailData", convertOrderDetailData$$serializer, 22);
    ...
    public final ConvertOrderDetailData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ConvertOrderDetailData(i, str, str7, str6, str3, str4, str2, str8, str11, str5, i2, str10, str9, str14, j, str15, str13, d2, d, str12, i3, iDecodeIntElement, iDecodeIntElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConvertOrderDetailData convertOrderDetailData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(convertOrderDetailData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConvertOrderDetailData.write$Self$OKBuySell_buysell_impl(convertOrderDetailData, compositeEncoderBeginStructure, serialDescriptor);
