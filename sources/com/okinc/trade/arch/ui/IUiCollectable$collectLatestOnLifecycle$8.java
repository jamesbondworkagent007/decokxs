...
public final class IUiCollectable$collectLatestOnLifecycle$8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IUiCollectable$collectLatestOnLifecycle$8(AbstractC49411unz<T> abstractC49411unz, InterfaceC56560yJx<T, ? extends A> interfaceC56560yJx, InterfaceC56560yJx<T, ? extends B> interfaceC56560yJx2, InterfaceC56560yJx<T, ? extends C> interfaceC56560yJx3, yHT<? super A, ? super B, ? super C, ? super Continuation<? super Unit>, ? extends Object> yht, Continuation<? super IUiCollectable$collectLatestOnLifecycle$8> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable$collectLatestOnLifecycle$8(this.$this_collectLatestOnLifecycle, this.$prop1, this.$prop2, this.$prop3, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable$collectLatestOnLifecycle$8) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
