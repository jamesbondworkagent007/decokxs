...
public final class IUiCollectable2$collectLatestWhenLifecycle$10 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IUiCollectable2$collectLatestWhenLifecycle$10(AbstractC49411unz<T> abstractC49411unz, InterfaceC56560yJx<T, ? extends A> interfaceC56560yJx, InterfaceC56560yJx<T, ? extends B> interfaceC56560yJx2, InterfaceC56560yJx<T, ? extends C> interfaceC56560yJx3, InterfaceC56560yJx<T, ? extends D> interfaceC56560yJx4, yHS<? super A, ? super B, ? super C, ? super D, ? super Continuation<? super Unit>, ? extends Object> yhs, Continuation<? super IUiCollectable2$collectLatestWhenLifecycle$10> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable2$collectLatestWhenLifecycle$10(this.$this_collectLatestWhenLifecycle, this.$prop1, this.$prop2, this.$prop3, this.$prop4, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable2$collectLatestWhenLifecycle$10) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
