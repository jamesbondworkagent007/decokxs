...
public final class IUiCollectable$collectLatestOnLifecycle$12 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IUiCollectable$collectLatestOnLifecycle$12(AbstractC49411unz<T> abstractC49411unz, InterfaceC56560yJx<T, ? extends A> interfaceC56560yJx, InterfaceC56560yJx<T, ? extends B> interfaceC56560yJx2, InterfaceC56560yJx<T, ? extends C> interfaceC56560yJx3, InterfaceC56560yJx<T, ? extends D> interfaceC56560yJx4, InterfaceC56560yJx<T, ? extends E> interfaceC56560yJx5, yHQ<? super A, ? super B, ? super C, ? super D, ? super E, ? super Continuation<? super Unit>, ? extends Object> yhq, Continuation<? super IUiCollectable$collectLatestOnLifecycle$12> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable$collectLatestOnLifecycle$12(this.$this_collectLatestOnLifecycle, this.$prop1, this.$prop2, this.$prop3, this.$prop4, this.$prop5, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable$collectLatestOnLifecycle$12) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
