...
public final class IUiCollectable$collectLatestOnLifecycle$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IUiCollectable$collectLatestOnLifecycle$4(AbstractC49411unz<T> abstractC49411unz, InterfaceC56560yJx<T, ? extends A> interfaceC56560yJx, Function2<? super A, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super IUiCollectable$collectLatestOnLifecycle$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable$collectLatestOnLifecycle$4(this.$this_collectLatestOnLifecycle, this.$prop1, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable$collectLatestOnLifecycle$4) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
