...
public final class IUiCollectable2$collectLatestWhenLifecycle$6 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IUiCollectable2$collectLatestWhenLifecycle$6(AbstractC49411unz<T> abstractC49411unz, InterfaceC56560yJx<T, ? extends A> interfaceC56560yJx, InterfaceC56560yJx<T, ? extends B> interfaceC56560yJx2, yHO<? super A, ? super B, ? super Continuation<? super Unit>, ? extends Object> yho, Continuation<? super IUiCollectable2$collectLatestWhenLifecycle$6> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable2$collectLatestWhenLifecycle$6(this.$this_collectLatestWhenLifecycle, this.$prop1, this.$prop2, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable2$collectLatestWhenLifecycle$6) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
