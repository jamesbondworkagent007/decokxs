...
public final class IUiCollectable$collectLatestOnLifecycle$14 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable$collectLatestOnLifecycle$14(this.$this_collectLatestOnLifecycle, this.$prop1, this.$prop2, this.$prop3, this.$prop4, this.$prop5, this.$prop6, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable$collectLatestOnLifecycle$14) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
