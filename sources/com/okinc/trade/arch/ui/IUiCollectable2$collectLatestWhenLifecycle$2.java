...
public final class IUiCollectable2$collectLatestWhenLifecycle$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public IUiCollectable2$collectLatestWhenLifecycle$2(AbstractC49411unz<T> abstractC49411unz, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super IUiCollectable2$collectLatestWhenLifecycle$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IUiCollectable2$collectLatestWhenLifecycle$2(this.$this_collectLatestWhenLifecycle, this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IUiCollectable2$collectLatestWhenLifecycle$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
