package com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean;
...
public final class ApproveStatusGroup implements Parcelable {
    ...
    private static final KSerializer<Object>[] $childSerializers = {null, EnumsKt.createSimpleEnumSerializer("com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus", ApproveStatus.values()), null, null, null, null, null};
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatusGroup.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKKLine_kline_impl(ApproveStatusGroup approveStatusGroup, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus:?: TERNARY null = ((wrap:int:0x0008: ARITH (r17v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (wrap:??:0x000e: SGET  A[WRAPPED] (LINE:37) com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus.UN_APPROVE com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus) : (r11v0 com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus))
 ...
 A[MD:(boolean, com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus, java.lang.String, java.lang.String, boolean, java.lang.String, java.lang.String):void (m)] (LINE:35) call: com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatusGroup.<init>(boolean, com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatus, java.lang.String, java.lang.String, boolean, java.lang.String, java.lang.String):void type: THIS */
