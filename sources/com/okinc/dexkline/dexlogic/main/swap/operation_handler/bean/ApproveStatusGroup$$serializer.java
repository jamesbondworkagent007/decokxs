...
public final /* synthetic */ class ApproveStatusGroup$$serializer implements GeneratedSerializer<ApproveStatusGroup> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.dexlogic.main.swap.operation_handler.bean.ApproveStatusGroup", approveStatusGroup$$serializer, 7);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull ApproveStatusGroup approveStatusGroup) {
        ...
        ApproveStatusGroup.write$Self$OKKLine_kline_impl(approveStatusGroup, compositeEncoderBeginStructure, serialDescriptor);
