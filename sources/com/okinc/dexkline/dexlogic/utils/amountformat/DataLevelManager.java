...
public final class DataLevelManager {
    public static final DataLevelManager copydefault = new DataLevelManager();
    ...
    public final Triple<String, String, BigLevel> copydefault(@NotNull String str, @NotNull String str2) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        mRE.OLrzqt(str, str2);
    ...
    public final Triple<String, String, BigLevel> OLrzqt(@NotNull String str, @NotNull String str2) {
        ...
        Intrinsics.checkNotNullParameter(str2, "");
        mRE.OLrzqt(str, str2);
        String strEZpvd = C32163mRv.EZpvd(str);
        if (mRE.EZpvd(strEZpvd, 1000)) {
            return new Triple<>(str, str2, BigLevel.NORMAL);
        }
        if (mRE.KWHzl(strEZpvd, 1000) & mRE.EZpvd(strEZpvd, 1000000)) {
            return new Triple<>(mRE.divCheckS$default(str, 1000, Integer.valueOf(C33129mqd.AhwBna("18")), Boolean.FALSE, null, 8, null), "2", BigLevel.THOUSANDS);
        }
        if (mRE.KWHzl(strEZpvd, 1000000) & mRE.EZpvd(strEZpvd, 1000000000)) {
            return new Triple<>(mRE.divCheckS$default(str, 1000000, Integer.valueOf(C33129mqd.AhwBna("18")), Boolean.FALSE, null, 8, null), "2", BigLevel.MILLION);
        }
        return new Triple<>(mRE.divCheckS$default(str, 1000000000, Integer.valueOf(C33129mqd.AhwBna("18")), Boolean.FALSE, null, 8, null), "2", BigLevel.BILLION);
    }
