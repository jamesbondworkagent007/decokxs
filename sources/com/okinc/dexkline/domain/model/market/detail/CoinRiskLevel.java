package com.okinc.dexkline.domain.model.market.detail;
...
public final class CoinRiskLevel {
    ...
    public static final CoinRiskLevel LOW = new CoinRiskLevel(VerifyDAppDomainUrlResponse.LEVEL_LOW, 0);
    public static final CoinRiskLevel MEDIUM = new CoinRiskLevel(VerifyDAppDomainUrlResponse.LEVEL_MEDIUM, 1);
    public static final CoinRiskLevel HIGH = new CoinRiskLevel(VerifyDAppDomainUrlResponse.LEVEL_HIGH, 2);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private static final /* synthetic */ CoinRiskLevel[] $values() {
        return new CoinRiskLevel[]{LOW, MEDIUM, HIGH};
    }
