...
public final class ChainListInfo {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.dexkline.dex.api.bean.ChainListInfo */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.dexkline.dex.api.bean.ChainListInfo.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKKLine_kline_api(ChainListInfo chainListInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(java.util.List<java.lang.String>, java.util.List<java.lang.String>):void (m)] (LINE:14) call: com.okinc.dexkline.dex.api.bean.ChainListInfo.<init>(java.util.List, java.util.List):void type: THIS */
