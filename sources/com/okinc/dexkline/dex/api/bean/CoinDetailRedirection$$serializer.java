...
public final /* synthetic */ class CoinDetailRedirection$$serializer implements GeneratedSerializer<CoinDetailRedirection> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.dex.api.bean.CoinDetailRedirection", coinDetailRedirection$$serializer, 2);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CoinDetailRedirection coinDetailRedirection) {
        ...
        CoinDetailRedirection.write$Self$OKKLine_kline_api(coinDetailRedirection, compositeEncoderBeginStructure, serialDescriptor);
