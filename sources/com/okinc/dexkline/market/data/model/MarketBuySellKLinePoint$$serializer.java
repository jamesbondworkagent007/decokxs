...
public final /* synthetic */ class MarketBuySellKLinePoint$$serializer implements GeneratedSerializer<MarketBuySellKLinePoint> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.MarketBuySellKLinePoint", marketBuySellKLinePoint$$serializer, 10);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull MarketBuySellKLinePoint marketBuySellKLinePoint) {
        ...
        MarketBuySellKLinePoint.AEQbTJ(marketBuySellKLinePoint, compositeEncoderBeginStructure, serialDescriptor);
