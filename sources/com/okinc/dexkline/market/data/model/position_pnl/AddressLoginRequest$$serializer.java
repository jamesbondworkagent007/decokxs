...
public final /* synthetic */ class AddressLoginRequest$$serializer implements GeneratedSerializer<AddressLoginRequest> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.position_pnl.AddressLoginRequest", addressLoginRequest$$serializer, 8);
    ...
    public final AddressLoginRequest deserialize(@NotNull Decoder decoder) {
        ...
        return new AddressLoginRequest(i, str4, str3, l2, num, str5, l, str2, str, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull AddressLoginRequest addressLoginRequest) {
        ...
        AddressLoginRequest.EZpvd(addressLoginRequest, compositeEncoderBeginStructure, serialDescriptor);
