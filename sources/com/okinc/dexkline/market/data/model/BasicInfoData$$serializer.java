...
public final /* synthetic */ class BasicInfoData$$serializer implements GeneratedSerializer<BasicInfoData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.BasicInfoData", basicInfoData$$serializer, 8);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull BasicInfoData basicInfoData) {
        ...
        BasicInfoData.KWHzl(basicInfoData, compositeEncoderBeginStructure, serialDescriptor);
