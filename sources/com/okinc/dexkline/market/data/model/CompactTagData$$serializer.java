...
public final /* synthetic */ class CompactTagData$$serializer implements GeneratedSerializer<CompactTagData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.CompactTagData", compactTagData$$serializer, 3);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CompactTagData compactTagData) {
        ...
        CompactTagData.EZpvd(compactTagData, compositeEncoderBeginStructure, serialDescriptor);
