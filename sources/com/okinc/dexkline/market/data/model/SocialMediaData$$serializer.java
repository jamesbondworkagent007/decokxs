...
public final /* synthetic */ class SocialMediaData$$serializer implements GeneratedSerializer<SocialMediaData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.SocialMediaData", socialMediaData$$serializer, 10);
    ...
    public final SocialMediaData deserialize(@NotNull Decoder decoder) {
        ...
        return new SocialMediaData(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SocialMediaData socialMediaData) {
        ...
        SocialMediaData.AEQbTJ(socialMediaData, compositeEncoderBeginStructure, serialDescriptor);
