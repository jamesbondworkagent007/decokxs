...
public final /* synthetic */ class SmartMoneyAddressData$$serializer implements GeneratedSerializer<SmartMoneyAddressData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.smart_money.SmartMoneyAddressData", smartMoneyAddressData$$serializer, 6);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SmartMoneyAddressData smartMoneyAddressData) {
        ...
        SmartMoneyAddressData.copydefault(smartMoneyAddressData, compositeEncoderBeginStructure, serialDescriptor);
