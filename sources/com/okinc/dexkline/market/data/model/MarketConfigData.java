...
public final class MarketConfigData {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.dexkline.market.data.model.MarketConfigData */
    ...
    public static /* synthetic */ MarketConfigData copy$default(MarketConfigData marketConfigData, List list, List list2, HolderConfigData holderConfigData, List list3, int i, Object obj) {
        ...
        return marketConfigData.KWHzl(list, list2, holderConfigData, list3);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final HolderConfigData EZpvd() {
        return this.holderConfig;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final MarketConfigData KWHzl(List<String> list, List<BannerConfigData> list2, @NotNull HolderConfigData holderConfigData, List<String> list3) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final List<BannerConfigData> copydefault() {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.dexkline.market.data.model.MarketConfigData.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void AEQbTJ(MarketConfigData marketConfigData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.dexkline.market.data.model.HolderConfigData:?: TERNARY null = ((wrap:int:0x000b: ARITH (r6v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (wrap:com.okinc.dexkline.market.data.model.HolderConfigData:0x0012: CONSTRUCTOR 
 ...
 A[MD:(java.util.List, int, kotlin.jvm.internal.DefaultConstructorMarker):void (m), WRAPPED] (LINE:12) call: com.okinc.dexkline.market.data.model.HolderConfigData.<init>(java.util.List, int, kotlin.jvm.internal.DefaultConstructorMarker):void type: CONSTRUCTOR) : (r4v0 com.okinc.dexkline.market.data.model.HolderConfigData))
 ...
 A[MD:(java.util.List<java.lang.String>, java.util.List<com.okinc.dexkline.market.data.model.BannerConfigData>, com.okinc.dexkline.market.data.model.HolderConfigData, java.util.List<java.lang.String>):void (m)] (LINE:7) call: com.okinc.dexkline.market.data.model.MarketConfigData.<init>(java.util.List, java.util.List, com.okinc.dexkline.market.data.model.HolderConfigData, java.util.List):void type: THIS */
