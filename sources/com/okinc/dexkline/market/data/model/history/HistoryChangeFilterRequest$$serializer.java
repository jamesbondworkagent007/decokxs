...
public final /* synthetic */ class HistoryChangeFilterRequest$$serializer implements GeneratedSerializer<HistoryChangeFilterRequest> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.history.HistoryChangeFilterRequest", historyChangeFilterRequest$$serializer, 5);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull HistoryChangeFilterRequest historyChangeFilterRequest) {
        ...
        HistoryChangeFilterRequest.write$Self$OKKLine_kline_impl(historyChangeFilterRequest, compositeEncoderBeginStructure, serialDescriptor);
