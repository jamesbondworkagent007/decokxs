...
public final class HistoryChangeResponse {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.dexkline.market.data.model.history.HistoryChangeResponse */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.dexkline.market.data.model.history.HistoryChangeResponse.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKKLine_kline_impl(HistoryChangeResponse historyChangeResponse, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(int, java.util.List<com.okinc.dexkline.market.data.model.history.HistoryChangeData>):void (m)] (LINE:9) call: com.okinc.dexkline.market.data.model.history.HistoryChangeResponse.<init>(int, java.util.List):void type: THIS */
