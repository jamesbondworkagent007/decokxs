...
public final /* synthetic */ class BannerConfigData$$serializer implements GeneratedSerializer<BannerConfigData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.BannerConfigData", bannerConfigData$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("fixedStr", true);
    ...
    public final BannerConfigData deserialize(@NotNull Decoder decoder) {
        ...
        return new BannerConfigData(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull BannerConfigData bannerConfigData) {
        ...
        BannerConfigData.copydefault(bannerConfigData, compositeEncoderBeginStructure, serialDescriptor);
