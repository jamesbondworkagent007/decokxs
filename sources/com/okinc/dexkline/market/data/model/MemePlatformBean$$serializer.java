...
public final /* synthetic */ class MemePlatformBean$$serializer implements GeneratedSerializer<MemePlatformBean> {
    public static final int $stable;
    public static final MemePlatformBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MemePlatformBean$$serializer() {
    }
    ...
    static {
        MemePlatformBean$$serializer memePlatformBean$$serializer = new MemePlatformBean$$serializer();
        INSTANCE = memePlatformBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.dexkline.market.data.model.MemePlatformBean", memePlatformBean$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("id", true);
        pluginGeneratedSerialDescriptor.addElement("moduleTagName", true);
    ...
    public final MemePlatformBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new MemePlatformBean(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MemePlatformBean memePlatformBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(memePlatformBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MemePlatformBean.write$Self$OKKLine_kline_impl(memePlatformBean, compositeEncoderBeginStructure, serialDescriptor);
