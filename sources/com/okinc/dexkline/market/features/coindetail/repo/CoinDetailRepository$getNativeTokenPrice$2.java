...
public final class CoinDetailRepository$getNativeTokenPrice$2 extends SuspendLambda implements Function1<Continuation<? super ResponseData<NativeTokenPriceData>>, Object> {
    ...
    int label;
    final /* synthetic */ mWJ this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoinDetailRepository$getNativeTokenPrice$2(mWJ mwj, String str, Continuation<? super CoinDetailRepository$getNativeTokenPrice$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC32260mVk.AEQbTJ(str, this);
