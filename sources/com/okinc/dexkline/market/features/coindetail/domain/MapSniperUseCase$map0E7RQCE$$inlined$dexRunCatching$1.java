...
/* JADX INFO: renamed from: com.okinc.dexkline.market.features.coindetail.domain.MapSniperUseCase$map-0E7RQCE$$inlined$dexRunCatching$1, reason: invalid class name */
/* JADX INFO: loaded from: classes8.dex */
public final class MapSniperUseCase$map0E7RQCE$$inlined$dexRunCatching$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends C32316mXm>>, Object> {
    ...
    public MapSniperUseCase$map0E7RQCE$$inlined$dexRunCatching$1(Continuation continuation, List list, EarlyBuyersWs earlyBuyersWs, mWB mwb) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Result<? extends C32316mXm>> continuation) {
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i2 == 0) {
                ...
                if (i >= (this.$from$inlined.getPageNum() * this.$from$inlined.getPageSize()) + this.$from$inlined.getEarlyBuyerVO().getEarlyBuyerDetailVOList().size() || pageNum * pageSize > i) {
                    ...
                    if (!it.hasNext()) {
                        ...
                        if (listFJNWhG.size() < this.$from$inlined.getPageNum() * this.$from$inlined.getPageSize() || listFJNWhG.size() >= (this.$from$inlined.getPageNum() * this.$from$inlined.getPageSize()) + this.$from$inlined.getEarlyBuyerVO().getEarlyBuyerDetailVOList().size()) {
                            list = listFJNWhG;
                            objM7377constructorimpl = Result.m7377constructorimpl(new C32316mXm(this.$from$inlined.getEarlyBuyerVO().getTotalBuyInAmountPercentage(), this.$from$inlined.getEarlyBuyerVO().getTotalHoldAmountPercentage(), this.$from$inlined.getEarlyBuyerVO().getTokenContractAddress(), this.$from$inlined.getEarlyBuyerVO().getChainId(), list));
                    ...
                    this.I$0 = i5;
                    this.label = 1;
                    objEZpvd = mwb.EZpvd(sniperHolder, this);
            ...
            mXB mxb3 = (mXB) objEZpvd2;
            if (mxb3 != null) {
                collection.add(mxb3);
            }
            if (it2.hasNext()) {
                SniperHolder sniperHolder2 = (SniperHolder) it2.next();
                mWB mwb2 = this.this$0;
                this.L$0 = collection;
                this.L$1 = it2;
                this.L$2 = list3;
                this.L$3 = list2;
                this.label = 2;
                objEZpvd2 = mwb2.EZpvd(sniperHolder2, this);
                if (objEZpvd2 == objCopydefault) {
                    return objCopydefault;
                }
                if (Result.m7383isFailureimpl(objEZpvd2)) {
                }
                mXB mxb32 = (mXB) objEZpvd2;
                if (mxb32 != null) {
                }
                if (it2.hasNext()) {
