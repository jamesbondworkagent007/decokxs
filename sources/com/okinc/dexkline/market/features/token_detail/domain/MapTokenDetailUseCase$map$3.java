...
public final class MapTokenDetailUseCase$map$3 extends ContinuationImpl {
    public int label;
    ...
    public MapTokenDetailUseCase$map$3(C34576neg c34576neg, Continuation<? super MapTokenDetailUseCase$map$3> continuation) {
        super(continuation);
