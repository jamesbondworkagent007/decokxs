...
public final class HistoryChange implements Parcelable {
    ...
    public final List<CompactTag> valueOf;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final List<CompactTag> KWHzl() {
        return this.valueOf;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final HistoryChange OLrzqt(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, @NotNull String str8, @NotNull List<HistoryTokenChange> list, @NotNull String str9, @NotNull String str10, @NotNull String str11, @NotNull String str12, @NotNull String str13, @NotNull List<CompactTag> list2) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final List<HistoryTokenChange> copydefault() {
        return this.KWHzl;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd((Object) this.AhwBna, (Object) historyChange.AhwBna) && Intrinsics.EZpvd((Object) this.copydefault, (Object) historyChange.copydefault) && Intrinsics.EZpvd((Object) this.AEQbTJ, (Object) historyChange.AEQbTJ) && Intrinsics.EZpvd((Object) this.AYXKKw, (Object) historyChange.AYXKKw) && Intrinsics.EZpvd((Object) this.gEmmrt, (Object) historyChange.gEmmrt) && Intrinsics.EZpvd((Object) this.DbNXlk, (Object) historyChange.DbNXlk) && Intrinsics.EZpvd((Object) this.fetchVPNInfo, (Object) historyChange.fetchVPNInfo) && Intrinsics.EZpvd((Object) this.isConnected, (Object) historyChange.isConnected) && Intrinsics.EZpvd(this.KWHzl, historyChange.KWHzl) && Intrinsics.EZpvd((Object) this.AkhnZx, (Object) historyChange.AkhnZx) && Intrinsics.EZpvd((Object) this.EZpvd, (Object) historyChange.EZpvd) && Intrinsics.EZpvd((Object) this.values, (Object) historyChange.values) && Intrinsics.EZpvd((Object) this.djBIcL, (Object) historyChange.djBIcL) && Intrinsics.EZpvd((Object) this.OLrzqt, (Object) historyChange.OLrzqt) && Intrinsics.EZpvd(this.valueOf, historyChange.valueOf);
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public int hashCode() {
        return (((((((((((((((((((((((((((this.AhwBna.hashCode() * 31) + this.copydefault.hashCode()) * 31) + this.AEQbTJ.hashCode()) * 31) + this.AYXKKw.hashCode()) * 31) + this.gEmmrt.hashCode()) * 31) + this.DbNXlk.hashCode()) * 31) + this.fetchVPNInfo.hashCode()) * 31) + this.isConnected.hashCode()) * 31) + this.KWHzl.hashCode()) * 31) + this.AkhnZx.hashCode()) * 31) + this.EZpvd.hashCode()) * 31) + this.values.hashCode()) * 31) + this.djBIcL.hashCode()) * 31) + this.OLrzqt.hashCode()) * 31) + this.valueOf.hashCode();
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public String toString() {
        return "HistoryChange(id=" + this.AhwBna + ", chainId=" + this.copydefault + ", dexName=" + this.AEQbTJ + ", price=" + this.AYXKKw + ", poolLogoUrl=" + this.gEmmrt + ", txHashUrl=" + this.DbNXlk + ", volume=" + this.fetchVPNInfo + ", userAddress=" + this.isConnected + ", changedTokenInfo=" + this.KWHzl + ", tokenSymbol=" + this.AkhnZx + ", amount=" + this.EZpvd + ", timestamp=" + this.values + ", isBuy=" + this.djBIcL + ", baseTokenPrice=" + this.OLrzqt + ", newTagList=" + this.valueOf + ")";
    }
    ...
    public final void writeToParcel(@NotNull Parcel parcel, int i) {
        ...
        List<CompactTag> list2 = this.valueOf;
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List<com.okinc.dexkline.market.features.history.domian.models.HistoryTokenChange>, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List<com.okinc.dexkline.market.features.tag.domain.CompactTag>):void (m)] (LINE:10) call: com.okinc.dexkline.market.features.history.domian.models.HistoryChange.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List):void type: THIS */
