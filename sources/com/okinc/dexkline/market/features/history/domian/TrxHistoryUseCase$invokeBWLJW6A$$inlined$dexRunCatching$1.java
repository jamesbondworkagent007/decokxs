...
/* JADX INFO: renamed from: com.okinc.dexkline.market.features.history.domian.TrxHistoryUseCase$invoke-BWLJW6A$$inlined$dexRunCatching$1, reason: invalid class name */
...
public final class TrxHistoryUseCase$invokeBWLJW6A$$inlined$dexRunCatching$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Boolean>>, Object> {
    ...
    public TrxHistoryUseCase$invokeBWLJW6A$$inlined$dexRunCatching$1(Continuation continuation, String str, C32380mZw c32380mZw, TokenFilter tokenFilter, boolean z) {
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i3 == 0) {
            ...
            C32378mZu c32378mZu = this.this$0.AEQbTJ;
            String str = this.$lastItemId$inlined;
            TokenFilter tokenFilter = this.$tokenFilter$inlined;
            this.I$0 = i;
            this.label = 1;
            objKWHzl = c32378mZu.KWHzl(str, tokenFilter, this);
            ...
            arrayList = (Collection) this.L$0;
            C56391yDq.AEQbTJ(obj);
            c34371nan = (C34371nan) obj;
            if (c34371nan != null) {
                arrayList.add(c34371nan);
            }
            zBooleanValue = z;
            if (it.hasNext()) {
                HistoryChange historyChange = (HistoryChange) it.next();
                if (this.$isMainHistory$inlined) {
                    C32377mZt c32377mZt = this.this$0.AhwBna;
                    this.L$0 = arrayList;
                    this.L$1 = it;
                    this.I$0 = i2;
                    this.Z$0 = zBooleanValue;
                    this.label = 2;
                    Object objAEQbTJ = c32377mZt.AEQbTJ(historyChange, this);
                    if (objAEQbTJ == objCopydefault) {
                        return objCopydefault;
                    }
                    z = zBooleanValue;
                    objM7386unboximpl = objAEQbTJ;
                    c34371nan = !Result.m7383isFailureimpl(objM7386unboximpl) ? (C34371nan) null : (C34371nan) null;
                    if (c34371nan != null) {
                    }
                    zBooleanValue = z;
                    if (it.hasNext()) {
                        ...
                        if (i2 != 0) {
                            ...
                            List<C34371nan> value = this.this$0.AEQbTJ().getValue();
                    ...
                    C32380mZw c32380mZw = this.this$0;
                    this.L$0 = arrayList;
                    this.L$1 = it;
                    this.I$0 = i2;
                    this.Z$0 = zBooleanValue;
                    this.label = 3;
                    Object objOLrzqt = c32380mZw.OLrzqt(historyChange, this);
