...
public final class TransactionStatistic implements Parcelable {
    ...
    public static /* synthetic */ TransactionStatistic copy$default(TransactionStatistic transactionStatistic, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
        if ((i & 1) != 0) {
            str = transactionStatistic.valueOf;
        }
        if ((i & 2) != 0) {
            str2 = transactionStatistic.EZpvd;
        }
        String str7 = str2;
        if ((i & 4) != 0) {
        ...
        String str8 = str3;
        if ((i & 8) != 0) {
            str4 = transactionStatistic.AEQbTJ;
        }
        String str9 = str4;
        if ((i & 16) != 0) {
            str5 = transactionStatistic.KWHzl;
        }
        String str10 = str5;
        if ((i & 32) != 0) {
            str6 = transactionStatistic.OLrzqt;
        }
        return transactionStatistic.OLrzqt(str, str7, str8, str9, str10, str6);
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final TransactionStatistic OLrzqt(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull String str6) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd((Object) this.valueOf, (Object) transactionStatistic.valueOf) && Intrinsics.EZpvd((Object) this.EZpvd, (Object) transactionStatistic.EZpvd) && Intrinsics.EZpvd((Object) this.copydefault, (Object) transactionStatistic.copydefault) && Intrinsics.EZpvd((Object) this.AEQbTJ, (Object) transactionStatistic.AEQbTJ) && Intrinsics.EZpvd((Object) this.KWHzl, (Object) transactionStatistic.KWHzl) && Intrinsics.EZpvd((Object) this.OLrzqt, (Object) transactionStatistic.OLrzqt);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public int hashCode() {
        return (((((((((this.valueOf.hashCode() * 31) + this.EZpvd.hashCode()) * 31) + this.copydefault.hashCode()) * 31) + this.AEQbTJ.hashCode()) * 31) + this.KWHzl.hashCode()) * 31) + this.OLrzqt.hashCode();
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public String toString() {
        return "TransactionStatistic(totalVolume=" + this.valueOf + ", netVolume=" + this.EZpvd + ", buyCount=" + this.copydefault + ", buyVolume=" + this.AEQbTJ + ", sellCount=" + this.KWHzl + ", sellVolume=" + this.OLrzqt + ")";
    }
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String):void (m)] (LINE:29) call: com.okinc.dexkline.market.features.overview.domain.TransactionStatistic.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String):void type: THIS */
