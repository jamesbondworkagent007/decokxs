...
public final class FavoriteListSignalUseCase$signalFavoriteListChange$1 extends ContinuationImpl {
    ...
    public FavoriteListSignalUseCase$signalFavoriteListChange$1(mYU myu, Continuation<? super FavoriteListSignalUseCase$signalFavoriteListChange$1> continuation) {
        super(continuation);
        this.this$0 = myu;
    }
