...
public final class PriceRangeFilter implements Parcelable {
    ...
    public static /* synthetic */ PriceRangeFilter copy$default(PriceRangeFilter priceRangeFilter, String str, String str2, TokenAgeType tokenAgeType, String str3, String str4, String str5, boolean z, int i, Object obj) {
        ...
        return priceRangeFilter.AEQbTJ(str, str6, tokenAgeType2, str7, str8, str9, z);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final PriceRangeFilter AEQbTJ(@NotNull String str, @NotNull String str2, TokenAgeType tokenAgeType, String str3, @NotNull String str4, @NotNull String str5, boolean z) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.dexkline.market.features.filter.domain.PriceRangeFilter.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void AEQbTJ(PriceRangeFilter priceRangeFilter, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.dexkline.market.common.constants.TokenAgeType:?: TERNARY null = ((wrap:int:0x0010: ARITH (r13v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? (null com.okinc.dexkline.market.common.constants.TokenAgeType) : (r8v0 com.okinc.dexkline.market.common.constants.TokenAgeType))
 ...
 A[MD:(java.lang.String, java.lang.String, com.okinc.dexkline.market.common.constants.TokenAgeType, java.lang.String, java.lang.String, java.lang.String, boolean):void (m)] (LINE:11) call: com.okinc.dexkline.market.features.filter.domain.PriceRangeFilter.<init>(java.lang.String, java.lang.String, com.okinc.dexkline.market.common.constants.TokenAgeType, java.lang.String, java.lang.String, java.lang.String, boolean):void type: THIS */
