...
public final class LatestPnLRepositoryImpl$getLatestPnL$2 extends SuspendLambda implements Function1<Continuation<? super ResponseData<LatestPnLData>>, Object> {
    ...
    int label;
    final /* synthetic */ C34468nce this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LatestPnLRepositoryImpl$getLatestPnL$2(String str, String str2, String str3, C34468nce c34468nce, Continuation<? super LatestPnLRepositoryImpl$getLatestPnL$2> continuation) {
        super(1, continuation);
        this.$chainId = str;
        this.$walletAddress = str2;
        this.$tokenContractAddress = str3;
        this.this$0 = c34468nce;
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC32260mVk.OLrzqt(map, this);
