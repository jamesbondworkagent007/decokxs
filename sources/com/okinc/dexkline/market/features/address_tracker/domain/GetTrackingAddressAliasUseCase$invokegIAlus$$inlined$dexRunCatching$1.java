...
/* JADX INFO: renamed from: com.okinc.dexkline.market.features.address_tracker.domain.GetTrackingAddressAliasUseCase$invoke-gIAlu-s$$inlined$dexRunCatching$1, reason: invalid class name */
...
public final class GetTrackingAddressAliasUseCase$invokegIAlus$$inlined$dexRunCatching$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends TrackingAddressAlias>>>, Object> {
    ...
    int label;
    final /* synthetic */ mVO this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetTrackingAddressAliasUseCase$invokegIAlus$$inlined$dexRunCatching$1(Continuation continuation, mVO mvo, String str) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                mVV mvv = this.this$0.KWHzl;
                String str = this.$walletAddress$inlined;
                this.label = 1;
                objCopydefault = mvv.copydefault(str, this);
