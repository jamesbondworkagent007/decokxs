...
public final class KlineContainerFragment$initView$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineContainerFragment$initView$1$1(mTF mtf, LatestMarketInfoBean latestMarketInfoBean, Continuation<? super KlineContainerFragment$initView$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KlineContainerFragment$initView$1$1(this.this$0, this.$bean, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineContainerFragment$initView$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
