...
public final class SelectionType {
    ...
    public static final SelectionType CurrencyUnit = new SelectionType("CurrencyUnit", 0);
    public static final SelectionType More = new SelectionType("More", 1);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private static final /* synthetic */ SelectionType[] $values() {
        return new SelectionType[]{CurrencyUnit, More};
    }
