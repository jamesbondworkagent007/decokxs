...
public final /* synthetic */ class AddressInfo$$serializer implements GeneratedSerializer<AddressInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.assets.backend.api.model.AddressInfo", addressInfo$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("tips", true);
        pluginGeneratedSerialDescriptor.addElement("liteTips", true);
        pluginGeneratedSerialDescriptor.addElement(ProductMatrixRemoteConfig.ALERT, true);
        pluginGeneratedSerialDescriptor.addElement("packageTips", true);
        pluginGeneratedSerialDescriptor.addElement("comTips", true);
    ...
    public final AddressInfo deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new AddressInfo(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AddressInfo addressInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(addressInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AddressInfo.write$Self$OKAssets_assets_pro_api(addressInfo, compositeEncoderBeginStructure, serialDescriptor);
