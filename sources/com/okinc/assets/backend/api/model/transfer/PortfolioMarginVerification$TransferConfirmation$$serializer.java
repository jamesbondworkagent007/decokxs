...
public final /* synthetic */ class PortfolioMarginVerification$TransferConfirmation$$serializer implements GeneratedSerializer<PortfolioMarginVerification.TransferConfirmation> {
    public static final int $stable;
    public static final PortfolioMarginVerification$TransferConfirmation$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PortfolioMarginVerification$TransferConfirmation$$serializer() {
    }
    ...
    static {
        PortfolioMarginVerification$TransferConfirmation$$serializer portfolioMarginVerification$TransferConfirmation$$serializer = new PortfolioMarginVerification$TransferConfirmation$$serializer();
        INSTANCE = portfolioMarginVerification$TransferConfirmation$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.assets.backend.api.model.transfer.PortfolioMarginVerification.TransferConfirmation", portfolioMarginVerification$TransferConfirmation$$serializer, 6);
    ...
    public final PortfolioMarginVerification.TransferConfirmation deserialize(@NotNull Decoder decoder) {
        ...
        return new PortfolioMarginVerification.TransferConfirmation(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PortfolioMarginVerification.TransferConfirmation transferConfirmation) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(transferConfirmation, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PortfolioMarginVerification.TransferConfirmation.write$Self$OKAssets_assets_pro_api(transferConfirmation, compositeEncoderBeginStructure, serialDescriptor);
