...
public final class LcaDebugResultActivity$handleJwstQueryResultResponse$7$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ LcaDebugResultActivity this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LcaDebugResultActivity$handleJwstQueryResultResponse$7$1(LcaDebugResultActivity lcaDebugResultActivity, Continuation<? super LcaDebugResultActivity$handleJwstQueryResultResponse$7$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LcaDebugResultActivity$handleJwstQueryResultResponse$7$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LcaDebugResultActivity$handleJwstQueryResultResponse$7$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            ...
            viewOnClickListenerC54939xaY.setTitle("Response JSON (Query Result)");
            viewOnClickListenerC54939xaY.EZpvd(str);
            viewOnClickListenerC54939xaY.AEQbTJ((CharSequence) "OK", (View.OnClickListener) null);
            viewOnClickListenerC54939xaY.AEQbTJ("Copy", new View.OnClickListener() { // from class: com.okinc.liveness.lca.debugtool.ui.LcaDebugResultActivity$handleJwstQueryResultResponse$7$1$$ExternalSyntheticLambda0
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LcaDebugResultActivity$handleJwstQueryResultResponse$7$1.invokeSuspend$lambda$1$lambda$0(viewOnClickListenerC54939xaY, lcaDebugResultActivity, str, view);
                }
            });
    ...
    public static final void invokeSuspend$lambda$1$lambda$0(ViewOnClickListenerC54939xaY viewOnClickListenerC54939xaY, LcaDebugResultActivity lcaDebugResultActivity, String str, View view) {
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(viewOnClickListenerC54939xaY), Dispatchers.getMain(), null, new LcaDebugResultActivity$handleJwstQueryResultResponse$7$1$1$1$1(lcaDebugResultActivity, str, null), 2, null);
    }
}
