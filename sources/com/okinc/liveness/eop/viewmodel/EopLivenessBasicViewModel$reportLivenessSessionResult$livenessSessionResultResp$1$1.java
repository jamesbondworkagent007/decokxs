...
public final class EopLivenessBasicViewModel$reportLivenessSessionResult$livenessSessionResultResp$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ResponseData<AwsSessionResultResp>>, Object> {
    ...
    public EopLivenessBasicViewModel$reportLivenessSessionResult$livenessSessionResultResp$1$1(EopLivenessBasicViewModel eopLivenessBasicViewModel, String str, Continuation<? super EopLivenessBasicViewModel$reportLivenessSessionResult$livenessSessionResultResp$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EopLivenessBasicViewModel$reportLivenessSessionResult$livenessSessionResultResp$1$1(this.$this_runOrErrorResponse, this.$extMsg, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ResponseData<AwsSessionResultResp>> continuation) {
        return ((EopLivenessBasicViewModel$reportLivenessSessionResult$livenessSessionResultResp$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (Intrinsics.EZpvd((Object) this.$this_runOrErrorResponse.QOLQEE(), (Object) LivenessRouter.ALI.getVendorName())) {
                ...
                livenessSessionResultRequest = new LivenessSessionResultRequest(null, this.$this_runOrErrorResponse.DTwDnp(), this.$extMsg, null, null, strGEmmrt, str, (interfaceC6884aXmOLrzqt == null || (c6885aXnAEQbTJ = interfaceC6884aXmOLrzqt.AEQbTJ()) == null) ? null : c6885aXnAEQbTJ.EZpvd(), 24, null);
            } else {
                livenessSessionResultRequest = new LivenessSessionResultRequest(null, this.$this_runOrErrorResponse.DTwDnp(), this.$extMsg, null, null, null, null, null, 248, null);
            }
            ...
            this.label = 1;
            obj = pqfOLrzqt.KWHzl(livenessSessionResultRequest, mapKWHzl, this);
