...
public final /* synthetic */ class MiniAppUpdateResp$$serializer implements GeneratedSerializer<MiniAppUpdateResp> {
    public static final int $stable;
    public static final MiniAppUpdateResp$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MiniAppUpdateResp$$serializer() {
    }
    ...
    static {
        MiniAppUpdateResp$$serializer miniAppUpdateResp$$serializer = new MiniAppUpdateResp$$serializer();
        INSTANCE = miniAppUpdateResp$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.resource.request.MiniAppUpdateResp", miniAppUpdateResp$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("md5", true);
        pluginGeneratedSerialDescriptor.addElement("version", true);
        pluginGeneratedSerialDescriptor.addElement("url", true);
        pluginGeneratedSerialDescriptor.addElement("nameKey", true);
        pluginGeneratedSerialDescriptor.addElement("appid", true);
        pluginGeneratedSerialDescriptor.addElement("fitVersion", true);
    ...
    public final MiniAppUpdateResp deserialize(@NotNull Decoder decoder) {
        ...
        return new MiniAppUpdateResp(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MiniAppUpdateResp miniAppUpdateResp) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(miniAppUpdateResp, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MiniAppUpdateResp.write$Self$OKRuntime_ok_runtime(miniAppUpdateResp, compositeEncoderBeginStructure, serialDescriptor);
