...
public final class AdvancedWalletUseCase$getAccountId$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    int label;
    final /* synthetic */ C28196kSl this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdvancedWalletUseCase$getAccountId$2(C28196kSl c28196kSl, Continuation<? super AdvancedWalletUseCase$getAccountId$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AdvancedWalletUseCase$getAccountId$2(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super String> continuation) {
        return ((AdvancedWalletUseCase$getAccountId$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
