...
public final class AdvancedCustomMevPresetVM$initSlippage$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AdvancedCustomMevPresetVM$initSlippage$1(String str, int i, String str2, AdvancedCustomMevPresetVM advancedCustomMevPresetVM, Continuation<? super AdvancedCustomMevPresetVM$initSlippage$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AdvancedCustomMevPresetVM$initSlippage$1(this.$autoSlippageValue, this.$type, this.$slippageValue, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AdvancedCustomMevPresetVM$initSlippage$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
