...
public final class DynamicTokenListRepository$getSingleTokenListByChain$$inlined$getApiResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ResponseData<List<? extends ChainTokensData>>>, Object> {
    ...
    public DynamicTokenListRepository$getSingleTokenListByChain$$inlined$getApiResult$1(Continuation continuation, kYA kya, C28382kZi c28382kZi, OKWalletHiddenSmallAssetTokenModel oKWalletHiddenSmallAssetTokenModel) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DynamicTokenListRepository$getSingleTokenListByChain$$inlined$getApiResult$1(continuation, this.this$0, this.$request$inlined, this.$hiddenStatusAndSmallValue$inlined);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ResponseData<List<? extends ChainTokensData>>> continuation) {
        return ((DynamicTokenListRepository$getSingleTokenListByChain$$inlined$getApiResult$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC23233huP.KWHzl(strCopydefault, strDjBIcL, strValueOf, strAEQbTJ, strAYXKKw, numAhwBna, hiddenValue, this);
