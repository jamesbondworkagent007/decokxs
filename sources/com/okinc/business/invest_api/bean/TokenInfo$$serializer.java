...
public final /* synthetic */ class TokenInfo$$serializer implements GeneratedSerializer<TokenInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_api.bean.TokenInfo", tokenInfo$$serializer, 2);
    ...
    public final TokenInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new TokenInfo(i, jDecodeLongElement, strDecodeStringElement, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull TokenInfo tokenInfo) {
        ...
        TokenInfo.write$Self$OKDeFi_invest_api(tokenInfo, compositeEncoderBeginStructure, serialDescriptor);
