...
public final class KlineContainerFragment$initView$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineContainerFragment$initView$2$1(hRN hrn, LatestMarketInfoBean latestMarketInfoBean, Continuation<? super KlineContainerFragment$initView$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KlineContainerFragment$initView$2$1(this.this$0, this.$bean, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineContainerFragment$initView$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
