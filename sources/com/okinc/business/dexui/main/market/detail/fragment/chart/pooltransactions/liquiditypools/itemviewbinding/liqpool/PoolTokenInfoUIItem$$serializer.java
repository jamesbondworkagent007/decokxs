...
public final /* synthetic */ class PoolTokenInfoUIItem$$serializer implements GeneratedSerializer<PoolTokenInfoUIItem> {
    public static final int $stable;
    public static final PoolTokenInfoUIItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PoolTokenInfoUIItem$$serializer() {
    }
    ...
    static {
        PoolTokenInfoUIItem$$serializer poolTokenInfoUIItem$$serializer = new PoolTokenInfoUIItem$$serializer();
        INSTANCE = poolTokenInfoUIItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexui.main.market.detail.fragment.chart.pooltransactions.liquiditypools.itemviewbinding.liqpool.PoolTokenInfoUIItem", poolTokenInfoUIItem$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement(OtcExtraKeys.AMOUNT, false);
        pluginGeneratedSerialDescriptor.addElement("tokenAmountUsd", false);
    ...
    public final PoolTokenInfoUIItem deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new PoolTokenInfoUIItem(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PoolTokenInfoUIItem poolTokenInfoUIItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(poolTokenInfoUIItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PoolTokenInfoUIItem.write$Self$OKDex_dex_impl(poolTokenInfoUIItem, compositeEncoderBeginStructure, serialDescriptor);
