...
public final /* synthetic */ class HolderTagResponseData$$serializer implements GeneratedSerializer<HolderTagResponseData> {
    public static final int $stable;
    public static final HolderTagResponseData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private HolderTagResponseData$$serializer() {
    }
    ...
    static {
        HolderTagResponseData$$serializer holderTagResponseData$$serializer = new HolderTagResponseData$$serializer();
        INSTANCE = holderTagResponseData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.data.model.market.HolderTagResponseData", holderTagResponseData$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("suspicious", true);
        pluginGeneratedSerialDescriptor.addElement("snipers", true);
        pluginGeneratedSerialDescriptor.addElement("liquidityPool", true);
        pluginGeneratedSerialDescriptor.addElement("creator", true);
        pluginGeneratedSerialDescriptor.addElement("dev", true);
        pluginGeneratedSerialDescriptor.addElement("smartMoney", true);
    ...
    public final HolderTagResponseData deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new HolderTagResponseData(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull HolderTagResponseData holderTagResponseData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(holderTagResponseData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        HolderTagResponseData.write$Self$OKDex_dex_impl(holderTagResponseData, compositeEncoderBeginStructure, serialDescriptor);
