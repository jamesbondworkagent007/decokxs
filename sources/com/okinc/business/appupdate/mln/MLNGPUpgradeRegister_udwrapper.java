...
@InterfaceC60044zuT
public class MLNGPUpgradeRegister_udwrapper extends LuaUserdata {
    public static final String[] methods = new String[0];

    public MLNGPUpgradeRegister_udwrapper(Globals globals, Object obj) {
        super(globals, obj);
    }

    /* JADX WARN: Type inference failed for: r1v1, types: [T, java.lang.Object] */
    public MLNGPUpgradeRegister_udwrapper(long j, LuaValue[] luaValueArr) {
        super(j, luaValueArr);
    ...
    public MLNGPUpgradeRegister getJavaUserdata() {
        return (MLNGPUpgradeRegister) this.javaUserdata;
    }
