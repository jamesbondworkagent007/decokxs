...
@InterfaceC60044zuT
public class MLNUpgradeRegister_udwrapper extends LuaUserdata {
    public static final String[] methods = new String[0];

    public MLNUpgradeRegister_udwrapper(Globals globals, Object obj) {
        super(globals, obj);
    }

    /* JADX WARN: Type inference failed for: r1v1, types: [T, java.lang.Object] */
    public MLNUpgradeRegister_udwrapper(long j, LuaValue[] luaValueArr) {
        super(j, luaValueArr);
    ...
    public MLNUpgradeRegister getJavaUserdata() {
        return (MLNUpgradeRegister) this.javaUserdata;
    }
