...
public final /* synthetic */ class GasFeeSubResponse$$serializer implements GeneratedSerializer<GasFeeSubResponse> {
    public static final int $stable;
    public static final GasFeeSubResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GasFeeSubResponse$$serializer() {
    }
    ...
    static {
        GasFeeSubResponse$$serializer gasFeeSubResponse$$serializer = new GasFeeSubResponse$$serializer();
        INSTANCE = gasFeeSubResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.core.network.ws.GasFeeSubResponse", gasFeeSubResponse$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("chainIndex", false);
        pluginGeneratedSerialDescriptor.addElement("baseFee", false);
    ...
    public final GasFeeSubResponse deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new GasFeeSubResponse(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GasFeeSubResponse gasFeeSubResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(gasFeeSubResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GasFeeSubResponse.write$Self$OKPayCore_web3pay_lib(gasFeeSubResponse, compositeEncoderBeginStructure, serialDescriptor);
