...
public final /* synthetic */ class GasLimit$$serializer implements GeneratedSerializer<GasLimit> {
    public static final int $stable;
    public static final GasLimit$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GasLimit$$serializer() {
    }
    ...
    static {
        GasLimit$$serializer gasLimit$$serializer = new GasLimit$$serializer();
        INSTANCE = gasLimit$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.core.model.GasLimit", gasLimit$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("initGasLimit", false);
    ...
    public final GasLimit deserialize(@NotNull Decoder decoder) {
        ...
        return new GasLimit(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GasLimit gasLimit) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(gasLimit, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GasLimit.write$Self$OKPayCore_web3pay_lib(gasLimit, compositeEncoderBeginStructure, serialDescriptor);
