...
public final /* synthetic */ class AccountAddress$$serializer implements GeneratedSerializer<AccountAddress> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.account.model.AccountAddress", accountAddress$$serializer, 2);
    ...
    public final AccountAddress deserialize(@NotNull Decoder decoder) {
        ...
        return new AccountAddress(i, strDecodeStringElement, strDecodeStringElement2, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull AccountAddress accountAddress) {
        ...
        AccountAddress.write$Self$OKPayCore_web3pay_lib(accountAddress, compositeEncoderBeginStructure, serialDescriptor);
