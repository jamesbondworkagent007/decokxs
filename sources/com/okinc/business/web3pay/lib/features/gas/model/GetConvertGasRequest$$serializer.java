...
public final /* synthetic */ class GetConvertGasRequest$$serializer implements GeneratedSerializer<GetConvertGasRequest> {
    public static final int $stable;
    public static final GetConvertGasRequest$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GetConvertGasRequest$$serializer() {
    }
    ...
    static {
        GetConvertGasRequest$$serializer getConvertGasRequest$$serializer = new GetConvertGasRequest$$serializer();
        INSTANCE = getConvertGasRequest$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.gas.model.GetConvertGasRequest", getConvertGasRequest$$serializer, 5);
    ...
    public final GetConvertGasRequest deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new GetConvertGasRequest(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GetConvertGasRequest getConvertGasRequest) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(getConvertGasRequest, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GetConvertGasRequest.write$Self$OKPayCore_web3pay_lib(getConvertGasRequest, compositeEncoderBeginStructure, serialDescriptor);
