...
public final /* synthetic */ class ConvertInfoApiModel$$serializer implements GeneratedSerializer<ConvertInfoApiModel> {
    public static final int $stable;
    public static final ConvertInfoApiModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConvertInfoApiModel$$serializer() {
    }
    ...
    static {
        ConvertInfoApiModel$$serializer convertInfoApiModel$$serializer = new ConvertInfoApiModel$$serializer();
        INSTANCE = convertInfoApiModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.transactionhistory.datasource.remote.http.model.ConvertInfoApiModel", convertInfoApiModel$$serializer, 6);
    ...
    public final ConvertInfoApiModel deserialize(@NotNull Decoder decoder) {
        ...
        return new ConvertInfoApiModel(i, str3, str2, iDecodeIntElement, i2, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConvertInfoApiModel convertInfoApiModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(convertInfoApiModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConvertInfoApiModel.write$Self$OKPayCore_web3pay_lib(convertInfoApiModel, compositeEncoderBeginStructure, serialDescriptor);
