...
public final /* synthetic */ class CoinAsset$$serializer implements GeneratedSerializer<CoinAsset> {
    public static final int $stable;
    public static final CoinAsset$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CoinAsset$$serializer() {
    }
    ...
    static {
        CoinAsset$$serializer coinAsset$$serializer = new CoinAsset$$serializer();
        INSTANCE = coinAsset$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.asset.model.CoinAsset", coinAsset$$serializer, 4);
    ...
    public final CoinAsset deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new CoinAsset(i, str, str3, str2, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CoinAsset coinAsset) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(coinAsset, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CoinAsset.write$Self$OKPayCore_web3pay_lib(coinAsset, compositeEncoderBeginStructure, serialDescriptor);
