...
public final /* synthetic */ class CreatePayTransferUopResponse$$serializer implements GeneratedSerializer<CreatePayTransferUopResponse> {
    public static final int $stable;
    public static final CreatePayTransferUopResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CreatePayTransferUopResponse$$serializer() {
    }
    ...
    static {
        CreatePayTransferUopResponse$$serializer createPayTransferUopResponse$$serializer = new CreatePayTransferUopResponse$$serializer();
        INSTANCE = createPayTransferUopResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.uop.model.CreatePayTransferUopResponse", createPayTransferUopResponse$$serializer, 5);
    ...
    public final CreatePayTransferUopResponse deserialize(@NotNull Decoder decoder) {
        boolean z;
        ...
        return new CreatePayTransferUopResponse(i, z, str2, jsonElement, iDecodeIntElement, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CreatePayTransferUopResponse createPayTransferUopResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(createPayTransferUopResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CreatePayTransferUopResponse.write$Self$OKPayCore_web3pay_lib(createPayTransferUopResponse, compositeEncoderBeginStructure, serialDescriptor);
