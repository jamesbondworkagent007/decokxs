...
public final /* synthetic */ class CreateConvertUopResponse$$serializer implements GeneratedSerializer<CreateConvertUopResponse> {
    public static final int $stable;
    public static final CreateConvertUopResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CreateConvertUopResponse$$serializer() {
    }
    ...
    static {
        CreateConvertUopResponse$$serializer createConvertUopResponse$$serializer = new CreateConvertUopResponse$$serializer();
        INSTANCE = createConvertUopResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.uop.model.CreateConvertUopResponse", createConvertUopResponse$$serializer, 5);
    ...
    public final CreateConvertUopResponse deserialize(@NotNull Decoder decoder) {
        boolean z;
        ...
        return new CreateConvertUopResponse(i, z, str2, jsonElement, iDecodeIntElement, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CreateConvertUopResponse createConvertUopResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(createConvertUopResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CreateConvertUopResponse.write$Self$OKPayCore_web3pay_lib(createConvertUopResponse, compositeEncoderBeginStructure, serialDescriptor);
