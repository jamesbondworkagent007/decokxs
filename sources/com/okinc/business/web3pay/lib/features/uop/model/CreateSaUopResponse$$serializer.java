...
public final /* synthetic */ class CreateSaUopResponse$$serializer implements GeneratedSerializer<CreateSaUopResponse> {
    public static final int $stable;
    public static final CreateSaUopResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CreateSaUopResponse$$serializer() {
    }
    ...
    static {
        CreateSaUopResponse$$serializer createSaUopResponse$$serializer = new CreateSaUopResponse$$serializer();
        INSTANCE = createSaUopResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.lib.features.uop.model.CreateSaUopResponse", createSaUopResponse$$serializer, 5);
    ...
    public final CreateSaUopResponse deserialize(@NotNull Decoder decoder) {
        boolean z;
        ...
        return new CreateSaUopResponse(i, z, str2, jsonElement, iDecodeIntElement, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CreateSaUopResponse createSaUopResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(createSaUopResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CreateSaUopResponse.write$Self$OKPayCore_web3pay_lib(createSaUopResponse, compositeEncoderBeginStructure, serialDescriptor);
