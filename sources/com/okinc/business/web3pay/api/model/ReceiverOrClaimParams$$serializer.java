...
public final /* synthetic */ class ReceiverOrClaimParams$$serializer implements GeneratedSerializer<ReceiverOrClaimParams> {
    public static final int $stable;
    public static final ReceiverOrClaimParams$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ReceiverOrClaimParams$$serializer() {
    }
    ...
    static {
        ReceiverOrClaimParams$$serializer receiverOrClaimParams$$serializer = new ReceiverOrClaimParams$$serializer();
        INSTANCE = receiverOrClaimParams$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.web3pay.api.model.ReceiverOrClaimParams", receiverOrClaimParams$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("orderId", false);
        pluginGeneratedSerialDescriptor.addElement("senderName", false);
        pluginGeneratedSerialDescriptor.addElement("tokenInfo", false);
        pluginGeneratedSerialDescriptor.addElement("senderMessage", false);
        pluginGeneratedSerialDescriptor.addElement("usdValue", false);
    ...
    public final ReceiverOrClaimParams deserialize(@NotNull Decoder decoder) {
        ...
        return new ReceiverOrClaimParams(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ReceiverOrClaimParams receiverOrClaimParams) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(receiverOrClaimParams, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ReceiverOrClaimParams.OLrzqt(receiverOrClaimParams, compositeEncoderBeginStructure, serialDescriptor);
