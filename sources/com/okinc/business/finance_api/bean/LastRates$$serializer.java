...
public final /* synthetic */ class LastRates$$serializer implements GeneratedSerializer<LastRates> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.finance_api.bean.LastRates", lastRates$$serializer, 2);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull LastRates lastRates) {
        ...
        LastRates.write$Self$OKFinance_finance_api(lastRates, compositeEncoderBeginStructure, serialDescriptor);
