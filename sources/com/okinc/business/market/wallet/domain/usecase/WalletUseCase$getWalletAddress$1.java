...
public final class WalletUseCase$getWalletAddress$1 extends ContinuationImpl {
    public int label;
    ...
    public WalletUseCase$getWalletAddress$1(kKG kkg, Continuation<? super WalletUseCase$getWalletAddress$1> continuation) {
        super(continuation);
        this.this$0 = kkg;
    }
