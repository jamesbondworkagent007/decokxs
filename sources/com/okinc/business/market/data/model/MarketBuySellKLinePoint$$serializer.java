...
public final /* synthetic */ class MarketBuySellKLinePoint$$serializer implements GeneratedSerializer<MarketBuySellKLinePoint> {
    public static final int $stable;
    public static final MarketBuySellKLinePoint$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MarketBuySellKLinePoint$$serializer() {
    }
    ...
    static {
        MarketBuySellKLinePoint$$serializer marketBuySellKLinePoint$$serializer = new MarketBuySellKLinePoint$$serializer();
        INSTANCE = marketBuySellKLinePoint$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.MarketBuySellKLinePoint", marketBuySellKLinePoint$$serializer, 10);
        pluginGeneratedSerialDescriptor.addElement(CrashHianalyticsData.TIME, false);
        pluginGeneratedSerialDescriptor.addElement("buyPrice", false);
        pluginGeneratedSerialDescriptor.addElement("buyCount", false);
        pluginGeneratedSerialDescriptor.addElement("buyAmount", false);
        pluginGeneratedSerialDescriptor.addElement("buyValue", false);
        pluginGeneratedSerialDescriptor.addElement("sellPrice", false);
        pluginGeneratedSerialDescriptor.addElement("sellCount", false);
        pluginGeneratedSerialDescriptor.addElement("sellAmount", false);
        pluginGeneratedSerialDescriptor.addElement("sellValue", false);
        pluginGeneratedSerialDescriptor.addElement("fromAddressTag", true);
    ...
    public final MarketBuySellKLinePoint deserialize(@NotNull Decoder decoder) {
        ...
        return new MarketBuySellKLinePoint(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MarketBuySellKLinePoint marketBuySellKLinePoint) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(marketBuySellKLinePoint, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MarketBuySellKLinePoint.copydefault(marketBuySellKLinePoint, compositeEncoderBeginStructure, serialDescriptor);
