package com.okinc.business.market.data.model.holder;
...
public final class HolderChartData {
 ...
 A[MD:(java.lang.String, java.lang.String, java.util.List<com.okinc.business.market.data.model.holder.HolderChartItemData>, java.util.List<com.okinc.business.market.data.model.holder.HolderChartItemData>, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List<com.okinc.business.market.data.model.holder.HolderTopChartItemData>, java.util.List<com.okinc.business.market.data.model.holder.HolderTopChartItemData>, java.util.List<com.okinc.business.market.data.model.holder.HolderTopChartItemData>, java.util.List<com.okinc.business.market.data.model.holder.HoldingItemData>, java.util.List<com.okinc.business.market.data.model.holder.HoldingItemData>, java.util.List<com.okinc.business.market.data.model.holder.HoldingItemData>, java.util.List<com.okinc.business.market.data.model.holder.HoldingItemData>, java.util.List<com.okinc.business.market.data.model.holder.HoldingItemData>):void (m)] (LINE:6) call: com.okinc.business.market.data.model.holder.HolderChartData.<init>(java.lang.String, java.lang.String, java.util.List, java.util.List, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List, java.util.List, java.util.List, java.util.List, java.util.List, java.util.List, java.util.List, java.util.List):void type: THIS */
