...
public final /* synthetic */ class RwaTradingInfoData$$serializer implements GeneratedSerializer<RwaTradingInfoData> {
    public static final int $stable;
    public static final RwaTradingInfoData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RwaTradingInfoData$$serializer() {
    }
    ...
    static {
        RwaTradingInfoData$$serializer rwaTradingInfoData$$serializer = new RwaTradingInfoData$$serializer();
        INSTANCE = rwaTradingInfoData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.RwaTradingInfoData", rwaTradingInfoData$$serializer, 9);
        pluginGeneratedSerialDescriptor.addElement("circulatingMarketCap", true);
        pluginGeneratedSerialDescriptor.addElement("companyName", true);
        pluginGeneratedSerialDescriptor.addElement("companyProfile", true);
        pluginGeneratedSerialDescriptor.addElement("industry", true);
        pluginGeneratedSerialDescriptor.addElement("listedCompany", true);
        pluginGeneratedSerialDescriptor.addElement("peRatio", true);
        pluginGeneratedSerialDescriptor.addElement("stockCode", true);
        pluginGeneratedSerialDescriptor.addElement("totalMarketCap", true);
        pluginGeneratedSerialDescriptor.addElement("turnoverRatio24h", true);
    ...
    public final RwaTradingInfoData deserialize(@NotNull Decoder decoder) {
        ...
        return new RwaTradingInfoData(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RwaTradingInfoData rwaTradingInfoData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(rwaTradingInfoData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RwaTradingInfoData.copydefault(rwaTradingInfoData, compositeEncoderBeginStructure, serialDescriptor);
