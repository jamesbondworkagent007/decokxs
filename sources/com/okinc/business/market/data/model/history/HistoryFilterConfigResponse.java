...
import com.okinc.business.market.data.model.PriceRangeConfigData$$serializer;
...
public final class HistoryFilterConfigResponse {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.market.data.model.history.HistoryFilterConfigResponse */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.data.model.history.HistoryFilterConfigResponse.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKDex_dex_impl(HistoryFilterConfigResponse historyFilterConfigResponse, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(java.util.List<com.okinc.business.market.data.model.PriceRangeConfigData>):void (m)] (LINE:10) call: com.okinc.business.market.data.model.history.HistoryFilterConfigResponse.<init>(java.util.List):void type: THIS */
