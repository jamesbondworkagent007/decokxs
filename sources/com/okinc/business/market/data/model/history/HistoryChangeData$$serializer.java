...
public final /* synthetic */ class HistoryChangeData$$serializer implements GeneratedSerializer<HistoryChangeData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.history.HistoryChangeData", historyChangeData$$serializer, 15);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull HistoryChangeData historyChangeData) {
        ...
        HistoryChangeData.write$Self$OKDex_dex_impl(historyChangeData, compositeEncoderBeginStructure, serialDescriptor);
