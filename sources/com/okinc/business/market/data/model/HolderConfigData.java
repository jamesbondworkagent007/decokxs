...
public final class HolderConfigData {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.market.data.model.HolderConfigData */
    ...
    public static /* synthetic */ HolderConfigData copy$default(HolderConfigData holderConfigData, List list, int i, Object obj) {
        ...
        return holderConfigData.copydefault(list);
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final HolderConfigData copydefault(@NotNull List<String> list) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.data.model.HolderConfigData.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
 ...
 A[MD:(java.util.List<java.lang.String>):void (m)] (LINE:18) call: com.okinc.business.market.data.model.HolderConfigData.<init>(java.util.List):void type: THIS */
