...
public final /* synthetic */ class AlertListResponse$$serializer implements GeneratedSerializer<AlertListResponse> {
    public static final int $stable;
    public static final AlertListResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AlertListResponse$$serializer() {
    }
    ...
    static {
        AlertListResponse$$serializer alertListResponse$$serializer = new AlertListResponse$$serializer();
        INSTANCE = alertListResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.alert.AlertListResponse", alertListResponse$$serializer, 8);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = AlertListResponse.$childSerializers;
    ...
    public final AlertListResponse deserialize(@NotNull Decoder decoder) {
        String str;
        int i;
        List list;
        String str2;
        ...
        return new AlertListResponse(i, strDecodeStringElement2, str4, str3, strDecodeStringElement, z, str2, str, list, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AlertListResponse alertListResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(alertListResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AlertListResponse.EZpvd(alertListResponse, compositeEncoderBeginStructure, serialDescriptor);
