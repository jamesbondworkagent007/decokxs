...
public final /* synthetic */ class DevAnalysisTokenSummary$$serializer implements GeneratedSerializer<DevAnalysisTokenSummary> {
    public static final int $stable;
    public static final DevAnalysisTokenSummary$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DevAnalysisTokenSummary$$serializer() {
    }
    ...
    static {
        DevAnalysisTokenSummary$$serializer devAnalysisTokenSummary$$serializer = new DevAnalysisTokenSummary$$serializer();
        INSTANCE = devAnalysisTokenSummary$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.DevAnalysisTokenSummary", devAnalysisTokenSummary$$serializer, 11);
        pluginGeneratedSerialDescriptor.addElement("createdTokenCount", true);
        pluginGeneratedSerialDescriptor.addElement("creatorAddress", true);
        pluginGeneratedSerialDescriptor.addElement("goldenDogCount", true);
        pluginGeneratedSerialDescriptor.addElement("goldenDogRate", true);
        pluginGeneratedSerialDescriptor.addElement("launchedRate", true);
        ...
        pluginGeneratedSerialDescriptor.addElement("ruggedTokenCount", true);
        pluginGeneratedSerialDescriptor.addElement("ruggedTokenRate", true);
    ...
    public final DevAnalysisTokenSummary deserialize(@NotNull Decoder decoder) {
        ...
        return new DevAnalysisTokenSummary(i, str2, str4, str10, str7, str8, str6, str9, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DevAnalysisTokenSummary devAnalysisTokenSummary) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(devAnalysisTokenSummary, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DevAnalysisTokenSummary.OLrzqt(devAnalysisTokenSummary, compositeEncoderBeginStructure, serialDescriptor);
