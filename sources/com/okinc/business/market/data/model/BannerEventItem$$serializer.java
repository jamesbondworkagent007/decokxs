...
public final /* synthetic */ class BannerEventItem$$serializer implements GeneratedSerializer<BannerEventItem> {
    public static final int $stable;
    public static final BannerEventItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BannerEventItem$$serializer() {
    }
    ...
    static {
        BannerEventItem$$serializer bannerEventItem$$serializer = new BannerEventItem$$serializer();
        INSTANCE = bannerEventItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.BannerEventItem", bannerEventItem$$serializer, 7);
    ...
    public final BannerEventItem deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new BannerEventItem(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BannerEventItem bannerEventItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(bannerEventItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BannerEventItem.AEQbTJ(bannerEventItem, compositeEncoderBeginStructure, serialDescriptor);
