...
public final class PnLTransactionResponse {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.market.data.model.position_pnl.PnLTransactionResponse */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.data.model.position_pnl.PnLTransactionResponse.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKDex_dex_impl(PnLTransactionResponse pnLTransactionResponse, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(boolean, boolean, java.util.List<com.okinc.business.market.data.model.position_pnl.PnLTransactionData>):void (m)] (LINE:9) call: com.okinc.business.market.data.model.position_pnl.PnLTransactionResponse.<init>(boolean, boolean, java.util.List):void type: THIS */
