...
public final /* synthetic */ class PnLTransactionData$$serializer implements GeneratedSerializer<PnLTransactionData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.position_pnl.PnLTransactionData", pnLTransactionData$$serializer, 13);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull PnLTransactionData pnLTransactionData) {
        ...
        PnLTransactionData.AEQbTJ(pnLTransactionData, compositeEncoderBeginStructure, serialDescriptor);
