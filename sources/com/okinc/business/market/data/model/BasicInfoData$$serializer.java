...
public final /* synthetic */ class BasicInfoData$$serializer implements GeneratedSerializer<BasicInfoData> {
    public static final int $stable;
    public static final BasicInfoData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BasicInfoData$$serializer() {
    }
    ...
    static {
        BasicInfoData$$serializer basicInfoData$$serializer = new BasicInfoData$$serializer();
        INSTANCE = basicInfoData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.BasicInfoData", basicInfoData$$serializer, 8);
    ...
    public final BasicInfoData deserialize(@NotNull Decoder decoder) {
        ...
        return new BasicInfoData(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BasicInfoData basicInfoData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(basicInfoData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BasicInfoData.AEQbTJ(basicInfoData, compositeEncoderBeginStructure, serialDescriptor);
