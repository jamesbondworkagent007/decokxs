...
public final /* synthetic */ class MemePlatformBean$$serializer implements GeneratedSerializer<MemePlatformBean> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.MemePlatformBean", memePlatformBean$$serializer, 4);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull MemePlatformBean memePlatformBean) {
        ...
        MemePlatformBean.write$Self$OKDex_dex_impl(memePlatformBean, compositeEncoderBeginStructure, serialDescriptor);
