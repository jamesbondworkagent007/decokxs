...
public final /* synthetic */ class TokenMetricsFilterRequest$$serializer implements GeneratedSerializer<TokenMetricsFilterRequest> {
    public static final int $stable;
    public static final TokenMetricsFilterRequest$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TokenMetricsFilterRequest$$serializer() {
    }
    ...
    static {
        TokenMetricsFilterRequest$$serializer tokenMetricsFilterRequest$$serializer = new TokenMetricsFilterRequest$$serializer();
        INSTANCE = tokenMetricsFilterRequest$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.smart_money.TokenMetricsFilterRequest", tokenMetricsFilterRequest$$serializer, 14);
        pluginGeneratedSerialDescriptor.addElement("tokenMcapMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenMcapMax", true);
        pluginGeneratedSerialDescriptor.addElement("tokenVolumeMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenVolumeMax", true);
        pluginGeneratedSerialDescriptor.addElement("tokenHoldersMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenHoldersMax", true);
        pluginGeneratedSerialDescriptor.addElement("tokenAgeMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenAgeMax", true);
        pluginGeneratedSerialDescriptor.addElement("tokenTxsMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenTxsMax", true);
        pluginGeneratedSerialDescriptor.addElement("tokenBuyTxsMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenBuyTxsMax", true);
        pluginGeneratedSerialDescriptor.addElement("tokenSellTxsMin", true);
        pluginGeneratedSerialDescriptor.addElement("tokenSellTxsMax", true);
    ...
    public final TokenMetricsFilterRequest deserialize(@NotNull Decoder decoder) {
        ...
        return new TokenMetricsFilterRequest(i, str, str3, str5, str7, str9, str11, str10, str8, strDecodeStringElement, str6, str4, str2, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TokenMetricsFilterRequest tokenMetricsFilterRequest) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(tokenMetricsFilterRequest, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TokenMetricsFilterRequest.EZpvd(tokenMetricsFilterRequest, compositeEncoderBeginStructure, serialDescriptor);
