...
public final /* synthetic */ class SignalMetricsFilterRequest$$serializer implements GeneratedSerializer<SignalMetricsFilterRequest> {
    public static final int $stable;
    public static final SignalMetricsFilterRequest$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SignalMetricsFilterRequest$$serializer() {
    }
    ...
    static {
        SignalMetricsFilterRequest$$serializer signalMetricsFilterRequest$$serializer = new SignalMetricsFilterRequest$$serializer();
        INSTANCE = signalMetricsFilterRequest$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.smart_money.SignalMetricsFilterRequest", signalMetricsFilterRequest$$serializer, 8);
        pluginGeneratedSerialDescriptor.addElement("tradeAddressNumMin", true);
        pluginGeneratedSerialDescriptor.addElement("tradeAddressNumMax", true);
    ...
    public final SignalMetricsFilterRequest deserialize(@NotNull Decoder decoder) {
        ...
        return new SignalMetricsFilterRequest(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SignalMetricsFilterRequest signalMetricsFilterRequest) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(signalMetricsFilterRequest, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SignalMetricsFilterRequest.OLrzqt(signalMetricsFilterRequest, compositeEncoderBeginStructure, serialDescriptor);
