...
public final class AddressResponse {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.market.data.model.smart_money.AddressResponse */
    ...
    public static /* synthetic */ AddressResponse copy$default(AddressResponse addressResponse, List list, int i, Object obj) {
        ...
        return addressResponse.KWHzl(list);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final List<SmartMoneyAddressData> AEQbTJ() {
        return this.addresses;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final AddressResponse KWHzl(@NotNull List<SmartMoneyAddressData> list) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.data.model.smart_money.AddressResponse.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void EZpvd(AddressResponse addressResponse, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(java.util.List<com.okinc.business.market.data.model.smart_money.SmartMoneyAddressData>):void (m)] (LINE:8) call: com.okinc.business.market.data.model.smart_money.AddressResponse.<init>(java.util.List):void type: THIS */
