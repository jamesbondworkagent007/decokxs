...
public final /* synthetic */ class KolInfoData$$serializer implements GeneratedSerializer<KolInfoData> {
    public static final int $stable;
    public static final KolInfoData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private KolInfoData$$serializer() {
    }
    ...
    static {
        KolInfoData$$serializer kolInfoData$$serializer = new KolInfoData$$serializer();
        INSTANCE = kolInfoData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.KolInfoData", kolInfoData$$serializer, 14);
    ...
    public final KolInfoData deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new KolInfoData(i, str11, str8, str12, str14, str2, str7, str, str10, str3, str9, str4, str5, str6, str13, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull KolInfoData kolInfoData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(kolInfoData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        KolInfoData.OLrzqt(kolInfoData, compositeEncoderBeginStructure, serialDescriptor);
