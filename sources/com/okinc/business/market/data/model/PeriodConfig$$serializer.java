...
public final /* synthetic */ class PeriodConfig$$serializer implements GeneratedSerializer<PeriodConfig> {
    public static final int $stable;
    public static final PeriodConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PeriodConfig$$serializer() {
    }
    ...
    static {
        PeriodConfig$$serializer periodConfig$$serializer = new PeriodConfig$$serializer();
        INSTANCE = periodConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.PeriodConfig", periodConfig$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("isDefault", true);
        pluginGeneratedSerialDescriptor.addElement("periodContent", true);
    ...
    public final PeriodConfig deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new PeriodConfig(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PeriodConfig periodConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(periodConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PeriodConfig.write$Self$OKDex_dex_impl(periodConfig, compositeEncoderBeginStructure, serialDescriptor);
