...
public final /* synthetic */ class ProtocolInfoData$$serializer implements GeneratedSerializer<ProtocolInfoData> {
    public static final int $stable;
    public static final ProtocolInfoData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ProtocolInfoData$$serializer() {
    }
    ...
    static {
        ProtocolInfoData$$serializer protocolInfoData$$serializer = new ProtocolInfoData$$serializer();
        INSTANCE = protocolInfoData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.data.model.common.ProtocolInfoData", protocolInfoData$$serializer, 9);
        pluginGeneratedSerialDescriptor.addElement("protocolId", true);
        pluginGeneratedSerialDescriptor.addElement("protocolName", true);
        pluginGeneratedSerialDescriptor.addElement("protocolLogo", true);
        pluginGeneratedSerialDescriptor.addElement("protocolGrayLogo", true);
        pluginGeneratedSerialDescriptor.addElement("protocolTagKey", true);
        pluginGeneratedSerialDescriptor.addElement("protocolColorNumber", true);
        pluginGeneratedSerialDescriptor.addElement("protocolGradientColor", true);
        pluginGeneratedSerialDescriptor.addElement("protocolGradientColorUrl", true);
        pluginGeneratedSerialDescriptor.addElement("progressFlag", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = ProtocolInfoData.$childSerializers;
        StringSerializer stringSerializer = StringSerializer.INSTANCE;
        return new KSerializer[]{stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, kSerializerArr[6], stringSerializer, stringSerializer};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final ProtocolInfoData deserialize(@NotNull Decoder decoder) {
        List list;
        ...
        return new ProtocolInfoData(i, str2, str, str6, str5, str3, str4, list, strDecodeStringElement2, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ProtocolInfoData protocolInfoData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(protocolInfoData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ProtocolInfoData.write$Self$OKDex_dex_impl(protocolInfoData, compositeEncoderBeginStructure, serialDescriptor);
