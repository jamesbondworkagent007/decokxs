...
public final class TrackerGroupRepositoryImpl$getTrackerGroups$1 extends ContinuationImpl {
    public int label;
    ...
    public TrackerGroupRepositoryImpl$getTrackerGroups$1(C25650jBg c25650jBg, Continuation<? super TrackerGroupRepositoryImpl$getTrackerGroups$1> continuation) {
        super(continuation);
