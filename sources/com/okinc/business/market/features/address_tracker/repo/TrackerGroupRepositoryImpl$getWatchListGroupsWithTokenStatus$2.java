...
public final class TrackerGroupRepositoryImpl$getWatchListGroupsWithTokenStatus$2 extends SuspendLambda implements Function1<Continuation<? super ResponseData<List<? extends CommonGroupData>>>, Object> {
    ...
    public TrackerGroupRepositoryImpl$getWatchListGroupsWithTokenStatus$2(String str, String str2, String str3, String str4, C25650jBg c25650jBg, Continuation<? super TrackerGroupRepositoryImpl$getWatchListGroupsWithTokenStatus$2> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new TrackerGroupRepositoryImpl$getWatchListGroupsWithTokenStatus$2(this.$accountId, this.$walletAddress, this.$chainId, this.$tokenContractAddress, this.this$0, continuation);
    }
    ...
    public final Object invoke2(Continuation<? super ResponseData<List<CommonGroupData>>> continuation) {
        return ((TrackerGroupRepositoryImpl$getWatchListGroupsWithTokenStatus$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
