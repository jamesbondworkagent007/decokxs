...
public final class TrackerApiKt$selectTrackerGroupApi$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TrackerApiKt$selectTrackerGroupApi$2$1(this.$jwtUseCase, this.$holderAddress, this.$dexId, this.$bundle, this.$getTrackingGroupsListUseCase, this.$getSelectedGroupsUseCase, this.$batchUpdateTrackerGroupUseCase, this.$addressTrackerNotificationUseCase, this.$fragmentManager, this.$collectAddress, this.$context, this.$showToast, this.$callback, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TrackerApiKt$selectTrackerGroupApi$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (bool != null && bool.booleanValue()) {
            ...
            this.label = 2;
            if (jAT.OLrzqt(jal, jak, jaf, c25640jAx, fragmentManager, str2, str3, context, z, (Function1<? super Boolean, Unit>) function1, (Continuation<? super Unit>) this) == objCopydefault) {
                return objCopydefault;
            }
        }
        return Unit.INSTANCE;
