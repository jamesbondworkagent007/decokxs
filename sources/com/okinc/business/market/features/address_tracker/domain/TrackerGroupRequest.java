...
public final class TrackerGroupRequest {
    ...
    public static /* synthetic */ TrackerGroupRequest copy$default(TrackerGroupRequest trackerGroupRequest, String str, String str2, Integer num, TrackerOperationType trackerOperationType, int i, Object obj) {
        ...
        return trackerGroupRequest.copydefault(str, str2, num, trackerOperationType);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final TrackerGroupRequest copydefault(@NotNull String str, String str2, Integer num, @NotNull TrackerOperationType trackerOperationType) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.features.address_tracker.domain.TrackerGroupRequest.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void EZpvd(TrackerGroupRequest trackerGroupRequest, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.business.market.features.address_tracker.domain.TrackerOperationType:?: TERNARY null = ((wrap:int:0x0011: ARITH (r6v0 int) & (8 int) A[WRAPPED]) != (0 int)) ? (wrap:com.okinc.business.market.features.address_tracker.domain.TrackerOperationType:0x0015: SGET  A[WRAPPED] (LINE:25) com.okinc.business.market.features.address_tracker.domain.TrackerOperationType.ADD com.okinc.business.market.features.address_tracker.domain.TrackerOperationType) : (r5v0 com.okinc.business.market.features.address_tracker.domain.TrackerOperationType))
 A[MD:(java.lang.String, java.lang.String, java.lang.Integer, com.okinc.business.market.features.address_tracker.domain.TrackerOperationType):void (m)] (LINE:17) call: com.okinc.business.market.features.address_tracker.domain.TrackerGroupRequest.<init>(java.lang.String, java.lang.String, java.lang.Integer, com.okinc.business.market.features.address_tracker.domain.TrackerOperationType):void type: THIS */
