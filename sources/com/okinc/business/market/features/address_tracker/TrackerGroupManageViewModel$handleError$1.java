...
public final class TrackerGroupManageViewModel$handleError$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public TrackerGroupManageViewModel$handleError$1(Throwable th, TrackerGroupManageViewModel trackerGroupManageViewModel, Continuation<? super TrackerGroupManageViewModel$handleError$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TrackerGroupManageViewModel$handleError$1(this.$error, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TrackerGroupManageViewModel$handleError$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
