package com.okinc.business.market.features.history.repo;
...
/* JADX INFO: renamed from: com.okinc.business.market.features.history.repo.HistoryChangeRepo$load-0E7RQCE$$inlined$dexRunCatching$1, reason: invalid class name */
...
public final class HistoryChangeRepo$load0E7RQCE$$inlined$dexRunCatching$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Pair<? extends List<? extends HistoryChange>, ? extends Boolean>>>, Object> {
    ...
    int label;
    final /* synthetic */ C26252jXo this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HistoryChangeRepo$load0E7RQCE$$inlined$dexRunCatching$1(Continuation continuation, C26252jXo c26252jXo, TokenFilter tokenFilter, String str) {
        super(2, continuation);
        this.this$0 = c26252jXo;
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                HistoryChangeFilterRequest historyChangeFilterRequest = new HistoryChangeFilterRequest(this.this$0.copydefault.KWHzl(this.$tokenFilter$inlined), this.$lastItemId$inlined, (String) null, false, (String) null, 28, (DefaultConstructorMarker) null);
                InterfaceC27595jyE interfaceC27595jyE = this.this$0.AEQbTJ;
                this.label = 1;
                obj = interfaceC27595jyE.copydefault(historyChangeFilterRequest, this);
