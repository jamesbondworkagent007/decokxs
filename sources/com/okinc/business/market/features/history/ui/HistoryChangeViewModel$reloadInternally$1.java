...
public final class HistoryChangeViewModel$reloadInternally$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        C26274jYj c26274jYj;
        Object objM8643invokeBWLJW6A$default;
        Object objCopydefault = C56442yFn.copydefault();
        int i = this.label;
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            if (this.$isFirstPage) {
                c26274jYj = new C26274jYj(false, true, false, false, null, false, 61, null);
            } else {
                c26274jYj = new C26274jYj(false, false, true, false, null, false, 59, null);
            }
            this.this$0.djBIcL.setValue(c26274jYj);
            C26249jXl c26249jXl = this.this$0.iwGUEr;
            String str = this.$lastItemId;
            TokenFilter tokenFilterEZpvd = this.this$0.EZpvd();
            this.label = 1;
            objM8643invokeBWLJW6A$default = C26249jXl.m8643invokeBWLJW6A$default(c26249jXl, str, tokenFilterEZpvd, false, this, 4, null);
            if (objM8643invokeBWLJW6A$default == objCopydefault) {
            ...
            C56391yDq.AEQbTJ(obj);
            objM8643invokeBWLJW6A$default = ((Result) obj).m7386unboximpl();
        }
        HistoryChangeViewModel historyChangeViewModel = this.this$0;
        boolean z = this.$isFirstPage;
        if (Result.m7384isSuccessimpl(objM8643invokeBWLJW6A$default)) {
            historyChangeViewModel.djBIcL.setValue(new C26274jYj(((Boolean) objM8643invokeBWLJW6A$default).booleanValue(), false, false, false, null, false, 62, null));
            if (z) {
                historyChangeViewModel.copydefault(historyChangeViewModel.EZpvd());
            }
        }
        boolean z2 = this.$isFirstPage;
        HistoryChangeViewModel historyChangeViewModel2 = this.this$0;
        Throwable thM7380exceptionOrNullimpl = Result.m7380exceptionOrNullimpl(objM8643invokeBWLJW6A$default);
        if (thM7380exceptionOrNullimpl != null) {
            pUU.KWHzl(thM7380exceptionOrNullimpl);
            if (!z2) {
                historyChangeViewModel2.djBIcL.setValue(new C26274jYj(false, false, false, true, null, false, 55, null));
            } else {
                historyChangeViewModel2.djBIcL.setValue(new C26274jYj(false, false, false, false, thM7380exceptionOrNullimpl, false, 47, null));
            }
        }
