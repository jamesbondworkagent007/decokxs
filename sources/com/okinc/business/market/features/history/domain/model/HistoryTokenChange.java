...
public final class HistoryTokenChange implements Parcelable {
    ...
    public static /* synthetic */ HistoryTokenChange copy$default(HistoryTokenChange historyTokenChange, String str, String str2, String str3, int i, Object obj) {
        if ((i & 1) != 0) {
            str = historyTokenChange.AEQbTJ;
        }
        if ((i & 2) != 0) {
            str2 = historyTokenChange.KWHzl;
        }
        if ((i & 4) != 0) {
            str3 = historyTokenChange.EZpvd;
        }
        return historyTokenChange.EZpvd(str, str2, str3);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final HistoryTokenChange EZpvd(@NotNull String str, @NotNull String str2, @NotNull String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd((Object) this.AEQbTJ, (Object) historyTokenChange.AEQbTJ) && Intrinsics.EZpvd((Object) this.KWHzl, (Object) historyTokenChange.KWHzl) && Intrinsics.EZpvd((Object) this.EZpvd, (Object) historyTokenChange.EZpvd);
    }
    ...
    public String toString() {
        return "HistoryTokenChange(symbol=" + this.AEQbTJ + ", amount=" + this.KWHzl + ", address=" + this.EZpvd + ")";
    }
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.String):void (m)] (LINE:7) call: com.okinc.business.market.features.history.domain.model.HistoryTokenChange.<init>(java.lang.String, java.lang.String, java.lang.String):void type: THIS */
