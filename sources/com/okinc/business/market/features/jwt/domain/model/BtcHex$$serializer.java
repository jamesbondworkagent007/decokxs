...
public final /* synthetic */ class BtcHex$$serializer implements GeneratedSerializer<BtcHex> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.jwt.domain.model.BtcHex", btcHex$$serializer, 3);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull BtcHex btcHex) {
        ...
        BtcHex.write$Self$OKDex_dex_impl(btcHex, compositeEncoderBeginStructure, serialDescriptor);
