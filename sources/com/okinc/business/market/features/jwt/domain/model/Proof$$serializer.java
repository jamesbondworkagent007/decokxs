...
public final /* synthetic */ class Proof$$serializer implements GeneratedSerializer<Proof> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.jwt.domain.model.Proof", proof$$serializer, 4);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Proof proof) {
        ...
        Proof.write$Self$OKDex_dex_impl(proof, compositeEncoderBeginStructure, serialDescriptor);
