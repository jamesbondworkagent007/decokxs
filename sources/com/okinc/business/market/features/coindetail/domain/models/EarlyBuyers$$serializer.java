...
public final /* synthetic */ class EarlyBuyers$$serializer implements GeneratedSerializer<EarlyBuyers> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers", earlyBuyers$$serializer, 5);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull EarlyBuyers earlyBuyers) {
        ...
        EarlyBuyers.write$Self$OKDex_dex_impl(earlyBuyers, compositeEncoderBeginStructure, serialDescriptor);
