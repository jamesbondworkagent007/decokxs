...
public final class SniperHolder {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.market.features.coindetail.domain.models.SniperHolder */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.features.coindetail.domain.models.SniperHolder.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKDex_dex_impl(SniperHolder sniperHolder, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity:?: TERNARY null = ((wrap:int:0x0000: ARITH (r4v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (wrap:com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity:0x0004: SGET  A[WRAPPED] (LINE:15) com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity.HOLD com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity) : (r2v0 com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity))
 ...
 A[MD:(java.lang.String, com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity, java.util.List<com.okinc.business.market.data.model.CompactTagData>):void (m)] (LINE:11) call: com.okinc.business.market.features.coindetail.domain.models.SniperHolder.<init>(java.lang.String, com.okinc.business.market.features.coindetail.ui.snipers.HoldActivity, java.util.List):void type: THIS */
