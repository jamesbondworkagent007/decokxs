...
public final class EarlyBuyersWs {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.features.coindetail.domain.models.EarlyBuyersWs.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKDex_dex_impl(EarlyBuyersWs earlyBuyersWs, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers:?: TERNARY null = ((wrap:int:0x0000: ARITH (r13v0 int) & (1 int) A[WRAPPED]) != (0 int)) ? (wrap:com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers:0x000f: CONSTRUCTOR 
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List, int, kotlin.jvm.internal.DefaultConstructorMarker):void (m), WRAPPED] (LINE:23) call: com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.List, int, kotlin.jvm.internal.DefaultConstructorMarker):void type: CONSTRUCTOR) : (r9v0 com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers))
 ...
 A[MD:(com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers, int, int, int):void (m)] (LINE:22) call: com.okinc.business.market.features.coindetail.domain.models.EarlyBuyersWs.<init>(com.okinc.business.market.features.coindetail.domain.models.EarlyBuyers, int, int, int):void type: THIS */
