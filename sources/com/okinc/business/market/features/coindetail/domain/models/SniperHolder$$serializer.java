...
public final /* synthetic */ class SniperHolder$$serializer implements GeneratedSerializer<SniperHolder> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.coindetail.domain.models.SniperHolder", sniperHolder$$serializer, 3);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SniperHolder sniperHolder) {
        ...
        SniperHolder.write$Self$OKDex_dex_impl(sniperHolder, compositeEncoderBeginStructure, serialDescriptor);
