...
public final class SniperHoldersViewModel$loadData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            jNS jns = this.this$0.KWHzl;
            String str = this.$chainId;
            String str2 = this.$tokenContractAddress;
            this.label = 1;
            obj = jns.KWHzl(str, str2, this);
        ...
        this.this$0.AEQbTJ(this.$chainId, this.$tokenContractAddress);
        if (c26029jPh == null) {
            this.this$0.EZpvd.setValue(InterfaceC26043jPv.Activity.AEQbTJ);
            return Unit.INSTANCE;
        }
        this.this$0.EZpvd.setValue(this.this$0.copydefault(c26029jPh));
        return Unit.INSTANCE;
    }
}
