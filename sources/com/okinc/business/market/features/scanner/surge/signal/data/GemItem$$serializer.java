...
public final /* synthetic */ class GemItem$$serializer implements GeneratedSerializer<GemItem> {
    public static final int $stable;
    public static final GemItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GemItem$$serializer() {
    }
    ...
    static {
        GemItem$$serializer gemItem$$serializer = new GemItem$$serializer();
        INSTANCE = gemItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.scanner.surge.signal.data.GemItem", gemItem$$serializer, 9);
        pluginGeneratedSerialDescriptor.addElement("cid", true);
        pluginGeneratedSerialDescriptor.addElement("ta", true);
        pluginGeneratedSerialDescriptor.addElement("tSym", true);
        pluginGeneratedSerialDescriptor.addElement("tUrl", true);
        pluginGeneratedSerialDescriptor.addElement("gemsType", true);
        pluginGeneratedSerialDescriptor.addElement("t", true);
        pluginGeneratedSerialDescriptor.addElement("mip", true);
        pluginGeneratedSerialDescriptor.addElement("mim", true);
        pluginGeneratedSerialDescriptor.addElement("fst", true);
    ...
    public final GemItem deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new GemItem(i, str9, str7, str5, str6, str8, str4, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GemItem gemItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(gemItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GemItem.AEQbTJ(gemItem, compositeEncoderBeginStructure, serialDescriptor);
