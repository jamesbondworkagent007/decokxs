...
public final class FilterTagRepositoryImpl$getHistoryFilterTags$2 extends SuspendLambda implements Function1<Continuation<? super ResponseData<List<? extends FilterTagData>>>, Object> {
    ...
    public FilterTagRepositoryImpl$getHistoryFilterTags$2(C26212jWb c26212jWb, String str, String str2, String str3, Continuation<? super FilterTagRepositoryImpl$getHistoryFilterTags$2> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new FilterTagRepositoryImpl$getHistoryFilterTags$2(this.this$0, this.$tokenContractAddress, this.$walletAddress, this.$chainId, continuation);
    }
    ...
    public final Object invoke2(Continuation<? super ResponseData<List<FilterTagData>>> continuation) {
        return ((FilterTagRepositoryImpl$getHistoryFilterTags$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC27595jyE.OLrzqt(str, str2, str3, this);
