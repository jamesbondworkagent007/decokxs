...
public final /* synthetic */ class RankInfoData$$serializer implements GeneratedSerializer<RankInfoData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.meme.domain.model.RankInfoData", rankInfoData$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("rankType", true);
        pluginGeneratedSerialDescriptor.addElement("rankName", true);
        pluginGeneratedSerialDescriptor.addElement("pushChannelName", true);
        pluginGeneratedSerialDescriptor.addElement("newTokenPushChannelName", true);
        pluginGeneratedSerialDescriptor.addElement("privatePushChannelName", true);
        pluginGeneratedSerialDescriptor.addElement("maxTokenCount", true);
    ...
    public final RankInfoData deserialize(@NotNull Decoder decoder) {
        ...
        return new RankInfoData(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull RankInfoData rankInfoData) {
        ...
        RankInfoData.write$Self$OKDex_dex_impl(rankInfoData, compositeEncoderBeginStructure, serialDescriptor);
