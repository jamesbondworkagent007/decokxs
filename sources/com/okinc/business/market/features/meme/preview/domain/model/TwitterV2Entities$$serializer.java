...
public final /* synthetic */ class TwitterV2Entities$$serializer implements GeneratedSerializer<TwitterV2Entities> {
    public static final int $stable;
    public static final TwitterV2Entities$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TwitterV2Entities$$serializer() {
    }
    ...
    static {
        TwitterV2Entities$$serializer twitterV2Entities$$serializer = new TwitterV2Entities$$serializer();
        INSTANCE = twitterV2Entities$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.meme.preview.domain.model.TwitterV2Entities", twitterV2Entities$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("cashtags", true);
        pluginGeneratedSerialDescriptor.addElement("hashtags", true);
        pluginGeneratedSerialDescriptor.addElement("urls", true);
        pluginGeneratedSerialDescriptor.addElement("userMentions", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = TwitterV2Entities.$childSerializers;
    ...
    public final TwitterV2Entities deserialize(@NotNull Decoder decoder) {
        int i;
        List list;
        List list2;
        List list3;
        ...
        return new TwitterV2Entities(i, list4, list3, list, list2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TwitterV2Entities twitterV2Entities) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(twitterV2Entities, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TwitterV2Entities.write$Self$OKDex_dex_impl(twitterV2Entities, compositeEncoderBeginStructure, serialDescriptor);
