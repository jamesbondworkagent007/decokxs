...
public final /* synthetic */ class TwitterV2VideoVariant$$serializer implements GeneratedSerializer<TwitterV2VideoVariant> {
    public static final int $stable;
    public static final TwitterV2VideoVariant$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TwitterV2VideoVariant$$serializer() {
    }
    ...
    static {
        TwitterV2VideoVariant$$serializer twitterV2VideoVariant$$serializer = new TwitterV2VideoVariant$$serializer();
        INSTANCE = twitterV2VideoVariant$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.meme.preview.domain.model.TwitterV2VideoVariant", twitterV2VideoVariant$$serializer, 3);
    ...
    public final TwitterV2VideoVariant deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Long l;
        String str2;
        ...
        return new TwitterV2VideoVariant(i, l, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TwitterV2VideoVariant twitterV2VideoVariant) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(twitterV2VideoVariant, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TwitterV2VideoVariant.write$Self$OKDex_dex_impl(twitterV2VideoVariant, compositeEncoderBeginStructure, serialDescriptor);
