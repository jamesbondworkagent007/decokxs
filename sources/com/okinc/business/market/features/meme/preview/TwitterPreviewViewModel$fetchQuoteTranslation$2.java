...
public final class TwitterPreviewViewModel$fetchQuoteTranslation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ InterfaceC28740kgV.TaskDescription $contentState;
    final /* synthetic */ String $mainContentId;
    ...
    public TwitterPreviewViewModel$fetchQuoteTranslation$2(TwitterPreviewViewModel twitterPreviewViewModel, String str, List<String> list, InterfaceC28740kgV.TaskDescription taskDescription, Continuation<? super TwitterPreviewViewModel$fetchQuoteTranslation$2> continuation) {
        super(2, continuation);
        this.this$0 = twitterPreviewViewModel;
        this.$mainContentId = str;
        this.$referencedIds = list;
        this.$contentState = taskDescription;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TwitterPreviewViewModel$fetchQuoteTranslation$2(this.this$0, this.$mainContentId, this.$referencedIds, this.$contentState, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TwitterPreviewViewModel$fetchQuoteTranslation$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            String str = this.$mainContentId;
            List<String> list = this.$referencedIds;
            int iAEQbTJ = this.this$0.AEQbTJ(this.$contentState.copydefault().getNewProxyInstance());
            this.label = 1;
            objAEQbTJ = interfaceC28744kgZ.AEQbTJ(str, list, iAEQbTJ, this);
        ...
        if (abstractC43419rot instanceof AbstractC43419rot.StateListAnimator) {
            ...
            } while (!mutableStateFlow.compareAndSet(value2, c28735kgQ2.EZpvd((63 & 1) != 0 ? c28735kgQ2.gEmmrt : false, (63 & 2) != 0 ? c28735kgQ2.EZpvd : translatedText.length() == 0 ? c28735kgQ2.OLrzqt() : translatedText, (63 & 4) != 0 ? c28735kgQ2.OLrzqt : false, (63 & 8) != 0 ? c28735kgQ2.copydefault : false, (63 & 16) != 0 ? c28735kgQ2.djBIcL : str2.length() > 0, (63 & 32) != 0 ? c28735kgQ2.AhwBna : str2.length() == 0 ? c28735kgQ2.copydefault() : str2, (63 & 64) != 0 ? c28735kgQ2.KWHzl : false, (63 & 128) != 0 ? c28735kgQ2.AEQbTJ : str2.length() == 0)));
        }
        ...
        if (abstractC43419rot instanceof AbstractC43419rot.ActionBar) {
            ...
            } while (!mutableStateFlow2.compareAndSet(value, c28735kgQ.EZpvd((63 & 1) != 0 ? c28735kgQ.gEmmrt : false, (63 & 2) != 0 ? c28735kgQ.EZpvd : null, (63 & 4) != 0 ? c28735kgQ.OLrzqt : false, (63 & 8) != 0 ? c28735kgQ.copydefault : false, (63 & 16) != 0 ? c28735kgQ.djBIcL : false, (63 & 32) != 0 ? c28735kgQ.AhwBna : null, (63 & 64) != 0 ? c28735kgQ.KWHzl : false, (63 & 128) != 0 ? c28735kgQ.AEQbTJ : true)));
        }
