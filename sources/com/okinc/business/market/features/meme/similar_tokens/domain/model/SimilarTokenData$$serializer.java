...
public final /* synthetic */ class SimilarTokenData$$serializer implements GeneratedSerializer<SimilarTokenData> {
    public static final int $stable;
    public static final SimilarTokenData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SimilarTokenData$$serializer() {
    }
    ...
    static {
        SimilarTokenData$$serializer similarTokenData$$serializer = new SimilarTokenData$$serializer();
        INSTANCE = similarTokenData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.meme.similar_tokens.domain.model.SimilarTokenData", similarTokenData$$serializer, 9);
        ...
        pluginGeneratedSerialDescriptor.addElement("lastPricingTransactionTime", true);
    ...
    public final SimilarTokenData deserialize(@NotNull Decoder decoder) {
        ...
        return new SimilarTokenData(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SimilarTokenData similarTokenData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(similarTokenData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SimilarTokenData.write$Self$OKDex_dex_impl(similarTokenData, compositeEncoderBeginStructure, serialDescriptor);
