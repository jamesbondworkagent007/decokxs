...
public final class ChartDetailSubTabName {
    ...
    public static final ChartDetailSubTabName HOLDERS = new ChartDetailSubTabName("HOLDERS", 0, "holders");
    public static final ChartDetailSubTabName TRADER = new ChartDetailSubTabName("TRADER", 1, "trader");
    public static final ChartDetailSubTabName HISTORY_CHANGE = new ChartDetailSubTabName("HISTORY_CHANGE", 2, "history");
    public static final ChartDetailSubTabName LIQUIDITY_CHANGE = new ChartDetailSubTabName("LIQUIDITY_CHANGE", 3, "liquidity change");
    ...
    private static final /* synthetic */ ChartDetailSubTabName[] $values() {
        return new ChartDetailSubTabName[]{HOLDERS, TRADER, HISTORY_CHANGE, LIQUIDITY_CHANGE, MY_POSITION, NONE};
    }
