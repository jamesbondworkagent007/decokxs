...
public final /* synthetic */ class VibesKolData$$serializer implements GeneratedSerializer<VibesKolData> {
    public static final int $stable;
    public static final VibesKolData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private VibesKolData$$serializer() {
    }
    ...
    static {
        VibesKolData$$serializer vibesKolData$$serializer = new VibesKolData$$serializer();
        INSTANCE = vibesKolData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.market.features.vibes.domain.VibesKolData", vibesKolData$$serializer, 16);
        pluginGeneratedSerialDescriptor.addElement("authorId", true);
        pluginGeneratedSerialDescriptor.addElement("kolNickname", true);
        pluginGeneratedSerialDescriptor.addElement("kolHandleId", true);
        pluginGeneratedSerialDescriptor.addElement("kolAvatar", true);
        pluginGeneratedSerialDescriptor.addElement("engagementCount", true);
        pluginGeneratedSerialDescriptor.addElement("engagementCountChangeRate", true);
        pluginGeneratedSerialDescriptor.addElement("impressionsCount", true);
        pluginGeneratedSerialDescriptor.addElement("impressionsCountChangeRate", true);
        pluginGeneratedSerialDescriptor.addElement("mentionsCount", true);
        pluginGeneratedSerialDescriptor.addElement("mentionsCountChangeRate", true);
        pluginGeneratedSerialDescriptor.addElement("followers", true);
        pluginGeneratedSerialDescriptor.addElement("twitterLink", true);
        pluginGeneratedSerialDescriptor.addElement("firstMentionTime", true);
        pluginGeneratedSerialDescriptor.addElement("firstMentionContentId", true);
        pluginGeneratedSerialDescriptor.addElement("firstMentionPrice", true);
        pluginGeneratedSerialDescriptor.addElement("firstMentionMarketCap", true);
    ...
    public final VibesKolData deserialize(@NotNull Decoder decoder) {
        ...
        return new VibesKolData(i, str, str3, str2, str4, str10, strDecodeStringElement2, str9, str8, str11, str7, str6, str13, str5, str12, strDecodeStringElement3, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull VibesKolData vibesKolData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(vibesKolData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        VibesKolData.KWHzl(vibesKolData, compositeEncoderBeginStructure, serialDescriptor);
