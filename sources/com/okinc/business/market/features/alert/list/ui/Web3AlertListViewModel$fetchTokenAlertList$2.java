...
public final class Web3AlertListViewModel$fetchTokenAlertList$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Web3AlertListViewModel$fetchTokenAlertList$2(C25829jHx c25829jHx, String str, String str2, Continuation<? super Web3AlertListViewModel$fetchTokenAlertList$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Web3AlertListViewModel$fetchTokenAlertList$2(this.this$0, this.$currentTokenAddress, this.$currentChainId, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((Web3AlertListViewModel$fetchTokenAlertList$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            AlertListRequest alertListRequest = new AlertListRequest(strCopydefault, this.$currentTokenAddress, this.$currentChainId);
            this.label = 1;
        ...
        if (Result.m7384isSuccessimpl(objKWHzl)) {
            ...
            if (list.isEmpty()) {
                ...
                } while (!mutableStateFlow2.compareAndSet(value2, new InterfaceC25830jHy.ActionBar.AssistContent(list, false)));
            }
        }
