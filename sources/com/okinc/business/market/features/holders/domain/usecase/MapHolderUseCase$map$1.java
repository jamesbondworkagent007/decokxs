...
public final class MapHolderUseCase$map$1 extends ContinuationImpl {
    public int label;
    ...
    public MapHolderUseCase$map$1(jYH jyh, Continuation<? super MapHolderUseCase$map$1> continuation) {
        super(continuation);
        this.this$0 = jyh;
    }
