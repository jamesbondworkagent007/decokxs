...
public final class GetLatestPnLUseCase$subscribeOthersPnl$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public GetLatestPnLUseCase$subscribeOthersPnl$2(C29123knh c29123knh, String str, String str2, Continuation<? super GetLatestPnLUseCase$subscribeOthersPnl$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GetLatestPnLUseCase$subscribeOthersPnl$2(this.this$0, this.$chainId, this.$tokenAddress, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GetLatestPnLUseCase$subscribeOthersPnl$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        FlowCollector flowCollector = new FlowCollector() { // from class: com.okinc.business.market.features.position.domain.GetLatestPnLUseCase$subscribeOthersPnl$2.2
