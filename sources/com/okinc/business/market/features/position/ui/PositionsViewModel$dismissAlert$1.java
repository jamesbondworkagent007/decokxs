...
public final class PositionsViewModel$dismissAlert$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (c29123knh.KWHzl(positionDetailsParam, this) == objCopydefault) {
        ...
        C29123knh c29123knh2 = this.this$0.fIwbmz;
        PositionDetailsParam positionDetailsParam2 = this.this$0.getNewProxyInstance;
        this.L$0 = mutableStateFlow2;
        this.label = 2;
        Object objAEQbTJ = c29123knh2.AEQbTJ(positionDetailsParam2, this);
