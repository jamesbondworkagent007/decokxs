...
public final class OverviewViewModel$getTransactionData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.this$0.OLrzqt.setValue(new C29009klZ(true, false, null, 6, null));
            ...
            this.label = 1;
            objCopydefault = c28986klC.copydefault(tokenContractAddress, chainId, filterTimeDuration, this);
        ...
        if (Result.m7384isSuccessimpl(objCopydefault)) {
            overviewViewModel.OLrzqt.setValue(new C29009klZ(false, false, (TransactionStatistic) objCopydefault, 3, null));
        }
        OverviewViewModel overviewViewModel2 = this.this$0;
        if (Result.m7380exceptionOrNullimpl(objCopydefault) != null) {
            overviewViewModel2.OLrzqt.setValue(new C29009klZ(false, true, null, 5, null));
        }
