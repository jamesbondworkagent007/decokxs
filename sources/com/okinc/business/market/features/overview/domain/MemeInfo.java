...
public final class MemeInfo implements Parcelable {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final MemeInfo EZpvd(@NotNull String str, @NotNull String str2, Float f, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd((Object) this.EZpvd, (Object) memeInfo.EZpvd) && Intrinsics.EZpvd((Object) this.copydefault, (Object) memeInfo.copydefault) && Intrinsics.EZpvd(this.gEmmrt, memeInfo.gEmmrt) && Intrinsics.EZpvd((Object) this.djBIcL, (Object) memeInfo.djBIcL) && Intrinsics.EZpvd((Object) this.KWHzl, (Object) memeInfo.KWHzl) && Intrinsics.EZpvd((Object) this.AEQbTJ, (Object) memeInfo.AEQbTJ) && Intrinsics.EZpvd((Object) this.OLrzqt, (Object) memeInfo.OLrzqt) && Intrinsics.EZpvd((Object) this.valueOf, (Object) memeInfo.valueOf);
    }
    ...
    public int hashCode() {
        ...
        Float f = this.gEmmrt;
        return (((((((((((((iHashCode * 31) + iHashCode2) * 31) + (f == null ? 0 : f.hashCode())) * 31) + this.djBIcL.hashCode()) * 31) + this.KWHzl.hashCode()) * 31) + this.AEQbTJ.hashCode()) * 31) + this.OLrzqt.hashCode()) * 31) + this.valueOf.hashCode();
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public String toString() {
        return "MemeInfo(createTime=" + this.EZpvd + ", creatorAddress=" + this.copydefault + ", progress=" + this.gEmmrt + ", transactions=" + this.djBIcL + ", platformLogo=" + this.KWHzl + ", platformName=" + this.AEQbTJ + ", platformLink=" + this.OLrzqt + ", volume=" + this.valueOf + ")";
    }
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.Float, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String):void (m)] (LINE:44) call: com.okinc.business.market.features.overview.domain.MemeInfo.<init>(java.lang.String, java.lang.String, java.lang.Float, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String):void type: THIS */
