...
public final class MarketInfo implements Parcelable {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final MarketInfo copydefault(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, @NotNull String str8, @NotNull String str9, @NotNull String str10, @NotNull String str11, @NotNull String str12, @NotNull String str13, @NotNull String str14, @NotNull String str15, @NotNull String str16, @NotNull String str17) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd((Object) this.AkhnZx, (Object) marketInfo.AkhnZx) && Intrinsics.EZpvd((Object) this.KWHzl, (Object) marketInfo.KWHzl) && Intrinsics.EZpvd((Object) this.AEQbTJ, (Object) marketInfo.AEQbTJ) && Intrinsics.EZpvd((Object) this.djBIcL, (Object) marketInfo.djBIcL) && Intrinsics.EZpvd((Object) this.fIwbmz, (Object) marketInfo.fIwbmz) && Intrinsics.EZpvd((Object) this.EZpvd, (Object) marketInfo.EZpvd) && Intrinsics.EZpvd((Object) this.gEmmrt, (Object) marketInfo.gEmmrt) && Intrinsics.EZpvd((Object) this.valueOf, (Object) marketInfo.valueOf) && Intrinsics.EZpvd((Object) this.AhwBna, (Object) marketInfo.AhwBna) && Intrinsics.EZpvd((Object) this.AYXKKw, (Object) marketInfo.AYXKKw) && Intrinsics.EZpvd((Object) this.copydefault, (Object) marketInfo.copydefault) && Intrinsics.EZpvd((Object) this.isConnected, (Object) marketInfo.isConnected) && Intrinsics.EZpvd((Object) this.ejfBZ, (Object) marketInfo.ejfBZ) && Intrinsics.EZpvd((Object) this.OLrzqt, (Object) marketInfo.OLrzqt) && Intrinsics.EZpvd((Object) this.fetchVPNInfo, (Object) marketInfo.fetchVPNInfo) && Intrinsics.EZpvd((Object) this.values, (Object) marketInfo.values) && Intrinsics.EZpvd((Object) this.DbNXlk, (Object) marketInfo.DbNXlk);
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public int hashCode() {
        return (((((((((((((((((((((((((((((((this.AkhnZx.hashCode() * 31) + this.KWHzl.hashCode()) * 31) + this.AEQbTJ.hashCode()) * 31) + this.djBIcL.hashCode()) * 31) + this.fIwbmz.hashCode()) * 31) + this.EZpvd.hashCode()) * 31) + this.gEmmrt.hashCode()) * 31) + this.valueOf.hashCode()) * 31) + this.AhwBna.hashCode()) * 31) + this.AYXKKw.hashCode()) * 31) + this.copydefault.hashCode()) * 31) + this.isConnected.hashCode()) * 31) + this.ejfBZ.hashCode()) * 31) + this.OLrzqt.hashCode()) * 31) + this.fetchVPNInfo.hashCode()) * 31) + this.values.hashCode()) * 31) + this.DbNXlk.hashCode();
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public String toString() {
        return "MarketInfo(riskControlLevel=" + this.AkhnZx + ", holders=" + this.KWHzl + ", circulatingSupply=" + this.AEQbTJ + ", maxSupply=" + this.djBIcL + ", totalLiquidity=" + this.fIwbmz + ", marketCap=" + this.EZpvd + ", priceChange24H=" + this.gEmmrt + ", priceChange4H=" + this.valueOf + ", priceChange1H=" + this.AhwBna + ", priceChange5M=" + this.AYXKKw + ", fdv=" + this.copydefault + ", tokenCreateTime=" + this.isConnected + ", tokenCreatorAddress=" + this.ejfBZ + ", lpTokenBurntInfo=" + this.OLrzqt + ", snipersClear=" + this.fetchVPNInfo + ", snipersTotal=" + this.values + ", suspiciousRatio=" + this.DbNXlk + ")";
    }
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String):void (m)] (LINE:71) call: com.okinc.business.market.features.overview.domain.MarketInfo.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String):void type: THIS */
