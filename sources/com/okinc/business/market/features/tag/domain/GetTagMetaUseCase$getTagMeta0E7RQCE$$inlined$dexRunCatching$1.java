...
/* JADX INFO: renamed from: com.okinc.business.market.features.tag.domain.GetTagMetaUseCase$getTagMeta-0E7RQCE$$inlined$dexRunCatching$1, reason: invalid class name */
...
public final class GetTagMetaUseCase$getTagMeta0E7RQCE$$inlined$dexRunCatching$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends TagMeta>>, Object> {
    ...
    public GetTagMetaUseCase$getTagMeta0E7RQCE$$inlined$dexRunCatching$1(Continuation continuation, C29715kyq c29715kyq, boolean z, String str) {
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                if (i != 2) {
                    ...
                    TagMetaData tagMetaData = (TagMetaData) CollectionsKt___CollectionsKt.firstOrNull((List) objEZpvd);
                ...
                this.label = 3;
                objEZpvd = c29710kyl2.EZpvd(listEZpvd, this);
                if (objEZpvd == objCopydefault) {
                    return objCopydefault;
                }
                if (Result.m7380exceptionOrNullimpl(objEZpvd) != null) {
                }
                TagMetaData tagMetaData2 = (TagMetaData) CollectionsKt___CollectionsKt.firstOrNull((List) objEZpvd);
        ...
        this.label = 3;
        objEZpvd = c29710kyl22.EZpvd(listEZpvd2, this);
        if (objEZpvd == objCopydefault) {
        }
        if (Result.m7380exceptionOrNullimpl(objEZpvd) != null) {
        }
        TagMetaData tagMetaData22 = (TagMetaData) CollectionsKt___CollectionsKt.firstOrNull((List) objEZpvd);
