...
public final class GetSignalOverviewListUseCase$subscribeMultipleTokenUpdatesWs$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ List<Pair<String, String>> $validTokens;
    int label;
    final /* synthetic */ C29508kuv this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetSignalOverviewListUseCase$subscribeMultipleTokenUpdatesWs$2(C29508kuv c29508kuv, List<Pair<String, String>> list, Continuation<? super GetSignalOverviewListUseCase$subscribeMultipleTokenUpdatesWs$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GetSignalOverviewListUseCase$subscribeMultipleTokenUpdatesWs$2(this.this$0, this.$validTokens, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GetSignalOverviewListUseCase$subscribeMultipleTokenUpdatesWs$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            List<Pair<String, String>> list = this.$validTokens;
            this.label = 1;
            obj = interfaceC29466kuF.copydefault(list, this);
        ...
        FlowCollector flowCollector = new FlowCollector() { // from class: com.okinc.business.market.features.smart_money.signal.domain.GetSignalOverviewListUseCase$subscribeMultipleTokenUpdatesWs$2.4
            ...
            public final Object emit(CoinRankingWsData coinRankingWsData, Continuation<? super Unit> continuation) {
                ...
                do {
                    ...
                    List<SignalOverviewUiModel> list2 = (List) value;
                    if (list2 != null) {
                        arrayList = new ArrayList(C56403yEb.AYXKKw(list2, 10));
                        for (SignalOverviewUiModel signalOverviewUiModelAEQbTJ : list2) {
