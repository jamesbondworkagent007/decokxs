...
/* JADX INFO: renamed from: com.okinc.business.market.features.smart_money.signal.domain.UpdateSignalAlertsUseCase$addAlert-BWLJW6A$$inlined$dexRunCatching$1, reason: invalid class name */
/* JADX INFO: loaded from: classes7.dex */
public final class UpdateSignalAlertsUseCase$addAlertBWLJW6A$$inlined$dexRunCatching$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Boolean>>, Object> {
    ...
    public UpdateSignalAlertsUseCase$addAlertBWLJW6A$$inlined$dexRunCatching$1(Continuation continuation, C29461kuA c29461kuA, String str, C29463kuC.Application application, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UpdateSignalAlertsUseCase$addAlertBWLJW6A$$inlined$dexRunCatching$1(continuation, this.this$0, this.$walletAddress$inlined, this.$tokenAlert$inlined, this.$chainIdForSignature$inlined);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Result<? extends Boolean>> continuation) {
        return ((UpdateSignalAlertsUseCase$addAlertBWLJW6A$$inlined$dexRunCatching$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            updateSignalAlertsRequestEZpvd = this.this$0.EZpvd(this.$walletAddress$inlined, this.$tokenAlert$inlined, 1);
