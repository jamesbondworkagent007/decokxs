...
public final class SignalAlertViewModel$deleteAlert$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SignalAlertViewModel$deleteAlert$1(SignalAlertViewModel signalAlertViewModel, C29463kuC.Application application, Continuation<? super SignalAlertViewModel$deleteAlert$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SignalAlertViewModel$deleteAlert$1(this.this$0, this.$tokenAlert, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SignalAlertViewModel$deleteAlert$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    this.L$1 = null;
                    this.label = 3;
                    objEZpvd = c29461kuA2.EZpvd(str, jLongValue, application, this);
                    ...
                    if (((Boolean) objEZpvd).booleanValue()) {
                        ...
                        do {
                            ...
                            if (application22 == null) {
                                c29463kuCCopy$default = C29463kuC.copy$default(c29463kuC, false, false, null, 5, null);
                            } else {
                                c29463kuCCopy$default = C29463kuC.copy$default(c29463kuC, false, false, yEJ.EZpvd((Set<? extends C29463kuC.Application>) ((Set<? extends Object>) c29463kuC.AEQbTJ()), application22), 3, null);
                            }
                        ...
                        Integer numAEQbTJ = C56443yFo.AEQbTJ(application22 == null ? C23274hvD.Fragment.call : C23274hvD.Fragment.spnCvw);
                        this.L$0 = objEZpvd;
                        this.label = 4;
        ...
        this.L$1 = str3;
        this.label = 2;
        Object objEZpvd2 = signalAlertViewModel3.EZpvd((Continuation<? super Long>) this);
        ...
        this.L$1 = null;
        this.label = 3;
        objEZpvd = c29461kuA2.EZpvd(str, jLongValue2, application3, this);
        if (objEZpvd == objCopydefault) {
        }
