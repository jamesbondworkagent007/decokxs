...
public final class SignalAlertViewModel$generateSignMessage$1 extends ContinuationImpl {
    Object L$0;
    int label;
    ...
    public SignalAlertViewModel$generateSignMessage$1(SignalAlertViewModel signalAlertViewModel, Continuation<? super SignalAlertViewModel$generateSignMessage$1> continuation) {
        super(continuation);
