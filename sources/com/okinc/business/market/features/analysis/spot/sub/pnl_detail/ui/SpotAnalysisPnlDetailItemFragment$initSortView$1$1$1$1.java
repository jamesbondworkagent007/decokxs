...
public final class SpotAnalysisPnlDetailItemFragment$initSortView$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SpotAnalysisPnlDetailItemFragment$initSortView$1$1$1$1(jMM jmm, OKSortTextView.SortType sortType, Continuation<? super SpotAnalysisPnlDetailItemFragment$initSortView$1$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SpotAnalysisPnlDetailItemFragment$initSortView$1$1$1$1(this.this$0, this.$sortType, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SpotAnalysisPnlDetailItemFragment$initSortView$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            int i2 = StateListAnimator.KWHzl[this.$sortType.ordinal()];
            if (i2 == 1) {
                pnlDetailListSortType = PnlDetailListSortType.NAME_ASC;
            } else if (i2 == 2) {
                pnlDetailListSortType = PnlDetailListSortType.NAME_DESC;
            } else {
                if (i2 != 3) {
