...
public final class FuturesAnalysisOverviewFragment$setListener$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ jKQ this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FuturesAnalysisOverviewFragment$setListener$5(jKQ jkq, Continuation<? super FuturesAnalysisOverviewFragment$setListener$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FuturesAnalysisOverviewFragment$setListener$5(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FuturesAnalysisOverviewFragment$setListener$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(jkq, null);
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(jkq, state, anonymousClass1, this) == objCopydefault) {
    ...
    /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.overview.ui.FuturesAnalysisOverviewFragment$setListener$5$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(jKQ jkq, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.this$0 = jkq;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                C56391yDq.AEQbTJ(obj);
                StateFlow<ValuationCurrency> stateFlowOLrzqt = this.this$0.gEmmrt().AEQbTJ().OLrzqt();
                jKQ jkq = this.this$0;
                Flow flowDistinctUntilChanged = FlowKt.distinctUntilChanged(FlowKt.combine(stateFlowOLrzqt, jkq.KWHzl(jkq.gEmmrt(), new MutablePropertyReference1Impl() { // from class: com.okinc.business.market.features.analysis.futures.sub.overview.ui.FuturesAnalysisOverviewFragment.setListener.5.1.1
                ...
                }), new AnonymousClass2(null)), new Function2() { // from class: o.jKW
                    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                    @Override // kotlin.jvm.functions.Function2
                    public final java.lang.Object invoke(java.lang.Object obj2, java.lang.Object obj3) {
                        return java.lang.Boolean.valueOf(FuturesAnalysisOverviewFragment$setListener$5.AnonymousClass1.invokeSuspend$lambda$0((kotlin.Pair) obj2, (kotlin.Pair) obj3));
                    }
                });
        ...
        /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.overview.ui.FuturesAnalysisOverviewFragment$setListener$5$1$2, reason: invalid class name */
        ...
        /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.overview.ui.FuturesAnalysisOverviewFragment$setListener$5$1$4, reason: invalid class name */
        public static final class AnonymousClass4 extends SuspendLambda implements Function2<Pair<? extends ValuationCurrency, ? extends String>, Continuation<? super Unit>, Object> {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public AnonymousClass4(jKQ jkq, Continuation<? super AnonymousClass4> continuation) {
                super(2, continuation);
                this.this$0 = jkq;
            }
