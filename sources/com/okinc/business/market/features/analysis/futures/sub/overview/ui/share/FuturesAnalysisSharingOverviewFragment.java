...
public final class FuturesAnalysisSharingOverviewFragment extends jIJ<C42903rfG> {
    public static final int $stable = 0;

    public static final /* synthetic */ C42903rfG access$getContentBinding(FuturesAnalysisSharingOverviewFragment futuresAnalysisSharingOverviewFragment) {
        return futuresAnalysisSharingOverviewFragment.getContentBinding();
    }
    ...
    /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.overview.ui.share.FuturesAnalysisSharingOverviewFragment$setListener$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return FuturesAnalysisSharingOverviewFragment.this.new AnonymousClass1(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                FuturesAnalysisSharingOverviewFragment futuresAnalysisSharingOverviewFragment = FuturesAnalysisSharingOverviewFragment.this;
                futuresAnalysisSharingOverviewFragment.collectLatestOnLifecycle(futuresAnalysisSharingOverviewFragment.getViewModel(), new MutablePropertyReference1Impl() { // from class: com.okinc.business.market.features.analysis.futures.sub.overview.ui.share.FuturesAnalysisSharingOverviewFragment.setListener.1.1
                ...
                }, Lifecycle.State.CREATED, new AnonymousClass2(FuturesAnalysisSharingOverviewFragment.this, null));
                return Unit.INSTANCE;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }

        /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.overview.ui.share.FuturesAnalysisSharingOverviewFragment$setListener$1$2, reason: invalid class name */
        public static final class AnonymousClass2 extends SuspendLambda implements Function2<InterfaceC49371unL<? extends C25915jLb>, Continuation<? super Unit>, Object> {
            ...
            int label;
            final /* synthetic */ FuturesAnalysisSharingOverviewFragment this$0;

            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public AnonymousClass2(FuturesAnalysisSharingOverviewFragment futuresAnalysisSharingOverviewFragment, Continuation<? super AnonymousClass2> continuation) {
                super(2, continuation);
                this.this$0 = futuresAnalysisSharingOverviewFragment;
            }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (this.label == 0) {
                    ...
                    FuturesAnalysisSharingOverviewFragment futuresAnalysisSharingOverviewFragment = this.this$0;
                    futuresAnalysisSharingOverviewFragment.updateOverviewUiState(FuturesAnalysisSharingOverviewFragment.access$getContentBinding(futuresAnalysisSharingOverviewFragment), interfaceC49371unL);
                    return Unit.INSTANCE;
                }
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
