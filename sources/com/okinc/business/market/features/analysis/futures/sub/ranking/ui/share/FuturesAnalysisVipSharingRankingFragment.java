...
public final class FuturesAnalysisVipSharingRankingFragment extends jIJ<C42905rfI> {
    private static final int MAX_COUNT = 3;
    private static final ActionBar Companion = new ActionBar(null);
    public static final int $stable = 8;
    private final boolean isVip = true;
    private final InterfaceC56387yDm adapter$delegate = C56392yDr.copydefault(new Function0() { // from class: o.jLA
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        @Override // kotlin.jvm.functions.Function0
        public final java.lang.Object invoke() {
            return FuturesAnalysisVipSharingRankingFragment.adapter_delegate$lambda$3(this.OLrzqt);
        }
    });
    ...
    public static final /* synthetic */ C42905rfI access$getContentBinding(FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment) {
        return futuresAnalysisVipSharingRankingFragment.getContentBinding();
    }

    public static final class ActionBar {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.market.features.analysis.futures.sub.ranking.ui.share.FuturesAnalysisVipSharingRankingFragment.ActionBar.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final C25932jLs adapter_delegate$lambda$3(final FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment) {
        return new C25932jLs(new Function1() { // from class: o.jLD
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj) {
                return FuturesAnalysisVipSharingRankingFragment.adapter_delegate$lambda$3$lambda$0(this.AEQbTJ, (android.view.ViewGroup) obj);
            }
        }, new Function1() { // from class: o.jLB
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj) {
                return FuturesAnalysisVipSharingRankingFragment.adapter_delegate$lambda$3$lambda$2((ViewBinding) obj);
            }
        }, false, true, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ViewBinding adapter_delegate$lambda$3$lambda$0(FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment, ViewGroup viewGroup) {
        Intrinsics.checkNotNullParameter(viewGroup, "");
        C42874ree c42874reeAEQbTJ = C42874ree.AEQbTJ(futuresAnalysisVipSharingRankingFragment.getLayoutInflater(), viewGroup, false);
    ...
    public C42905rfI onBindContent(@NotNull ViewGroup viewGroup) {
        ...
        int i = StateListAnimator.EZpvd[getViewModel().valueOf().ordinal()];
        if (i == 1) {
    ...
    private static final void onBindContent$lambda$4$setTitle(C42905rfI c42905rfI, FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment, @PluralsRes int i, @StringRes int i2) {
        String strEZpvd;
        AppCompatTextView appCompatTextView = c42905rfI.AEQbTJ;
        int num = futuresAnalysisVipSharingRankingFragment.getViewModel().copydefault().getNum();
        if (num == FuturesAnalysisRankingPeriod.PERIOD_ALL.getNum()) {
            strEZpvd = C33070mpX.AYXKKw(i2);
        } else {
            Context context = futuresAnalysisVipSharingRankingFragment.getContext();
    ...
    /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.ranking.ui.share.FuturesAnalysisVipSharingRankingFragment$setListener$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return FuturesAnalysisVipSharingRankingFragment.this.new AnonymousClass1(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment = FuturesAnalysisVipSharingRankingFragment.this;
                futuresAnalysisVipSharingRankingFragment.collectLatestOnLifecycle(futuresAnalysisVipSharingRankingFragment.getViewModel(), new MutablePropertyReference1Impl() { // from class: com.okinc.business.market.features.analysis.futures.sub.ranking.ui.share.FuturesAnalysisVipSharingRankingFragment.setListener.1.1
                ...
                }, Lifecycle.State.CREATED, new AnonymousClass2(FuturesAnalysisVipSharingRankingFragment.this, null));
                return Unit.INSTANCE;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }

        /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.ranking.ui.share.FuturesAnalysisVipSharingRankingFragment$setListener$1$2, reason: invalid class name */
        public static final class AnonymousClass2 extends SuspendLambda implements Function2<InterfaceC49371unL<? extends List<? extends C25937jLx>>, Continuation<? super Unit>, Object> {
            ...
            int label;
            final /* synthetic */ FuturesAnalysisVipSharingRankingFragment this$0;

            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public AnonymousClass2(FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment, Continuation<? super AnonymousClass2> continuation) {
                super(2, continuation);
                this.this$0 = futuresAnalysisVipSharingRankingFragment;
            }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (this.label == 0) {
                    ...
                    if (listAhwBna == null || listAhwBna.isEmpty()) {
                        FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment = this.this$0;
                        futuresAnalysisVipSharingRankingFragment.showContentEmpty(FuturesAnalysisVipSharingRankingFragment.access$getContentBinding(futuresAnalysisVipSharingRankingFragment));
                    } else {
                        ...
                        FuturesAnalysisVipSharingRankingFragment futuresAnalysisVipSharingRankingFragment2 = this.this$0;
                        futuresAnalysisVipSharingRankingFragment2.showContentList(FuturesAnalysisVipSharingRankingFragment.access$getContentBinding(futuresAnalysisVipSharingRankingFragment2), arrayList2);
                    }
