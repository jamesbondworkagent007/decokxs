...
public final class FuturesAnalysisSharingCalendarFragment extends jIJ<C42901rfE> {
    public static final int $stable = 0;

    public static final /* synthetic */ C42901rfE access$getContentBinding(FuturesAnalysisSharingCalendarFragment futuresAnalysisSharingCalendarFragment) {
        return futuresAnalysisSharingCalendarFragment.getContentBinding();
    }
    ...
    /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.calendar.ui.share.FuturesAnalysisSharingCalendarFragment$setListener$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return FuturesAnalysisSharingCalendarFragment.this.new AnonymousClass1(continuation);
        }
        ...
        /* JADX INFO: renamed from: com.okinc.business.market.features.analysis.futures.sub.calendar.ui.share.FuturesAnalysisSharingCalendarFragment$setListener$1$1, reason: invalid class name and collision with other inner class name */
        public static final class C03471 extends SuspendLambda implements Function2<FuturesAnalysisViewModel.StateListAnimator, Continuation<? super Unit>, Object> {
            ...
            public C03471(FuturesAnalysisSharingCalendarFragment futuresAnalysisSharingCalendarFragment, Continuation<? super C03471> continuation) {
                super(2, continuation);
            ...
            public final Object invoke(FuturesAnalysisViewModel.StateListAnimator stateListAnimator, Continuation<? super Unit> continuation) {
                return ((C03471) create(stateListAnimator, continuation)).invokeSuspend(Unit.INSTANCE);
            }

            /* JADX DEBUG: Class process forced to load method for inline: o.jIJ.showEmpty$default(o.jIJ, boolean, int, int, java.lang.Object):void */
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    if (stateListAnimator.KWHzl() instanceof InterfaceC49371unL.Activity) {
                        Group group = FuturesAnalysisSharingCalendarFragment.access$getContentBinding(this.this$0).EZpvd;
                        Intrinsics.checkNotNullExpressionValue(group, "");
                        group.setVisibility(0);
                        jIJ.showEmpty$default(this.this$0, false, 0, 2, null);
                        Calendar calendar = Calendar.getInstance();
                        calendar.setTime(this.this$0.getViewModel().EZpvd());
                        qYH qyh = FuturesAnalysisSharingCalendarFragment.access$getContentBinding(this.this$0).KWHzl;
                        ...
                        FuturesAnalysisSharingCalendarFragment$setListener$1$1$dayItemExtras$1 futuresAnalysisSharingCalendarFragment$setListener$1$1$dayItemExtras$1 = new FuturesAnalysisSharingCalendarFragment$setListener$1$1$dayItemExtras$1(c25876jJq, this.this$0, null);
                        this.L$0 = stateListAnimator;
                        this.L$1 = c25876jJq;
                        this.label = 1;
                        Object objWithContext = BuildersKt.withContext(coroutineDispatcher, futuresAnalysisSharingCalendarFragment$setListener$1$1$dayItemExtras$1, this);
                        ...
                        Group group2 = FuturesAnalysisSharingCalendarFragment.access$getContentBinding(this.this$0).EZpvd;
                ...
                FuturesAnalysisSharingCalendarFragment.access$getContentBinding(this.this$0).KWHzl.setMonthExtra(c25876jJq2.copydefault(), (List) obj);
                if (this.this$0.getContext() != null) {
                    C42901rfE c42901rfEAccess$getContentBinding = FuturesAnalysisSharingCalendarFragment.access$getContentBinding(this.this$0);
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                C56391yDq.AEQbTJ(obj);
                FuturesAnalysisSharingCalendarFragment futuresAnalysisSharingCalendarFragment = FuturesAnalysisSharingCalendarFragment.this;
                futuresAnalysisSharingCalendarFragment.collectLatestOnLifecycle(futuresAnalysisSharingCalendarFragment.getViewModel(), Lifecycle.State.CREATED, new C03471(FuturesAnalysisSharingCalendarFragment.this, null));
                return Unit.INSTANCE;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
