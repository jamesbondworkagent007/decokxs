...
public final class FutureAnalysisCoinPairDialogFragment$initListener$2$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    public FutureAnalysisCoinPairDialogFragment$initListener$2$1$1(C25881jJv c25881jJv, Continuation<? super FutureAnalysisCoinPairDialogFragment$initListener$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FutureAnalysisCoinPairDialogFragment$initListener$2$1$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FutureAnalysisCoinPairDialogFragment$initListener$2$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
