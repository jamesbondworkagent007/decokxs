...
public final class WatchListChildViewModel$data$2 extends SuspendLambda implements yHO<List<? extends Pair<? extends CoinQuote, ? extends MarketDataSource>>, String, Continuation<? super ArrayList<Pair<? extends CoinQuote, ? extends MarketDataSource>>>, Object> {
    /* synthetic */ Object L$0;
    /* synthetic */ Object L$1;
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public WatchListChildViewModel$data$2(Continuation<? super WatchListChildViewModel$data$2> continuation) {
    ...
    public final Object invoke2(List<? extends Pair<CoinQuote, ? extends MarketDataSource>> list, String str, Continuation<? super ArrayList<Pair<CoinQuote, MarketDataSource>>> continuation) {
        WatchListChildViewModel$data$2 watchListChildViewModel$data$2 = new WatchListChildViewModel$data$2(continuation);
        watchListChildViewModel$data$2.L$0 = list;
        watchListChildViewModel$data$2.L$1 = str;
        return watchListChildViewModel$data$2.invokeSuspend(Unit.INSTANCE);
    }
