...
public final class MarketConfigUseCase$isExpandV2DataSupportedChain$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    ...
    public MarketConfigUseCase$isExpandV2DataSupportedChain$2(C27633jyq c27633jyq, String str, Continuation<? super MarketConfigUseCase$isExpandV2DataSupportedChain$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC27636jyt.copydefault(false, (Continuation<? super MarketConfigData>) this);
        ...
        return C56443yFo.KWHzl(((MarketConfigData) obj).AEQbTJ().KWHzl().contains(this.$chainId));
    }
}
