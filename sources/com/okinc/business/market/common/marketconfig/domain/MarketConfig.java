...
public final class MarketConfig implements Parcelable {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.market.common.marketconfig.domain.MarketConfig */
    ...
    public static /* synthetic */ MarketConfig copy$default(MarketConfig marketConfig, List list, BannerConfig bannerConfig, List list2, List list3, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            list2 = marketConfig.copydefault;
        }
        if ((i & 8) != 0) {
            list3 = marketConfig.EZpvd;
        }
        return marketConfig.copydefault(list, bannerConfig, list2, list3);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final BannerConfig AEQbTJ() {
        return this.KWHzl;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final MarketConfig copydefault(@NotNull List<String> list, BannerConfig bannerConfig, @NotNull List<String> list2, @NotNull List<String> list3) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.EZpvd(this.AEQbTJ, marketConfig.AEQbTJ) && Intrinsics.EZpvd(this.KWHzl, marketConfig.KWHzl) && Intrinsics.EZpvd(this.copydefault, marketConfig.copydefault) && Intrinsics.EZpvd(this.EZpvd, marketConfig.EZpvd);
    }
    ...
    public int hashCode() {
        ...
        return (((((iHashCode * 31) + (bannerConfig == null ? 0 : bannerConfig.hashCode())) * 31) + this.copydefault.hashCode()) * 31) + this.EZpvd.hashCode();
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public String toString() {
        return "MarketConfig(supportChainsHolderDesc=" + this.AEQbTJ + ", bannerConfig=" + this.KWHzl + ", expandV2DataSupportedChains=" + this.copydefault + ", supportRugPull=" + this.EZpvd + ")";
    }
  ...
  (wrap:com.okinc.business.market.common.marketconfig.domain.BannerConfig:?: TERNARY null = ((wrap:int:0x0008: ARITH (r5v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (null com.okinc.business.market.common.marketconfig.domain.BannerConfig) : (r2v0 com.okinc.business.market.common.marketconfig.domain.BannerConfig))
 ...
 A[MD:(java.util.List<java.lang.String>, com.okinc.business.market.common.marketconfig.domain.BannerConfig, java.util.List<java.lang.String>, java.util.List<java.lang.String>):void (m)] (LINE:7) call: com.okinc.business.market.common.marketconfig.domain.MarketConfig.<init>(java.util.List, com.okinc.business.market.common.marketconfig.domain.BannerConfig, java.util.List, java.util.List):void type: THIS */
