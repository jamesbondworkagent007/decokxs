...
public final class OrderPagerViewModel$cancelOrders$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public OrderPagerViewModel$cancelOrders$1(OrderPagerViewModel orderPagerViewModel, List<String> list, Continuation<? super OrderPagerViewModel$cancelOrders$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OrderPagerViewModel$cancelOrders$1(this.this$0, this.$orderIdList, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OrderPagerViewModel$cancelOrders$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (thM7380exceptionOrNullimpl != null) {
            pUU.AEQbTJ("OrderPagerViewModel", "cancelOrders failed " + CollectionsKt___CollectionsKt.joinToString$default(list2, ",", null, null, 0, null, null, 62, null), thM7380exceptionOrNullimpl);
            MutableSharedFlow mutableSharedFlow = orderPagerViewModel.copydefault;
