...
public final class OrderPagerViewModel$loadMoreHistoryOrderList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ OrderPagerViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OrderPagerViewModel$loadMoreHistoryOrderList$1(OrderPagerViewModel orderPagerViewModel, Continuation<? super OrderPagerViewModel$loadMoreHistoryOrderList$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OrderPagerViewModel$loadMoreHistoryOrderList$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OrderPagerViewModel$loadMoreHistoryOrderList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C20071gZv c20071gZv = new C20071gZv(str, orderSubStatusAYXKKw, null, types, defiChainInfoGEmmrt != null ? defiChainInfoGEmmrt.getChainId() : null, null, 20, 36, null);
            this.label = 1;
            obj = gzb.copydefault(c20071gZv, this);
        ...
        if (abstractC43419rot instanceof AbstractC43419rot.StateListAnimator) {
            ...
            while (it.hasNext()) {
                arrayList.add(C20064gZo.Companion.KWHzl((HistoryOrderData) it.next()));
            }
            list.addAll(arrayList);
            orderPagerViewModel.EZpvd((List<? extends Object>) orderPagerViewModel.AYXKKw.AEQbTJ(list), orderListPagerResult.getHasNext());
        }
        ...
        if (abstractC43419rot instanceof AbstractC43419rot.ActionBar) {
            ...
            if ((exc instanceof WalletJwtException) || ((exc instanceof OKServerException) && (((OKServerException) exc).getOrigin() instanceof WalletJwtException))) {
