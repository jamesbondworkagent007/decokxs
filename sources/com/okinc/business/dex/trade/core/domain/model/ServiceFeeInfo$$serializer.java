...
public final /* synthetic */ class ServiceFeeInfo$$serializer implements GeneratedSerializer<ServiceFeeInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dex.trade.core.domain.model.ServiceFeeInfo", serviceFeeInfo$$serializer, 10);
    ...
    public final ServiceFeeInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new ServiceFeeInfo(i, str10, str6, str, str5, str7, str9, str8, str4, str2, str3, (SerializationConstructorMarker) null);
    }
