...
public final /* synthetic */ class LiquidityConfig$$serializer implements GeneratedSerializer<LiquidityConfig> {
    public static final int $stable;
    public static final LiquidityConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LiquidityConfig$$serializer() {
    }
    ...
    static {
        LiquidityConfig$$serializer liquidityConfig$$serializer = new LiquidityConfig$$serializer();
        INSTANCE = liquidityConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dex.trade.core.domain.model.common.LiquidityConfig", liquidityConfig$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("excludedDexIds", true);
        pluginGeneratedSerialDescriptor.addElement("excludedDefiPlatformIds", true);
    ...
    public final LiquidityConfig deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new LiquidityConfig(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LiquidityConfig liquidityConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(liquidityConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LiquidityConfig.write$Self$OKDex_dex_impl(liquidityConfig, compositeEncoderBeginStructure, serialDescriptor);
