...
public final class CopyTradingStrategiesVM$updateStrategyStatus$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CopyTradingStrategiesVM$updateStrategyStatus$1(CopyTradingStrategiesVM copyTradingStrategiesVM, boolean z, Triple<String, String, String> triple, Continuation<? super CopyTradingStrategiesVM$updateStrategyStatus$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CopyTradingStrategiesVM$updateStrategyStatus$1(this.this$0, this.$active, this.$idTitleChain, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CopyTradingStrategiesVM$updateStrategyStatus$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                ...
                if (Result.m7384isSuccessimpl(objOLrzqt)) {
                    ...
                    MutableStateFlow mutableStateFlow = copyTradingStrategiesVM.EZpvd;
                    if (iIntValue == 0) {
                ...
                if (thM7380exceptionOrNullimpl != null) {
                    ...
                    MutableStateFlow mutableStateFlow2 = copyTradingStrategiesVM2.EZpvd;
        ...
        gLQ glq = (gLQ) obj;
        if (!this.$active || glq == null || this.this$0.copydefault(glq)) {
            C20013gXr c20013gXr = this.this$0.AkhnZx;
