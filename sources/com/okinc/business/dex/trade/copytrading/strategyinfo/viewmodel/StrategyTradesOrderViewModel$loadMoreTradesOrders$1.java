...
public final class StrategyTradesOrderViewModel$loadMoreTradesOrders$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ StrategyTradesOrderViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StrategyTradesOrderViewModel$loadMoreTradesOrders$1(StrategyTradesOrderViewModel strategyTradesOrderViewModel, Continuation<? super StrategyTradesOrderViewModel$loadMoreTradesOrders$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StrategyTradesOrderViewModel$loadMoreTradesOrders$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StrategyTradesOrderViewModel$loadMoreTradesOrders$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (Result.m7384isSuccessimpl(objM8610invokeBWLJW6A$default)) {
            ...
            InterfaceC20068gZs.StateListAnimator stateListAnimatorKWHzl = strategyTradesOrderViewModel.KWHzl();
            if ((stateListAnimatorKWHzl != null ? stateListAnimatorKWHzl.EZpvd() : null) != null) {
                strategyTradesOrderViewModel.OLrzqt = orderListPagerResult.getCursor();
                InterfaceC20068gZs.StateListAnimator stateListAnimatorKWHzl2 = strategyTradesOrderViewModel.KWHzl();
                List listFJNWhG = (stateListAnimatorKWHzl2 == null || (listEZpvd = stateListAnimatorKWHzl2.EZpvd()) == null) ? null : CollectionsKt___CollectionsKt.fJNWhG((Collection) listEZpvd);
                ...
                if (list != null) {
                    ...
                    strategyTradesOrderViewModel.AEQbTJ().setValue(new InterfaceC20068gZs.StateListAnimator(strategyTradesOrderViewModel.EZpvd.AEQbTJ(list), orderListPagerResult.getHasNext(), null, 4, null));
                }
            } else {
                strategyTradesOrderViewModel.AEQbTJ().setValue(InterfaceC20068gZs.Fragment.KWHzl);
            }
        }
        ...
        if (Result.m7380exceptionOrNullimpl(objM8610invokeBWLJW6A$default) != null) {
            strategyTradesOrderViewModel2.AEQbTJ().setValue(InterfaceC20068gZs.Fragment.KWHzl);
        }
