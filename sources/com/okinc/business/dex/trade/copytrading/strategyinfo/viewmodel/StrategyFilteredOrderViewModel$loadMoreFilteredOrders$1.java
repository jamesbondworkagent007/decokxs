...
public final class StrategyFilteredOrderViewModel$loadMoreFilteredOrders$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ StrategyFilteredOrderViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StrategyFilteredOrderViewModel$loadMoreFilteredOrders$1(StrategyFilteredOrderViewModel strategyFilteredOrderViewModel, Continuation<? super StrategyFilteredOrderViewModel$loadMoreFilteredOrders$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StrategyFilteredOrderViewModel$loadMoreFilteredOrders$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StrategyFilteredOrderViewModel$loadMoreFilteredOrders$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (Result.m7384isSuccessimpl(objM8608invokeBWLJW6A$default)) {
            ...
            InterfaceC20068gZs.StateListAnimator stateListAnimatorCopydefault = strategyFilteredOrderViewModel.copydefault();
            List<Object> listEZpvd = stateListAnimatorCopydefault != null ? stateListAnimatorCopydefault.EZpvd() : null;
            if (listEZpvd != null) {
                ...
                mutableStateFlowKWHzl.setValue(new InterfaceC20068gZs.StateListAnimator(CollectionsKt___CollectionsKt.djBIcL((Collection) listEZpvd, (Iterable) strategyFilteredOrderViewModel.AEQbTJ.AEQbTJ(arrayList)), orderListPagerResult.getHasNext(), null, 4, null));
            } else {
                strategyFilteredOrderViewModel.KWHzl().setValue(InterfaceC20068gZs.Fragment.KWHzl);
            }
        }
        StrategyFilteredOrderViewModel strategyFilteredOrderViewModel2 = this.this$0;
        if (Result.m7380exceptionOrNullimpl(objM8608invokeBWLJW6A$default) != null) {
            strategyFilteredOrderViewModel2.KWHzl().setValue(InterfaceC20068gZs.Fragment.KWHzl);
        }
