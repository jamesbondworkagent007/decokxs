...
public final class StrategyOpenOrderViewModel$loadMoreOpenOrders$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ StrategyOpenOrderViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StrategyOpenOrderViewModel$loadMoreOpenOrders$1(StrategyOpenOrderViewModel strategyOpenOrderViewModel, Continuation<? super StrategyOpenOrderViewModel$loadMoreOpenOrders$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StrategyOpenOrderViewModel$loadMoreOpenOrders$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StrategyOpenOrderViewModel$loadMoreOpenOrders$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            boolean z = this.this$0.AYXKKw;
            String str2 = this.this$0.gEmmrt;
            this.label = 1;
            objM8609invokeyxL6bBk$default = C20010gXo.m8609invokeyxL6bBk$default(c20010gXo, str, z, str2, 0, this, 8, null);
        ...
        if (Result.m7384isSuccessimpl(objM8609invokeyxL6bBk$default)) {
            ...
            InterfaceC20068gZs.StateListAnimator stateListAnimatorOLrzqt = strategyOpenOrderViewModel.OLrzqt();
            List<Object> listEZpvd = stateListAnimatorOLrzqt != null ? stateListAnimatorOLrzqt.EZpvd() : null;
            List<Object> list = listEZpvd instanceof List ? listEZpvd : null;
            if (list != null) {
                ...
                mutableStateFlowValueOf.setValue(new InterfaceC20068gZs.StateListAnimator(strategyOpenOrderViewModel.OLrzqt.AEQbTJ(CollectionsKt___CollectionsKt.djBIcL((Collection) list, (Iterable) arrayList)), orderListPagerResult.getHasNext(), null, 4, null));
            } else {
                strategyOpenOrderViewModel.valueOf().setValue(InterfaceC20068gZs.Fragment.KWHzl);
            }
        }
        StrategyOpenOrderViewModel strategyOpenOrderViewModel2 = this.this$0;
        if (Result.m7380exceptionOrNullimpl(objM8609invokeyxL6bBk$default) != null) {
            strategyOpenOrderViewModel2.valueOf().setValue(InterfaceC20068gZs.Fragment.KWHzl);
        }
