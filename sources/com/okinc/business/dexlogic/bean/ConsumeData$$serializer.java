...
public final /* synthetic */ class ConsumeData$$serializer<T> implements GeneratedSerializer<ConsumeData<T>> {
    ...
    private ConsumeData$$serializer() {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.bean.ConsumeData", this, 2);
    ...
    public ConsumeData$$serializer(@NotNull KSerializer<T> kSerializer) {
        this();
    ...
    public final ConsumeData<T> deserialize(@NotNull Decoder decoder) {
        ...
        return new ConsumeData<>(i, objDecodeSerializableElement, zDecodeBooleanElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConsumeData<T> consumeData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(consumeData, "");
        SerialDescriptor serialDescriptor = this.descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConsumeData.write$Self$OKDex_dex_impl(consumeData, compositeEncoderBeginStructure, serialDescriptor, this.typeSerial0);
