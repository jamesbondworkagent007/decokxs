...
public final /* synthetic */ class RepeatOrderRequest$$serializer implements GeneratedSerializer<RepeatOrderRequest> {
    public static final int $stable;
    public static final RepeatOrderRequest$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RepeatOrderRequest$$serializer() {
    }
    ...
    static {
        RepeatOrderRequest$$serializer repeatOrderRequest$$serializer = new RepeatOrderRequest$$serializer();
        INSTANCE = repeatOrderRequest$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.bean.RepeatOrderRequest", repeatOrderRequest$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("fromSwapFeeUsd", false);
    ...
    public final RepeatOrderRequest deserialize(@NotNull Decoder decoder) {
        ...
        return new RepeatOrderRequest(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RepeatOrderRequest repeatOrderRequest) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(repeatOrderRequest, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RepeatOrderRequest.write$Self$OKDex_dex_impl(repeatOrderRequest, compositeEncoderBeginStructure, serialDescriptor);
