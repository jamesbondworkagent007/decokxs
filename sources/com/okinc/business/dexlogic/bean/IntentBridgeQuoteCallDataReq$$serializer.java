...
public final /* synthetic */ class IntentBridgeQuoteCallDataReq$$serializer implements GeneratedSerializer<IntentBridgeQuoteCallDataReq> {
    public static final int $stable;
    public static final IntentBridgeQuoteCallDataReq$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private IntentBridgeQuoteCallDataReq$$serializer() {
    }
    ...
    static {
        IntentBridgeQuoteCallDataReq$$serializer intentBridgeQuoteCallDataReq$$serializer = new IntentBridgeQuoteCallDataReq$$serializer();
        INSTANCE = intentBridgeQuoteCallDataReq$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.bean.IntentBridgeQuoteCallDataReq", intentBridgeQuoteCallDataReq$$serializer, 9);
    ...
    public final IntentBridgeQuoteCallDataReq deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new IntentBridgeQuoteCallDataReq(i, str9, str7, str5, str6, str8, str4, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull IntentBridgeQuoteCallDataReq intentBridgeQuoteCallDataReq) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(intentBridgeQuoteCallDataReq, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        IntentBridgeQuoteCallDataReq.write$Self$OKDex_dex_impl(intentBridgeQuoteCallDataReq, compositeEncoderBeginStructure, serialDescriptor);
