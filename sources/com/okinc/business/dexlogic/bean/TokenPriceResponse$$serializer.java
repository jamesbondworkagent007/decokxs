...
public final /* synthetic */ class TokenPriceResponse$$serializer implements GeneratedSerializer<TokenPriceResponse> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.bean.TokenPriceResponse", tokenPriceResponse$$serializer, 4);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull TokenPriceResponse tokenPriceResponse) {
        ...
        TokenPriceResponse.EZpvd(tokenPriceResponse, compositeEncoderBeginStructure, serialDescriptor);
