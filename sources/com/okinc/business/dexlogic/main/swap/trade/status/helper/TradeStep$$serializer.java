...
public final /* synthetic */ class TradeStep$$serializer implements GeneratedSerializer<TradeStep> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.main.swap.trade.status.helper.TradeStep", tradeStep$$serializer, 5);
