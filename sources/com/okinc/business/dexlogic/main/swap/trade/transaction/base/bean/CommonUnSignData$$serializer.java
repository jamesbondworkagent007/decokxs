...
public final /* synthetic */ class CommonUnSignData$$serializer implements GeneratedSerializer<CommonUnSignData> {
    public static final int $stable;
    public static final CommonUnSignData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CommonUnSignData$$serializer() {
    }
    ...
    static {
        CommonUnSignData$$serializer commonUnSignData$$serializer = new CommonUnSignData$$serializer();
        INSTANCE = commonUnSignData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.main.swap.trade.transaction.base.bean.CommonUnSignData", commonUnSignData$$serializer, 5);
    ...
    public final CommonUnSignData deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new CommonUnSignData(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CommonUnSignData commonUnSignData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(commonUnSignData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CommonUnSignData.write$Self$OKDex_dex_impl(commonUnSignData, compositeEncoderBeginStructure, serialDescriptor);
