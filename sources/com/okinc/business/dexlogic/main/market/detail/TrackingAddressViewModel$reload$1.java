    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C28586kda c28586kda = this.this$0.valueOf;
            this.label = 1;
            ...
            trackingAddressViewModel.KWHzl.clear();
            Map map2 = trackingAddressViewModel.KWHzl;
            ...
            if (i != 3) {
                ...
                trackingAddressViewModel2.djBIcL.clear();
                trackingAddressViewModel2.djBIcL.addAll((List) objAEQbTJ);
                if (z2) {
                    trackingAddressViewModel2.OLrzqt.setValue(C56443yFo.KWHzl(System.currentTimeMillis()));
                }
            ...
            if (!it.hasNext()) {
                ...
                kKG kkg = trackingAddressViewModel.isConnected;
                String strOLrzqt = trackingAddressViewModel.AYXKKw.OLrzqt();
                ...
                this.Z$0 = z;
                this.label = 3;
                objEZpvd = kkg.EZpvd(strOLrzqt, this);
                ...
                if (!it.hasNext()) {
                    ...
                    jAO jao = trackingAddressViewModel.copydefault;
        ...
        if (Result.m7384isSuccessimpl(objOLrzqt)) {
            ...
            DexUserIdentity dexUserIdentity3 = (DexUserIdentity) objOLrzqt;
            jAH jah = trackingAddressViewModel.EZpvd;
            String strEZpvd2 = dexUserIdentity3.EZpvd();
            this.L$0 = trackingAddressViewModel;
            ...
            trackingAddressViewModel.KWHzl.clear();
            Map map22 = trackingAddressViewModel.KWHzl;
            dexUserIdentity2 = dexUserIdentity;
