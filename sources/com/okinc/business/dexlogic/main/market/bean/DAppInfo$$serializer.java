...
public final /* synthetic */ class DAppInfo$$serializer implements GeneratedSerializer<DAppInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.main.market.bean.DAppInfo", dAppInfo$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("dappName", true);
        pluginGeneratedSerialDescriptor.addElement("dappLogo", true);
        pluginGeneratedSerialDescriptor.addElement("dappSwapUrl", true);
    ...
    public final DAppInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new DAppInfo(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull DAppInfo dAppInfo) {
        ...
        DAppInfo.write$Self$OKDex_dex_impl(dAppInfo, compositeEncoderBeginStructure, serialDescriptor);
