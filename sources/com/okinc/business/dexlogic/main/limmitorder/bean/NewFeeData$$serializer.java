...
public final /* synthetic */ class NewFeeData$$serializer implements GeneratedSerializer<NewFeeData> {
    public static final int $stable;
    public static final NewFeeData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NewFeeData$$serializer() {
    }
    ...
    static {
        NewFeeData$$serializer newFeeData$$serializer = new NewFeeData$$serializer();
        INSTANCE = newFeeData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.dexlogic.main.limmitorder.bean.NewFeeData", newFeeData$$serializer, 17);
        pluginGeneratedSerialDescriptor.addElement("fastFee", true);
        pluginGeneratedSerialDescriptor.addElement("fastFeeUsd", true);
        pluginGeneratedSerialDescriptor.addElement("fastActualFee", true);
        pluginGeneratedSerialDescriptor.addElement("fastActualFeeUsd", true);
        pluginGeneratedSerialDescriptor.addElement("marketFee", true);
        pluginGeneratedSerialDescriptor.addElement("marketFeeUsd", true);
        pluginGeneratedSerialDescriptor.addElement("marketActualFee", true);
        pluginGeneratedSerialDescriptor.addElement("marketActualFeeUsd", true);
        pluginGeneratedSerialDescriptor.addElement("maxFee", true);
        pluginGeneratedSerialDescriptor.addElement("minFee", true);
        pluginGeneratedSerialDescriptor.addElement("solDecimals", true);
        pluginGeneratedSerialDescriptor.addElement("solPrice", true);
        pluginGeneratedSerialDescriptor.addElement("solTokenSymbol", true);
        pluginGeneratedSerialDescriptor.addElement("turboFee", true);
        pluginGeneratedSerialDescriptor.addElement("turboFeeUsd", true);
        pluginGeneratedSerialDescriptor.addElement("turboActualFee", true);
        pluginGeneratedSerialDescriptor.addElement("turboActualFeeUsd", true);
    ...
    public final NewFeeData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new NewFeeData(i, str, str3, str2, str4, str10, strDecodeStringElement2, str9, str8, str11, str7, str6, str5, str13, str14, str12, strDecodeStringElement3, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NewFeeData newFeeData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(newFeeData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NewFeeData.write$Self$OKDex_dex_impl(newFeeData, compositeEncoderBeginStructure, serialDescriptor);
