...
public final class TradeStep {
    ...
    private static final KSerializer<Object>[] $childSerializers = {EnumsKt.createSimpleEnumSerializer("com.okinc.business.dexlogic.main.limmitorder.CheckStep", CheckStep.values()), null, EnumsKt.createSimpleEnumSerializer("com.okinc.business.dexlogic.main.limmitorder.SwapState", SwapState.values()), null, null};
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.dexlogic.main.limmitorder.TradeStep.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public int hashCode() {
        int iHashCode = this.step.hashCode();
        int iHashCode2 = Boolean.hashCode(this.hasCheck);
        int iHashCode3 = this.state.hashCode();
        return (((((((iHashCode * 31) + iHashCode2) * 31) + iHashCode3) * 31) + Boolean.hashCode(this.showState)) * 31) + Boolean.hashCode(this.doNext);
    }
}
