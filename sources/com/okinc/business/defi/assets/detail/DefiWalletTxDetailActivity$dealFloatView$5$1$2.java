...
public final class DefiWalletTxDetailActivity$dealFloatView$5$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DefiWalletTxDetailActivity$dealFloatView$5$1$2(ActivityC10049bhC activityC10049bhC, String str, Continuation<? super DefiWalletTxDetailActivity$dealFloatView$5$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DefiWalletTxDetailActivity$dealFloatView$5$1$2(this.this$0, this.$walletId, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((DefiWalletTxDetailActivity$dealFloatView$5$1$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            objOLrzqt = c10148biwAkhnZx.OLrzqt(strAYXKKw, str, jFetchVPNInfo, this);
