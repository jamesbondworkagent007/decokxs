...
public final class InvestSpUtil$runOnIo$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends T>>, Object> {
    ...
    public InvestSpUtil$runOnIo$2(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super InvestSpUtil$runOnIo$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Intrinsics.OLrzqt();
        return new InvestSpUtil$runOnIo$2(this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Result<? extends T>> continuation) {
        return ((InvestSpUtil$runOnIo$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
