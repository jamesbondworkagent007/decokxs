...
public final /* synthetic */ class DappDetailBean$Token$$serializer implements GeneratedSerializer<DappDetailBean.Token> {
    public static final int $stable;
    public static final DappDetailBean$Token$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DappDetailBean$Token$$serializer() {
    }
    ...
    static {
        DappDetailBean$Token$$serializer dappDetailBean$Token$$serializer = new DappDetailBean$Token$$serializer();
        INSTANCE = dappDetailBean$Token$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.dapp.net.search.DappDetailBean.Token", dappDetailBean$Token$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("tokenName", true);
        pluginGeneratedSerialDescriptor.addElement("tokenChange", true);
    ...
    public final DappDetailBean.Token deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new DappDetailBean.Token(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DappDetailBean.Token token) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(token, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DappDetailBean.Token.write$Self$OKDiscover_discover_impl(token, compositeEncoderBeginStructure, serialDescriptor);
