...
public final /* synthetic */ class DappDetailBean$Metric$$serializer implements GeneratedSerializer<DappDetailBean.Metric> {
    public static final int $stable;
    public static final DappDetailBean$Metric$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DappDetailBean$Metric$$serializer() {
    }
    ...
    static {
        DappDetailBean$Metric$$serializer dappDetailBean$Metric$$serializer = new DappDetailBean$Metric$$serializer();
        INSTANCE = dappDetailBean$Metric$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.dapp.net.search.DappDetailBean.Metric", dappDetailBean$Metric$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("name", true);
        pluginGeneratedSerialDescriptor.addElement("value", true);
        pluginGeneratedSerialDescriptor.addElement("changeIn24h", true);
    ...
    public final DappDetailBean.Metric deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new DappDetailBean.Metric(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DappDetailBean.Metric metric) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(metric, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DappDetailBean.Metric.write$Self$OKDiscover_discover_impl(metric, compositeEncoderBeginStructure, serialDescriptor);
