...
public final /* synthetic */ class FixedUTXOInfo$$serializer implements GeneratedSerializer<FixedUTXOInfo> {
    public static final int $stable;
    public static final FixedUTXOInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private FixedUTXOInfo$$serializer() {
    }
    ...
    static {
        FixedUTXOInfo$$serializer fixedUTXOInfo$$serializer = new FixedUTXOInfo$$serializer();
        INSTANCE = fixedUTXOInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.api.model.tx.signdata.FixedUTXOInfo", fixedUTXOInfo$$serializer, 17);
    ...
    public final FixedUTXOInfo deserialize(@NotNull Decoder decoder) {
        Integer num;
        String str;
        Integer num2;
        String str2;
        ...
        return new FixedUTXOInfo(i, l, str9, str2, num2, str5, str6, str10, str8, str7, z, str4, str3, num, str12, str13, str, str11, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull FixedUTXOInfo fixedUTXOInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(fixedUTXOInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        FixedUTXOInfo.write$Self$OKWallet_wallet_api(fixedUTXOInfo, compositeEncoderBeginStructure, serialDescriptor);
