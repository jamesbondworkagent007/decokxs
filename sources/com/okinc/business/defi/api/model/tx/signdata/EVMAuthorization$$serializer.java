...
public final /* synthetic */ class EVMAuthorization$$serializer implements GeneratedSerializer<EVMAuthorization> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.api.model.tx.signdata.EVMAuthorization", eVMAuthorization$$serializer, 6);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull EVMAuthorization eVMAuthorization) {
        ...
        EVMAuthorization.write$Self$OKWallet_wallet_api(eVMAuthorization, compositeEncoderBeginStructure, serialDescriptor);
