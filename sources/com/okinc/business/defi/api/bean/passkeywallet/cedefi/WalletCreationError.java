...
@Serializable
public abstract class WalletCreationError implements Parcelable {
    public static final int $stable = 0;
    public static final Companion Companion = new Companion(null);
    private static final InterfaceC56387yDm<KSerializer<Object>> $cachedSerializer$delegate = C56392yDr.EZpvd(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: o.bbl
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        @Override // kotlin.jvm.functions.Function0
        public final java.lang.Object invoke() {
            return WalletCreationError._init_$_anonymous_();
        }
    });

    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.defi.api.bean.passkeywallet.cedefi.WalletCreationError.<init>():void type: THIS */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public /* synthetic */ WalletCreationError(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    public static final /* synthetic */ void write$Self(WalletCreationError walletCreationError, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.defi.api.bean.passkeywallet.cedefi.WalletCreationError.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final /* synthetic */ KSerializer EZpvd() {
            return (KSerializer) WalletCreationError.$cachedSerializer$delegate.getValue();
        }

        public final KSerializer<WalletCreationError> serializer() {
            return EZpvd();
        }
    }

    private WalletCreationError() {
    }

    public /* synthetic */ WalletCreationError(int i, SerializationConstructorMarker serializationConstructorMarker) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final /* synthetic */ KSerializer _init_$_anonymous_() {
        return new SealedClassSerializer("com.okinc.business.defi.api.bean.passkeywallet.cedefi.WalletCreationError", C56524yIo.AEQbTJ(WalletCreationError.class), new InterfaceC56551yJo[0], new KSerializer[0], new Annotation[0]);
    }

    public static final class PasskeySdkError extends WalletCreationError {
        ...
        public static /* synthetic */ PasskeySdkError copy$default(PasskeySdkError passkeySdkError, Throwable th, int i, Object obj) {
            ...
            return passkeySdkError.KWHzl(th);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final PasskeySdkError KWHzl(@NotNull Throwable th) {
    ...
    public static final class WalletNetworkFailure extends WalletCreationError {
        ...
        public static /* synthetic */ WalletNetworkFailure copy$default(WalletNetworkFailure walletNetworkFailure, Throwable th, int i, Object obj) {
            ...
            return walletNetworkFailure.EZpvd(th);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final WalletNetworkFailure EZpvd(@NotNull Throwable th) {
            Intrinsics.checkNotNullParameter(th, "");
    ...
    public static final class PasskeyNetworkFailure extends WalletCreationError {
        ...
        public static /* synthetic */ PasskeyNetworkFailure copy$default(PasskeyNetworkFailure passkeyNetworkFailure, Throwable th, int i, Object obj) {
            ...
            return passkeyNetworkFailure.OLrzqt(th);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final PasskeyNetworkFailure OLrzqt(@NotNull Throwable th) {
            Intrinsics.checkNotNullParameter(th, "");
    ...
    public static final class GeneralFailure extends WalletCreationError {
        ...
        public static /* synthetic */ GeneralFailure copy$default(GeneralFailure generalFailure, Throwable th, int i, Object obj) {
            if ((i & 1) != 0) {
                th = generalFailure.OLrzqt;
            }
            return generalFailure.EZpvd(th);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final GeneralFailure EZpvd(@NotNull Throwable th) {
            Intrinsics.checkNotNullParameter(th, "");
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof GeneralFailure) && Intrinsics.EZpvd(this.OLrzqt, ((GeneralFailure) obj).OLrzqt);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public String toString() {
            return "GeneralFailure(error=" + this.OLrzqt + ")";
        }
    ...
    public static final class ReachMaximum extends WalletCreationError {
        public static final ReachMaximum OLrzqt = new ReachMaximum();
    ...
    public static final class AccountFrozen extends WalletCreationError {
    ...
    public static final class RiskControl extends WalletCreationError {
