...
public final /* synthetic */ class Value$$serializer implements GeneratedSerializer<Value> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.api.bean.Value", value$$serializer, 6);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Value value) {
        ...
        Value.write$Self$OKWallet_wallet_api(value, compositeEncoderBeginStructure, serialDescriptor);
