...
public final /* synthetic */ class SignRequestBean$$serializer implements GeneratedSerializer<SignRequestBean> {
    public static final int $stable;
    public static final SignRequestBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SignRequestBean$$serializer() {
    }
    ...
    static {
        SignRequestBean$$serializer signRequestBean$$serializer = new SignRequestBean$$serializer();
        INSTANCE = signRequestBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.api.bean.SignRequestBean", signRequestBean$$serializer, 7);
    ...
    public final SignRequestBean deserialize(@NotNull Decoder decoder) {
        ...
        return new SignRequestBean(i, str2, str4, str6, str3, str5, str, iDecodeIntElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SignRequestBean signRequestBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(signRequestBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SignRequestBean.write$Self$OKWallet_wallet_api(signRequestBean, compositeEncoderBeginStructure, serialDescriptor);
