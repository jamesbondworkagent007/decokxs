...
public final class StarkNetSignTypeListData {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.business.defi.jwt.StarkNetSignTypeListData */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.defi.jwt.StarkNetSignTypeListData.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void EZpvd(StarkNetSignTypeListData starkNetSignTypeListData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(java.util.List<com.okinc.business.defi.jwt.StarkNetSignTypeData>, java.util.List<com.okinc.business.defi.jwt.StarkNetSignTypeData>):void (m)] (LINE:37) call: com.okinc.business.defi.jwt.StarkNetSignTypeListData.<init>(java.util.List, java.util.List):void type: THIS */
