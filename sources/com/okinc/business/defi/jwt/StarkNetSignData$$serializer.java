...
public final /* synthetic */ class StarkNetSignData$$serializer implements GeneratedSerializer<StarkNetSignData> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.jwt.StarkNetSignData", starkNetSignData$$serializer, 3);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull StarkNetSignData starkNetSignData) {
        ...
        StarkNetSignData.AEQbTJ(starkNetSignData, compositeEncoderBeginStructure, serialDescriptor);
