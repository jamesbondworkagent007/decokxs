...
public final /* synthetic */ class StarkNetHex$$serializer implements GeneratedSerializer<StarkNetHex> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.jwt.model.StarkNetHex", starkNetHex$$serializer, 2);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull StarkNetHex starkNetHex) {
        ...
        StarkNetHex.write$Self$OKWallet_wallet_impl(starkNetHex, compositeEncoderBeginStructure, serialDescriptor);
