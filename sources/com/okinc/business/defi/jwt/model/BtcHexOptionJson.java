...
public final class BtcHexOptionJson {
    ...
    public static /* synthetic */ BtcHexOptionJson copy$default(BtcHexOptionJson btcHexOptionJson, String str, int i, Object obj) {
        ...
        return btcHexOptionJson.AEQbTJ(str);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final BtcHexOptionJson AEQbTJ(@NotNull String str) {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.business.defi.jwt.model.BtcHexOptionJson.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
