...
public final class WalletPnlDataViewModel$getWalletAccountAnalysis$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WalletPnlDataViewModel$getWalletAccountAnalysis$1(WalletPnlDataViewModel walletPnlDataViewModel, String str, String str2, long j, String str3, Continuation<? super WalletPnlDataViewModel$getWalletAccountAnalysis$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletPnlDataViewModel$getWalletAccountAnalysis$1(this.this$0, this.$periodType, this.$accountId, this.$chainIndex, this.$walletAddress, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WalletPnlDataViewModel$getWalletAccountAnalysis$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            String str3 = j != Long.MIN_VALUE ? this.$walletAddress : null;
            Long lKWHzl = j != Long.MIN_VALUE ? C56443yFo.KWHzl(j) : null;
            this.label = 1;
            obj = c15835eXa.AEQbTJ(str, str2, str3, lKWHzl, this);
