...
public final /* synthetic */ class WalletPnlShareInfo$$serializer implements GeneratedSerializer<WalletPnlShareInfo> {
    public static final int $stable;
    public static final WalletPnlShareInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private WalletPnlShareInfo$$serializer() {
    }
    ...
    static {
        WalletPnlShareInfo$$serializer walletPnlShareInfo$$serializer = new WalletPnlShareInfo$$serializer();
        INSTANCE = walletPnlShareInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.home.addressDetail.utils.WalletPnlShareInfo", walletPnlShareInfo$$serializer, 10);
        ...
        pluginGeneratedSerialDescriptor.addElement("buyTxs", false);
        pluginGeneratedSerialDescriptor.addElement("sellTxs", false);
    ...
    public final WalletPnlShareInfo deserialize(@NotNull Decoder decoder) {
        String str;
        int i;
        Boolean bool;
        String str2;
        ...
        return new WalletPnlShareInfo(i, str9, str5, str, str4, str6, str8, str7, str3, bool, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull WalletPnlShareInfo walletPnlShareInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(walletPnlShareInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        WalletPnlShareInfo.write$Self$OKWallet_wallet_impl(walletPnlShareInfo, compositeEncoderBeginStructure, serialDescriptor);
