...
public final /* synthetic */ class KLineData$$serializer implements GeneratedSerializer<KLineData> {
    public static final int $stable;
    public static final KLineData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private KLineData$$serializer() {
    }
    ...
    static {
        KLineData$$serializer kLineData$$serializer = new KLineData$$serializer();
        INSTANCE = kLineData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.home.addressDetail.utils.KLineData", kLineData$$serializer, 2);
    ...
    public final KLineData deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        int i;
        ...
        return new KLineData(i, str2, str, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull KLineData kLineData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(kLineData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        KLineData.write$Self$OKWallet_wallet_impl(kLineData, compositeEncoderBeginStructure, serialDescriptor);
