...
public final /* synthetic */ class ConvertInfoWS$$serializer implements GeneratedSerializer<ConvertInfoWS> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.passkey.common.ws.bean.ConvertInfoWS", convertInfoWS$$serializer, 6);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull ConvertInfoWS convertInfoWS) {
        ...
        ConvertInfoWS.write$Self$OKWallet_wallet_impl(convertInfoWS, compositeEncoderBeginStructure, serialDescriptor);
