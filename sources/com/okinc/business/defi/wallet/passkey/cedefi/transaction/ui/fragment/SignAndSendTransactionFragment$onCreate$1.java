...
public final class SignAndSendTransactionFragment$onCreate$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ C17639fMu this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SignAndSendTransactionFragment$onCreate$1(C17639fMu c17639fMu, Continuation<? super SignAndSendTransactionFragment$onCreate$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SignAndSendTransactionFragment$onCreate$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SignAndSendTransactionFragment$onCreate$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.passkey.cedefi.transaction.ui.fragment.SignAndSendTransactionFragment$onCreate$1$1, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                if (Result.m7384isSuccessimpl(objM7386unboximpl)) {
                    pUU.copydefault("SignAndSendTransactionFragment", "authenticate");
                    ActivityResultLauncher activityResultLauncher = this.this$0.AEQbTJ;
                    ...
                    if (thM7380exceptionOrNullimpl != null) {
                        ...
                        pUU.AEQbTJ("SignAndSendTransactionFragment", "createUop", thM7380exceptionOrNullimpl);
                        ...
                        c17639fMu.copydefault(unknownError);
                    }
                }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            Flow flowFilterNotNull = FlowKt.filterNotNull(this.this$0.KWHzl().OLrzqt());
