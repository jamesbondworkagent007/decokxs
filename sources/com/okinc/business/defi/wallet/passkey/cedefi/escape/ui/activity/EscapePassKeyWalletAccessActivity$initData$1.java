...
public final class EscapePassKeyWalletAccessActivity$initData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ fJX this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EscapePassKeyWalletAccessActivity$initData$1(fJX fjx, Continuation<? super EscapePassKeyWalletAccessActivity$initData$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EscapePassKeyWalletAccessActivity$initData$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((EscapePassKeyWalletAccessActivity$initData$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.passkey.cedefi.escape.ui.activity.EscapePassKeyWalletAccessActivity$initData$1$1, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                if (interfaceC49371unL instanceof InterfaceC49371unL.Activity) {
                    ...
                    abstractC17010eui.AEQbTJ.fIwbmz();
                    this.this$0.copydefault(new AccountPreCheckResult.OtherFailure(((InterfaceC49371unL.Application) interfaceC49371unL).AEQbTJ()));
                }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            StateFlow<InterfaceC49371unL<Boolean>> stateFlowEZpvd = this.this$0.EZpvd().EZpvd();
