...
public final class RecoverPassKeyWalletAccessActivity$observeState$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ fLW this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RecoverPassKeyWalletAccessActivity$observeState$2(fLW flw, Continuation<? super RecoverPassKeyWalletAccessActivity$observeState$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RecoverPassKeyWalletAccessActivity$observeState$2(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((RecoverPassKeyWalletAccessActivity$observeState$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.passkey.cedefi.recovery.ui.activity.RecoverPassKeyWalletAccessActivity$observeState$2$1, reason: invalid class name */
            ...
            if (this.label == 0) {
                ...
                if (interfaceC49371unL instanceof InterfaceC49371unL.ActionBar) {
                    ...
                    if (((Boolean) ((InterfaceC49371unL.Activity) interfaceC49371unL).copydefault()).booleanValue()) {
                        this.this$0.AhwBna.launch(Unit.INSTANCE);
                    } else {
                        this.this$0.OLrzqt();
                    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            SharedFlow<InterfaceC49371unL<Boolean>> sharedFlowOLrzqt = this.this$0.AYXKKw().OLrzqt();
