...
public final class EnableLimitOrderFragment$onCreate$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ fMI this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EnableLimitOrderFragment$onCreate$1(fMI fmi, Continuation<? super EnableLimitOrderFragment$onCreate$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EnableLimitOrderFragment$onCreate$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((EnableLimitOrderFragment$onCreate$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.passkey.cedefi.update.ui.fragment.EnableLimitOrderFragment$onCreate$1$1, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                if (Result.m7384isSuccessimpl(objM7386unboximpl)) {
                    pUU.copydefault("EnableLimitOrderFragment", "authenticate");
                    ...
                    if (thM7380exceptionOrNullimpl != null) {
                        ...
                        fmi.OLrzqt(new InternalEnableLimitOrderResult.Failed(strAYXKKw));
                    }
                }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            Flow flowFilterNotNull = FlowKt.filterNotNull(this.this$0.KWHzl().copydefault());
