...
public final class WalletSwitchSearchFragment$observeChangeWalletState$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ C17760fRg this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WalletSwitchSearchFragment$observeChangeWalletState$1(C17760fRg c17760fRg, Continuation<? super WalletSwitchSearchFragment$observeChangeWalletState$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletSwitchSearchFragment$observeChangeWalletState$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WalletSwitchSearchFragment$observeChangeWalletState$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.switchComponent.fragments.WalletSwitchSearchFragment$observeChangeWalletState$1$1, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                if (point instanceof Point.Application) {
                    C17760fRg.TaskDescription taskDescription = this.this$0.AYXKKw;
                    if (taskDescription != null) {
                        taskDescription.OLrzqt((String) ((Point.Application) point).copydefault());
                    }
                    this.this$0.AhwBna.invoke();
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            StateFlow<Point<String>> stateFlowKWHzl = this.this$0.AEQbTJ().KWHzl();
