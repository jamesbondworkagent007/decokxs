...
public final /* synthetic */ class DAppRequest$$serializer implements GeneratedSerializer<DAppRequest> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.common.tonconnect.model.request.DAppRequest", dAppRequest$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = DAppRequest.$childSerializers;
    ...
    public final DAppRequest deserialize(@NotNull Decoder decoder) {
        ...
        return new DAppRequest(i, str2, str, list, (SerializationConstructorMarker) null);
    }
