...
public final class TonConnectManager$fetchDAppManifest$1 extends ContinuationImpl {
    public int label;
    ...
    public TonConnectManager$fetchDAppManifest$1(C16058eck c16058eck, Continuation<? super TonConnectManager$fetchDAppManifest$1> continuation) {
        super(continuation);
