...
public final class DAppMethodHelper$onBtcSignAndPushPsbt$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onBtcSignAndPushPsbt$2$1$1(C15974ebF c15974ebF, String str, DAppInfo dAppInfo, String str2, String str3, String str4, Continuation<? super DAppMethodHelper$onBtcSignAndPushPsbt$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onBtcSignAndPushPsbt$2$1$1(this.this$0, this.$caip2ChainId, this.$dAppInfo, this.$walletId, this.$content, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onBtcSignAndPushPsbt$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onBtcSignAndPushPsbt$2$1$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (context != null) {
                    MethodHelperActivity.Companion.KWHzl(context, str, dappSignArgs, c15974ebF);
                } else {
