...
public final class DAppMethodHelper$onCosmosSignArbitrary$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onCosmosSignArbitrary$2$1$1(C15974ebF c15974ebF, String str, DAppInfo dAppInfo, JsonObject jsonObject, String str2, String str3, Continuation<? super DAppMethodHelper$onCosmosSignArbitrary$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onCosmosSignArbitrary$2$1$1(this.this$0, this.$caip2ChainId, this.$dAppInfo, this.$content, this.$walletId, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onCosmosSignArbitrary$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        JsonElement jsonElement = (JsonElement) this.$content.get((Object) "data");
        JsonObject jsonObject = jsonElement != null ? JsonElementKt.getJsonObject(jsonElement) : null;
        json.getSerializersModule();
        DappSignArgs dappSignArgs3 = new DappSignArgs(this.$walletId, str2, platformItem, json.encodeToString(BuiltinSerializersKt.getNullable(JsonObject.Companion.serializer()), jsonObject), false, C56443yFo.AEQbTJ(5), "okx_connect", null, false, false, null, null, null, null, null, false, null, 130960, null);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onCosmosSignArbitrary$2$1$1$1, reason: invalid class name */
