...
public final class DAppMethodHelper$handleSign$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$handleSign$2(String str, C15974ebF c15974ebF, String str2, WeakReference<Context> weakReference, DappSignArgs dappSignArgs, Continuation<? super DAppMethodHelper$handleSign$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DAppMethodHelper$handleSign$2(this.$method, this.this$0, this.$messageId, this.$context, this.$args, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super String> continuation) {
        return ((DAppMethodHelper$handleSign$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
