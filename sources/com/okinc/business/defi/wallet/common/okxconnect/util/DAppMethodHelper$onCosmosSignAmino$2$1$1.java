...
public final class DAppMethodHelper$onCosmosSignAmino$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onCosmosSignAmino$2$1$1(C15974ebF c15974ebF, String str, JsonObject jsonObject, DAppInfo dAppInfo, String str2, String str3, Continuation<? super DAppMethodHelper$onCosmosSignAmino$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onCosmosSignAmino$2$1$1(this.this$0, this.$caip2ChainId, this.$content, this.$dAppInfo, this.$walletId, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onCosmosSignAmino$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        JsonElement jsonElement = (JsonElement) this.$content.get((Object) "sign_doc");
        JsonObject jsonObject = jsonElement != null ? JsonElementKt.getJsonObject(jsonElement) : null;
        JsonElement jsonElement2 = (JsonElement) this.$content.get((Object) "signOptions");
        ...
        if (jsonObject2 != null) {
            jSONObject.put("signOptions", new JSONObject(jsonObject2.toString()));
        }
        ...
        dappInteractionArgs = new DappInteractionArgs(this.$walletId, null, str2, platformItem, string2, null, "okx_connect", C56443yFo.AEQbTJ(5), null, null, null, null, false, false, null, true, null, null, null, null, null, null, null, null, null, null, C56443yFo.AEQbTJ(0), null, null, null, null, null, -67141886, null);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onCosmosSignAmino$2$1$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (context != null) {
                    MethodHelperActivity.Companion.EZpvd(context, str, dappInteractionArgs, "tx_sign", true, c15974ebF);
                } else {
