...
public final class DAppMethodHelper$onSolInteraction$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onSolInteraction$2$1$1(C15974ebF c15974ebF, String str, DAppInfo dAppInfo, boolean z, String str2, String str3, String str4, Continuation<? super DAppMethodHelper$onSolInteraction$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onSolInteraction$2$1$1(this.this$0, this.$caip2ChainId, this.$dAppInfo, this.$isBroadcastToBlockchain, this.$walletId, this.$content, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onSolInteraction$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onSolInteraction$2$1$1$1, reason: invalid class name */
