...
public final class DAppMethodHelper$onTronSignMessage$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onTronSignMessage$2$1$1(C15974ebF c15974ebF, String str, String str2, DAppInfo dAppInfo, String str3, TronSignMethodVersion tronSignMethodVersion, String str4, Continuation<? super DAppMethodHelper$onTronSignMessage$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onTronSignMessage$2$1$1(this.this$0, this.$caip2ChainId, this.$walletId, this.$dAppInfo, this.$sign, this.$version, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onTronSignMessage$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        dappSignArgs = new DappSignArgs(this.$walletId, (String) objAEQbTJ, new PlatformItem(0L, this.$dAppInfo.getName(), this.$dAppInfo.getIcon(), (String) null, (String) null, (String) null, (List) null, (List) null, this.$dAppInfo.getUrl(), (String) null, 0L, 0, (String) null, (String) null, 16121, (DefaultConstructorMarker) null), this.$sign.toString(), true, C56443yFo.AEQbTJ(5), "okx_connect", null, false, false, null, null, null, null, this.$version, true, null, 81664, null);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onTronSignMessage$2$1$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(this.this$0, this.$messageId, this.$context, this.$args, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (context != null) {
                    MethodHelperActivity.Companion.copydefault(context, str, dappSignArgs, c15974ebF);
                } else {
