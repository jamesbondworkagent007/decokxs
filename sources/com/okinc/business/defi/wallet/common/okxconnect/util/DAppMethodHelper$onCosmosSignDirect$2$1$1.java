...
public final class DAppMethodHelper$onCosmosSignDirect$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onCosmosSignDirect$2$1$1(C15974ebF c15974ebF, String str, DAppInfo dAppInfo, JsonObject jsonObject, String str2, String str3, Continuation<? super DAppMethodHelper$onCosmosSignDirect$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onCosmosSignDirect$2$1$1(this.this$0, this.$caip2ChainId, this.$dAppInfo, this.$content, this.$walletId, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onCosmosSignDirect$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        dappInteractionArgs = new DappInteractionArgs(this.$walletId, null, str2, platformItem, json.encodeToString(JsonObject.Companion.serializer(), jsonObject), null, "okx_connect", C56443yFo.AEQbTJ(5), null, null, null, null, false, false, null, true, null, null, null, null, null, null, null, null, null, null, C56443yFo.AEQbTJ(0), null, null, null, null, null, -67141886, null);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onCosmosSignDirect$2$1$1$1, reason: invalid class name */
