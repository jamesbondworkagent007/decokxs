...
public final /* synthetic */ class RpcResponse$Error$$serializer implements GeneratedSerializer<RpcResponse.Error> {
    public static final int $stable;
    public static final RpcResponse$Error$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RpcResponse$Error$$serializer() {
    }
    ...
    static {
        RpcResponse$Error$$serializer rpcResponse$Error$$serializer = new RpcResponse$Error$$serializer();
        INSTANCE = rpcResponse$Error$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.common.okxconnect.network.rpc.RpcResponse.Error", rpcResponse$Error$$serializer, 3);
    ...
    public final RpcResponse.Error deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        ...
        return new RpcResponse.Error(i, str2, str, oKXConnectException, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RpcResponse.Error error) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(error, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RpcResponse.Error.write$Self$OKWallet_wallet_impl(error, compositeEncoderBeginStructure, serialDescriptor);
