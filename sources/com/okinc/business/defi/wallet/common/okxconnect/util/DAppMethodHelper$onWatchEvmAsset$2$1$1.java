...
public final class DAppMethodHelper$onWatchEvmAsset$2$1$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    public DAppMethodHelper$onWatchEvmAsset$2$1$1(C15974ebF c15974ebF, String str, WalletWatchAsset walletWatchAsset, String str2, String str3, Continuation<? super DAppMethodHelper$onWatchEvmAsset$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DAppMethodHelper$onWatchEvmAsset$2$1$1(this.this$0, this.$caip2ChainId, this.$walletWatchAsset, this.$walletId, this.$messageId, continuation);
    }
    ...
    public final Object invoke(Continuation<? super String> continuation) {
        return ((DAppMethodHelper$onWatchEvmAsset$2$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        WalletWatchAssetOption options = this.$walletWatchAsset.getOptions();
        String image = options != null ? options.getImage() : null;
        WalletWatchAssetOption options2 = this.$walletWatchAsset.getOptions();
        String symbol = options2 != null ? options2.getSymbol() : null;
        WalletWatchAssetOption options3 = this.$walletWatchAsset.getOptions();
        int iIntValue = (options3 == null || (decimals = options3.getDecimals()) == null) ? -1 : decimals.intValue();
        WalletWatchAssetOption options4 = this.$walletWatchAsset.getOptions();
        dappInteractionArgs = new DappInteractionArgs(this.$walletId, null, str2, null, null, null, "okx_connect", C56443yFo.AEQbTJ(1), null, null, null, null, false, false, null, false, null, null, null, null, null, new CustomNetworkInfo(image, null, null, null, null, symbol, null, options4 != null ? options4.getAddress() : null, iIntValue, 94, null), null, null, null, null, C56443yFo.AEQbTJ(0), null, null, null, null, null, -69206214, null);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.common.okxconnect.util.DAppMethodHelper$onWatchEvmAsset$2$1$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (context != null) {
                    MethodHelperActivity.Companion.OLrzqt(context, str, dappInteractionArgs, "custom_coin", c15974ebF);
                } else {
