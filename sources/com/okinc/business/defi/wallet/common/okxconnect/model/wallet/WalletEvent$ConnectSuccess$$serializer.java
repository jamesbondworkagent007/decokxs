...
public final /* synthetic */ class WalletEvent$ConnectSuccess$$serializer implements GeneratedSerializer<WalletEvent.ConnectSuccess> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.common.okxconnect.model.wallet.WalletEvent.ConnectSuccess", walletEvent$ConnectSuccess$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{stringSerializer, stringSerializer, WalletEvent$ConnectSuccess$Payload$$serializer.INSTANCE};
    }
    ...
    public final WalletEvent.ConnectSuccess deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            payload = (WalletEvent.ConnectSuccess.Payload) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 2, WalletEvent$ConnectSuccess$Payload$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    payload2 = (WalletEvent.ConnectSuccess.Payload) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 2, WalletEvent$ConnectSuccess$Payload$$serializer.INSTANCE, payload2);
                    i2 |= 4;
                }
            }
            i = i2;
        ...
        return new WalletEvent.ConnectSuccess(i, str2, str, payload, (SerializationConstructorMarker) null);
    }
