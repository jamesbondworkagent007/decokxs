...
public final /* synthetic */ class ExchangeAddressData$AddressBean$$serializer implements GeneratedSerializer<ExchangeAddressData.AddressBean> {
    public static final int $stable;
    public static final ExchangeAddressData$AddressBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ExchangeAddressData$AddressBean$$serializer() {
    }
    ...
    static {
        ExchangeAddressData$AddressBean$$serializer exchangeAddressData$AddressBean$$serializer = new ExchangeAddressData$AddressBean$$serializer();
        INSTANCE = exchangeAddressData$AddressBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.transfer.receive.exchange.bean.ExchangeAddressData.AddressBean", exchangeAddressData$AddressBean$$serializer, 3);
    ...
    public final ExchangeAddressData.AddressBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ExchangeAddressData.AddressBean(i, str3, str, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ExchangeAddressData.AddressBean addressBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(addressBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ExchangeAddressData.AddressBean.write$Self$OKWallet_wallet_impl(addressBean, compositeEncoderBeginStructure, serialDescriptor);
