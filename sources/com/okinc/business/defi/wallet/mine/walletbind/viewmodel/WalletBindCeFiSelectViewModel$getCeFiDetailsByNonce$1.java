...
public final class WalletBindCeFiSelectViewModel$getCeFiDetailsByNonce$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WalletBindCeFiSelectViewModel$getCeFiDetailsByNonce$1(WalletBindCeFiSelectViewModel walletBindCeFiSelectViewModel, String str, Continuation<? super WalletBindCeFiSelectViewModel$getCeFiDetailsByNonce$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletBindCeFiSelectViewModel$getCeFiDetailsByNonce$1(this.this$0, this.$nonce, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WalletBindCeFiSelectViewModel$getCeFiDetailsByNonce$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Removed duplicated region for block: B:30:0x00b3  */
    /* JADX WARN: Removed duplicated region for block: B:31:0x00b5  */
    /* JADX WARN: Removed duplicated region for block: B:34:0x00ba A[Catch: all -> 0x0127, TryCatch #0 {all -> 0x0127, blocks: (B:14:0x0042, B:41:0x0100, B:43:0x0122, B:17:0x004f, B:28:0x00ad, B:32:0x00b6, B:34:0x00ba, B:35:0x00e3, B:37:0x00e9, B:24:0x0079), top: B:59:0x0014 }] */
    /* JADX WARN: Removed duplicated region for block: B:37:0x00e9 A[Catch: all -> 0x0127, TryCatch #0 {all -> 0x0127, blocks: (B:14:0x0042, B:41:0x0100, B:43:0x0122, B:17:0x004f, B:28:0x00ad, B:32:0x00b6, B:34:0x00ba, B:35:0x00e3, B:37:0x00e9, B:24:0x0079), top: B:59:0x0014 }] */
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        Boolean boolKWHzl;
        String str2;
        WalletBindCeFiSelectViewModel walletBindCeFiSelectViewModel;
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                if (i == 2) {
                    walletBindCeFiSelectViewModel = (WalletBindCeFiSelectViewModel) this.L$1;
                    ...
                    if (validateNonceResponseBody != null) {
                        walletBindCeFiSelectViewModel.OLrzqt.setValue(validateNonceResponseBody);
                    ...
                    if (thM7380exceptionOrNullimpl2 == null) {
                        MutableSharedFlow mutableSharedFlow = walletBindCeFiSelectViewModel.KWHzl;
                        ...
                        WalletBindCeFiSelectViewModel walletBindCeFiSelectViewModel2 = this.this$0;
                    ...
                    unit = null;
                    objM7377constructorimpl = Result.m7377constructorimpl(unit);
                    WalletBindCeFiSelectViewModel walletBindCeFiSelectViewModel22 = this.this$0;
                ...
                unit = Unit.INSTANCE;
                objM7377constructorimpl = Result.m7377constructorimpl(unit);
                WalletBindCeFiSelectViewModel walletBindCeFiSelectViewModel222 = this.this$0;
                String str422 = this.$nonce;
                thM7380exceptionOrNullimpl = Result.m7380exceptionOrNullimpl(objM7377constructorimpl);
                if (thM7380exceptionOrNullimpl != null) {
                    MutableSharedFlow mutableSharedFlow2 = walletBindCeFiSelectViewModel222.KWHzl;
                    String message2 = thM7380exceptionOrNullimpl.getMessage();
                    this.L$0 = objM7377constructorimpl;
                    this.L$1 = str422;
                    this.L$2 = thM7380exceptionOrNullimpl;
                    this.label = 4;
                    if (mutableSharedFlow2.emit(message2, this) == objCopydefault) {
                        return objCopydefault;
                    }
                    str = str422;
        ...
        WalletBindCeFiSelectViewModel walletBindCeFiSelectViewModel3 = this.this$0;
        Result.Application application2 = Result.Companion;
        C19339fzS.EZpvd.OLrzqt("[OKX APP-Bind Wallet]", "get cefi detail by nonce started,nonce:" + str5);
        C19337fzQ c19337fzQ = walletBindCeFiSelectViewModel3.fJNWhG;
        ValidateNonceRequestBody validateNonceRequestBody = new ValidateNonceRequestBody(str5);
        this.L$0 = str5;
        this.L$1 = walletBindCeFiSelectViewModel3;
        this.label = 2;
        ...
        str2 = str5;
        walletBindCeFiSelectViewModel = walletBindCeFiSelectViewModel3;
