...
public final /* synthetic */ class TagExtra$$serializer implements GeneratedSerializer<TagExtra> {
    public static final int $stable;
    public static final TagExtra$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TagExtra$$serializer() {
    }
    ...
    static {
        TagExtra$$serializer tagExtra$$serializer = new TagExtra$$serializer();
        INSTANCE = tagExtra$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.mine.search.data.model.TagExtra", tagExtra$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("name", true);
        pluginGeneratedSerialDescriptor.addElement("kolTwitterLink", true);
        pluginGeneratedSerialDescriptor.addElement("kolTwitterImage", true);
    ...
    public final TagExtra deserialize(@NotNull Decoder decoder) {
        ...
        return new TagExtra(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TagExtra tagExtra) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(tagExtra, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TagExtra.copydefault(tagExtra, compositeEncoderBeginStructure, serialDescriptor);
