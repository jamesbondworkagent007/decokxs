...
public final /* synthetic */ class WalletBannerEventItem$$serializer implements GeneratedSerializer<WalletBannerEventItem> {
    public static final int $stable;
    public static final WalletBannerEventItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private WalletBannerEventItem$$serializer() {
    }
    ...
    static {
        WalletBannerEventItem$$serializer walletBannerEventItem$$serializer = new WalletBannerEventItem$$serializer();
        INSTANCE = walletBannerEventItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.mine.search.banner.data.model.WalletBannerEventItem", walletBannerEventItem$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("title", true);
        pluginGeneratedSerialDescriptor.addElement("reward", true);
        pluginGeneratedSerialDescriptor.addElement("endTime", true);
        pluginGeneratedSerialDescriptor.addElement("appBgNightImg", true);
        pluginGeneratedSerialDescriptor.addElement("appBgImg", true);
        pluginGeneratedSerialDescriptor.addElement("appJoinLink", true);
    ...
    public final WalletBannerEventItem deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new WalletBannerEventItem(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull WalletBannerEventItem walletBannerEventItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(walletBannerEventItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        WalletBannerEventItem.write$Self$OKWallet_wallet_impl(walletBannerEventItem, compositeEncoderBeginStructure, serialDescriptor);
