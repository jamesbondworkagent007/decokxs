...
public final /* synthetic */ class SearchAddressResponse$$serializer implements GeneratedSerializer<SearchAddressResponse> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.wallet.mine.search.data.model.SearchAddressResponse", searchAddressResponse$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = SearchAddressResponse.$childSerializers;
    ...
    public final SearchAddressResponse deserialize(@NotNull Decoder decoder) {
        ...
        return new SearchAddressResponse(i, str2, str, arrayList, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SearchAddressResponse searchAddressResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(searchAddressResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SearchAddressResponse.write$Self$OKWallet_wallet_impl(searchAddressResponse, compositeEncoderBeginStructure, serialDescriptor);
