...
public final class AddressBookNetworkSelectionBottomSheet$observeSvmNetworksSelectedState$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AddressBookNetworkSelectionBottomSheet$observeSvmNetworksSelectedState$1(AddressBookNetworkSelectionBottomSheet addressBookNetworkSelectionBottomSheet, List<Object> list, Continuation<? super AddressBookNetworkSelectionBottomSheet$observeSvmNetworksSelectedState$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AddressBookNetworkSelectionBottomSheet$observeSvmNetworksSelectedState$1(this.this$0, this.$section0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AddressBookNetworkSelectionBottomSheet$observeSvmNetworksSelectedState$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            Flow flowFlowWithLifecycle = FlowExtKt.flowWithLifecycle(this.this$0.KWHzl().AEQbTJ(), this.this$0.getViewLifecycleOwner().getLifecycle(), Lifecycle.State.STARTED);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.wallet.mine.addressbook.detail.AddressBookNetworkSelectionBottomSheet$observeSvmNetworksSelectedState$1$1, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                while (true) {
                    ...
                    next = it.next();
                    if ((next instanceof AddressBookNetworkSelectionBottomSheet.QuickSelectionItem) && ((AddressBookNetworkSelectionBottomSheet.QuickSelectionItem) next).AhwBna()) {
                        break;
                    }
                }
