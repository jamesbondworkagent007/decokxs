...
public final class WalletAddressBookDetailViewModel$checkAddressFieldState$2$supportedChainsResult$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public WalletAddressBookDetailViewModel$checkAddressFieldState$2$supportedChainsResult$1(FlowCollector<? super WalletAddressBookDetailViewModel.AddressInputFieldState> flowCollector, Continuation<? super WalletAddressBookDetailViewModel$checkAddressFieldState$2$supportedChainsResult$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new WalletAddressBookDetailViewModel$checkAddressFieldState$2$supportedChainsResult$1(this.$$this$flow, continuation);
    }
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((WalletAddressBookDetailViewModel$checkAddressFieldState$2$supportedChainsResult$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
