...
public final class WalletMineFragment$handleJudgeForbiddenCheck$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ Function0<Unit> $callback;
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WalletMineFragment$handleJudgeForbiddenCheck$1(Function0<Unit> function0, Continuation<? super WalletMineFragment$handleJudgeForbiddenCheck$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletMineFragment$handleJudgeForbiddenCheck$1(this.$callback, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WalletMineFragment$handleJudgeForbiddenCheck$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (this.label == 0) {
            ...
            if (oKComplianceRestrictionService.OLrzqt(feature)) {
