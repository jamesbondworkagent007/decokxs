...
public final /* synthetic */ class NativeCurrency$$serializer implements GeneratedSerializer<NativeCurrency> {
    public static final int $stable;
    public static final NativeCurrency$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NativeCurrency$$serializer() {
    }
    ...
    static {
        NativeCurrency$$serializer nativeCurrency$$serializer = new NativeCurrency$$serializer();
        INSTANCE = nativeCurrency$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.walletconnect.NativeCurrency", nativeCurrency$$serializer, 3);
    ...
    public final NativeCurrency deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Integer num;
        String str2;
        ...
        return new NativeCurrency(i, num, str, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NativeCurrency nativeCurrency) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(nativeCurrency, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NativeCurrency.write$Self$OKWallet_wallet_impl(nativeCurrency, compositeEncoderBeginStructure, serialDescriptor);
