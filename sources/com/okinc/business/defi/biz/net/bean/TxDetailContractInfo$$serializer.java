...
public final /* synthetic */ class TxDetailContractInfo$$serializer implements GeneratedSerializer<TxDetailContractInfo> {
    public static final int $stable;
    public static final TxDetailContractInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TxDetailContractInfo$$serializer() {
    }
    ...
    static {
        TxDetailContractInfo$$serializer txDetailContractInfo$$serializer = new TxDetailContractInfo$$serializer();
        INSTANCE = txDetailContractInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.TxDetailContractInfo", txDetailContractInfo$$serializer, 3);
    ...
    public final TxDetailContractInfo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TxDetailContractInfo(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TxDetailContractInfo txDetailContractInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(txDetailContractInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TxDetailContractInfo.write$Self$OKWallet_wallet_impl(txDetailContractInfo, compositeEncoderBeginStructure, serialDescriptor);
