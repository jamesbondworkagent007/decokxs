...
public final /* synthetic */ class AmountDetail$$serializer implements GeneratedSerializer<AmountDetail> {
    public static final int $stable;
    public static final AmountDetail$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AmountDetail$$serializer() {
    }
    ...
    static {
        AmountDetail$$serializer amountDetail$$serializer = new AmountDetail$$serializer();
        INSTANCE = amountDetail$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.AmountDetail", amountDetail$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("nftImageUrl", true);
        pluginGeneratedSerialDescriptor.addElement("nftName", true);
        pluginGeneratedSerialDescriptor.addElement("rawValue", true);
        pluginGeneratedSerialDescriptor.addElement("tokenId", true);
        pluginGeneratedSerialDescriptor.addElement("tokenNum", true);
    ...
    public final AmountDetail deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new AmountDetail(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AmountDetail amountDetail) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(amountDetail, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AmountDetail.write$Self$OKWallet_wallet_api(amountDetail, compositeEncoderBeginStructure, serialDescriptor);
