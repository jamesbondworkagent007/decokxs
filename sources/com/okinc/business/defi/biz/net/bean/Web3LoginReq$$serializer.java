...
public final /* synthetic */ class Web3LoginReq$$serializer implements GeneratedSerializer<Web3LoginReq> {
    public static final int $stable;
    public static final Web3LoginReq$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private Web3LoginReq$$serializer() {
    }
    ...
    static {
        Web3LoginReq$$serializer web3LoginReq$$serializer = new Web3LoginReq$$serializer();
        INSTANCE = web3LoginReq$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.Web3LoginReq", web3LoginReq$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{stringSerializer, LongSerializer.INSTANCE, stringSerializer, stringSerializer, IntSerializer.INSTANCE, stringSerializer};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final Web3LoginReq deserialize(@NotNull Decoder decoder) {
        ...
        return new Web3LoginReq(i, str, j, str3, str2, i2, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull Web3LoginReq web3LoginReq) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(web3LoginReq, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        Web3LoginReq.write$Self$OKWallet_wallet_impl(web3LoginReq, compositeEncoderBeginStructure, serialDescriptor);
