...
public final /* synthetic */ class TxDetailApproveInfo$$serializer implements GeneratedSerializer<TxDetailApproveInfo> {
    public static final int $stable;
    public static final TxDetailApproveInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TxDetailApproveInfo$$serializer() {
    }
    ...
    static {
        TxDetailApproveInfo$$serializer txDetailApproveInfo$$serializer = new TxDetailApproveInfo$$serializer();
        INSTANCE = txDetailApproveInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.TxDetailApproveInfo", txDetailApproveInfo$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("nftCollectionAddress", true);
    ...
    public final TxDetailApproveInfo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TxDetailApproveInfo(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TxDetailApproveInfo txDetailApproveInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(txDetailApproveInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TxDetailApproveInfo.write$Self$OKWallet_wallet_impl(txDetailApproveInfo, compositeEncoderBeginStructure, serialDescriptor);
