...
public final /* synthetic */ class CeDefiEvmGasPrice$$serializer implements GeneratedSerializer<CeDefiEvmGasPrice> {
    public static final int $stable;
    public static final CeDefiEvmGasPrice$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CeDefiEvmGasPrice$$serializer() {
    }
    ...
    static {
        CeDefiEvmGasPrice$$serializer ceDefiEvmGasPrice$$serializer = new CeDefiEvmGasPrice$$serializer();
        INSTANCE = ceDefiEvmGasPrice$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.CeDefiEvmGasPrice", ceDefiEvmGasPrice$$serializer, 4);
    ...
    public final CeDefiEvmGasPrice deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new CeDefiEvmGasPrice(i, str4, str3, str, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CeDefiEvmGasPrice ceDefiEvmGasPrice) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(ceDefiEvmGasPrice, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CeDefiEvmGasPrice.write$Self$OKWallet_wallet_impl(ceDefiEvmGasPrice, compositeEncoderBeginStructure, serialDescriptor);
