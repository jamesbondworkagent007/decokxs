...
public final /* synthetic */ class InviteeInfoItemResponse$$serializer implements GeneratedSerializer<InviteeInfoItemResponse> {
    public static final int $stable;
    public static final InviteeInfoItemResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InviteeInfoItemResponse$$serializer() {
    }
    ...
    static {
        InviteeInfoItemResponse$$serializer inviteeInfoItemResponse$$serializer = new InviteeInfoItemResponse$$serializer();
        INSTANCE = inviteeInfoItemResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.InviteeInfoItemResponse", inviteeInfoItemResponse$$serializer, 5);
    ...
    public final InviteeInfoItemResponse deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new InviteeInfoItemResponse(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InviteeInfoItemResponse inviteeInfoItemResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inviteeInfoItemResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InviteeInfoItemResponse.write$Self$OKWallet_wallet_impl(inviteeInfoItemResponse, compositeEncoderBeginStructure, serialDescriptor);
