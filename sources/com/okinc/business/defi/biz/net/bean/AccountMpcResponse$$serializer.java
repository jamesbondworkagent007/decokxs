...
public final /* synthetic */ class AccountMpcResponse$$serializer implements GeneratedSerializer<AccountMpcResponse> {
    public static final int $stable;
    public static final AccountMpcResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AccountMpcResponse$$serializer() {
    }
    ...
    static {
        AccountMpcResponse$$serializer accountMpcResponse$$serializer = new AccountMpcResponse$$serializer();
        INSTANCE = accountMpcResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.AccountMpcResponse", accountMpcResponse$$serializer, 5);
    ...
    public final AccountMpcResponse deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new AccountMpcResponse(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AccountMpcResponse accountMpcResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(accountMpcResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AccountMpcResponse.write$Self$OKWallet_wallet_impl(accountMpcResponse, compositeEncoderBeginStructure, serialDescriptor);
