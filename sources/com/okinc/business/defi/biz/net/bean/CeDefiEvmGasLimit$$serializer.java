...
public final /* synthetic */ class CeDefiEvmGasLimit$$serializer implements GeneratedSerializer<CeDefiEvmGasLimit> {
    public static final int $stable;
    public static final CeDefiEvmGasLimit$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CeDefiEvmGasLimit$$serializer() {
    }
    ...
    static {
        CeDefiEvmGasLimit$$serializer ceDefiEvmGasLimit$$serializer = new CeDefiEvmGasLimit$$serializer();
        INSTANCE = ceDefiEvmGasLimit$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.CeDefiEvmGasLimit", ceDefiEvmGasLimit$$serializer, 6);
        ...
        pluginGeneratedSerialDescriptor.addElement("l1GasLimit", false);
    ...
    public final CeDefiEvmGasLimit deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new CeDefiEvmGasLimit(i, str3, str5, str, str6, str4, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CeDefiEvmGasLimit ceDefiEvmGasLimit) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(ceDefiEvmGasLimit, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CeDefiEvmGasLimit.write$Self$OKWallet_wallet_impl(ceDefiEvmGasLimit, compositeEncoderBeginStructure, serialDescriptor);
