...
public final /* synthetic */ class TxContractInfo$$serializer implements GeneratedSerializer<TxContractInfo> {
    public static final int $stable;
    public static final TxContractInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TxContractInfo$$serializer() {
    }
    ...
    static {
        TxContractInfo$$serializer txContractInfo$$serializer = new TxContractInfo$$serializer();
        INSTANCE = txContractInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.net.bean.TxContractInfo", txContractInfo$$serializer, 3);
    ...
    public final TxContractInfo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TxContractInfo(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TxContractInfo txContractInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(txContractInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TxContractInfo.write$Self$OKWallet_wallet_impl(txContractInfo, compositeEncoderBeginStructure, serialDescriptor);
