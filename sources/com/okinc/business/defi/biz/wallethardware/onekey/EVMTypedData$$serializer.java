...
public final /* synthetic */ class EVMTypedData$$serializer implements GeneratedSerializer<EVMTypedData> {
    public static final int $stable;
    public static final EVMTypedData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private EVMTypedData$$serializer() {
    }
    ...
    static {
        EVMTypedData$$serializer eVMTypedData$$serializer = new EVMTypedData$$serializer();
        INSTANCE = eVMTypedData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.wallethardware.onekey.EVMTypedData", eVMTypedData$$serializer, 3);
    ...
    public final EVMTypedData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new EVMTypedData(i, str2, str, str3, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull EVMTypedData eVMTypedData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(eVMTypedData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        EVMTypedData.write$Self$OKWallet_wallet_impl(eVMTypedData, compositeEncoderBeginStructure, serialDescriptor);
