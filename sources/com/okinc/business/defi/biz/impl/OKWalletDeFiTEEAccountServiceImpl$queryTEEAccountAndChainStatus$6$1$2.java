...
public final class OKWalletDeFiTEEAccountServiceImpl$queryTEEAccountAndChainStatus$6$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super SingleTeeStatus>, Object> {
    final /* synthetic */ String $accountId;
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OKWalletDeFiTEEAccountServiceImpl$queryTEEAccountAndChainStatus$6$1$2(String str, Continuation<? super OKWalletDeFiTEEAccountServiceImpl$queryTEEAccountAndChainStatus$6$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OKWalletDeFiTEEAccountServiceImpl$queryTEEAccountAndChainStatus$6$1$2(this.$accountId, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super SingleTeeStatus> continuation) {
        return ((OKWalletDeFiTEEAccountServiceImpl$queryTEEAccountAndChainStatus$6$1$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
