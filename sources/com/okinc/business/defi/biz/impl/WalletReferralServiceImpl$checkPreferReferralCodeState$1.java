...
public final class WalletReferralServiceImpl$checkPreferReferralCodeState$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WalletReferralServiceImpl$checkPreferReferralCodeState$1(ReferralInfo referralInfo, String str, Function2<? super Boolean, ? super String, Unit> function2, Continuation<? super WalletReferralServiceImpl$checkPreferReferralCodeState$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletReferralServiceImpl$checkPreferReferralCodeState$1(this.$codeInfo, this.$accountId, this.$callback, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WalletReferralServiceImpl$checkPreferReferralCodeState$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = ReferralManager.checkPreferReferralCodeState$default(instance$default, referralInfo, str, false, this, 4, null);
        ...
        pUU.KWHzl("DexReferral", "checkPreferReferralCodeState result=" + zBooleanValue);
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.biz.impl.WalletReferralServiceImpl$checkPreferReferralCodeState$1$1, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: com.okinc.business.defi.biz.impl.WalletReferralServiceImpl$checkPreferReferralCodeState$1$2, reason: invalid class name */
