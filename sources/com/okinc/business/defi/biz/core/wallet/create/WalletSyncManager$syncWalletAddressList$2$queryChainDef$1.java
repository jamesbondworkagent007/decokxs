...
public final class WalletSyncManager$syncWalletAddressList$2$queryChainDef$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<String, ? extends List<? extends ChainAddressEntity>>>, Object> {
    ...
    public WalletSyncManager$syncWalletAddressList$2$queryChainDef$1(C13062cyk c13062cyk, List<String> list, Continuation<? super WalletSyncManager$syncWalletAddressList$2$queryChainDef$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletSyncManager$syncWalletAddressList$2$queryChainDef$1(this.this$0, this.$walletids, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Map<String, ? extends List<ChainAddressEntity>>> continuation) {
        return ((WalletSyncManager$syncWalletAddressList$2$queryChainDef$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
