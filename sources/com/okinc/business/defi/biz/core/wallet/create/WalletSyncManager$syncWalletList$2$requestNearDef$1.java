...
public final class WalletSyncManager$syncWalletList$2$requestNearDef$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super C13062cyk.StateListAnimator<List<? extends WalletEntity>>>, Object> {
    ...
    public WalletSyncManager$syncWalletList$2$requestNearDef$1(C13062cyk c13062cyk, List<WalletEntity> list, Continuation<? super WalletSyncManager$syncWalletList$2$requestNearDef$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletSyncManager$syncWalletList$2$requestNearDef$1(this.this$0, this.$successCallCreateWallet, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super C13062cyk.StateListAnimator<List<WalletEntity>>> continuation) {
        return ((WalletSyncManager$syncWalletList$2$requestNearDef$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = c13062cyk.EZpvd((List<WalletEntity>) list, (Continuation<? super C13062cyk.StateListAnimator<List<WalletEntity>>>) this);
