...
public final class WalletSignManager$suppleCreateDataIfNeed$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WalletSignManager$suppleCreateDataIfNeed$1(List<? extends AbstractC12782ctV> list, C13058cyg c13058cyg, Continuation<? super WalletSignManager$suppleCreateDataIfNeed$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletSignManager$suppleCreateDataIfNeed$1(this.$wallets, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WalletSignManager$suppleCreateDataIfNeed$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            List<AbstractC12782ctV> list2 = this.$wallets;
            ...
            if (i != 1) {
                ...
                C56391yDq.AEQbTJ(obj);
                while (it.hasNext()) {
                    AbstractC12782ctV abstractC12782ctV2 = (AbstractC12782ctV) it.next();
