...
public final class WalletSyncManager$requestEosInfo$2$addressDef$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<String, ? extends List<? extends ChainAddressEntity>>>, Object> {
    ...
    public WalletSyncManager$requestEosInfo$2$addressDef$1(C13062cyk c13062cyk, List<String> list, List<Long> list2, Continuation<? super WalletSyncManager$requestEosInfo$2$addressDef$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletSyncManager$requestEosInfo$2$addressDef$1(this.this$0, this.$walletIds, this.$chainIds, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Map<String, ? extends List<ChainAddressEntity>>> continuation) {
        return ((WalletSyncManager$requestEosInfo$2$addressDef$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = cog.AEQbTJ(list, list2, this);
