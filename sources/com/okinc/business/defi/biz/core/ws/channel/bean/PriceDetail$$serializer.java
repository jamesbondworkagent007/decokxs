...
public final /* synthetic */ class PriceDetail$$serializer implements GeneratedSerializer<PriceDetail> {
    public static final int $stable;
    public static final PriceDetail$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PriceDetail$$serializer() {
    }
    ...
    static {
        PriceDetail$$serializer priceDetail$$serializer = new PriceDetail$$serializer();
        INSTANCE = priceDetail$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.core.ws.channel.bean.PriceDetail", priceDetail$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("currency", true);
        pluginGeneratedSerialDescriptor.addElement("currencyUrl", false);
    ...
    public final PriceDetail deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new PriceDetail(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PriceDetail priceDetail) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(priceDetail, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PriceDetail.write$Self$OKWallet_wallet_impl(priceDetail, compositeEncoderBeginStructure, serialDescriptor);
