...
public final /* synthetic */ class CoinFee$$serializer implements GeneratedSerializer<CoinFee> {
    public static final int $stable;
    public static final CoinFee$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CoinFee$$serializer() {
    }
    ...
    static {
        CoinFee$$serializer coinFee$$serializer = new CoinFee$$serializer();
        INSTANCE = coinFee$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.defi.biz.core.transaction.sign.zksync.bean.CoinFee", coinFee$$serializer, 5);
        ...
        pluginGeneratedSerialDescriptor.addElement("originSymbol", true);
    ...
    public final CoinFee deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new CoinFee(i, l, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CoinFee coinFee) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(coinFee, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CoinFee.EZpvd(coinFee, compositeEncoderBeginStructure, serialDescriptor);
