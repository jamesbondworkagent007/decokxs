...
public final class WalletRepository$queryChainAddressesByWalletIdsSuspend$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<String, ? extends List<? extends ChainAddressEntity>>>, Object> {
    ...
    public WalletRepository$queryChainAddressesByWalletIdsSuspend$2(cQM cqm, List<String> list, Continuation<? super WalletRepository$queryChainAddressesByWalletIdsSuspend$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletRepository$queryChainAddressesByWalletIdsSuspend$2(this.this$0, this.$walletIds, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Map<String, ? extends List<ChainAddressEntity>>> continuation) {
        return ((WalletRepository$queryChainAddressesByWalletIdsSuspend$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC11384cMf.djBIcL(list, this);
