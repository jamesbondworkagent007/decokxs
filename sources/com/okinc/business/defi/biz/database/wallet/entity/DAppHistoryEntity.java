...
public final class DAppHistoryEntity {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final DAppHistoryEntity copy(long j, @NotNull String str, @NotNull String str2, @NotNull String str3, double d, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, int i, int i2, long j2) {
        ...
        return new DAppHistoryEntity(j, str, str2, str3, d, str4, str5, str6, str7, i, i2, j2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DAppHistoryEntity)) {
            return false;
        }
        DAppHistoryEntity dAppHistoryEntity = (DAppHistoryEntity) obj;
        return this.id == dAppHistoryEntity.id && Intrinsics.EZpvd((Object) this.platform, (Object) dAppHistoryEntity.platform) && Intrinsics.EZpvd((Object) this.logo, (Object) dAppHistoryEntity.logo) && Intrinsics.EZpvd((Object) this.network, (Object) dAppHistoryEntity.network) && Double.compare(this.tvl, dAppHistoryEntity.tvl) == 0 && Intrinsics.EZpvd((Object) this.intro, (Object) dAppHistoryEntity.intro) && Intrinsics.EZpvd((Object) this.tag, (Object) dAppHistoryEntity.tag) && Intrinsics.EZpvd((Object) this.type, (Object) dAppHistoryEntity.type) && Intrinsics.EZpvd((Object) this.url, (Object) dAppHistoryEntity.url) && this.dau == dAppHistoryEntity.dau && this.order == dAppHistoryEntity.order && this.timeStamp == dAppHistoryEntity.timeStamp;
    }
    ...
    public String toString() {
        return "DAppHistoryEntity(id=" + this.id + ", platform=" + this.platform + ", logo=" + this.logo + ", network=" + this.network + ", tvl=" + this.tvl + ", intro=" + this.intro + ", tag=" + this.tag + ", type=" + this.type + ", url=" + this.url + ", dau=" + this.dau + ", order=" + this.order + ", timeStamp=" + this.timeStamp + ")";
    }

    public DAppHistoryEntity(long j, @NotNull String str, @NotNull String str2, @NotNull String str3, double d, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, int i, int i2, long j2) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        Intrinsics.checkNotNullParameter(str3, "");
        Intrinsics.checkNotNullParameter(str4, "");
 ...
 A[MD:(long, java.lang.String, java.lang.String, java.lang.String, double, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, int, long):void (m)] (LINE:9) call: com.okinc.business.defi.biz.database.wallet.entity.DAppHistoryEntity.<init>(long, java.lang.String, java.lang.String, java.lang.String, double, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, int, long):void type: THIS */
    public /* synthetic */ DAppHistoryEntity(long j, String str, String str2, String str3, double d, String str4, String str5, String str6, String str7, int i, int i2, long j2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
