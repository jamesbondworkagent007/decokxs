...
public final class WalletRepository$getWalletByTypeSuspend$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends WalletEntity>>, Object> {
    ...
    public WalletRepository$getWalletByTypeSuspend$2(cQM cqm, List<Integer> list, Continuation<? super WalletRepository$getWalletByTypeSuspend$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WalletRepository$getWalletByTypeSuspend$2(this.this$0, this.$typeList, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<WalletEntity>> continuation) {
        return ((WalletRepository$getWalletByTypeSuspend$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC11384cMf.copydefault(list, this);
