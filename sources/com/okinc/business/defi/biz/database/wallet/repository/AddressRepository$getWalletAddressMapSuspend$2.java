...
public final class AddressRepository$getWalletAddressMapSuspend$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<String, ? extends List<? extends ChainAddressEntity>>>, Object> {
    ...
    public AddressRepository$getWalletAddressMapSuspend$2(cOG cog, List<String> list, List<Long> list2, Continuation<? super AddressRepository$getWalletAddressMapSuspend$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AddressRepository$getWalletAddressMapSuspend$2(this.this$0, this.$walletIds, this.$chainIds, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Map<String, ? extends List<ChainAddressEntity>>> continuation) {
        return ((AddressRepository$getWalletAddressMapSuspend$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC11289cIs.KWHzl(list, list2, this);
