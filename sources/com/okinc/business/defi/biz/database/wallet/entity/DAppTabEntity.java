...
public final class DAppTabEntity {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final DAppTabEntity copy(long j, @NotNull String str, @NotNull String str2, @NotNull String str3, double d, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, int i, int i2, long j2) {
        ...
        return new DAppTabEntity(j, str, str2, str3, d, str4, str5, str6, str7, i, i2, j2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DAppTabEntity)) {
            return false;
        }
        DAppTabEntity dAppTabEntity = (DAppTabEntity) obj;
        return this.id == dAppTabEntity.id && Intrinsics.EZpvd((Object) this.platform, (Object) dAppTabEntity.platform) && Intrinsics.EZpvd((Object) this.logo, (Object) dAppTabEntity.logo) && Intrinsics.EZpvd((Object) this.network, (Object) dAppTabEntity.network) && Double.compare(this.tvl, dAppTabEntity.tvl) == 0 && Intrinsics.EZpvd((Object) this.intro, (Object) dAppTabEntity.intro) && Intrinsics.EZpvd((Object) this.tag, (Object) dAppTabEntity.tag) && Intrinsics.EZpvd((Object) this.type, (Object) dAppTabEntity.type) && Intrinsics.EZpvd((Object) this.url, (Object) dAppTabEntity.url) && this.dau == dAppTabEntity.dau && this.order == dAppTabEntity.order && this.timeStamp == dAppTabEntity.timeStamp;
    }
    ...
    public String toString() {
        return "DAppTabEntity(id=" + this.id + ", platform=" + this.platform + ", logo=" + this.logo + ", network=" + this.network + ", tvl=" + this.tvl + ", intro=" + this.intro + ", tag=" + this.tag + ", type=" + this.type + ", url=" + this.url + ", dau=" + this.dau + ", order=" + this.order + ", timeStamp=" + this.timeStamp + ")";
    }

    public DAppTabEntity(long j, @NotNull String str, @NotNull String str2, @NotNull String str3, double d, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, int i, int i2, long j2) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        Intrinsics.checkNotNullParameter(str3, "");
        Intrinsics.checkNotNullParameter(str4, "");
 ...
 A[MD:(long, java.lang.String, java.lang.String, java.lang.String, double, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, int, long):void (m)] (LINE:9) call: com.okinc.business.defi.biz.database.wallet.entity.DAppTabEntity.<init>(long, java.lang.String, java.lang.String, java.lang.String, double, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, int, long):void type: THIS */
    public /* synthetic */ DAppTabEntity(long j, String str, String str2, String str3, double d, String str4, String str5, String str6, String str7, int i, int i2, long j2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
