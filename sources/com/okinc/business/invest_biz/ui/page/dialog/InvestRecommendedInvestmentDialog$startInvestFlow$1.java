...
import com.okinc.business.invest_biz.ui.page.dialog.InvestRecommendedInvestmentDialog$startInvestFlow$1;
...
public final class InvestRecommendedInvestmentDialog$startInvestFlow$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InvestRecommendedInvestmentDialog$startInvestFlow$1(InvestRecommendedInvestmentDialog investRecommendedInvestmentDialog, long j, boolean z, Continuation<? super InvestRecommendedInvestmentDialog$startInvestFlow$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InvestRecommendedInvestmentDialog$startInvestFlow$1(this.this$0, this.$investmentId, this.$hasMultipleProtocols, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((InvestRecommendedInvestmentDialog$startInvestFlow$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            List<TokenInvestDetail> value = this.this$0.djBIcL().AEQbTJ().getValue();
            if (value != null) {
            ...
            if (t == 0) {
                this.this$0.AYXKKw();
                C27103joq c27103joqDjBIcL = this.this$0.djBIcL();
                long j2 = this.$investmentId;
                this.L$0 = objectRef;
                this.L$1 = objectRef;
                this.label = 1;
                objCopydefault = c27103joqDjBIcL.copydefault(j2, this);
                ...
                this.L$1 = null;
                this.label = 2;
                if (BuildersKt.withContext(main, anonymousClass1, this) == objCopydefault2) {
                    return objCopydefault2;
                }
        ...
        TokenInvestDetailResponse tokenInvestDetailResponse = (TokenInvestDetailResponse) objCopydefault;
    ...
    /* JADX INFO: renamed from: com.okinc.business.invest_biz.ui.page.dialog.InvestRecommendedInvestmentDialog$startInvestFlow$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(Ref.ObjectRef<TokenInvestDetail> objectRef, InvestRecommendedInvestmentDialog investRecommendedInvestmentDialog, long j, boolean z, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                if (this.$detail.element != null) {
                    C26588jfE c26588jfEValueOf = this.this$0.valueOf();
                    long j = this.$investmentId;
                    ...
                    c26588jfEValueOf.copydefault(j, tokenInvestDetail, (68 & 4) != 0 ? false : z, (68 & 8) != 0 ? InvestPageSource.Default : investPageSource, (68 & 16) != 0 ? null : null, (68 & 32) != 0 ? null : new Function0() { // from class: o.iUc
                        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                        @Override // kotlin.jvm.functions.Function0
                        public final java.lang.Object invoke() {
                            return InvestRecommendedInvestmentDialog$startInvestFlow$1.AnonymousClass1.invokeSuspend$lambda$0(investRecommendedInvestmentDialog);
                        }
                    }, (68 & 64) != 0 ? false : false);
                }
                return Unit.INSTANCE;
        ...
        public static final Unit invokeSuspend$lambda$0(InvestRecommendedInvestmentDialog investRecommendedInvestmentDialog) {
            investRecommendedInvestmentDialog.dismissAllowingStateLoss();
            return Unit.INSTANCE;
        }
    }
}
