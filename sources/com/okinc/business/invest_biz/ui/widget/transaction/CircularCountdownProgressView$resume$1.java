...
public final class CircularCountdownProgressView$resume$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ int $elapsedSeconds;
    int I$0;
    long J$0;
    long J$1;
    int label;
    ...
    public CircularCountdownProgressView$resume$1(int i, C27446jvO c27446jvO, Continuation<? super CircularCountdownProgressView$resume$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CircularCountdownProgressView$resume$1(this.$elapsedSeconds, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CircularCountdownProgressView$resume$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:14:0x0057 -> B:16:0x005a). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            long j3 = ((long) this.$elapsedSeconds) * 1000;
            i = 0;
