...
public final class InvestRedeemViewModel$reloadCTAButton$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InvestRedeemViewModel$reloadCTAButton$1(InvestRedeemViewModel investRedeemViewModel, List<TransactionStep> list, Continuation<? super InvestRedeemViewModel$reloadCTAButton$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InvestRedeemViewModel$reloadCTAButton$1(this.this$0, this.$trxSteps, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((InvestRedeemViewModel$reloadCTAButton$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            PromptInformation promptInformation = this.this$0.values().getPromptInformation();
            ...
            TransactionStage transactionStageAhwBna = this.this$0.AhwBna();
            List<TransactionStep> list = this.$trxSteps;
            this.L$0 = c24177iXtKWHzl;
            this.label = 1;
            Object objEZpvd = ixhValueOf.EZpvd(transactionStageAhwBna, list, c24177iXtKWHzl, this);
        ...
        if (Result.m7384isSuccessimpl(objM7386unboximpl)) {
            investRedeemViewModel.OLrzqt.setValue((InterfaceC24173iXp) objM7386unboximpl);
        }
        ...
        if (thM7380exceptionOrNullimpl != null) {
            ...
            investRedeemViewModel2.OLrzqt.setValue(new InterfaceC24173iXp.ActionBar(c24177iXt));
        }
