...
public final class SingleRedeemTransactionFragment$onInputChange$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ boolean $isMax;
    final /* synthetic */ String $newInput;
    int label;
    final /* synthetic */ C26773jie this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SingleRedeemTransactionFragment$onInputChange$1(C26773jie c26773jie, boolean z, String str, Continuation<? super SingleRedeemTransactionFragment$onInputChange$1> continuation) {
        super(2, continuation);
        this.this$0 = c26773jie;
        this.$isMax = z;
        this.$newInput = str;
    }
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SingleRedeemTransactionFragment$onInputChange$1(this.this$0, this.$isMax, this.$newInput, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SingleRedeemTransactionFragment$onInputChange$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
