...
public final class HomeV2TabsUseCaseImpl$invoke$1 extends ContinuationImpl {
    public int label;
    ...
    public HomeV2TabsUseCaseImpl$invoke$1(iFT ift, Continuation<? super HomeV2TabsUseCaseImpl$invoke$1> continuation) {
        super(continuation);
        this.this$0 = ift;
    }
