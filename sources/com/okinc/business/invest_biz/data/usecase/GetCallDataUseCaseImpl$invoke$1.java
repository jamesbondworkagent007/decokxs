...
public final class GetCallDataUseCaseImpl$invoke$1 extends ContinuationImpl {
    public int label;
    ...
    public GetCallDataUseCaseImpl$invoke$1(iFG ifg, Continuation<? super GetCallDataUseCaseImpl$invoke$1> continuation) {
        super(continuation);
        this.this$0 = ifg;
    }
