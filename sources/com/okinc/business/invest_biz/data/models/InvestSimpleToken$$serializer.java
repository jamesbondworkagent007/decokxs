...
public final /* synthetic */ class InvestSimpleToken$$serializer implements GeneratedSerializer<InvestSimpleToken> {
    public static final int $stable;
    public static final InvestSimpleToken$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InvestSimpleToken$$serializer() {
    }
    ...
    static {
        InvestSimpleToken$$serializer investSimpleToken$$serializer = new InvestSimpleToken$$serializer();
        INSTANCE = investSimpleToken$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.models.InvestSimpleToken", investSimpleToken$$serializer, 6);
    ...
    public final InvestSimpleToken deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        int i;
        String str3;
        ...
        return new InvestSimpleToken(i, l, str5, str4, str2, str3, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InvestSimpleToken investSimpleToken) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(investSimpleToken, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InvestSimpleToken.write$Self$OKDeFi_invest_biz(investSimpleToken, compositeEncoderBeginStructure, serialDescriptor);
