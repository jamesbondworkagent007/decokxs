...
public final class InvestWebSocketManager$special$$inlined$createWebSocket$1 extends SuspendLambda implements Function2<ProducerScope<? super InvestTransactionModel>, Continuation<? super Unit>, Object> {
    ...
    public InvestWebSocketManager$special$$inlined$createWebSocket$1(String str, C23597iCg c23597iCg, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        InvestWebSocketManager$special$$inlined$createWebSocket$1 investWebSocketManager$special$$inlined$createWebSocket$1 = new InvestWebSocketManager$special$$inlined$createWebSocket$1(this.$channelId, this.this$0, continuation);
        investWebSocketManager$special$$inlined$createWebSocket$1.L$0 = obj;
        return investWebSocketManager$special$$inlined$createWebSocket$1;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Method merged with bridge method: invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object; */
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(ProducerScope<? super InvestTransactionModel> producerScope, Continuation<? super Unit> continuation) {
        return ((InvestWebSocketManager$special$$inlined$createWebSocket$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                abstractC57556ykeAEQbTJ = C57554ykc.Companion.AEQbTJ(this.$channelId, this.this$0.KWHzl(), yDY.copydefault(new WsArgV5(this.$channelId, null, null, null, null, null, null, null, 254, null)), new Function2<AbstractC33132mqg, OKIncomingData, Unit>() { // from class: com.okinc.business.invest_biz.data.logic.ws.InvestWebSocketManager$special$$inlined$createWebSocket$1.3
                    ...
                    public final void copydefault(AbstractC33132mqg abstractC33132mqg, OKIncomingData oKIncomingData) {
                        ...
                        try {
                            producerScope.mo5769trySendJP2dKIU((InvestTransactionModel) C33489mxS.KWHzl.OLrzqt((DeserializationStrategy) InvestTransactionModel.Companion.serializer(), str));
                        } catch (Throwable th) {
            ...
            Function0<Unit> function0 = new Function0<Unit>() { // from class: com.okinc.business.invest_biz.data.logic.ws.InvestWebSocketManager$special$$inlined$createWebSocket$1.1
