...
public final /* synthetic */ class PositionExtInfo$$serializer implements GeneratedSerializer<PositionExtInfo> {
    public static final int $stable;
    public static final PositionExtInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PositionExtInfo$$serializer() {
    }
    ...
    static {
        PositionExtInfo$$serializer positionExtInfo$$serializer = new PositionExtInfo$$serializer();
        INSTANCE = positionExtInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.bean.PositionExtInfo", positionExtInfo$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement(JwtUtilsKt.DID_METHOD_KEY, true);
        pluginGeneratedSerialDescriptor.addElement("value", true);
        pluginGeneratedSerialDescriptor.addElement("typeEnum", true);
    ...
    public final PositionExtInfo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new PositionExtInfo(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PositionExtInfo positionExtInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(positionExtInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PositionExtInfo.write$Self$OKDeFi_invest_biz(positionExtInfo, compositeEncoderBeginStructure, serialDescriptor);
