...
public final /* synthetic */ class NetworkTotal$$serializer implements GeneratedSerializer<NetworkTotal> {
    public static final int $stable;
    public static final NetworkTotal$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NetworkTotal$$serializer() {
    }
    ...
    static {
        NetworkTotal$$serializer networkTotal$$serializer = new NetworkTotal$$serializer();
        INSTANCE = networkTotal$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.bean.response.NetworkTotal", networkTotal$$serializer, 6);
        ...
        pluginGeneratedSerialDescriptor.addElement("totalCurrencyAmount", true);
    ...
    public final NetworkTotal deserialize(@NotNull Decoder decoder) {
        ...
        return new NetworkTotal(i, j, str2, str, str3, str4, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NetworkTotal networkTotal) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(networkTotal, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NetworkTotal.AEQbTJ(networkTotal, compositeEncoderBeginStructure, serialDescriptor);
