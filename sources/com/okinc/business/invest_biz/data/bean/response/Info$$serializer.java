...
public final /* synthetic */ class Info$$serializer implements GeneratedSerializer<Info> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.bean.response.Info", info$$serializer, 3);
    ...
    public final Info deserialize(@NotNull Decoder decoder) {
        ...
        return new Info(i, str, str2, strDecodeStringElement, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Info info) {
        ...
        Info.KWHzl(info, compositeEncoderBeginStructure, serialDescriptor);
