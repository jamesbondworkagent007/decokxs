...
public final /* synthetic */ class SwapSlippageConfig$$serializer implements GeneratedSerializer<SwapSlippageConfig> {
    public static final int $stable;
    public static final SwapSlippageConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SwapSlippageConfig$$serializer() {
    }
    ...
    static {
        SwapSlippageConfig$$serializer swapSlippageConfig$$serializer = new SwapSlippageConfig$$serializer();
        INSTANCE = swapSlippageConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.bean.SwapSlippageConfig", swapSlippageConfig$$serializer, 10);
        ...
        pluginGeneratedSerialDescriptor.addElement("autoCustomMin", true);
        pluginGeneratedSerialDescriptor.addElement("autoCustomMax", true);
    ...
    public final SwapSlippageConfig deserialize(@NotNull Decoder decoder) {
        ...
        return new SwapSlippageConfig(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SwapSlippageConfig swapSlippageConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(swapSlippageConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SwapSlippageConfig.write$Self$OKDeFi_invest_biz(swapSlippageConfig, compositeEncoderBeginStructure, serialDescriptor);
