...
public final /* synthetic */ class InvestLogo$$serializer implements GeneratedSerializer<InvestLogo> {
    public static final int $stable;
    public static final InvestLogo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InvestLogo$$serializer() {
    }
    ...
    static {
        InvestLogo$$serializer investLogo$$serializer = new InvestLogo$$serializer();
        INSTANCE = investLogo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.bean.InvestLogo", investLogo$$serializer, 4);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = InvestLogo.$childSerializers;
    ...
    public final InvestLogo deserialize(@NotNull Decoder decoder) {
        int i;
        List list;
        List list2;
        List list3;
        ...
        return new InvestLogo(i, list4, list3, list, list2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InvestLogo investLogo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(investLogo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InvestLogo.write$Self$OKDeFi_invest_biz(investLogo, compositeEncoderBeginStructure, serialDescriptor);
