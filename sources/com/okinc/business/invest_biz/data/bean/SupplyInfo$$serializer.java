...
public final /* synthetic */ class SupplyInfo$$serializer implements GeneratedSerializer<SupplyInfo> {
    public static final int $stable;
    public static final SupplyInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SupplyInfo$$serializer() {
    }
    ...
    static {
        SupplyInfo$$serializer supplyInfo$$serializer = new SupplyInfo$$serializer();
        INSTANCE = supplyInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.business.invest_biz.data.bean.SupplyInfo", supplyInfo$$serializer, 5);
    ...
    public final SupplyInfo deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        HoverData hoverData;
        ...
        return new SupplyInfo(i, str3, str, str2, hoverData, iDecodeIntElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SupplyInfo supplyInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(supplyInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SupplyInfo.copydefault(supplyInfo, compositeEncoderBeginStructure, serialDescriptor);
