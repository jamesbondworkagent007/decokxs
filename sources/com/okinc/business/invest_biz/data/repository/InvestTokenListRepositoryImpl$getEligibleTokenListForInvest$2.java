...
public final class InvestTokenListRepositoryImpl$getEligibleTokenListForInvest$2 extends SuspendLambda implements Function1<Continuation<? super List<? extends InvestTokenWithAmount>>, Object> {
    ...
    public InvestTokenListRepositoryImpl$getEligibleTokenListForInvest$2(iDB idb, String str, long j, long j2, Continuation<? super InvestTokenListRepositoryImpl$getEligibleTokenListForInvest$2> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new InvestTokenListRepositoryImpl$getEligibleTokenListForInvest$2(this.this$0, this.$walletId, this.$chainId, this.$investmentId, continuation);
    }
    ...
    public final Object invoke2(Continuation<? super List<InvestTokenWithAmount>> continuation) {
        return ((InvestTokenListRepositoryImpl$getEligibleTokenListForInvest$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = interfaceC25472ixPOLrzqt.AEQbTJ(j, str, strEZpvd, this);
