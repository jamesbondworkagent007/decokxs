...
public final class InvestSpRepositoryImpl$runOnIo$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends T>>, Object> {
    ...
    public InvestSpRepositoryImpl$runOnIo$2(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super InvestSpRepositoryImpl$runOnIo$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Intrinsics.OLrzqt();
        return new InvestSpRepositoryImpl$runOnIo$2(this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Result<? extends T>> continuation) {
        return ((InvestSpRepositoryImpl$runOnIo$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
