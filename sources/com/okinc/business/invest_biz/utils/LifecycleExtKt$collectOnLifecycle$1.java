...
public final class LifecycleExtKt$collectOnLifecycle$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public LifecycleExtKt$collectOnLifecycle$1(LifecycleOwner lifecycleOwner, Lifecycle.State state, Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super LifecycleExtKt$collectOnLifecycle$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LifecycleExtKt$collectOnLifecycle$1(this.$this_collectOnLifecycle, this.$state, this.$flow, this.$collector, continuation);
    }
    ...
    /* JADX INFO: renamed from: com.okinc.business.invest_biz.utils.LifecycleExtKt$collectOnLifecycle$1$1, reason: invalid class name */
