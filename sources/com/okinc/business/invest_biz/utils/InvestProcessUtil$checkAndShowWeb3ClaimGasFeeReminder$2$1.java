...
public final class InvestProcessUtil$checkAndShowWeb3ClaimGasFeeReminder$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InvestProcessUtil$checkAndShowWeb3ClaimGasFeeReminder$2$1(InvestGetGasFeeRequest investGetGasFeeRequest, String str, CancellableContinuation<? super Boolean> cancellableContinuation, FragmentManager fragmentManager, Continuation<? super InvestProcessUtil$checkAndShowWeb3ClaimGasFeeReminder$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InvestProcessUtil$checkAndShowWeb3ClaimGasFeeReminder$2$1(this.$request, this.$totalRewards, this.$continuation, this.$fragmentManager, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((InvestProcessUtil$checkAndShowWeb3ClaimGasFeeReminder$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                obj = c25592izd.EZpvd(investGetGasFeeRequest, this);
