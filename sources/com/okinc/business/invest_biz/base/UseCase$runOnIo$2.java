...
public final class UseCase$runOnIo$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends T>>, Object> {
    ...
    public UseCase$runOnIo$2(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super UseCase$runOnIo$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UseCase$runOnIo$2(this.$block, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Result<? extends T>> continuation) {
        return ((UseCase$runOnIo$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
