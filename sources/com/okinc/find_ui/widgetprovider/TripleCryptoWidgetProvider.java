...
public final class TripleCryptoWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(@NotNull Context context, @NotNull AppWidgetManager appWidgetManager, @NotNull int[] iArr) {
        ...
        C43296rmc.AEQbTJ("CryptoWidgetProvider", " TripleCryptoWidgetProvider onUpdate() called with: context = " + context + ", appWidgetManager = " + appWidgetManager + ", appWidgetIds = " + iArr);
        WorkManager.getInstance(context).enqueue(new OneTimeWorkRequest.Builder(TripleCryptoWidgetWorker.class).build());
    ...
    public void onDeleted(@NotNull Context context, @NotNull int[] iArr) {
        ...
        Intrinsics.checkNotNullParameter(iArr, "");
        for (int i : iArr) {
            C35192nqg.EZpvd(context, i, "TRIPLE_COIN_PREFS_KEY_STRING");
        }
    }
    ...
    public void onEnabled(@NotNull Context context) throws Throwable {
        Intrinsics.checkNotNullParameter(context, "");
        C32866mlf.onEvent$default("MobileWidget_Initialize_AddWidget_Click", (TrackChannel[]) null, new Function1() { // from class: o.npE
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj) {
                return TripleCryptoWidgetProvider.EZpvd((EventParamsList) obj);
            }
        }, 1, (Object) null);
