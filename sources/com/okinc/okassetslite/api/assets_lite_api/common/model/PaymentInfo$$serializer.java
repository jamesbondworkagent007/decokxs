...
public final /* synthetic */ class PaymentInfo$$serializer implements GeneratedSerializer<PaymentInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okassetslite.api.assets_lite_api.common.model.PaymentInfo", paymentInfo$$serializer, 1);
    ...
    public final PaymentInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new PaymentInfo(i, str, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull PaymentInfo paymentInfo) {
        ...
        PaymentInfo.write$Self$OKAssetsLite_assets_lite_api(paymentInfo, compositeEncoderBeginStructure, serialDescriptor);
