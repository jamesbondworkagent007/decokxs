...
public final /* synthetic */ class MarketCapRank$$serializer implements GeneratedSerializer<MarketCapRank> {
    public static final int $stable;
    public static final MarketCapRank$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MarketCapRank$$serializer() {
    }
    ...
    static {
        MarketCapRank$$serializer marketCapRank$$serializer = new MarketCapRank$$serializer();
        INSTANCE = marketCapRank$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_find.data.MarketCapRank", marketCapRank$$serializer, 9);
        pluginGeneratedSerialDescriptor.addElement("instId", true);
        pluginGeneratedSerialDescriptor.addElement("instType", true);
        pluginGeneratedSerialDescriptor.addElement("iconV2", true);
        ...
        pluginGeneratedSerialDescriptor.addElement("ccyV2", true);
    ...
    public final MarketCapRank deserialize(@NotNull Decoder decoder) {
        ...
        return new MarketCapRank(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MarketCapRank marketCapRank) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(marketCapRank, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MarketCapRank.write$Self$OKMarket_market_impl(marketCapRank, compositeEncoderBeginStructure, serialDescriptor);
