...
public final /* synthetic */ class RankListRequest$$serializer implements GeneratedSerializer<RankListRequest> {
    public static final int $stable;
    public static final RankListRequest$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RankListRequest$$serializer() {
    }
    ...
    static {
        RankListRequest$$serializer rankListRequest$$serializer = new RankListRequest$$serializer();
        INSTANCE = rankListRequest$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_find.data.RankListRequest", rankListRequest$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("plateType", true);
    ...
    public final RankListRequest deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new RankListRequest(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RankListRequest rankListRequest) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(rankListRequest, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RankListRequest.write$Self$OKMarket_market_impl(rankListRequest, compositeEncoderBeginStructure, serialDescriptor);
