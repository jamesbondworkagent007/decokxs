...
public final /* synthetic */ class OKTDexTPSLStrategy$StopLoss$$serializer implements GeneratedSerializer<OKTDexTPSLStrategy.StopLoss> {
    public static final int $stable;
    public static final OKTDexTPSLStrategy$StopLoss$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OKTDexTPSLStrategy$StopLoss$$serializer() {
    }
    ...
    static {
        OKTDexTPSLStrategy$StopLoss$$serializer oKTDexTPSLStrategy$StopLoss$$serializer = new OKTDexTPSLStrategy$StopLoss$$serializer();
        INSTANCE = oKTDexTPSLStrategy$StopLoss$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("stopLoss", oKTDexTPSLStrategy$StopLoss$$serializer, 4);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = OKTDexTPSLStrategy.StopLoss.$childSerializers;
    ...
    public final OKTDexTPSLStrategy.StopLoss deserialize(@NotNull Decoder decoder) {
        int i;
        ...
        return new OKTDexTPSLStrategy.StopLoss(i, str2, str, dexTPSLLabelType, dexTPSLLabelType2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OKTDexTPSLStrategy.StopLoss stopLoss) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(stopLoss, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OKTDexTPSLStrategy.StopLoss.KWHzl(stopLoss, compositeEncoderBeginStructure, serialDescriptor);
