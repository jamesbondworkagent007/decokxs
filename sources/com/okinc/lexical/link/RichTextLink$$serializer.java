...
public final /* synthetic */ class RichTextLink$$serializer implements GeneratedSerializer<RichTextLink> {
    public static final int $stable;
    public static final RichTextLink$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RichTextLink$$serializer() {
    }
    ...
    static {
        RichTextLink$$serializer richTextLink$$serializer = new RichTextLink$$serializer();
        INSTANCE = richTextLink$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.lexical.link.RichTextLink", richTextLink$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = RichTextLink.$childSerializers;
    ...
    public final RichTextLink deserialize(@NotNull Decoder decoder) {
        String str;
        int i;
        ...
        return new RichTextLink(i, i2, str2, i3, str, list, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RichTextLink richTextLink) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(richTextLink, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RichTextLink.write$Self$OKGrowthTools_biz_rewards(richTextLink, compositeEncoderBeginStructure, serialDescriptor);
