...
public final /* synthetic */ class RichTextTable$$serializer implements GeneratedSerializer<RichTextTable> {
    public static final int $stable;
    public static final RichTextTable$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RichTextTable$$serializer() {
    }
    ...
    static {
        RichTextTable$$serializer richTextTable$$serializer = new RichTextTable$$serializer();
        INSTANCE = richTextTable$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.lexical.table.RichTextTable", richTextTable$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = RichTextTable.$childSerializers;
    ...
    public final RichTextTable deserialize(@NotNull Decoder decoder) {
        String str;
        int i;
        ...
        return new RichTextTable(i, i2, str2, i3, str, list, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RichTextTable richTextTable) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(richTextTable, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RichTextTable.write$Self$OKGrowthTools_biz_rewards(richTextTable, compositeEncoderBeginStructure, serialDescriptor);
