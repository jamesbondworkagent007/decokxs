...
public final class TwoFactorAuthRepository$submitNonAuthRebind2fa$1 extends SuspendLambda implements Function2<FlowCollector<? super TwoFactorAuth<Object>>, Continuation<? super Unit>, Object> {
    ...
    public TwoFactorAuthRepository$submitNonAuthRebind2fa$1(C6660aTY c6660aTY, SubdomainStrategy subdomainStrategy, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Continuation<? super TwoFactorAuthRepository$submitNonAuthRebind2fa$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TwoFactorAuthRepository$submitNonAuthRebind2fa$1 twoFactorAuthRepository$submitNonAuthRebind2fa$1 = new TwoFactorAuthRepository$submitNonAuthRebind2fa$1(this.this$0, this.$subdomainStrategy, this.$workflowToken, this.$newAreaCode, this.$newPhone, this.$newPhoneCode, this.$newEmail, this.$newEmailCode, this.$areaCode, this.$loginName, continuation);
        twoFactorAuthRepository$submitNonAuthRebind2fa$1.L$0 = obj;
        return twoFactorAuthRepository$submitNonAuthRebind2fa$1;
    }
    ...
    public final Object invoke(FlowCollector<? super TwoFactorAuth<Object>> flowCollector, Continuation<? super Unit> continuation) {
        return ((TwoFactorAuthRepository$submitNonAuthRebind2fa$1) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            SubmitRebindMfaRequest submitRebindMfaRequest = new SubmitRebindMfaRequest(str, str2, str3, str4, str5, str6, str7, str8);
            this.L$0 = flowCollector;
            this.label = 1;
            objNonAuthSubmit = reset2faRemoteDataSource.nonAuthSubmit(subdomainStrategy, submitRebindMfaRequest, this);
            if (objNonAuthSubmit == objCopydefault) {
            ...
            flowCollector = (FlowCollector) this.L$0;
            C56391yDq.AEQbTJ(obj);
            objNonAuthSubmit = obj;
        }
        responseData = (ResponseData) objNonAuthSubmit;
