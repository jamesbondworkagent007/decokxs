...
public final class OtpViewModel$requestPhoneOtpForRebind2fa$3 extends SuspendLambda implements yHO<FlowCollector<? super Otp>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public OtpViewModel$requestPhoneOtpForRebind2fa$3(OtpAction otpAction, OtpViewModel otpViewModel, Continuation<? super OtpViewModel$requestPhoneOtpForRebind2fa$3> continuation) {
    ...
    public final Object invoke(FlowCollector<? super Otp> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
        OtpViewModel$requestPhoneOtpForRebind2fa$3 otpViewModel$requestPhoneOtpForRebind2fa$3 = new OtpViewModel$requestPhoneOtpForRebind2fa$3(this.$otpAction, this.this$0, continuation);
        otpViewModel$requestPhoneOtpForRebind2fa$3.L$0 = flowCollector;
        otpViewModel$requestPhoneOtpForRebind2fa$3.L$1 = th;
        return otpViewModel$requestPhoneOtpForRebind2fa$3.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i != 0) {
            ...
            if (otpError != null) {
                ...
                int i2 = TaskDescription.OLrzqt[otpAction.ordinal()];
                if (i2 == 1) {
                ...
                int i3 = TaskDescription.OLrzqt[otpAction2.ordinal()];
                if (i3 == 1) {
