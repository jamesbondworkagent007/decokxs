...
public final class OtpViewModel$requestEmailOtpForRebind2fa$2 extends SuspendLambda implements Function2<Otp, Continuation<? super Unit>, Object> {
    ...
    public OtpViewModel$requestEmailOtpForRebind2fa$2(OtpAction otpAction, OtpViewModel otpViewModel, Continuation<? super OtpViewModel$requestEmailOtpForRebind2fa$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OtpViewModel$requestEmailOtpForRebind2fa$2(this.$otpAction, this.this$0, continuation);
    }
    ...
    public final Object invoke(Otp otp, Continuation<? super Unit> continuation) {
        return ((OtpViewModel$requestEmailOtpForRebind2fa$2) create(otp, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            int i2 = Activity.EZpvd[this.$otpAction.ordinal()];
            if (i2 == 1) {
