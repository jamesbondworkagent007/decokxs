...
public final class OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$1 extends SuspendLambda implements Function2<FlowCollector<? super Otp>, Continuation<? super Unit>, Object> {
    ...
    public OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$1(OtpAction otpAction, OtpViewModel otpViewModel, Continuation<? super OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$1(this.$otpAction, this.this$0, continuation);
    }
    ...
    public final Object invoke(FlowCollector<? super Otp> flowCollector, Continuation<? super Unit> continuation) {
        return ((OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$1) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            int i2 = StateListAnimator.copydefault[this.$otpAction.ordinal()];
            if (i2 == 1) {
