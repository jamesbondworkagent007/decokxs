...
public final class OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$2 extends SuspendLambda implements Function2<Otp, Continuation<? super Unit>, Object> {
    ...
    public OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$2(OtpAction otpAction, OtpViewModel otpViewModel, int i, Continuation<? super OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$2(this.$otpAction, this.this$0, this.$msgType, continuation);
    }
    ...
    public final Object invoke(Otp otp, Continuation<? super Unit> continuation) {
        return ((OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$2) create(otp, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            int i2 = Application.EZpvd[this.$otpAction.ordinal()];
            if (i2 == 1) {
