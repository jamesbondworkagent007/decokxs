...
public final class OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3 extends SuspendLambda implements yHO<FlowCollector<? super Otp>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3(OtpAction otpAction, OtpViewModel otpViewModel, Continuation<? super OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3> continuation) {
    ...
    public final Object invoke(FlowCollector<? super Otp> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
        OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3 otpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3 = new OtpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3(this.$otpAction, this.this$0, continuation);
        otpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3.L$0 = flowCollector;
        otpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3.L$1 = th;
        return otpViewModel$requestPhoneOtpForForgetPasswordRebind2fa$3.invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i != 0) {
            ...
            if (otpError != null) {
                ...
                int i2 = StateListAnimator.AEQbTJ[otpAction.ordinal()];
                if (i2 == 1) {
                    MutableSharedFlow mutableSharedFlow = otpViewModel.OLrzqt;
                    ...
                    MutableSharedFlow mutableSharedFlow2 = otpViewModel.OLrzqt;
                ...
                int i3 = StateListAnimator.AEQbTJ[otpAction2.ordinal()];
                if (i3 == 1) {
                    MutableSharedFlow mutableSharedFlow3 = otpViewModel2.OLrzqt;
                    ...
                    MutableSharedFlow mutableSharedFlow4 = otpViewModel2.OLrzqt;
