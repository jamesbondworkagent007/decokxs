...
public final class PasskeyAuthenticateScenarioActivity$onCreate$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public PasskeyAuthenticateScenarioActivity$onCreate$1$1(PasskeyAuthenticateScenarioRequest passkeyAuthenticateScenarioRequest, ActivityC6005aHF activityC6005aHF, PasskeyAuthenticateRequest passkeyAuthenticateRequest, boolean z, Continuation<? super PasskeyAuthenticateScenarioActivity$onCreate$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PasskeyAuthenticateScenarioActivity$onCreate$1$1(this.$request, this.this$0, this.$it, this.$enableExternal, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((PasskeyAuthenticateScenarioActivity$onCreate$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
