...
public final class SecurityFido2AuthenticatorViewModel$checkPasskeyToggleStatus$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    Object L$0;
    int label;
    ...
    public SecurityFido2AuthenticatorViewModel$checkPasskeyToggleStatus$1(SecurityFido2AuthenticatorViewModel securityFido2AuthenticatorViewModel, Continuation<? super SecurityFido2AuthenticatorViewModel$checkPasskeyToggleStatus$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SecurityFido2AuthenticatorViewModel$checkPasskeyToggleStatus$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SecurityFido2AuthenticatorViewModel$checkPasskeyToggleStatus$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                ...
                if (Result.m7384isSuccessimpl(obj2)) {
                    PasskeyToggleInfoResponse passkeyToggleInfoResponse = (PasskeyToggleInfoResponse) obj2;
                    securityFido2AuthenticatorViewModel3.valueOf.setValue(C56443yFo.KWHzl(passkeyToggleInfoResponse.getShowFeatureToggle()));
                    securityFido2AuthenticatorViewModel3.values.setValue(C56443yFo.KWHzl(passkeyToggleInfoResponse.getFeatureToggleOn()));
                }
        ...
        C5915aFV c5915aFV = this.this$0.sSMYrx;
        this.label = 2;
        objAEQbTJ = c5915aFV.AEQbTJ(this);
