...
public final class SingleResetRemovePasskeyFragment$trackButton$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SingleResetRemovePasskeyFragment$trackButton$1(C6480aQD c6480aQD, String str, Continuation<? super SingleResetRemovePasskeyFragment$trackButton$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SingleResetRemovePasskeyFragment$trackButton$1(this.this$0, this.$action, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SingleResetRemovePasskeyFragment$trackButton$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (passkeyResetRemoveTypeAYXKKw instanceof PasskeyResetRemoveType.Remove) {
            ...
            C32866mlf.EZpvd("PasskeySingleRemove_Full_Button_Click", trackChannelArr, (Function1<? super EventParamsList, Unit>) new Function1() { // from class: o.aQG
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function1
                public final java.lang.Object invoke(java.lang.Object obj2) {
                    return SingleResetRemovePasskeyFragment$trackButton$1.invokeSuspend$lambda$0(str, zBooleanValue, (EventParamsList) obj2);
                }
            });
            ...
            C32866mlf.EZpvd("PasskeySingleReset_Full_Button_Click", trackChannelArr2, (Function1<? super EventParamsList, Unit>) new Function1() { // from class: o.aQH
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function1
                public final java.lang.Object invoke(java.lang.Object obj2) {
                    return SingleResetRemovePasskeyFragment$trackButton$1.invokeSuspend$lambda$1(str2, zBooleanValue, (EventParamsList) obj2);
                }
            });
        }
    ...
    public static final Unit invokeSuspend$lambda$0(String str, boolean z, EventParamsList eventParamsList) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit invokeSuspend$lambda$1(String str, boolean z, EventParamsList eventParamsList) {
        eventParamsList.put(EopTrackEvent.KEY_BUTTON_NAME, str, true);
        eventParamsList.put("flow", z ? "normal" : "notsupport", true);
        return Unit.INSTANCE;
    }
