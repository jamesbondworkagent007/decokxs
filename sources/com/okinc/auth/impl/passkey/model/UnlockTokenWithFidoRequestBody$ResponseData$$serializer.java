...
public final /* synthetic */ class UnlockTokenWithFidoRequestBody$ResponseData$$serializer implements GeneratedSerializer<UnlockTokenWithFidoRequestBody.ResponseData> {
    public static final int $stable;
    public static final UnlockTokenWithFidoRequestBody$ResponseData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private UnlockTokenWithFidoRequestBody$ResponseData$$serializer() {
    }
    ...
    static {
        UnlockTokenWithFidoRequestBody$ResponseData$$serializer unlockTokenWithFidoRequestBody$ResponseData$$serializer = new UnlockTokenWithFidoRequestBody$ResponseData$$serializer();
        INSTANCE = unlockTokenWithFidoRequestBody$ResponseData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.auth.impl.passkey.model.UnlockTokenWithFidoRequestBody.ResponseData", unlockTokenWithFidoRequestBody$ResponseData$$serializer, 4);
    ...
    public final UnlockTokenWithFidoRequestBody.ResponseData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new UnlockTokenWithFidoRequestBody.ResponseData(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull UnlockTokenWithFidoRequestBody.ResponseData responseData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(responseData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        UnlockTokenWithFidoRequestBody.ResponseData.KWHzl(responseData, compositeEncoderBeginStructure, serialDescriptor);
