...
public final class Reset2faUseCase$getPreLoginPreconditionFlow$1 extends SuspendLambda implements Function2<FlowCollector<? super C6623aSo.StateListAnimator>, Continuation<? super Unit>, Object> {
    ...
    public Reset2faUseCase$getPreLoginPreconditionFlow$1(C6623aSo c6623aSo, SubdomainStrategy subdomainStrategy, String str, Continuation<? super Reset2faUseCase$getPreLoginPreconditionFlow$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Reset2faUseCase$getPreLoginPreconditionFlow$1 reset2faUseCase$getPreLoginPreconditionFlow$1 = new Reset2faUseCase$getPreLoginPreconditionFlow$1(this.this$0, this.$subdomainStrategy, this.$token, continuation);
        reset2faUseCase$getPreLoginPreconditionFlow$1.L$0 = obj;
        return reset2faUseCase$getPreLoginPreconditionFlow$1;
    }
    ...
    public final Object invoke(FlowCollector<? super C6623aSo.StateListAnimator> flowCollector, Continuation<? super Unit> continuation) {
        return ((Reset2faUseCase$getPreLoginPreconditionFlow$1) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        this.label = 2;
        obj = reset2faRemoteDataSource.nonAuthPrecondition(subdomainStrategy, str, this);
        r12 = flowCollector;
