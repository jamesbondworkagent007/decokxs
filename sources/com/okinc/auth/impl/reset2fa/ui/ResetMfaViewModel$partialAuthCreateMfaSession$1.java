...
public final class ResetMfaViewModel$partialAuthCreateMfaSession$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ResetMfaViewModel$partialAuthCreateMfaSession$1(ResetMfaViewModel resetMfaViewModel, String str, SubdomainStrategy subdomainStrategy, Continuation<? super ResetMfaViewModel$partialAuthCreateMfaSession$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ResetMfaViewModel$partialAuthCreateMfaSession$1(this.this$0, this.$business, this.$subdomainStrategy, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ResetMfaViewModel$partialAuthCreateMfaSession$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C6621aSm c6621aSm = this.this$0.iwGUEr;
            PartialAuthMfaCreateSessionRequest partialAuthMfaCreateSessionRequest = new PartialAuthMfaCreateSessionRequest(this.$business);
            SubdomainStrategy subdomainStrategy = this.$subdomainStrategy;
            this.label = 1;
            objOLrzqt = c6621aSm.OLrzqt(partialAuthMfaCreateSessionRequest, subdomainStrategy, this);
        ...
        if (Result.m7384isSuccessimpl(objOLrzqt)) {
            MutableLiveData mutableLiveData2 = resetMfaViewModel2.valueOf;
            String sessionId = ((PartialAuthMfaCreateSessionResponse) objOLrzqt).getSessionId();
            if (sessionId == null) {
                sessionId = "";
            }
