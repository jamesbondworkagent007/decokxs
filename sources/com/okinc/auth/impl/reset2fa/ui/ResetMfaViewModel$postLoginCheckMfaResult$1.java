...
public final class ResetMfaViewModel$postLoginCheckMfaResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ResetMfaViewModel$postLoginCheckMfaResult$1(ResetMfaViewModel resetMfaViewModel, String str, Continuation<? super ResetMfaViewModel$postLoginCheckMfaResult$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ResetMfaViewModel$postLoginCheckMfaResult$1 resetMfaViewModel$postLoginCheckMfaResult$1 = new ResetMfaViewModel$postLoginCheckMfaResult$1(this.this$0, this.$mfaSessionId, continuation);
        resetMfaViewModel$postLoginCheckMfaResult$1.L$0 = obj;
        return resetMfaViewModel$postLoginCheckMfaResult$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ResetMfaViewModel$postLoginCheckMfaResult$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C5763aCc c5763aCc = this.this$0.AkhnZx;
            ...
            String workflowToken = resetMfaInitiateResponse != null ? resetMfaInitiateResponse.getWorkflowToken() : null;
            this.L$0 = coroutineScope;
            this.label = 1;
            objOLrzqt = c5763aCc.OLrzqt(str, workflowToken, this);
        ...
        if (Result.m7384isSuccessimpl(objOLrzqt)) {
            MfaCheckResultResponse mfaCheckResultResponse = (MfaCheckResultResponse) objOLrzqt;
            if (mfaCheckResultResponse == null) {
                resetMfaViewModel2.AEQbTJ.setValue(new C32989mnw(resetMfaViewModel2.DbNXlk(C8206ayP.Dialog.DPHNDa)));
            } else {
                String nextStep = mfaCheckResultResponse.getNextStep();
                if (nextStep == null) {
                    nextStep = "";
                }
