...
public final class OtpRepository$requestPhoneOtpForForgetRebind2fa$1 extends SuspendLambda implements Function2<FlowCollector<? super Otp>, Continuation<? super Unit>, Object> {
    ...
    public OtpRepository$requestPhoneOtpForForgetRebind2fa$1(C8211ayU c8211ayU, SubdomainStrategy subdomainStrategy, int i, String str, String str2, String str3, int i2, String str4, Continuation<? super OtpRepository$requestPhoneOtpForForgetRebind2fa$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        OtpRepository$requestPhoneOtpForForgetRebind2fa$1 otpRepository$requestPhoneOtpForForgetRebind2fa$1 = new OtpRepository$requestPhoneOtpForForgetRebind2fa$1(this.this$0, this.$subdomainStrategy, this.$behavior, this.$areaCode, this.$phone, this.$token, this.$msgType, this.$uuid, continuation);
        otpRepository$requestPhoneOtpForForgetRebind2fa$1.L$0 = obj;
        return otpRepository$requestPhoneOtpForForgetRebind2fa$1;
    }
    ...
    public final Object invoke(FlowCollector<? super Otp> flowCollector, Continuation<? super Unit> continuation) {
        return ((OtpRepository$requestPhoneOtpForForgetRebind2fa$1) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (r12 == 0) {
            ...
            SendSMSForRebind2faRequest sendSMSForRebind2faRequest = new SendSMSForRebind2faRequest(C56443yFo.AEQbTJ(i), str, str2, str3, C56443yFo.AEQbTJ(i2), str4);
            this.L$0 = flowCollector;
            this.label = 1;
            obj = reset2faRemoteDataSource.sendForgetPasswordReset2FaPhoneOtp(subdomainStrategy, sendSMSForRebind2faRequest, this);
            r12 = flowCollector;
