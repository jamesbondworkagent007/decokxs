...
public final class OtpRepository$requestPhoneOtpForRebind2fa$1 extends SuspendLambda implements Function2<FlowCollector<? super Otp>, Continuation<? super Unit>, Object> {
    ...
    public OtpRepository$requestPhoneOtpForRebind2fa$1(C8211ayU c8211ayU, SubdomainStrategy subdomainStrategy, int i, String str, String str2, String str3, int i2, String str4, Continuation<? super OtpRepository$requestPhoneOtpForRebind2fa$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        OtpRepository$requestPhoneOtpForRebind2fa$1 otpRepository$requestPhoneOtpForRebind2fa$1 = new OtpRepository$requestPhoneOtpForRebind2fa$1(this.this$0, this.$subdomainStrategy, this.$behavior, this.$areaCode, this.$phone, this.$token, this.$msgType, this.$uuid, continuation);
        otpRepository$requestPhoneOtpForRebind2fa$1.L$0 = obj;
        return otpRepository$requestPhoneOtpForRebind2fa$1;
    }
    ...
    public final Object invoke(FlowCollector<? super Otp> flowCollector, Continuation<? super Unit> continuation) {
        return ((OtpRepository$requestPhoneOtpForRebind2fa$1) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (r12 == 0) {
            ...
            this.label = 1;
            obj = reset2faRemoteDataSource.sendPhoneOtp(subdomainStrategy, sendSMSForRebind2faRequest, this);
            r12 = flowCollector;
