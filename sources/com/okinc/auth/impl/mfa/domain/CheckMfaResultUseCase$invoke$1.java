...
public final class CheckMfaResultUseCase$invoke$1 extends ContinuationImpl {
    public int label;
    ...
    public CheckMfaResultUseCase$invoke$1(C5763aCc c5763aCc, Continuation<? super CheckMfaResultUseCase$invoke$1> continuation) {
        super(continuation);
