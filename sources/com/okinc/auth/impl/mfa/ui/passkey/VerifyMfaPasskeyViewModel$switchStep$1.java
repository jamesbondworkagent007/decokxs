...
public final class VerifyMfaPasskeyViewModel$switchStep$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public VerifyMfaPasskeyViewModel$switchStep$1(VerifyMfaPasskeyViewModel verifyMfaPasskeyViewModel, OTP otp, MfaScenario mfaScenario, Continuation<? super VerifyMfaPasskeyViewModel$switchStep$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new VerifyMfaPasskeyViewModel$switchStep$1(this.this$0, this.$targetOtpType, this.$mfaScenario, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((VerifyMfaPasskeyViewModel$switchStep$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        switch (this.label) {
            case 0:
                ...
                C5776aCp c5776aCp = this.this$0.UeEOUB;
                ...
                this.label = 2;
                obj = c5776aCp.copydefault(str, otp, value, mfaScenario, this);
            ...
            case 1:
                C56391yDq.AEQbTJ(obj);
                C5776aCp c5776aCp2 = this.this$0.UeEOUB;
                str = (String) this.this$0.values.getValue();
                if (str == null) {
                }
                ...
                this.label = 2;
                obj = c5776aCp2.copydefault(str, otp2, value2, mfaScenario2, this);
                if (obj == objCopydefault) {
                }
                mfaResult = (MfaResult) obj;
                mutableSharedFlow = this.this$0.gEmmrt;
