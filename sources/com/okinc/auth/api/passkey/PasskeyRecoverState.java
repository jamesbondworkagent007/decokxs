...
public abstract class PasskeyRecoverState implements Parcelable {
    public static final int $stable = 0;

    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.auth.api.passkey.PasskeyRecoverState.<init>():void type: THIS */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public /* synthetic */ PasskeyRecoverState(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    private PasskeyRecoverState() {
    }

    /* JADX INFO: loaded from: classes17.dex */
    public static final class Success extends PasskeyRecoverState {
    ...
    /* JADX INFO: loaded from: classes17.dex */
    public static final class Close extends PasskeyRecoverState {
        public static final Close OLrzqt = new Close();
    ...
    /* JADX INFO: loaded from: classes17.dex */
    public static final class ResetInProgress extends PasskeyRecoverState {
