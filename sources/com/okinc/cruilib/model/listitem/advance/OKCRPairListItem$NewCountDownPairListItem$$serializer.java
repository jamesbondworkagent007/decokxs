...
public final /* synthetic */ class OKCRPairListItem$NewCountDownPairListItem$$serializer implements GeneratedSerializer<OKCRPairListItem.NewCountDownPairListItem> {
    public static final int $stable;
    public static final OKCRPairListItem$NewCountDownPairListItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OKCRPairListItem$NewCountDownPairListItem$$serializer() {
    }
    ...
    static {
        OKCRPairListItem$NewCountDownPairListItem$$serializer oKCRPairListItem$NewCountDownPairListItem$$serializer = new OKCRPairListItem$NewCountDownPairListItem$$serializer();
        INSTANCE = oKCRPairListItem$NewCountDownPairListItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.cruilib.model.listitem.advance.OKCRPairListItem.NewCountDownPairListItem", oKCRPairListItem$NewCountDownPairListItem$$serializer, 10);
        ...
        pluginGeneratedSerialDescriptor.addElement("countDown", false);
        pluginGeneratedSerialDescriptor.addElement("onlineTime", false);
    ...
    public final OKCRPairListItem.NewCountDownPairListItem deserialize(@NotNull Decoder decoder) {
        ...
        return new OKCRPairListItem.NewCountDownPairListItem(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, zDecodeBooleanElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OKCRPairListItem.NewCountDownPairListItem newCountDownPairListItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(newCountDownPairListItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OKCRPairListItem.NewCountDownPairListItem.write$Self$OKCRUILib_cr_uilib(newCountDownPairListItem, compositeEncoderBeginStructure, serialDescriptor);
