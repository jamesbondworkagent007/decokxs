...
public final /* synthetic */ class OKCRPairListItem$BotListItem$$serializer implements GeneratedSerializer<OKCRPairListItem.BotListItem> {
    public static final int $stable;
    public static final OKCRPairListItem$BotListItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OKCRPairListItem$BotListItem$$serializer() {
    }
    ...
    static {
        OKCRPairListItem$BotListItem$$serializer oKCRPairListItem$BotListItem$$serializer = new OKCRPairListItem$BotListItem$$serializer();
        INSTANCE = oKCRPairListItem$BotListItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.cruilib.model.listitem.advance.OKCRPairListItem.BotListItem", oKCRPairListItem$BotListItem$$serializer, 10);
        ...
        pluginGeneratedSerialDescriptor.addElement("strategyToDisplay", false);
        ...
        pluginGeneratedSerialDescriptor.addElement("isShowAPR", false);
    ...
    public final OKCRPairListItem.BotListItem deserialize(@NotNull Decoder decoder) {
        ...
        return new OKCRPairListItem.BotListItem(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, zDecodeBooleanElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OKCRPairListItem.BotListItem botListItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(botListItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OKCRPairListItem.BotListItem.write$Self$OKCRUILib_cr_uilib(botListItem, compositeEncoderBeginStructure, serialDescriptor);
