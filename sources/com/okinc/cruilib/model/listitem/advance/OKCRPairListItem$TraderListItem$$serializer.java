...
public final /* synthetic */ class OKCRPairListItem$TraderListItem$$serializer implements GeneratedSerializer<OKCRPairListItem.TraderListItem> {
    public static final int $stable;
    public static final OKCRPairListItem$TraderListItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OKCRPairListItem$TraderListItem$$serializer() {
    }
    ...
    static {
        OKCRPairListItem$TraderListItem$$serializer oKCRPairListItem$TraderListItem$$serializer = new OKCRPairListItem$TraderListItem$$serializer();
        INSTANCE = oKCRPairListItem$TraderListItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.cruilib.model.listitem.advance.OKCRPairListItem.TraderListItem", oKCRPairListItem$TraderListItem$$serializer, 9);
        ...
        pluginGeneratedSerialDescriptor.addElement("defaultHeadPictureId", false);
        pluginGeneratedSerialDescriptor.addElement("name", false);
        pluginGeneratedSerialDescriptor.addElement("aum", false);
        pluginGeneratedSerialDescriptor.addElement("description", false);
        pluginGeneratedSerialDescriptor.addElement("jumpParam", false);
    ...
    public final OKCRPairListItem.TraderListItem deserialize(@NotNull Decoder decoder) {
        ...
        return new OKCRPairListItem.TraderListItem(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OKCRPairListItem.TraderListItem traderListItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(traderListItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OKCRPairListItem.TraderListItem.write$Self$OKCRUILib_cr_uilib(traderListItem, compositeEncoderBeginStructure, serialDescriptor);
