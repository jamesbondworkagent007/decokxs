...
public final /* synthetic */ class OKCRTokenListItem$TokenEarnCardItem$$serializer implements GeneratedSerializer<OKCRTokenListItem.TokenEarnCardItem> {
    public static final int $stable;
    public static final OKCRTokenListItem$TokenEarnCardItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OKCRTokenListItem$TokenEarnCardItem$$serializer() {
    }
    ...
    static {
        OKCRTokenListItem$TokenEarnCardItem$$serializer oKCRTokenListItem$TokenEarnCardItem$$serializer = new OKCRTokenListItem$TokenEarnCardItem$$serializer();
        INSTANCE = oKCRTokenListItem$TokenEarnCardItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.cruilib.model.listitem.simple.OKCRTokenListItem.TokenEarnCardItem", oKCRTokenListItem$TokenEarnCardItem$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("earnPercentage", false);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = OKCRTokenListItem.TokenEarnCardItem.$childSerializers;
    ...
    public final OKCRTokenListItem.TokenEarnCardItem deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            itemRank = (ItemRank) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 5, kSerializerArr[5], null);
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 5:
                        i2 |= 32;
                        itemRank2 = (ItemRank) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 5, kSerializerArr[5], itemRank2);
                        break;
                    case 6:
                        i2 |= 64;
        ...
        return new OKCRTokenListItem.TokenEarnCardItem(i, str, str2, strDecodeStringElement, strDecodeStringElement2, str3, itemRank, strDecodeStringElement3, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OKCRTokenListItem.TokenEarnCardItem tokenEarnCardItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(tokenEarnCardItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OKCRTokenListItem.TokenEarnCardItem.KWHzl(tokenEarnCardItem, compositeEncoderBeginStructure, serialDescriptor);
