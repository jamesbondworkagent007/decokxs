package com.okinc.cruilib.compose.lifecycle;
...
public final class StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1<T> extends SuspendLambda implements Function2<ProduceStateScope<T>, Continuation<? super Unit>, Object> {
    ...
    public StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1(Lifecycle lifecycle, Lifecycle.State state, CoroutineContext coroutineContext, Flow<? extends T> flow, Continuation<? super StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1 stateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1 = new StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1(this.$lifecycle, this.$minActiveState, this.$context, this.$this_collectAsStateWithLifecycle, continuation);
        stateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1.L$0 = obj;
        return stateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1;
    }
    ...
    public final Object invoke(ProduceStateScope<T> produceStateScope, Continuation<? super Unit> continuation) {
        return ((StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1) create(produceStateScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.cruilib.compose.lifecycle.StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (Intrinsics.EZpvd(this.$context, EmptyCoroutineContext.INSTANCE)) {
                    ...
                    FlowCollector<? super T> flowCollector = new FlowCollector() { // from class: com.okinc.cruilib.compose.lifecycle.StateFlowLifecycleExtensionsKt.collectAsStateWithLifecycle.1.1.1.3
        ...
        /* JADX INFO: renamed from: com.okinc.cruilib.compose.lifecycle.StateFlowLifecycleExtensionsKt$collectAsStateWithLifecycle$1$1$1$2, reason: invalid class name */
        public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    Flow<T> flow = this.$this_collectAsStateWithLifecycle;
                    final ProduceStateScope<T> produceStateScope = this.$$this$produceState;
                    FlowCollector<? super T> flowCollector = new FlowCollector() { // from class: com.okinc.cruilib.compose.lifecycle.StateFlowLifecycleExtensionsKt.collectAsStateWithLifecycle.1.1.1.2.1
                        @Override // kotlinx.coroutines.flow.FlowCollector
                        public final Object emit(T t, Continuation<? super Unit> continuation) {
                            produceStateScope.setValue(t);
                            return Unit.INSTANCE;
