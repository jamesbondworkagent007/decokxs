...
public final class MarketDataApiImpl$getPriceAndPercentUseNetPrice$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Pair<? extends String, ? extends Triple<? extends String, ? extends Double, ? extends String>>>>, Object> {
    ...
    public MarketDataApiImpl$getPriceAndPercentUseNetPrice$2(List<String> list, sZN szn, InterfaceC54581xNr interfaceC54581xNr, Continuation<? super MarketDataApiImpl$getPriceAndPercentUseNetPrice$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MarketDataApiImpl$getPriceAndPercentUseNetPrice$2(this.$ccy, this.this$0, this.$trade, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<Pair<String, Triple<String, Double, String>>>> continuation) {
        return ((MarketDataApiImpl$getPriceAndPercentUseNetPrice$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        while (it.hasNext()) {
            arrayList.add(szn.EZpvd((TickersData) it.next(), interfaceC54581xNr));
        }
        return arrayList;
    }
}
