...
public final class LayoutType implements Parcelable {
    ...
    public static final LayoutType TYPE0 = new LayoutType("TYPE0", 0, 0);
    public static final LayoutType TYPE1 = new LayoutType("TYPE1", 1, 1);
    public static final LayoutType TYPE2 = new LayoutType("TYPE2", 2, 2);
    public static final LayoutType TYPE3 = new LayoutType("TYPE3", 3, 3);
    private final int type;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private static final /* synthetic */ LayoutType[] $values() {
        return new LayoutType[]{TYPE0, TYPE1, TYPE2, TYPE3};
    }
    ...
    public static final class CREATOR implements Parcelable.Creator<LayoutType> {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.share.bean.LayoutType.CREATOR.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final LayoutType valueOf(int i) {
            LayoutType layoutType = LayoutType.TYPE0;
            if (i == layoutType.getType()) {
                return layoutType;
            }
            LayoutType layoutType2 = LayoutType.TYPE1;
            if (i == layoutType2.getType()) {
                return layoutType2;
            }
            LayoutType layoutType3 = LayoutType.TYPE2;
            if (i == layoutType3.getType()) {
                return layoutType3;
            }
            LayoutType layoutType4 = LayoutType.TYPE3;
            if (i == layoutType4.getType()) {
                return layoutType4;
            }
            return null;
        }
