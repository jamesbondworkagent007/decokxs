...
public final /* synthetic */ class ShareFooterInfo$$serializer implements GeneratedSerializer<ShareFooterInfo> {
    public static final int $stable;
    public static final ShareFooterInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ShareFooterInfo$$serializer() {
    }
    ...
    static {
        ShareFooterInfo$$serializer shareFooterInfo$$serializer = new ShareFooterInfo$$serializer();
        INSTANCE = shareFooterInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.share.bean.ShareFooterInfo", shareFooterInfo$$serializer, 6);
    ...
    public final ShareFooterInfo deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        int i;
        String str3;
        ...
        return new ShareFooterInfo(i, num, str5, str4, str2, str3, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ShareFooterInfo shareFooterInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(shareFooterInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ShareFooterInfo.write$Self$OKShare_share_api(shareFooterInfo, compositeEncoderBeginStructure, serialDescriptor);
