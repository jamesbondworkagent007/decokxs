...
public final class OverviewViewModel$getBillArchive$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public OverviewViewModel$getBillArchive$1(OverviewViewModel overviewViewModel, Long l, Continuation<? super OverviewViewModel$getBillArchive$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        OverviewViewModel$getBillArchive$1 overviewViewModel$getBillArchive$1 = new OverviewViewModel$getBillArchive$1(this.this$0, this.$accountId, continuation);
        overviewViewModel$getBillArchive$1.L$0 = obj;
        return overviewViewModel$getBillArchive$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OverviewViewModel$getBillArchive$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            wTK wtk = overviewViewModel.valueOf;
            ...
            if (i != 1) {
                ...
                if (thM7380exceptionOrNullimpl != null) {
                    MutableStateFlow mutableStateFlow = overviewViewModel2.KWHzl;
