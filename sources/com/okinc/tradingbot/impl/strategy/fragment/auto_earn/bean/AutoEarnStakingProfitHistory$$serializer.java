...
public final /* synthetic */ class AutoEarnStakingProfitHistory$$serializer implements GeneratedSerializer<AutoEarnStakingProfitHistory> {
    public static final int $stable;
    public static final AutoEarnStakingProfitHistory$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AutoEarnStakingProfitHistory$$serializer() {
    }
    ...
    static {
        AutoEarnStakingProfitHistory$$serializer autoEarnStakingProfitHistory$$serializer = new AutoEarnStakingProfitHistory$$serializer();
        INSTANCE = autoEarnStakingProfitHistory$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.tradingbot.impl.strategy.fragment.auto_earn.bean.AutoEarnStakingProfitHistory", autoEarnStakingProfitHistory$$serializer, 5);
        ...
        pluginGeneratedSerialDescriptor.addElement("rateRatio", true);
    ...
    public final AutoEarnStakingProfitHistory deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new AutoEarnStakingProfitHistory(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AutoEarnStakingProfitHistory autoEarnStakingProfitHistory) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(autoEarnStakingProfitHistory, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AutoEarnStakingProfitHistory.write$Self$OKTradingBot_trading_bot_impl(autoEarnStakingProfitHistory, compositeEncoderBeginStructure, serialDescriptor);
