...
public final class BotGuideCardActivity$initTrade$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ActivityC52394wJu this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BotGuideCardActivity$initTrade$1(ActivityC52394wJu activityC52394wJu, Continuation<? super BotGuideCardActivity$initTrade$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BotGuideCardActivity$initTrade$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BotGuideCardActivity$initTrade$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (Result.m7384isSuccessimpl(objM8790ensureInitialize0E7RQCE$default)) {
            ...
            ActivityC52394wJu activityC52394wJu = this.this$0;
            ...
            activityC52394wJu.AEQbTJ(message);
        }
