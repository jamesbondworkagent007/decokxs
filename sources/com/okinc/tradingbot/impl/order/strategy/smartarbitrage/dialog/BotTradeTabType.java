...
public abstract class BotTradeTabType implements InterfaceC47982uAp, Parcelable {
    ...
    public static final BotTradeTabType AI = new BotTradeTabType("AI", 0) { // from class: com.okinc.tradingbot.impl.order.strategy.smartarbitrage.dialog.BotTradeTabType.AI
    ...
    public static final BotTradeTabType MANUAL = new BotTradeTabType("MANUAL", 1) { // from class: com.okinc.tradingbot.impl.order.strategy.smartarbitrage.dialog.BotTradeTabType.MANUAL
        /* JADX DEBUG: Incorrect args count in method signature: ()V */
        {
            String str = "manual";
            DefaultConstructorMarker defaultConstructorMarker = null;
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [40=4] */
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 java.lang.String), (r2v0 int), (r3v0 java.lang.String) A[MD:(java.lang.String, int, java.lang.String):void (m)] call: com.okinc.tradingbot.impl.order.strategy.smartarbitrage.dialog.BotTradeTabType.<init>(java.lang.String, int, java.lang.String):void type: THIS */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<BotTradeTabType>() { // from class: com.okinc.tradingbot.impl.order.strategy.smartarbitrage.dialog.BotTradeTabType.Creator
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final class Application {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.tradingbot.impl.order.strategy.smartarbitrage.dialog.BotTradeTabType.Application.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
