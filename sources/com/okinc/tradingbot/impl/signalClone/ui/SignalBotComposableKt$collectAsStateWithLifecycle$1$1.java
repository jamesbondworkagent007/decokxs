...
public final class SignalBotComposableKt$collectAsStateWithLifecycle$1$1<T> extends SuspendLambda implements Function2<ProduceStateScope<T>, Continuation<? super Unit>, Object> {
    ...
    public SignalBotComposableKt$collectAsStateWithLifecycle$1$1(Lifecycle lifecycle, Lifecycle.State state, CoroutineContext coroutineContext, Flow<? extends T> flow, Continuation<? super SignalBotComposableKt$collectAsStateWithLifecycle$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        SignalBotComposableKt$collectAsStateWithLifecycle$1$1 signalBotComposableKt$collectAsStateWithLifecycle$1$1 = new SignalBotComposableKt$collectAsStateWithLifecycle$1$1(this.$lifecycle, this.$minActiveState, this.$context, this.$this_collectAsStateWithLifecycle, continuation);
        signalBotComposableKt$collectAsStateWithLifecycle$1$1.L$0 = obj;
        return signalBotComposableKt$collectAsStateWithLifecycle$1$1;
    }
    ...
    public final Object invoke(ProduceStateScope<T> produceStateScope, Continuation<? super Unit> continuation) {
        return ((SignalBotComposableKt$collectAsStateWithLifecycle$1$1) create(produceStateScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.tradingbot.impl.signalClone.ui.SignalBotComposableKt$collectAsStateWithLifecycle$1$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (Intrinsics.EZpvd(this.$context, EmptyCoroutineContext.INSTANCE)) {
                    ...
                    FlowCollector<? super T> flowCollector = new FlowCollector() { // from class: com.okinc.tradingbot.impl.signalClone.ui.SignalBotComposableKt.collectAsStateWithLifecycle.1.1.1.4
        ...
        /* JADX INFO: renamed from: com.okinc.tradingbot.impl.signalClone.ui.SignalBotComposableKt$collectAsStateWithLifecycle$1$1$1$2, reason: invalid class name */
        public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    Flow<T> flow = this.$this_collectAsStateWithLifecycle;
                    final ProduceStateScope<T> produceStateScope = this.$$this$produceState;
                    FlowCollector<? super T> flowCollector = new FlowCollector() { // from class: com.okinc.tradingbot.impl.signalClone.ui.SignalBotComposableKt.collectAsStateWithLifecycle.1.1.1.2.2
                        @Override // kotlinx.coroutines.flow.FlowCollector
                        public final Object emit(T t, Continuation<? super Unit> continuation) {
                            produceStateScope.setValue(t);
                            return Unit.INSTANCE;
