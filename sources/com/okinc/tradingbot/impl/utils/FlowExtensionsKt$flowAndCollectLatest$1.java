...
public final class FlowExtensionsKt$flowAndCollectLatest$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public FlowExtensionsKt$flowAndCollectLatest$1(Flow<? extends T> flow, LifecycleOwner lifecycleOwner, Lifecycle.State state, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super FlowExtensionsKt$flowAndCollectLatest$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FlowExtensionsKt$flowAndCollectLatest$1(this.$this_flowAndCollectLatest, this.$owner, this.$minActiveState, this.$action, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FlowExtensionsKt$flowAndCollectLatest$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
