...
public final /* synthetic */ class OrbitOnboardingRestRequst$$serializer implements GeneratedSerializer<OrbitOnboardingRestRequst> {
    public static final int $stable;
    public static final OrbitOnboardingRestRequst$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OrbitOnboardingRestRequst$$serializer() {
    }
    ...
    static {
        OrbitOnboardingRestRequst$$serializer orbitOnboardingRestRequst$$serializer = new OrbitOnboardingRestRequst$$serializer();
        INSTANCE = orbitOnboardingRestRequst$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_onboarding.data.OrbitOnboardingRestRequst", orbitOnboardingRestRequst$$serializer, 4);
        ...
        pluginGeneratedSerialDescriptor.addElement("orbitLevel", false);
        pluginGeneratedSerialDescriptor.addElement("orbitUpgradeType", false);
    ...
    public final OrbitOnboardingRestRequst deserialize(@NotNull Decoder decoder) {
        int i;
        Integer num;
        Integer num2;
        Integer num3;
        ...
        return new OrbitOnboardingRestRequst(i, num4, num3, num, num2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OrbitOnboardingRestRequst orbitOnboardingRestRequst) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(orbitOnboardingRestRequst, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OrbitOnboardingRestRequst.write$Self$OKPlanet_ok_feature_planet_impl(orbitOnboardingRestRequst, compositeEncoderBeginStructure, serialDescriptor);
