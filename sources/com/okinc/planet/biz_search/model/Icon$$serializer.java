...
public final /* synthetic */ class Icon$$serializer implements GeneratedSerializer<Icon> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_search.model.Icon", icon$$serializer, 2);
    ...
    public final Icon deserialize(@NotNull Decoder decoder) {
        ...
        return new Icon(i, str2, str, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull Icon icon) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(icon, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        Icon.write$Self$OKPlanet_ok_feature_planet_impl(icon, compositeEncoderBeginStructure, serialDescriptor);
