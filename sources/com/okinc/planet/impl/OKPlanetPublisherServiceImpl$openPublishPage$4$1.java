...
public final class OKPlanetPublisherServiceImpl$openPublishPage$4$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OKPlanetPublisherServiceImpl$openPublishPage$4$1(this.$successMsg, this.$channelId, this.$anchorView, this.$context, this.$data, this.$params, this.$testMode, this.$userManager, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OKPlanetPublisherServiceImpl$openPublishPage$4$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (C46377tSb.copydefault(planetPublisherChannelId, view, context, (Map<String, ? extends Object>) map, bundle, z, interfaceC47278tmy, str, (Continuation<? super Unit>) this) == objCopydefault) {
