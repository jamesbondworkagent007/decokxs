...
public final class OKPlanetPublisherServiceImpl$openPublishPage$5$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OKPlanetPublisherServiceImpl$openPublishPage$5$1(this.$successMsg, this.$channelId, this.$anchorView, this.$context, this.$data, this.$params, this.$testMode, this.$userManager, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OKPlanetPublisherServiceImpl$openPublishPage$5$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
