...
public final class PlanetRepository$followBatch$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends Object, ? extends OKServerException>>, Object> {
    final /* synthetic */ C45910tAu $req;
    ...
    public PlanetRepository$followBatch$2(tQQ tqq, C45910tAu c45910tAu, Continuation<? super PlanetRepository$followBatch$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        PlanetRepository$followBatch$2 planetRepository$followBatch$2 = new PlanetRepository$followBatch$2(this.this$0, this.$req, continuation);
        planetRepository$followBatch$2.L$0 = obj;
        return planetRepository$followBatch$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends Object, OKServerException>> continuation) {
        return ((PlanetRepository$followBatch$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                tQQ tqq = this.this$0;
                C45910tAu c45910tAu = this.$req;
                tQP tqp = tqq.copydefault;
                this.label = 1;
                obj = tqp.OLrzqt(c45910tAu, this);
