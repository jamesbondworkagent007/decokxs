...
public final class PlanetRepository$xAsync$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends Object, ? extends OKServerException>>, Object> {
    final /* synthetic */ PlanetXAsync $data;
    ...
    public PlanetRepository$xAsync$2(tQQ tqq, PlanetXAsync planetXAsync, Continuation<? super PlanetRepository$xAsync$2> continuation) {
        super(2, continuation);
        this.this$0 = tqq;
        this.$data = planetXAsync;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        PlanetRepository$xAsync$2 planetRepository$xAsync$2 = new PlanetRepository$xAsync$2(this.this$0, this.$data, continuation);
        planetRepository$xAsync$2.L$0 = obj;
        return planetRepository$xAsync$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends Object, OKServerException>> continuation) {
        return ((PlanetRepository$xAsync$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                tQQ tqq = this.this$0;
                PlanetXAsync planetXAsync = this.$data;
