...
public final /* synthetic */ class ActivityCardPublish$$serializer implements GeneratedSerializer<ActivityCardPublish> {
    public static final int $stable;
    public static final ActivityCardPublish$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ActivityCardPublish$$serializer() {
    }
    ...
    static {
        ActivityCardPublish$$serializer activityCardPublish$$serializer = new ActivityCardPublish$$serializer();
        INSTANCE = activityCardPublish$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.domain.remote.dto.ActivityCardPublish", activityCardPublish$$serializer, 9);
    ...
    public final ActivityCardPublish deserialize(@NotNull Decoder decoder) {
        ...
        return new ActivityCardPublish(i, str, str5, num, str4, str3, str6, str2, strDecodeStringElement, publishImageItem, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ActivityCardPublish activityCardPublish) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(activityCardPublish, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ActivityCardPublish.OLrzqt(activityCardPublish, compositeEncoderBeginStructure, serialDescriptor);
