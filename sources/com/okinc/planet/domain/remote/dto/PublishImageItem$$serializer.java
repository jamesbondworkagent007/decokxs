...
public final /* synthetic */ class PublishImageItem$$serializer implements GeneratedSerializer<PublishImageItem> {
    public static final int $stable;
    public static final PublishImageItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PublishImageItem$$serializer() {
    }
    ...
    static {
        PublishImageItem$$serializer publishImageItem$$serializer = new PublishImageItem$$serializer();
        INSTANCE = publishImageItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.domain.remote.dto.PublishImageItem", publishImageItem$$serializer, 6);
    ...
    public final PublishImageItem deserialize(@NotNull Decoder decoder) {
        ...
        return new PublishImageItem(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PublishImageItem publishImageItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(publishImageItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PublishImageItem.EZpvd(publishImageItem, compositeEncoderBeginStructure, serialDescriptor);
