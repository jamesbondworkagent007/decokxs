...
public final /* synthetic */ class PluginInfo$$serializer implements GeneratedSerializer<PluginInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.domain.remote.dto.PluginInfo", pluginInfo$$serializer, 4);
    ...
    public final PluginInfo deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new PluginInfo(i, str, str3, str2, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PluginInfo pluginInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(pluginInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PluginInfo.KWHzl(pluginInfo, compositeEncoderBeginStructure, serialDescriptor);
