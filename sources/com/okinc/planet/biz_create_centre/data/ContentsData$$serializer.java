...
public final /* synthetic */ class ContentsData$$serializer implements GeneratedSerializer<ContentsData> {
    public static final int $stable;
    public static final ContentsData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ContentsData$$serializer() {
    }
    ...
    static {
        ContentsData$$serializer contentsData$$serializer = new ContentsData$$serializer();
        INSTANCE = contentsData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_create_centre.data.ContentsData", contentsData$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("likeCount", true);
        pluginGeneratedSerialDescriptor.addElement("likePopRatio", true);
        ...
        pluginGeneratedSerialDescriptor.addElement("replyPopRatio", true);
    ...
    public final ContentsData deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new ContentsData(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ContentsData contentsData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(contentsData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ContentsData.write$Self$OKPlanet_ok_feature_planet_impl(contentsData, compositeEncoderBeginStructure, serialDescriptor);
