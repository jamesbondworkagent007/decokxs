...
public final /* synthetic */ class GroupsData$$serializer implements GeneratedSerializer<GroupsData> {
    public static final int $stable;
    public static final GroupsData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GroupsData$$serializer() {
    }
    ...
    static {
        GroupsData$$serializer groupsData$$serializer = new GroupsData$$serializer();
        INSTANCE = groupsData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_create_centre.data.GroupsData", groupsData$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("membershipChange", true);
        pluginGeneratedSerialDescriptor.addElement("membershipChangePopRatio", true);
        pluginGeneratedSerialDescriptor.addElement("messageCount", true);
        pluginGeneratedSerialDescriptor.addElement("messageCountPopRatio", true);
    ...
    public final GroupsData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new GroupsData(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GroupsData groupsData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(groupsData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GroupsData.write$Self$OKPlanet_ok_feature_planet_impl(groupsData, compositeEncoderBeginStructure, serialDescriptor);
