...
public final class FollowersNotificationsViewModel$followUser$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public FollowersNotificationsViewModel$followUser$1(C47913tzA c47913tzA, boolean z, String str, Function2<? super Boolean, ? super OKServerException, Unit> function2, Continuation<? super FollowersNotificationsViewModel$followUser$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        FollowersNotificationsViewModel$followUser$1 followersNotificationsViewModel$followUser$1 = new FollowersNotificationsViewModel$followUser$1(this.this$0, this.$isFollow, this.$authorId, this.$callback, continuation);
        followersNotificationsViewModel$followUser$1.L$0 = obj;
        return followersNotificationsViewModel$followUser$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FollowersNotificationsViewModel$followUser$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
