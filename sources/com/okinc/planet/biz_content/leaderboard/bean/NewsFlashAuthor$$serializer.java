...
public final /* synthetic */ class NewsFlashAuthor$$serializer implements GeneratedSerializer<NewsFlashAuthor> {
    public static final int $stable;
    public static final NewsFlashAuthor$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NewsFlashAuthor$$serializer() {
    }
    ...
    static {
        NewsFlashAuthor$$serializer newsFlashAuthor$$serializer = new NewsFlashAuthor$$serializer();
        INSTANCE = newsFlashAuthor$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_content.leaderboard.bean.NewsFlashAuthor", newsFlashAuthor$$serializer, 3);
    ...
    public final NewsFlashAuthor deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new NewsFlashAuthor(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NewsFlashAuthor newsFlashAuthor) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(newsFlashAuthor, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NewsFlashAuthor.write$Self$OKPlanet_ok_feature_planet_impl(newsFlashAuthor, compositeEncoderBeginStructure, serialDescriptor);
