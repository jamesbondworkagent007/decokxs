...
public final /* synthetic */ class SpotlightAuthor$$serializer implements GeneratedSerializer<SpotlightAuthor> {
    public static final int $stable;
    public static final SpotlightAuthor$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SpotlightAuthor$$serializer() {
    }
    ...
    static {
        SpotlightAuthor$$serializer spotlightAuthor$$serializer = new SpotlightAuthor$$serializer();
        INSTANCE = spotlightAuthor$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_content.leaderboard.bean.SpotlightAuthor", spotlightAuthor$$serializer, 4);
        ...
        pluginGeneratedSerialDescriptor.addElement("officialStatus", true);
    ...
    public final SpotlightAuthor deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new SpotlightAuthor(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SpotlightAuthor spotlightAuthor) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(spotlightAuthor, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SpotlightAuthor.write$Self$OKPlanet_ok_feature_planet_impl(spotlightAuthor, compositeEncoderBeginStructure, serialDescriptor);
