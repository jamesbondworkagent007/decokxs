...
public final /* synthetic */ class Rate$$serializer implements GeneratedSerializer<Rate> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.planet.biz_content.leaderboard.bean.Rate", rate$$serializer, 2);
    ...
    public final Rate deserialize(@NotNull Decoder decoder) {
        ...
        return new Rate(i, str2, str, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Rate rate) {
        ...
        Rate.write$Self$OKPlanet_ok_feature_planet_impl(rate, compositeEncoderBeginStructure, serialDescriptor);
