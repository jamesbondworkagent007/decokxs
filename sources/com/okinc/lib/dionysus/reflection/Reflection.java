package com.okinc.lib.dionysus.reflection;
...
public class Reflection {
    ...
    public static int KWHzl(Context context) {
        return (Build.VERSION.SDK_INT < 28 || pIY.copydefault() || EZpvd(context)) ? 0 : -1;
    }
    ...
    public static boolean EZpvd(Context context) {
        ...
        try {
            ...
            try {
                ...
                return ((Boolean) new DexFile(file).loadClass(pIY.class.getCanonicalName(), null).getDeclaredMethod("exemptAll", new Class[0]).invoke(null, new Object[0])).booleanValue();
            } finally {
            }
