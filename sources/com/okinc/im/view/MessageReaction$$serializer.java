...
public final /* synthetic */ class MessageReaction$$serializer implements GeneratedSerializer<MessageReaction> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.im.view.MessageReaction", messageReaction$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("emoji", false);
        pluginGeneratedSerialDescriptor.addElement("count", false);
        pluginGeneratedSerialDescriptor.addElement("isUserReacted", true);
    ...
    public final MessageReaction deserialize(@NotNull Decoder decoder) {
        ...
        return new MessageReaction(i2, str, i, zDecodeBooleanElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MessageReaction messageReaction) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(messageReaction, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MessageReaction.write$Self$OKIM_okim_api(messageReaction, compositeEncoderBeginStructure, serialDescriptor);
