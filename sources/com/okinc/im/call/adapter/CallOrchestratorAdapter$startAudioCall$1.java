...
public final class CallOrchestratorAdapter$startAudioCall$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CallOrchestratorAdapter$startAudioCall$1(C35255nrq c35255nrq, String str, String str2, Function1<? super InterfaceC35336ntR, Unit> function1, Continuation<? super CallOrchestratorAdapter$startAudioCall$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CallOrchestratorAdapter$startAudioCall$1(this.this$0, this.$conversationId, this.$calleeUserId, this.$errorCallback, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CallOrchestratorAdapter$startAudioCall$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = c35217nrE.AEQbTJ(str, str2, this);
        ...
        if (abstractC35226nrN instanceof AbstractC35226nrN.ActionBar) {
            c35255nrq.copydefault("startAudioCall: Successfully initiated");
        }
        ...
        if (abstractC35226nrN instanceof AbstractC35226nrN.Application) {
            ...
            c35255nrq2.copydefault("startAudioCall: Error - " + abstractC35221nrIOLrzqt.AEQbTJ());
            InterfaceC35336ntR interfaceC35336ntREZpvd = C35258nrt.EZpvd(abstractC35221nrIOLrzqt);
            if (function1 != null) {
                function1.invoke(interfaceC35336ntREZpvd);
            }
        }
