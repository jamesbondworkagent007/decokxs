...
public final class CallOrchestratorAdapter$ringGroupCallUsers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CallOrchestratorAdapter$ringGroupCallUsers$1(C35255nrq c35255nrq, List<String> list, Function0<Unit> function0, Function1<? super InterfaceC35336ntR, Unit> function1, Continuation<? super CallOrchestratorAdapter$ringGroupCallUsers$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CallOrchestratorAdapter$ringGroupCallUsers$1(this.this$0, this.$targetUids, this.$onSuccess, this.$errorCallback, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CallOrchestratorAdapter$ringGroupCallUsers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = c35217nrE.copydefault(list, this);
        ...
        if (abstractC35226nrN instanceof AbstractC35226nrN.ActionBar) {
            c35255nrq.copydefault("ringGroupCallUsers: Successfully rang users");
            function0.invoke();
        }
        ...
        if (abstractC35226nrN instanceof AbstractC35226nrN.Application) {
            ...
            c35255nrq2.copydefault("ringGroupCallUsers: Error - " + abstractC35221nrIOLrzqt.AEQbTJ());
            if (function1 != null) {
