...
public final class CallRepositoryImpl$ringGroupCall$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC35226nrN<? extends Unit>>, Object> {
    ...
    public CallRepositoryImpl$ringGroupCall$2(C35235nrW c35235nrW, String str, List<String> list, Continuation<? super CallRepositoryImpl$ringGroupCall$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CallRepositoryImpl$ringGroupCall$2(this.this$0, this.$groupId, this.$targetUids, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC35226nrN<Unit>> continuation) {
        return ((CallRepositoryImpl$ringGroupCall$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                RingGroupVoiceCallRequest ringGroupVoiceCallRequest = new RingGroupVoiceCallRequest(this.$groupId, this.$targetUids);
                this.label = 1;
                obj = inHouseIMGroupService.ringGroupVoiceCall(ringGroupVoiceCallRequest, this);
            ...
            if (((ResponseData) obj).getCode() == 5002) {
