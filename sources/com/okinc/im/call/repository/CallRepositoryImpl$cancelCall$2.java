...
public final class CallRepositoryImpl$cancelCall$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC35226nrN<? extends Unit>>, Object> {
    ...
    public CallRepositoryImpl$cancelCall$2(C35235nrW c35235nrW, CallSessionV2 callSessionV2, Continuation<? super CallRepositoryImpl$cancelCall$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CallRepositoryImpl$cancelCall$2(this.this$0, this.$session, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC35226nrN<Unit>> continuation) {
        return ((CallRepositoryImpl$cancelCall$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                OKMessage oKMessageAEQbTJ = c35340ntV.AEQbTJ(this.$session.AYXKKw());
                this.label = 1;
            ...
            return AbstractC35226nrN.Companion.copydefault((AbstractC35221nrI) new AbstractC35221nrI.AssistContent("Failed to cancel call: " + e.getMessage()));
        }
    }
}
