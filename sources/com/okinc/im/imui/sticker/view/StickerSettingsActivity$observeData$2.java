...
public final class StickerSettingsActivity$observeData$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ActivityC37628oxS this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StickerSettingsActivity$observeData$2(ActivityC37628oxS activityC37628oxS, Continuation<? super StickerSettingsActivity$observeData$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StickerSettingsActivity$observeData$2(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StickerSettingsActivity$observeData$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.im.imui.sticker.view.StickerSettingsActivity$observeData$2$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<Pair<? extends Long, ? extends Long>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                ((nIX) this.this$0.KWHzl()).valueOf.setText(" " + pair.getFirst() + "/" + pair.getSecond());
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            C56391yDq.AEQbTJ(obj);
            StateFlow<Pair<Long, Long>> stateFlowAYXKKw = this.this$0.fetchVPNInfo().AYXKKw();
