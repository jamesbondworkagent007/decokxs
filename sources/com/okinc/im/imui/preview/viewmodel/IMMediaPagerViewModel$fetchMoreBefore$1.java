...
public final class IMMediaPagerViewModel$fetchMoreBefore$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    Object L$2;
    int label;
    ...
    public IMMediaPagerViewModel$fetchMoreBefore$1(IMMediaPagerViewModel iMMediaPagerViewModel, Continuation<? super IMMediaPagerViewModel$fetchMoreBefore$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new IMMediaPagerViewModel$fetchMoreBefore$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((IMMediaPagerViewModel$fetchMoreBefore$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                if (!this.this$0.gEmmrt() && this.this$0.EZpvd()) {
                ...
                if (i != 1) {
                    if (i != 2) {
                        ...
                        try {
                            if (!list.isEmpty()) {
                                iMMediaPagerViewModel2.EZpvd.setValue(CollectionsKt___CollectionsKt.djBIcL((Collection) list, (Iterable) iMMediaPagerViewModel2.EZpvd.getValue()));
                            }
                            if (list.size() < 10) {
                                iMMediaPagerViewModel2.isConnected.set("KEY_HAS_MORE_BEFORE", C56443yFo.KWHzl(false));
                            }
                            iMMediaPagerViewModel2.isConnected.set("KEY_IS_LOADING_BEFORE", C56443yFo.KWHzl(false));
                            return Unit.INSTANCE;
                        } finally {
                        }
                    }
            ...
            iMMediaPagerViewModel.isConnected.set("KEY_IS_LOADING_BEFORE", C56443yFo.KWHzl(true));
            OKMessage oKMessageKWHzl = ((C37233opv) CollectionsKt___CollectionsKt.AuCTelauCTel((List) iMMediaPagerViewModel.EZpvd.getValue())).KWHzl();
            mutex.unlock(null);
            C35804oEh c35804oEh = this.this$0.djBIcL;
            OKGetMessageDirection oKGetMessageDirection = OKGetMessageDirection.FRONT;
            this.L$0 = null;
            this.L$1 = null;
            this.label = 2;
