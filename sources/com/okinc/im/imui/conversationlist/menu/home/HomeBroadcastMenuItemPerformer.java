...
public class HomeBroadcastMenuItemPerformer implements IMenuItemPerformer {
    public static final Parcelable.Creator<HomeBroadcastMenuItemPerformer> CREATOR = new Creator();

    public static final class Creator implements Parcelable.Creator<HomeBroadcastMenuItemPerformer> {
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX DEBUG: Method merged with bridge method: createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final HomeBroadcastMenuItemPerformer createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "");
            parcel.readInt();
            return new HomeBroadcastMenuItemPerformer();
        }
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final HomeBroadcastMenuItemPerformer[] newArray(int i) {
            return new HomeBroadcastMenuItemPerformer[i];
        }
    }
    ...
    public CharSequence EZpvd() {
        return C33070mpX.AYXKKw(C35399nuc.LoaderManager.RJOkX);
    }

    @Override // com.okinc.im.imui.conversation.message.menu.api.IMenuItemPerformer
    public Drawable copydefault() {
        Drawable drawableKWHzl = C33070mpX.KWHzl(C35399nuc.ActionBar.getNewProxyInstance);
