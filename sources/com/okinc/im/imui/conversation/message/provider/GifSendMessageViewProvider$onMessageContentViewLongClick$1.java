...
public final class GifSendMessageViewProvider$onMessageContentViewLongClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ C35254nrp $item;
    final /* synthetic */ ViewBinding $parentView;
    Object L$0;
    int label;
    final /* synthetic */ C33680nBw this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GifSendMessageViewProvider$onMessageContentViewLongClick$1(C35254nrp c35254nrp, C33680nBw c33680nBw, ViewBinding viewBinding, Continuation<? super GifSendMessageViewProvider$onMessageContentViewLongClick$1> continuation) {
        super(2, continuation);
        this.$item = c35254nrp;
        this.this$0 = c33680nBw;
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GifSendMessageViewProvider$onMessageContentViewLongClick$1(this.$item, this.this$0, this.$parentView, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GifSendMessageViewProvider$onMessageContentViewLongClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i == 0) {
            ...
            if (C33129mqd.KWHzl((Collection) arrayList)) {
                ...
                if (abstractC44112sDu != null && (linearLayoutCompat = abstractC44112sDu.AhwBna) != null) {
                    C33680nBw c33680nBw = this.this$0;
                    C35254nrp c35254nrp = this.$item;
                    yHO yhoAuCTel = c33680nBw.AuCTel();
                    if (yhoAuCTel != null) {
