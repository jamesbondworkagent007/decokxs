...
public final class ShareReceiveMessageViewProvider$handleViewLongClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ C35254nrp $item;
    final /* synthetic */ ViewBinding $parentView;
    int label;
    final /* synthetic */ C33705nCu this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShareReceiveMessageViewProvider$handleViewLongClick$1(C35254nrp c35254nrp, C33705nCu c33705nCu, ViewBinding viewBinding, Continuation<? super ShareReceiveMessageViewProvider$handleViewLongClick$1> continuation) {
        super(2, continuation);
        this.$item = c35254nrp;
        this.this$0 = c33705nCu;
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ShareReceiveMessageViewProvider$handleViewLongClick$1(this.$item, this.this$0, this.$parentView, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ShareReceiveMessageViewProvider$handleViewLongClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            final C33705nCu c33705nCu = this.this$0;
            Function0<Boolean> function0 = new Function0() { // from class: o.nCA
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function0
                public final java.lang.Object invoke() {
                    return java.lang.Boolean.valueOf(ShareReceiveMessageViewProvider$handleViewLongClick$1.invokeSuspend$lambda$0(c33705nCu, c35254nrp));
                }
            };
        ...
        if (!arrayList.isEmpty()) {
            ...
            if (abstractC44111sDt != null && (linearLayoutCompat = abstractC44111sDt.AhwBna) != null) {
                C33705nCu c33705nCu2 = this.this$0;
                ...
                yHO yhoAuCTel = c33705nCu2.AuCTel();
                if (yhoAuCTel != null) {
    ...
    public static final boolean invokeSuspend$lambda$0(C33705nCu c33705nCu, C35254nrp c35254nrp) {
        return c33705nCu.copydefault(c35254nrp.OLrzqt());
    }
}
