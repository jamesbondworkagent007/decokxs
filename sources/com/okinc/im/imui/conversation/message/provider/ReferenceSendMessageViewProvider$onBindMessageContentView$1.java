...
public final class ReferenceSendMessageViewProvider$onBindMessageContentView$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ReferenceSendMessageViewProvider$onBindMessageContentView$1(C35254nrp c35254nrp, OKReferenceMessage oKReferenceMessage, nDB.TaskDescription taskDescription, nDB.Application application, C33690nCf c33690nCf, Continuation<? super ReferenceSendMessageViewProvider$onBindMessageContentView$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ReferenceSendMessageViewProvider$onBindMessageContentView$1(this.$item, this.$content, this.$container, this.$callbacks, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ReferenceSendMessageViewProvider$onBindMessageContentView$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (oKMessageAEQbTJ != null) {
                ...
                iMUserInfo = null;
                nDB.Activity activity = new nDB.Activity(this.$item, iMUserInfo, this.$content, OKMessage.MessageDirection.SEND);
        ...
        nDB.Activity activity2 = new nDB.Activity(this.$item, iMUserInfo, this.$content, OKMessage.MessageDirection.SEND);
        mainCoroutineDispatcherAEQbTJ = sDN.copydefault.AEQbTJ();
    ...
    /* JADX INFO: renamed from: com.okinc.im.imui.conversation.message.provider.ReferenceSendMessageViewProvider$onBindMessageContentView$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(nDB.TaskDescription taskDescription, nDB.Application application, nDB.Activity activity, C33690nCf c33690nCf, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.$container = taskDescription;
            this.$callbacks = application;
            this.$data = activity;
