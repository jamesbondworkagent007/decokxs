...
public final class StickerSendMessageViewProvider$onMessageContentViewLongClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ OKStickerMessage $content;
    final /* synthetic */ C35254nrp $item;
    final /* synthetic */ ViewBinding $parentView;
    Object L$0;
    int label;
    final /* synthetic */ nCK this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StickerSendMessageViewProvider$onMessageContentViewLongClick$1(C35254nrp c35254nrp, nCK nck, OKStickerMessage oKStickerMessage, ViewBinding viewBinding, Continuation<? super StickerSendMessageViewProvider$onMessageContentViewLongClick$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StickerSendMessageViewProvider$onMessageContentViewLongClick$1(this.$item, this.this$0, this.$content, this.$parentView, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StickerSendMessageViewProvider$onMessageContentViewLongClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            final nCK nck = this.this$0;
            Function0<Boolean> function0 = new Function0() { // from class: o.nCL
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function0
                public final java.lang.Object invoke() {
                    return java.lang.Boolean.valueOf(StickerSendMessageViewProvider$onMessageContentViewLongClick$1.invokeSuspend$lambda$0(nck, c35254nrp));
                }
            };
    ...
    public static final boolean invokeSuspend$lambda$0(nCK nck, C35254nrp c35254nrp) {
        return nck.copydefault(c35254nrp.OLrzqt());
    }

    /* JADX INFO: renamed from: com.okinc.im.imui.conversation.message.provider.StickerSendMessageViewProvider$onMessageContentViewLongClick$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(ViewBinding viewBinding, nCK nck, ArrayList<MenuActionBase> arrayList, C35254nrp c35254nrp, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.$parentView = viewBinding;
            this.this$0 = nck;
