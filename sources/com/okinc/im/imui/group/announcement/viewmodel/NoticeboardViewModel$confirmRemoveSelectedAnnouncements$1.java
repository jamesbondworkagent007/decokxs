...
public final class NoticeboardViewModel$confirmRemoveSelectedAnnouncements$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ String $groupId;
    final /* synthetic */ List<Long> $idsToRemove;
    Object L$0;
    Object L$1;
    int label;
    ...
    public NoticeboardViewModel$confirmRemoveSelectedAnnouncements$1(NoticeboardViewModel noticeboardViewModel, String str, List<Long> list, Continuation<? super NoticeboardViewModel$confirmRemoveSelectedAnnouncements$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new NoticeboardViewModel$confirmRemoveSelectedAnnouncements$1(this.this$0, this.$groupId, this.$idsToRemove, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((NoticeboardViewModel$confirmRemoveSelectedAnnouncements$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            List<Long> list = this.$idsToRemove;
            this.label = 1;
            objKWHzl = c35794oDy.KWHzl(str, list, this);
        ...
        List<Long> list2 = this.$idsToRemove;
