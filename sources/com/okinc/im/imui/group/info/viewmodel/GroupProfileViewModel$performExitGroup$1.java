...
public final class GroupProfileViewModel$performExitGroup$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ GroupProfileViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GroupProfileViewModel$performExitGroup$1(GroupProfileViewModel groupProfileViewModel, Continuation<? super GroupProfileViewModel$performExitGroup$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GroupProfileViewModel$performExitGroup$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GroupProfileViewModel$performExitGroup$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX INFO: renamed from: com.okinc.im.imui.group.info.viewmodel.GroupProfileViewModel$performExitGroup$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<String, Continuation<? super Result<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                objOLrzqt = c35782oDm.OLrzqt(str, this);
    ...
    /* JADX INFO: renamed from: com.okinc.im.imui.group.info.viewmodel.GroupProfileViewModel$performExitGroup$1$2, reason: invalid class name */
    public static final class AnonymousClass2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                GroupProfileViewModel.Application.ActionBar actionBar = GroupProfileViewModel.Application.ActionBar.AEQbTJ;
                this.label = 1;
