...
public final class GroupProfileViewModel$toggleMuteNotifications$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ GroupProfileViewModel this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GroupProfileViewModel$toggleMuteNotifications$1(GroupProfileViewModel groupProfileViewModel, Continuation<? super GroupProfileViewModel$toggleMuteNotifications$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GroupProfileViewModel$toggleMuteNotifications$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GroupProfileViewModel$toggleMuteNotifications$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX INFO: renamed from: com.okinc.im.imui.group.info.viewmodel.GroupProfileViewModel$toggleMuteNotifications$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<String, Continuation<? super Result<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                boolean zIsConnected = this.this$0.isConnected();
                this.label = 1;
                objOLrzqt = c35782oDm.OLrzqt(str, true ^ zIsConnected, this);
    ...
    /* JADX INFO: renamed from: com.okinc.im.imui.group.info.viewmodel.GroupProfileViewModel$toggleMuteNotifications$1$2, reason: invalid class name */
