...
public final class MessageListViewModel$debounceRefresh$1$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    public MessageListViewModel$debounceRefresh$1$1(MessageListViewModel messageListViewModel, Continuation<? super MessageListViewModel$debounceRefresh$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new MessageListViewModel$debounceRefresh$1$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((MessageListViewModel$debounceRefresh$1$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (actionBar2 != null) {
                ...
                pUU.EZpvd("MessageListViewModel", "debounceRefresh processing");
                ...
                this.label = 1;
                obj = c36593odr.valueOf(c36558odIKWHzl, this);
                if (obj == objCopydefault) {
                    return objCopydefault;
                }
                messageListViewModel2 = messageListViewModel4;
                messageListViewModel3 = messageListViewModel4;
                pUU.EZpvd("MessageListViewModel", "debounceRefresh setMessageListModel");
