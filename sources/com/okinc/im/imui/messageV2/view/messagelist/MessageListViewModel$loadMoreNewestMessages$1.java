...
public final class MessageListViewModel$loadMoreNewestMessages$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    public MessageListViewModel$loadMoreNewestMessages$1(MessageListViewModel messageListViewModel, Continuation<? super MessageListViewModel$loadMoreNewestMessages$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new MessageListViewModel$loadMoreNewestMessages$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((MessageListViewModel$loadMoreNewestMessages$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (actionBar3 != null) {
                ...
                MutableLiveData mutableLiveData2 = messageListViewModel6.KWHzl;
                ...
                pUU.EZpvd("MessageListViewModel", "loadMoreNewestMessages processing");
                ...
                this.label = 2;
                obj = c36593odr.copydefault(c36558odIKWHzl, this);
            ...
            try {
                ...
                this.L$1 = messageListViewModel;
                this.label = 2;
                obj = c36593odr2.copydefault(c36558odIKWHzl2, this);
                if (obj != objCopydefault) {
                    return objCopydefault;
                }
                messageListViewModel3 = messageListViewModel;
                pUU.EZpvd("MessageListViewModel", "loadMoreNewestMessages setMessageListModel");
            ...
            mutableLiveData = messageListViewModel5.KWHzl;
