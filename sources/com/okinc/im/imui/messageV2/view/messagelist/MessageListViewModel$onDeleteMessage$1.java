...
public final class MessageListViewModel$onDeleteMessage$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public MessageListViewModel$onDeleteMessage$1(MessageListViewModel messageListViewModel, C44454sQk c44454sQk, Continuation<? super MessageListViewModel$onDeleteMessage$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new MessageListViewModel$onDeleteMessage$1(this.this$0, this.$deleteEvent, continuation);
    }
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((MessageListViewModel$onDeleteMessage$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (actionBar2 != null) {
                ...
                C44454sQk c44454sQk2 = this.$deleteEvent;
                Result.Application application2 = Result.Companion;
                pUU.EZpvd("MessageListViewModel", "onDeleteMessage processing - onDeleteMessage seq:" + c44454sQk2.AEQbTJ());
                ...
                this.label = 1;
                obj = c36593odr.EZpvd(c36558odIKWHzl, c44454sQk2, this);
                if (obj == objCopydefault) {
                    return objCopydefault;
                }
                c44454sQk = c44454sQk2;
                messageListViewModel2 = messageListViewModel4;
                messageListViewModel3 = messageListViewModel4;
                pUU.EZpvd("MessageListViewModel", "onDeleteMessage setMessageListModel - onDeleteMessage seq:" + c44454sQk.AEQbTJ());
