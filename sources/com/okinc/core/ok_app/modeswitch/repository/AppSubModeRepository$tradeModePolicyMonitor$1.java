...
public final class AppSubModeRepository$tradeModePolicyMonitor$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ C33451mwh this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppSubModeRepository$tradeModePolicyMonitor$1(C33451mwh c33451mwh, Continuation<? super AppSubModeRepository$tradeModePolicyMonitor$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AppSubModeRepository$tradeModePolicyMonitor$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AppSubModeRepository$tradeModePolicyMonitor$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.core.ok_app.modeswitch.repository.AppSubModeRepository$tradeModePolicyMonitor$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<FeatureRestrictionDiffSet, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                Function1<Continuation<? super Unit>, Object> function1Copydefault = this.this$0.copydefault();
                this.label = 1;
                if (function1Copydefault.invoke(this) == objCopydefault) {
