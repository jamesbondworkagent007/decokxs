...
public final class LiteSubModeRepository$tradeModePolicyMonitor$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ C33447mwd this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LiteSubModeRepository$tradeModePolicyMonitor$2(C33447mwd c33447mwd, Continuation<? super LiteSubModeRepository$tradeModePolicyMonitor$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LiteSubModeRepository$tradeModePolicyMonitor$2(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LiteSubModeRepository$tradeModePolicyMonitor$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.core.ok_app.modeswitch.repository.LiteSubModeRepository$tradeModePolicyMonitor$2$1, reason: invalid class name */
