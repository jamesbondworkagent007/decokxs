...
public final class PromptUIRequestHandler$handle$1$invokeSuspend$$inlined$nativeResponse$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public PromptUIRequestHandler$handle$1$invokeSuspend$$inlined$nativeResponse$1(C57149ycv c57149ycv, String str, Object obj, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PromptUIRequestHandler$handle$1$invokeSuspend$$inlined$nativeResponse$1(this.this$0, this.$id, this.$params, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((PromptUIRequestHandler$handle$1$invokeSuspend$$inlined$nativeResponse$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX INFO: renamed from: com.okinc.wallet.hardware.impl.onekey.handler.PromptUIRequestHandler$handle$1$invokeSuspend$$inlined$nativeResponse$1$1, reason: invalid class name */
