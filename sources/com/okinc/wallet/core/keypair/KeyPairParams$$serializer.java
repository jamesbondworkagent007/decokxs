...
public final /* synthetic */ class KeyPairParams$$serializer implements GeneratedSerializer<KeyPairParams> {
    public static final int $stable;
    public static final KeyPairParams$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private KeyPairParams$$serializer() {
    }
    ...
    static {
        KeyPairParams$$serializer keyPairParams$$serializer = new KeyPairParams$$serializer();
        INSTANCE = keyPairParams$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.keypair.KeyPairParams", keyPairParams$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("mnemonic", true);
        pluginGeneratedSerialDescriptor.addElement("language", true);
        pluginGeneratedSerialDescriptor.addElement("prvKey", true);
        pluginGeneratedSerialDescriptor.addElement("inputEncrypted", false);
    ...
    public final KeyPairParams deserialize(@NotNull Decoder decoder) {
        ...
        return new KeyPairParams(i, str3, str2, str, zDecodeBooleanElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull KeyPairParams keyPairParams) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(keyPairParams, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        KeyPairParams.write$Self$OKWalletCore_wallet_lib(keyPairParams, compositeEncoderBeginStructure, serialDescriptor);
