...
public final /* synthetic */ class NearTransaction$$serializer implements GeneratedSerializer<NearTransaction> {
    public static final int $stable;
    public static final NearTransaction$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NearTransaction$$serializer() {
    }
    ...
    static {
        NearTransaction$$serializer nearTransaction$$serializer = new NearTransaction$$serializer();
        INSTANCE = nearTransaction$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.near.NearTransaction", nearTransaction$$serializer, 5);
    ...
    public final NearTransaction deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new NearTransaction(i, str, str3, str2, strDecodeStringElement, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NearTransaction nearTransaction) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(nearTransaction, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NearTransaction.write$Self$OKWalletCore_wallet_lib(nearTransaction, compositeEncoderBeginStructure, serialDescriptor);
