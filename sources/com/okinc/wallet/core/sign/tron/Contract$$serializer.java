...
public final /* synthetic */ class Contract$$serializer implements GeneratedSerializer<Contract> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.tron.Contract", contract$$serializer, 2);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Contract contract) {
        ...
        Contract.write$Self$OKWalletCore_wallet_lib(contract, compositeEncoderBeginStructure, serialDescriptor);
