...
public final /* synthetic */ class Parameter$$serializer implements GeneratedSerializer<Parameter> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.tron.Parameter", parameter$$serializer, 2);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Parameter parameter) {
        ...
        Parameter.write$Self$OKWalletCore_wallet_lib(parameter, compositeEncoderBeginStructure, serialDescriptor);
