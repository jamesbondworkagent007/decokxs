...
public final /* synthetic */ class EosTransaction$$serializer implements GeneratedSerializer<EosTransaction> {
    public static final int $stable;
    public static final EosTransaction$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private EosTransaction$$serializer() {
    }
    ...
    static {
        EosTransaction$$serializer eosTransaction$$serializer = new EosTransaction$$serializer();
        INSTANCE = eosTransaction$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.eos.EosTransaction", eosTransaction$$serializer, 11);
    ...
    public final EosTransaction deserialize(@NotNull Decoder decoder) {
        ...
        return new EosTransaction(i, str2, str4, str10, str7, str8, str6, str9, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull EosTransaction eosTransaction) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(eosTransaction, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        EosTransaction.write$Self$OKWalletCore_wallet_lib(eosTransaction, compositeEncoderBeginStructure, serialDescriptor);
