...
public final /* synthetic */ class RunesMainOutPut$$serializer implements GeneratedSerializer<RunesMainOutPut> {
    public static final int $stable;
    public static final RunesMainOutPut$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RunesMainOutPut$$serializer() {
    }
    ...
    static {
        RunesMainOutPut$$serializer runesMainOutPut$$serializer = new RunesMainOutPut$$serializer();
        INSTANCE = runesMainOutPut$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.utxo.RunesMainOutPut", runesMainOutPut$$serializer, 3);
    ...
    public final RunesMainOutPut deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new RunesMainOutPut(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RunesMainOutPut runesMainOutPut) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(runesMainOutPut, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RunesMainOutPut.write$Self$OKWalletCore_wallet_lib(runesMainOutPut, compositeEncoderBeginStructure, serialDescriptor);
