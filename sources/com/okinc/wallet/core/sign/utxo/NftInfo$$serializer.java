...
public final /* synthetic */ class NftInfo$$serializer implements GeneratedSerializer<NftInfo> {
    public static final int $stable;
    public static final NftInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NftInfo$$serializer() {
    }
    ...
    static {
        NftInfo$$serializer nftInfo$$serializer = new NftInfo$$serializer();
        INSTANCE = nftInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.utxo.NftInfo", nftInfo$$serializer, 3);
    ...
    public final NftInfo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new NftInfo(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NftInfo nftInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(nftInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NftInfo.write$Self$OKWalletCore_wallet_lib(nftInfo, compositeEncoderBeginStructure, serialDescriptor);
