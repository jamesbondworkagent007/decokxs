...
public final /* synthetic */ class RunesOutPut$$serializer implements GeneratedSerializer<RunesOutPut> {
    public static final int $stable;
    public static final RunesOutPut$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RunesOutPut$$serializer() {
    }
    ...
    static {
        RunesOutPut$$serializer runesOutPut$$serializer = new RunesOutPut$$serializer();
        INSTANCE = runesOutPut$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.utxo.RunesOutPut", runesOutPut$$serializer, 3);
    ...
    public final RunesOutPut deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new RunesOutPut(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RunesOutPut runesOutPut) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(runesOutPut, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RunesOutPut.write$Self$OKWalletCore_wallet_lib(runesOutPut, compositeEncoderBeginStructure, serialDescriptor);
