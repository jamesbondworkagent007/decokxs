...
public final /* synthetic */ class PiTokenTransaction$$serializer implements GeneratedSerializer<PiTokenTransaction> {
    public static final int $stable;
    public static final PiTokenTransaction$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PiTokenTransaction$$serializer() {
    }
    ...
    static {
        PiTokenTransaction$$serializer piTokenTransaction$$serializer = new PiTokenTransaction$$serializer();
        INSTANCE = piTokenTransaction$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.pi.PiTokenTransaction", piTokenTransaction$$serializer, 11);
    ...
    public final PiTokenTransaction deserialize(@NotNull Decoder decoder) {
        ...
        return new PiTokenTransaction(i, str2, str4, str10, str7, str8, str6, str9, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.wallet.core.sign.pi.PiTokenTransaction.write$Self$OKWalletCore_wallet_lib(com.okinc.wallet.core.sign.pi.PiTokenTransaction, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PiTokenTransaction piTokenTransaction) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(piTokenTransaction, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PiTokenTransaction.write$Self$OKWalletCore_wallet_lib(piTokenTransaction, compositeEncoderBeginStructure, serialDescriptor);
