...
public final /* synthetic */ class PiTransaction$$serializer implements GeneratedSerializer<PiTransaction> {
    public static final int $stable;
    public static final PiTransaction$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PiTransaction$$serializer() {
    }
    ...
    static {
        PiTransaction$$serializer piTransaction$$serializer = new PiTransaction$$serializer();
        INSTANCE = piTransaction$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.pi.PiTransaction", piTransaction$$serializer, 9);
    ...
    public final PiTransaction deserialize(@NotNull Decoder decoder) {
        ...
        return new PiTransaction(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.wallet.core.sign.pi.PiTransaction.write$Self$OKWalletCore_wallet_lib(com.okinc.wallet.core.sign.pi.PiTransaction, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PiTransaction piTransaction) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(piTransaction, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PiTransaction.write$Self$OKWalletCore_wallet_lib(piTransaction, compositeEncoderBeginStructure, serialDescriptor);
