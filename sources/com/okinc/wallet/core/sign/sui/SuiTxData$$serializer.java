...
public final /* synthetic */ class SuiTxData$$serializer implements GeneratedSerializer<SuiTxData> {
    public static final int $stable;
    public static final SuiTxData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SuiTxData$$serializer() {
    }
    ...
    static {
        SuiTxData$$serializer suiTxData$$serializer = new SuiTxData$$serializer();
        INSTANCE = suiTxData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.wallet.core.sign.sui.SuiTxData", suiTxData$$serializer, 7);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = SuiTxData.$childSerializers;
    ...
    public final SuiTxData deserialize(@NotNull Decoder decoder) {
        List list;
        String str;
        String str2;
        String str3;
        ...
        return new SuiTxData(i, str3, str6, str5, str4, str, str2, list, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SuiTxData suiTxData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(suiTxData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SuiTxData.write$Self$OKWalletCore_wallet_lib(suiTxData, compositeEncoderBeginStructure, serialDescriptor);
