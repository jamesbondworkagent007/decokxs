package com.okinc.wallet.core.mnemonic;
...
public final class MnemonicValidateResult {
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.wallet.core.mnemonic.MnemonicValidateResult.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKWalletCore_wallet_lib(MnemonicValidateResult mnemonicValidateResult, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(java.lang.String, boolean, int):void (m)] (LINE:43) call: com.okinc.wallet.core.mnemonic.MnemonicValidateResult.<init>(java.lang.String, boolean, int):void type: THIS */
