...
public final /* synthetic */ class TermsURLContentData$$serializer implements GeneratedSerializer<TermsURLContentData> {
    public static final int $stable;
    public static final TermsURLContentData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TermsURLContentData$$serializer() {
    }
    ...
    static {
        TermsURLContentData$$serializer termsURLContentData$$serializer = new TermsURLContentData$$serializer();
        INSTANCE = termsURLContentData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.management.TermsURLContentData", termsURLContentData$$serializer, 5);
    ...
    public final TermsURLContentData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TermsURLContentData(i, str4, str5, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TermsURLContentData termsURLContentData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(termsURLContentData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TermsURLContentData.write$Self$OKPayments_ok_payment_api(termsURLContentData, compositeEncoderBeginStructure, serialDescriptor);
