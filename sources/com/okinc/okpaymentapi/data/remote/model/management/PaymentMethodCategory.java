...
public final class PaymentMethodCategory implements Parcelable {
    ...
    public static final PaymentMethodCategory CRYPTO = new PaymentMethodCategory("CRYPTO", 2, 2);

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private static final /* synthetic */ PaymentMethodCategory[] $values() {
        return new PaymentMethodCategory[]{CASH, STABLECOIN, CRYPTO};
    }
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.okpaymentapi.data.remote.model.management.PaymentMethodCategory.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ KSerializer _init_$_anonymous_() {
        return EnumsKt.createSimpleEnumSerializer("com.okinc.okpaymentapi.data.remote.model.management.PaymentMethodCategory", values());
    }
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<PaymentMethodCategory>() { // from class: com.okinc.okpaymentapi.data.remote.model.management.PaymentMethodCategory.Creator
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        $cachedSerializer$delegate = C56392yDr.EZpvd(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: o.tfV
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
