...
public final /* synthetic */ class BankingHours$$serializer implements GeneratedSerializer<BankingHours> {
    public static final int $stable;
    public static final BankingHours$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BankingHours$$serializer() {
    }
    ...
    static {
        BankingHours$$serializer bankingHours$$serializer = new BankingHours$$serializer();
        INSTANCE = bankingHours$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.management.BankingHours", bankingHours$$serializer, 5);
    ...
    public final BankingHours deserialize(@NotNull Decoder decoder) {
        boolean z;
        ...
        return new BankingHours(i, z, str2, str, strDecodeStringElement, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BankingHours bankingHours) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(bankingHours, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BankingHours.write$Self$OKPayments_ok_payment_api(bankingHours, compositeEncoderBeginStructure, serialDescriptor);
