...
public final /* synthetic */ class LocalizedText$$serializer implements GeneratedSerializer<LocalizedText> {
    public static final int $stable;
    public static final LocalizedText$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LocalizedText$$serializer() {
    }
    ...
    static {
        LocalizedText$$serializer localizedText$$serializer = new LocalizedText$$serializer();
        INSTANCE = localizedText$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.management.LocalizedText", localizedText$$serializer, 6);
    ...
    public final LocalizedText deserialize(@NotNull Decoder decoder) {
        ...
        return new LocalizedText(i, z, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LocalizedText localizedText) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(localizedText, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LocalizedText.write$Self$OKPayments_ok_payment_api(localizedText, compositeEncoderBeginStructure, serialDescriptor);
