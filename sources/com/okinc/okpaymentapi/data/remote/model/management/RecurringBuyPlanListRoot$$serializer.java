...
public final /* synthetic */ class RecurringBuyPlanListRoot$$serializer implements GeneratedSerializer<RecurringBuyPlanListRoot> {
    public static final int $stable;
    public static final RecurringBuyPlanListRoot$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RecurringBuyPlanListRoot$$serializer() {
    }
    ...
    static {
        RecurringBuyPlanListRoot$$serializer recurringBuyPlanListRoot$$serializer = new RecurringBuyPlanListRoot$$serializer();
        INSTANCE = recurringBuyPlanListRoot$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.management.RecurringBuyPlanListRoot", recurringBuyPlanListRoot$$serializer, 10);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = RecurringBuyPlanListRoot.$childSerializers;
        BooleanSerializer booleanSerializer = BooleanSerializer.INSTANCE;
        LongSerializer longSerializer = LongSerializer.INSTANCE;
        return new KSerializer[]{booleanSerializer, booleanSerializer, longSerializer, longSerializer, longSerializer, longSerializer, kSerializerArr[6], longSerializer, longSerializer, longSerializer};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final RecurringBuyPlanListRoot deserialize(@NotNull Decoder decoder) {
        ...
        return new RecurringBuyPlanListRoot(i, z, z2, j2, j4, j3, j5, list, jDecodeLongElement, j, jDecodeLongElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RecurringBuyPlanListRoot recurringBuyPlanListRoot) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(recurringBuyPlanListRoot, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RecurringBuyPlanListRoot.write$Self$OKPayments_ok_payment_api(recurringBuyPlanListRoot, compositeEncoderBeginStructure, serialDescriptor);
