...
public final /* synthetic */ class BillingAddress$$serializer implements GeneratedSerializer<BillingAddress> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.management.BillingAddress", billingAddress$$serializer, 6);
    ...
    public final BillingAddress deserialize(@NotNull Decoder decoder) {
        ...
        return new BillingAddress(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BillingAddress billingAddress) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(billingAddress, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BillingAddress.write$Self$OKPayments_ok_payment_api(billingAddress, compositeEncoderBeginStructure, serialDescriptor);
