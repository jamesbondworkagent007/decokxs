...
public final /* synthetic */ class RecurringConvertOrderDetail$$serializer implements GeneratedSerializer<RecurringConvertOrderDetail> {
    public static final int $stable;
    public static final RecurringConvertOrderDetail$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RecurringConvertOrderDetail$$serializer() {
    }
    ...
    static {
        RecurringConvertOrderDetail$$serializer recurringConvertOrderDetail$$serializer = new RecurringConvertOrderDetail$$serializer();
        INSTANCE = recurringConvertOrderDetail$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.management.RecurringConvertOrderDetail", recurringConvertOrderDetail$$serializer, 22);
    ...
    public final RecurringConvertOrderDetail deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new RecurringConvertOrderDetail(i, str, str7, str6, str3, str4, str2, str8, str11, str5, i2, str10, str9, str14, j, str15, str13, d2, d, str12, i3, iDecodeIntElement, iDecodeIntElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RecurringConvertOrderDetail recurringConvertOrderDetail) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(recurringConvertOrderDetail, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RecurringConvertOrderDetail.write$Self$OKPayments_ok_payment_api(recurringConvertOrderDetail, compositeEncoderBeginStructure, serialDescriptor);
