...
public final /* synthetic */ class B2CSwapBean$$serializer implements GeneratedSerializer<B2CSwapBean> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okpaymentapi.data.remote.model.experience.B2CSwapBean", b2CSwapBean$$serializer, 6);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull B2CSwapBean b2CSwapBean) {
        ...
        B2CSwapBean.write$Self$OKPayments_ok_payment_api(b2CSwapBean, compositeEncoderBeginStructure, serialDescriptor);
