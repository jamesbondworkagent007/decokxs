...
public final class CRRubikRepository$searchDexTokenList$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends List<? extends DexTokenBean>, ? extends OKServerException>>, Object> {
    ...
    public CRRubikRepository$searchDexTokenList$2(C31747mCk c31747mCk, String str, String str2, Continuation<? super CRRubikRepository$searchDexTokenList$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CRRubikRepository$searchDexTokenList$2 cRRubikRepository$searchDexTokenList$2 = new CRRubikRepository$searchDexTokenList$2(this.this$0, this.$key, this.$periodType, continuation);
        cRRubikRepository$searchDexTokenList$2.L$0 = obj;
        return cRRubikRepository$searchDexTokenList$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends List<DexTokenBean>, OKServerException>> continuation) {
        return ((CRRubikRepository$searchDexTokenList$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                obj = InterfaceC31771mDh.Application.searchDexTokenList$default(interfaceC31771mDh, str, str2, null, null, this, 12, null);
        ...
        return mAY.OLrzqt(actionBar, new Function1() { // from class: o.mCR
            ...
            public final java.lang.Object invoke(java.lang.Object obj2) {
                return CRRubikRepository$searchDexTokenList$2.invokeSuspend$lambda$2((java.util.List) obj2);
            }
        });
    }
