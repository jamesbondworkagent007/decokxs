...
public final class CRB2CRepository$getQuotedPrice$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends List<? extends B2CQuotePriceBean>, ? extends OKServerException>>, Object> {
    ...
    public CRB2CRepository$getQuotedPrice$2(C31731mBv c31731mBv, String str, String str2, String str3, String str4, int i, String str5, String str6, Continuation<? super CRB2CRepository$getQuotedPrice$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CRB2CRepository$getQuotedPrice$2 cRB2CRepository$getQuotedPrice$2 = new CRB2CRepository$getQuotedPrice$2(this.this$0, this.$baseCurrency, this.$quoteCurrency, this.$tradeType, this.$quoteAmount, this.$standard, this.$depositName, this.$paymentMethod, continuation);
        cRB2CRepository$getQuotedPrice$2.L$0 = obj;
        return cRB2CRepository$getQuotedPrice$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends List<B2CQuotePriceBean>, OKServerException>> continuation) {
        return ((CRB2CRepository$getQuotedPrice$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                String strKWHzl = C31788mDy.copydefault.KWHzl(str4);
                this.label = 1;
                obj = interfaceC31770mDg.KWHzl(str, str2, str3, strKWHzl, i2, str5, str6, this);
        ...
        return mAY.OLrzqt(actionBar, new Function1() { // from class: o.mBH
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj2) {
                return CRB2CRepository$getQuotedPrice$2.invokeSuspend$lambda$2((java.util.ArrayList) obj2);
            }
        });
    }
    ...
    public static final List invokeSuspend$lambda$2(ArrayList arrayList) {
        ...
        while (it.hasNext()) {
            arrayList2.add(B2CQuotePriceBean.Companion.EZpvd((B2CQuotePriceResponseBean) it.next()));
        }
        return arrayList2;
    }
}
