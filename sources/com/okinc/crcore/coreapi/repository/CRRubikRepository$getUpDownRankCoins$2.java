...
public final class CRRubikRepository$getUpDownRankCoins$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends List<? extends CoinBean>, ? extends OKServerException>>, Object> {
    ...
    public CRRubikRepository$getUpDownRankCoins$2(C31747mCk c31747mCk, Integer num, Integer num2, String str, String str2, Continuation<? super CRRubikRepository$getUpDownRankCoins$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CRRubikRepository$getUpDownRankCoins$2 cRRubikRepository$getUpDownRankCoins$2 = new CRRubikRepository$getUpDownRankCoins$2(this.this$0, this.$num, this.$rank, this.$zone, this.$fiat, continuation);
        cRRubikRepository$getUpDownRankCoins$2.L$0 = obj;
        return cRRubikRepository$getUpDownRankCoins$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<? extends List<CoinBean>, OKServerException>> continuation) {
        return ((CRRubikRepository$getUpDownRankCoins$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                obj = interfaceC31771mDh.copydefault(num, num2, str, str2, this);
        ...
        return mAY.OLrzqt(actionBar, new Function1() { // from class: o.mCS
            ...
            public final java.lang.Object invoke(java.lang.Object obj2) {
                return CRRubikRepository$getUpDownRankCoins$2.invokeSuspend$lambda$1((java.util.List) obj2);
            }
        });
    }
