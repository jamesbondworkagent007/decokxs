...
public final class CRRubikRepository$deletePriceRemind$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AbstractC43419rot<? extends Unit, ? extends OKServerException>>, Object> {
    ...
    public CRRubikRepository$deletePriceRemind$2(C31747mCk c31747mCk, String str, int i, Continuation<? super CRRubikRepository$deletePriceRemind$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CRRubikRepository$deletePriceRemind$2 cRRubikRepository$deletePriceRemind$2 = new CRRubikRepository$deletePriceRemind$2(this.this$0, this.$ruleId, this.$bizType, continuation);
        cRRubikRepository$deletePriceRemind$2.L$0 = obj;
        return cRRubikRepository$deletePriceRemind$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super AbstractC43419rot<Unit, OKServerException>> continuation) {
        return ((CRRubikRepository$deletePriceRemind$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                DeleteRuleApiRequestBean deleteRuleApiRequestBean = new DeleteRuleApiRequestBean(str, i2);
                this.label = 1;
                obj = interfaceC31771mDh.KWHzl(deleteRuleApiRequestBean, this);
