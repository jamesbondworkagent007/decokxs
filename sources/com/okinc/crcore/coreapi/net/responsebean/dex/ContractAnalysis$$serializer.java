...
public final /* synthetic */ class ContractAnalysis$$serializer implements GeneratedSerializer<ContractAnalysis> {
    public static final int $stable;
    public static final ContractAnalysis$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ContractAnalysis$$serializer() {
    }
    ...
    static {
        ContractAnalysis$$serializer contractAnalysis$$serializer = new ContractAnalysis$$serializer();
        INSTANCE = contractAnalysis$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.dex.ContractAnalysis", contractAnalysis$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = ContractAnalysis.$childSerializers;
        return new KSerializer[]{kSerializerArr[0], kSerializerArr[1], kSerializerArr[2]};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final ContractAnalysis deserialize(@NotNull Decoder decoder) {
        int i;
        List list;
        List list2;
        List list3;
        ...
        return new ContractAnalysis(i, list3, list, list2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ContractAnalysis contractAnalysis) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(contractAnalysis, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ContractAnalysis.write$Self$OKCRCore_cr_core(contractAnalysis, compositeEncoderBeginStructure, serialDescriptor);
