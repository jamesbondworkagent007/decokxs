...
public final /* synthetic */ class RiskItem$$serializer implements GeneratedSerializer<RiskItem> {
    public static final int $stable;
    public static final RiskItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RiskItem$$serializer() {
    }
    ...
    static {
        RiskItem$$serializer riskItem$$serializer = new RiskItem$$serializer();
        INSTANCE = riskItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.dex.RiskItem", riskItem$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("newRiskDesc", true);
        pluginGeneratedSerialDescriptor.addElement("newRiskLabel", true);
        pluginGeneratedSerialDescriptor.addElement("newRiskName", true);
        pluginGeneratedSerialDescriptor.addElement("riskControlLevel", true);
        pluginGeneratedSerialDescriptor.addElement("riskDesc", true);
        pluginGeneratedSerialDescriptor.addElement("riskName", true);
    ...
    public final RiskItem deserialize(@NotNull Decoder decoder) {
        ...
        return new RiskItem(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RiskItem riskItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(riskItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RiskItem.write$Self$OKCRCore_cr_core(riskItem, compositeEncoderBeginStructure, serialDescriptor);
