...
public final /* synthetic */ class ExtraAnalysis$$serializer implements GeneratedSerializer<ExtraAnalysis> {
    public static final int $stable;
    public static final ExtraAnalysis$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ExtraAnalysis$$serializer() {
    }
    ...
    static {
        ExtraAnalysis$$serializer extraAnalysis$$serializer = new ExtraAnalysis$$serializer();
        INSTANCE = extraAnalysis$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.dex.ExtraAnalysis", extraAnalysis$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = ExtraAnalysis.$childSerializers;
        return new KSerializer[]{kSerializerArr[0], kSerializerArr[1], kSerializerArr[2]};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final ExtraAnalysis deserialize(@NotNull Decoder decoder) {
        int i;
        List list;
        List list2;
        List list3;
        ...
        return new ExtraAnalysis(i, list3, list, list2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ExtraAnalysis extraAnalysis) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(extraAnalysis, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ExtraAnalysis.write$Self$OKCRCore_cr_core(extraAnalysis, compositeEncoderBeginStructure, serialDescriptor);
