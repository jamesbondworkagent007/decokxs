...
public final /* synthetic */ class AllAnalysis$$serializer implements GeneratedSerializer<AllAnalysis> {
    public static final int $stable;
    public static final AllAnalysis$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AllAnalysis$$serializer() {
    }
    ...
    static {
        AllAnalysis$$serializer allAnalysis$$serializer = new AllAnalysis$$serializer();
        INSTANCE = allAnalysis$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.dex.AllAnalysis", allAnalysis$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = AllAnalysis.$childSerializers;
        return new KSerializer[]{kSerializerArr[0], kSerializerArr[1], kSerializerArr[2]};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final AllAnalysis deserialize(@NotNull Decoder decoder) {
        int i;
        List list;
        List list2;
        List list3;
        ...
        return new AllAnalysis(i, list3, list, list2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AllAnalysis allAnalysis) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(allAnalysis, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AllAnalysis.write$Self$OKCRCore_cr_core(allAnalysis, compositeEncoderBeginStructure, serialDescriptor);
