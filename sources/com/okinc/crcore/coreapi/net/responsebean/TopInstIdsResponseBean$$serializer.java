...
public final /* synthetic */ class TopInstIdsResponseBean$$serializer implements GeneratedSerializer<TopInstIdsResponseBean> {
    public static final int $stable;
    public static final TopInstIdsResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TopInstIdsResponseBean$$serializer() {
    }
    ...
    static {
        TopInstIdsResponseBean$$serializer topInstIdsResponseBean$$serializer = new TopInstIdsResponseBean$$serializer();
        INSTANCE = topInstIdsResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.TopInstIdsResponseBean", topInstIdsResponseBean$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("instId", true);
        pluginGeneratedSerialDescriptor.addElement("displayId", true);
        pluginGeneratedSerialDescriptor.addElement("latestPrice", true);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = TopInstIdsResponseBean.$childSerializers;
    ...
    public final TopInstIdsResponseBean deserialize(@NotNull Decoder decoder) {
        List list;
        String str;
        String str2;
        String str3;
        ...
        return new TopInstIdsResponseBean(i, str3, str6, str5, str4, str, str2, list, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TopInstIdsResponseBean topInstIdsResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(topInstIdsResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TopInstIdsResponseBean.write$Self$OKCRCore_cr_core(topInstIdsResponseBean, compositeEncoderBeginStructure, serialDescriptor);
