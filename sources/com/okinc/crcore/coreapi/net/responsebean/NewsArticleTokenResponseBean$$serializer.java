...
public final /* synthetic */ class NewsArticleTokenResponseBean$$serializer implements GeneratedSerializer<NewsArticleTokenResponseBean> {
    public static final int $stable;
    public static final NewsArticleTokenResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private NewsArticleTokenResponseBean$$serializer() {
    }
    ...
    static {
        NewsArticleTokenResponseBean$$serializer newsArticleTokenResponseBean$$serializer = new NewsArticleTokenResponseBean$$serializer();
        INSTANCE = newsArticleTokenResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.NewsArticleTokenResponseBean", newsArticleTokenResponseBean$$serializer, 9);
    ...
    public final NewsArticleTokenResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new NewsArticleTokenResponseBean(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull NewsArticleTokenResponseBean newsArticleTokenResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(newsArticleTokenResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        NewsArticleTokenResponseBean.write$Self$OKCRCore_cr_core(newsArticleTokenResponseBean, compositeEncoderBeginStructure, serialDescriptor);
