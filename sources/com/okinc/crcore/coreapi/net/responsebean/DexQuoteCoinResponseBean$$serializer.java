...
public final /* synthetic */ class DexQuoteCoinResponseBean$$serializer implements GeneratedSerializer<DexQuoteCoinResponseBean> {
    public static final int $stable;
    public static final DexQuoteCoinResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DexQuoteCoinResponseBean$$serializer() {
    }
    ...
    static {
        DexQuoteCoinResponseBean$$serializer dexQuoteCoinResponseBean$$serializer = new DexQuoteCoinResponseBean$$serializer();
        INSTANCE = dexQuoteCoinResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.DexQuoteCoinResponseBean", dexQuoteCoinResponseBean$$serializer, 8);
    ...
    public final DexQuoteCoinResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new DexQuoteCoinResponseBean(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DexQuoteCoinResponseBean dexQuoteCoinResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dexQuoteCoinResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DexQuoteCoinResponseBean.write$Self$OKCRCore_cr_core(dexQuoteCoinResponseBean, compositeEncoderBeginStructure, serialDescriptor);
