...
public final /* synthetic */ class CoinFilter$$serializer implements GeneratedSerializer<CoinFilter> {
    public static final int $stable;
    public static final CoinFilter$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CoinFilter$$serializer() {
    }
    ...
    static {
        CoinFilter$$serializer coinFilter$$serializer = new CoinFilter$$serializer();
        INSTANCE = coinFilter$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.transactions.filter.CoinFilter", coinFilter$$serializer, 6);
    ...
    public final CoinFilter deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        int i;
        String str3;
        ...
        return new CoinFilter(i, num, str5, str4, str2, str3, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CoinFilter coinFilter) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(coinFilter, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CoinFilter.KWHzl(coinFilter, compositeEncoderBeginStructure, serialDescriptor);
