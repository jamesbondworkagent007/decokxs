...
public final /* synthetic */ class UiFlowControlResponseBean$$serializer implements GeneratedSerializer<UiFlowControlResponseBean> {
    public static final int $stable;
    public static final UiFlowControlResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private UiFlowControlResponseBean$$serializer() {
    }
    ...
    static {
        UiFlowControlResponseBean$$serializer uiFlowControlResponseBean$$serializer = new UiFlowControlResponseBean$$serializer();
        INSTANCE = uiFlowControlResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.UiFlowControlResponseBean", uiFlowControlResponseBean$$serializer, 9);
    ...
    public final UiFlowControlResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new UiFlowControlResponseBean(i, z5, z3, z2, z, zDecodeBooleanElement, z4, bool, zDecodeBooleanElement2, zDecodeBooleanElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull UiFlowControlResponseBean uiFlowControlResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(uiFlowControlResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        UiFlowControlResponseBean.write$Self$OKCRCore_cr_core(uiFlowControlResponseBean, compositeEncoderBeginStructure, serialDescriptor);
