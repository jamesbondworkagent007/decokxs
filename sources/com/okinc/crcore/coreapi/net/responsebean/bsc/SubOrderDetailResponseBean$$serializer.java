...
public final /* synthetic */ class SubOrderDetailResponseBean$$serializer implements GeneratedSerializer<SubOrderDetailResponseBean> {
    public static final int $stable;
    public static final SubOrderDetailResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SubOrderDetailResponseBean$$serializer() {
    }
    ...
    static {
        SubOrderDetailResponseBean$$serializer subOrderDetailResponseBean$$serializer = new SubOrderDetailResponseBean$$serializer();
        INSTANCE = subOrderDetailResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.SubOrderDetailResponseBean", subOrderDetailResponseBean$$serializer, 17);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = SubOrderDetailResponseBean.$childSerializers;
    ...
    public final SubOrderDetailResponseBean deserialize(@NotNull Decoder decoder) {
        double d;
        boolean z;
        String str;
        String str2;
        ...
        return new SubOrderDetailResponseBean(i2, i, d, str11, str10, str7, d2, str9, str8, str, z, str6, str2, str5, str4, str3, j, list, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SubOrderDetailResponseBean subOrderDetailResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(subOrderDetailResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SubOrderDetailResponseBean.write$Self$OKCRCore_cr_core(subOrderDetailResponseBean, compositeEncoderBeginStructure, serialDescriptor);
