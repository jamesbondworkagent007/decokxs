...
public final /* synthetic */ class LocalizationHighlightStyleResponseBean$$serializer implements GeneratedSerializer<LocalizationHighlightStyleResponseBean> {
    public static final int $stable;
    public static final LocalizationHighlightStyleResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LocalizationHighlightStyleResponseBean$$serializer() {
    }
    ...
    static {
        LocalizationHighlightStyleResponseBean$$serializer localizationHighlightStyleResponseBean$$serializer = new LocalizationHighlightStyleResponseBean$$serializer();
        INSTANCE = localizationHighlightStyleResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.LocalizationHighlightStyleResponseBean", localizationHighlightStyleResponseBean$$serializer, 5);
    ...
    public final LocalizationHighlightStyleResponseBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new LocalizationHighlightStyleResponseBean(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LocalizationHighlightStyleResponseBean localizationHighlightStyleResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(localizationHighlightStyleResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LocalizationHighlightStyleResponseBean.write$Self$OKCRCore_cr_core(localizationHighlightStyleResponseBean, compositeEncoderBeginStructure, serialDescriptor);
