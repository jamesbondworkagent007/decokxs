...
public final /* synthetic */ class BuySellCurrencyResponseBean$$serializer implements GeneratedSerializer<BuySellCurrencyResponseBean> {
    public static final int $stable;
    public static final BuySellCurrencyResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BuySellCurrencyResponseBean$$serializer() {
    }
    ...
    static {
        BuySellCurrencyResponseBean$$serializer buySellCurrencyResponseBean$$serializer = new BuySellCurrencyResponseBean$$serializer();
        INSTANCE = buySellCurrencyResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.BuySellCurrencyResponseBean", buySellCurrencyResponseBean$$serializer, 17);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = BuySellCurrencyResponseBean.$childSerializers;
    ...
    public final BuySellCurrencyResponseBean deserialize(@NotNull Decoder decoder) {
        List list;
        int i;
        String str;
        String str2;
        ...
        return new BuySellCurrencyResponseBean(i, str4, z, list, str3, str2, str7, str9, z2, str6, str8, i2, list2, i3, str5, str, d, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BuySellCurrencyResponseBean buySellCurrencyResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(buySellCurrencyResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BuySellCurrencyResponseBean.write$Self$OKCRCore_cr_core(buySellCurrencyResponseBean, compositeEncoderBeginStructure, serialDescriptor);
