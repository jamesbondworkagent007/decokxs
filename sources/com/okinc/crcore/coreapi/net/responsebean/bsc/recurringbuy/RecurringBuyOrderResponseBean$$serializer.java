...
public final /* synthetic */ class RecurringBuyOrderResponseBean$$serializer implements GeneratedSerializer<RecurringBuyOrderResponseBean> {
    public static final int $stable;
    public static final RecurringBuyOrderResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RecurringBuyOrderResponseBean$$serializer() {
    }
    ...
    static {
        RecurringBuyOrderResponseBean$$serializer recurringBuyOrderResponseBean$$serializer = new RecurringBuyOrderResponseBean$$serializer();
        INSTANCE = recurringBuyOrderResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.recurringbuy.RecurringBuyOrderResponseBean", recurringBuyOrderResponseBean$$serializer, 29);
        ...
        pluginGeneratedSerialDescriptor.addElement("convertOrderDetail", false);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, BuiltinSerializersKt.getNullable(stringSerializer), stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, LongSerializer.INSTANCE, stringSerializer, stringSerializer, stringSerializer, BooleanSerializer.INSTANCE, BuiltinSerializersKt.getNullable(RecurringBuyConvertOrderDetailResponseBean$$serializer.INSTANCE), stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final RecurringBuyOrderResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        String str14;
        long j;
        RecurringBuyConvertOrderDetailResponseBean recurringBuyConvertOrderDetailResponseBean;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            RecurringBuyConvertOrderDetailResponseBean recurringBuyConvertOrderDetailResponseBean2 = (RecurringBuyConvertOrderDetailResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 20, RecurringBuyConvertOrderDetailResponseBean$$serializer.INSTANCE, null);
            ...
            strDecodeStringElement3 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, 28);
            ...
            recurringBuyConvertOrderDetailResponseBean = recurringBuyConvertOrderDetailResponseBean2;
            ...
            i = 536870911;
            str22 = strDecodeStringElement22;
            ...
            str21 = strDecodeStringElement5;
        } else {
            String strDecodeStringElement27 = null;
            int i7 = 0;
            boolean zDecodeBooleanElement2 = false;
            boolean z2 = true;
            RecurringBuyConvertOrderDetailResponseBean recurringBuyConvertOrderDetailResponseBean3 = null;
            String str24 = null;
            ...
            while (z2) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 4:
                        i2 = i6;
                        i7 |= 16;
                        strDecodeStringElement39 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, i2);
                        i6 = i2;
                        i5 = 5;
                        break;
                    case 5:
                    ...
                    case 9:
                        i7 |= 512;
                        strDecodeStringElement47 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, 9);
                        i6 = 4;
                        break;
                    case 10:
                        i7 |= 1024;
                    ...
                    case 19:
                        ...
                        break;
                    case 20:
                        recurringBuyConvertOrderDetailResponseBean3 = (RecurringBuyConvertOrderDetailResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 20, RecurringBuyConvertOrderDetailResponseBean$$serializer.INSTANCE, recurringBuyConvertOrderDetailResponseBean3);
                        i7 = 1048576 | i7;
                        i6 = 4;
                        break;
                    case 21:
                        strDecodeStringElement32 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, 21);
                        i3 = 2097152;
                        i7 |= i3;
                        i2 = i6;
                        i6 = i2;
                    ...
                    case 22:
                        ...
                        break;
                    case 23:
                        strDecodeStringElement31 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, 23);
                        i3 = 8388608;
                        i7 |= i3;
                        i2 = i6;
                        i6 = i2;
                    ...
                    case 26:
                        ...
                        break;
                    case 27:
                        strDecodeStringElement50 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, 27);
                        i3 = 134217728;
                        i7 |= i3;
                        i2 = i6;
                        i6 = i2;
                        ...
                        break;
                    case 28:
                        strDecodeStringElement49 = compositeDecoderBeginStructure.decodeStringElement(serialDescriptor, 28);
                        i3 = 268435456;
                        i7 |= i3;
                        i2 = i6;
                        i6 = i2;
            ...
            str10 = strDecodeStringElement43;
            strDecodeStringElement2 = strDecodeStringElement44;
            str11 = strDecodeStringElement45;
            str12 = strDecodeStringElement46;
            str13 = strDecodeStringElement47;
            str14 = strDecodeStringElement48;
            j = jDecodeLongElement2;
            recurringBuyConvertOrderDetailResponseBean = recurringBuyConvertOrderDetailResponseBean3;
            ...
            String str25 = strDecodeStringElement32;
            str22 = strDecodeStringElement31;
            str23 = str25;
        }
        compositeDecoderBeginStructure.endStructure(serialDescriptor);
        return new RecurringBuyOrderResponseBean(i, str10, str21, str9, str8, str7, str14, str6, str, str5, str13, str12, str4, str11, str2, strDecodeStringElement2, j, str15, str17, str19, z, recurringBuyConvertOrderDetailResponseBean, str23, strDecodeStringElement, str22, str3, str20, str18, str16, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RecurringBuyOrderResponseBean recurringBuyOrderResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(recurringBuyOrderResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RecurringBuyOrderResponseBean.write$Self$OKCRCore_cr_core(recurringBuyOrderResponseBean, compositeEncoderBeginStructure, serialDescriptor);
