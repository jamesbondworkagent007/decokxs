...
public final /* synthetic */ class FiatOrderItem$$serializer implements GeneratedSerializer<FiatOrderItem> {
    public static final int $stable;
    public static final FiatOrderItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private FiatOrderItem$$serializer() {
    }
    ...
    static {
        FiatOrderItem$$serializer fiatOrderItem$$serializer = new FiatOrderItem$$serializer();
        INSTANCE = fiatOrderItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.FiatOrderItem", fiatOrderItem$$serializer, 37);
    ...
    public final FiatOrderItem deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            ConvertOrderDetail convertOrderDetail2 = (ConvertOrderDetail) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 33, ConvertOrderDetail$$serializer.INSTANCE, null);
            ...
            convertOrderDetail = convertOrderDetail2;
            ...
            i = 0;
            ConvertOrderDetail convertOrderDetail3 = null;
            ...
            while (z2) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 32:
                        ...
                        break;
                    case 33:
                        convertOrderDetail3 = (ConvertOrderDetail) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 33, ConvertOrderDetail$$serializer.INSTANCE, convertOrderDetail3);
                        i6 = i9 | 2;
            ...
            convertOrderDetail = convertOrderDetail3;
        ...
        return new FiatOrderItem(i, i4, str11, str10, str3, str9, str8, strDecodeStringElement2, str7, str20, i2, j, str2, i3, str, str6, str24, str22, str17, str16, z, str5, str18, str23, str21, str27, str29, strDecodeStringElement, str28, str26, str19, str25, str15, str12, str4, convertOrderDetail, str13, str14, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull FiatOrderItem fiatOrderItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(fiatOrderItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        FiatOrderItem.write$Self$OKCRCore_cr_core(fiatOrderItem, compositeEncoderBeginStructure, serialDescriptor);
