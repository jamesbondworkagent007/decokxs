...
public final /* synthetic */ class B2CSwapResponseBean$$serializer implements GeneratedSerializer<B2CSwapResponseBean> {
    public static final int $stable;
    public static final B2CSwapResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private B2CSwapResponseBean$$serializer() {
    }
    ...
    static {
        B2CSwapResponseBean$$serializer b2CSwapResponseBean$$serializer = new B2CSwapResponseBean$$serializer();
        INSTANCE = b2CSwapResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.B2CSwapResponseBean", b2CSwapResponseBean$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = B2CSwapResponseBean.$childSerializers;
    ...
    public final B2CSwapResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new B2CSwapResponseBean(i, str, str3, strDecodeStringElement, str4, str2, arrayList, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull B2CSwapResponseBean b2CSwapResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(b2CSwapResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        B2CSwapResponseBean.write$Self$OKCRCore_cr_core(b2CSwapResponseBean, compositeEncoderBeginStructure, serialDescriptor);
