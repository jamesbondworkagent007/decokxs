...
public final /* synthetic */ class ConvertOrderDetail$$serializer implements GeneratedSerializer<ConvertOrderDetail> {
    public static final int $stable;
    public static final ConvertOrderDetail$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConvertOrderDetail$$serializer() {
    }
    ...
    static {
        ConvertOrderDetail$$serializer convertOrderDetail$$serializer = new ConvertOrderDetail$$serializer();
        INSTANCE = convertOrderDetail$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.ConvertOrderDetail", convertOrderDetail$$serializer, 22);
    ...
    public final ConvertOrderDetail deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ConvertOrderDetail(i, str, str7, str6, str3, str4, str2, str8, str11, str5, i2, str10, str9, str14, j, str15, str13, d2, d, str12, i3, iDecodeIntElement, iDecodeIntElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConvertOrderDetail convertOrderDetail) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(convertOrderDetail, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConvertOrderDetail.write$Self$OKCRCore_cr_core(convertOrderDetail, compositeEncoderBeginStructure, serialDescriptor);
