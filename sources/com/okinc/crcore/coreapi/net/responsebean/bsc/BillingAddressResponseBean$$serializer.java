...
public final /* synthetic */ class BillingAddressResponseBean$$serializer implements GeneratedSerializer<BillingAddressResponseBean> {
    public static final int $stable;
    public static final BillingAddressResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BillingAddressResponseBean$$serializer() {
    }
    ...
    static {
        BillingAddressResponseBean$$serializer billingAddressResponseBean$$serializer = new BillingAddressResponseBean$$serializer();
        INSTANCE = billingAddressResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.BillingAddressResponseBean", billingAddressResponseBean$$serializer, 6);
    ...
    public final BillingAddressResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new BillingAddressResponseBean(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BillingAddressResponseBean billingAddressResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(billingAddressResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BillingAddressResponseBean.write$Self$OKCRCore_cr_core(billingAddressResponseBean, compositeEncoderBeginStructure, serialDescriptor);
