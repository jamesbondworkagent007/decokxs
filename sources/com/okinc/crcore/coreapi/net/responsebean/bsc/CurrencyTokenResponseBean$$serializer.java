...
public final /* synthetic */ class CurrencyTokenResponseBean$$serializer implements GeneratedSerializer<CurrencyTokenResponseBean> {
    public static final int $stable;
    public static final CurrencyTokenResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CurrencyTokenResponseBean$$serializer() {
    }
    ...
    static {
        CurrencyTokenResponseBean$$serializer currencyTokenResponseBean$$serializer = new CurrencyTokenResponseBean$$serializer();
        INSTANCE = currencyTokenResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.CurrencyTokenResponseBean", currencyTokenResponseBean$$serializer, 27);
    ...
    public final CurrencyTokenResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            EarnOptionResponseBean earnOptionResponseBean2 = (EarnOptionResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 19, EarnOptionResponseBean$$serializer.INSTANCE, null);
            ...
            dexInfoResponseBean = (DexInfoResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 26, DexInfoResponseBean$$serializer.INSTANCE, null);
            ...
            EarnOptionResponseBean earnOptionResponseBean3 = null;
            ...
            while (z5) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 18:
                        ...
                        break;
                    case 19:
                        earnOptionResponseBean3 = (EarnOptionResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 19, EarnOptionResponseBean$$serializer.INSTANCE, earnOptionResponseBean3);
                        i6 = 524288;
                        i12 |= i6;
                        i4 = 6;
                        i10 = i4;
                    ...
                    case 25:
                        ...
                        break;
                    case 26:
                        dexInfoResponseBean2 = (DexInfoResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 26, DexInfoResponseBean$$serializer.INSTANCE, dexInfoResponseBean2);
                        i7 = 67108864;
                        i6 = i7;
                        i12 |= i6;
                        i4 = 6;
        ...
        return new CurrencyTokenResponseBean(i, str6, z, list, str5, str4, str3, str7, z2, str2, str, i2, list3, i3, str13, str11, d2, strDecodeStringElement, str12, str8, earnOptionResponseBean, list2, str10, str9, d, z4, z3, dexInfoResponseBean, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CurrencyTokenResponseBean currencyTokenResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(currencyTokenResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CurrencyTokenResponseBean.write$Self$OKCRCore_cr_core(currencyTokenResponseBean, compositeEncoderBeginStructure, serialDescriptor);
