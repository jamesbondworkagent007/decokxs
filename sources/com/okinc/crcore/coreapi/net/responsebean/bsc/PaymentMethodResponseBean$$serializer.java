...
public final /* synthetic */ class PaymentMethodResponseBean$$serializer implements GeneratedSerializer<PaymentMethodResponseBean> {
    public static final int $stable;
    public static final PaymentMethodResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PaymentMethodResponseBean$$serializer() {
    }
    ...
    static {
        PaymentMethodResponseBean$$serializer paymentMethodResponseBean$$serializer = new PaymentMethodResponseBean$$serializer();
        INSTANCE = paymentMethodResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.PaymentMethodResponseBean", paymentMethodResponseBean$$serializer, 29);
    ...
    public final PaymentMethodResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            AccountResponseBean accountResponseBean2 = (AccountResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 14, AccountResponseBean$$serializer.INSTANCE, null);
            ...
            SellerReceiptAccountResponseBean sellerReceiptAccountResponseBean2 = (SellerReceiptAccountResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 22, SellerReceiptAccountResponseBean$$serializer.INSTANCE, null);
            ...
            sellerReceiptAccountResponseBean = sellerReceiptAccountResponseBean2;
            ...
            List list6 = null;
            List list7 = null;
            SellerReceiptAccountResponseBean sellerReceiptAccountResponseBean3 = null;
            AccountResponseBean accountResponseBean3 = null;
            ...
            while (z6) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        accountResponseBean3 = (AccountResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 14, AccountResponseBean$$serializer.INSTANCE, accountResponseBean3);
                        i5 |= 16384;
                        i4 = 8;
                        i3 = 9;
                        break;
                    ...
                    case 21:
                        ...
                        break;
                    case 22:
                        sellerReceiptAccountResponseBean3 = (SellerReceiptAccountResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 22, SellerReceiptAccountResponseBean$$serializer.INSTANCE, sellerReceiptAccountResponseBean3);
                        i2 = 4194304;
                        i5 |= i2;
                        i4 = 8;
                        i3 = 9;
            ...
            list = list8;
            sellerReceiptAccountResponseBean = sellerReceiptAccountResponseBean3;
        ...
        return new PaymentMethodResponseBean(i, str11, str10, str9, str8, str7, str6, str5, str12, str, str2, list2, str13, z3, z5, accountResponseBean, str15, str4, str17, list3, z2, str16, z4, sellerReceiptAccountResponseBean, str3, str18, str14, z, list, iDecodeIntElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PaymentMethodResponseBean paymentMethodResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(paymentMethodResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PaymentMethodResponseBean.write$Self$OKCRCore_cr_core(paymentMethodResponseBean, compositeEncoderBeginStructure, serialDescriptor);
