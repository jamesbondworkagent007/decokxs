...
public final /* synthetic */ class RecurringBuyConvertOrderDetailResponseBean$$serializer implements GeneratedSerializer<RecurringBuyConvertOrderDetailResponseBean> {
    public static final int $stable;
    public static final RecurringBuyConvertOrderDetailResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RecurringBuyConvertOrderDetailResponseBean$$serializer() {
    }
    ...
    static {
        RecurringBuyConvertOrderDetailResponseBean$$serializer recurringBuyConvertOrderDetailResponseBean$$serializer = new RecurringBuyConvertOrderDetailResponseBean$$serializer();
        INSTANCE = recurringBuyConvertOrderDetailResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.bsc.recurringbuy.RecurringBuyConvertOrderDetailResponseBean", recurringBuyConvertOrderDetailResponseBean$$serializer, 22);
    ...
    public final RecurringBuyConvertOrderDetailResponseBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new RecurringBuyConvertOrderDetailResponseBean(i, str, str7, str6, str3, str4, str2, str8, str11, str5, i2, str10, str9, str14, j, str15, str13, d2, d, str12, i3, iDecodeIntElement, iDecodeIntElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RecurringBuyConvertOrderDetailResponseBean recurringBuyConvertOrderDetailResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(recurringBuyConvertOrderDetailResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RecurringBuyConvertOrderDetailResponseBean.write$Self$OKCRCore_cr_core(recurringBuyConvertOrderDetailResponseBean, compositeEncoderBeginStructure, serialDescriptor);
