...
public final /* synthetic */ class FollowRankResponseBean$$serializer implements GeneratedSerializer<FollowRankResponseBean> {
    public static final int $stable;
    public static final FollowRankResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private FollowRankResponseBean$$serializer() {
    }
    ...
    static {
        FollowRankResponseBean$$serializer followRankResponseBean$$serializer = new FollowRankResponseBean$$serializer();
        INSTANCE = followRankResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.FollowRankResponseBean", followRankResponseBean$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("yieldRatio", true);
    ...
    public final FollowRankResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new FollowRankResponseBean(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull FollowRankResponseBean followRankResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(followRankResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        FollowRankResponseBean.write$Self$OKCRCore_cr_core(followRankResponseBean, compositeEncoderBeginStructure, serialDescriptor);
