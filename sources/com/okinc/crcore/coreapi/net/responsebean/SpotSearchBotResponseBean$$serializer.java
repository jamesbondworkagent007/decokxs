...
public final /* synthetic */ class SpotSearchBotResponseBean$$serializer implements GeneratedSerializer<SpotSearchBotResponseBean> {
    public static final int $stable;
    public static final SpotSearchBotResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SpotSearchBotResponseBean$$serializer() {
    }
    ...
    static {
        SpotSearchBotResponseBean$$serializer spotSearchBotResponseBean$$serializer = new SpotSearchBotResponseBean$$serializer();
        INSTANCE = spotSearchBotResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.SpotSearchBotResponseBean", spotSearchBotResponseBean$$serializer, 6);
    ...
    public final SpotSearchBotResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new SpotSearchBotResponseBean(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SpotSearchBotResponseBean spotSearchBotResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(spotSearchBotResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SpotSearchBotResponseBean.write$Self$OKCRCore_cr_core(spotSearchBotResponseBean, compositeEncoderBeginStructure, serialDescriptor);
