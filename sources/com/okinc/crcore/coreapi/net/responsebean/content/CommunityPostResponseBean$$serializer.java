...
public final /* synthetic */ class CommunityPostResponseBean$$serializer implements GeneratedSerializer<CommunityPostResponseBean> {
    public static final int $stable;
    public static final CommunityPostResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CommunityPostResponseBean$$serializer() {
    }
    ...
    static {
        CommunityPostResponseBean$$serializer communityPostResponseBean$$serializer = new CommunityPostResponseBean$$serializer();
        INSTANCE = communityPostResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.content.CommunityPostResponseBean", communityPostResponseBean$$serializer, 19);
    ...
    public final CommunityPostResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        KSerializer[] kSerializerArr2 = CommunityPostResponseBean.$childSerializers;
        int i4 = 8;
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            CommunityPostReferencedContentResponseBean communityPostReferencedContentResponseBean2 = (CommunityPostReferencedContentResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 10, CommunityPostReferencedContentResponseBean$$serializer.INSTANCE, null);
            ...
            while (z2) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        communityPostReferencedContentResponseBean3 = (CommunityPostReferencedContentResponseBean) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 10, CommunityPostReferencedContentResponseBean$$serializer.INSTANCE, communityPostReferencedContentResponseBean3);
                        i6 |= 1024;
                        kSerializerArr = kSerializerArr2;
                        list4 = list9;
                        str7 = str12;
        ...
        return new CommunityPostResponseBean(i3, communityAuthorResponseBean, str6, num2, strDecodeStringElement2, str3, str5, str, list3, num, list, communityPostReferencedContentResponseBean, j, str4, list2, z, i, i2, strDecodeStringElement, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CommunityPostResponseBean communityPostResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(communityPostResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CommunityPostResponseBean.write$Self$OKCRCore_cr_core(communityPostResponseBean, compositeEncoderBeginStructure, serialDescriptor);
