...
public final /* synthetic */ class ConceptCoinResponseBean$$serializer implements GeneratedSerializer<ConceptCoinResponseBean> {
    public static final int $stable;
    public static final ConceptCoinResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConceptCoinResponseBean$$serializer() {
    }
    ...
    static {
        ConceptCoinResponseBean$$serializer conceptCoinResponseBean$$serializer = new ConceptCoinResponseBean$$serializer();
        INSTANCE = conceptCoinResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.ConceptCoinResponseBean", conceptCoinResponseBean$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("instName", true);
        pluginGeneratedSerialDescriptor.addElement("instType", true);
        pluginGeneratedSerialDescriptor.addElement("lastPrice", true);
        pluginGeneratedSerialDescriptor.addElement("changePerDay", true);
        pluginGeneratedSerialDescriptor.addElement("volume", true);
        pluginGeneratedSerialDescriptor.addElement("hotIndex", true);
    ...
    public final ConceptCoinResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new ConceptCoinResponseBean(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConceptCoinResponseBean conceptCoinResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(conceptCoinResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConceptCoinResponseBean.write$Self$OKCRCore_cr_core(conceptCoinResponseBean, compositeEncoderBeginStructure, serialDescriptor);
