...
public final /* synthetic */ class SpotSearchTraderResponseBean$$serializer implements GeneratedSerializer<SpotSearchTraderResponseBean> {
    public static final int $stable;
    public static final SpotSearchTraderResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SpotSearchTraderResponseBean$$serializer() {
    }
    ...
    static {
        SpotSearchTraderResponseBean$$serializer spotSearchTraderResponseBean$$serializer = new SpotSearchTraderResponseBean$$serializer();
        INSTANCE = spotSearchTraderResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.SpotSearchTraderResponseBean", spotSearchTraderResponseBean$$serializer, 8);
        pluginGeneratedSerialDescriptor.addElement("incomeRate", true);
        pluginGeneratedSerialDescriptor.addElement("jumpParam", true);
        pluginGeneratedSerialDescriptor.addElement("nickNameCn", true);
        pluginGeneratedSerialDescriptor.addElement("nickNameEn", true);
        pluginGeneratedSerialDescriptor.addElement("headPicture", true);
        pluginGeneratedSerialDescriptor.addElement("defaultHeadPictureId", true);
    ...
    public final SpotSearchTraderResponseBean deserialize(@NotNull Decoder decoder) {
        ...
        return new SpotSearchTraderResponseBean(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SpotSearchTraderResponseBean spotSearchTraderResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(spotSearchTraderResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SpotSearchTraderResponseBean.write$Self$OKCRCore_cr_core(spotSearchTraderResponseBean, compositeEncoderBeginStructure, serialDescriptor);
