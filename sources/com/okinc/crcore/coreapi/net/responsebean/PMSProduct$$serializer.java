...
public final /* synthetic */ class PMSProduct$$serializer implements GeneratedSerializer<PMSProduct> {
    public static final int $stable;
    public static final PMSProduct$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PMSProduct$$serializer() {
    }
    ...
    static {
        PMSProduct$$serializer pMSProduct$$serializer = new PMSProduct$$serializer();
        INSTANCE = pMSProduct$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.PMSProduct", pMSProduct$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("lightIconLink", false);
        pluginGeneratedSerialDescriptor.addElement("darkIconLink", false);
    ...
    public final PMSProduct deserialize(@NotNull Decoder decoder) {
        ...
        return new PMSProduct(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PMSProduct pMSProduct) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(pMSProduct, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PMSProduct.write$Self$OKCRCore_cr_core(pMSProduct, compositeEncoderBeginStructure, serialDescriptor);
