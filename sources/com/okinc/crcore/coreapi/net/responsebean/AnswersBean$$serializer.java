...
public final /* synthetic */ class AnswersBean$$serializer implements GeneratedSerializer<AnswersBean> {
    public static final int $stable;
    public static final AnswersBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AnswersBean$$serializer() {
    }
    ...
    static {
        AnswersBean$$serializer answersBean$$serializer = new AnswersBean$$serializer();
        INSTANCE = answersBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.AnswersBean", answersBean$$serializer, 3);
    ...
    public final AnswersBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new AnswersBean(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AnswersBean answersBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(answersBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AnswersBean.write$Self$OKCRCore_cr_core(answersBean, compositeEncoderBeginStructure, serialDescriptor);
