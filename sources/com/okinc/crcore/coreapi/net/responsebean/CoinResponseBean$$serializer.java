...
public final /* synthetic */ class CoinResponseBean$$serializer implements GeneratedSerializer<CoinResponseBean> {
    public static final int $stable;
    public static final CoinResponseBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CoinResponseBean$$serializer() {
    }
    ...
    static {
        CoinResponseBean$$serializer coinResponseBean$$serializer = new CoinResponseBean$$serializer();
        INSTANCE = coinResponseBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.CoinResponseBean", coinResponseBean$$serializer, 17);
        ...
        pluginGeneratedSerialDescriptor.addElement("fairPrice", true);
        pluginGeneratedSerialDescriptor.addElement("fairPricePair", true);
        pluginGeneratedSerialDescriptor.addElement("isConverterNeeded", true);
        pluginGeneratedSerialDescriptor.addElement("marketCap", true);
        pluginGeneratedSerialDescriptor.addElement("upPercent", true);
        pluginGeneratedSerialDescriptor.addElement("changePer", true);
    ...
    public final CoinResponseBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new CoinResponseBean(i, str, str3, str2, str4, str10, strDecodeStringElement2, str9, str8, str11, str7, str6, str5, str13, str14, str12, strDecodeStringElement3, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CoinResponseBean coinResponseBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(coinResponseBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CoinResponseBean.write$Self$OKCRCore_cr_core(coinResponseBean, compositeEncoderBeginStructure, serialDescriptor);
