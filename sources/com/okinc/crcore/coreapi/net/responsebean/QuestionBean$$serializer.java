...
public final /* synthetic */ class QuestionBean$$serializer implements GeneratedSerializer<QuestionBean> {
    public static final int $stable;
    public static final QuestionBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private QuestionBean$$serializer() {
    }
    ...
    static {
        QuestionBean$$serializer questionBean$$serializer = new QuestionBean$$serializer();
        INSTANCE = questionBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.coreapi.net.responsebean.QuestionBean", questionBean$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("id", true);
        pluginGeneratedSerialDescriptor.addElement("title", true);
        pluginGeneratedSerialDescriptor.addElement("description", true);
        pluginGeneratedSerialDescriptor.addElement("selectedId", true);
    ...
    public final QuestionBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        ...
        return new QuestionBean(i, str3, str2, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull QuestionBean questionBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(questionBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        QuestionBean.write$Self$OKCRCore_cr_core(questionBean, compositeEncoderBeginStructure, serialDescriptor);
