...
@Serializable
public final class B2CSwapBean {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: com.okinc.crcore.shared.net.responsebean.bsc.B2CSwapBean */
    ...
    public static final /* synthetic */ void write$Self$OKCRCore_cr_core(B2CSwapBean b2CSwapBean, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
 ...
 A[MD:(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.ArrayList<java.lang.String>):void (m)] (LINE:111) call: com.okinc.crcore.shared.net.responsebean.bsc.B2CSwapBean.<init>(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.ArrayList):void type: THIS */
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.crcore.shared.net.responsebean.bsc.B2CSwapBean.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final B2CSwapBean OLrzqt(@NotNull B2CSwapResponseBean b2CSwapResponseBean) {
            Intrinsics.checkNotNullParameter(b2CSwapResponseBean, "");
            String convertBaseAmount = b2CSwapResponseBean.getConvertBaseAmount();
            String convertBaseCurrency = b2CSwapResponseBean.getConvertBaseCurrency();
            String convertPrice = b2CSwapResponseBean.getConvertPrice();
            String premiumRangeMax = b2CSwapResponseBean.getPremiumRangeMax();
            String premiumRangeMin = b2CSwapResponseBean.getPremiumRangeMin();
            ArrayList<String> premiumTolerance = b2CSwapResponseBean.getPremiumTolerance();
            return new B2CSwapBean(convertBaseAmount, convertBaseCurrency, convertPrice, premiumRangeMax, premiumRangeMin, premiumTolerance != null ? new ArrayList(premiumTolerance) : null);
        }
    }
}
