...
public final /* synthetic */ class DexOrderDetailBean$$serializer implements GeneratedSerializer<DexOrderDetailBean> {
    public static final int $stable;
    public static final DexOrderDetailBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DexOrderDetailBean$$serializer() {
    }
    ...
    static {
        DexOrderDetailBean$$serializer dexOrderDetailBean$$serializer = new DexOrderDetailBean$$serializer();
        INSTANCE = dexOrderDetailBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.DexOrderDetailBean", dexOrderDetailBean$$serializer, 17);
    ...
    public final DexOrderDetailBean deserialize(@NotNull Decoder decoder) {
        int i;
        Integer num;
        ...
        return new DexOrderDetailBean(i, str13, str12, str14, str11, str10, str9, str8, str7, strDecodeStringElement, str, str2, str3, str4, num, str5, str6, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DexOrderDetailBean dexOrderDetailBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dexOrderDetailBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DexOrderDetailBean.write$Self$OKCRCore_cr_core(dexOrderDetailBean, compositeEncoderBeginStructure, serialDescriptor);
