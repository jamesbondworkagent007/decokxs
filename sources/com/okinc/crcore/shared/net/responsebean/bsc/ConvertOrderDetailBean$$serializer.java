...
public final /* synthetic */ class ConvertOrderDetailBean$$serializer implements GeneratedSerializer<ConvertOrderDetailBean> {
    public static final int $stable;
    public static final ConvertOrderDetailBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConvertOrderDetailBean$$serializer() {
    }
    ...
    static {
        ConvertOrderDetailBean$$serializer convertOrderDetailBean$$serializer = new ConvertOrderDetailBean$$serializer();
        INSTANCE = convertOrderDetailBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.ConvertOrderDetailBean", convertOrderDetailBean$$serializer, 22);
    ...
    public final ConvertOrderDetailBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ConvertOrderDetailBean(i, str, str7, str6, str3, str4, str2, str8, str11, str5, i2, str10, str9, str14, j, str15, str13, d2, d, str12, i3, iDecodeIntElement, iDecodeIntElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConvertOrderDetailBean convertOrderDetailBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(convertOrderDetailBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConvertOrderDetailBean.write$Self$OKCRCore_cr_core(convertOrderDetailBean, compositeEncoderBeginStructure, serialDescriptor);
