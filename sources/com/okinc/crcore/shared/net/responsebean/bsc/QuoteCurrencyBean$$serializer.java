...
public final /* synthetic */ class QuoteCurrencyBean$$serializer implements GeneratedSerializer<QuoteCurrencyBean> {
    public static final int $stable;
    public static final QuoteCurrencyBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private QuoteCurrencyBean$$serializer() {
    }
    ...
    static {
        QuoteCurrencyBean$$serializer quoteCurrencyBean$$serializer = new QuoteCurrencyBean$$serializer();
        INSTANCE = quoteCurrencyBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.QuoteCurrencyBean", quoteCurrencyBean$$serializer, 11);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = QuoteCurrencyBean.$childSerializers;
    ...
    public final QuoteCurrencyBean deserialize(@NotNull Decoder decoder) {
        ...
        return new QuoteCurrencyBean(i2, z, i, str, str6, list, str4, str5, str3, str2, strDecodeStringElement, dDecodeDoubleElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull QuoteCurrencyBean quoteCurrencyBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(quoteCurrencyBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        QuoteCurrencyBean.write$Self$OKCRCore_cr_core(quoteCurrencyBean, compositeEncoderBeginStructure, serialDescriptor);
