...
public final /* synthetic */ class FiatBean$$serializer implements GeneratedSerializer<FiatBean> {
    public static final int $stable;
    public static final FiatBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private FiatBean$$serializer() {
    }
    ...
    static {
        FiatBean$$serializer fiatBean$$serializer = new FiatBean$$serializer();
        INSTANCE = fiatBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.FiatBean", fiatBean$$serializer, 10);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = FiatBean.$childSerializers;
    ...
    public final FiatBean deserialize(@NotNull Decoder decoder) {
        ...
        return new FiatBean(i, str2, str, str6, str8, str4, str5, str7, str3, list, dDecodeDoubleElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull FiatBean fiatBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(fiatBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        FiatBean.write$Self$OKCRCore_cr_core(fiatBean, compositeEncoderBeginStructure, serialDescriptor);
