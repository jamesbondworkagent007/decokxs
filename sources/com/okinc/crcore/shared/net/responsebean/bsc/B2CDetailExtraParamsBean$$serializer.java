...
public final /* synthetic */ class B2CDetailExtraParamsBean$$serializer implements GeneratedSerializer<B2CDetailExtraParamsBean> {
    public static final int $stable;
    public static final B2CDetailExtraParamsBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private B2CDetailExtraParamsBean$$serializer() {
    }
    ...
    static {
        B2CDetailExtraParamsBean$$serializer b2CDetailExtraParamsBean$$serializer = new B2CDetailExtraParamsBean$$serializer();
        INSTANCE = b2CDetailExtraParamsBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.B2CDetailExtraParamsBean", b2CDetailExtraParamsBean$$serializer, 6);
    ...
    public final B2CDetailExtraParamsBean deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new B2CDetailExtraParamsBean(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull B2CDetailExtraParamsBean b2CDetailExtraParamsBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(b2CDetailExtraParamsBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        B2CDetailExtraParamsBean.write$Self$OKCRCore_cr_core(b2CDetailExtraParamsBean, compositeEncoderBeginStructure, serialDescriptor);
