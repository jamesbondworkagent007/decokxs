...
public final /* synthetic */ class LocalizedTextBean$$serializer implements GeneratedSerializer<LocalizedTextBean> {
    public static final int $stable;
    public static final LocalizedTextBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LocalizedTextBean$$serializer() {
    }
    ...
    static {
        LocalizedTextBean$$serializer localizedTextBean$$serializer = new LocalizedTextBean$$serializer();
        INSTANCE = localizedTextBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.LocalizedTextBean", localizedTextBean$$serializer, 6);
    ...
    public final LocalizedTextBean deserialize(@NotNull Decoder decoder) {
        ...
        return new LocalizedTextBean(i, z, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LocalizedTextBean localizedTextBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(localizedTextBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LocalizedTextBean.write$Self$OKCRCore_cr_core(localizedTextBean, compositeEncoderBeginStructure, serialDescriptor);
