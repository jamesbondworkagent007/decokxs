...
public final /* synthetic */ class SupportBannerBean$$serializer implements GeneratedSerializer<SupportBannerBean> {
    public static final int $stable;
    public static final SupportBannerBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SupportBannerBean$$serializer() {
    }
    ...
    static {
        SupportBannerBean$$serializer supportBannerBean$$serializer = new SupportBannerBean$$serializer();
        INSTANCE = supportBannerBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.SupportBannerBean", supportBannerBean$$serializer, 7);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = SupportBannerBean.$childSerializers;
    ...
    public final SupportBannerBean deserialize(@NotNull Decoder decoder) {
        ...
        return new SupportBannerBean(i, str, z, i2, str2, str3, list, iDecodeIntElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SupportBannerBean supportBannerBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(supportBannerBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SupportBannerBean.write$Self$OKCRCore_cr_core(supportBannerBean, compositeEncoderBeginStructure, serialDescriptor);
