...
public final /* synthetic */ class BuySellCurrencyBean$$serializer implements GeneratedSerializer<BuySellCurrencyBean> {
    public static final int $stable;
    public static final BuySellCurrencyBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BuySellCurrencyBean$$serializer() {
    }
    ...
    static {
        BuySellCurrencyBean$$serializer buySellCurrencyBean$$serializer = new BuySellCurrencyBean$$serializer();
        INSTANCE = buySellCurrencyBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.BuySellCurrencyBean", buySellCurrencyBean$$serializer, 17);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = BuySellCurrencyBean.$childSerializers;
    ...
    public final BuySellCurrencyBean deserialize(@NotNull Decoder decoder) {
        List list;
        int i;
        String str;
        String str2;
        ...
        return new BuySellCurrencyBean(i, str4, z, list, str3, str2, str7, str9, z2, str6, str8, i2, list2, i3, str5, str, d, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BuySellCurrencyBean buySellCurrencyBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(buySellCurrencyBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BuySellCurrencyBean.write$Self$OKCRCore_cr_core(buySellCurrencyBean, compositeEncoderBeginStructure, serialDescriptor);
