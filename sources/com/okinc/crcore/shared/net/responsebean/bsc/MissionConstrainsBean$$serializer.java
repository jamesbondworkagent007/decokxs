...
public final /* synthetic */ class MissionConstrainsBean$$serializer implements GeneratedSerializer<MissionConstrainsBean> {
    public static final int $stable;
    public static final MissionConstrainsBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MissionConstrainsBean$$serializer() {
    }
    ...
    static {
        MissionConstrainsBean$$serializer missionConstrainsBean$$serializer = new MissionConstrainsBean$$serializer();
        INSTANCE = missionConstrainsBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.bsc.MissionConstrainsBean", missionConstrainsBean$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = MissionConstrainsBean.$childSerializers;
    ...
    public final MissionConstrainsBean deserialize(@NotNull Decoder decoder) {
        ...
        return new MissionConstrainsBean(i, str2, strDecodeStringElement, z, str3, str, list, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MissionConstrainsBean missionConstrainsBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(missionConstrainsBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MissionConstrainsBean.write$Self$OKCRCore_cr_core(missionConstrainsBean, compositeEncoderBeginStructure, serialDescriptor);
