...
public final /* synthetic */ class DexQuoteCoinBean$$serializer implements GeneratedSerializer<DexQuoteCoinBean> {
    public static final int $stable;
    public static final DexQuoteCoinBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DexQuoteCoinBean$$serializer() {
    }
    ...
    static {
        DexQuoteCoinBean$$serializer dexQuoteCoinBean$$serializer = new DexQuoteCoinBean$$serializer();
        INSTANCE = dexQuoteCoinBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.DexQuoteCoinBean", dexQuoteCoinBean$$serializer, 8);
    ...
    public final DexQuoteCoinBean deserialize(@NotNull Decoder decoder) {
        ...
        return new DexQuoteCoinBean(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DexQuoteCoinBean dexQuoteCoinBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dexQuoteCoinBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DexQuoteCoinBean.write$Self$OKCRCore_cr_core(dexQuoteCoinBean, compositeEncoderBeginStructure, serialDescriptor);
