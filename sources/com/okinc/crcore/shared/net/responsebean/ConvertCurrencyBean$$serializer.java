...
public final /* synthetic */ class ConvertCurrencyBean$$serializer implements GeneratedSerializer<ConvertCurrencyBean> {
    public static final int $stable;
    public static final ConvertCurrencyBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConvertCurrencyBean$$serializer() {
    }
    ...
    static {
        ConvertCurrencyBean$$serializer convertCurrencyBean$$serializer = new ConvertCurrencyBean$$serializer();
        INSTANCE = convertCurrencyBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.crcore.shared.net.responsebean.ConvertCurrencyBean", convertCurrencyBean$$serializer, 18);
    ...
    public final ConvertCurrencyBean deserialize(@NotNull Decoder decoder) {
        int i;
        ...
        return new ConvertCurrencyBean(i, str3, i2, str2, str4, str6, str9, str8, i4, bool, str, str10, z, z2, str7, z3, i3, str5, earnOption, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConvertCurrencyBean convertCurrencyBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(convertCurrencyBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConvertCurrencyBean.write$Self$OKCRCore_cr_core(convertCurrencyBean, compositeEncoderBeginStructure, serialDescriptor);
