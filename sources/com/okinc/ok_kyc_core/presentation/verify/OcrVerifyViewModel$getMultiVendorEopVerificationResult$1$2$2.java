...
import com.okinc.ok_kyc_core.presentation.verify.OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2;
...
public final class OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2(C42203rKd.StateListAnimator stateListAnimator, C42203rKd c42203rKd, MultiVendorResultResp multiVendorResultResp, VendorVerifyRequest vendorVerifyRequest, Continuation<? super OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2(this.$eopVerifyCallback, this.this$0, this.$it, this.$verifyRequest, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (this.label == 0) {
            ...
            AbstractC42074rFj.signalCompletionAndPop$default(c42203rKd, taskDescription, playbook, featureUri, resultId, params, null, null, new Function0() { // from class: o.rKg
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function0
                public final java.lang.Object invoke() {
                    return OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2.invokeSuspend$lambda$1(c42203rKd2);
                }
            }, 96, null);
    ...
    public static final Unit invokeSuspend$lambda$1(C42203rKd c42203rKd) {
        ...
        C32866mlf.EZpvd("app_compliance_verify_post_error", (TrackChannel[]) Arrays.copyOf(trackChannelArrCopydefault, trackChannelArrCopydefault.length), (Function1<? super EventParamsList, Unit>) new Function1() { // from class: o.rKe
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj) {
                return OcrVerifyViewModel$getMultiVendorEopVerificationResult$1$2$2.invokeSuspend$lambda$1$lambda$0((EventParamsList) obj);
            }
        });
        c42203rKd.wlaJM();
        return Unit.INSTANCE;
