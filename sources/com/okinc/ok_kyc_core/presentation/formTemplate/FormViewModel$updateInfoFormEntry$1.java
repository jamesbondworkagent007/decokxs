...
public final class FormViewModel$updateInfoFormEntry$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public FormViewModel$updateInfoFormEntry$1(rGL rgl, String str, Map<String, String> map, String str2, C41957rBa c41957rBa, C52794wYp c52794wYp, FragmentActivity fragmentActivity, String str3, Continuation<? super FormViewModel$updateInfoFormEntry$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FormViewModel$updateInfoFormEntry$1(this.this$0, this.$url, this.$params, this.$id, this.$form, this.$view, this.$activity, this.$successMessage, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FormViewModel$updateInfoFormEntry$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            rBO rboEZpvd = this.this$0.QKVWgx().EZpvd();
            String str = this.$url;
            Map<String, String> map = this.$params;
            String str2 = this.$id;
            C41957rBa c41957rBa = this.$form;
            this.label = 1;
            obj = rboEZpvd.AEQbTJ(str, map, str2, c41957rBa, this);
