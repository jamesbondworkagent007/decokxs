...
public final class BaseKYCFragment$nfcLauncher$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BaseKYCFragment$nfcLauncher$1$1(AbstractC42060rEw<BINDING, VM> abstractC42060rEw, ActivityResult activityResult, Continuation<? super BaseKYCFragment$nfcLauncher$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BaseKYCFragment$nfcLauncher$1$1(this.this$0, this.$result, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BaseKYCFragment$nfcLauncher$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Can't wrap try/catch for region: R(9:0|2|(1:(1:(5:6|51|55|56|57)(2:7|8))(1:9))(4:10|(2:14|(2:18|(1:20)))|56|57)|58|21|(1:23)(1:27)|(4:29|(9:31|(1:37)(1:36)|38|(1:40)|41|(2:44|42)|60|45|(2:47|(1:49)(3:50|51|55))(1:52))(1:53)|54|55)|56|57) */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x0087, code lost:
        ...
        o.C32866mlf.EZpvd("fd_eop_crash", (com.okinc.components.track.TrackChannel[]) java.util.Arrays.copyOf(r2, r2.length), (kotlin.jvm.functions.Function1<? super com.okinc.components.track.bean.EventParamsList, kotlin.Unit>) new o.C42072rFh(r0));
     */
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i != 1) {
            ...
            C32866mlf.EZpvd("OKCard_SDK_Finish_Status", (TrackChannel[]) Arrays.copyOf(trackChannelArrCopydefault, trackChannelArrCopydefault.length), (Function1<? super EventParamsList, Unit>) new Function1() { // from class: o.rFk
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function1
                public final java.lang.Object invoke(java.lang.Object obj2) {
                    return BaseKYCFragment$nfcLauncher$1$1.invokeSuspend$lambda$3$lambda$2(objectRef2, eopUiModelCopydefault, abstractC42060rEw2, (EventParamsList) obj2);
                }
            });
            return Unit.INSTANCE;
        }
        ...
        if (eopUiModelCopydefault != null) {
            ...
            if (eopUiModelCopydefault.isSuccess()) {
                pUU.KWHzl("qjf", "nfcLauncher---success----->");
                abstractC42060rEw4.EZpvd().copydefault(eopUiModelCopydefault.getMrz());
                ...
                VendorConfig vendorConfigDjBIcL = abstractC42060rEw4.EZpvd().djBIcL();
                if (vendorConfigDjBIcL == null) {
                    vendorConfigDjBIcL = new VendorConfig((String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, 0, 0, 0, 0, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, 0, 1048575, (DefaultConstructorMarker) null);
                }
                VendorConfig vendorConfig = vendorConfigDjBIcL;
                ...
                for (EopResultImageInfo eopResultImageInfo : eopUiModelCopydefault.getEopResultList()) {
                    arrayList.add(new EopImageInfo(eopResultImageInfo.getImageId(), eopResultImageInfo.getImageType(), eopResultImageInfo.getName(), eopResultImageInfo.getWidth(), eopResultImageInfo.getHeight()));
                }
                pUU.KWHzl("qjf", "imageList = " + arrayList);
                ...
                if (!abstractC42060rEw4.EZpvd().AEQbTJ().contains(C56443yFo.AEQbTJ(Constant.UploadFileType.LIVE_FACE.getImageTypeVal()))) {
                    ...
                    abstractC42060rEw4.EZpvd(Constant.VendorType.EOP.getVendorType(), eopUiModelCopydefault.getVerifyType(), eopUiModelCopydefault.getSessionId(), arrayList, abstractC42060rEw4.EZpvd().copydefault(), C56443yFo.AEQbTJ(vendorConfig.getNfcType()));
                } else {
                    rTM rtm = rTM.KWHzl;
                    ...
                    C32866mlf.EZpvd("OKCard_SDK_Finish_Status", (TrackChannel[]) Arrays.copyOf(trackChannelArrCopydefault2, trackChannelArrCopydefault2.length), (Function1<? super EventParamsList, Unit>) new Function1() { // from class: o.rFk
                        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                        @Override // kotlin.jvm.functions.Function1
                        public final java.lang.Object invoke(java.lang.Object obj2) {
                            return BaseKYCFragment$nfcLauncher$1$1.invokeSuspend$lambda$3$lambda$2(objectRef2, eopUiModelCopydefault, abstractC42060rEw2, (EventParamsList) obj2);
                ...
                objectRef = objectRef4;
                abstractC42060rEw = abstractC42060rEw4;
                pUU.KWHzl("qjf", "nfcLauncher---failed----->");
            ...
            C32866mlf.EZpvd("OKCard_SDK_Finish_Status", (TrackChannel[]) Arrays.copyOf(trackChannelArrCopydefault22, trackChannelArrCopydefault22.length), (Function1<? super EventParamsList, Unit>) new Function1() { // from class: o.rFk
                /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
                @Override // kotlin.jvm.functions.Function1
                public final java.lang.Object invoke(java.lang.Object obj2) {
                    return BaseKYCFragment$nfcLauncher$1$1.invokeSuspend$lambda$3$lambda$2(objectRef2, eopUiModelCopydefault, abstractC42060rEw2, (EventParamsList) obj2);
