...
public final class ProcessingFragment$getWCResult$1$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ProcessingFragment$getWCResult$1$1$1$1$1(rIF rif, ProcessingAppModel processingAppModel, Continuation<? super ProcessingFragment$getWCResult$1$1$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ProcessingFragment$getWCResult$1$1$1$1$1(this.this$0, this.$processingAppModel, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ProcessingFragment$getWCResult$1$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
