...
public final class KYCRepositoryImpl$getMergeAccountResultNew$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ResponseData<OnDemandKYCAppModel>>, Object> {
    final /* synthetic */ C43746rvB $this_runOrErrorResponse;
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KYCRepositoryImpl$getMergeAccountResultNew$2$1(C43746rvB c43746rvB, Continuation<? super KYCRepositoryImpl$getMergeAccountResultNew$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KYCRepositoryImpl$getMergeAccountResultNew$2$1(this.$this_runOrErrorResponse, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ResponseData<OnDemandKYCAppModel>> continuation) {
        return ((KYCRepositoryImpl$getMergeAccountResultNew$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            objEZpvd = interfaceC43709ruR.EZpvd(this);
        ...
        if (onDemandKYCResponse != null) {
            ...
            return new ResponseData(code, msg, detailMsg, msg2, new OnDemandKYCAppModel(compliant, true, profile, c43746rvB.copydefault(viewModel2)), responseData.getMsg());
        }
