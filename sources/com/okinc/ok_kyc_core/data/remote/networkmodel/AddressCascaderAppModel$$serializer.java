...
public final /* synthetic */ class AddressCascaderAppModel$$serializer implements GeneratedSerializer<AddressCascaderAppModel> {
    public static final int $stable;
    public static final AddressCascaderAppModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AddressCascaderAppModel$$serializer() {
    }
    ...
    static {
        AddressCascaderAppModel$$serializer addressCascaderAppModel$$serializer = new AddressCascaderAppModel$$serializer();
        INSTANCE = addressCascaderAppModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.AddressCascaderAppModel", addressCascaderAppModel$$serializer, 12);
    ...
    public final AddressCascaderAppModel deserialize(@NotNull Decoder decoder) {
        int i;
        Float f;
        Boolean bool;
        String str;
        ...
        return new AddressCascaderAppModel(i, str4, str5, bool3, divisionTitle, addressCascaderFildValue, bool2, str2, bool, str, str3, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.AddressCascaderAppModel.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.AddressCascaderAppModel, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AddressCascaderAppModel addressCascaderAppModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(addressCascaderAppModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AddressCascaderAppModel.write$Self$OKCompliance_ok_compliance_impl(addressCascaderAppModel, compositeEncoderBeginStructure, serialDescriptor);
