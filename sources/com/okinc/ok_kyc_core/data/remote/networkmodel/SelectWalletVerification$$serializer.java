...
public final /* synthetic */ class SelectWalletVerification$$serializer implements GeneratedSerializer<SelectWalletVerification> {
    public static final int $stable;
    public static final SelectWalletVerification$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SelectWalletVerification$$serializer() {
    }
    ...
    static {
        SelectWalletVerification$$serializer selectWalletVerification$$serializer = new SelectWalletVerification$$serializer();
        INSTANCE = selectWalletVerification$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("selectWalletVerificationMethod", selectWalletVerification$$serializer, 13);
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.SelectWalletVerification.access$get$childSerializers$cp():kotlinx.serialization.KSerializer[] */
    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = SelectWalletVerification.$childSerializers;
    ...
    public final SelectWalletVerification deserialize(@NotNull Decoder decoder) {
        String str;
        ArrayList arrayList;
        Quit quit;
        Boolean bool;
        ...
        KSerializer[] kSerializerArr3 = SelectWalletVerification.$childSerializers;
        int i2 = 9;
        String str12 = null;
        ...
        return new SelectWalletVerification(i, str4, bool4, bool3, str7, arrayList, quit, str3, bool, str6, str2, str5, str, bool2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SelectWalletVerification selectWalletVerification) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(selectWalletVerification, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SelectWalletVerification.write$Self$OKCompliance_ok_compliance_impl(selectWalletVerification, compositeEncoderBeginStructure, serialDescriptor);
