...
public final /* synthetic */ class ImageItem$$serializer implements GeneratedSerializer<ImageItem> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.ImageItem", imageItem$$serializer, 9);
        ...
        pluginGeneratedSerialDescriptor.addElement("urlDark", true);
        pluginGeneratedSerialDescriptor.addElement("textLines", true);
    ...
    public final ImageItem deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Integer num;
        String str2;
        ...
        return new ImageItem(i, str6, num3, str4, num2, str5, str3, str2, num, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ImageItem imageItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(imageItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ImageItem.write$Self$OKCompliance_ok_compliance_impl(imageItem, compositeEncoderBeginStructure, serialDescriptor);
