...
public final /* synthetic */ class MergeAccountCenterPopUp$$serializer implements GeneratedSerializer<MergeAccountCenterPopUp> {
    public static final int $stable;
    public static final MergeAccountCenterPopUp$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MergeAccountCenterPopUp$$serializer() {
    }
    ...
    static {
        MergeAccountCenterPopUp$$serializer mergeAccountCenterPopUp$$serializer = new MergeAccountCenterPopUp$$serializer();
        INSTANCE = mergeAccountCenterPopUp$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("identify-already-use-center-pop-up", mergeAccountCenterPopUp$$serializer, 9);
    ...
    public final MergeAccountCenterPopUp deserialize(@NotNull Decoder decoder) {
        int i;
        Boolean bool;
        Float f;
        Float f2;
        ...
        return new MergeAccountCenterPopUp(i, str4, accountMergeActionParams, str2, bool2, str3, str, f2, f, bool, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.MergeAccountCenterPopUp.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.MergeAccountCenterPopUp, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MergeAccountCenterPopUp mergeAccountCenterPopUp) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(mergeAccountCenterPopUp, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MergeAccountCenterPopUp.write$Self$OKCompliance_ok_compliance_impl(mergeAccountCenterPopUp, compositeEncoderBeginStructure, serialDescriptor);
