...
public final /* synthetic */ class InputSelect$$serializer implements GeneratedSerializer<InputSelect> {
    public static final int $stable;
    public static final InputSelect$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputSelect$$serializer() {
    }
    ...
    static {
        InputSelect$$serializer inputSelect$$serializer = new InputSelect$$serializer();
        INSTANCE = inputSelect$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-select", inputSelect$$serializer, 19);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), Choices$$serializer.INSTANCE, BuiltinSerializersKt.getNullable(booleanSerializer), BuiltinSerializersKt.getNullable(booleanSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(booleanSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(FreeText$$serializer.INSTANCE), BuiltinSerializersKt.getNullable(CTAButton$$serializer.INSTANCE), stringSerializer, BuiltinSerializersKt.getNullable(booleanSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(floatSerializer), BuiltinSerializersKt.getNullable(floatSerializer), BuiltinSerializersKt.getNullable(booleanSerializer)};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final InputSelect deserialize(@NotNull Decoder decoder) {
        String str;
        Boolean bool;
        String str2;
        Boolean bool2;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            FreeText freeText4 = (FreeText) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 10, FreeText$$serializer.INSTANCE, null);
            CTAButton cTAButton2 = (CTAButton) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 11, CTAButton$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 10:
                        ...
                        f5 = f5;
                        str29 = str29;
                        freeText5 = (FreeText) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 10, FreeText$$serializer.INSTANCE, freeText5);
                        str11 = str31;
                        str31 = str11;
                        str28 = str10;
                        i4 = 18;
                    ...
                    case 11:
                        i5 |= 2048;
                        cTAButton3 = (CTAButton) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 11, CTAButton$$serializer.INSTANCE, cTAButton3);
                        str10 = str28;
                        f5 = f5;
                        str11 = str31;
                        str31 = str11;
        ...
        return new InputSelect(i, str7, str8, choices, bool4, bool2, str, bool, str3, str9, str5, freeText, cTAButton, str4, bool3, str6, str2, f, f2, bool5, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputSelect.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.InputSelect, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputSelect inputSelect) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputSelect, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputSelect.write$Self$OKCompliance_ok_compliance_impl(inputSelect, compositeEncoderBeginStructure, serialDescriptor);
