...
public final /* synthetic */ class VerifyCenterNotificationAppModel$$serializer implements GeneratedSerializer<VerifyCenterNotificationAppModel> {
    public static final int $stable;
    public static final VerifyCenterNotificationAppModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private VerifyCenterNotificationAppModel$$serializer() {
    }
    ...
    static {
        VerifyCenterNotificationAppModel$$serializer verifyCenterNotificationAppModel$$serializer = new VerifyCenterNotificationAppModel$$serializer();
        INSTANCE = verifyCenterNotificationAppModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.VerifyCenterNotificationAppModel", verifyCenterNotificationAppModel$$serializer, 7);
    ...
    public final VerifyCenterNotificationAppModel deserialize(@NotNull Decoder decoder) {
        Float f;
        Float f2;
        String str;
        Boolean bool;
        ...
        return new VerifyCenterNotificationAppModel(i, bool, str, bool2, str3, str2, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull VerifyCenterNotificationAppModel verifyCenterNotificationAppModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(verifyCenterNotificationAppModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        VerifyCenterNotificationAppModel.write$Self$OKCompliance_ok_compliance_impl(verifyCenterNotificationAppModel, compositeEncoderBeginStructure, serialDescriptor);
