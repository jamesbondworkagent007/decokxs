...
public final /* synthetic */ class InputFormatTextAppModel$$serializer implements GeneratedSerializer<InputFormatTextAppModel> {
    public static final int $stable;
    public static final InputFormatTextAppModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputFormatTextAppModel$$serializer() {
    }
    ...
    static {
        InputFormatTextAppModel$$serializer inputFormatTextAppModel$$serializer = new InputFormatTextAppModel$$serializer();
        INSTANCE = inputFormatTextAppModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.InputFormatTextAppModel", inputFormatTextAppModel$$serializer, 15);
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputFormatTextAppModel.access$get$childSerializers$cp():kotlinx.serialization.KSerializer[] */
    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = InputFormatTextAppModel.$childSerializers;
    ...
    public final InputFormatTextAppModel deserialize(@NotNull Decoder decoder) {
        int i;
        Float f;
        Boolean bool;
        String str;
        ...
        KSerializer[] kSerializerArr2 = InputFormatTextAppModel.$childSerializers;
        int i2 = 9;
        ...
        return new InputFormatTextAppModel(i, str3, str5, list, bool, bool3, inputFormat, dependency, num, bool2, str4, bool4, str, str2, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputFormatTextAppModel inputFormatTextAppModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputFormatTextAppModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputFormatTextAppModel.write$Self$OKCompliance_ok_compliance_impl(inputFormatTextAppModel, compositeEncoderBeginStructure, serialDescriptor);
