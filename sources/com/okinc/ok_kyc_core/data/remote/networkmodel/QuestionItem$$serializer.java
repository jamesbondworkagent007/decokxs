...
public final /* synthetic */ class QuestionItem$$serializer implements GeneratedSerializer<QuestionItem> {
    public static final int $stable;
    public static final QuestionItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private QuestionItem$$serializer() {
    }
    ...
    static {
        QuestionItem$$serializer questionItem$$serializer = new QuestionItem$$serializer();
        INSTANCE = questionItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.QuestionItem", questionItem$$serializer, 3);
    ...
    public final QuestionItem deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Boolean bool;
        String str2;
        ...
        return new QuestionItem(i, str2, str, bool, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull QuestionItem questionItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(questionItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        QuestionItem.write$Self$OKCompliance_ok_compliance_impl(questionItem, compositeEncoderBeginStructure, serialDescriptor);
