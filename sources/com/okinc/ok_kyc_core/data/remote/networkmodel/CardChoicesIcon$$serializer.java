...
public final /* synthetic */ class CardChoicesIcon$$serializer implements GeneratedSerializer<CardChoicesIcon> {
    public static final int $stable;
    public static final CardChoicesIcon$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CardChoicesIcon$$serializer() {
    }
    ...
    static {
        CardChoicesIcon$$serializer cardChoicesIcon$$serializer = new CardChoicesIcon$$serializer();
        INSTANCE = cardChoicesIcon$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.CardChoicesIcon", cardChoicesIcon$$serializer, 5);
    ...
    public final CardChoicesIcon deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new CardChoicesIcon(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CardChoicesIcon cardChoicesIcon) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(cardChoicesIcon, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CardChoicesIcon.write$Self$OKCompliance_ok_compliance_impl(cardChoicesIcon, compositeEncoderBeginStructure, serialDescriptor);
