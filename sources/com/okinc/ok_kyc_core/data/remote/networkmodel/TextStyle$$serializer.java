...
public final /* synthetic */ class TextStyle$$serializer implements GeneratedSerializer<TextStyle> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.TextStyle", textStyle$$serializer, 4);
    ...
    public final TextStyle deserialize(@NotNull Decoder decoder) {
        int i;
        Boolean bool;
        String str;
        Integer num;
        ...
        return new TextStyle(i, num, str, bool, f, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TextStyle textStyle) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(textStyle, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TextStyle.write$Self$OKCompliance_ok_compliance_impl(textStyle, compositeEncoderBeginStructure, serialDescriptor);
