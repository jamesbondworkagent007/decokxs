...
public final /* synthetic */ class DialogCheckbox$$serializer implements GeneratedSerializer<DialogCheckbox> {
    public static final int $stable;
    public static final DialogCheckbox$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DialogCheckbox$$serializer() {
    }
    ...
    static {
        DialogCheckbox$$serializer dialogCheckbox$$serializer = new DialogCheckbox$$serializer();
        INSTANCE = dialogCheckbox$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.DialogCheckbox", dialogCheckbox$$serializer, 5);
    ...
    public final DialogCheckbox deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Float f;
        String str2;
        ...
        return new DialogCheckbox(i, str3, num, str2, str, f, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DialogCheckbox dialogCheckbox) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dialogCheckbox, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DialogCheckbox.write$Self$OKCompliance_ok_compliance_impl(dialogCheckbox, compositeEncoderBeginStructure, serialDescriptor);
