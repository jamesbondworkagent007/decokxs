...
public final /* synthetic */ class InputText$$serializer implements GeneratedSerializer<InputText> {
    public static final int $stable;
    public static final InputText$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputText$$serializer() {
    }
    ...
    static {
        InputText$$serializer inputText$$serializer = new InputText$$serializer();
        INSTANCE = inputText$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-text", inputText$$serializer, 17);
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputText.access$get$childSerializers$cp():kotlinx.serialization.KSerializer[] */
    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = InputText.$childSerializers;
    ...
    public final InputText deserialize(@NotNull Decoder decoder) {
        Boolean bool;
        Boolean bool2;
        String str;
        String str2;
        ...
        KSerializer[] kSerializerArr3 = InputText.$childSerializers;
        ...
        return new InputText(i, str7, str6, str8, str, str4, num, bool2, list, bool, addressAutoComplete, bool4, str5, bool3, str2, str3, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputText inputText) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputText, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputText.write$Self$OKCompliance_ok_compliance_impl(inputText, compositeEncoderBeginStructure, serialDescriptor);
