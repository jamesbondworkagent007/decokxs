...
public final /* synthetic */ class PageComponentProfile$$serializer implements GeneratedSerializer<PageComponentProfile> {
    public static final int $stable;
    public static final PageComponentProfile$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PageComponentProfile$$serializer() {
    }
    ...
    static {
        PageComponentProfile$$serializer pageComponentProfile$$serializer = new PageComponentProfile$$serializer();
        INSTANCE = pageComponentProfile$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.PageComponentProfile", pageComponentProfile$$serializer, 3);
    ...
    public final PageComponentProfile deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Integer num;
        String str2;
        ...
        return new PageComponentProfile(i, num, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PageComponentProfile pageComponentProfile) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(pageComponentProfile, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PageComponentProfile.write$Self$OKCompliance_ok_compliance_impl(pageComponentProfile, compositeEncoderBeginStructure, serialDescriptor);
