...
public final /* synthetic */ class LinkTextContent$$serializer implements GeneratedSerializer<LinkTextContent> {
    public static final int $stable;
    public static final LinkTextContent$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LinkTextContent$$serializer() {
    }
    ...
    static {
        LinkTextContent$$serializer linkTextContent$$serializer = new LinkTextContent$$serializer();
        INSTANCE = linkTextContent$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.LinkTextContent", linkTextContent$$serializer, 7);
    ...
    public final LinkTextContent deserialize(@NotNull Decoder decoder) {
        Boolean bool;
        String str;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            str = str9;
            cTAButtonAppModel = (CTAButtonAppModel) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 6, CTAButtonAppModel$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 6:
                        i3 |= 64;
                        cTAButtonAppModel2 = (CTAButtonAppModel) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, i2, CTAButtonAppModel$$serializer.INSTANCE, cTAButtonAppModel2);
                        i2 = 6;
                        break;
                    default:
        ...
        return new LinkTextContent(i, str2, str4, str3, bool, str, linkTextStyle, cTAButtonAppModel, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LinkTextContent linkTextContent) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(linkTextContent, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LinkTextContent.write$Self$OKCompliance_ok_compliance_impl(linkTextContent, compositeEncoderBeginStructure, serialDescriptor);
