...
public final /* synthetic */ class InputMultipleChoices$$serializer implements GeneratedSerializer<InputMultipleChoices> {
    public static final int $stable;
    public static final InputMultipleChoices$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputMultipleChoices$$serializer() {
    }
    ...
    static {
        InputMultipleChoices$$serializer inputMultipleChoices$$serializer = new InputMultipleChoices$$serializer();
        INSTANCE = inputMultipleChoices$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-multiple-choices", inputMultipleChoices$$serializer, 11);
    ...
    public final InputMultipleChoices deserialize(@NotNull Decoder decoder) {
        Choices choices;
        int i;
        String str;
        String str2;
        ...
        return new InputMultipleChoices(i, str3, str5, str6, choices, bool2, str4, bool, str2, str, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputMultipleChoices.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.InputMultipleChoices, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputMultipleChoices inputMultipleChoices) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputMultipleChoices, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputMultipleChoices.write$Self$OKCompliance_ok_compliance_impl(inputMultipleChoices, compositeEncoderBeginStructure, serialDescriptor);
