...
public final /* synthetic */ class InputMultipleChoicesAppModel$$serializer implements GeneratedSerializer<InputMultipleChoicesAppModel> {
    public static final int $stable;
    public static final InputMultipleChoicesAppModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputMultipleChoicesAppModel$$serializer() {
    }
    ...
    static {
        InputMultipleChoicesAppModel$$serializer inputMultipleChoicesAppModel$$serializer = new InputMultipleChoicesAppModel$$serializer();
        INSTANCE = inputMultipleChoicesAppModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.InputMultipleChoicesAppModel", inputMultipleChoicesAppModel$$serializer, 11);
    ...
    public final InputMultipleChoicesAppModel deserialize(@NotNull Decoder decoder) {
        Boolean bool;
        Boolean bool2;
        String str;
        Float f;
        ...
        return new InputMultipleChoicesAppModel(i, str5, str3, str6, choices, bool, str4, bool2, str2, str, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputMultipleChoicesAppModel.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.InputMultipleChoicesAppModel, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputMultipleChoicesAppModel inputMultipleChoicesAppModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputMultipleChoicesAppModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputMultipleChoicesAppModel.write$Self$OKCompliance_ok_compliance_impl(inputMultipleChoicesAppModel, compositeEncoderBeginStructure, serialDescriptor);
