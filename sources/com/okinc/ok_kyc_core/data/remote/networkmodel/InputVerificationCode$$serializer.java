...
public final /* synthetic */ class InputVerificationCode$$serializer implements GeneratedSerializer<InputVerificationCode> {
    public static final int $stable;
    public static final InputVerificationCode$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputVerificationCode$$serializer() {
    }
    ...
    static {
        InputVerificationCode$$serializer inputVerificationCode$$serializer = new InputVerificationCode$$serializer();
        INSTANCE = inputVerificationCode$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-verification-code", inputVerificationCode$$serializer, 10);
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputVerificationCode.access$get$childSerializers$cp():kotlinx.serialization.KSerializer[] */
    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = InputVerificationCode.$childSerializers;
    ...
    public final InputVerificationCode deserialize(@NotNull Decoder decoder) {
        Boolean bool;
        Float f;
        Float f2;
        String str;
        ...
        return new InputVerificationCode(i, num, str3, list, bool2, str4, bool, str, str2, f2, f, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputVerificationCode inputVerificationCode) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputVerificationCode, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputVerificationCode.write$Self$OKCompliance_ok_compliance_impl(inputVerificationCode, compositeEncoderBeginStructure, serialDescriptor);
