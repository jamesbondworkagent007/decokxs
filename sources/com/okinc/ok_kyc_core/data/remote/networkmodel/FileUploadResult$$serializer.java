...
public final /* synthetic */ class FileUploadResult$$serializer implements GeneratedSerializer<FileUploadResult> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.FileUploadResult", fileUploadResult$$serializer, 5);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull FileUploadResult fileUploadResult) {
        ...
        FileUploadResult.write$Self$OKCompliance_ok_compliance_impl(fileUploadResult, compositeEncoderBeginStructure, serialDescriptor);
