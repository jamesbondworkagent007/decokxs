...
public final /* synthetic */ class SingleFileUploadResultReq$$serializer implements GeneratedSerializer<SingleFileUploadResultReq> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.SingleFileUploadResultReq", singleFileUploadResultReq$$serializer, 4);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SingleFileUploadResultReq singleFileUploadResultReq) {
        ...
        SingleFileUploadResultReq.write$Self$OKCompliance_ok_compliance_impl(singleFileUploadResultReq, compositeEncoderBeginStructure, serialDescriptor);
