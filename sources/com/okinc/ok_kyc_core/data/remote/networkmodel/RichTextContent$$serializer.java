...
public final /* synthetic */ class RichTextContent$$serializer implements GeneratedSerializer<RichTextContent> {
    public static final int $stable;
    public static final RichTextContent$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RichTextContent$$serializer() {
    }
    ...
    static {
        RichTextContent$$serializer richTextContent$$serializer = new RichTextContent$$serializer();
        INSTANCE = richTextContent$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.RichTextContent", richTextContent$$serializer, 4);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = RichTextContent.$childSerializers;
    ...
    public final RichTextContent deserialize(@NotNull Decoder decoder) {
        int i;
        HashMap map;
        HashMap map2;
        HashMap map3;
        ...
        return new RichTextContent(i, str, map3, map, map2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RichTextContent richTextContent) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(richTextContent, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RichTextContent.write$Self$OKCompliance_ok_compliance_impl(richTextContent, compositeEncoderBeginStructure, serialDescriptor);
