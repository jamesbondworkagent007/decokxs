...
public final /* synthetic */ class InputChoice$$serializer implements GeneratedSerializer<InputChoice> {
    public static final int $stable;
    public static final InputChoice$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputChoice$$serializer() {
    }
    ...
    static {
        InputChoice$$serializer inputChoice$$serializer = new InputChoice$$serializer();
        INSTANCE = inputChoice$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-choice", inputChoice$$serializer, 11);
    ...
    public final InputChoice deserialize(@NotNull Decoder decoder) {
        Choices choices;
        int i;
        String str;
        String str2;
        ...
        return new InputChoice(i, str3, str5, str6, choices, bool2, str4, bool, str2, str, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputChoice.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.InputChoice, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputChoice inputChoice) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputChoice, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputChoice.write$Self$OKCompliance_ok_compliance_impl(inputChoice, compositeEncoderBeginStructure, serialDescriptor);
