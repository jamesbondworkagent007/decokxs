...
public final /* synthetic */ class VirtualAction$$serializer implements GeneratedSerializer<VirtualAction> {
    public static final int $stable;
    public static final VirtualAction$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private VirtualAction$$serializer() {
    }
    ...
    static {
        VirtualAction$$serializer virtualAction$$serializer = new VirtualAction$$serializer();
        INSTANCE = virtualAction$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("virtual", virtualAction$$serializer, 8);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer nullable = BuiltinSerializersKt.getNullable(Cta$$serializer.INSTANCE);
    ...
    public final VirtualAction deserialize(@NotNull Decoder decoder) {
        String str;
        Boolean bool;
        String str2;
        String str3;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            Cta cta2 = (Cta) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 0, Cta$$serializer.INSTANCE, null);
            StringSerializer stringSerializer = StringSerializer.INSTANCE;
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 0:
                        str6 = str16;
                        cta3 = (Cta) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 0, Cta$$serializer.INSTANCE, cta3);
                        i5 |= 1;
                        str16 = str6;
                        i2 = 7;
                        i3 = 6;
        ...
        return new VirtualAction(i, cta, str5, bool2, str, str4, str3, str2, bool, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.VirtualAction.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.VirtualAction, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull VirtualAction virtualAction) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(virtualAction, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        VirtualAction.write$Self$OKCompliance_ok_compliance_impl(virtualAction, compositeEncoderBeginStructure, serialDescriptor);
