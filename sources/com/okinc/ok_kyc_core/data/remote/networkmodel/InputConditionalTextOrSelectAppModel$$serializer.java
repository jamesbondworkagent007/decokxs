...
public final /* synthetic */ class InputConditionalTextOrSelectAppModel$$serializer implements GeneratedSerializer<InputConditionalTextOrSelectAppModel> {
    public static final int $stable;
    public static final InputConditionalTextOrSelectAppModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputConditionalTextOrSelectAppModel$$serializer() {
    }
    ...
    static {
        InputConditionalTextOrSelectAppModel$$serializer inputConditionalTextOrSelectAppModel$$serializer = new InputConditionalTextOrSelectAppModel$$serializer();
        INSTANCE = inputConditionalTextOrSelectAppModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.InputConditionalTextOrSelectAppModel", inputConditionalTextOrSelectAppModel$$serializer, 13);
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputConditionalTextOrSelectAppModel.access$get$childSerializers$cp():kotlinx.serialization.KSerializer[] */
    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = InputConditionalTextOrSelectAppModel.$childSerializers;
    ...
    public final InputConditionalTextOrSelectAppModel deserialize(@NotNull Decoder decoder) {
        Boolean bool;
        Float f;
        Boolean bool2;
        Boolean bool3;
        ...
        KSerializer[] kSerializerArr3 = InputConditionalTextOrSelectAppModel.$childSerializers;
        int i3 = 9;
        int i4 = 8;
        Float f3 = null;
        ...
        return new InputConditionalTextOrSelectAppModel(i, str5, str3, choices, str6, list, bool2, bool3, str4, bool, str, str2, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputConditionalTextOrSelectAppModel inputConditionalTextOrSelectAppModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputConditionalTextOrSelectAppModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputConditionalTextOrSelectAppModel.write$Self$OKCompliance_ok_compliance_impl(inputConditionalTextOrSelectAppModel, compositeEncoderBeginStructure, serialDescriptor);
