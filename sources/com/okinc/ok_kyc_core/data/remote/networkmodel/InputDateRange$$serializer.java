...
public final /* synthetic */ class InputDateRange$$serializer implements GeneratedSerializer<InputDateRange> {
    public static final int $stable;
    public static final InputDateRange$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputDateRange$$serializer() {
    }
    ...
    static {
        InputDateRange$$serializer inputDateRange$$serializer = new InputDateRange$$serializer();
        INSTANCE = inputDateRange$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-date-range", inputDateRange$$serializer, 15);
    ...
    public final InputDateRange deserialize(@NotNull Decoder decoder) {
        ...
        return new InputDateRange(i, inputDateRangeText, inputDateRangeText3, inputDateRangeText2, str6, str5, str2, rule, bool3, bool, str4, bool2, str, str3, f2, f, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputDateRange.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.InputDateRange, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputDateRange inputDateRange) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputDateRange, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputDateRange.write$Self$OKCompliance_ok_compliance_impl(inputDateRange, compositeEncoderBeginStructure, serialDescriptor);
