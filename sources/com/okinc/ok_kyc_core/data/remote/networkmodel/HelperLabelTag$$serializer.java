...
public final /* synthetic */ class HelperLabelTag$$serializer implements GeneratedSerializer<HelperLabelTag> {
    public static final int $stable;
    public static final HelperLabelTag$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private HelperLabelTag$$serializer() {
    }
    ...
    static {
        HelperLabelTag$$serializer helperLabelTag$$serializer = new HelperLabelTag$$serializer();
        INSTANCE = helperLabelTag$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.HelperLabelTag", helperLabelTag$$serializer, 4);
    ...
    public final HelperLabelTag deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new HelperLabelTag(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull HelperLabelTag helperLabelTag) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(helperLabelTag, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        HelperLabelTag.write$Self$OKCompliance_ok_compliance_impl(helperLabelTag, compositeEncoderBeginStructure, serialDescriptor);
