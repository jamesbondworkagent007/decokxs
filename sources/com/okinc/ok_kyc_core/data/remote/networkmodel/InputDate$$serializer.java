...
public final /* synthetic */ class InputDate$$serializer implements GeneratedSerializer<InputDate> {
    public static final int $stable;
    public static final InputDate$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InputDate$$serializer() {
    }
    ...
    static {
        InputDate$$serializer inputDate$$serializer = new InputDate$$serializer();
        INSTANCE = inputDate$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("input-date", inputDate$$serializer, 13);
    ...
    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.InputDate.access$get$childSerializers$cp():kotlinx.serialization.KSerializer[] */
    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = InputDate.$childSerializers;
    ...
    public final InputDate deserialize(@NotNull Decoder decoder) {
        Float f;
        Boolean bool;
        int i;
        String str;
        ...
        KSerializer[] kSerializerArr2 = InputDate.$childSerializers;
        int i3 = 9;
        int i4 = 8;
        Float f3 = null;
        ...
        return new InputDate(i, str5, str3, str6, list2, bool3, list, bool2, str4, bool, str, str2, f, f2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InputDate inputDate) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inputDate, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InputDate.write$Self$OKCompliance_ok_compliance_impl(inputDate, compositeEncoderBeginStructure, serialDescriptor);
