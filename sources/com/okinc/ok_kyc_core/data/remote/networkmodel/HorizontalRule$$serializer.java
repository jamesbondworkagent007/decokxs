...
public final /* synthetic */ class HorizontalRule$$serializer implements GeneratedSerializer<HorizontalRule> {
    public static final int $stable;
    public static final HorizontalRule$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private HorizontalRule$$serializer() {
    }
    ...
    static {
        HorizontalRule$$serializer horizontalRule$$serializer = new HorizontalRule$$serializer();
        INSTANCE = horizontalRule$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("horizontal-rule", horizontalRule$$serializer, 7);
    ...
    public final HorizontalRule deserialize(@NotNull Decoder decoder) {
        String str;
        Float f;
        String str2;
        Float f2;
        ...
        return new HorizontalRule(i, bool2, str, bool, str3, str2, f2, f, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull HorizontalRule horizontalRule) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(horizontalRule, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        HorizontalRule.write$Self$OKCompliance_ok_compliance_impl(horizontalRule, compositeEncoderBeginStructure, serialDescriptor);
