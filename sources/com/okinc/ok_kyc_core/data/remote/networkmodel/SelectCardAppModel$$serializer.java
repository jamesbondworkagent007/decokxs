...
public final /* synthetic */ class SelectCardAppModel$$serializer implements GeneratedSerializer<SelectCardAppModel> {
    public static final int $stable;
    public static final SelectCardAppModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SelectCardAppModel$$serializer() {
    }
    ...
    static {
        SelectCardAppModel$$serializer selectCardAppModel$$serializer = new SelectCardAppModel$$serializer();
        INSTANCE = selectCardAppModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.ok_kyc_core.data.remote.networkmodel.SelectCardAppModel", selectCardAppModel$$serializer, 10);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{stringSerializer, Choices$$serializer.INSTANCE, BuiltinSerializersKt.getNullable(booleanSerializer), BuiltinSerializersKt.getNullable(booleanSerializer), stringSerializer, BuiltinSerializersKt.getNullable(booleanSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(floatSerializer), BuiltinSerializersKt.getNullable(floatSerializer)};
    }

    /* JADX DEBUG: Method merged with bridge method: deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object; */
    @Override // kotlinx.serialization.DeserializationStrategy
    public final SelectCardAppModel deserialize(@NotNull Decoder decoder) {
        Boolean bool;
        String str;
        String str2;
        String str3;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            Choices choices3 = (Choices) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 1, Choices$$serializer.INSTANCE, null);
            BooleanSerializer booleanSerializer = BooleanSerializer.INSTANCE;
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 1:
                        bool4 = bool10;
                        choices4 = (Choices) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 1, Choices$$serializer.INSTANCE, choices4);
                        i6 |= 2;
                        bool10 = bool4;
                        i2 = 9;
                        i3 = 7;
        ...
        return new SelectCardAppModel(i, str4, choices, bool3, bool2, str3, bool, str, str2, f2, f, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Class process forced to load method for inline: com.okinc.ok_kyc_core.data.remote.networkmodel.SelectCardAppModel.write$Self$OKCompliance_ok_compliance_impl(com.okinc.ok_kyc_core.data.remote.networkmodel.SelectCardAppModel, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void */
    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SelectCardAppModel selectCardAppModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(selectCardAppModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SelectCardAppModel.write$Self$OKCompliance_ok_compliance_impl(selectCardAppModel, compositeEncoderBeginStructure, serialDescriptor);
