...
public final class OKXComplianceApiImpl$getKycInfo$1$apiResult$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ResponseData<KycInfoListBean>>, Object> {
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public OKXComplianceApiImpl$getKycInfo$1$apiResult$1$1(Continuation<? super OKXComplianceApiImpl$getKycInfo$1$apiResult$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new OKXComplianceApiImpl$getKycInfo$1$apiResult$1$1(continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ResponseData<KycInfoListBean>> continuation) {
        return ((OKXComplianceApiImpl$getKycInfo$1$apiResult$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
