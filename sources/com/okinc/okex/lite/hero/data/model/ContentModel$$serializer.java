...
public final /* synthetic */ class ContentModel$$serializer implements GeneratedSerializer<ContentModel> {
    public static final int $stable;
    public static final ContentModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ContentModel$$serializer() {
    }
    ...
    static {
        ContentModel$$serializer contentModel$$serializer = new ContentModel$$serializer();
        INSTANCE = contentModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.lite.hero.data.model.ContentModel", contentModel$$serializer, 6);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = ContentModel.$childSerializers;
    ...
    public final ContentModel deserialize(@NotNull Decoder decoder) {
        ...
        return new ContentModel(i, str2, strDecodeStringElement, z, str3, str, list, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ContentModel contentModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(contentModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ContentModel.KWHzl(contentModel, compositeEncoderBeginStructure, serialDescriptor);
