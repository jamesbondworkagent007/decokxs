...
public final /* synthetic */ class CTA$$serializer implements GeneratedSerializer<CTA> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.lite.home.bean.CTA", cTA$$serializer, 2);
    ...
    public final CTA deserialize(@NotNull Decoder decoder) {
        ...
        return new CTA(i, strDecodeStringElement, strDecodeStringElement2, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CTA cta) {
        ...
        CTA.copydefault(cta, compositeEncoderBeginStructure, serialDescriptor);
