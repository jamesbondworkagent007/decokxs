...
public final /* synthetic */ class OnboardingCardInfo$$serializer implements GeneratedSerializer<OnboardingCardInfo> {
    public static final int $stable;
    public static final OnboardingCardInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OnboardingCardInfo$$serializer() {
    }
    ...
    static {
        OnboardingCardInfo$$serializer onboardingCardInfo$$serializer = new OnboardingCardInfo$$serializer();
        INSTANCE = onboardingCardInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.lite.home.bean.OnboardingCardInfo", onboardingCardInfo$$serializer, 6);
    ...
    public final OnboardingCardInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new OnboardingCardInfo(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OnboardingCardInfo onboardingCardInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(onboardingCardInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OnboardingCardInfo.AEQbTJ(onboardingCardInfo, compositeEncoderBeginStructure, serialDescriptor);
