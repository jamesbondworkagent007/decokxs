...
public final /* synthetic */ class TemplateParam$$serializer implements GeneratedSerializer<TemplateParam> {
    public static final int $stable;
    public static final TemplateParam$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TemplateParam$$serializer() {
    }
    ...
    static {
        TemplateParam$$serializer templateParam$$serializer = new TemplateParam$$serializer();
        INSTANCE = templateParam$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.lite.home.bean.TemplateParam", templateParam$$serializer, 4);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = TemplateParam.$childSerializers;
    ...
    public final TemplateParam deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        ...
        return new TemplateParam(i, str3, descriptionTemplateStyle, str, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TemplateParam templateParam) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(templateParam, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TemplateParam.copydefault(templateParam, compositeEncoderBeginStructure, serialDescriptor);
