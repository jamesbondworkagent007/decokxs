...
public final /* synthetic */ class EarnAssetRewardProgram$$serializer implements GeneratedSerializer<EarnAssetRewardProgram> {
    public static final int $stable;
    public static final EarnAssetRewardProgram$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private EarnAssetRewardProgram$$serializer() {
    }
    ...
    static {
        EarnAssetRewardProgram$$serializer earnAssetRewardProgram$$serializer = new EarnAssetRewardProgram$$serializer();
        INSTANCE = earnAssetRewardProgram$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.lite.earn.bean.EarnAssetRewardProgram", earnAssetRewardProgram$$serializer, 5);
    ...
    public final EarnAssetRewardProgram deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new EarnAssetRewardProgram(i, str, str2, j, strDecodeStringElement, strDecodeStringElement2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull EarnAssetRewardProgram earnAssetRewardProgram) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(earnAssetRewardProgram, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        EarnAssetRewardProgram.write$Self$OKFinance_finance_api(earnAssetRewardProgram, compositeEncoderBeginStructure, serialDescriptor);
