...
public final /* synthetic */ class Currency$$serializer implements GeneratedSerializer<Currency> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.lite.earn.bean.Currency", currency$$serializer, 4);
    ...
    public final Currency deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new Currency(i2, str, str2, i, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull Currency currency) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(currency, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        Currency.write$Self$OKFinance_finance_api(currency, compositeEncoderBeginStructure, serialDescriptor);
