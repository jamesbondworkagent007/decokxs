...
public final /* synthetic */ class PopupAnnouncementItem$$serializer implements GeneratedSerializer<PopupAnnouncementItem> {
    public static final int $stable;
    public static final PopupAnnouncementItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private PopupAnnouncementItem$$serializer() {
    }
    ...
    static {
        PopupAnnouncementItem$$serializer popupAnnouncementItem$$serializer = new PopupAnnouncementItem$$serializer();
        INSTANCE = popupAnnouncementItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.center.bean.PopupAnnouncementItem", popupAnnouncementItem$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("id", true);
        pluginGeneratedSerialDescriptor.addElement("title", true);
        pluginGeneratedSerialDescriptor.addElement("htmlContent", true);
    ...
    public final PopupAnnouncementItem deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new PopupAnnouncementItem(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull PopupAnnouncementItem popupAnnouncementItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(popupAnnouncementItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        PopupAnnouncementItem.write$Self$OKSupport_support_impl(popupAnnouncementItem, compositeEncoderBeginStructure, serialDescriptor);
