...
public final /* synthetic */ class ChatbotEntryDisplayModel$$serializer implements GeneratedSerializer<ChatbotEntryDisplayModel> {
    public static final int $stable;
    public static final ChatbotEntryDisplayModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ChatbotEntryDisplayModel$$serializer() {
    }
    ...
    static {
        ChatbotEntryDisplayModel$$serializer chatbotEntryDisplayModel$$serializer = new ChatbotEntryDisplayModel$$serializer();
        INSTANCE = chatbotEntryDisplayModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.center.ui.displaymodels.ChatbotEntryDisplayModel", chatbotEntryDisplayModel$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("chatbotIcon", true);
    ...
    public final ChatbotEntryDisplayModel deserialize(@NotNull Decoder decoder) {
        ...
        return new ChatbotEntryDisplayModel(i, z, str3, str5, str2, str4, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ChatbotEntryDisplayModel chatbotEntryDisplayModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(chatbotEntryDisplayModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ChatbotEntryDisplayModel.write$Self$OKSupport_support_impl(chatbotEntryDisplayModel, compositeEncoderBeginStructure, serialDescriptor);
