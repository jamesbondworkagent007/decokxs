...
public final /* synthetic */ class SearchSectionBean$$serializer implements GeneratedSerializer<SearchSectionBean> {
    public static final int $stable;
    public static final SearchSectionBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SearchSectionBean$$serializer() {
    }
    ...
    static {
        SearchSectionBean$$serializer searchSectionBean$$serializer = new SearchSectionBean$$serializer();
        INSTANCE = searchSectionBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.search.bean.SearchSectionBean", searchSectionBean$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("id", true);
        pluginGeneratedSerialDescriptor.addElement("slug", true);
        pluginGeneratedSerialDescriptor.addElement("title", true);
        pluginGeneratedSerialDescriptor.addElement("chipColor", true);
    ...
    public final SearchSectionBean deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new SearchSectionBean(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SearchSectionBean searchSectionBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(searchSectionBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SearchSectionBean.write$Self$OKSupport_support_impl(searchSectionBean, compositeEncoderBeginStructure, serialDescriptor);
