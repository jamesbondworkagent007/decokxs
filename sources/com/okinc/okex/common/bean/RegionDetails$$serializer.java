...
public final /* synthetic */ class RegionDetails$$serializer implements GeneratedSerializer<RegionDetails> {
    public static final int $stable;
    public static final RegionDetails$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RegionDetails$$serializer() {
    }
    ...
    static {
        RegionDetails$$serializer regionDetails$$serializer = new RegionDetails$$serializer();
        INSTANCE = regionDetails$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okex.common.bean.RegionDetails", regionDetails$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("userSite", true);
        pluginGeneratedSerialDescriptor.addElement("domain", true);
        pluginGeneratedSerialDescriptor.addElement("wsDomain", true);
        pluginGeneratedSerialDescriptor.addElement("wsDexDomain", true);
    ...
    public final RegionDetails deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new RegionDetails(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RegionDetails regionDetails) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(regionDetails, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RegionDetails.write$Self$OKSupport_support_impl(regionDetails, compositeEncoderBeginStructure, serialDescriptor);
