...
public final /* synthetic */ class BorrowRepayResp$$serializer implements GeneratedSerializer<BorrowRepayResp> {
    public static final int $stable;
    public static final BorrowRepayResp$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BorrowRepayResp$$serializer() {
    }
    ...
    static {
        BorrowRepayResp$$serializer borrowRepayResp$$serializer = new BorrowRepayResp$$serializer();
        INSTANCE = borrowRepayResp$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.BorrowRepayResp", borrowRepayResp$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("loanQuota", true);
        pluginGeneratedSerialDescriptor.addElement("posLoan", true);
        pluginGeneratedSerialDescriptor.addElement("availLoan", false);
        pluginGeneratedSerialDescriptor.addElement("usedLoan", false);
    ...
    public final BorrowRepayResp deserialize(@NotNull Decoder decoder) {
        ...
        return new BorrowRepayResp(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BorrowRepayResp borrowRepayResp) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(borrowRepayResp, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BorrowRepayResp.write$Self$OKTradeCore_trade_core(borrowRepayResp, compositeEncoderBeginStructure, serialDescriptor);
