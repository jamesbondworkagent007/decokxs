...
public final /* synthetic */ class StrikeConfig$$serializer implements GeneratedSerializer<StrikeConfig> {
    public static final int $stable;
    public static final StrikeConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private StrikeConfig$$serializer() {
    }
    ...
    static {
        StrikeConfig$$serializer strikeConfig$$serializer = new StrikeConfig$$serializer();
        INSTANCE = strikeConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.StrikeConfig", strikeConfig$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("limitCurrency", false);
        pluginGeneratedSerialDescriptor.addElement("strikeMax", false);
        pluginGeneratedSerialDescriptor.addElement("strikeMin", false);
        pluginGeneratedSerialDescriptor.addElement("strikeStep", false);
        pluginGeneratedSerialDescriptor.addElement("underlyingIndex", false);
    ...
    public final StrikeConfig deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new StrikeConfig(i, str5, str4, str, str3, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull StrikeConfig strikeConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(strikeConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        StrikeConfig.write$Self$OKTradeCore_trade_core(strikeConfig, compositeEncoderBeginStructure, serialDescriptor);
