...
public final /* synthetic */ class RFQGetQuoteLeg$$serializer implements GeneratedSerializer<RFQGetQuoteLeg> {
    public static final int $stable;
    public static final RFQGetQuoteLeg$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RFQGetQuoteLeg$$serializer() {
    }
    ...
    static {
        RFQGetQuoteLeg$$serializer rFQGetQuoteLeg$$serializer = new RFQGetQuoteLeg$$serializer();
        INSTANCE = rFQGetQuoteLeg$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.RFQGetQuoteLeg", rFQGetQuoteLeg$$serializer, 5);
    ...
    public final RFQGetQuoteLeg deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new RFQGetQuoteLeg(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RFQGetQuoteLeg rFQGetQuoteLeg) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(rFQGetQuoteLeg, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RFQGetQuoteLeg.write$Self$OKTradeCore_trade_core(rFQGetQuoteLeg, compositeEncoderBeginStructure, serialDescriptor);
