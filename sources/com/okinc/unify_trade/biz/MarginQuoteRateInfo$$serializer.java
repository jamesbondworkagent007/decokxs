...
public final /* synthetic */ class MarginQuoteRateInfo$$serializer implements GeneratedSerializer<MarginQuoteRateInfo> {
    public static final int $stable;
    public static final MarginQuoteRateInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MarginQuoteRateInfo$$serializer() {
    }
    ...
    static {
        MarginQuoteRateInfo$$serializer marginQuoteRateInfo$$serializer = new MarginQuoteRateInfo$$serializer();
        INSTANCE = marginQuoteRateInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.MarginQuoteRateInfo", marginQuoteRateInfo$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("instId", false);
        pluginGeneratedSerialDescriptor.addElement("baseRate", false);
        pluginGeneratedSerialDescriptor.addElement("baseDiscountRate", false);
        pluginGeneratedSerialDescriptor.addElement("quoteRate", false);
        pluginGeneratedSerialDescriptor.addElement("quoteDiscountRate", false);
        pluginGeneratedSerialDescriptor.addElement("nextInterestTime", false);
        pluginGeneratedSerialDescriptor.addElement("nextDeductionTime", false);
    ...
    public final MarginQuoteRateInfo deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new MarginQuoteRateInfo(i, str6, str7, str4, str5, str3, str2, str, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MarginQuoteRateInfo marginQuoteRateInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(marginQuoteRateInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MarginQuoteRateInfo.write$Self$OKTradeCore_trade_core(marginQuoteRateInfo, compositeEncoderBeginStructure, serialDescriptor);
