...
public final /* synthetic */ class BizModifyMultipleOrderReq$$serializer implements GeneratedSerializer<BizModifyMultipleOrderReq> {
    public static final int $stable;
    public static final BizModifyMultipleOrderReq$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BizModifyMultipleOrderReq$$serializer() {
    }
    ...
    static {
        BizModifyMultipleOrderReq$$serializer bizModifyMultipleOrderReq$$serializer = new BizModifyMultipleOrderReq$$serializer();
        INSTANCE = bizModifyMultipleOrderReq$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.BizModifyMultipleOrderReq", bizModifyMultipleOrderReq$$serializer, 13);
        ...
        pluginGeneratedSerialDescriptor.addElement("newTpOrdKind", true);
        pluginGeneratedSerialDescriptor.addElement("newPercent", true);
    ...
    public final BizModifyMultipleOrderReq deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new BizModifyMultipleOrderReq(i, str10, str12, str4, str9, str6, str13, str7, str8, str11, str5, str, str2, str3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BizModifyMultipleOrderReq bizModifyMultipleOrderReq) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(bizModifyMultipleOrderReq, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BizModifyMultipleOrderReq.write$Self$OKTradeCore_trade_core(bizModifyMultipleOrderReq, compositeEncoderBeginStructure, serialDescriptor);
