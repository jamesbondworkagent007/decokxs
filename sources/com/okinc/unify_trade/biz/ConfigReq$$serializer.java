...
public final /* synthetic */ class ConfigReq$$serializer implements GeneratedSerializer<ConfigReq> {
    public static final int $stable;
    public static final ConfigReq$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ConfigReq$$serializer() {
    }
    ...
    static {
        ConfigReq$$serializer configReq$$serializer = new ConfigReq$$serializer();
        INSTANCE = configReq$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.ConfigReq", configReq$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("alternativeCurrency", false);
        pluginGeneratedSerialDescriptor.addElement("currency", false);
        pluginGeneratedSerialDescriptor.addElement("expiryTime", false);
        pluginGeneratedSerialDescriptor.addElement("requestTime", false);
        pluginGeneratedSerialDescriptor.addElement("strike", true);
        pluginGeneratedSerialDescriptor.addElement("tradeSide", false);
    ...
    public final ConfigReq deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new ConfigReq(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ConfigReq configReq) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(configReq, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ConfigReq.write$Self$OKTradeCore_trade_core(configReq, compositeEncoderBeginStructure, serialDescriptor);
