...
public final /* synthetic */ class SegmentOrderResponse$$serializer implements GeneratedSerializer<SegmentOrderResponse> {
    public static final int $stable;
    public static final SegmentOrderResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SegmentOrderResponse$$serializer() {
    }
    ...
    static {
        SegmentOrderResponse$$serializer segmentOrderResponse$$serializer = new SegmentOrderResponse$$serializer();
        INSTANCE = segmentOrderResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.SegmentOrderResponse", segmentOrderResponse$$serializer, 5);
    ...
    public final SegmentOrderResponse deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new SegmentOrderResponse(i, str5, str4, str, str3, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SegmentOrderResponse segmentOrderResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(segmentOrderResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SegmentOrderResponse.write$Self$OKTradeCore_trade_core(segmentOrderResponse, compositeEncoderBeginStructure, serialDescriptor);
