...
public final /* synthetic */ class LendingHistoryRecordData$$serializer implements GeneratedSerializer<LendingHistoryRecordData> {
    public static final int $stable;
    public static final LendingHistoryRecordData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LendingHistoryRecordData$$serializer() {
    }
    ...
    static {
        LendingHistoryRecordData$$serializer lendingHistoryRecordData$$serializer = new LendingHistoryRecordData$$serializer();
        INSTANCE = lendingHistoryRecordData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.LendingHistoryRecordData", lendingHistoryRecordData$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("dateHour", false);
        pluginGeneratedSerialDescriptor.addElement("dateHourStr", true);
        pluginGeneratedSerialDescriptor.addElement("rate", false);
        pluginGeneratedSerialDescriptor.addElement("borrowingYearRate", false);
    ...
    public final LendingHistoryRecordData deserialize(@NotNull Decoder decoder) {
        ...
        return new LendingHistoryRecordData(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LendingHistoryRecordData lendingHistoryRecordData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(lendingHistoryRecordData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LendingHistoryRecordData.write$Self$OKTradeCore_trade_core(lendingHistoryRecordData, compositeEncoderBeginStructure, serialDescriptor);
