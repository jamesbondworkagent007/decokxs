...
public final /* synthetic */ class ArbInvestDetailsItems$$serializer implements GeneratedSerializer<ArbInvestDetailsItems> {
    public static final int $stable;
    public static final ArbInvestDetailsItems$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ArbInvestDetailsItems$$serializer() {
    }
    ...
    static {
        ArbInvestDetailsItems$$serializer arbInvestDetailsItems$$serializer = new ArbInvestDetailsItems$$serializer();
        INSTANCE = arbInvestDetailsItems$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.ArbInvestDetailsItems", arbInvestDetailsItems$$serializer, 3);
    ...
    public final ArbInvestDetailsItems deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ArbInvestDetailsItems(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ArbInvestDetailsItems arbInvestDetailsItems) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(arbInvestDetailsItems, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ArbInvestDetailsItems.write$Self$OKTradeCore_trade_core(arbInvestDetailsItems, compositeEncoderBeginStructure, serialDescriptor);
