...
public final /* synthetic */ class LossInsurance$$serializer implements GeneratedSerializer<LossInsurance> {
    public static final int $stable;
    public static final LossInsurance$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LossInsurance$$serializer() {
    }
    ...
    static {
        LossInsurance$$serializer lossInsurance$$serializer = new LossInsurance$$serializer();
        INSTANCE = lossInsurance$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.LossInsurance", lossInsurance$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("eligible", true);
    ...
    public final LossInsurance deserialize(@NotNull Decoder decoder) {
        boolean z;
        String str;
        String str2;
        int i;
        ...
        return new LossInsurance(i, z, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LossInsurance lossInsurance) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(lossInsurance, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LossInsurance.write$Self$OKTradeCore_trade_core(lossInsurance, compositeEncoderBeginStructure, serialDescriptor);
