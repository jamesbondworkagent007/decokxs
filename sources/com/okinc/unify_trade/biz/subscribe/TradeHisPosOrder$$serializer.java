...
public final /* synthetic */ class TradeHisPosOrder$$serializer implements GeneratedSerializer<TradeHisPosOrder> {
    public static final int $stable;
    public static final TradeHisPosOrder$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TradeHisPosOrder$$serializer() {
    }
    ...
    static {
        TradeHisPosOrder$$serializer tradeHisPosOrder$$serializer = new TradeHisPosOrder$$serializer();
        INSTANCE = tradeHisPosOrder$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.subscribe.TradeHisPosOrder", tradeHisPosOrder$$serializer, 17);
        ...
        pluginGeneratedSerialDescriptor.addElement("paginateTime", true);
        pluginGeneratedSerialDescriptor.addElement("paginateId", true);
    ...
    public final TradeHisPosOrder deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TradeHisPosOrder(i, str, str3, str2, str4, str10, strDecodeStringElement2, str9, str8, str11, str7, str6, str5, str13, str14, str12, strDecodeStringElement3, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TradeHisPosOrder tradeHisPosOrder) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(tradeHisPosOrder, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TradeHisPosOrder.write$Self$OKTradeCore_trade_core(tradeHisPosOrder, compositeEncoderBeginStructure, serialDescriptor);
