...
public final /* synthetic */ class WatchListData$$serializer implements GeneratedSerializer<WatchListData> {
    public static final int $stable;
    public static final WatchListData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private WatchListData$$serializer() {
    }
    ...
    static {
        WatchListData$$serializer watchListData$$serializer = new WatchListData$$serializer();
        INSTANCE = watchListData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.subscribe.WatchListData", watchListData$$serializer, 8);
    ...
    public final WatchListData deserialize(@NotNull Decoder decoder) {
        ...
        return new WatchListData(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull WatchListData watchListData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(watchListData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        WatchListData.write$Self$OKTradeCore_trade_core(watchListData, compositeEncoderBeginStructure, serialDescriptor);
