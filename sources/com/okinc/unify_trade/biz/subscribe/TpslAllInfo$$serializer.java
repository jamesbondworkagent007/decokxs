...
public final /* synthetic */ class TpslAllInfo$$serializer implements GeneratedSerializer<TpslAllInfo> {
    public static final int $stable;
    public static final TpslAllInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TpslAllInfo$$serializer() {
    }
    ...
    static {
        TpslAllInfo$$serializer tpslAllInfo$$serializer = new TpslAllInfo$$serializer();
        INSTANCE = tpslAllInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.subscribe.TpslAllInfo", tpslAllInfo$$serializer, 6);
    ...
    public final TpslAllInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new TpslAllInfo(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TpslAllInfo tpslAllInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(tpslAllInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TpslAllInfo.write$Self$OKTradeCore_trade_core(tpslAllInfo, compositeEncoderBeginStructure, serialDescriptor);
