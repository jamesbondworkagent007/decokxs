...
public final /* synthetic */ class SettingWatchList$$serializer implements GeneratedSerializer<SettingWatchList> {
    public static final int $stable;
    public static final SettingWatchList$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SettingWatchList$$serializer() {
    }
    ...
    static {
        SettingWatchList$$serializer settingWatchList$$serializer = new SettingWatchList$$serializer();
        INSTANCE = settingWatchList$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.subscribe.SettingWatchList", settingWatchList$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("expTime", false);
    ...
    public final SettingWatchList deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        int i;
        ...
        return new SettingWatchList(i, str5, str2, str7, str6, str3, str4, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SettingWatchList settingWatchList) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(settingWatchList, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SettingWatchList.write$Self$OKTradeCore_trade_core(settingWatchList, compositeEncoderBeginStructure, serialDescriptor);
