...
public final /* synthetic */ class AccountSummaryAccountDetail$$serializer implements GeneratedSerializer<AccountSummaryAccountDetail> {
    public static final int $stable;
    public static final AccountSummaryAccountDetail$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AccountSummaryAccountDetail$$serializer() {
    }
    ...
    static {
        AccountSummaryAccountDetail$$serializer accountSummaryAccountDetail$$serializer = new AccountSummaryAccountDetail$$serializer();
        INSTANCE = accountSummaryAccountDetail$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.subscribe.AccountSummaryAccountDetail", accountSummaryAccountDetail$$serializer, 9);
        pluginGeneratedSerialDescriptor.addElement("upl", true);
        pluginGeneratedSerialDescriptor.addElement("availEq", true);
        pluginGeneratedSerialDescriptor.addElement("adjEq", true);
    ...
    public final AccountSummaryAccountDetail deserialize(@NotNull Decoder decoder) {
        ...
        return new AccountSummaryAccountDetail(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AccountSummaryAccountDetail accountSummaryAccountDetail) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(accountSummaryAccountDetail, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AccountSummaryAccountDetail.write$Self$OKTradeCore_trade_core(accountSummaryAccountDetail, compositeEncoderBeginStructure, serialDescriptor);
