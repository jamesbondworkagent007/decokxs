...
public final /* synthetic */ class FundingRateItem$$serializer implements GeneratedSerializer<FundingRateItem> {
    public static final int $stable;
    public static final FundingRateItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private FundingRateItem$$serializer() {
    }
    ...
    static {
        FundingRateItem$$serializer fundingRateItem$$serializer = new FundingRateItem$$serializer();
        INSTANCE = fundingRateItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.subscribe.FundingRateItem", fundingRateItem$$serializer, 10);
        ...
        pluginGeneratedSerialDescriptor.addElement("minFundingRate", true);
        pluginGeneratedSerialDescriptor.addElement("maxFundingRate", true);
        ...
        pluginGeneratedSerialDescriptor.addElement("formulaType", true);
        pluginGeneratedSerialDescriptor.addElement("interestRate", true);
        pluginGeneratedSerialDescriptor.addElement("impactValue", true);
    ...
    public final FundingRateItem deserialize(@NotNull Decoder decoder) {
        ...
        return new FundingRateItem(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull FundingRateItem fundingRateItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(fundingRateItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        FundingRateItem.write$Self$OKTradeCore_trade_core(fundingRateItem, compositeEncoderBeginStructure, serialDescriptor);
