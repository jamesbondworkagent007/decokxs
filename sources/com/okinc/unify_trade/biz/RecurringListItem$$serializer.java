...
public final /* synthetic */ class RecurringListItem$$serializer implements GeneratedSerializer<RecurringListItem> {
    public static final int $stable;
    public static final RecurringListItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RecurringListItem$$serializer() {
    }
    ...
    static {
        RecurringListItem$$serializer recurringListItem$$serializer = new RecurringListItem$$serializer();
        INSTANCE = recurringListItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.RecurringListItem", recurringListItem$$serializer, 8);
    ...
    public final RecurringListItem deserialize(@NotNull Decoder decoder) {
        ...
        return new RecurringListItem(i, str2, str4, str6, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RecurringListItem recurringListItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(recurringListItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RecurringListItem.write$Self$OKTradeCore_trade_core(recurringListItem, compositeEncoderBeginStructure, serialDescriptor);
