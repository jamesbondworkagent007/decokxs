...
public final /* synthetic */ class TradeSizeConfig$$serializer implements GeneratedSerializer<TradeSizeConfig> {
    public static final int $stable;
    public static final TradeSizeConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TradeSizeConfig$$serializer() {
    }
    ...
    static {
        TradeSizeConfig$$serializer tradeSizeConfig$$serializer = new TradeSizeConfig$$serializer();
        INSTANCE = tradeSizeConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.TradeSizeConfig", tradeSizeConfig$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("limitCurrency", false);
        pluginGeneratedSerialDescriptor.addElement("tradeSizeMax", false);
        pluginGeneratedSerialDescriptor.addElement("tradeSizeMin", false);
        pluginGeneratedSerialDescriptor.addElement("tradeStepSize", false);
    ...
    public final TradeSizeConfig deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TradeSizeConfig(i, str4, str3, str, str2, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TradeSizeConfig tradeSizeConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(tradeSizeConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TradeSizeConfig.write$Self$OKTradeCore_trade_core(tradeSizeConfig, compositeEncoderBeginStructure, serialDescriptor);
