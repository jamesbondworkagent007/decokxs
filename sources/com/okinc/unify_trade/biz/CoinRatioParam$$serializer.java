...
public final /* synthetic */ class CoinRatioParam$$serializer implements GeneratedSerializer<CoinRatioParam> {
    public static final int $stable;
    public static final CoinRatioParam$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CoinRatioParam$$serializer() {
    }
    ...
    static {
        CoinRatioParam$$serializer coinRatioParam$$serializer = new CoinRatioParam$$serializer();
        INSTANCE = coinRatioParam$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.CoinRatioParam", coinRatioParam$$serializer, 4);
    ...
    public final CoinRatioParam deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new CoinRatioParam(i, str3, str2, str, str4, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CoinRatioParam coinRatioParam) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(coinRatioParam, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CoinRatioParam.write$Self$OKTradeCore_trade_core(coinRatioParam, compositeEncoderBeginStructure, serialDescriptor);
