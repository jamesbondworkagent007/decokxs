...
public final /* synthetic */ class BizTradeClosePosition$$serializer implements GeneratedSerializer<BizTradeClosePosition> {
    public static final int $stable;
    public static final BizTradeClosePosition$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BizTradeClosePosition$$serializer() {
    }
    ...
    static {
        BizTradeClosePosition$$serializer bizTradeClosePosition$$serializer = new BizTradeClosePosition$$serializer();
        INSTANCE = bizTradeClosePosition$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.BizTradeClosePosition", bizTradeClosePosition$$serializer, 6);
    ...
    public final BizTradeClosePosition deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        int i;
        String str3;
        ...
        return new BizTradeClosePosition(i, str4, str6, str5, str2, str3, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BizTradeClosePosition bizTradeClosePosition) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(bizTradeClosePosition, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BizTradeClosePosition.write$Self$OKTradeCore_trade_core(bizTradeClosePosition, compositeEncoderBeginStructure, serialDescriptor);
