...
public final /* synthetic */ class MPBotEventData$$serializer implements GeneratedSerializer<MPBotEventData> {
    public static final int $stable;
    public static final MPBotEventData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MPBotEventData$$serializer() {
    }
    ...
    static {
        MPBotEventData$$serializer mPBotEventData$$serializer = new MPBotEventData$$serializer();
        INSTANCE = mPBotEventData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.MPBotEventData", mPBotEventData$$serializer, 3);
    ...
    public final MPBotEventData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new MPBotEventData(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MPBotEventData mPBotEventData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(mPBotEventData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MPBotEventData.write$Self$OKTradeCore_trade_core(mPBotEventData, compositeEncoderBeginStructure, serialDescriptor);
