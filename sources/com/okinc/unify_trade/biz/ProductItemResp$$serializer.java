...
public final /* synthetic */ class ProductItemResp$$serializer implements GeneratedSerializer<ProductItemResp> {
    public static final int $stable;
    public static final ProductItemResp$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ProductItemResp$$serializer() {
    }
    ...
    static {
        ProductItemResp$$serializer productItemResp$$serializer = new ProductItemResp$$serializer();
        INSTANCE = productItemResp$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.ProductItemResp", productItemResp$$serializer, 16);
        ...
        pluginGeneratedSerialDescriptor.addElement("underlyingIndex", true);
        pluginGeneratedSerialDescriptor.addElement("strike", true);
        pluginGeneratedSerialDescriptor.addElement("launchTime", true);
        pluginGeneratedSerialDescriptor.addElement("stopTradingTime", true);
        pluginGeneratedSerialDescriptor.addElement("expiryTime", true);
        pluginGeneratedSerialDescriptor.addElement("settlementTime", true);
        pluginGeneratedSerialDescriptor.addElement("annualYieldPercentage", true);
        pluginGeneratedSerialDescriptor.addElement("absYieldPercentage", true);
        pluginGeneratedSerialDescriptor.addElement(FirebaseAnalytics.Param.TERM, true);
        pluginGeneratedSerialDescriptor.addElement("interestAccuralTime", true);
        pluginGeneratedSerialDescriptor.addElement("shortSymbol", true);
    ...
    public final ProductItemResp deserialize(@NotNull Decoder decoder) {
        ...
        return new ProductItemResp(i, str, str3, str2, str4, str10, strDecodeStringElement2, str9, str8, str11, str7, str6, str13, str5, str12, strDecodeStringElement3, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ProductItemResp productItemResp) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(productItemResp, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ProductItemResp.write$Self$OKTradeCore_trade_core(productItemResp, compositeEncoderBeginStructure, serialDescriptor);
