...
public final /* synthetic */ class BotLeadProfitChartModel$$serializer implements GeneratedSerializer<BotLeadProfitChartModel> {
    public static final int $stable;
    public static final BotLeadProfitChartModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BotLeadProfitChartModel$$serializer() {
    }
    ...
    static {
        BotLeadProfitChartModel$$serializer botLeadProfitChartModel$$serializer = new BotLeadProfitChartModel$$serializer();
        INSTANCE = botLeadProfitChartModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.BotLeadProfitChartModel", botLeadProfitChartModel$$serializer, 3);
    ...
    public final BotLeadProfitChartModel deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new BotLeadProfitChartModel(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BotLeadProfitChartModel botLeadProfitChartModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(botLeadProfitChartModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BotLeadProfitChartModel.write$Self$OKTradeCore_trade_core(botLeadProfitChartModel, compositeEncoderBeginStructure, serialDescriptor);
