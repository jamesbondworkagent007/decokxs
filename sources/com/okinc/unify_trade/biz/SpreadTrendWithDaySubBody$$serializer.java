...
public final /* synthetic */ class SpreadTrendWithDaySubBody$$serializer implements GeneratedSerializer<SpreadTrendWithDaySubBody> {
    public static final int $stable;
    public static final SpreadTrendWithDaySubBody$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SpreadTrendWithDaySubBody$$serializer() {
    }
    ...
    static {
        SpreadTrendWithDaySubBody$$serializer spreadTrendWithDaySubBody$$serializer = new SpreadTrendWithDaySubBody$$serializer();
        INSTANCE = spreadTrendWithDaySubBody$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.SpreadTrendWithDaySubBody", spreadTrendWithDaySubBody$$serializer, 5);
    ...
    public final SpreadTrendWithDaySubBody deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new SpreadTrendWithDaySubBody(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SpreadTrendWithDaySubBody spreadTrendWithDaySubBody) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(spreadTrendWithDaySubBody, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SpreadTrendWithDaySubBody.write$Self$OKTradeCore_trade_core(spreadTrendWithDaySubBody, compositeEncoderBeginStructure, serialDescriptor);
