...
public final class LastRates implements Parcelable {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.okinc.unify_trade.biz.LastRates */
    ...
    public static final class Companion {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.unify_trade.biz.LastRates.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public static final /* synthetic */ void write$Self$OKTradeCore_trade_core(LastRates lastRates, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
  ...
  (wrap:com.okinc.unify_trade.biz.AverageRate:?: TERNARY null = ((wrap:int:0x0000: ARITH (r9v0 int) & (1 int) A[WRAPPED]) != (0 int)) ? (wrap:com.okinc.unify_trade.biz.AverageRate:0x000c: CONSTRUCTOR 
 ...
 A[MD:(java.lang.Double, java.lang.Long, java.lang.Long, int, kotlin.jvm.internal.DefaultConstructorMarker):void (m), WRAPPED] (LINE:23) call: com.okinc.unify_trade.biz.AverageRate.<init>(java.lang.Double, java.lang.Long, java.lang.Long, int, kotlin.jvm.internal.DefaultConstructorMarker):void type: CONSTRUCTOR) : (r7v0 com.okinc.unify_trade.biz.AverageRate))
  (wrap:java.util.List:?: TERNARY null = ((wrap:int:0x000f: ARITH (r9v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (wrap:java.util.List:0x0013: INVOKE  STATIC call: o.yDY.AhwBna():java.util.List A[MD:<T>:():java.util.List<T> (m), WRAPPED] (LINE:24)) : (r8v0 java.util.List))
 A[MD:(com.okinc.unify_trade.biz.AverageRate, java.util.List<com.okinc.unify_trade.biz.Rate>):void (m)] (LINE:22) call: com.okinc.unify_trade.biz.LastRates.<init>(com.okinc.unify_trade.biz.AverageRate, java.util.List):void type: THIS */
