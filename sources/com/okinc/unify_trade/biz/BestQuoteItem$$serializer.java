...
public final /* synthetic */ class BestQuoteItem$$serializer implements GeneratedSerializer<BestQuoteItem> {
    public static final int $stable;
    public static final BestQuoteItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BestQuoteItem$$serializer() {
    }
    ...
    static {
        BestQuoteItem$$serializer bestQuoteItem$$serializer = new BestQuoteItem$$serializer();
        INSTANCE = bestQuoteItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.BestQuoteItem", bestQuoteItem$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("quoteId", true);
        pluginGeneratedSerialDescriptor.addElement("rfqId", true);
        pluginGeneratedSerialDescriptor.addElement("clRfqId", true);
        pluginGeneratedSerialDescriptor.addElement("validUntil", true);
        pluginGeneratedSerialDescriptor.addElement("state", true);
        pluginGeneratedSerialDescriptor.addElement("quoteSide", true);
    ...
    public final BestQuoteItem deserialize(@NotNull Decoder decoder) {
        ...
        return new BestQuoteItem(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BestQuoteItem bestQuoteItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(bestQuoteItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BestQuoteItem.write$Self$OKTradeCore_trade_core(bestQuoteItem, compositeEncoderBeginStructure, serialDescriptor);
