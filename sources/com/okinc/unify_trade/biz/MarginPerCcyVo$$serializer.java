...
public final /* synthetic */ class MarginPerCcyVo$$serializer implements GeneratedSerializer<MarginPerCcyVo> {
    public static final int $stable;
    public static final MarginPerCcyVo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MarginPerCcyVo$$serializer() {
    }
    ...
    static {
        MarginPerCcyVo$$serializer marginPerCcyVo$$serializer = new MarginPerCcyVo$$serializer();
        INSTANCE = marginPerCcyVo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.MarginPerCcyVo", marginPerCcyVo$$serializer, 11);
        ...
        pluginGeneratedSerialDescriptor.addElement("gridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("gridProfitRate", true);
        ...
        pluginGeneratedSerialDescriptor.addElement("floatProfitRate", true);
        pluginGeneratedSerialDescriptor.addElement("arbitrageApy", true);
    ...
    public final MarginPerCcyVo deserialize(@NotNull Decoder decoder) {
        ...
        return new MarginPerCcyVo(i, str2, str4, str10, str7, str8, str6, str9, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MarginPerCcyVo marginPerCcyVo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(marginPerCcyVo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MarginPerCcyVo.write$Self$OKTradeCore_trade_core(marginPerCcyVo, compositeEncoderBeginStructure, serialDescriptor);
