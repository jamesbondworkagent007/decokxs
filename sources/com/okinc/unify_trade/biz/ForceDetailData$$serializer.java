...
public final /* synthetic */ class ForceDetailData$$serializer implements GeneratedSerializer<ForceDetailData> {
    public static final int $stable;
    public static final ForceDetailData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ForceDetailData$$serializer() {
    }
    ...
    static {
        ForceDetailData$$serializer forceDetailData$$serializer = new ForceDetailData$$serializer();
        INSTANCE = forceDetailData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.ForceDetailData", forceDetailData$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement(OtcExtraKeys.SIDE, true);
        pluginGeneratedSerialDescriptor.addElement("posSide", true);
        pluginGeneratedSerialDescriptor.addElement("bkPx", true);
        pluginGeneratedSerialDescriptor.addElement("sz", true);
        pluginGeneratedSerialDescriptor.addElement("bkLoss", true);
    ...
    public final ForceDetailData deserialize(@NotNull Decoder decoder) {
        ...
        return new ForceDetailData(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ForceDetailData forceDetailData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(forceDetailData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ForceDetailData.write$Self$OKTradeCore_trade_core(forceDetailData, compositeEncoderBeginStructure, serialDescriptor);
