...
public final /* synthetic */ class RFQQuoteRespLeg$$serializer implements GeneratedSerializer<RFQQuoteRespLeg> {
    public static final int $stable;
    public static final RFQQuoteRespLeg$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RFQQuoteRespLeg$$serializer() {
    }
    ...
    static {
        RFQQuoteRespLeg$$serializer rFQQuoteRespLeg$$serializer = new RFQQuoteRespLeg$$serializer();
        INSTANCE = rFQQuoteRespLeg$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.RFQQuoteRespLeg", rFQQuoteRespLeg$$serializer, 7);
    ...
    public final RFQQuoteRespLeg deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new RFQQuoteRespLeg(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RFQQuoteRespLeg rFQQuoteRespLeg) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(rFQQuoteRespLeg, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RFQQuoteRespLeg.write$Self$OKTradeCore_trade_core(rFQQuoteRespLeg, compositeEncoderBeginStructure, serialDescriptor);
