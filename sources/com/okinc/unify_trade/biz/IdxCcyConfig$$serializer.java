...
public final /* synthetic */ class IdxCcyConfig$$serializer implements GeneratedSerializer<IdxCcyConfig> {
    public static final int $stable;
    public static final IdxCcyConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private IdxCcyConfig$$serializer() {
    }
    ...
    static {
        IdxCcyConfig$$serializer idxCcyConfig$$serializer = new IdxCcyConfig$$serializer();
        INSTANCE = idxCcyConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.IdxCcyConfig", idxCcyConfig$$serializer, 9);
        ...
        pluginGeneratedSerialDescriptor.addElement("ccyName", true);
        pluginGeneratedSerialDescriptor.addElement("ccySign", true);
        pluginGeneratedSerialDescriptor.addElement("priceDig", true);
        pluginGeneratedSerialDescriptor.addElement(AppLocaleInfo.KEY_DISPLAY_NAME, true);
        pluginGeneratedSerialDescriptor.addElement("displaySign", true);
    ...
    public final IdxCcyConfig deserialize(@NotNull Decoder decoder) {
        ...
        return new IdxCcyConfig(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull IdxCcyConfig idxCcyConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(idxCcyConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        IdxCcyConfig.write$Self$OKTradeCore_trade_core(idxCcyConfig, compositeEncoderBeginStructure, serialDescriptor);
