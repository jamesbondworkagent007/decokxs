...
public final /* synthetic */ class DcaTriggerParam$$serializer implements GeneratedSerializer<DcaTriggerParam> {
    public static final int $stable;
    public static final DcaTriggerParam$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DcaTriggerParam$$serializer() {
    }
    ...
    static {
        DcaTriggerParam$$serializer dcaTriggerParam$$serializer = new DcaTriggerParam$$serializer();
        INSTANCE = dcaTriggerParam$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.DcaTriggerParam", dcaTriggerParam$$serializer, 10);
        ...
        pluginGeneratedSerialDescriptor.addElement("tholdWarning", true);
    ...
    public final DcaTriggerParam deserialize(@NotNull Decoder decoder) {
        String str;
        int i;
        String str2;
        String str3;
        ...
        return new DcaTriggerParam(i, str10, str6, str, str5, str7, str9, str8, str4, str2, str3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DcaTriggerParam dcaTriggerParam) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dcaTriggerParam, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DcaTriggerParam.write$Self$OKTradeCore_trade_core(dcaTriggerParam, compositeEncoderBeginStructure, serialDescriptor);
