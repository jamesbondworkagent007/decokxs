...
public final /* synthetic */ class RFQCreateLeg$$serializer implements GeneratedSerializer<RFQCreateLeg> {
    public static final int $stable;
    public static final RFQCreateLeg$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RFQCreateLeg$$serializer() {
    }
    ...
    static {
        RFQCreateLeg$$serializer rFQCreateLeg$$serializer = new RFQCreateLeg$$serializer();
        INSTANCE = rFQCreateLeg$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.RFQCreateLeg", rFQCreateLeg$$serializer, 8);
        ...
        pluginGeneratedSerialDescriptor.addElement("lmtPx", true);
    ...
    public final RFQCreateLeg deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new RFQCreateLeg(i, str8, str5, str7, str4, str6, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RFQCreateLeg rFQCreateLeg) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(rFQCreateLeg, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RFQCreateLeg.write$Self$OKTradeCore_trade_core(rFQCreateLeg, compositeEncoderBeginStructure, serialDescriptor);
