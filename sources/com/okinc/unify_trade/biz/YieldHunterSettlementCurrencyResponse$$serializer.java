...
public final /* synthetic */ class YieldHunterSettlementCurrencyResponse$$serializer implements GeneratedSerializer<YieldHunterSettlementCurrencyResponse> {
    public static final int $stable;
    public static final YieldHunterSettlementCurrencyResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private YieldHunterSettlementCurrencyResponse$$serializer() {
    }
    ...
    static {
        YieldHunterSettlementCurrencyResponse$$serializer yieldHunterSettlementCurrencyResponse$$serializer = new YieldHunterSettlementCurrencyResponse$$serializer();
        INSTANCE = yieldHunterSettlementCurrencyResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.YieldHunterSettlementCurrencyResponse", yieldHunterSettlementCurrencyResponse$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("settleCcy", true);
        pluginGeneratedSerialDescriptor.addElement("estAplRatioLow", true);
        pluginGeneratedSerialDescriptor.addElement("estAplRatioHigh", true);
        pluginGeneratedSerialDescriptor.addElement("stkLow", false);
        pluginGeneratedSerialDescriptor.addElement("stkHigh", false);
    ...
    public final YieldHunterSettlementCurrencyResponse deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new YieldHunterSettlementCurrencyResponse(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull YieldHunterSettlementCurrencyResponse yieldHunterSettlementCurrencyResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(yieldHunterSettlementCurrencyResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        YieldHunterSettlementCurrencyResponse.write$Self$OKTradeCore_trade_core(yieldHunterSettlementCurrencyResponse, compositeEncoderBeginStructure, serialDescriptor);
