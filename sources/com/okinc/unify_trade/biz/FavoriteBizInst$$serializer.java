...
public final /* synthetic */ class FavoriteBizInst$$serializer implements GeneratedSerializer<FavoriteBizInst> {
    public static final int $stable;
    public static final FavoriteBizInst$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private FavoriteBizInst$$serializer() {
    }
    ...
    static {
        FavoriteBizInst$$serializer favoriteBizInst$$serializer = new FavoriteBizInst$$serializer();
        INSTANCE = favoriteBizInst$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.FavoriteBizInst", favoriteBizInst$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("SWAP", true);
        pluginGeneratedSerialDescriptor.addElement("MARGIN", true);
        pluginGeneratedSerialDescriptor.addElement("SPOT", true);
        pluginGeneratedSerialDescriptor.addElement("FUTURES", true);
    ...
    public final KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = FavoriteBizInst.$childSerializers;
    ...
    public final FavoriteBizInst deserialize(@NotNull Decoder decoder) {
        int i;
        List list;
        List list2;
        List list3;
        ...
        return new FavoriteBizInst(i, list5, list4, list, list3, list2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull FavoriteBizInst favoriteBizInst) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(favoriteBizInst, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        FavoriteBizInst.write$Self$OKTradeCore_trade_core(favoriteBizInst, compositeEncoderBeginStructure, serialDescriptor);
