...
public final /* synthetic */ class VipLevelItem$$serializer implements GeneratedSerializer<VipLevelItem> {
    public static final int $stable;
    public static final VipLevelItem$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private VipLevelItem$$serializer() {
    }
    ...
    static {
        VipLevelItem$$serializer vipLevelItem$$serializer = new VipLevelItem$$serializer();
        INSTANCE = vipLevelItem$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.VipLevelItem", vipLevelItem$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("coefficient", true);
    ...
    public final VipLevelItem deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new VipLevelItem(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull VipLevelItem vipLevelItem) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(vipLevelItem, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        VipLevelItem.write$Self$OKTradeCore_trade_core(vipLevelItem, compositeEncoderBeginStructure, serialDescriptor);
