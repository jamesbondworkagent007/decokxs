...
public final /* synthetic */ class MPBotBannerCard$$serializer implements GeneratedSerializer<MPBotBannerCard> {
    public static final int $stable;
    public static final MPBotBannerCard$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MPBotBannerCard$$serializer() {
    }
    ...
    static {
        MPBotBannerCard$$serializer mPBotBannerCard$$serializer = new MPBotBannerCard$$serializer();
        INSTANCE = mPBotBannerCard$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.MPBotBannerCard", mPBotBannerCard$$serializer, 4);
        ...
        pluginGeneratedSerialDescriptor.addElement("algoIndexId", true);
    ...
    public final MPBotBannerCard deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new MPBotBannerCard(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MPBotBannerCard mPBotBannerCard) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(mPBotBannerCard, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MPBotBannerCard.write$Self$OKTradeCore_trade_core(mPBotBannerCard, compositeEncoderBeginStructure, serialDescriptor);
