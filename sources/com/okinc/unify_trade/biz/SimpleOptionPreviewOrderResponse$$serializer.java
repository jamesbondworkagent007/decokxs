...
public final /* synthetic */ class SimpleOptionPreviewOrderResponse$$serializer implements GeneratedSerializer<SimpleOptionPreviewOrderResponse> {
    public static final int $stable;
    public static final SimpleOptionPreviewOrderResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SimpleOptionPreviewOrderResponse$$serializer() {
    }
    ...
    static {
        SimpleOptionPreviewOrderResponse$$serializer simpleOptionPreviewOrderResponse$$serializer = new SimpleOptionPreviewOrderResponse$$serializer();
        INSTANCE = simpleOptionPreviewOrderResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.SimpleOptionPreviewOrderResponse", simpleOptionPreviewOrderResponse$$serializer, 7);
        ...
        pluginGeneratedSerialDescriptor.addElement("estCost", true);
    ...
    public final SimpleOptionPreviewOrderResponse deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new SimpleOptionPreviewOrderResponse(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SimpleOptionPreviewOrderResponse simpleOptionPreviewOrderResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(simpleOptionPreviewOrderResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SimpleOptionPreviewOrderResponse.write$Self$OKTradeCore_trade_core(simpleOptionPreviewOrderResponse, compositeEncoderBeginStructure, serialDescriptor);
