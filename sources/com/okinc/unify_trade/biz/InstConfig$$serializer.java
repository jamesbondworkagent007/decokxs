...
public final /* synthetic */ class InstConfig$$serializer implements GeneratedSerializer<InstConfig> {
    public static final int $stable;
    public static final InstConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InstConfig$$serializer() {
    }
    ...
    static {
        InstConfig$$serializer instConfig$$serializer = new InstConfig$$serializer();
        INSTANCE = instConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.InstConfig", instConfig$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("instId", true);
        pluginGeneratedSerialDescriptor.addElement("leverLow", true);
        pluginGeneratedSerialDescriptor.addElement("leverHigh", true);
        pluginGeneratedSerialDescriptor.addElement("leverSuggested", true);
        pluginGeneratedSerialDescriptor.addElement("leverSuggestedHig", true);
        pluginGeneratedSerialDescriptor.addElement("leverPercents", true);
        pluginGeneratedSerialDescriptor.addElement("leverSuggestedHigh", true);
    ...
    public final InstConfig deserialize(@NotNull Decoder decoder) {
        ...
        return new InstConfig(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InstConfig instConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(instConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InstConfig.write$Self$OKTradeCore_trade_core(instConfig, compositeEncoderBeginStructure, serialDescriptor);
