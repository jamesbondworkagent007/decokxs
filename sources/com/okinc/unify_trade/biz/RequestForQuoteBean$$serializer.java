...
public final /* synthetic */ class RequestForQuoteBean$$serializer implements GeneratedSerializer<RequestForQuoteBean> {
    public static final int $stable;
    public static final RequestForQuoteBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private RequestForQuoteBean$$serializer() {
    }
    ...
    static {
        RequestForQuoteBean$$serializer requestForQuoteBean$$serializer = new RequestForQuoteBean$$serializer();
        INSTANCE = requestForQuoteBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.RequestForQuoteBean", requestForQuoteBean$$serializer, 10);
        pluginGeneratedSerialDescriptor.addElement("alternativeCurrency", true);
        pluginGeneratedSerialDescriptor.addElement(CoreNetworkModuleKt.KEY_CLIENT_ID, true);
    ...
    public final RequestForQuoteBean deserialize(@NotNull Decoder decoder) {
        String str;
        int i;
        String str2;
        String str3;
        ...
        return new RequestForQuoteBean(i, str10, str6, str, str5, str7, str9, str8, str4, str2, str3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull RequestForQuoteBean requestForQuoteBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(requestForQuoteBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        RequestForQuoteBean.write$Self$OKTradeCore_trade_core(requestForQuoteBean, compositeEncoderBeginStructure, serialDescriptor);
