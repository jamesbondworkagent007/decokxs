...
public final /* synthetic */ class TriggerStrategyOrderReq$$serializer implements GeneratedSerializer<TriggerStrategyOrderReq> {
    public static final int $stable;
    public static final TriggerStrategyOrderReq$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private TriggerStrategyOrderReq$$serializer() {
    }
    ...
    static {
        TriggerStrategyOrderReq$$serializer triggerStrategyOrderReq$$serializer = new TriggerStrategyOrderReq$$serializer();
        INSTANCE = triggerStrategyOrderReq$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.TriggerStrategyOrderReq", triggerStrategyOrderReq$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("triggerPx", false);
        pluginGeneratedSerialDescriptor.addElement("orderPx", false);
    ...
    public final TriggerStrategyOrderReq deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new TriggerStrategyOrderReq(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull TriggerStrategyOrderReq triggerStrategyOrderReq) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(triggerStrategyOrderReq, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        TriggerStrategyOrderReq.write$Self$OKTradeCore_trade_core(triggerStrategyOrderReq, compositeEncoderBeginStructure, serialDescriptor);
