...
public final /* synthetic */ class AccountModePreCheckPosData$$serializer implements GeneratedSerializer<AccountModePreCheckPosData> {
    public static final int $stable;
    public static final AccountModePreCheckPosData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private AccountModePreCheckPosData$$serializer() {
    }
    ...
    static {
        AccountModePreCheckPosData$$serializer accountModePreCheckPosData$$serializer = new AccountModePreCheckPosData$$serializer();
        INSTANCE = accountModePreCheckPosData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.AccountModePreCheckPosData", accountModePreCheckPosData$$serializer, 3);
    ...
    public final AccountModePreCheckPosData deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new AccountModePreCheckPosData(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull AccountModePreCheckPosData accountModePreCheckPosData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(accountModePreCheckPosData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        AccountModePreCheckPosData.write$Self$OKTradeCore_trade_core(accountModePreCheckPosData, compositeEncoderBeginStructure, serialDescriptor);
