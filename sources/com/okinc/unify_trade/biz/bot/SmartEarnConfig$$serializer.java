...
public final /* synthetic */ class SmartEarnConfig$$serializer implements GeneratedSerializer<SmartEarnConfig> {
    public static final int $stable;
    public static final SmartEarnConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SmartEarnConfig$$serializer() {
    }
    ...
    static {
        SmartEarnConfig$$serializer smartEarnConfig$$serializer = new SmartEarnConfig$$serializer();
        INSTANCE = smartEarnConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.bot.SmartEarnConfig", smartEarnConfig$$serializer, 10);
        pluginGeneratedSerialDescriptor.addElement("distanceLimit", true);
        pluginGeneratedSerialDescriptor.addElement("minRangeLimit", true);
        pluginGeneratedSerialDescriptor.addElement("maxRangeLimit", true);
        pluginGeneratedSerialDescriptor.addElement("minGridNum", true);
        pluginGeneratedSerialDescriptor.addElement("defaultMinRange", true);
        pluginGeneratedSerialDescriptor.addElement("defaultMaxRange", true);
        pluginGeneratedSerialDescriptor.addElement("earnSupport", true);
        pluginGeneratedSerialDescriptor.addElement("wideDistanceLimit", true);
        pluginGeneratedSerialDescriptor.addElement("wideMinRangeLimit", true);
        pluginGeneratedSerialDescriptor.addElement("wideMaxRangeLimit", true);
    ...
    public final SmartEarnConfig deserialize(@NotNull Decoder decoder) {
        ...
        return new SmartEarnConfig(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SmartEarnConfig smartEarnConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(smartEarnConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SmartEarnConfig.write$Self$OKTradeCore_trade_core(smartEarnConfig, compositeEncoderBeginStructure, serialDescriptor);
