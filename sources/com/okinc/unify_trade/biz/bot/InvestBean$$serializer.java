...
public final /* synthetic */ class InvestBean$$serializer implements GeneratedSerializer<InvestBean> {
    public static final int $stable;
    public static final InvestBean$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InvestBean$$serializer() {
    }
    ...
    static {
        InvestBean$$serializer investBean$$serializer = new InvestBean$$serializer();
        INSTANCE = investBean$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.bot.InvestBean", investBean$$serializer, 4);
        ...
        pluginGeneratedSerialDescriptor.addElement("capitalSz", true);
    ...
    public final InvestBean deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new InvestBean(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InvestBean investBean) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(investBean, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InvestBean.write$Self$OKTradeCore_trade_core(investBean, compositeEncoderBeginStructure, serialDescriptor);
