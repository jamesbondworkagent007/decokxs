...
public final /* synthetic */ class BalanceDetailInfoDto$$serializer implements GeneratedSerializer<BalanceDetailInfoDto> {
    public static final int $stable;
    public static final BalanceDetailInfoDto$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BalanceDetailInfoDto$$serializer() {
    }
    ...
    static {
        BalanceDetailInfoDto$$serializer balanceDetailInfoDto$$serializer = new BalanceDetailInfoDto$$serializer();
        INSTANCE = balanceDetailInfoDto$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.bot.BalanceDetailInfoDto", balanceDetailInfoDto$$serializer, 10);
        pluginGeneratedSerialDescriptor.addElement("accGridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("curGridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("displayCurGridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("displayAccGridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("withdrawnGridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("frozenGridProfit", true);
        pluginGeneratedSerialDescriptor.addElement("withdrawnMargin", true);
        pluginGeneratedSerialDescriptor.addElement("extraMargin", true);
        pluginGeneratedSerialDescriptor.addElement("actualMargin", true);
        pluginGeneratedSerialDescriptor.addElement("assetInBot", true);
    ...
    public final BalanceDetailInfoDto deserialize(@NotNull Decoder decoder) {
        ...
        return new BalanceDetailInfoDto(i, str8, str6, str4, strDecodeStringElement, str2, str3, str5, str7, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BalanceDetailInfoDto balanceDetailInfoDto) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(balanceDetailInfoDto, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BalanceDetailInfoDto.write$Self$OKTradeCore_trade_core(balanceDetailInfoDto, compositeEncoderBeginStructure, serialDescriptor);
