...
public final /* synthetic */ class Portfolio$$serializer implements GeneratedSerializer<Portfolio> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.bot.Portfolio", portfolio$$serializer, 2);
    ...
    public final Portfolio deserialize(@NotNull Decoder decoder) {
        ...
        return new Portfolio(i, strDecodeStringElement, strDecodeStringElement2, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Portfolio portfolio) {
        ...
        Portfolio.write$Self$OKTradeCore_trade_core(portfolio, compositeEncoderBeginStructure, serialDescriptor);
