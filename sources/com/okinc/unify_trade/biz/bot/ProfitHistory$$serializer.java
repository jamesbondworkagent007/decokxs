...
public final /* synthetic */ class ProfitHistory$$serializer implements GeneratedSerializer<ProfitHistory> {
    public static final int $stable;
    public static final ProfitHistory$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ProfitHistory$$serializer() {
    }
    ...
    static {
        ProfitHistory$$serializer profitHistory$$serializer = new ProfitHistory$$serializer();
        INSTANCE = profitHistory$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.bot.ProfitHistory", profitHistory$$serializer, 4);
    ...
    public final ProfitHistory deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new ProfitHistory(i, str4, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ProfitHistory profitHistory) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(profitHistory, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ProfitHistory.write$Self$OKTradeCore_trade_core(profitHistory, compositeEncoderBeginStructure, serialDescriptor);
