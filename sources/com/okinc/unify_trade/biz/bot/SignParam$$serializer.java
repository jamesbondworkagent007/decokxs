...
public final /* synthetic */ class SignParam$$serializer implements GeneratedSerializer<SignParam> {
    public static final int $stable;
    public static final SignParam$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SignParam$$serializer() {
    }
    ...
    static {
        SignParam$$serializer signParam$$serializer = new SignParam$$serializer();
        INSTANCE = signParam$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.bot.SignParam", signParam$$serializer, 12);
    ...
    public final SignParam deserialize(@NotNull Decoder decoder) {
        ...
        return new SignParam(i, str2, str4, str6, str9, str11, str10, str8, str5, str7, str3, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SignParam signParam) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(signParam, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SignParam.write$Self$OKTradeCore_trade_core(signParam, compositeEncoderBeginStructure, serialDescriptor);
