...
public final /* synthetic */ class AverageRate$$serializer implements GeneratedSerializer<AverageRate> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.AverageRate", averageRate$$serializer, 3);
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull AverageRate averageRate) {
        ...
        AverageRate.write$Self$OKTradeCore_trade_core(averageRate, compositeEncoderBeginStructure, serialDescriptor);
