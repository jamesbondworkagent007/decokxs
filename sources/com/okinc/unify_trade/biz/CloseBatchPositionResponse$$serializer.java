...
public final /* synthetic */ class CloseBatchPositionResponse$$serializer implements GeneratedSerializer<CloseBatchPositionResponse> {
    public static final int $stable;
    public static final CloseBatchPositionResponse$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private CloseBatchPositionResponse$$serializer() {
    }
    ...
    static {
        CloseBatchPositionResponse$$serializer closeBatchPositionResponse$$serializer = new CloseBatchPositionResponse$$serializer();
        INSTANCE = closeBatchPositionResponse$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.CloseBatchPositionResponse", closeBatchPositionResponse$$serializer, 8);
    ...
    public final CloseBatchPositionResponse deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new CloseBatchPositionResponse(i, str8, str5, str7, str4, str6, str3, str2, str, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull CloseBatchPositionResponse closeBatchPositionResponse) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(closeBatchPositionResponse, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        CloseBatchPositionResponse.write$Self$OKTradeCore_trade_core(closeBatchPositionResponse, compositeEncoderBeginStructure, serialDescriptor);
