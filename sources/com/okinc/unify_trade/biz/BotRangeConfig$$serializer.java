...
public final /* synthetic */ class BotRangeConfig$$serializer implements GeneratedSerializer<BotRangeConfig> {
    public static final int $stable;
    public static final BotRangeConfig$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private BotRangeConfig$$serializer() {
    }
    ...
    static {
        BotRangeConfig$$serializer botRangeConfig$$serializer = new BotRangeConfig$$serializer();
        INSTANCE = botRangeConfig$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.BotRangeConfig", botRangeConfig$$serializer, 6);
        ...
        pluginGeneratedSerialDescriptor.addElement("maxLongFuture", true);
        pluginGeneratedSerialDescriptor.addElement("maxMultiplier", true);
    ...
    public final BotRangeConfig deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new BotRangeConfig(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull BotRangeConfig botRangeConfig) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(botRangeConfig, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        BotRangeConfig.write$Self$OKTradeCore_trade_core(botRangeConfig, compositeEncoderBeginStructure, serialDescriptor);
