...
public final /* synthetic */ class LoanInterestBasic$$serializer implements GeneratedSerializer<LoanInterestBasic> {
    public static final int $stable;
    public static final LoanInterestBasic$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private LoanInterestBasic$$serializer() {
    }
    ...
    static {
        LoanInterestBasic$$serializer loanInterestBasic$$serializer = new LoanInterestBasic$$serializer();
        INSTANCE = loanInterestBasic$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.LoanInterestBasic", loanInterestBasic$$serializer, 7);
    ...
    public final LoanInterestBasic deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new LoanInterestBasic(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull LoanInterestBasic loanInterestBasic) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(loanInterestBasic, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        LoanInterestBasic.write$Self$OKTradeCore_trade_core(loanInterestBasic, compositeEncoderBeginStructure, serialDescriptor);
