...
public final /* synthetic */ class MarketLendingData$$serializer implements GeneratedSerializer<MarketLendingData> {
    public static final int $stable;
    public static final MarketLendingData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MarketLendingData$$serializer() {
    }
    ...
    static {
        MarketLendingData$$serializer marketLendingData$$serializer = new MarketLendingData$$serializer();
        INSTANCE = marketLendingData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.MarketLendingData", marketLendingData$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("avgBorrowAmt", false);
        pluginGeneratedSerialDescriptor.addElement("avgBorrowAmtInUSD", false);
        pluginGeneratedSerialDescriptor.addElement("avgRate", false);
        pluginGeneratedSerialDescriptor.addElement("currencyId", false);
        pluginGeneratedSerialDescriptor.addElement("currencyName", true);
        pluginGeneratedSerialDescriptor.addElement("estimatedRate", false);
        pluginGeneratedSerialDescriptor.addElement("preRate", false);
    ...
    public final MarketLendingData deserialize(@NotNull Decoder decoder) {
        ...
        return new MarketLendingData(i, str2, str4, str6, str3, str5, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MarketLendingData marketLendingData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(marketLendingData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MarketLendingData.write$Self$OKTradeCore_trade_core(marketLendingData, compositeEncoderBeginStructure, serialDescriptor);
