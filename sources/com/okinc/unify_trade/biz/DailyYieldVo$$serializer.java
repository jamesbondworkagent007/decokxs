...
public final /* synthetic */ class DailyYieldVo$$serializer implements GeneratedSerializer<DailyYieldVo> {
    public static final int $stable;
    public static final DailyYieldVo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DailyYieldVo$$serializer() {
    }
    ...
    static {
        DailyYieldVo$$serializer dailyYieldVo$$serializer = new DailyYieldVo$$serializer();
        INSTANCE = dailyYieldVo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.DailyYieldVo", dailyYieldVo$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("totalDailyYield", true);
        pluginGeneratedSerialDescriptor.addElement("arbDailyYield", true);
        pluginGeneratedSerialDescriptor.addElement("stakingDailyYield", true);
        pluginGeneratedSerialDescriptor.addElement("debitDailyRate", true);
    ...
    public final DailyYieldVo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new DailyYieldVo(i, str5, str4, str, str3, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DailyYieldVo dailyYieldVo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dailyYieldVo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DailyYieldVo.write$Self$OKTradeCore_trade_core(dailyYieldVo, compositeEncoderBeginStructure, serialDescriptor);
