...
public final /* synthetic */ class ArbitrageCostVo$$serializer implements GeneratedSerializer<ArbitrageCostVo> {
    public static final int $stable;
    public static final ArbitrageCostVo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ArbitrageCostVo$$serializer() {
    }
    ...
    static {
        ArbitrageCostVo$$serializer arbitrageCostVo$$serializer = new ArbitrageCostVo$$serializer();
        INSTANCE = arbitrageCostVo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.biz.ArbitrageCostVo", arbitrageCostVo$$serializer, 7);
        pluginGeneratedSerialDescriptor.addElement("openSpreadRatio", true);
        pluginGeneratedSerialDescriptor.addElement("closeSpreadRatio", true);
        pluginGeneratedSerialDescriptor.addElement("spotFeeRatio", true);
        pluginGeneratedSerialDescriptor.addElement("swapFeeRatio", true);
        pluginGeneratedSerialDescriptor.addElement("fundUtilizationRatio", true);
        pluginGeneratedSerialDescriptor.addElement("totalCostRatio", true);
        pluginGeneratedSerialDescriptor.addElement("totalCostQuoteAmount", true);
    ...
    public final ArbitrageCostVo deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new ArbitrageCostVo(i, str6, str7, str4, str5, str3, str2, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ArbitrageCostVo arbitrageCostVo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(arbitrageCostVo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ArbitrageCostVo.write$Self$OKTradeCore_trade_core(arbitrageCostVo, compositeEncoderBeginStructure, serialDescriptor);
