...
public final class TradeInitJob$marketEnsureOKTradeResume$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public TradeInitJob$marketEnsureOKTradeResume$2(yHT<? super Boolean, ? super InterfaceC54581xNr, ? super Exception, ? super Continuation<? super Unit>, ? extends Object> yht, C54588xNy c54588xNy, Continuation<? super TradeInitJob$marketEnsureOKTradeResume$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TradeInitJob$marketEnsureOKTradeResume$2(this.$invokeCallBack, this.$config, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TradeInitJob$marketEnsureOKTradeResume$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
