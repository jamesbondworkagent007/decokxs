...
public final /* synthetic */ class OKTDexQuoteCoinModel$$serializer implements GeneratedSerializer<OKTDexQuoteCoinModel> {
    public static final int $stable;
    public static final OKTDexQuoteCoinModel$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private OKTDexQuoteCoinModel$$serializer() {
    }
    ...
    static {
        OKTDexQuoteCoinModel$$serializer oKTDexQuoteCoinModel$$serializer = new OKTDexQuoteCoinModel$$serializer();
        INSTANCE = oKTDexQuoteCoinModel$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.dex.biz.data.OKTDexQuoteCoinModel", oKTDexQuoteCoinModel$$serializer, 9);
        pluginGeneratedSerialDescriptor.addElement("symbol", true);
        pluginGeneratedSerialDescriptor.addElement("name", true);
        pluginGeneratedSerialDescriptor.addElement("buyStatus", true);
        pluginGeneratedSerialDescriptor.addElement("sellStatus", true);
        ...
        pluginGeneratedSerialDescriptor.addElement("supportTradeWith", true);
    ...
    public final OKTDexQuoteCoinModel deserialize(@NotNull Decoder decoder) {
        ...
        return new OKTDexQuoteCoinModel(i, str6, str4, str2, str, strDecodeStringElement, str3, str5, strDecodeStringElement2, strDecodeStringElement3, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull OKTDexQuoteCoinModel oKTDexQuoteCoinModel) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(oKTDexQuoteCoinModel, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        OKTDexQuoteCoinModel.write$Self$OKTradeCore_trade_core(oKTDexQuoteCoinModel, compositeEncoderBeginStructure, serialDescriptor);
