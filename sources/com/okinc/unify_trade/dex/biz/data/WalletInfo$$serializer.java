...
public final /* synthetic */ class WalletInfo$$serializer implements GeneratedSerializer<WalletInfo> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.dex.biz.data.WalletInfo", walletInfo$$serializer, 2);
    ...
    public final WalletInfo deserialize(@NotNull Decoder decoder) {
        ...
        return new WalletInfo(i, strDecodeStringElement, strDecodeStringElement2, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull WalletInfo walletInfo) {
        ...
        WalletInfo.write$Self$OKTradeCore_trade_core(walletInfo, compositeEncoderBeginStructure, serialDescriptor);
