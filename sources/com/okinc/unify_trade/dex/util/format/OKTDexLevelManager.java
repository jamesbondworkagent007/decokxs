package com.okinc.unify_trade.dex.util.format;
...
public final class OKTDexLevelManager {
    public static final OKTDexLevelManager EZpvd = new OKTDexLevelManager();

    private OKTDexLevelManager() {
    }

    public final Triple<String, String, BigLevel> copydefault(@NotNull String str, @NotNull String str2, boolean z) {
    ...
    public final Triple<String, String, BigLevel> AEQbTJ(@NotNull String str, @NotNull String str2) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        xHM.copydefault(str, str2);
    ...
    public final Triple<String, String, BigLevel> KWHzl(@NotNull String str, @NotNull String str2) {
        ...
        Intrinsics.checkNotNullParameter(str2, "");
        xHM.copydefault(str, str2);
        String strEZpvd = xHN.EZpvd(str);
        if (xHM.OLrzqt(strEZpvd, 1000)) {
            return new Triple<>(str, str2, BigLevel.NORMAL);
        }
        if (xHM.EZpvd(strEZpvd, 1000) & xHM.OLrzqt(strEZpvd, 1000000)) {
            return new Triple<>(xHM.divCheckS$default(str, 1000, Integer.valueOf(C33129mqd.AhwBna("18")), Boolean.FALSE, null, 8, null), "2", BigLevel.THOUSANDS);
        }
        if (xHM.EZpvd(strEZpvd, 1000000) & xHM.OLrzqt(strEZpvd, 1000000000)) {
            return new Triple<>(xHM.divCheckS$default(str, 1000000, Integer.valueOf(C33129mqd.AhwBna("18")), Boolean.FALSE, null, 8, null), "2", BigLevel.MILLION);
        }
        return new Triple<>(xHM.divCheckS$default(str, 1000000000, Integer.valueOf(C33129mqd.AhwBna("18")), Boolean.FALSE, null, 8, null), "2", BigLevel.BILLION);
    }
