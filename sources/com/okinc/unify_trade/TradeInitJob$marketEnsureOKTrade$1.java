...
public final class TradeInitJob$marketEnsureOKTrade$1 extends SuspendLambda implements yHT<Boolean, InterfaceC54581xNr, Exception, Continuation<? super Unit>, Object> {
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public TradeInitJob$marketEnsureOKTrade$1(Continuation<? super TradeInitJob$marketEnsureOKTrade$1> continuation) {
    ...
    public final Object invoke(boolean z, InterfaceC54581xNr interfaceC54581xNr, Exception exc, Continuation<? super Unit> continuation) {
        return new TradeInitJob$marketEnsureOKTrade$1(continuation).invokeSuspend(Unit.INSTANCE);
    }
