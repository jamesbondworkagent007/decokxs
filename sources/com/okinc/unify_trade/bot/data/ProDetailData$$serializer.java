...
public final /* synthetic */ class ProDetailData$$serializer implements GeneratedSerializer<ProDetailData> {
    public static final int $stable;
    public static final ProDetailData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ProDetailData$$serializer() {
    }
    ...
    static {
        ProDetailData$$serializer proDetailData$$serializer = new ProDetailData$$serializer();
        INSTANCE = proDetailData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.unify_trade.bot.data.ProDetailData", proDetailData$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("title", false);
        pluginGeneratedSerialDescriptor.addElement("firstContent", true);
        pluginGeneratedSerialDescriptor.addElement("secondContent", true);
        pluginGeneratedSerialDescriptor.addElement("doubtMsg", true);
        pluginGeneratedSerialDescriptor.addElement("learnMore", true);
    ...
    public final ProDetailData deserialize(@NotNull Decoder decoder) {
        ...
        return new ProDetailData(i, str4, str2, strDecodeStringElement, str3, str, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ProDetailData proDetailData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(proDetailData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ProDetailData.write$Self$OKTradeCore_trade_core(proDetailData, compositeEncoderBeginStructure, serialDescriptor);
