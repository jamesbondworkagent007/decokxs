...
public final class DefaultKlineDrawLineDelegate$useLocalDrawingData$1$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DefaultKlineDrawLineDelegate$useLocalDrawingData$1$1$2(Ref.ObjectRef<ArrayList<DrawLineData.DrawLineItem>> objectRef, C39295ppc c39295ppc, C36250oUv c36250oUv, Continuation<? super DefaultKlineDrawLineDelegate$useLocalDrawingData$1$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DefaultKlineDrawLineDelegate$useLocalDrawingData$1$1$2(this.$allList, this.this$0, this.$chartView, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((DefaultKlineDrawLineDelegate$useLocalDrawingData$1$1$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
