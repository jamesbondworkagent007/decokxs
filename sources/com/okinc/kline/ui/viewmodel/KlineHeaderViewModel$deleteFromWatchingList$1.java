...
public final class KlineHeaderViewModel$deleteFromWatchingList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineHeaderViewModel$deleteFromWatchingList$1(KlineHeaderViewModel klineHeaderViewModel, WatchListData watchListData, Continuation<? super KlineHeaderViewModel$deleteFromWatchingList$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        KlineHeaderViewModel$deleteFromWatchingList$1 klineHeaderViewModel$deleteFromWatchingList$1 = new KlineHeaderViewModel$deleteFromWatchingList$1(this.this$0, this.$data, continuation);
        klineHeaderViewModel$deleteFromWatchingList$1.L$0 = obj;
        return klineHeaderViewModel$deleteFromWatchingList$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineHeaderViewModel$deleteFromWatchingList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                if (i != 2) {
                    ...
                    C56391yDq.AEQbTJ(obj);
                    pUU.copydefault("KlineHeaderViewModel", "deleteFromWatchingList failed: " + th);
