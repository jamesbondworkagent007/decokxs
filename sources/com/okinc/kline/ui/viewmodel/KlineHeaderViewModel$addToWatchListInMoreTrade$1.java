...
public final class KlineHeaderViewModel$addToWatchListInMoreTrade$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineHeaderViewModel$addToWatchListInMoreTrade$1(KlineHeaderViewModel klineHeaderViewModel, WatchListData watchListData, String str, Continuation<? super KlineHeaderViewModel$addToWatchListInMoreTrade$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        KlineHeaderViewModel$addToWatchListInMoreTrade$1 klineHeaderViewModel$addToWatchListInMoreTrade$1 = new KlineHeaderViewModel$addToWatchListInMoreTrade$1(this.this$0, this.$data, this.$instId, continuation);
        klineHeaderViewModel$addToWatchListInMoreTrade$1.L$0 = obj;
        return klineHeaderViewModel$addToWatchListInMoreTrade$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineHeaderViewModel$addToWatchListInMoreTrade$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (interfaceC40387qTz.OLrzqt(watchListData, this) == objCopydefault) {
            ...
            if (i != 1) {
                if (i != 2 && i != 3) {
                    ...
                    C56391yDq.AEQbTJ(obj);
                    pUU.copydefault("KlineHeaderViewModel", "addToWatchListInMoreTrade failed: " + th);
