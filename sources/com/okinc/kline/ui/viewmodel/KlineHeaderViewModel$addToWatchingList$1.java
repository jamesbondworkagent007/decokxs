...
public final class KlineHeaderViewModel$addToWatchingList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineHeaderViewModel$addToWatchingList$1(KlineHeaderViewModel klineHeaderViewModel, WatchListData watchListData, Continuation<? super KlineHeaderViewModel$addToWatchingList$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        KlineHeaderViewModel$addToWatchingList$1 klineHeaderViewModel$addToWatchingList$1 = new KlineHeaderViewModel$addToWatchingList$1(this.this$0, this.$data, continuation);
        klineHeaderViewModel$addToWatchingList$1.L$0 = obj;
        return klineHeaderViewModel$addToWatchingList$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineHeaderViewModel$addToWatchingList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                if (i != 2) {
                    ...
                    C56391yDq.AEQbTJ(obj);
                    pUU.copydefault("KlineHeaderViewModel", "addToWatchingList failed: " + th);
                ...
                if (thM7380exceptionOrNullimpl != null) {
                    MutableSharedFlow mutableSharedFlow = klineHeaderViewModel2.AEQbTJ;
