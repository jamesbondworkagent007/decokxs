...
public final class BaseKlineFragment$onResume$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ oYA this$0;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseKlineFragment$onResume$1(oYA oya, Continuation<? super BaseKlineFragment$onResume$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BaseKlineFragment$onResume$1(this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BaseKlineFragment$onResume$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (Result.m7384isSuccessimpl(objM8790ensureInitialize0E7RQCE$default)) {
            ...
            pUU.copydefault(this.this$0.getTAG(), "onResume : ensureInitialize 失败");
            this.this$0.gwTjWJ();
        }
