...
public final class KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$3(Ref.ObjectRef<ArrayList<DrawLineData.DrawLineItem>> objectRef, KlineQuoteDataComponent klineQuoteDataComponent, Continuation<? super KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$3(this.$allList, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
