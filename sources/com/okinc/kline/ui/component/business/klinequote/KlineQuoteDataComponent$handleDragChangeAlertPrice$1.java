...
public final class KlineQuoteDataComponent$handleDragChangeAlertPrice$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ PriceWarningItemBean $priceWarningItemBean;
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KlineQuoteDataComponent$handleDragChangeAlertPrice$1(PriceWarningItemBean priceWarningItemBean, Continuation<? super KlineQuoteDataComponent$handleDragChangeAlertPrice$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KlineQuoteDataComponent$handleDragChangeAlertPrice$1(this.$priceWarningItemBean, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineQuoteDataComponent$handleDragChangeAlertPrice$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: com.okinc.kline.ui.component.business.klinequote.KlineQuoteDataComponent$handleDragChangeAlertPrice$1$1, reason: invalid class name */
