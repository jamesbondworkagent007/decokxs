...
public final class KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$2(Ref.ObjectRef<ArrayList<DrawLineData.DrawLineItem>> objectRef, KlineQuoteDataComponent klineQuoteDataComponent, Continuation<? super KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$2(this.$allList, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((KlineQuoteDataComponent$useLocalDrawgingData$1$1$1$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        objectRef.element = t;
        this.this$0.values().OLrzqt(this.$allList.element);
