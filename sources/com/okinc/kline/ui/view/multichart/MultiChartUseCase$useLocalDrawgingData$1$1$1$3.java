...
public final class MultiChartUseCase$useLocalDrawgingData$1$1$1$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public MultiChartUseCase$useLocalDrawgingData$1$1$1$3(Ref.ObjectRef<ArrayList<DrawLineData.DrawLineItem>> objectRef, pAR par, Continuation<? super MultiChartUseCase$useLocalDrawgingData$1$1$1$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MultiChartUseCase$useLocalDrawgingData$1$1$1$3(this.$allList, this.this$0, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MultiChartUseCase$useLocalDrawgingData$1$1$1$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
