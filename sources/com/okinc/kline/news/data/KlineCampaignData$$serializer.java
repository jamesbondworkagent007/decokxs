...
public final /* synthetic */ class KlineCampaignData$$serializer implements GeneratedSerializer<KlineCampaignData> {
    public static final int $stable;
    public static final KlineCampaignData$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private KlineCampaignData$$serializer() {
    }
    ...
    static {
        KlineCampaignData$$serializer klineCampaignData$$serializer = new KlineCampaignData$$serializer();
        INSTANCE = klineCampaignData$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.kline.news.data.KlineCampaignData", klineCampaignData$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("activeId", true);
        pluginGeneratedSerialDescriptor.addElement("urlSlug", true);
        pluginGeneratedSerialDescriptor.addElement("language", true);
        pluginGeneratedSerialDescriptor.addElement("seoTitle", true);
        pluginGeneratedSerialDescriptor.addElement("seoDescription", true);
        pluginGeneratedSerialDescriptor.addElement("flashType", true);
    ...
    public final KlineCampaignData deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new KlineCampaignData(i, str3, str5, str, str6, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull KlineCampaignData klineCampaignData) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(klineCampaignData, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        KlineCampaignData.write$Self$OKKLine_kline_impl(klineCampaignData, compositeEncoderBeginStructure, serialDescriptor);
