...
public final /* synthetic */ class PaymentMethod$$serializer implements GeneratedSerializer<PaymentMethod> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okx.paymentapi.presentation.PaymentMethod", paymentMethod$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("paymentMethodName", false);
        pluginGeneratedSerialDescriptor.addElement("iconUrl", false);
        pluginGeneratedSerialDescriptor.addElement("iconUrlNight", false);
    ...
    public final PaymentMethod deserialize(@NotNull Decoder decoder) {
        ...
        return new PaymentMethod(i, str, str2, strDecodeStringElement, null);
    }
