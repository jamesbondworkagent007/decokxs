...
public final /* synthetic */ class DimBody$$serializer implements GeneratedSerializer<DimBody> {
    public static final int $stable;
    public static final DimBody$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private DimBody$$serializer() {
    }
    ...
    static {
        DimBody$$serializer dimBody$$serializer = new DimBody$$serializer();
        INSTANCE = dimBody$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okrisk.service.DimBody", dimBody$$serializer, 5);
    ...
    public final DimBody deserialize(@NotNull Decoder decoder) {
        String str;
        ...
        return new DimBody(i, str, str3, str2, iDecodeIntElement, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull DimBody dimBody) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(dimBody, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        DimBody.write$Self$OKRiskLibrary_okrisk_impl(dimBody, compositeEncoderBeginStructure, serialDescriptor);
