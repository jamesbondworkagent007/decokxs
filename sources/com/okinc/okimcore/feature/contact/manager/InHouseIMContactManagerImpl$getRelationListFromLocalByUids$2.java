...
public final class InHouseIMContactManagerImpl$getRelationListFromLocalByUids$2 extends SuspendLambda implements Function2<Set<? extends String>, Continuation<? super List<? extends ContactWithPhoneData>>, Object> {
    int I$0;
    int I$1;
    int I$2;
    long J$0;
    ...
    public InHouseIMContactManagerImpl$getRelationListFromLocalByUids$2(C44176sGc c44176sGc, Continuation<? super InHouseIMContactManagerImpl$getRelationListFromLocalByUids$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        InHouseIMContactManagerImpl$getRelationListFromLocalByUids$2 inHouseIMContactManagerImpl$getRelationListFromLocalByUids$2 = new InHouseIMContactManagerImpl$getRelationListFromLocalByUids$2(this.this$0, continuation);
        inHouseIMContactManagerImpl$getRelationListFromLocalByUids$2.L$0 = obj;
        return inHouseIMContactManagerImpl$getRelationListFromLocalByUids$2;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX DEBUG: Method arguments types fixed to match base method, original types: [java.lang.Object, java.lang.Object] */
    @Override // kotlin.jvm.functions.Function2
    public /* bridge */ /* synthetic */ Object invoke(Set<? extends String> set, Continuation<? super List<? extends ContactWithPhoneData>> continuation) {
        return invoke2((Set<String>) set, (Continuation<? super List<ContactWithPhoneData>>) continuation);
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
    public final Object invoke2(Set<String> set, Continuation<? super List<ContactWithPhoneData>> continuation) {
        return ((InHouseIMContactManagerImpl$getRelationListFromLocalByUids$2) create(set, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        try {
            if (i7 != 0) {
                ...
                if (i2 >= i) {
                    ...
                    this.J$0 = jNanoTime;
                    this.label = i8;
                    Object relationListFromLocalByUids = inHouseIMContactDaoKWHzl.getRelationListFromLocalByUids(set, this);
            ...
            InHouseIMContactDao inHouseIMContactDaoKWHzl2 = this.this$0.KWHzl();
            C44176sGc c44176sGc3 = this.this$0;
