...
public final class PhoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2 extends SuspendLambda implements Function2<Set<? extends String>, Continuation<? super List<? extends PhoneRelationEntity>>, Object> {
    int I$0;
    int I$1;
    int I$2;
    long J$0;
    ...
    public PhoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2(C44358sMw c44358sMw, Continuation<? super PhoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        PhoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2 phoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2 = new PhoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2(this.this$0, continuation);
        phoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2.L$0 = obj;
        return phoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2;
    }
    ...
    public final Object invoke2(Set<String> set, Continuation<? super List<PhoneRelationEntity>> continuation) {
        return ((PhoneRelationEntityRepository$getPhoneRelationsNoOkxRelationByHashes$2) create(set, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        try {
            if (i7 != 0) {
                ...
                if (i2 >= i) {
                    ...
                    this.J$0 = jNanoTime;
                    this.label = i8;
                    Object phoneRelationsNoOkxRelationByHashes = phoneRelationEntityDaoEZpvd.getPhoneRelationsNoOkxRelationByHashes(set, this);
                    ...
                    i5 = i;
                    i6 = i2;
                    t = phoneRelationsNoOkxRelationByHashes;
                    try {
