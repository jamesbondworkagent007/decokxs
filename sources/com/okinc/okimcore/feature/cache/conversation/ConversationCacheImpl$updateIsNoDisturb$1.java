...
public final class ConversationCacheImpl$updateIsNoDisturb$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ConversationCacheImpl$updateIsNoDisturb$1(sFN sfn, String str, boolean z, Continuation<? super ConversationCacheImpl$updateIsNoDisturb$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ConversationCacheImpl$updateIsNoDisturb$1(this.this$0, this.$targetId, this.$isNoDisturb, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ConversationCacheImpl$updateIsNoDisturb$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX DEBUG: Duplicate block (B:63:0x0180) to fix multi-entry loop: BACK_EDGE: B:63:0x0180 -> B:64:0x0186 */
    ...
    /* JADX WARN: Removed duplicated region for block: B:59:0x0156 A[Catch: all -> 0x018c, TRY_LEAVE, TryCatch #4 {all -> 0x018c, blocks: (B:57:0x0149, B:59:0x0156), top: B:77:0x0149 }] */
        ...
        try {
            if (i7 != 0) {
                ...
                if (i2 < i) {
                    ...
                    int apiValue = (z ? ReceiveMessageOptionType.RECEIVE_SILENTLY : ReceiveMessageOptionType.RECEIVE).getApiValue();
                    this.L$0 = baseDao2;
                    this.L$1 = sfn;
                    this.L$2 = str;
                    this.L$3 = longRef2;
                    ...
                    this.J$0 = jNanoTime;
                    this.label = 1;
                    if (inHouseIMConversationDaoCopydefault.updateIsNoDisturb(str, apiValue, this) == objCopydefault) {
                        return objCopydefault;
                    }
