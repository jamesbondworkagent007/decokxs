...
public final class ConversationCacheImpl$updateIsTop$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ConversationCacheImpl$updateIsTop$1(sFN sfn, String str, boolean z, Continuation<? super ConversationCacheImpl$updateIsTop$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ConversationCacheImpl$updateIsTop$1(this.this$0, this.$targetId, this.$isTop, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ConversationCacheImpl$updateIsTop$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        try {
            if (i7 != 0) {
                ...
                if (i2 < i) {
                    ...
                    this.J$0 = jNanoTime;
                    this.label = 1;
                    if (inHouseIMConversationDaoCopydefault.updateIsTop(str, z ? 1 : 0, this) == objCopydefault) {
                        return objCopydefault;
                    }
