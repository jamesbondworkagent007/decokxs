...
public final class InHouseIMConversationManagerImpl$getAllConversationsFlow$2 extends SuspendLambda implements Function2<FlowCollector<? super List<? extends InHouseIMConversationListData>>, Continuation<? super Unit>, Object> {
    final /* synthetic */ Ref.LongRef $startTime;
    int label;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InHouseIMConversationManagerImpl$getAllConversationsFlow$2(Ref.LongRef longRef, Continuation<? super InHouseIMConversationManagerImpl$getAllConversationsFlow$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InHouseIMConversationManagerImpl$getAllConversationsFlow$2(this.$startTime, continuation);
    }
    ...
    public final Object invoke2(FlowCollector<? super List<InHouseIMConversationListData>> flowCollector, Continuation<? super Unit> continuation) {
        return ((InHouseIMConversationManagerImpl$getAllConversationsFlow$2) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
