...
@Serializable
public final class OKOpenFailedRedPacketMessage extends OKCustomMessage implements sJU<OKOpenFailedRedPacketMessage> {
    ...
    public static final Parcelable.Creator<OKOpenFailedRedPacketMessage> CREATOR = new Parcelable.Creator<OKOpenFailedRedPacketMessage>() { // from class: com.okinc.okimcore.model.im.OKOpenFailedRedPacketMessage$Companion$CREATOR$1
        /* JADX DEBUG: Method merged with bridge method: createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKOpenFailedRedPacketMessage createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "");
            return new OKOpenFailedRedPacketMessage(parcel);
        }

        /* JADX DEBUG: Method merged with bridge method: newArray(I)[Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKOpenFailedRedPacketMessage[] newArray(int i) {
            return new OKOpenFailedRedPacketMessage[i];
        }
    };
    ...
    public /* synthetic */ OKOpenFailedRedPacketMessage(int i, String str, OKUserInfo oKUserInfo, OKMentionedInfo oKMentionedInfo, String str2, boolean z, long j, InHouseIMContentType inHouseIMContentType, boolean z2, String str3, String str4, String str5, String str6, String str7, JsonObject jsonObject, String str8, String str9, String str10, String str11, String str12, String str13, Uri uri, Integer num, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if ((i & 65536) == 0) {
            oKOpenFailedRedPacketMessage = this;
            oKOpenFailedRedPacketMessage.giftId = null;
        } else {
            oKOpenFailedRedPacketMessage = this;
            oKOpenFailedRedPacketMessage.giftId = str10;
        }
        if ((i & 131072) == 0) {
            oKOpenFailedRedPacketMessage.giftReceiverUid = null;
        } else {
            oKOpenFailedRedPacketMessage.giftReceiverUid = str11;
        }
        if ((i & 262144) == 0) {
            oKOpenFailedRedPacketMessage.giftSenderUid = null;
        } else {
            oKOpenFailedRedPacketMessage.giftSenderUid = str12;
        }
        if ((i & 524288) == 0) {
            oKOpenFailedRedPacketMessage.giftSenderName = null;
        } else {
            oKOpenFailedRedPacketMessage.giftSenderName = str13;
        }
        if ((i & 1048576) == 0) {
            oKOpenFailedRedPacketMessage.image = null;
        } else {
            oKOpenFailedRedPacketMessage.image = uri;
        }
        oKOpenFailedRedPacketMessage.state = (i & 2097152) != 0 ? num : null;
    }

    public static final /* synthetic */ void write$Self$OKIMCore_okimcore(OKOpenFailedRedPacketMessage oKOpenFailedRedPacketMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        OKCustomMessage.write$Self((OKCustomMessage) oKOpenFailedRedPacketMessage, compositeEncoder, serialDescriptor);
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 16) || oKOpenFailedRedPacketMessage.giftId != null) {
            compositeEncoder.encodeNullableSerializableElement(serialDescriptor, 16, StringSerializer.INSTANCE, oKOpenFailedRedPacketMessage.giftId);
        }
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 17) || oKOpenFailedRedPacketMessage.giftReceiverUid != null) {
            compositeEncoder.encodeNullableSerializableElement(serialDescriptor, 17, StringSerializer.INSTANCE, oKOpenFailedRedPacketMessage.giftReceiverUid);
        }
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 18) || oKOpenFailedRedPacketMessage.giftSenderUid != null) {
            compositeEncoder.encodeNullableSerializableElement(serialDescriptor, 18, StringSerializer.INSTANCE, oKOpenFailedRedPacketMessage.giftSenderUid);
        }
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 19) || oKOpenFailedRedPacketMessage.giftSenderName != null) {
            compositeEncoder.encodeNullableSerializableElement(serialDescriptor, 19, StringSerializer.INSTANCE, oKOpenFailedRedPacketMessage.giftSenderName);
        }
        if (compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 20) || oKOpenFailedRedPacketMessage.image != null) {
            compositeEncoder.encodeNullableSerializableElement(serialDescriptor, 20, UriSerializer.INSTANCE, oKOpenFailedRedPacketMessage.image);
        }
        if (!compositeEncoder.shouldEncodeElementDefault(serialDescriptor, 21) && oKOpenFailedRedPacketMessage.state == null) {
            return;
        }
        compositeEncoder.encodeNullableSerializableElement(serialDescriptor, 21, IntSerializer.INSTANCE, oKOpenFailedRedPacketMessage.state);
    }

    public OKOpenFailedRedPacketMessage() {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OKOpenFailedRedPacketMessage(@NotNull Parcel parcel) {
        super(parcel);
        Intrinsics.checkNotNullParameter(parcel, "");
    ...
    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.okimcore.model.im.OKOpenFailedRedPacketMessage.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final KSerializer<OKOpenFailedRedPacketMessage> serializer() {
            return OKOpenFailedRedPacketMessage$$serializer.INSTANCE;
        }
    }
    ...
    public OKOpenFailedRedPacketMessage m6884decodeFromRcJson(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "");
        return new OKOpenFailedRedPacketMessage();
    }
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // o.sJU
    public OKOpenFailedRedPacketMessage decodeFromInHouseCustomContent(String str) {
        String utf8ContentString;
        Object objM7377constructorimpl;
        Uri uri;
