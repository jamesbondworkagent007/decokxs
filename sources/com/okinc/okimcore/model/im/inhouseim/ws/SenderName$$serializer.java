...
public final /* synthetic */ class SenderName$$serializer implements GeneratedSerializer<SenderName> {
    public static final int $stable;
    public static final SenderName$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private SenderName$$serializer() {
    }
    ...
    static {
        SenderName$$serializer senderName$$serializer = new SenderName$$serializer();
        INSTANCE = senderName$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.im.inhouseim.ws.SenderName", senderName$$serializer, 3);
    ...
    public final SenderName deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new SenderName(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull SenderName senderName) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(senderName, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        SenderName.write$Self$OKIMCore_okimcore(senderName, compositeEncoderBeginStructure, serialDescriptor);
