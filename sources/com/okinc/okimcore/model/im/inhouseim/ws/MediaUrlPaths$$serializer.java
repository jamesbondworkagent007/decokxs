...
public final /* synthetic */ class MediaUrlPaths$$serializer implements GeneratedSerializer<MediaUrlPaths> {
    public static final int $stable;
    public static final MediaUrlPaths$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private MediaUrlPaths$$serializer() {
    }
    ...
    static {
        MediaUrlPaths$$serializer mediaUrlPaths$$serializer = new MediaUrlPaths$$serializer();
        INSTANCE = mediaUrlPaths$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.im.inhouseim.ws.MediaUrlPaths", mediaUrlPaths$$serializer, 3);
        pluginGeneratedSerialDescriptor.addElement("CN", true);
    ...
    public final MediaUrlPaths deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new MediaUrlPaths(i, str3, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull MediaUrlPaths mediaUrlPaths) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(mediaUrlPaths, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        MediaUrlPaths.write$Self$OKIMCore_okimcore(mediaUrlPaths, compositeEncoderBeginStructure, serialDescriptor);
