...
@Serializable
public final class OKPrivateTypingIndicatorMessage extends OKCustomMessage implements sJU<OKPrivateTypingIndicatorMessage> {
    ...
    public static final Parcelable.Creator<OKPrivateTypingIndicatorMessage> CREATOR = new Parcelable.Creator<OKPrivateTypingIndicatorMessage>() { // from class: com.okinc.okimcore.model.im.OKPrivateTypingIndicatorMessage$Companion$CREATOR$1
        /* JADX DEBUG: Method merged with bridge method: createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKPrivateTypingIndicatorMessage createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "");
            return new OKPrivateTypingIndicatorMessage(parcel);
        }

        /* JADX DEBUG: Method merged with bridge method: newArray(I)[Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKPrivateTypingIndicatorMessage[] newArray(int i) {
            return new OKPrivateTypingIndicatorMessage[i];
        }
    };
 ...
 A[MD:(int, java.lang.String, com.okinc.okimcore.model.im.OKUserInfo, com.okinc.okimcore.model.im.OKMentionedInfo, java.lang.String, boolean, long, com.okinc.okimcore.model.im.inhouseim.ws.InHouseIMContentType, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlinx.serialization.json.JsonObject, java.lang.String, java.lang.String, kotlinx.serialization.internal.SerializationConstructorMarker):void (m)] (LINE:16) call: com.okinc.okimcore.model.im.OKCustomMessage.<init>(int, java.lang.String, com.okinc.okimcore.model.im.OKUserInfo, com.okinc.okimcore.model.im.OKMentionedInfo, java.lang.String, boolean, long, com.okinc.okimcore.model.im.inhouseim.ws.InHouseIMContentType, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlinx.serialization.json.JsonObject, java.lang.String, java.lang.String, kotlinx.serialization.internal.SerializationConstructorMarker):void type: SUPER */
    ...
    public OKPrivateTypingIndicatorMessage() {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OKPrivateTypingIndicatorMessage(@NotNull Parcel parcel) {
        super(parcel);
        Intrinsics.checkNotNullParameter(parcel, "");
    }

    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.okimcore.model.im.OKPrivateTypingIndicatorMessage.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final KSerializer<OKPrivateTypingIndicatorMessage> serializer() {
            return OKPrivateTypingIndicatorMessage$$serializer.INSTANCE;
        }
    }
    ...
    public OKPrivateTypingIndicatorMessage m6887decodeFromRcJson(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "");
        return new OKPrivateTypingIndicatorMessage();
    }
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // o.sJU
    public OKPrivateTypingIndicatorMessage decodeFromInHouseCustomContent(String str) {
        String utf8ContentString;
        Object objM7377constructorimpl;
        ...
        Result.m7383isFailureimpl(objM7377constructorimpl);
        return this;
    }
}
