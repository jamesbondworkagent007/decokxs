...
@Serializable
public final class OKTradingStartCompetitionMessage extends OKCustomMessage implements sJU<OKTradingStartCompetitionMessage> {
    ...
    public static final Parcelable.Creator<OKTradingStartCompetitionMessage> CREATOR = new Parcelable.Creator<OKTradingStartCompetitionMessage>() { // from class: com.okinc.okimcore.model.im.OKTradingStartCompetitionMessage$Companion$CREATOR$1
        /* JADX DEBUG: Method merged with bridge method: createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKTradingStartCompetitionMessage createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "");
            return new OKTradingStartCompetitionMessage(parcel);
        }

        /* JADX DEBUG: Method merged with bridge method: newArray(I)[Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKTradingStartCompetitionMessage[] newArray(int i) {
            return new OKTradingStartCompetitionMessage[i];
        }
    };
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // o.sJU
    public OKTradingStartCompetitionMessage decodeFromInHouseCustomContent(String str) {
        return this;
    }
 ...
 A[MD:(int, java.lang.String, com.okinc.okimcore.model.im.OKUserInfo, com.okinc.okimcore.model.im.OKMentionedInfo, java.lang.String, boolean, long, com.okinc.okimcore.model.im.inhouseim.ws.InHouseIMContentType, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlinx.serialization.json.JsonObject, java.lang.String, java.lang.String, kotlinx.serialization.internal.SerializationConstructorMarker):void (m)] (LINE:10) call: com.okinc.okimcore.model.im.OKCustomMessage.<init>(int, java.lang.String, com.okinc.okimcore.model.im.OKUserInfo, com.okinc.okimcore.model.im.OKMentionedInfo, java.lang.String, boolean, long, com.okinc.okimcore.model.im.inhouseim.ws.InHouseIMContentType, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlinx.serialization.json.JsonObject, java.lang.String, java.lang.String, kotlinx.serialization.internal.SerializationConstructorMarker):void type: SUPER */
    ...
    public OKTradingStartCompetitionMessage() {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OKTradingStartCompetitionMessage(@NotNull Parcel parcel) {
        super(parcel);
        Intrinsics.checkNotNullParameter(parcel, "");
    }

    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.okimcore.model.im.OKTradingStartCompetitionMessage.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final KSerializer<OKTradingStartCompetitionMessage> serializer() {
            return OKTradingStartCompetitionMessage$$serializer.INSTANCE;
        }
    }
    ...
    public OKTradingStartCompetitionMessage m6895decodeFromRcJson(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "");
        return new OKTradingStartCompetitionMessage();
    }
