...
@Serializable
public final class OKTradingEndCompetitionMessage extends OKCustomMessage implements sJU<OKTradingEndCompetitionMessage> {
    ...
    public static final Parcelable.Creator<OKTradingEndCompetitionMessage> CREATOR = new Parcelable.Creator<OKTradingEndCompetitionMessage>() { // from class: com.okinc.okimcore.model.im.OKTradingEndCompetitionMessage$Companion$CREATOR$1
        /* JADX DEBUG: Method merged with bridge method: createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKTradingEndCompetitionMessage createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "");
            return new OKTradingEndCompetitionMessage(parcel);
        }

        /* JADX DEBUG: Method merged with bridge method: newArray(I)[Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public OKTradingEndCompetitionMessage[] newArray(int i) {
            return new OKTradingEndCompetitionMessage[i];
        }
    };
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // o.sJU
    public OKTradingEndCompetitionMessage decodeFromInHouseCustomContent(String str) {
        return this;
    }
 ...
 A[MD:(int, java.lang.String, com.okinc.okimcore.model.im.OKUserInfo, com.okinc.okimcore.model.im.OKMentionedInfo, java.lang.String, boolean, long, com.okinc.okimcore.model.im.inhouseim.ws.InHouseIMContentType, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlinx.serialization.json.JsonObject, java.lang.String, java.lang.String, kotlinx.serialization.internal.SerializationConstructorMarker):void (m)] (LINE:10) call: com.okinc.okimcore.model.im.OKCustomMessage.<init>(int, java.lang.String, com.okinc.okimcore.model.im.OKUserInfo, com.okinc.okimcore.model.im.OKMentionedInfo, java.lang.String, boolean, long, com.okinc.okimcore.model.im.inhouseim.ws.InHouseIMContentType, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, kotlinx.serialization.json.JsonObject, java.lang.String, java.lang.String, kotlinx.serialization.internal.SerializationConstructorMarker):void type: SUPER */
    ...
    public OKTradingEndCompetitionMessage() {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OKTradingEndCompetitionMessage(@NotNull Parcel parcel) {
        super(parcel);
        Intrinsics.checkNotNullParameter(parcel, "");
    }

    public static final class Companion {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: com.okinc.okimcore.model.im.OKTradingEndCompetitionMessage.Companion.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        public final KSerializer<OKTradingEndCompetitionMessage> serializer() {
            return OKTradingEndCompetitionMessage$$serializer.INSTANCE;
        }
    }
    ...
    public OKTradingEndCompetitionMessage m6893decodeFromRcJson(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "");
        return new OKTradingEndCompetitionMessage();
    }
