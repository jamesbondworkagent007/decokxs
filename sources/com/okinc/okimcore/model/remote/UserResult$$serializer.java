...
public final /* synthetic */ class UserResult$$serializer implements GeneratedSerializer<UserResult> {
    public static final int $stable;
    public static final UserResult$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private UserResult$$serializer() {
    }
    ...
    static {
        UserResult$$serializer userResult$$serializer = new UserResult$$serializer();
        INSTANCE = userResult$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.remote.UserResult", userResult$$serializer, 4);
    ...
    public final UserResult deserialize(@NotNull Decoder decoder) {
        boolean z;
        String str;
        int i;
        int i2;
        ...
        return new UserResult(i, j, z, i2, str, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull UserResult userResult) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(userResult, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        UserResult.write$Self$OKIMCore_okimcore(userResult, compositeEncoderBeginStructure, serialDescriptor);
