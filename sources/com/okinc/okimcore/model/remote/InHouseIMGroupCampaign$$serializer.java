...
public final /* synthetic */ class InHouseIMGroupCampaign$$serializer implements GeneratedSerializer<InHouseIMGroupCampaign> {
    public static final int $stable;
    public static final InHouseIMGroupCampaign$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private InHouseIMGroupCampaign$$serializer() {
    }
    ...
    static {
        InHouseIMGroupCampaign$$serializer inHouseIMGroupCampaign$$serializer = new InHouseIMGroupCampaign$$serializer();
        INSTANCE = inHouseIMGroupCampaign$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.remote.InHouseIMGroupCampaign", inHouseIMGroupCampaign$$serializer, 7);
    ...
    public final InHouseIMGroupCampaign deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        return new InHouseIMGroupCampaign(i, num, str6, str5, str, str3, str4, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull InHouseIMGroupCampaign inHouseIMGroupCampaign) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(inHouseIMGroupCampaign, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        InHouseIMGroupCampaign.write$Self$OKIMCore_okimcore(inHouseIMGroupCampaign, compositeEncoderBeginStructure, serialDescriptor);
