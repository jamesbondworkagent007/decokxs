...
public final /* synthetic */ class GroupBanner$$serializer implements GeneratedSerializer<GroupBanner> {
    public static final int $stable;
    public static final GroupBanner$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GroupBanner$$serializer() {
    }
    ...
    static {
        GroupBanner$$serializer groupBanner$$serializer = new GroupBanner$$serializer();
        INSTANCE = groupBanner$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.remote.GroupBanner", groupBanner$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("id", false);
        pluginGeneratedSerialDescriptor.addElement("title", false);
        pluginGeneratedSerialDescriptor.addElement("content", false);
        pluginGeneratedSerialDescriptor.addElement("ctaLink", false);
    ...
    public final GroupBanner deserialize(@NotNull Decoder decoder) {
        ...
        return new GroupBanner(i, j, str2, str, str3, str4, strDecodeStringElement, null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GroupBanner groupBanner) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(groupBanner, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GroupBanner.write$Self$OKIMCore_okimcore(groupBanner, compositeEncoderBeginStructure, serialDescriptor);
