...
public final /* synthetic */ class GroupInvitationInfoResponse$GroupOwnerInfo$$serializer implements GeneratedSerializer<GroupInvitationInfoResponse.GroupOwnerInfo> {
    public static final int $stable;
    public static final GroupInvitationInfoResponse$GroupOwnerInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private GroupInvitationInfoResponse$GroupOwnerInfo$$serializer() {
    }
    ...
    static {
        GroupInvitationInfoResponse$GroupOwnerInfo$$serializer groupInvitationInfoResponse$GroupOwnerInfo$$serializer = new GroupInvitationInfoResponse$GroupOwnerInfo$$serializer();
        INSTANCE = groupInvitationInfoResponse$GroupOwnerInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.remote.GroupInvitationInfoResponse.GroupOwnerInfo", groupInvitationInfoResponse$GroupOwnerInfo$$serializer, 3);
    ...
    public final GroupInvitationInfoResponse.GroupOwnerInfo deserialize(@NotNull Decoder decoder) {
        int i;
        String str;
        Long l;
        String str2;
        ...
        return new GroupInvitationInfoResponse.GroupOwnerInfo(i, l, str, str2, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull GroupInvitationInfoResponse.GroupOwnerInfo groupOwnerInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(groupOwnerInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        GroupInvitationInfoResponse.GroupOwnerInfo.write$Self$OKIMCore_okimcore(groupOwnerInfo, compositeEncoderBeginStructure, serialDescriptor);
