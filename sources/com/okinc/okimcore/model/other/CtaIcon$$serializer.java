...
public final /* synthetic */ class CtaIcon$$serializer implements GeneratedSerializer<CtaIcon> {
    ...
    static {
        ...
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.okimcore.model.other.CtaIcon", ctaIcon$$serializer, 2);
    ...
    public final CtaIcon deserialize(@NotNull Decoder decoder) {
        ...
        return new CtaIcon(i, str2, str, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CtaIcon ctaIcon) {
        ...
        CtaIcon.write$Self$OKIMCore_okimcore(ctaIcon, compositeEncoderBeginStructure, serialDescriptor);
