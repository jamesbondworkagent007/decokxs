...
public final /* synthetic */ class ReferralFooterInfo$$serializer implements GeneratedSerializer<ReferralFooterInfo> {
    public static final int $stable;
    public static final ReferralFooterInfo$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    private ReferralFooterInfo$$serializer() {
    }
    ...
    static {
        ReferralFooterInfo$$serializer referralFooterInfo$$serializer = new ReferralFooterInfo$$serializer();
        INSTANCE = referralFooterInfo$$serializer;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.okinc.referral.bean.ReferralFooterInfo", referralFooterInfo$$serializer, 6);
        pluginGeneratedSerialDescriptor.addElement("layoutType", false);
        pluginGeneratedSerialDescriptor.addElement("downloadUrl", false);
        pluginGeneratedSerialDescriptor.addElement("shareUrl", false);
        pluginGeneratedSerialDescriptor.addElement("referralCode", false);
        pluginGeneratedSerialDescriptor.addElement("inviterShareText", true);
        pluginGeneratedSerialDescriptor.addElement("inviteeShareText", true);
    ...
    public final ReferralFooterInfo deserialize(@NotNull Decoder decoder) {
        String str;
        String str2;
        int i;
        String str3;
        ...
        return new ReferralFooterInfo(i, num, str5, str4, str2, str3, str, (SerializationConstructorMarker) null);
    }

    /* JADX DEBUG: Method merged with bridge method: serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V */
    @Override // kotlinx.serialization.SerializationStrategy
    public final void serialize(@NotNull Encoder encoder, @NotNull ReferralFooterInfo referralFooterInfo) {
        Intrinsics.checkNotNullParameter(encoder, "");
        Intrinsics.checkNotNullParameter(referralFooterInfo, "");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        ReferralFooterInfo.write$Self$OKReferral_referral_api(referralFooterInfo, compositeEncoderBeginStructure, serialDescriptor);
