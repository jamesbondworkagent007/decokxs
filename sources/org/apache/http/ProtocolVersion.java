...
public class ProtocolVersion implements Serializable, Cloneable {
    ...
    public ProtocolVersion(String str, int i, int i2) {
        this.protocol = (String) C59851zoo.AEQbTJ(str, "Protocol name");
        this.major = C59851zoo.KWHzl(i, "Protocol minor version");
        this.minor = C59851zoo.KWHzl(i2, "Protocol minor version");
    }
    ...
    public int compareToVersion(ProtocolVersion protocolVersion) {
        ...
        C59851zoo.copydefault(this.protocol.equals(protocolVersion.protocol), "Versions for different protocols cannot be compared: %s %s", this, protocolVersion);
