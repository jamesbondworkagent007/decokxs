...
public final class HttpHost implements Cloneable, Serializable {
    ...
    public HttpHost(String str, int i, String str2) {
        this.hostname = (String) C59825zoO.AEQbTJ(str, "Host name");
    ...
    public static HttpHost create(String str) {
        String strSubstring;
        int i;
        C59825zoO.AEQbTJ(str, "HTTP Host");
    ...
    public HttpHost(InetAddress inetAddress, int i, String str) {
        this((InetAddress) C59825zoO.copydefault(inetAddress, "Inet address"), inetAddress.getHostName(), i, str);
    }

    public HttpHost(InetAddress inetAddress, String str, int i, String str2) {
        this.address = (InetAddress) C59825zoO.copydefault(inetAddress, "Inet address");
        String str3 = (String) C59825zoO.copydefault(str, "Hostname");
        this.hostname = str3;
        Locale locale = Locale.ROOT;
    ...
    public HttpHost(HttpHost httpHost) {
        C59825zoO.copydefault(httpHost, "HTTP host");
    ...
    public int hashCode() {
        int iAEQbTJ = C59828zoR.AEQbTJ(C59828zoR.OLrzqt(C59828zoR.AEQbTJ(17, this.lcHostname), this.port), this.schemeName);
        InetAddress inetAddress = this.address;
        return inetAddress != null ? C59828zoR.AEQbTJ(iAEQbTJ, inetAddress) : iAEQbTJ;
    }
