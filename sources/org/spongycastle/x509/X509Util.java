...
class X509Util {
    ...
    public static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        while (true) {
            String property = provider.getProperty("Alg.Alias." + str + JwtUtilsKt.JWT_DELIMITER + upperCase);
            if (property == null) {
                break;
            }
            upperCase = property;
        }
        String property2 = provider.getProperty(str + JwtUtilsKt.JWT_DELIMITER + upperCase);
        if (property2 != null) {
            try {
