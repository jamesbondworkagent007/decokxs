                        ...
                        if (cRLDistPoint != null) {
                            try {
                                ...
                                while (i < distributionPoints.length && certStatus.getCertStatus() == 11 && !reasonsMask.isAllReasons()) {
                                    try {
                                        int i2 = i;
                                        checkCRL(distributionPoints[i], x509AttributeCertificate, (PKIXExtendedParameters) pKIXExtendedParametersBuild.clone(), date, x509Certificate, certStatus, reasonsMask, list, jcaJceHelper);
                                        i = i2 + 1;
                                        z = true;
    ...
    public static void additionalChecks(X509AttributeCertificate x509AttributeCertificate, Set set, Set set2) throws CertPathValidatorException {
        ...
        while (it.hasNext()) {
            ...
            if (x509AttributeCertificate.getAttributes(str) != null) {
                throw new CertPathValidatorException("Attribute certificate contains prohibited attribute: " + str + JwtUtilsKt.JWT_DELIMITER);
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (x509AttributeCertificate.getAttributes(str2) == null) {
                throw new CertPathValidatorException("Attribute certificate does not contain necessary attribute: " + str2 + JwtUtilsKt.JWT_DELIMITER);
            }
        }
    }
