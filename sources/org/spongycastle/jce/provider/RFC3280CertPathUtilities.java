...
class RFC3280CertPathUtilities {
                        ...
                        if (pKIXPolicyNode4.getValidPolicy().equals(str)) {
                            ...
                            for (int i5 = size - 1; i5 >= 0; i5--) {
                                ...
                                while (i3 < list.size()) {
                                    ...
                                    i3 = (pKIXPolicyNode5.hasChildren() || (pKIXPolicyNodeRemovePolicyNode = CertPathValidatorUtilities.removePolicyNode(pKIXPolicyNodeRemovePolicyNode, listArr, pKIXPolicyNode5)) != null) ? i3 + 1 : 0;
                                }
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static void checkCRLs(PKIXExtendedParameters pKIXExtendedParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, List list, JcaJceHelper jcaJceHelper) throws AnnotatedException {
