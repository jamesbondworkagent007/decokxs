...
public abstract class Primes {
    ...
    private static boolean implHasAnySmallFactors(BigInteger bigInteger) {
        ...
        if (iIntValue6 % 107 == 0 || iIntValue6 % 109 == 0 || iIntValue6 % WalletImportError.ERROR_CODE_HARDWARE_ACCOUNT_EXIST == 0 || iIntValue6 % 127 == 0) {
            return true;
        }
        int iIntValue7 = bigInteger.mod(BigInteger.valueOf(371700317)).intValue();
        if (iIntValue7 % DateFormat.RELATIVE_SHORT == 0 || iIntValue7 % CipherSuite.TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA == 0 || iIntValue7 % CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA == 0 || iIntValue7 % CipherSuite.TLS_RSA_PSK_WITH_AES_256_CBC_SHA == 0) {
            return true;
        }
        ...
        if (iIntValue9 % CipherSuite.TLS_RSA_PSK_WITH_AES_256_GCM_SHA384 == 0 || iIntValue9 % CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA384 == 0 || iIntValue9 % CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA384 == 0 || iIntValue9 % 191 == 0) {
            return true;
        }
        int iIntValue10 = bigInteger.mod(BigInteger.valueOf(1596463769)).intValue();
        return iIntValue10 % CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256 == 0 || iIntValue10 % CipherSuite.TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA256 == 0 || iIntValue10 % 199 == 0 || iIntValue10 % 211 == 0;
    }
    ...
    private static int extract32(byte[] bArr) {
        ...
        while (i < iMin) {
            int i3 = i + 1;
            i2 |= (bArr[bArr.length - i3] & UnsignedBytes.MAX_VALUE) << (i * 8);
            i = i3;
        }
        return i2;
    }
