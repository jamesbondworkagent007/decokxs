...
public abstract class Nat512 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int iAddTo = Nat256.addTo(iArr3, 24, iArr3, 16, Nat256.addTo(iArr3, 0, iArr3, 8, 0) + iAddToEachOther);
        ...
        Nat.addWordAt(32, iAddToEachOther + iAddTo + (z ? Nat.addTo(16, iArrCreateExt, 0, iArr3, 8) : Nat.subFrom(16, iArrCreateExt, 0, iArr3, 8)), iArr3, 24);
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        int iAddTo = Nat256.addTo(iArr2, 24, iArr2, 16, Nat256.addTo(iArr2, 0, iArr2, 8, 0) + iAddToEachOther);
        int[] iArrCreate = Nat256.create();
        Nat256.diff(iArr, 8, iArr, 0, iArrCreate, 0);
        int[] iArrCreateExt = Nat256.createExt();
        Nat256.square(iArrCreate, iArrCreateExt);
        Nat.addWordAt(32, iAddToEachOther + iAddTo + Nat.subFrom(16, iArrCreateExt, 0, iArr2, 8), iArr2, 24);
    }
}
