...
public abstract class Nat384 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int iAddTo = Nat192.addTo(iArr3, 18, iArr3, 12, Nat192.addTo(iArr3, 0, iArr3, 6, 0) + iAddToEachOther);
        ...
        Nat.addWordAt(24, iAddToEachOther + iAddTo + (z ? Nat.addTo(12, iArrCreateExt, 0, iArr3, 6) : Nat.subFrom(12, iArrCreateExt, 0, iArr3, 6)), iArr3, 18);
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        int iAddTo = Nat192.addTo(iArr2, 18, iArr2, 12, Nat192.addTo(iArr2, 0, iArr2, 6, 0) + iAddToEachOther);
        int[] iArrCreate = Nat192.create();
        Nat192.diff(iArr, 6, iArr, 0, iArrCreate, 0);
        int[] iArrCreateExt = Nat192.createExt();
        Nat192.square(iArrCreate, iArrCreateExt);
        Nat.addWordAt(24, iAddToEachOther + iAddTo + Nat.subFrom(12, iArrCreateExt, 0, iArr2, 6), iArr2, 18);
    }
}
