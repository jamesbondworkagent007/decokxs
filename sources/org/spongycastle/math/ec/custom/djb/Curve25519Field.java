...
public class Curve25519Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int iMulByWordAddTo = Nat256.mulByWordAddTo(19, iArr, iArr2);
        int i2 = iArr2[7];
        iArr2[7] = (Integer.MAX_VALUE & i2) + Nat.addWordTo(7, ((iMulByWordAddTo << 1) + ((i2 >>> 31) - (i >>> 31))) * 19, iArr2);
        if (Nat256.gte(iArr2, P)) {
            subPFrom(iArr2);
        }
    }
    ...
    private static int addPExtTo(int[] iArr) {
        long j = iArr[0];
        int[] iArr2 = PExt;
        long j2 = (j & 4294967295L) + (((long) iArr2[0]) & 4294967295L);
        iArr[0] = (int) j2;
        long jIncAt = j2 >> 32;
        if (jIncAt != 0) {
        ...
        long j4 = jDecAt + (((long) iArr[15]) & 4294967295L) + (((long) (iArr2[15] + 1)) & 4294967295L);
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j4 = jIncAt + ((((long) iArr[15]) & 4294967295L) - (((long) (iArr2[15] + 1)) & 4294967295L));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
}
