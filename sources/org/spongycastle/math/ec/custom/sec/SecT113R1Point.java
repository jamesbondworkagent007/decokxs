...
public class SecT113R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (!zIsOne2) {
                eCFieldElementMultiply8 = eCFieldElementMultiply8.multiply(zCoord);
            }
            ECFieldElement eCFieldElementSquarePlusProduct = eCFieldElementMultiply6.add(eCFieldElementSquare).squarePlusProduct(eCFieldElementMultiply8, eCFieldElement2.add(eCFieldElement3));
            ECFieldElement eCFieldElementMultiply9 = !zIsOne ? eCFieldElementMultiply8.multiply(eCFieldElement3) : eCFieldElementMultiply8;
