...
public class SecT233Field {
    ...
    public static void invert(long[] jArr, long[] jArr2) {
        ...
        multiply(jArrCreate642, jArrCreate64, jArrCreate642);
        squareN(jArrCreate642, AppInfoTableDecoder.APPLICATION_INFORMATION_TABLE_ID, jArrCreate64);
        multiply(jArrCreate64, jArrCreate642, jArrCreate64);
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j2 = (jUnshuffle3 >>> 32) | ((-4294967296L) & jUnshuffle4);
        long j3 = j2 >>> 27;
        ...
        while (i2 < i) {
            ...
            int i4 = i3 >>> 6;
            int i5 = i3 & 63;
            jArrCreateExt64[i4] = jArrCreateExt64[i4] ^ (j5 << i5);
            int i6 = i4 + 1;
            int[] iArr2 = iArr;
            int i7 = -i5;
            jArrCreateExt64[i6] = jArrCreateExt64[i6] ^ ((j4 << i5) | (j5 >>> i7));
            int i8 = i4 + 2;
            jArrCreateExt64[i8] = jArrCreateExt64[i8] ^ ((j3 << i5) | (j4 >>> i7));
            i = 3;
            int i9 = i4 + 3;
            jArrCreateExt64[i9] = jArrCreateExt64[i9] ^ (j3 >>> i7);
            i2++;
            iArr = iArr2;
        }
        reduce(jArrCreateExt64, jArr2);
        jArr2[0] = ((jUnshuffle & BodyPartID.bodyIdMax) | (jUnshuffle2 << 32)) ^ jArr2[0];
        jArr2[1] = jArr2[1] ^ ((jUnshuffle3 & BodyPartID.bodyIdMax) | (jUnshuffle4 << 32));
    }
