...
public class SecT239Field {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j2 = ((-4294967296L) & jUnshuffle4) | (jUnshuffle3 >>> 32);
        long j3 = j2 >>> 49;
        long j4 = (j >>> 49) | (j2 << 15);
        long j5 = j2 ^ (j << 15);
        long[] jArrCreateExt64 = Nat256.createExt64();
        ...
        while (i2 < i) {
            ...
            int i4 = i3 >>> 6;
            int i5 = i3 & 63;
            jArrCreateExt64[i4] = jArrCreateExt64[i4] ^ (j << i5);
            int i6 = i4 + 1;
            int[] iArr2 = iArr;
            int i7 = -i5;
            jArrCreateExt64[i6] = jArrCreateExt64[i6] ^ ((j5 << i5) | (j >>> i7));
            int i8 = i4 + 2;
            jArrCreateExt64[i8] = jArrCreateExt64[i8] ^ ((j4 << i5) | (j5 >>> i7));
            int i9 = i4 + 3;
            jArrCreateExt64[i9] = jArrCreateExt64[i9] ^ ((j3 << i5) | (j4 >>> i7));
            int i10 = i4 + 4;
            jArrCreateExt64[i10] = jArrCreateExt64[i10] ^ (j3 >>> i7);
            i2++;
            i = 2;
            iArr = iArr2;
        }
