...
public class SecT193Field {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j = (jUnshuffle >>> 32) | ((-4294967296L) & jUnshuffle2);
        long jUnshuffle3 = Interleave.unshuffle(jArr[2]);
        long j2 = jArr[3];
        long j3 = jUnshuffle3 >>> 32;
        jArr2[0] = ((jUnshuffle & BodyPartID.bodyIdMax) | (jUnshuffle2 << 32)) ^ (j << 8);
        jArr2[1] = ((((jUnshuffle3 & BodyPartID.bodyIdMax) ^ (j2 << 32)) ^ (j3 << 8)) ^ (j >>> 56)) ^ (j << 33);
        jArr2[2] = (j >>> 31) ^ ((jUnshuffle3 >>> 88) ^ (j3 << 33));
