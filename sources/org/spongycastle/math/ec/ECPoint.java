        ...
        */
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 0) {
                ...
                return new Fp(curve, eCFieldElementSubtract4, eCFieldElementDivide.multiply(eCFieldElementMultiply2.subtract(eCFieldElementSubtract4)).subtract(eCFieldElementMultiply3), this.withCompression);
            }
            if (coordinateSystem == 1) {
                ...
                ECFieldElement eCFieldElementSquare2 = eCFieldElementSubtract6.square();
                ECFieldElement eCFieldElementMultiply7 = eCFieldElementSquare2.multiply(eCFieldElementSubtract6);
            ...
            if (coordinateSystem == 2 || coordinateSystem == 4) {
                ...
                if (!zIsOne3 && eCFieldElement4.equals(eCFieldElement5)) {
                    ...
                    ECFieldElement eCFieldElementSquare3 = eCFieldElementSubtract8.square();
                    ...
                    eCFieldElementMultiply = eCFieldElementSubtract8.multiply(eCFieldElement4);
                } else {
                    if (!zIsOne3) {
                    ...
                    eCFieldElementSquare = eCFieldElementSubtract10.square();
                    ECFieldElement eCFieldElementMultiply12 = eCFieldElementSquare.multiply(eCFieldElementSubtract10);
                    ...
                    ECFieldElement eCFieldElementMultiply14 = !zIsOne3 ? eCFieldElementSubtract10.multiply(eCFieldElement4) : eCFieldElementSubtract10;
                ...
                eCFieldElement = eCFieldElementMultiplyMinusProduct;
                eCFieldElement2 = eCFieldElementSubtract;
                return new Fp(curve, eCFieldElement2, eCFieldElement, coordinateSystem != 4 ? new ECFieldElement[]{eCFieldElementMultiply, calculateJacobianModifiedW(eCFieldElementMultiply, eCFieldElementSquare)} : new ECFieldElement[]{eCFieldElementMultiply}, this.withCompression);
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement3 = this.y;
                ECFieldElement eCFieldElement4 = eCPoint.y;
                ECFieldElement eCFieldElementAdd2 = eCFieldElementMultiply5.add(eCFieldElement2);
                ...
                return new F2m(curve, eCFieldElementAdd4, eCFieldElementDivide.multiply(eCFieldElementMultiply5.add(eCFieldElementAdd4)).add(eCFieldElementAdd4).add(eCFieldElement3), this.withCompression);
            }
            if (coordinateSystem == 1) {
                ...
                ECFieldElement eCFieldElementAdd5 = eCFieldElementMultiply6.multiply(eCFieldElement6).add(zIsOne ? eCFieldElement5 : eCFieldElement5.multiply(eCFieldElement7));
                ECFieldElement eCFieldElementAdd6 = eCFieldElementMultiply6.multiply(eCFieldElement2).add(zIsOne ? eCFieldElementMultiply5 : eCFieldElementMultiply5.multiply(eCFieldElement7));
                ...
                if (!zIsOne) {
                    eCFieldElementMultiply6 = eCFieldElementMultiply6.multiply(eCFieldElement7);
                }
                ...
                return new F2m(curve, eCFieldElementMultiply8, eCFieldElementAdd5.multiplyPlusProduct(eCFieldElementMultiply5, eCFieldElementAdd6, eCFieldElement5).multiplyPlusProduct(eCFieldElementSquare, eCFieldElementAdd7, eCFieldElementAdd8), new ECFieldElement[]{eCFieldElementMultiply7.multiply(eCFieldElementMultiply6)}, this.withCompression);
            }
            if (coordinateSystem == 6) {
                ...
                if (zIsOne3) {
                    ...
                    eCFieldElementMultiply5 = eCFieldElementMultiply5.multiply(eCFieldElement11);
                ...
                if (eCFieldElement2.isZero()) {
                    ...
                    if (eCFieldElementMultiply11.isZero()) {
                        return new F2m(curve, eCFieldElementMultiply11, curve.getB().sqrt(), this.withCompression);
                    }
                    ECFieldElement eCFieldElementMultiply12 = eCFieldElementAdd9.multiply(eCFieldElementSquare2);
                    if (!zIsOne3) {
                        eCFieldElementMultiply12 = eCFieldElementMultiply12.multiply(eCFieldElement11);
                    }
                    ECFieldElement eCFieldElementSquarePlusProduct = eCFieldElementMultiply10.add(eCFieldElementSquare2).squarePlusProduct(eCFieldElementMultiply12, eCFieldElement8.add(eCFieldElement9));
                    eCFieldElementMultiply4 = !zIsOne2 ? eCFieldElementMultiply12.multiply(eCFieldElement9) : eCFieldElementMultiply12;
                    eCFieldElement = eCFieldElementSquarePlusProduct;
                    eCFieldElementAdd = eCFieldElementMultiply11;
                }
                return new F2m(curve, eCFieldElementAdd, eCFieldElement, new ECFieldElement[]{eCFieldElementMultiply4}, this.withCompression);
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
