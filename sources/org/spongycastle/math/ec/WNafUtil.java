...
public abstract class WNafUtil {
    ...
    public static int[] generateCompactWindowNaf(int i, BigInteger bigInteger) {
        ...
        while (i3 <= bigInteger.bitLength()) {
            if (bigInteger.testBit(i3) == z) {
                ...
                int iIntValue = bigInteger.intValue() & (i2 - 1);
                if (z) {
                    iIntValue++;
                }
                z = ((i2 >>> 1) & iIntValue) != 0;
                ...
                iArr[i4] = i3 | (iIntValue << 16);
                i4++;
                i3 = i;
            }
        }
        return iBitLength > i4 ? trim(iArr, i4) : iArr;
    }
    ...
    public static byte[] generateJSF(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        while (true) {
            ...
            int iIntValue = (bigInteger.intValue() >>> i3) + i;
            int iIntValue2 = (bigInteger2.intValue() >>> i3) + i2;
            int i5 = iIntValue & 1;
            if (i5 != 0) {
                i5 -= iIntValue & 2;
                if ((iIntValue & 7) + i5 == 4 && (iIntValue2 & 3) == 2) {
                    i5 = -i5;
                }
            }
            int i6 = iIntValue2 & 1;
            if (i6 != 0) {
                i6 -= iIntValue2 & 2;
                if ((iIntValue2 & 7) + i6 == 4 && (iIntValue & 3) == 2) {
                    i6 = -i6;
                }
            }
            if ((i << 1) == i5 + 1) {
    ...
    public static byte[] generateWindowNaf(int i, BigInteger bigInteger) {
        ...
        while (i3 <= bigInteger.bitLength()) {
            if (bigInteger.testBit(i3) == z) {
                ...
                int i5 = i4 + i3;
                bArr[i5] = (byte) iIntValue;
                i4 = i5 + 1;
                i3 = i;
            }
        }
        return iBitLength > i4 ? trim(bArr, i4) : bArr;
    }
