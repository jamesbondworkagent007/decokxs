...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    public AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null) {
            if (this.pbeSpec != null) {
                ...
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance2 = createParametersInstance(CodePackage.GCM);
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:213:0x046c */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:237:0x04c0 */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v17, types: [org.spongycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher] */
    /* JADX WARN: Type inference failed for: r0v24, types: [org.spongycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher] */
            ...
            if (this.baseEngine.getAlgorithmName().startsWith("RC5")) {
                if (this.baseEngine.getAlgorithmName().equals("RC5-32")) {
                    if (rC5ParameterSpec.getWordSize() != 32) {
                        throw new InvalidAlgorithmParameterException("RC5 already set up for a word size of 32 not " + rC5ParameterSpec.getWordSize() + JwtUtilsKt.JWT_DELIMITER);
                    }
                } else if (this.baseEngine.getAlgorithmName().equals("RC5-64") && rC5ParameterSpec.getWordSize() != 64) {
                    throw new InvalidAlgorithmParameterException("RC5 already set up for a word size of 64 not " + rC5ParameterSpec.getWordSize() + JwtUtilsKt.JWT_DELIMITER);
                }
