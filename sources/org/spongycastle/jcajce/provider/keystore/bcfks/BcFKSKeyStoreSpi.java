...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                cipher2.init(1, new SecretKeySpec(bArrGenerateKey, BouncyCastleKeyManagementRepository.AES));
            ...
            try {
                ...
                cipher.init(1, new SecretKeySpec(bArrGenerateKey2, BouncyCastleKeyManagementRepository.AES));
                String upperCase = Strings.toUpperCase(key.getAlgorithm());
                if (upperCase.indexOf(BouncyCastleKeyManagementRepository.AES) > -1) {
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws NoSuchAlgorithmException, IOException, CertificateException {
        ...
        try {
            ...
            cipher.init(1, new SecretKeySpec(bArrGenerateKey, BouncyCastleKeyManagementRepository.AES));
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException {
        ...
        try {
            ...
            cipher.init(2, new SecretKeySpec(generateKey(keyDerivationFunc, str, cArr), BouncyCastleKeyManagementRepository.AES), algorithmParameters);
