    ...
    public byte[] getEncoded() {
        ...
        if (x962Parameters == null) {
            ...
            if (eCParameterSpec instanceof ECNamedCurveSpec) {
                if (z) {
                    gOST3410PublicKeyAlgParameters = new GOST3410PublicKeyAlgParameters(ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec) eCParameterSpec).getName()), RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512);
                } else {
                    gOST3410PublicKeyAlgParameters = new GOST3410PublicKeyAlgParameters(ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec) eCParameterSpec).getName()), RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256);
                }
