...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        BigInteger[] bigIntegerArr3 = {new BigInteger(Integer.toString(iNextInt))};
        int[] iArr = {i3};
        int i6 = 0;
        int i7 = 0;
        while (iArr[i7] >= 17) {
        ...
        while (i11 < i7) {
            ...
            while (true) {
                ...
                int i16 = i10 + 1;
                BigInteger bigIntegerAdd = bigInteger6.pow(iArr[i10] - 1).divide(bigIntegerArr4[i16]).add(bigInteger6.pow(iArr[i10] - 1).multiply(bigInteger5).divide(bigIntegerArr4[i16].multiply(bigInteger6.pow(i12 * 16))));
                ...
                while (true) {
                    ...
                    long j = i17;
                    i4 = i7;
                    BigInteger bigIntegerMultiply = bigIntegerArr4[i16].multiply(bigInteger8.add(BigInteger.valueOf(j)));
                    ...
                    i5 = i12;
                    if (bigIntegerAdd2.compareTo(bigInteger10.pow(iArr[i10])) == 1) {
                        break;
                    }
                    if (bigInteger10.modPow(bigIntegerArr4[i16].multiply(bigInteger8.add(BigInteger.valueOf(j))), bigIntegerArr4[i10]).compareTo(bigInteger9) == 0 && bigInteger10.modPow(bigInteger8.add(BigInteger.valueOf(j)), bigIntegerArr4[i10]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i17 += 2;
        ...
        return bigIntegerArr3[i6].intValue();
    }
    ...
    private long procedure_Aa(long j, long j2, BigInteger[] bigIntegerArr, int i) {
        ...
        BigInteger[] bigIntegerArr3 = {new BigInteger(Long.toString(jNextInt))};
        int[] iArr = {i};
        int i3 = 0;
        int i4 = 0;
        while (iArr[i4] >= 33) {
        ...
        while (i7 < i4) {
            ...
            while (true) {
                ...
                BigInteger bigInteger6 = TWO;
                int i13 = i6 + 1;
                BigInteger bigIntegerAdd = bigInteger6.pow(iArr[i6] - 1).divide(bigIntegerArr4[i13]).add(bigInteger6.pow(iArr[i6] - 1).multiply(bigInteger5).divide(bigIntegerArr4[i13].multiply(bigInteger6.pow(i9 * 32))));
                BigInteger bigIntegerMod = bigIntegerAdd.mod(bigInteger6);
                BigInteger bigInteger7 = ONE;
                if (bigIntegerMod.compareTo(bigInteger7) == 0) {
                    bigIntegerAdd = bigIntegerAdd.add(bigInteger7);
