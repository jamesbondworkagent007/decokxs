...
public class DSAParametersGenerator {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        loop0: while (true) {
            ...
            if (isProbablePrime(bit)) {
                ...
                while (i < i6 * 4) {
                    for (int i7 = 1; i7 <= i3; i7++) {
                        inc(bArrClone);
                        hash(digest, bArrClone, bArr2, i4 - (i7 * digestSize2));
                    }
                    int i8 = i4 - (i3 * digestSize2);
                    inc(bArrClone);
                    hash(digest, bArrClone, bArr3, i5);
                    System.arraycopy(bArr3, digestSize2 - i8, bArr2, i5, i8);
                    bArr2[i5] = (byte) (bArr2[i5] | UnsignedBytes.MAX_POWER_OF_TWO);
        ...
        if (i9 >= 0 && (bigIntegerCalculateGenerator_FIPS186_3_Verifiable = calculateGenerator_FIPS186_3_Verifiable(digest, bigIntegerSubtract, bit, bArr, i9)) != null) {
