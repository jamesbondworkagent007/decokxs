...
public final class DERMacData {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 byte[]) A[MD:(byte[]):void (m)] (LINE:12) call: org.spongycastle.crypto.util.DERMacData.<init>(byte[]):void type: THIS */
