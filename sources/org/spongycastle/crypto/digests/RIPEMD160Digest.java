...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    public void processWord(byte[] bArr, int i) {
        ...
        int i3 = i2 + 1;
        this.xOff = i3;
        iArr[i2] = ((bArr[i + 3] & UnsignedBytes.MAX_VALUE) << 24) | (bArr[i] & UnsignedBytes.MAX_VALUE) | ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 8) | ((bArr[i + 2] & UnsignedBytes.MAX_VALUE) << 16);
        if (i3 == 16) {
            processBlock();
        }
    }
    ...
    public void processBlock() {
        ...
        int iRL287 = RL(((iRL282 + f5(iRL285, iRL283, iRL286)) + this.X[13]) - 1454113458, 6);
        ...
        int iRL319 = RL(iRL314 + f1(iRL317, iRL315, iRL318) + this.X[11], 11);
        int iRL320 = RL(iRL315, 10);
        int i6 = this.H1;
        this.H1 = this.H2 + iRL288 + iRL318;
        this.H2 = this.H3 + iRL286 + iRL316;
        this.H3 = this.H4 + iRL284 + iRL319 + iRL316;
        this.H4 = this.H0 + iRL287 + iRL284 + iRL317;
        this.H0 = iRL320 + iRL285 + i6;
        this.xOff = 0;
        int i7 = 0;
        while (true) {
            int[] iArr = this.X;
