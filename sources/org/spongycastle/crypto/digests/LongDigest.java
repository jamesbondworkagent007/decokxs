...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    public void processBlock() {
        ...
        while (i3 < 10) {
            long jSum1 = Sum1(j12);
            long j16 = j12;
            long jCh = Ch(j12, j8, j15);
            long[] jArr3 = K;
            int i4 = i2 + 1;
            long j17 = j13 + jSum1 + jCh + jArr3[i2] + this.W[i2];
            long j18 = j9 + j17;
            long jSum0 = j17 + Sum0(j14) + Maj(j14, j10, j11);
            int i5 = i2 + 2;
            long jSum12 = j15 + Sum1(j18) + Ch(j18, j16, j8) + jArr3[i4] + this.W[i4];
            long j19 = j11 + jSum12;
            long jSum02 = jSum12 + Sum0(jSum0) + Maj(jSum0, j14, j10);
            int i6 = i2 + 3;
            long jSum13 = j8 + Sum1(j19) + Ch(j19, j18, j16) + jArr3[i5] + this.W[i5];
            long j20 = j10 + jSum13;
            long jSum03 = jSum13 + Sum0(jSum02) + Maj(jSum02, jSum0, j14);
            int i7 = i2 + 4;
            long jSum14 = j16 + Sum1(j20) + Ch(j20, j19, j18) + jArr3[i6] + this.W[i6];
            long j21 = j14 + jSum14;
            long jSum04 = jSum14 + Sum0(jSum03) + Maj(jSum03, jSum02, jSum0);
            int i8 = i2 + 5;
            long jSum15 = j18 + Sum1(j21) + Ch(j21, j20, j19) + jArr3[i7] + this.W[i7];
            long j22 = jSum0 + jSum15;
            long jSum05 = jSum15 + Sum0(jSum04) + Maj(jSum04, jSum03, jSum02);
            int i9 = i2 + 6;
            long jSum16 = j19 + Sum1(j22) + Ch(j22, j21, j20) + jArr3[i8] + this.W[i8];
            long j23 = jSum02 + jSum16;
            long jSum06 = jSum16 + Sum0(jSum05) + Maj(jSum05, jSum04, jSum03);
            j15 = j23;
            int i10 = i2 + 7;
            long jSum17 = j20 + Sum1(j23) + Ch(j23, j22, j21) + jArr3[i9] + this.W[i9];
            long j24 = jSum03 + jSum17;
            long jSum07 = Sum0(jSum06);
            long jMaj = Maj(jSum06, jSum05, jSum04);
            j10 = jSum17 + jSum07 + jMaj;
            i2 += 8;
            long jSum18 = j21 + Sum1(j24) + Ch(j24, j15, j22) + jArr3[i10] + this.W[i10];
            long jSum08 = Sum0(j10);
            long jMaj2 = Maj(j10, jSum06, jSum05);
            i3++;
            j12 = jSum04 + jSum18;
            j14 = jSum18 + jSum08 + jMaj2;
            j8 = j24;
            j11 = jSum06;
            j13 = j22;
            j9 = jSum05;
