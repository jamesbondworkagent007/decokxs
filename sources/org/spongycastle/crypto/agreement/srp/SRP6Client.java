...
public class SRP6Client {
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        this.f1100a = bigIntegerSelectPrivateValue;
    ...
    private BigInteger calculateS() {
        ...
        return this.B.subtract(this.g.modPow(this.x, this.N).multiply(bigIntegerCalculateK).mod(this.N)).mod(this.N).modPow(this.u.multiply(this.x).add(this.f1100a), this.N);
    }
