...
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IOException, IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            System.arraycopy(iv, 0, this.iv, length3 - length4, iv.length);
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException, IOException {
        ...
        if (this.forEncryption) {
            System.arraycopy(bArr2, 0, bArr, i + iDoFinal, this.macSize);
            reset();
        ...
        System.arraycopy(this.macBlock, 0, bArr4, 0, i2);
