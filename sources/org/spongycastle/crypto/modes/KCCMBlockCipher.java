...
public class KCCMBlockCipher implements AEADBlockCipher {
    ...
    public int processPacket(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, InvalidCipherTextException, IOException {
        int i4;
        if (bArr.length - i < i2) {
            throw new DataLengthException("input buffer too short");
        }
    ...
    @Override // org.spongycastle.crypto.modes.AEADBlockCipher
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException, IOException {
    ...
    private byte getFlag(boolean z, int i) {
        ...
        if (i == 8) {
            ...
            stringBuffer.append(UnsignedSwapData.CALLDATA_TYPE_EVM_TRANSFER);
        } else if (i == 64) {
