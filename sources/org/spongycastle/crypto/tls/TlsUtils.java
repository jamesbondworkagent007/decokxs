...
public class TlsUtils {
    ...
    public static long readUint32(byte[] bArr, int i) {
        return ((long) ((bArr[i + 3] & UnsignedBytes.MAX_VALUE) | ((bArr[i] & UnsignedBytes.MAX_VALUE) << 24) | ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 16) | ((bArr[i + 2] & UnsignedBytes.MAX_VALUE) << 8))) & BodyPartID.bodyIdMax;
    }
    ...
    public static long readUint48(byte[] bArr, int i) {
        return (((long) readUint24(bArr, i + 3)) & BodyPartID.bodyIdMax) | ((((long) readUint24(bArr, i)) & BodyPartID.bodyIdMax) << 24);
    }
    ...
    public static void validateKeyUsage(org.spongycastle.asn1.x509.Certificate certificate, int i) throws IOException {
        ...
        if (extensions != null && (keyUsageFromExtensions = KeyUsage.fromExtensions(extensions)) != null && (keyUsageFromExtensions.getBytes()[0] & UnsignedBytes.MAX_VALUE & i) != i) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:55:0x0067 A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:62:0x0071 A[RETURN] */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x0059 A[RETURN] */
    ...
    */
    public static int getMACAlgorithm(int i) throws IOException {
        if (i != 1) {
            if (i != 2) {
                if (i != 4) {
                    if (i != 5 && i != 10 && i != 13 && i != 16 && i != 19 && i != 22) {
                        if (i != 24) {
                            if (i != 27) {
                                switch (i) {
                                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA /* 132 */:
