...
public class DESEngine implements BlockCipher {
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        int i3 = ((bArr[i] & UnsignedBytes.MAX_VALUE) << 24) | ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 16) | ((bArr[i + 2] & UnsignedBytes.MAX_VALUE) << 8) | (bArr[i + 3] & UnsignedBytes.MAX_VALUE);
        int i4 = ((bArr[i + 4] & UnsignedBytes.MAX_VALUE) << 24) | ((bArr[i + 5] & UnsignedBytes.MAX_VALUE) << 16) | ((bArr[i + 6] & UnsignedBytes.MAX_VALUE) << 8) | (bArr[i + 7] & UnsignedBytes.MAX_VALUE);
        ...
        int i15 = i12 ^ i14;
        int i16 = i13 ^ (i14 << 8);
        int i17 = (i16 << 1) | ((i16 >>> 31) & 1);
        int i18 = (i15 ^ i17) & (-1431655766);
        int i19 = i15 ^ i18;
        int i20 = i17 ^ i18;
        int i21 = (i19 << 1) | ((i19 >>> 31) & 1);
        for (int i22 = 0; i22 < 8; i22++) {
            ...
            int i39 = iArr6[i38 & 63];
            i20 ^= iArr9[(i38 >>> 24) & 63] | ((((i37 | ((i34 | i35) | i36)) | i39) | iArr7[(i38 >>> 8) & 63]) | iArr8[(i38 >>> 16) & 63]);
        }
        int i40 = (i20 << 31) | (i20 >>> 1);
        int i41 = (i21 ^ i40) & (-1431655766);
        int i42 = i21 ^ i41;
        int i43 = i40 ^ i41;
        int i44 = (i42 << 31) | (i42 >>> 1);
        ...
        int i49 = i46 ^ i48;
        int i50 = i47 ^ (i48 << 2);
        int i51 = ((i49 >>> 16) ^ i50) & 65535;
        int i52 = i50 ^ i51;
        int i53 = i49 ^ (i51 << 16);
        int i54 = ((i53 >>> 4) ^ i52) & 252645135;
        int i55 = i52 ^ i54;
        int i56 = i53 ^ (i54 << 4);
        bArr2[i2] = (byte) ((i56 >>> 24) & 255);
        bArr2[i2 + 1] = (byte) ((i56 >>> 16) & 255);
        bArr2[i2 + 2] = (byte) ((i56 >>> 8) & 255);
        bArr2[i2 + 3] = (byte) (i56 & 255);
        bArr2[i2 + 4] = (byte) ((i55 >>> 24) & 255);
        bArr2[i2 + 5] = (byte) ((i55 >>> 16) & 255);
        bArr2[i2 + 6] = (byte) ((i55 >>> 8) & 255);
        bArr2[i2 + 7] = (byte) (i55 & 255);
    }
}
