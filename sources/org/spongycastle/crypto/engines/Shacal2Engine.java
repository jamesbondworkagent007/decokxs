...
public class Shacal2Engine implements BlockCipher {
        ...
        if (bArr.length != 0 && bArr.length <= 64) {
            if (bArr.length >= 16 && bArr.length % 8 == 0) {
                ...
                for (int i = 16; i < 64; i++) {
                    ...
                    int i3 = iArr[i - 7];
                    int i4 = iArr[i - 15];
                    iArr[i] = ((((i2 << (-19)) | (i2 >>> 19)) ^ ((i2 >>> 17) | (i2 << (-17)))) ^ (i2 >>> 10)) + i3 + ((i4 >>> 3) ^ (((i4 << (-18)) | (i4 >>> 18)) ^ ((i4 >>> 7) | (i4 << (-7))))) + iArr[i - 16];
                }
                return;
            }
        }
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 0; i3 < 64; i3++) {
            ...
            int i5 = iArr[5];
            int i6 = iArr[6];
            int i7 = ((((i4 >>> 6) | (i4 << (-6))) ^ ((i4 >>> 11) | (i4 << (-11)))) ^ ((i4 >>> 25) | (i4 << (-25)))) + ((i4 & i5) ^ ((~i4) & i6)) + iArr[7] + K[i3] + this.workingKey[i3];
            iArr[7] = i6;
            iArr[6] = i5;
            iArr[5] = i4;
            iArr[4] = iArr[3] + i7;
            ...
            int i10 = iArr[0];
            iArr[1] = i10;
            iArr[0] = i7 + ((((i10 >>> 2) | (i10 << (-2))) ^ ((i10 >>> 13) | (i10 << (-13)))) ^ ((i10 >>> 22) | (i10 << (-22)))) + (((i10 & i9) ^ (i10 & i8)) ^ (i9 & i8));
        }
    ...
    private void bytes2ints(byte[] bArr, int[] iArr, int i, int i2) {
        while (i2 < bArr.length / 4) {
            int i3 = bArr[i];
            int i4 = (i3 & 255) << 24;
            iArr[i2] = (bArr[i + 3] & 255) | i4 | ((bArr[i + 1] & 255) << 16) | ((bArr[i + 2] & 255) << 8);
            i2++;
            i += 4;
        }
    }
