...
public class RijndaelEngine implements BlockCipher {
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (i8 < i) {
            ...
            while (i10 < i4) {
                ...
                jArr2[i10] = (((long) (bArr2[i10][i8] & UnsignedBytes.MAX_VALUE)) << ((i9 * 8) % i11)) | jArr2[i10];
                i10++;
                jArr = jArr;
                i4 = 4;
            }
        ...
        while (i9 < (this.ROUNDS + 1) * (this.BC / i3)) {
            ...
            while (i13 < 4) {
                ...
                i13++;
                bArr3[i5] = (byte) (bArr3[i5] ^ S[bArr2[i13 % 4][i - 1] & UnsignedBytes.MAX_VALUE]);
            }
            byte[] bArr4 = bArr2[i5];
            bArr4[i5] = (byte) (bArr4[i5] ^ rcon[i12]);
            if (i <= 6) {
                ...
                for (int i18 = i5; i18 < 4; i18++) {
                    ...
                    bArr7[4] = (byte) (bArr7[4] ^ S[bArr7[3] & UnsignedBytes.MAX_VALUE]);
                }
                int i19 = 5;
                while (i19 < i) {
                    int i20 = i5;
            ...
            int i21 = i5;
            while (i21 < i) {
                if (i9 < (this.ROUNDS + 1) * (this.BC / i3)) {
                    int i22 = i5;
                    while (i22 < 4) {
                        int i23 = this.BC;
                        long[] jArr4 = jArr3[i9 / (i23 / 8)];
                        jArr4[i22] = (((long) (bArr2[i22][i21] & UnsignedBytes.MAX_VALUE)) << ((i9 * 8) % i23)) | jArr4[i22];
                        i22++;
                        bArr2 = bArr2;
                    }
                    i21++;
    ...
    private void unpackBlock(byte[] bArr, int i) {
        ...
        this.A1 = bArr[i + 1] & UnsignedBytes.MAX_VALUE;
        this.A2 = bArr[i + 2] & UnsignedBytes.MAX_VALUE;
        int i2 = i + 4;
        this.A3 = bArr[i + 3] & UnsignedBytes.MAX_VALUE;
        int i3 = 8;
        while (i3 != this.BC) {
            this.A0 |= ((long) (bArr[i2] & UnsignedBytes.MAX_VALUE)) << i3;
            this.A1 |= ((long) (bArr[i2 + 1] & UnsignedBytes.MAX_VALUE)) << i3;
            this.A2 |= ((long) (bArr[i2 + 2] & UnsignedBytes.MAX_VALUE)) << i3;
            this.A3 |= ((long) (bArr[i2 + 3] & UnsignedBytes.MAX_VALUE)) << i3;
            i3 += 8;
            i2 += 4;
        }
    }
