...
public class DSTU7624Engine implements BlockCipher {
    ...
    private byte MultiplyGF(byte b, byte b2) {
        ...
        int i5 = 65280 & i3;
        int i6 = (((i5 >>> 6) ^ (((i5 >>> 4) ^ i5) ^ (i5 >>> 5))) ^ (i5 >>> 8)) ^ i3;
        int i7 = i6 & 3840;
        return (byte) (i6 ^ (((i7 >>> 6) ^ (((i7 >>> 4) ^ i7) ^ (i7 >>> 5))) ^ (i7 >>> 8)));
    }
    ...
    public DSTU7624Engine(int i) throws IllegalArgumentException {
        ...
        int i3 = (i2 * 64) / 8;
        this.internalStateBytes = new byte[i3];
        this.tempInternalStateBytes = new byte[i3];
    }

    /* JADX WARN: Removed duplicated region for block: B:38:0x006f A[LOOP:0: B:36:0x006a->B:38:0x006f, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:41:0x0085  */
    /* JADX WARN: Removed duplicated region for block: B:43:0x009a  */
    /* JADX WARN: Removed duplicated region for block: B:47:0x0078 A[EDGE_INSN: B:47:0x0078->B:39:0x0078 BREAK  A[LOOP:0: B:36:0x006a->B:38:0x006f], SYNTHETIC] */
    @Override // org.spongycastle.crypto.BlockCipher
    /*
    ...
    */
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof KeyParameter) {
            ...
            if (i4 == 128 && length == 512) {
                throw new IllegalArgumentException("Unsupported key length");
            }
            if (i4 == 256 && length == 128) {
                throw new IllegalArgumentException("Unsupported key length");
            }
            if (i4 == 512 && length != 512) {
                throw new IllegalArgumentException("Unsupported key length");
            }
            if (length == 128) {
                i = 10;
    ...
    private void SubBytes() {
        char c = 0;
        int i = 0;
        while (i < this.wordsInBlock) {
            long[] jArr = this.internalState;
            byte[][] bArr = this.sboxesForEncryption;
            byte[] bArr2 = bArr[c];
            long j = jArr[i];
            long j2 = bArr2[(int) (j & 255)];
            byte[] bArr3 = bArr[1];
            int i2 = i;
            long j3 = bArr3[(int) ((j & 65280) >>> 8)];
            byte[] bArr4 = bArr[2];
            long j4 = bArr4[(int) ((j & 16711680) >>> 16)];
            byte[] bArr5 = bArr[3];
            jArr[i2] = ((j3 << 8) & 65280) | (j2 & 255) | ((j4 << 16) & 16711680) | ((bArr5[(int) ((j & 4278190080L) >>> 24)] << 24) & 4278190080L) | ((bArr2[(int) ((j & 1095216660480L) >>> 32)] << 32) & 1095216660480L) | ((bArr3[(int) ((j & 280375465082880L) >>> 40)] << 40) & 280375465082880L) | ((bArr4[(int) ((j & 71776119061217280L) >>> 48)] << 48) & 71776119061217280L) | ((((long) bArr5[(int) ((j & (-72057594037927936L)) >>> 56)]) << 56) & (-72057594037927936L));
            i = i2 + 1;
            c = 0;
        }
    }
