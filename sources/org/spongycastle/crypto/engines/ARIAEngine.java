...
public class ARIAEngine implements BlockCipher {
    ...
    public static byte SB1(byte b) {
        return SB1_sbox[b & UnsignedBytes.MAX_VALUE];
    }

    public static byte SB2(byte b) {
        return SB2_sbox[b & UnsignedBytes.MAX_VALUE];
    }

    public static byte SB3(byte b) {
        return SB3_sbox[b & UnsignedBytes.MAX_VALUE];
    }

    public static byte SB4(byte b) {
        return SB4_sbox[b & UnsignedBytes.MAX_VALUE];
    }
