...
public abstract class SerpentEngineBase implements BlockCipher {
    ...
    public final void LT() {
        ...
        int i = this.X1;
        int i2 = this.X3;
        this.X1 = rotateLeft((i ^ iRotateLeft) ^ iRotateLeft2, 1);
        int iRotateLeft3 = rotateLeft((i2 ^ iRotateLeft2) ^ (iRotateLeft << 3), 7);
    ...
    public final void inverseLT() {
        ...
        int iRotateRight2 = rotateRight(this.X0, 5);
        int i = this.X1;
        int i2 = this.X3;
        int i3 = (iRotateRight2 ^ i) ^ i2;
