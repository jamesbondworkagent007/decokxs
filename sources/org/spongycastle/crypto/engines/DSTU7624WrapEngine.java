...
public class DSTU7624WrapEngine implements Wrapper {
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        ...
        while (i4 < i3 * 6) {
            ...
            i4++;
            intToBytes(i4, this.intArray, 0);
            for (int i5 = 0; i5 < 4; i5++) {
                int blockSize5 = (this.engine.getBlockSize() / 2) + i5;
                bArr2[blockSize5] = (byte) (bArr2[blockSize5] ^ this.intArray[i5]);
            }
            System.arraycopy(bArr2, this.engine.getBlockSize() / 2, this.B, 0, this.engine.getBlockSize() / 2);
            for (int i6 = 2; i6 < blockSize; i6++) {
                System.arraycopy(this.Btemp.get(i6 - 1), 0, this.Btemp.get(i6 - 2), 0, this.engine.getBlockSize() / 2);
            }
        ...
        for (int i7 = 0; i7 < i3; i7++) {
            System.arraycopy(this.Btemp.get(i7), 0, bArr2, blockSize6, this.engine.getBlockSize() / 2);
