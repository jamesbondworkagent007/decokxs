...
public class IDEAEngine implements BlockCipher {
    ...
    private int bytesToWord(byte[] bArr, int i) {
        return ((bArr[i] << 8) & 65280) + (bArr[i + 1] & UnsignedBytes.MAX_VALUE);
    }
    ...
    private void ideaFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i7 = 0;
        while (i7 < 8) {
            int iMul = mul(i6, iArr[i3]);
            int i8 = (i5 + iArr[i3 + 1]) & 65535;
            int i9 = (i4 + iArr[i3 + 2]) & 65535;
            int iMul2 = mul(iBytesToWord4, iArr[i3 + 3]);
            int iMul3 = mul(i9 ^ iMul, iArr[i3 + 4]);
            int i10 = i3 + 6;
            int iMul4 = mul(((i8 ^ iMul2) + iMul3) & 65535, iArr[i3 + 5]);
        ...
        wordToBytes(mul(iBytesToWord4, iArr[i3 + 3]), bArr2, i2 + 6);
    }
