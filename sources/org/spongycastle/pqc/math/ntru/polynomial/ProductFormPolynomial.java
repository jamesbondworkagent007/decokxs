...
public class ProductFormPolynomial implements Polynomial {
    ...
    public int hashCode() {
        ...
        int iHashCode = sparseTernaryPolynomial == null ? 0 : sparseTernaryPolynomial.hashCode();
        SparseTernaryPolynomial sparseTernaryPolynomial2 = this.f2;
        int iHashCode2 = sparseTernaryPolynomial2 == null ? 0 : sparseTernaryPolynomial2.hashCode();
        SparseTernaryPolynomial sparseTernaryPolynomial3 = this.f3;
        return ((((iHashCode + 31) * 31) + iHashCode2) * 31) + (sparseTernaryPolynomial3 != null ? sparseTernaryPolynomial3.hashCode() : 0);
    }
