...
public class ArrayEncoder {
    ...
    public static int[] decodeModQ(byte[] bArr, int i, int i2) {
        ...
        int i3 = 0;
        for (int i4 = 0; i4 < i * iNumberOfLeadingZeros; i4++) {
            if (i4 > 0 && i4 % iNumberOfLeadingZeros == 0) {
                i3++;
            }
            iArr[i3] = iArr[i3] + (getBit(bArr, i4) << (i4 % iNumberOfLeadingZeros));
        }
        return iArr;
    }
    ...
    public static int[] decodeMod3Sves(byte[] bArr, int i) {
        ...
        while (i2 < bArr.length * 8) {
            int i4 = i2 + 3;
            int bit = (getBit(bArr, i2) * 4) + (getBit(bArr, i2 + 1) * 2) + getBit(bArr, i2 + 2);
            iArr[i3] = COEFF1_TABLE[bit];
            int i5 = i3 + 2;
            iArr[i3 + 1] = COEFF2_TABLE[bit];
            if (i5 > i - 2) {
                break;
            }
            i3 = i5;
