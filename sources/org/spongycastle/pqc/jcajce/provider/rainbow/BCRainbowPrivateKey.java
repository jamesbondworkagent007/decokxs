...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    public int hashCode() {
        ...
        int iHashCode = org.spongycastle.util.Arrays.hashCode(this.A1inv);
        int iHashCode2 = org.spongycastle.util.Arrays.hashCode(this.b1);
        int iHashCode3 = (((((((((length * 37) + iHashCode) * 37) + iHashCode2) * 37) + org.spongycastle.util.Arrays.hashCode(this.A2inv)) * 37) + org.spongycastle.util.Arrays.hashCode(this.b2)) * 37) + org.spongycastle.util.Arrays.hashCode(this.vi);
        for (int length2 = this.layers.length - 1; length2 >= 0; length2--) {
            iHashCode3 = (iHashCode3 * 37) + this.layers[length2].hashCode();
        }
        return iHashCode3;
    }
