...
public class GMSSPrivateKey extends ASN1Object {
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i29 < gMSSRootCalcArr.length) {
            ...
            ASN1EncodableVector aSN1EncodableVector53 = aSN1EncodableVector43;
            ASN1EncodableVector aSN1EncodableVector54 = aSN1EncodableVector50;
            ...
            if (gMSSRootCalcArr[i29].getTreehash() != null) {
                ...
                while (i36 < gMSSRootCalcArr[i29].getTreehash().length) {
                    aSN1EncodableVector56.add(new DERSequence(algorithmIdentifierArr[0]));
                    int i37 = gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[1];
                    aSN1EncodableVector57.add(new DEROctetString(gMSSRootCalcArr[i29].getTreehash()[i36].getStatByte()[0]));
                    aSN1EncodableVector57.add(new DEROctetString(gMSSRootCalcArr[i29].getTreehash()[i36].getStatByte()[1]));
                    aSN1EncodableVector57.add(new DEROctetString(gMSSRootCalcArr[i29].getTreehash()[i36].getStatByte()[2]));
                    int i38 = 0;
                    while (i38 < i37) {
                        aSN1EncodableVector57.add(new DEROctetString(gMSSRootCalcArr[i29].getTreehash()[i36].getStatByte()[i38 + 3]));
                        i38++;
                    ...
                    ASN1EncodableVector aSN1EncodableVector60 = aSN1EncodableVector55;
                    aSN1EncodableVector58.add(new ASN1Integer(gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[0]));
                    aSN1EncodableVector58.add(new ASN1Integer(i37));
                    aSN1EncodableVector58.add(new ASN1Integer(gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[2]));
                    aSN1EncodableVector58.add(new ASN1Integer(gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[3]));
                    aSN1EncodableVector58.add(new ASN1Integer(gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[4]));
                    aSN1EncodableVector58.add(new ASN1Integer(gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[5]));
                    int i39 = 0;
                    while (i39 < i37) {
                        aSN1EncodableVector58.add(new ASN1Integer(gMSSRootCalcArr[i29].getTreehash()[i36].getStatInt()[i39 + 6]));
                        i39++;
                        aSN1EncodableVector53 = aSN1EncodableVector53;
                    }
                    aSN1EncodableVector56.add(new DERSequence(aSN1EncodableVector58));
                    ...
                    i36++;
                    aSN1EncodableVector52 = aSN1EncodableVector59;
                    aSN1EncodableVector55 = aSN1EncodableVector60;
                }
            }
            ASN1EncodableVector aSN1EncodableVector61 = aSN1EncodableVector52;
            ASN1EncodableVector aSN1EncodableVector62 = aSN1EncodableVector55;
            ASN1EncodableVector aSN1EncodableVector63 = aSN1EncodableVector53;
            aSN1EncodableVector47.add(new DERSequence(aSN1EncodableVector54));
            ...
            if (gMSSRootCalcArr[i29].getRetain() != null) {
                for (int i40 = 0; i40 < gMSSRootCalcArr[i29].getRetain().length; i40++) {
                    for (int i41 = 0; i41 < gMSSRootCalcArr[i29].getRetain()[i40].size(); i41++) {
                        aSN1EncodableVector64.add(new DEROctetString((byte[]) gMSSRootCalcArr[i29].getRetain()[i40].elementAt(i41)));
                    }
                    aSN1EncodableVector51.add(new DERSequence(aSN1EncodableVector64));
            ...
            i29++;
            aSN1EncodableVector48 = aSN1EncodableVector61;
            aSN1EncodableVector49 = aSN1EncodableVector62;
            aSN1EncodableVector43 = aSN1EncodableVector63;
        }
        ASN1EncodableVector aSN1EncodableVector65 = aSN1EncodableVector43;
        aSN1EncodableVector65.add(new DERSequence(aSN1EncodableVector46));
        ASN1EncodableVector aSN1EncodableVector66 = new ASN1EncodableVector();
        for (byte[] bArr14 : bArr7) {
            aSN1EncodableVector66.add(new DEROctetString(bArr14));
        }
        ...
        for (int i42 = 0; i42 < gMSSRootSigArr.length; i42++) {
            ...
            new ASN1EncodableVector();
            aSN1EncodableVector69.add(new DEROctetString(gMSSRootSigArr[i42].getStatByte()[0]));
            aSN1EncodableVector69.add(new DEROctetString(gMSSRootSigArr[i42].getStatByte()[1]));
            aSN1EncodableVector69.add(new DEROctetString(gMSSRootSigArr[i42].getStatByte()[2]));
            aSN1EncodableVector69.add(new DEROctetString(gMSSRootSigArr[i42].getStatByte()[3]));
            aSN1EncodableVector69.add(new DEROctetString(gMSSRootSigArr[i42].getStatByte()[4]));
            aSN1EncodableVector68.add(new DERSequence(aSN1EncodableVector69));
            aSN1EncodableVector69 = new ASN1EncodableVector();
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[0]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[1]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[2]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[3]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[4]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[5]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[6]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[7]));
            aSN1EncodableVector70.add(new ASN1Integer(gMSSRootSigArr[i42].getStatInt()[8]));
        ...
        for (int i43 = 0; i43 < gMSSParameters.getHeightOfTrees().length; i43++) {
            aSN1EncodableVector72.add(new ASN1Integer(gMSSParameters.getHeightOfTrees()[i43]));
            aSN1EncodableVector73.add(new ASN1Integer(gMSSParameters.getWinternitzParameter()[i43]));
            aSN1EncodableVector74.add(new ASN1Integer(gMSSParameters.getK()[i43]));
        }
        aSN1EncodableVector71.add(new ASN1Integer(gMSSParameters.getNumOfLayers()));
        ...
        aSN1EncodableVector65.add(new DERSequence(aSN1EncodableVector71));
        ...
        for (AlgorithmIdentifier algorithmIdentifier : algorithmIdentifierArr) {
            aSN1EncodableVector75.add(algorithmIdentifier);
        }
        aSN1EncodableVector65.add(new DERSequence(aSN1EncodableVector75));
        return new DERSequence(aSN1EncodableVector65);
    }
