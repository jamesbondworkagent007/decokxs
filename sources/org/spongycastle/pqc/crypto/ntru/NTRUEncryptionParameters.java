...
public class NTRUEncryptionParameters implements Cloneable {
    ...
    private void init() {
        ...
        int i2 = (i * 3) / 2;
        int i3 = this.db;
        this.maxMsgLenBytes = (((i2 / 8) - 1) - (i3 / 8)) - 1;
        this.bufferLenBits = (((i2 + 7) / 8) * 8) + 1;
    ...
    public int hashCode() {
        ...
        int i14 = this.dr2;
        int i15 = this.dr3;
        int i16 = this.fastFp ? 1231 : 1237;
        Digest digest = this.hashAlg;
        int iHashCode = digest == null ? 0 : digest.getAlgorithmName().hashCode();
        int i17 = this.hashSeed ? 1231 : 1237;
        int i18 = this.llen;
        int i19 = this.maxMsgLenBytes;
        int i20 = this.minCallsMask;
        int i21 = this.minCallsR;
        int iHashCode2 = Arrays.hashCode(this.oid);
        int i22 = this.pkLen;
        int i23 = this.polyType;
        return ((((((((((((((((((((((((((((((((((((((((((((((((((((i + 31) * 31) + i2) * 31) + i3) * 31) + i4) * 31) + i5) * 31) + i6) * 31) + i7) * 31) + i8) * 31) + i9) * 31) + i10) * 31) + i11) * 31) + i12) * 31) + i13) * 31) + i14) * 31) + i15) * 31) + i16) * 31) + iHashCode) * 31) + i17) * 31) + i18) * 31) + i19) * 31) + i20) * 31) + i21) * 31) + iHashCode2) * 31) + i22) * 31) + i23) * 31) + this.q) * 31) + (this.sparse ? 1231 : 1237);
    }
