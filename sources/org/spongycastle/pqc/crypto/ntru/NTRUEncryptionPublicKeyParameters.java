...
public class NTRUEncryptionPublicKeyParameters extends NTRUEncryptionKeyParameters {
    ...
    public int hashCode() {
        ...
        int iHashCode = integerPolynomial == null ? 0 : integerPolynomial.hashCode();
        NTRUEncryptionParameters nTRUEncryptionParameters = this.params;
        return ((iHashCode + 31) * 31) + (nTRUEncryptionParameters != null ? nTRUEncryptionParameters.hashCode() : 0);
    }
