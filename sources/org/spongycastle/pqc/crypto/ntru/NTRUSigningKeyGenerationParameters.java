...
public class NTRUSigningKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    public int hashCode() {
        ...
        int i5 = (int) (jDoubleToLongBits2 ^ (jDoubleToLongBits2 >>> 32));
        int i6 = this.bitsF;
        int i7 = this.d;
        int i8 = this.d1;
        int i9 = this.d2;
        ...
        int i12 = (int) (jDoubleToLongBits3 ^ (jDoubleToLongBits3 >>> 32));
        long jDoubleToLongBits4 = Double.doubleToLongBits(this.keyNormBoundSq);
        int i13 = (int) (jDoubleToLongBits4 ^ (jDoubleToLongBits4 >>> 32));
        long jDoubleToLongBits5 = Double.doubleToLongBits(this.normBound);
        int i14 = (int) (jDoubleToLongBits5 ^ (jDoubleToLongBits5 >>> 32));
        long jDoubleToLongBits6 = Double.doubleToLongBits(this.normBoundSq);
        int i15 = (int) (jDoubleToLongBits6 ^ (jDoubleToLongBits6 >>> 32));
        int i16 = this.polyType;
        int i17 = this.primeCheck ? 1231 : 1237;
        int i18 = this.q;
        return ((((((((((((((((((((((((((((((((((((((((i + 31) * 31) + i2) * 31) + i3) * 31) + i4) * 31) + i5) * 31) + i6) * 31) + i7) * 31) + i8) * 31) + i9) * 31) + i10) * 31) + iHashCode) * 31) + i11) * 31) + i12) * 31) + i13) * 31) + i14) * 31) + i15) * 31) + i16) * 31) + i17) * 31) + i18) * 31) + this.signFailTolerance) * 31) + (this.sparse ? 1231 : 1237);
    }
