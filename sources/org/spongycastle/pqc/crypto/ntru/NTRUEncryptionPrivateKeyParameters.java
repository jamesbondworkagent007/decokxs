...
public class NTRUEncryptionPrivateKeyParameters extends NTRUEncryptionKeyParameters {
    ...
    public int hashCode() {
        ...
        int iHashCode = nTRUEncryptionParameters == null ? 0 : nTRUEncryptionParameters.hashCode();
        Polynomial polynomial = this.t;
        int iHashCode2 = polynomial == null ? 0 : polynomial.hashCode();
        IntegerPolynomial integerPolynomial = this.h;
        return ((((iHashCode + 31) * 31) + iHashCode2) * 31) + (integerPolynomial != null ? integerPolynomial.hashCode() : 0);
    }
