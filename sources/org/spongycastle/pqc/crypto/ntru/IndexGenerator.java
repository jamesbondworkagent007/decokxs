...
public class IndexGenerator {
    ...
    public int nextIndex() {
        ...
        do {
            ...
            i = this.N;
            i2 = 1 << i13;
        } while (leadingAsInt >= i2 - (i2 % i));
        return leadingAsInt % i;
    }
    ...
    public static class BitString {
        ...
        public int getLeadingAsInt(int i) {
            ...
            int i3 = i2 / 8;
            int i4 = i2 % 8;
            int i5 = (this.bytes[i3] & UnsignedBytes.MAX_VALUE) >>> i4;
            int i6 = 8 - i4;
            while (true) {
                i3++;
                if (i3 >= this.numBytes) {
                ...
                i5 |= (this.bytes[i3] & UnsignedBytes.MAX_VALUE) << i6;
                i6 += 8;
            }
        }
