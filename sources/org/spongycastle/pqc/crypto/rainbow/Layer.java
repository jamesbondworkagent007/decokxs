...
public class Layer {
    ...
    public short[][] plugInVinegars(short[] sArr) {
        ...
        for (int i11 = 0; i11 < this.oi; i11++) {
            for (int i12 = this.vi; i12 < this.viNext; i12++) {
                ...
                int i13 = i12 - this.vi;
                sArr5[i13] = GF2Field.addElem(this.coeff_gamma[i11][i12], sArr5[i13]);
            }
        }
    ...
    public int hashCode() {
        ...
        int i2 = this.viNext;
        int i3 = this.oi;
        int iHashCode = Arrays.hashCode(this.coeff_alpha);
        int iHashCode2 = Arrays.hashCode(this.coeff_beta);
        return (((((((((((i * 37) + i2) * 37) + i3) * 37) + iHashCode) * 37) + iHashCode2) * 37) + Arrays.hashCode(this.coeff_gamma)) * 37) + Arrays.hashCode(this.coeff_eta);
    }
}
