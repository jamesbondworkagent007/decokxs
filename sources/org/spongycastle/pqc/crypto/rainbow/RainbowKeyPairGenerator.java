...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void computePublicKey() {
            ...
            while (i6 < length) {
                ...
                while (i7 < length) {
                    while (i < length2) {
                        ...
                        int i9 = i2;
                        int i10 = i7 + length2;
                        short[] sArrMultVect = computeInField.multVect(coeffAlpha[i6][i7][i], this.A2[i10]);
                        int i11 = i5 + i6;
                        int i12 = i4;
                        sArr[i11] = computeInField.addSquareMatrix(sArr[i11], computeInField.multVects(sArrMultVect, this.A2[i]));
                        short[] sArrMultVect2 = computeInField.multVect(this.b2[i], sArrMultVect);
                        short[][] sArr3 = this.pub_singular;
                        sArr3[i11] = computeInField.addVect(sArrMultVect2, sArr3[i11]);
                        short[] sArrMultVect3 = computeInField.multVect(this.b2[i10], computeInField.multVect(coeffAlpha[i6][i7][i], this.A2[i]));
                        short[][] sArr4 = this.pub_singular;
                        sArr4[i11] = computeInField.addVect(sArrMultVect3, sArr4[i11]);
                        short sMultElem = GF2Field.multElem(coeffAlpha[i6][i7][i], this.b2[i10]);
                        short[] sArr5 = this.pub_scalar;
                        sArr5[i11] = GF2Field.addElem(sArr5[i11], GF2Field.multElem(sMultElem, this.b2[i]));
                        i++;
                        i2 = i9;
                        i3 = i8;
                ...
                for (int i16 = 0; i16 < length2; i16++) {
                    for (int i17 = 0; i17 < length2; i17++) {
                        short[] sArrMultVect4 = computeInField.multVect(coeffBeta[i6][i16][i17], this.A2[i16]);
                        int i18 = i5 + i6;
                        ...
                        short[] sArrMultVect6 = computeInField.multVect(this.b2[i16], computeInField.multVect(coeffBeta[i6][i16][i17], this.A2[i17]));
                        short[][] sArr9 = this.pub_singular;
                        sArr9[i18] = computeInField.addVect(sArrMultVect6, sArr9[i18]);
                        short sMultElem2 = GF2Field.multElem(coeffBeta[i6][i16][i17], this.b2[i16]);
                ...
                for (int i19 = 0; i19 < length2 + length; i19++) {
                    short[] sArrMultVect7 = computeInField.multVect(coeffGamma[i6][i19], this.A2[i19]);
        ...
        short[][][] sArr14 = (short[][][]) Array.newInstance((Class<?>) cls2, i2, i3, i3);
        short[][] sArr15 = (short[][]) Array.newInstance((Class<?>) cls2, i2, i3);
