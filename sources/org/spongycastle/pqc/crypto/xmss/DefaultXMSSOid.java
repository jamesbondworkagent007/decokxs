...
public final class DefaultXMSSOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA-512", 64, 16, DateFormat.RELATIVE_SHORT, 10), new DefaultXMSSOid(67108868, "XMSS_SHA2-512_W16_H10"));
        map.put(createKey("SHA-512", 64, 16, DateFormat.RELATIVE_SHORT, 16), new DefaultXMSSOid(83886085, "XMSS_SHA2-512_W16_H16"));
        map.put(createKey("SHA-512", 64, 16, DateFormat.RELATIVE_SHORT, 20), new DefaultXMSSOid(100663302, "XMSS_SHA2-512_W16_H20"));
        ...
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 10), new DefaultXMSSOid(167772170, "XMSS_SHAKE256_W16_H10"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 16), new DefaultXMSSOid(184549387, "XMSS_SHAKE256_W16_H16"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 20), new DefaultXMSSOid(201326604, "XMSS_SHAKE256_W16_H20"));
