...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 20, 2), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H20_D2"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 20, 4), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H20_D4"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 40, 2), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H40_D2"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 40, 4), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H40_D4"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 40, 8), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H40_D8"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 60, 3), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H60_D3"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 60, 6), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H60_D6"));
        map.put(createKey("SHA2-512", 64, 16, DateFormat.RELATIVE_SHORT, 60, 12), new DefaultXMSSMTOid(16777217, "XMSSMT_SHA2-512_W16_H60_D12"));
        ...
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 20, 2), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H20_D2"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 20, 4), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H20_D4"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 40, 2), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H40_D2"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 40, 4), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H40_D4"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 40, 8), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H40_D8"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 60, 3), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H60_D3"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 60, 6), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H60_D6"));
        map.put(createKey("SHAKE256", 64, 16, DateFormat.RELATIVE_SHORT, 60, 12), new DefaultXMSSMTOid(16777217, "XMSSMT_SHAKE256_W16_H60_D12"));
