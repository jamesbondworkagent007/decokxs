        ...
        if (8 % i4 == 0) {
            ...
            while (i22 < i20) {
                ...
                for (int i26 = 0; i26 < this.w; i26++) {
                    j ^= (long) ((bArr4[i23] & UnsignedBytes.MAX_VALUE) << (i26 << 3));
                    i23++;
                }
                int i27 = 0;
                while (i27 < i5) {
            ...
            long j2 = 0;
            while (i32 < i31) {
                j2 ^= (long) ((bArr4[i23] & UnsignedBytes.MAX_VALUE) << (i32 << 3));
                i23++;
                i32++;
                i31 = i31;
            }
            ...
            int i38 = (this.messagesize << this.w) - i24;
            int i39 = 0;
            ...
            while (i47 <= (i43 << 3) - i4) {
                ...
                int i49 = 0;
                long j3 = 0;
                for (int i50 = i47 >>> 3; i50 < ((i48 + 7) >>> 3); i50++) {
                    j3 ^= (long) ((bArr4[i50] & UnsignedBytes.MAX_VALUE) << (i49 << 3));
                    i49++;
                }
                long j4 = (j3 >>> (i47 % 8)) & ((long) i44);
                i45 = (int) (((long) i45) + j4);
                System.arraycopy(this.privateKeyOTS[i46], 0, bArr7, 0, this.mdsize);
                while (j4 > 0) {
                ...
                int i51 = this.mdsize;
                System.arraycopy(bArr7, 0, bArr2, i46 * i51, i51);
                i46++;
                i47 = i48;
            }
            int i52 = i47 >>> 3;
            if (i52 < this.mdsize) {
                ...
                while (true) {
                    ...
                    j5 ^= (long) ((bArr4[i52] & UnsignedBytes.MAX_VALUE) << (i53 << 3));
                    i53++;
                    i52++;
                }
                long j6 = (j5 >>> (i47 % 8)) & ((long) i44);
                i45 = (int) (((long) i45) + j6);
                System.arraycopy(this.privateKeyOTS[i46], 0, bArr7, 0, i);
                while (j6 > 0) {
                    this.messDigestOTS.update(bArr7, 0, bArr7.length);
                    bArr7 = new byte[this.messDigestOTS.getDigestSize()];
                    this.messDigestOTS.doFinal(bArr7, 0);
                ...
                int i54 = this.mdsize;
                System.arraycopy(bArr7, 0, bArr2, i46 * i54, i54);
                i46++;
            }
            int i55 = (this.messagesize << this.w) - i45;
            int i56 = 0;
            while (i56 < this.checksumsize) {
                System.arraycopy(this.privateKeyOTS[i46], 0, bArr7, 0, this.mdsize);
                for (long j7 = i55 & i44; j7 > 0; j7--) {
                    this.messDigestOTS.update(bArr7, 0, bArr7.length);
                    bArr7 = new byte[this.messDigestOTS.getDigestSize()];
                    this.messDigestOTS.doFinal(bArr7, 0);
                }
                int i57 = this.mdsize;
                System.arraycopy(bArr7, 0, bArr2, i46 * i57, i57);
                int i58 = this.w;
                i55 >>>= i58;
                i46++;
                i56 += i58;
