...
public class IETFUtils {
    ...
    public static ASN1Encodable valueFromHexString(String str, int i) throws IOException {
        ...
        for (int i2 = 0; i2 != length; i2++) {
            ...
            bArr[i2] = (byte) (convertHex(str.charAt(i3 + 1)) | (convertHex(cCharAt) << 4));
        }
    ...
    public static String valueToString(ASN1Encodable aSN1Encodable) {
        ...
        if ((aSN1Encodable instanceof ASN1String) && !(aSN1Encodable instanceof DERUniversalString)) {
            ...
            try {
                stringBuffer.append(ModelIdentifier.Helper.PRIMARY_KEY_DELIMITER + bytesToString(Hex.encode(aSN1Encodable.toASN1Primitive().getEncoded("DER"))));
