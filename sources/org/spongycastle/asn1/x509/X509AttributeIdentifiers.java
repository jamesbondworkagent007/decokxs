...
public interface X509AttributeIdentifiers {
    ...
    static {
        ...
        id_pe_aaControls = aSN1ObjectIdentifier.branch(OrderDetailListItem.SLIP_OUT);
        ...
        id_aca_encAttrs = aSN1ObjectIdentifierBranch.branch(OrderDetailListItem.SLIP_OUT);
