    ...
    private int[] parseIPv6(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.equals(":")) {
                ...
                StringTokenizer stringTokenizer2 = new StringTokenizer(strNextToken, JwtUtilsKt.JWT_DELIMITER);
                iArr[i2] = (Integer.parseInt(stringTokenizer2.nextToken()) << 8) | Integer.parseInt(stringTokenizer2.nextToken());
                iArr[i2 + 1] = Integer.parseInt(stringTokenizer2.nextToken()) | (Integer.parseInt(stringTokenizer2.nextToken()) << 8);
                i2 += 2;
            }
        }
        if (i2 != 8) {
