...
public final class IntegrityCheckingUniffiLib {
    ...
    public final native int ffi_oklogging_uniffi_contract_version();

    public final native short uniffi_oklogging_checksum_func_register_platform_logger();

    public final native short uniffi_oklogging_checksum_method_platformlogger_write_log();
    ...
    static {
        ...
        Native.register((Class<?>) IntegrityCheckingUniffiLib.class, C60173zxj.findLibraryName("oklogging"));
        ...
        BfX.uniffiCheckContractApiVersion(integrityCheckingUniffiLib);
    }
}
