...
public class JzvdStd extends Jzvd {
        ...
        if (id == R.id.surface_container) {
            if (motionEvent.getAction() == 1) {
                ...
                if (this.mChangePosition) {
                    ...
                    this.bottomProgressBar.setProgress((int) ((j * 100) / duration));
                }
            }
    ...
    public void clickClarity() {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: cn.jzvd.JzvdStd$$ExternalSyntheticLambda3
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$clickClarity$0(linearLayout, view);
            }
        };
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() { // from class: cn.jzvd.JzvdStd$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showWifiDialog$1(dialogInterface, i);
            }
        });
        builder.setNegativeButton(getResources().getString(R.string.tips_not_wifi_cancel), new DialogInterface.OnClickListener() { // from class: cn.jzvd.JzvdStd$$ExternalSyntheticLambda1
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showWifiDialog$2(dialogInterface, i);
            }
        });
    ...
    public void dissmissControlView() {
        ...
        post(new Runnable() { // from class: cn.jzvd.JzvdStd$$ExternalSyntheticLambda2
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$dissmissControlView$3();
            }
        });
    }
