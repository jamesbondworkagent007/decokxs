...
public final class JI implements InterfaceC5243Kf {
    ...
    public Storage KWHzl(@NotNull JZ jz, java.lang.String str) {
        ...
        android.content.SharedPreferences sharedPreferences = c5216Je.copydefault().getSharedPreferences("amplitude-events-" + c5216Je.fetchVPNInfo(), 0);
        java.lang.String strFetchVPNInfo = c5216Je.fetchVPNInfo();
        Logger logger = c5216Je.AuCTel().getLogger(jz);
        Intrinsics.checkNotNullExpressionValue(sharedPreferences, "");
        return new JM(strFetchVPNInfo, logger, sharedPreferences, JJ.copydefault.OLrzqt(c5216Je), jz.values());
    }
}
