...
public final class C48101uF {
    public static final C46697tc AEQbTJ(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        C46697tc.ActionBar actionBar = new C46697tc.ActionBar();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    actionBar.copydefault(AbstractC47015ti.EZpvd.AEQbTJ(stateListAnimatorEZpvd.fetchVPNInfo()));
