...
public final class CaptivePortal {
    public static final void copydefault(@NotNull InterfaceC5106Ey interfaceC5106Ey, @NotNull FullBackup fullBackup) {
        ...
        ebEZpvd.AEQbTJ(c5101Et, fullBackup.EZpvd().EZpvd());
        ebEZpvd.AEQbTJ();
    }
}
