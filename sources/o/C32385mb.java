...
import aws.sdk.kotlin.services.rekognition.model.ThrottlingException;
import aws.sdk.kotlin.services.rekognition.serde.ThrottlingExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.mb, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C32385mb implements BB<ThrottlingException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super ThrottlingException> continuation) throws java.lang.Throwable {
        ...
        ThrottlingException.TaskDescription taskDescription;
        ...
        if (i2 == 0) {
            ...
            ThrottlingException.TaskDescription taskDescription2 = new ThrottlingException.TaskDescription();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            throttlingExceptionDeserializer$deserialize$1.L$0 = taskDescription2;
            ...
            taskDescription = (ThrottlingException.TaskDescription) throttlingExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C32386mc.KWHzl(taskDescription, bArr);
        }
