...
public final class C52938wc {
    public static final byte[] copydefault(DT dt, final C46429tU c46429tU) {
        EW ew = new EW();
        ...
        java.lang.String strCopydefault = c46429tU.copydefault();
        if (strCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et, strCopydefault);
        }
        if (c46429tU.OLrzqt() != null) {
            ebEZpvd.EZpvd(c5101Et2, new Function1<InterfaceC5094Em, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.TagResourceOperationSerializerKt$serializeTagResourceOperationBody$1$2
                ...
                /* JADX INFO: renamed from: aws.sdk.kotlin.services.translate.serde.TagResourceOperationSerializerKt$serializeTagResourceOperationBody$1$2$1, reason: invalid class name */
                ...
                public final void invoke2(@NotNull InterfaceC5094Em interfaceC5094Em) {
                    ...
                    Iterator<C46240tN> it = c46429tU.OLrzqt().iterator();
                    while (it.hasNext()) {
