...
public final class C18579fl implements BH<MediaControlView2> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull MediaControlView2 mediaControlView2, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.DetectFacesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C18738fo.copydefault(dt, mediaControlView2)));
