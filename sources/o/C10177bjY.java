...
public final class C10177bjY extends AbstractC10170bjR {
    ...
    public C10177bjY(@NotNull android.content.Context context, @NotNull TxIdOrHashHistoryDetail txIdOrHashHistoryDetail) {
    ...
    public java.lang.String fARcdN() {
        ...
        if (txType != 80) {
            switch (txType) {
                case 66:
                    return C33070mpX.AYXKKw(C13754dXa.FragmentManager.QSLkRj);
                case 67:
                    return C33070mpX.AYXKKw(C13754dXa.FragmentManager.QwvEab);
                case 68:
                    return C33070mpX.AYXKKw(C13754dXa.FragmentManager.QCjLjM);
                default:
                    return C33070mpX.AYXKKw(C13754dXa.FragmentManager.ComponentActivity);
            }
        }
        java.lang.String kysTxTypeText = fJNWhG().getKysTxTypeText();
        return (kysTxTypeText == null || kysTxTypeText.length() == 0) ? C33070mpX.AYXKKw(C13754dXa.FragmentManager.ComponentActivity) : kysTxTypeText;
    }
    ...
    public java.util.List<AbstractC10168bjP> AYXKKw() {
        ...
        while (it.hasNext()) {
            arrayList.add(generateCoinOrNftData$default(this, (TxAssetChangeBean) it.next(), false, 2, null));
        }
        return arrayList;
    }
    ...
    public java.util.List<AbstractC10168bjP> DbNXlk() {
        ...
        while (it.hasNext()) {
            arrayList.add(OLrzqt((TxAssetChangeBean) it.next(), true));
        }
        return arrayList;
    }
    ...
    public static /* synthetic */ AbstractC10168bjP generateCoinOrNftData$default(C10177bjY c10177bjY, TxAssetChangeBean txAssetChangeBean, boolean z, int i, java.lang.Object obj) {
        if ((i & 2) != 0) {
            z = false;
        }
        return c10177bjY.OLrzqt(txAssetChangeBean, z);
    }

    public final AbstractC10168bjP OLrzqt(TxAssetChangeBean txAssetChangeBean, boolean z) {
        int iTradeRiseDefault$default;
        java.lang.Integer hideTxType;
        ...
        if (zOLrzqt) {
            ...
            return new AbstractC10168bjP.Activity(nftId, str2, str3, " ", name == null ? "" : name, iTradeRiseDefault$default2, fJNWhG().getCoinId(), null, !yDY.gEmmrt(66, 67, 68).contains(java.lang.Integer.valueOf(fJNWhG().getTxType())), 128, null);
        }
        ...
        java.lang.Long coinId = txAssetChangeBean.getCoinId();
        return new AbstractC10168bjP.TaskDescription(str4, str5, " ", str6, iTradeRiseDefault$default, false, false, 0, zUzCIH, false, null, 0, coinId != null ? coinId.longValue() : -1L, z && OLrzqt(txAssetChangeBean.getCoinId()) && (hideTxType = fJNWhG().getHideTxType()) != null && hideTxType.intValue() == 0, 3808, null);
    }
}
