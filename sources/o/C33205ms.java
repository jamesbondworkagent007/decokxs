...
public final class C33205ms implements BH<C12707cs> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C12707cs c12707cs, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.UpdateDatasetEntriesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C33152mr.EZpvd(dt, c12707cs)));
