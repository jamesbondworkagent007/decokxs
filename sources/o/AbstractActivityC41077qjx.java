...
public abstract class AbstractActivityC41077qjx extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC41077qjx() {
        EZpvd();
    }

    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.qjx.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC41077qjx.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.EZpvd = true;
        ((InterfaceC41031qjD) aA_()).AEQbTJ((ActivityC41028qjA) C58163ywB.EZpvd(this));
    }
