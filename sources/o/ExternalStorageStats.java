...
public final class ExternalStorageStats {
    public static final byte[] AEQbTJ(DT dt, KeyAgreementSpi keyAgreementSpi) {
        EW ew = new EW();
        ...
        java.lang.String strOLrzqt = keyAgreementSpi.OLrzqt();
        if (strOLrzqt != null) {
            ebEZpvd.AEQbTJ(c5101Et, strOLrzqt);
        }
        java.lang.String strKWHzl = keyAgreementSpi.KWHzl();
        if (strKWHzl != null) {
