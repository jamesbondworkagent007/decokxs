...
public final class C56152xxS extends xKE<java.util.List<? extends StrategyResponse>> {
    public EditContractDcaReq copydefault;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final void copydefault(@NotNull EditContractDcaReq editContractDcaReq) {
        Intrinsics.checkNotNullParameter(editContractDcaReq, "");
        this.copydefault = editContractDcaReq;
    }
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends StrategyResponse>>> EZpvd() {
        ...
        EditContractDcaReq editContractDcaReq2 = this.copydefault;
        if (editContractDcaReq2 == null) {
            Intrinsics.gEmmrt("");
        } else {
            editContractDcaReq = editContractDcaReq2;
        }
        return bizApiService.editContractDca(editContractDcaReq);
    }
}
