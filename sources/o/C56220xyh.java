...
public final class C56220xyh extends xKE<java.util.List<? extends StrategyProfitResponse>> {
    public java.lang.String EZpvd = "";

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final C56220xyh OLrzqt(@NotNull java.lang.String str) {
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends StrategyProfitResponse>>> EZpvd() {
        return ((BizApiService) C43393roT.httpService$default(C56524yIo.AEQbTJ(BizApiService.class), null, 1, null)).getGridProfitList(this.EZpvd);
    }
}
