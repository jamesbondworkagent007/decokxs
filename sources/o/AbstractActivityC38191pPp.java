...
public abstract class AbstractActivityC38191pPp extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC38191pPp() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.pPp.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC38191pPp.this.KWHzl();
            }
        });
    }
    ...
    public void KWHzl() {
        ...
        ((pOW) aA_()).EZpvd((pOG) C58163ywB.EZpvd(this));
    }
