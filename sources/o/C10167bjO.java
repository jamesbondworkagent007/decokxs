...
public final class C10167bjO extends AbstractC10170bjR {
    ...
    public C10167bjO(@NotNull android.content.Context context, @NotNull TxIdOrHashHistoryDetail txIdOrHashHistoryDetail) {
    ...
    public java.lang.String fARcdN() {
        return C33070mpX.AYXKKw(C13754dXa.FragmentManager.IResultReceiver2);
    }
    ...
    public java.util.List<ItemType> AubY() {
        ...
        listAubY.add(listAubY.indexOf(ItemType.ITEM_TYPE_TRANSACTION_HASH) + 1, ItemType.ITEM_TYPE_APPROVED_AMOUNT);
        return listAubY;
    }
}
