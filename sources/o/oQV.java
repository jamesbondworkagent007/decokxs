...
public final class oQV extends AbstractC48902ueT<ImageCustomPreviewConfig> implements InterfaceC49363unD {
    public final int EZpvd = C35964oKf.Application.zzQwtT;
    public oOW KWHzl;
    ...
    public static final class Application {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: o.oQV.Application.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public void initView(@NotNull android.view.View view, android.os.Bundle bundle) {
        Intrinsics.checkNotNullParameter(view, "");
        this.KWHzl = oOW.copydefault(view);
        MarketEventShareData marketEventShareDataEZpvd = EZpvd();
        if (marketEventShareDataEZpvd != null) {
            KWHzl(marketEventShareDataEZpvd);
        }
        setOnEditMenuClickListener(new StateListAnimator());
        notifyPreviewFirstLoaded();
        view.post(new java.lang.Runnable() { // from class: o.oQS
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // java.lang.Runnable
            public final void run() {
                oQV.AEQbTJ(this.OLrzqt);
            }
        });
    }

    public static final void AEQbTJ(oQV oqv) {
        rVN.reportFullyDrawn$default((androidx.fragment.app.Fragment) oqv, true, (java.lang.String) null, 2, (java.lang.Object) null);
    }

    public final MarketEventShareData EZpvd() {
        return (MarketEventShareData) requireShareParams().getExtras().getParcelable("marketEventShareParamKey");
    }

    public final void KWHzl(MarketEventShareData marketEventShareData) {
        oOW oow = this.KWHzl;
        if (oow == null) {
            Intrinsics.gEmmrt("");
            oow = null;
        }
        oow.valueOf.setText(C36131oQk.KWHzl(marketEventShareData));
        oow.EZpvd.setText(C36131oQk.copydefault(marketEventShareData));
        AppCompatTextView appCompatTextView = oow.EZpvd;
        Intrinsics.checkNotNullExpressionValue(appCompatTextView, "");
        appCompatTextView.setVisibility(C33129mqd.OLrzqt(C36131oQk.copydefault(marketEventShareData)) ? 0 : 8);
        AppCompatTextView appCompatTextView2 = oow.AEQbTJ;
        android.graphics.drawable.Drawable drawableKWHzl = C33070mpX.KWHzl(C52761wXj.TaskDescription.DDxOgT);
        if (drawableKWHzl != null) {
            drawableKWHzl.setBounds(0, 0, C55298xhM.dp2px$default(16.0f, null, 1, null), C55298xhM.dp2px$default(16.0f, null, 1, null));
        } else {
            drawableKWHzl = null;
        }
        appCompatTextView2.setCompoundDrawablesRelative(drawableKWHzl, null, null, null);
        oow.AEQbTJ.requestLayout();
        oow.copydefault.setText(pTA.formatSimpleDateTime$default(new Date(marketEventShareData.getTime()), null, 1, null));
        oow.djBIcL.setText(marketEventShareData.getEventType());
        oow.AYXKKw.setQRCode(requireShareParams().getExtras().getString("marketEventShareShortLinkKey"));
    }
    ...
    public ImageShareParams onRequestPendingShareParams(@NotNull SharePlatform sharePlatform) {
        ...
        if (pendingShareImagePath == null && (pendingShareImagePath = super.buildCompositePreviewImagePath()) == null) {
            pendingShareImagePath = AEQbTJ();
        }
    ...
    public android.view.ViewGroup getPreviewContainer() {
        ...
        ConstraintLayout constraintLayout = oow.AkhnZx;
