...
import aws.sdk.kotlin.services.comprehend.model.ResourceInUseException;
import aws.sdk.kotlin.services.comprehend.serde.ResourceInUseExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes21.dex */
public final class LongSparseArray implements BB<ResourceInUseException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super ResourceInUseException> continuation) throws java.lang.Throwable {
        ...
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            MapCollections.AEQbTJ(application, bArr);
        }
        application.AEQbTJ();
