...
public final class C27778kD implements BH<C9993bg> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C9993bg c9993bg, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.StartCelebrityRecognitionOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C27751kC.EZpvd(dt, c9993bg)));
