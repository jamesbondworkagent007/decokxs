...
public final class C37904pF implements BH<C35265ns> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C35265ns c35265ns, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.CreateAdapterVersionOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C38067pL.copydefault(dt, c35265ns)));
