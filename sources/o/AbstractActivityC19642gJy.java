...
public abstract class AbstractActivityC19642gJy extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC19642gJy() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.gJy.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC19642gJy.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.EZpvd = true;
        ((gJD) aA_()).copydefault((ActivityC19643gJz) C58163ywB.EZpvd(this));
    }
