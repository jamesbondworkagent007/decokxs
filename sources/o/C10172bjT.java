...
/* JADX INFO: renamed from: o.bjT, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public final class C10172bjT extends AbstractC10170bjR {
    ...
    public C10172bjT(@NotNull android.content.Context context, @NotNull TxIdOrHashHistoryDetail txIdOrHashHistoryDetail) {
    ...
    public java.util.List<AbstractC10168bjP.TaskDescription> AYXKKw() {
        ...
        while (it.hasNext()) {
            arrayList.add(AEQbTJ((TxAssetChangeBean) it.next(), true));
        }
        return arrayList;
    }
    ...
    public java.util.List<AbstractC10168bjP.TaskDescription> DbNXlk() {
        ...
        while (it.hasNext()) {
            arrayList.add(generateCoinData$default(this, (TxAssetChangeBean) it.next(), false, 2, null));
        }
        return arrayList;
    }
    ...
    public static /* synthetic */ AbstractC10168bjP.TaskDescription generateCoinData$default(C10172bjT c10172bjT, TxAssetChangeBean txAssetChangeBean, boolean z, int i, java.lang.Object obj) {
        if ((i & 2) != 0) {
            z = false;
        }
        return c10172bjT.AEQbTJ(txAssetChangeBean, z);
    }
    ...
    */
    public final AbstractC10168bjP.TaskDescription AEQbTJ(TxAssetChangeBean txAssetChangeBean, boolean z) {
        int i;
        ...
        if (Intrinsics.EZpvd((java.lang.Object) direction, (java.lang.Object) "1")) {
            ...
            if (!Intrinsics.EZpvd((java.lang.Object) direction, (java.lang.Object) "2")) {
                ...
                return new AbstractC10168bjP.TaskDescription(str2, str3, " ", name != null ? "" : name, i, false, false, 0, false, fJNWhG().getTxType() != 65 && z, null, 0, 0L, false, 15840, null);
            }
            str = "-";
        }
        i = iCopydefault;
        ...
        return new AbstractC10168bjP.TaskDescription(str2, str32, " ", name2 != null ? "" : name2, i, false, false, 0, false, fJNWhG().getTxType() != 65 && z, null, 0, 0L, false, 15840, null);
    }
}
