...
/* JADX INFO: renamed from: o.nZm, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes16.dex */
public abstract class AbstractActivityC34317nZm<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC34317nZm() {
        djBIcL();
    }

    private void djBIcL() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.nZm.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC34317nZm.this.AhwBna();
            }
        });
    }
    ...
    public void AhwBna() {
        ...
        this.OLrzqt = true;
        ((InterfaceC34324nZt) aA_()).KWHzl((ActivityC34318nZn) C58163ywB.EZpvd(this));
    }
