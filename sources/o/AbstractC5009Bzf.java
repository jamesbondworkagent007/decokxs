...
public abstract class AbstractC5009Bzf {
    public static final int $stable = 0;

    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: o.Bzf.<init>():void type: THIS */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public /* synthetic */ AbstractC5009Bzf(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    private AbstractC5009Bzf() {
    }

    /* JADX INFO: renamed from: o.Bzf$TaskDescription */
    public static final class TaskDescription extends AbstractC5009Bzf {
        public static final int $stable = 0;
        ...
        public java.lang.String toString() {
            return "SiteCodeChanged(v1=" + this.KWHzl + ")";
        }
