...
public final class SearchIndexableResource {
    public static final NetworkQuotaInfo OLrzqt(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        NetworkQuotaInfo.Application application = new NetworkQuotaInfo.Application();
            ...
            if (numOLrzqt == null || numOLrzqt.intValue() != iCopydefault) {
                ...
                while (actionBarKWHzl.EZpvd()) {
                    if (!actionBarKWHzl.copydefault()) {
                        ...
                        arrayList.add(Formatter.EZpvd(interfaceC5095En));
                    }
                }
