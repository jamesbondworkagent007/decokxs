...
public final class TaskDrainer {
    public static final UiModeManager copydefault(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        UiModeManager.StateListAnimator stateListAnimator = new UiModeManager.StateListAnimator();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    stateListAnimator.AEQbTJ(SurfaceUtils.EZpvd(interfaceC5095En));
