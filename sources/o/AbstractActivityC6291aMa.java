...
/* JADX INFO: renamed from: o.aMa, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes14.dex */
public abstract class AbstractActivityC6291aMa extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6291aMa() {
        EZpvd();
    }

    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aMa.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6291aMa.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.EZpvd = true;
        ((InterfaceC6295aMe) aA_()).KWHzl((ActivityC6236aLY) C58163ywB.EZpvd(this));
    }
