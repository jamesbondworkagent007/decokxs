...
public final class C10252bku extends AbstractC10170bjR {
    ...
    public C10252bku(@NotNull android.content.Context context, @NotNull TxIdOrHashHistoryDetail txIdOrHashHistoryDetail) {
    ...
    public java.lang.String fARcdN() {
        return C33070mpX.AYXKKw(C13754dXa.FragmentManager.IntentSenderRequestCompanionCREATOR1);
    }
    ...
    */
    private final AbstractC10168bjP.TaskDescription KWHzl(TxAssetChangeBean txAssetChangeBean) {
        int i;
