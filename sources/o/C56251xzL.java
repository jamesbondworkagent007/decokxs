...
public final class C56251xzL extends xKE<java.util.List<? extends GridStopInfoDto>> {
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends GridStopInfoDto>>> EZpvd() {
        return ((BizApiService) C43393roT.httpService$default(C56524yIo.AEQbTJ(BizApiService.class), null, 1, null)).fetchGridStopInfo(this.KWHzl);
    }
}
