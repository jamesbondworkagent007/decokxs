...
/* JADX INFO: renamed from: o.jwI, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes6.dex */
public final class C27493jwI {
    public static final CoroutineExceptionHandler copydefault = new TaskDescription(CoroutineExceptionHandler.Key);
    ...
    public static final Job copydefault(@NotNull CoroutineScope coroutineScope, @NotNull CoroutineContext coroutineContext, @NotNull CoroutineStart coroutineStart, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends java.lang.Object> function2) {
        ...
        if (coroutineExceptionHandler == null) {
            coroutineContext = coroutineContext.plus(copydefault);
        }
        return BuildersKt.launch(coroutineScope, coroutineContext, coroutineStart, function2);
    }

    /* JADX INFO: renamed from: o.jwI$TaskDescription */
