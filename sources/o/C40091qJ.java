...
public final class C40091qJ implements BH<C34170nU> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C34170nU c34170nU, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.GetLendingAnalysisOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C40118qK.KWHzl(dt, c34170nU)));
