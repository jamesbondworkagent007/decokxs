...
import aws.sdk.kotlin.services.cognitoidentity.serde.TooManyRequestsExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes2.dex */
public final class HashMap implements BB<TooManyRequestsException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super TooManyRequestsException> continuation) throws java.lang.Throwable {
        ...
        TooManyRequestsException.ActionBar actionBar;
        ...
        if (i2 == 0) {
            ...
            TooManyRequestsException.ActionBar actionBar2 = new TooManyRequestsException.ActionBar();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            tooManyRequestsExceptionDeserializer$deserialize$1.L$0 = actionBar2;
            ...
            actionBar = (TooManyRequestsException.ActionBar) tooManyRequestsExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            Iterator.copydefault(actionBar, bArr);
        }
        actionBar.EZpvd();
