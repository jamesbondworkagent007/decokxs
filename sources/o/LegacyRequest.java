...
public final class LegacyRequest {
    public static final PackageDeleteObserver OLrzqt(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        PackageDeleteObserver.StateListAnimator stateListAnimator = new PackageDeleteObserver.StateListAnimator();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    stateListAnimator.EZpvd(NotificationChannelGroup.KWHzl.KWHzl(stateListAnimatorEZpvd.fetchVPNInfo()));
