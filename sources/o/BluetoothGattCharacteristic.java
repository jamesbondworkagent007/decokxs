...
public final class BluetoothGattCharacteristic {
    public static final byte[] AEQbTJ(DT dt, GCMParameterSpec gCMParameterSpec) {
        EW ew = new EW();
        ...
        java.lang.Integer numCopydefault = gCMParameterSpec.copydefault();
        if (numCopydefault != null) {
            ebEZpvd.OLrzqt(c5101Et, numCopydefault.intValue());
        }
        java.lang.String strEZpvd = gCMParameterSpec.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et2, strEZpvd);
        }
        java.lang.String strOLrzqt = gCMParameterSpec.OLrzqt();
        if (strOLrzqt != null) {
            ebEZpvd.AEQbTJ(c5101Et3, strOLrzqt);
        }
        java.lang.String strKWHzl = gCMParameterSpec.KWHzl();
        if (strKWHzl != null) {
