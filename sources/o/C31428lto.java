...
public final class C31428lto {
    public static final java.lang.String AEQbTJ(@NotNull java.lang.String str, @NotNull android.content.Context context, @NotNull CdnResourceType cdnResourceType, boolean z) {
        ...
        if (numValueOf != null && numValueOf.intValue() == 32) {
            return C43386roM.EZpvd.EZpvd() + "/cdn/mobile/resources/" + listSplit$default.get(0) + "_night." + listSplit$default.get(1);
        }
        return C43386roM.EZpvd.EZpvd() + "/cdn/mobile/resources/" + str;
    }
}
