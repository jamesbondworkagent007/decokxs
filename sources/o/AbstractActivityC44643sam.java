...
public abstract class AbstractActivityC44643sam<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC44643sam() {
        AhwBna();
    }

    private void AhwBna() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.sam.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC44643sam.this.djBIcL();
            }
        });
    }
    ...
    public void djBIcL() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC44653saw) aA_()).OLrzqt((NotificationCenterActivity) C58163ywB.EZpvd(this));
    }
