...
public final class KeymasterBlobArgument {
    public static final SntpClient KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        SntpClient.TaskDescription taskDescription = new SntpClient.TaskDescription();
