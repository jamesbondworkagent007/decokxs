...
/* JADX INFO: renamed from: o.lNn, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public final class C30144lNn extends C30142lNl {
    ...
    public C30144lNn(@NotNull com.okinc.okpaymentapi.data.remote.model.management.Channel channel, boolean z) {
        super(channel, z);
    ...
    public java.util.List<AbstractC30156lNz> AuCTel() {
        ...
        while (it.hasNext()) {
            arrayList.add(new lNJ((PaymentMethod) it.next()));
        }
        return arrayList;
    }
}
