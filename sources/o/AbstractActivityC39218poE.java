...
public abstract class AbstractActivityC39218poE extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC39218poE() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.poE.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC39218poE.this.AEQbTJ();
            }
        });
    }
    ...
    public void AEQbTJ() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC39231poR) aA_()).copydefault((ActivityC39220poG) C58163ywB.EZpvd(this));
    }
