...
/* JADX INFO: renamed from: o.eqv, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public class C16811eqv extends AbstractC16809eqt {
    ...
    static {
        ...
        sparseIntArray.put(C13754dXa.ActionBar.component2, 2);
        sparseIntArray.put(C13754dXa.ActionBar.postWhenReportersAreDone, 3);
    }

    public C16811eqv(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, EZpvd, AEQbTJ));
    }

    public C16811eqv(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
