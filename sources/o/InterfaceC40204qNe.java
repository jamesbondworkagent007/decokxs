...
/* JADX INFO: renamed from: o.qNe, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes9.dex */
public interface InterfaceC40204qNe extends InterfaceC40518qYv {
    int KWHzl();

    Function0<androidx.fragment.app.Fragment> copydefault();

    @Override // o.InterfaceC40518qYv
    androidx.fragment.app.Fragment createFragment();

    /* JADX INFO: renamed from: o.qNe$StateListAnimator */
    public static final class StateListAnimator implements InterfaceC40204qNe {
        public final int AEQbTJ;
        public final Function0<androidx.fragment.app.Fragment> EZpvd;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: o.qNe$StateListAnimator */
        ...
        public static /* synthetic */ StateListAnimator copy$default(StateListAnimator stateListAnimator, int i, Function0 function0, int i2, java.lang.Object obj) {
            ...
            return stateListAnimator.KWHzl(i, function0);
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        @Override // o.InterfaceC40204qNe
        public int KWHzl() {
            return this.AEQbTJ;
        }

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final StateListAnimator KWHzl(@androidx.annotation.StringRes int i, @NotNull Function0<? extends androidx.fragment.app.Fragment> function0) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        @Override // o.InterfaceC40204qNe
        public Function0<androidx.fragment.app.Fragment> copydefault() {
            return this.EZpvd;
        }
        ...
        public java.lang.String toString() {
            return "OptionsChain(titleResId=" + this.AEQbTJ + ", onCreateFragment=" + this.EZpvd + ")";
        }
 ...
 A[MD:(int, kotlin.jvm.functions.Function0<? extends androidx.fragment.app.Fragment>):void (m)] (LINE:13) call: o.qNe.StateListAnimator.<init>(int, kotlin.jvm.functions.Function0):void type: THIS */
        ...
        @Override // o.InterfaceC40204qNe, o.InterfaceC40518qYv
        ...
        public boolean onCompareItems(@NotNull InterfaceC40518qYv interfaceC40518qYv) {
            return TaskDescription.KWHzl(this, interfaceC40518qYv);
        }
    }

    /* JADX INFO: renamed from: o.qNe$ActionBar */
    public static final class ActionBar implements InterfaceC40204qNe {
        public final int AEQbTJ;
        public final Function0<androidx.fragment.app.Fragment> copydefault;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: o.qNe$ActionBar */
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ ActionBar copy$default(ActionBar actionBar, int i, Function0 function0, int i2, java.lang.Object obj) {
            ...
            if ((i2 & 2) != 0) {
                function0 = actionBar.copydefault;
            }
            return actionBar.OLrzqt(i, function0);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final ActionBar OLrzqt(@androidx.annotation.StringRes int i, @NotNull Function0<? extends androidx.fragment.app.Fragment> function0) {
            Intrinsics.checkNotNullParameter(function0, "");
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            return this.AEQbTJ == actionBar.AEQbTJ && Intrinsics.EZpvd(this.copydefault, actionBar.copydefault);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public java.lang.String toString() {
            return "OptionsQuote(titleResId=" + this.AEQbTJ + ", onCreateFragment=" + this.copydefault + ")";
        }
  ...
  (r2v0 kotlin.jvm.functions.Function0)
 A[MD:(int, kotlin.jvm.functions.Function0<? extends androidx.fragment.app.Fragment>):void (m)] (LINE:19) call: o.qNe.ActionBar.<init>(int, kotlin.jvm.functions.Function0):void type: THIS */
    ...
    /* JADX INFO: renamed from: o.qNe$Application */
    public static final class Application implements InterfaceC40204qNe {
        public final Function0<androidx.fragment.app.Fragment> KWHzl;
        public final int OLrzqt;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: o.qNe$Application */
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ Application copy$default(Application application, int i, Function0 function0, int i2, java.lang.Object obj) {
            ...
            if ((i2 & 2) != 0) {
                function0 = application.KWHzl;
            }
            return application.copydefault(i, function0);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public final Application copydefault(@androidx.annotation.StringRes int i, @NotNull Function0<? extends androidx.fragment.app.Fragment> function0) {
            Intrinsics.checkNotNullParameter(function0, "");
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public java.lang.String toString() {
            return "SimpleOptions(titleResId=" + this.OLrzqt + ", onCreateFragment=" + this.KWHzl + ")";
        }
  ...
  (r2v0 kotlin.jvm.functions.Function0)
 A[MD:(int, kotlin.jvm.functions.Function0<? extends androidx.fragment.app.Fragment>):void (m)] (LINE:25) call: o.qNe.Application.<init>(int, kotlin.jvm.functions.Function0):void type: THIS */
    ...
    /* JADX INFO: renamed from: o.qNe$Activity */
    public static final class Activity implements InterfaceC40204qNe {
        public final int OLrzqt;
        public final Function0<androidx.fragment.app.Fragment> copydefault;

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: o.qNe$Activity */
        /* JADX WARN: Multi-variable type inference failed */
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            return this.OLrzqt == activity.OLrzqt && Intrinsics.EZpvd(this.copydefault, activity.copydefault);
        }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        public java.lang.String toString() {
            return "OptionsCopilot(titleResId=" + this.OLrzqt + ", onCreateFragment=" + this.copydefault + ")";
        }
  ...
  (r2v0 kotlin.jvm.functions.Function0)
 A[MD:(int, kotlin.jvm.functions.Function0<? extends androidx.fragment.app.Fragment>):void (m)] (LINE:31) call: o.qNe.Activity.<init>(int, kotlin.jvm.functions.Function0):void type: THIS */
    ...
    /* JADX INFO: renamed from: o.qNe$TaskDescription */
    public static final class TaskDescription {
        public static boolean KWHzl(@NotNull InterfaceC40204qNe interfaceC40204qNe, @NotNull InterfaceC40518qYv interfaceC40518qYv) {
            Intrinsics.checkNotNullParameter(interfaceC40518qYv, "");
            return Intrinsics.EZpvd(interfaceC40204qNe, interfaceC40518qYv);
        }

        public static boolean OLrzqt(@NotNull InterfaceC40204qNe interfaceC40204qNe, @NotNull InterfaceC40518qYv interfaceC40518qYv) {
            Intrinsics.checkNotNullParameter(interfaceC40518qYv, "");
            return Intrinsics.EZpvd(interfaceC40204qNe, interfaceC40518qYv);
        }

        public static androidx.fragment.app.Fragment AEQbTJ(@NotNull InterfaceC40204qNe interfaceC40204qNe) {
            return interfaceC40204qNe.copydefault().invoke();
        }
    }
}
