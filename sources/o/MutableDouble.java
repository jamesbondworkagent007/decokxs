...
public final class MutableDouble {
    public static final void AEQbTJ(@NotNull InterfaceC5106Ey interfaceC5106Ey, @NotNull ResourceMismatchViolation resourceMismatchViolation) {
        ...
        java.lang.String strKWHzl = resourceMismatchViolation.KWHzl();
        if (strKWHzl != null) {
            ebEZpvd.AEQbTJ(c5101Et, strKWHzl);
        }
        StatsDimensionsValue statsDimensionsValueOLrzqt = resourceMismatchViolation.OLrzqt();
        if (statsDimensionsValueOLrzqt != null) {
            ebEZpvd.AEQbTJ(c5101Et2, statsDimensionsValueOLrzqt.KWHzl());
        }
        C5173Hn c5173HnAEQbTJ = resourceMismatchViolation.AEQbTJ();
        if (c5173HnAEQbTJ != null) {
            ebEZpvd.KWHzl(c5101Et4, c5173HnAEQbTJ, TimestampFormat.EPOCH_SECONDS);
        }
        C5173Hn c5173HnEZpvd = resourceMismatchViolation.EZpvd();
