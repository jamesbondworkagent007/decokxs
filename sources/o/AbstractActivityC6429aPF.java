...
public abstract class AbstractActivityC6429aPF extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6429aPF() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aPF.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6429aPF.this.KWHzl();
            }
        });
    }
    ...
    public void KWHzl() {
        ...
        ((InterfaceC6428aPE) aA_()).EZpvd((ActivityC6427aPD) C58163ywB.EZpvd(this));
    }
