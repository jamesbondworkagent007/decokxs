...
public final class C19563gH implements BH<TimePickerSpinnerDelegate> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull TimePickerSpinnerDelegate timePickerSpinnerDelegate, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.GetFaceLivenessSessionResultsOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C19671gL.KWHzl(dt, timePickerSpinnerDelegate)));
