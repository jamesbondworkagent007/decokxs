...
public final class C41663qv implements BH<C34089nR> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C34089nR c34089nR, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.GetDocumentAnalysisOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C39875qB.OLrzqt(dt, c34089nR)));
