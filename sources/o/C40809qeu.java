...
public final class C40809qeu extends AbstractC40515qYs<C41650qun, C42802rdL> {
    ...
    public void copydefault(@NotNull C42802rdL c42802rdL, int i, @NotNull C41650qun c41650qun) {
        ...
        C46742tcs.AEQbTJ(appCompatImageView, strOLrzqt);
        ...
        root.setOnClickListener(new StateListAnimator(root, 1000L, c41650qun));
    }

    /* JADX INFO: renamed from: o.qeu$StateListAnimator */
    public static final class StateListAnimator implements View.OnClickListener {
        ...
        public StateListAnimator(android.view.View view, long j, C41650qun c41650qun) {
            this.EZpvd = view;
            this.KWHzl = j;
        ...
        public final void onClick(android.view.View view) {
            ...
            if (jCurrentTimeMillis - C55296xhK.copydefault(this.EZpvd) > this.KWHzl || (this.EZpvd instanceof android.widget.Checkable)) {
                ...
                Intrinsics.checkNotNullExpressionValue(context, "");
                InterfaceC49497upf.ActionBar.openSimpleOptionPage$default(interfaceC49497upf, context, this.AEQbTJ.KWHzl().getInstId(), null, 4, null);
                C46688tbr.KWHzl.KWHzl("Market_Options_Simple", C56423yEv.EZpvd(C56390yDp.OLrzqt("Market_Options_Simple", this.AEQbTJ.AEQbTJ())));
            }
        }
    }
}
