...
public final class HdmiControlManager {
    public static final byte[] AEQbTJ(DT dt, final DeviceAdminService deviceAdminService) {
        EW ew = new EW();
        ...
        java.lang.String strKWHzl = deviceAdminService.KWHzl();
        if (strKWHzl != null) {
            ebEZpvd.AEQbTJ(c5101Et, strKWHzl);
        }
        if (deviceAdminService.OLrzqt() != null) {
            ebEZpvd.OLrzqt(c5101Et2, new Function1<InterfaceC5097Ep, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.serde.TagResourceOperationSerializerKt$serializeTagResourceOperationBody$1$2
                ...
                public final void invoke2(@NotNull InterfaceC5097Ep interfaceC5097Ep) {
                    ...
                    for (Map.Entry<String, String> entry : deviceAdminService.OLrzqt().entrySet()) {
