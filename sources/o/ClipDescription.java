...
public final class ClipDescription {
    public static final AnimatorInflater KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        AnimatorInflater.Activity activity = new AnimatorInflater.Activity();
        AbstractC5105Ex.LoaderManager loaderManager = AbstractC5105Ex.LoaderManager.KWHzl;
        C5101Et c5101Et = new C5101Et(loaderManager, new EX("AttributeName"));
        C5101Et c5101Et2 = new C5101Et(AbstractC5105Ex.StateListAnimator.copydefault, new EX("DeliveryMedium"));
        C5101Et c5101Et3 = new C5101Et(loaderManager, new EX("Destination"));
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    activity.KWHzl(ElapsedRealtimeLong.EZpvd.OLrzqt(stateListAnimatorEZpvd.fetchVPNInfo()));
                } else {
