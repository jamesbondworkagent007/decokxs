...
public final class FrameMetricsObserver {
    public static final PrinterDiscoverySession EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        PrinterDiscoverySession.ActionBar actionBar = new PrinterDiscoverySession.ActionBar();
