...
public abstract class AbstractActivityC5822aDi extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC5822aDi() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aDi.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC5822aDi.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        ((InterfaceC5836aDw) aA_()).copydefault((MfaForResultActivity) C58163ywB.EZpvd(this));
    }
