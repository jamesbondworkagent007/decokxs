...
import aws.sdk.kotlin.runtime.auth.credentials.internal.ssooidc.serde.AccessDeniedExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes.dex */
public final class OnCreateContextMenuListener implements BB<AccessDeniedException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super AccessDeniedException> continuation) throws java.lang.Throwable {
        ...
        AccessDeniedException.Activity activity;
        ...
        if (i2 == 0) {
            ...
            AccessDeniedException.Activity activity2 = new AccessDeniedException.Activity();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            accessDeniedExceptionDeserializer$deserialize$1.L$0 = activity2;
            ...
            activity = (AccessDeniedException.Activity) accessDeniedExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            OnClickListener.EZpvd(activity, bArr);
        }
        activity.KWHzl();
