...
public abstract class wGL<Binding extends ViewDataBinding, Presenter extends AbsPresenter> extends AbstractC54505xKx<Binding, Presenter> implements InterfaceC58208ywu {
    ...
    public void valueOf() {
        ...
        this.KWHzl = true;
        ((wGU) aA_()).EZpvd((wGT) C58163ywB.EZpvd(this));
    }
