...
public final class MutableInt {
    public static final NonSdkApiUsedViolation KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        NonSdkApiUsedViolation.StateListAnimator stateListAnimator;
        C5101Et c5101Et;
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        NonSdkApiUsedViolation.StateListAnimator stateListAnimator2 = new NonSdkApiUsedViolation.StateListAnimator();
        ...
        NonSdkApiUsedViolation.StateListAnimator stateListAnimator4 = stateListAnimator2;
                                ...
                                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault6) {
                                    ...
                                    if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault7) {
                                        ...
                                        if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault8) {
                                            stateListAnimator.copydefault(SynchronousResultReceiver.EZpvd.AEQbTJ(stateListAnimatorEZpvd.fetchVPNInfo()));
                                        } else {
                                            ...
                                            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault9) {
                                                ...
                                                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault10) {
                                                    stateListAnimator.EZpvd(IntProperty.AEQbTJ(interfaceC5095En));
                                                } else {
