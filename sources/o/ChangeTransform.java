...
public final class ChangeTransform implements BH<UEventObserver> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull UEventObserver uEventObserver, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.comprehend.serde.ListEndpointsOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(Crossfade.OLrzqt(dt, uEventObserver)));
