...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.ListTagsForResourceOperationDeserializer$deserialize$1;
...
public final class SensorManager implements BB<FragmentManagerNonConfig> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super FragmentManagerNonConfig> continuation) throws java.lang.Throwable {
        ListTagsForResourceOperationDeserializer$deserialize$1 listTagsForResourceOperationDeserializer$deserialize$1;
        FragmentManagerNonConfig.TaskDescription taskDescription;
        byte[] bArr;
        ...
        if (i2 != 0) {
            ...
            taskDescription = (FragmentManagerNonConfig.TaskDescription) listTagsForResourceOperationDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(objCopydefault);
            bArr = (byte[]) objCopydefault;
            if (bArr != null) {
                SerialPort.AEQbTJ(taskDescription, bArr);
            }
        ...
        if (!zT.copydefault(interfaceC5039CjAEQbTJ.OLrzqt())) {
            ...
            if (SerialPort.KWHzl(dt, c58859zS, listTagsForResourceOperationDeserializer$deserialize$1) == objCopydefault2) {
                return objCopydefault2;
            }
            throw new KotlinNothingValueException();
        }
        taskDescription = new FragmentManagerNonConfig.TaskDescription();
