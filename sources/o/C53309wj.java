...
import aws.sdk.kotlin.services.translate.serde.TextSizeLimitExceededExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.wj, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C53309wj implements BB<TextSizeLimitExceededException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super TextSizeLimitExceededException> continuation) throws java.lang.Throwable {
        ...
        TextSizeLimitExceededException.Application application;
        ...
        if (i2 == 0) {
            ...
            TextSizeLimitExceededException.Application application2 = new TextSizeLimitExceededException.Application();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            textSizeLimitExceededExceptionDeserializer$deserialize$1.L$0 = application2;
            ...
            application = (TextSizeLimitExceededException.Application) textSizeLimitExceededExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C53203wh.OLrzqt(application, bArr);
        }
        application.EZpvd();
