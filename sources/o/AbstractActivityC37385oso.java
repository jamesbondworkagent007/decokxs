...
public abstract class AbstractActivityC37385oso<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37385oso() {
        AhwBna();
    }

    private void AhwBna() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.oso.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37385oso.this.djBIcL();
            }
        });
    }
    ...
    public void djBIcL() {
        ...
        this.KWHzl = true;
        ((InterfaceC37358osN) aA_()).AEQbTJ((ActivityC37351osG) C58163ywB.EZpvd(this));
    }
