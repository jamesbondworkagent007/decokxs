...
public class C5322Ng {
    public static final int[] OLrzqt = {0, 31, 59, 90, 120, CipherSuite.TLS_DH_DSS_WITH_SEED_CBC_SHA, CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA384, BuildConfig.VERSION_CODE, 243, 273, 304, 334, 365};
    ...
    public static final int[] OLrzqt(int i, int i2, int i3, boolean z) {
        ...
        for (int i8 = 1; i8 < i2; i8++) {
            i7 = ((524288 >> (i8 + (-1))) & copydefault[i4]) == 0 ? i7 + 29 : i7 + 30;
        }
        int i9 = i7 + i3;
        int i10 = copydefault[i4];
    ...
    public static final int[] copydefault(int i, int i2, int i3) {
        int[] iArr = new int[4];
        int[] iArr2 = AEQbTJ;
        int i4 = 0;
        int i5 = i - iArr2[0];
        ...
        int i6 = iArr2[i5];
        int iAEQbTJ = AEQbTJ(i6, 12, 9);
        int iAEQbTJ2 = AEQbTJ(i6, 4, 5);
        int iAEQbTJ3 = AEQbTJ(i6, 5, 0);
        long jOLrzqt = OLrzqt(i, i2, i3);
        long jOLrzqt2 = OLrzqt(iAEQbTJ, iAEQbTJ2, iAEQbTJ3);
        int i7 = EZpvd[i5];
        int iAEQbTJ4 = AEQbTJ(i7, 4, 13);
        int i8 = AEQbTJ[0];
        long j = (jOLrzqt - jOLrzqt2) + 1;
        int i9 = 1;
        for (int i10 = 0; i10 < 13; i10++) {
            long j2 = AEQbTJ(i7, 1, 12 - i10) == 1 ? 30 : 29;
            if (j <= j2) {
                break;
            }
            i9++;
    ...
    public static long OLrzqt(int i, int i2, int i3) {
        int i4 = i - (((i2 + 9) % 12) / 10);
