...
public class C48636uYt extends AbstractC48638uYv {
    ...
    static {
        ...
        sparseIntArray.put(C48033uCm.Application.seekTo, 2);
        sparseIntArray.put(C48033uCm.Application.PlaybackStateCompatCustomAction, 3);
    }

    public C48636uYt(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, EZpvd, KWHzl));
    }

    public C48636uYt(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
