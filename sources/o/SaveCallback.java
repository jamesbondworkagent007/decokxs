...
public final class SaveCallback implements BH<FormatException> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull FormatException formatException, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.comprehend.serde.DescribeDocumentClassificationJobOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(SaveInfo.EZpvd(dt, formatException)));
