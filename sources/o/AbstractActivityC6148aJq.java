...
public abstract class AbstractActivityC6148aJq extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6148aJq() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aJq.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6148aJq.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        ((InterfaceC6107aJB) aA_()).OLrzqt((ActivityC6153aJv) C58163ywB.EZpvd(this));
    }
