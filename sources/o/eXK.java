...
public abstract class eXK extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.eXK.1
    ...
    public void OLrzqt() {
        ...
        this.OLrzqt = true;
        ((eYC) aA_()).KWHzl((ActivityC15886eYy) C58163ywB.EZpvd(this));
    }
