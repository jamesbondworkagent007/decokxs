...
public abstract class AbstractActivityC33326muO extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC33326muO() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.muO.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC33326muO.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.KWHzl = true;
        ((InterfaceC33331muT) aA_()).OLrzqt((ActivityC33327muP) C58163ywB.EZpvd(this));
    }
