...
public final class C42705rbU implements ViewBinding {
    public final AppCompatImageView AEQbTJ;
    public final C41387qpp EZpvd;
    ...
    public C42705rbU(@androidx.annotation.NonNull C41381qpj c41381qpj, @androidx.annotation.NonNull AppCompatImageView appCompatImageView, @androidx.annotation.NonNull C55244xgL c55244xgL, @androidx.annotation.NonNull ViewPager2 viewPager2, @androidx.annotation.NonNull C41387qpp c41387qpp) {
        this.KWHzl = c41381qpj;
        this.AEQbTJ = appCompatImageView;
        this.OLrzqt = c55244xgL;
        this.copydefault = viewPager2;
        this.EZpvd = c41387qpp;
    }

    public static C42705rbU EZpvd(@androidx.annotation.NonNull android.view.View view) {
        ...
        if (appCompatImageView != null) {
            ...
            if (c55244xgL != null) {
                ...
                if (viewPager2 != null) {
                    ...
                    if (c41387qpp != null) {
                        return new C42705rbU((C41381qpj) view, appCompatImageView, c55244xgL, viewPager2, c41387qpp);
                    }
                }
            }
        }
