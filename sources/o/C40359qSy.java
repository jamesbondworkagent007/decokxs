...
import com.okinc.market.search.features.navigation.widget.MarketTypefaceSpanUnder28;
...
public final class C40359qSy {
    public static /* synthetic */ void addHighLightTv$default(android.widget.TextView textView, java.lang.String str, java.lang.String str2, boolean z, int i, java.lang.Object obj) {
        ...
        KWHzl(textView, str, str2, z);
    }

    public static final void KWHzl(@NotNull android.widget.TextView textView, @NotNull java.lang.String str, @NotNull java.lang.String str2, boolean z) {
        Intrinsics.checkNotNullParameter(textView, "");
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        textView.setText(OLrzqt(str, str2, z));
    }
    ...
    public static final java.lang.CharSequence OLrzqt(@NotNull java.lang.String str, @NotNull java.lang.String str2, boolean z) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
        ...
        try {
            ...
            if (!z) {
                ...
                spannableString.setSpan(new MarketTypefaceSpanUnder28(font), 0, strCopydefault.length(), 33);
            }
    ...
    public static final java.util.List<kotlin.Pair<java.lang.Integer, java.lang.Integer>> AEQbTJ(@NotNull java.lang.String str, @NotNull java.lang.String str2) {
        Intrinsics.checkNotNullParameter(str, "");
        Intrinsics.checkNotNullParameter(str2, "");
