...
public class C7814aqt extends android.widget.HorizontalScrollView implements InterfaceC7410ajM, InterfaceC7408ajK, C7904asd.Application {
    public final C7904asd AEQbTJ;
    public final C7907asg OLrzqt;
    public final C7808aqn copydefault;

    public C7814aqt(@androidx.annotation.NonNull android.content.Context context) {
        super(context);
        this.copydefault = new C7808aqn();
        this.AEQbTJ = new C7904asd();
        this.OLrzqt = new C7907asg();
    }
    ...
    public void setAddShadow(int i, C7350aiF c7350aiF, float f, float f2) {
        this.OLrzqt.EZpvd(i, c7350aiF, f, f2);
    ...
    public void setCornerRadius(float f) {
        ...
        C7823arB.AEQbTJ(this, this.copydefault);
        this.AEQbTJ.KWHzl(f);
        this.OLrzqt.AEQbTJ(f);
        this.OLrzqt.OLrzqt(false);
