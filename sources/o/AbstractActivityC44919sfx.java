...
public abstract class AbstractActivityC44919sfx extends OKSupportBaseActivity {
    public boolean copydefault = false;

    public AbstractActivityC44919sfx() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.sfx.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC44919sfx.this.getFieldNames();
            }
        });
    }
    ...
    public void getFieldNames() {
        ...
        ((InterfaceC44887sfR) ((InterfaceC58208ywu) C58163ywB.EZpvd(this)).aA_()).AEQbTJ((SupportFullSelfToolsActivity) C58163ywB.EZpvd(this));
    }
