...
public final class C39319pq implements BH<C34543ne> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C34543ne c34543ne, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.AnalyzeIDOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C39529pu.KWHzl(dt, c34543ne)));
