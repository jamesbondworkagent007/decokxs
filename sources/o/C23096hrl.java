...
/* JADX INFO: renamed from: o.hrl, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public class C23096hrl extends C23017hqL {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // o.C23017hqL, o.AbstractC22974hpV
    ...
    public C23096hrl(@NotNull java.lang.String str, @NotNull AbstractC22977hpY abstractC22977hpY) {
    ...
    public final SolanaSignType OLrzqt(@NotNull MergeCallData mergeCallData) {
        MevConfig mevConfig;
        Intrinsics.checkNotNullParameter(mergeCallData, "");
        UnsignedSwapData unsingedCallData = mergeCallData.getUnsingedCallData();
        return (unsingedCallData == null || (mevConfig = unsingedCallData.getMevConfig()) == null || !mevConfig.getEnableMev()) ? SolanaSignType.NORMAL : SolanaSignType.FAST;
    }
}
