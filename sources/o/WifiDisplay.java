...
public final class WifiDisplay {
    public static final byte[] copydefault(DT dt, DeviceAdminInfo deviceAdminInfo) {
        EW ew = new EW();
        ...
        java.lang.String strEZpvd = deviceAdminInfo.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et, strEZpvd);
        }
        java.lang.String strCopydefault = deviceAdminInfo.copydefault();
