...
public final class LongSparseLongArray {
    public static final SqliteObjectLeakedViolation EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        SqliteObjectLeakedViolation.Application application = new SqliteObjectLeakedViolation.Application();
        ...
        while (true) {
            ...
            if (numOLrzqt == null || numOLrzqt.intValue() != iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    application.EZpvd(UnbufferedIoViolation.AEQbTJ.AEQbTJ(stateListAnimatorEZpvd.fetchVPNInfo()));
