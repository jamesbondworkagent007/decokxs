...
/* JADX INFO: renamed from: o.lNq, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public final class C30147lNq extends C30142lNl {
    ...
    public C30147lNq(@NotNull com.okinc.okpaymentapi.data.remote.model.management.Channel channel, boolean z) {
        super(channel, z);
    ...
    public java.util.List<AbstractC30156lNz> AuCTel() {
        ...
        while (it.hasNext()) {
            arrayList.add(new lNI((PaymentMethod) it.next()));
        }
        return arrayList;
    }
}
