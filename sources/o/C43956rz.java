...
public final class C43956rz implements BH<C37079on> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C37079on c37079on, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.ListAdaptersOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C43903ry.OLrzqt(dt, c37079on)));
