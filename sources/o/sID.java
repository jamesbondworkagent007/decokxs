...
public final class sID {
    public final java.lang.String EZpvd(java.util.List<java.lang.Integer> list) {
        if (list == null || list.isEmpty()) {
            return null;
        }
        try {
            return sHW.copydefault().KWHzl().encodeToString(BuiltinSerializersKt.ListSerializer(BuiltinSerializersKt.serializer(C56523yIn.AEQbTJ)), list);
    ...
    public final java.util.List<java.lang.Integer> OLrzqt(java.lang.String str) {
        java.lang.Object objDecodeFromString = null;
        if (str == null || StringsKt__StringsKt.fARcdN((java.lang.CharSequence) str)) {
            return null;
        }
        try {
            objDecodeFromString = sHW.copydefault().KWHzl().decodeFromString(BuiltinSerializersKt.ListSerializer(BuiltinSerializersKt.serializer(C56523yIn.AEQbTJ)), str);
