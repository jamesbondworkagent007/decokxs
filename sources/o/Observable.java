...
public final class Observable {
    public static final byte[] AEQbTJ(DT dt, ActivityGroup activityGroup) {
        EW ew = new EW();
        ...
        java.lang.String strAEQbTJ = activityGroup.AEQbTJ();
        if (strAEQbTJ != null) {
            ebEZpvd.AEQbTJ(c5101Et, strAEQbTJ);
        }
        java.lang.String strEZpvd = activityGroup.EZpvd();
        if (strEZpvd != null) {
