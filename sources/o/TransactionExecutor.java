...
public final class TransactionExecutor {
    public static final byte[] copydefault(DT dt, Stream stream) {
        EW ew = new EW();
        ...
        java.lang.String strCopydefault = stream.copydefault();
        if (strCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et, strCopydefault);
        }
        java.lang.String strAEQbTJ = stream.AEQbTJ();
        if (strAEQbTJ != null) {
            ebEZpvd.AEQbTJ(c5101Et2, strAEQbTJ);
        }
        java.lang.String strKWHzl = stream.KWHzl();
        if (strKWHzl != null) {
