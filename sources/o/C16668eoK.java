...
public class C16668eoK extends AbstractC16669eoL {
    ...
    public void copydefault(@androidx.annotation.Nullable DappBTCXRCAssets dappBTCXRCAssets) {
        this.KWHzl = dappBTCXRCAssets;
    }
    ...
    public C16668eoK(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, EZpvd, valueOf));
    }

    public C16668eoK(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
    ...
    public boolean setVariable(int i, @androidx.annotation.Nullable java.lang.Object obj) {
        ...
        copydefault((DappBTCXRCAssets) obj);
        return true;
    }
