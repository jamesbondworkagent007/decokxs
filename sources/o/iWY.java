...
public abstract class iWY extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.iWY.3
    ...
    public void OLrzqt() {
        ...
        this.OLrzqt = true;
        ((InterfaceC24154iWx) aA_()).AEQbTJ((ActivityC24156iWz) C58163ywB.EZpvd(this));
    }
