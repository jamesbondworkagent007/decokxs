...
public abstract class AbstractActivityC37508ovE<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37508ovE() {
        AhwBna();
    }

    private void AhwBna() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ovE.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37508ovE.this.gEmmrt();
            }
        });
    }
    ...
    public void gEmmrt() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC37586owd) aA_()).EZpvd((ActivityC37525ovV) C58163ywB.EZpvd(this));
    }
