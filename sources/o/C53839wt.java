...
public final class C53839wt implements BH<C48723ub> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C48723ub c48723ub, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.TranslateTextOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C54104wy.copydefault(dt, c48723ub)));
