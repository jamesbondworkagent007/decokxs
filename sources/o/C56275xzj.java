...
public final class C56275xzj extends xKQ<java.util.List<? extends BotAssetsHistoryData>> {
    ...
    public java.lang.Object KWHzl(@NotNull Continuation<? super ResponseData<java.util.List<? extends BotAssetsHistoryData>>> continuation) {
        return BotApiService.Companion.AEQbTJ().getSingleBotAssetsHistory(this.OLrzqt, this.AEQbTJ, continuation);
    }
}
