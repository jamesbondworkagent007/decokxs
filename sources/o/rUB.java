...
public final class rUB extends AbstractC43215rlA implements mMP {
    ...
    public java.lang.String name() {
        return "OKCompliance region mock without whitelist for non-production";
    }
    ...
    public static final class TaskDescription {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: o.rUB.TaskDescription.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    public boolean onClick() {
        ...
        ruf.show(supportFragmentManager);
        return true;
    }
}
