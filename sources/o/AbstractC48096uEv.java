...
public abstract class AbstractC48096uEv<Binding extends ViewDataBinding, Presenter extends BaseBotOrderPresenter> extends AbstractC48165uHj<Binding, Presenter> implements InterfaceC58208ywu {
    ...
    public void OLrzqt() {
        ...
        this.AEQbTJ = true;
        ((uFB) aA_()).EZpvd((C48112uFk) C58163ywB.EZpvd(this));
    }
