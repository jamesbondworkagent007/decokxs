...
public abstract class AbstractActivityC6087aIi extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6087aIi() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aIi.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6087aIi.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        ((InterfaceC6103aIy) aA_()).AEQbTJ((PasskeyCrossDeviceMasterActivity) C58163ywB.EZpvd(this));
    }
