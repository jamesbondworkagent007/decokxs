...
import aws.sdk.kotlin.services.comprehend.serde.InvalidRequestExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes21.dex */
public final class RasterizerSpan implements BB<InvalidRequestException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InvalidRequestException> continuation) throws java.lang.Throwable {
        ...
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            MaskFilterSpan.KWHzl(activity, bArr);
        }
        activity.EZpvd();
