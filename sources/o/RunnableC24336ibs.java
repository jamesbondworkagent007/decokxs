...
/* JADX INFO: renamed from: o.ibs, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes6.dex */
public final class RunnableC24336ibs implements java.lang.Runnable {
    public PointF OLrzqt;
    public final android.widget.TextView copydefault;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final void KWHzl(@NotNull PointF pointF) {
        Intrinsics.checkNotNullParameter(pointF, "");
        this.OLrzqt = pointF;
    }

    public RunnableC24336ibs(@NotNull android.widget.TextView textView) {
    ...
    public void run() {
        int measuredWidth = this.copydefault.getMeasuredWidth();
