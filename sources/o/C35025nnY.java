...
/* JADX INFO: renamed from: o.nnY, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C35025nnY extends AbstractC35018nnR implements InterfaceC27808kEb {
    public C42826rdj AhwBna;
    public C46689tbs values;
    public final /* synthetic */ kDL valueOf = new kDL();
    public final int fetchVPNInfo = qZH.ActionBar.UccSpe;
    public final InterfaceC56387yDm AkhnZx = C56392yDr.copydefault(new Function0() { // from class: o.nnX
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        @Override // kotlin.jvm.functions.Function0
        public final java.lang.Object invoke() {
            return C35025nnY.KWHzl(this.copydefault);
        }
    });
    ...
    public final C35080noa fIwbmz() {
        return (C35080noa) this.AkhnZx.getValue();
    }

    public static final C35080noa KWHzl(C35025nnY c35025nnY) {
        return new C35080noa(c35025nnY);
    }
    ...
    public void initView(@NotNull android.view.View view, android.os.Bundle bundle) {
        ...
        this.values = c46689tbs;
        c46689tbs.KWHzl(fIwbmz());
        fIwbmz().copydefault(MarketHomeUpRankingSubPage.getEntries());
        new TabLayoutMediator(c42826rdjOLrzqt.EZpvd.AYXKKw(), c42826rdjOLrzqt.OLrzqt, true, new TabLayoutMediator.TabConfigurationStrategy() { // from class: o.nnZ
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // com.google.android.material.tabs.TabLayoutMediator.TabConfigurationStrategy
            public final void onConfigureTab(TabLayout.Tab tab, int i) {
                C35025nnY.EZpvd(this.OLrzqt, tab, i);
            }
        }).attach();
        c42826rdjOLrzqt.EZpvd.copydefault(new StateListAnimator());
        rVN.reportFullyDrawn$default((androidx.fragment.app.Fragment) this, true, (java.lang.String) null, 2, (java.lang.Object) null);
        this.AhwBna = c42826rdjOLrzqt;
    }

    public static final void EZpvd(C35025nnY c35025nnY, TabLayout.Tab tab, int i) {
        Intrinsics.checkNotNullParameter(tab, "");
        tab.setText(c35025nnY.fIwbmz().copydefault(i));
        tab.setContentDescription(c35025nnY.fIwbmz().OLrzqt(i));
    }

    /* JADX INFO: renamed from: o.nnY$StateListAnimator */
    public static final class StateListAnimator implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(TabLayout.Tab tab) {
            Intrinsics.checkNotNullParameter(tab, "");
            InterfaceC27808kEb interfaceC27808kEbEZpvd = C27807kEa.EZpvd(C35025nnY.this);
            if (interfaceC27808kEbEZpvd != null) {
                interfaceC27808kEbEZpvd.EZpvd("gainers", C35025nnY.this.isConnected());
            }
        }
    }

    public final void values() {
        C46689tbs c46689tbs = this.values;
        if (c46689tbs != null) {
            c46689tbs.KWHzl();
        }
    }
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        C46688tbr.registerTradeFragmentTrack$default(C46688tbr.KWHzl, this, "MarketHomeUpRankingContainerFragment", new kotlin.Pair[0], null, 4, null);
    }
    ...
    public void onVisible() {
        ...
        EZpvd(getView(), MarketHomeTabType.UP_RANK);
    }

    public final java.lang.String isConnected() {
        C55244xgL c55244xgL;
        C42826rdj c42826rdj = this.AhwBna;
        return (c42826rdj == null || (c55244xgL = c42826rdj.EZpvd) == null || c55244xgL.gEmmrt() != 1) ? "spot" : "futures";
    }
}
