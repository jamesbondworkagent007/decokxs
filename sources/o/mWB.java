...
import com.okinc.dexkline.market.features.coindetail.domain.MapSniperUseCase$map$1;
import com.okinc.dexkline.market.features.coindetail.domain.MapSniperUseCase$map$3;
import com.okinc.dexkline.market.features.coindetail.domain.MapSniperUseCase$map$5;
import com.okinc.dexkline.market.features.coindetail.domain.MapSniperUseCase$map0E7RQCE$$inlined$dexRunCatching$1;
import com.okinc.dexkline.market.features.coindetail.domain.MapSniperUseCase$mapgIAlus$$inlined$dexRunCatching$1;
...
public final class mWB {
    public final C34541ndy AEQbTJ;
    public final CoroutineDispatcher EZpvd;

    @yCM
    public mWB(@NotNull C34541ndy c34541ndy, @NotNull CoroutineDispatcher coroutineDispatcher) {
        Intrinsics.checkNotNullParameter(c34541ndy, "");
        Intrinsics.checkNotNullParameter(coroutineDispatcher, "");
        this.AEQbTJ = c34541ndy;
    ...
    */
    public final java.lang.Object OLrzqt(@NotNull EarlyBuyers earlyBuyers, @NotNull Continuation<? super Result<C32316mXm>> continuation) {
        ...
        try {
            if (i2 == 0) {
                ...
                mWB mwb2 = (mWB) mapSniperUseCase$map$1.L$0;
                C56391yDq.AEQbTJ(obj);
                ...
                if (it.hasNext()) {
                    ...
                    mapSniperUseCase$map$1.L$0 = mwb;
                    ...
                    java.lang.Object objEZpvd = mwb.EZpvd(sniperHolder, mapSniperUseCase$map$1);
                    ...
                    mXB mxb2 = (mXB) objM7386unboximpl;
                    if (mxb2 != null) {
                    }
                    mwb = mwb2;
                    str2 = str9;
                    if (it.hasNext()) {
                        return Result.m7377constructorimpl(new C32316mXm(str3, str4, str, str2, (java.util.List) collection));
                    }
                }
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final java.lang.Object copydefault(@NotNull EarlyBuyersWs earlyBuyersWs, @NotNull java.util.List<mXB> list, @NotNull Continuation<? super Result<C32316mXm>> continuation) throws java.lang.Throwable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: o.mWB */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: map-0E7RQCE$default, reason: not valid java name */
    public static /* synthetic */ java.lang.Object m8688map0E7RQCE$default(mWB mwb, EarlyBuyersWs earlyBuyersWs, java.util.List list, Continuation continuation, int i, java.lang.Object obj) {
        if ((i & 2) != 0) {
            list = yDY.AhwBna();
        }
        return mwb.copydefault(earlyBuyersWs, list, continuation);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final java.lang.Object EZpvd(@NotNull SniperHolder sniperHolder, @NotNull Continuation<? super Result<mXB>> continuation) throws java.lang.Throwable {
