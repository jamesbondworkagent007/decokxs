...
public final class C32675mi {
    public static final C12497co copydefault(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        C12497co.StateListAnimator stateListAnimator = new C12497co.StateListAnimator();
                ...
                if (numOLrzqt == null || numOLrzqt.intValue() != iCopydefault2) {
                    ...
                    while (actionBarKWHzl.EZpvd()) {
                        if (!actionBarKWHzl.copydefault()) {
                            ...
                            arrayList.add(AbstractC12601cq.OLrzqt.KWHzl(actionBarKWHzl.fetchVPNInfo()));
                        }
                    }
