...
public final class ConfirmationCallback {
    public static final NetworkStatsHistory EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        NetworkStatsHistory.ActionBar actionBar = new NetworkStatsHistory.ActionBar();
        C5101Et c5101Et = new C5101Et(AbstractC5105Ex.FragmentManager.AEQbTJ, new EX("Index"));
        C5101Et c5101Et2 = new C5101Et(AbstractC5105Ex.Fragment.KWHzl, new EX("SyntaxTokens"));
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    ...
                    while (actionBarKWHzl.EZpvd()) {
                        if (!actionBarKWHzl.copydefault()) {
                            ...
                            arrayList.add(FrameMetrics.OLrzqt(interfaceC5095En));
                        }
                    }
