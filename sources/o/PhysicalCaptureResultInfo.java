...
public final class PhysicalCaptureResultInfo {
    public static final ListFragment EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        ListFragment.Activity activity = new ListFragment.Activity();
