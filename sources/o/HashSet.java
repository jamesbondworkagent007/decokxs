...
public final class HashSet {
    public static final byte[] copydefault(DT dt, final Runtime runtime) {
        EW ew = new EW();
        ...
        java.lang.String strEZpvd = runtime.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et, strEZpvd);
        }
        if (runtime.AEQbTJ() != null) {
            ebEZpvd.OLrzqt(c5101Et2, new Function1<InterfaceC5097Ep, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentity.serde.TagResourceOperationSerializerKt$serializeTagResourceOperationBody$1$2
                ...
                public final void invoke2(@NotNull InterfaceC5097Ep interfaceC5097Ep) {
                    ...
                    for (Map.Entry<String, String> entry : runtime.AEQbTJ().entrySet()) {
