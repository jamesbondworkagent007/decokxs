...
public final class C23752iI implements BH<T> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull T t, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.ListUsersOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C23860iM.AEQbTJ(dt, t)));
