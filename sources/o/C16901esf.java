...
public class C16901esf extends AbstractC16899esd {
    ...
    static {
        ...
        sparseIntArray.put(C13754dXa.ActionBar.MainThread, 2);
    }

    public C16901esf(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, copydefault, KWHzl));
    }

    public C16901esf(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
