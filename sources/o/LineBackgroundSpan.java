...
import aws.sdk.kotlin.services.comprehend.model.InternalServerException;
import aws.sdk.kotlin.services.comprehend.serde.InternalServerExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes21.dex */
public final class LineBackgroundSpan implements BB<InternalServerException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InternalServerException> continuation) throws java.lang.Throwable {
        ...
        InternalServerException.StateListAnimator stateListAnimator;
        ...
        if (i2 == 0) {
            ...
            InternalServerException.StateListAnimator stateListAnimator2 = new InternalServerException.StateListAnimator();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            internalServerExceptionDeserializer$deserialize$1.L$0 = stateListAnimator2;
            ...
            stateListAnimator = (InternalServerException.StateListAnimator) internalServerExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            LeadingMarginSpan.AEQbTJ(stateListAnimator, bArr);
        }
