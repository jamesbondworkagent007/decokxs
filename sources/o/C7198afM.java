...
public class C7198afM extends AbstractC7210afY {
    public static UnicodeSet OLrzqt;
    ...
    static {
        AEQbTJ.OLrzqt("[[:Mymr:]&[:LineBreak=SA:]]");
        AEQbTJ.KWHzl();
        copydefault.OLrzqt("[[:Mymr:]&[:LineBreak=SA:]&[:M:]]");
        copydefault.KWHzl(32);
        OLrzqt = new UnicodeSet(AEQbTJ);
        KWHzl.EZpvd(4096, 4138);
        copydefault.KWHzl();
        OLrzqt.KWHzl();
        KWHzl.KWHzl();
        AEQbTJ.AYXKKw();
    ...
    public C7198afM() throws java.io.IOException {
        AEQbTJ(AEQbTJ);
        this.EZpvd = C7209afX.EZpvd("Mymr");
    }

    public boolean equals(java.lang.Object obj) {
        return obj instanceof C7198afM;
    }
    ...
    public boolean AEQbTJ(int i) {
        return C7223afl.copydefault(i, 4106) == 28;
    }
                        ...
                        if (characterIterator.getIndex() < i2 && iEZpvd < 3) {
                            ...
                            if (applicationArr[i3].OLrzqt(characterIterator, this.EZpvd, i2) > 0 && (iEZpvd == 0 || applicationArr[i3].OLrzqt() < 3)) {
                                ...
                                while (true) {
                                    ...
                                    if (OLrzqt.AEQbTJ(cCurrent) && KWHzl.AEQbTJ(cCurrent2)) {
