...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.TooManyRequestsExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes2.dex */
public final class HdmiRecordListener implements BB<TooManyRequestsException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super TooManyRequestsException> continuation) throws java.lang.Throwable {
        ...
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            InputDeviceIdentifier.AEQbTJ(activity, bArr);
        }
        activity.EZpvd();
