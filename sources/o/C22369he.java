...
public final class C22369he implements BH<C5627a> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C5627a c5627a, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.GetSegmentDetectionOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C22263hc.copydefault(dt, c5627a)));
