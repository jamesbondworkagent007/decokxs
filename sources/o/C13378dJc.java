...
/* JADX INFO: renamed from: o.dJc, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final class C13378dJc implements dGQ.StateListAnimator {
    public final WeakReference<C13241dEa> KWHzl;

    public C13378dJc(@NotNull WeakReference<C13241dEa> weakReference) {
    ...
    public void AEQbTJ(@NotNull java.lang.String str, @NotNull java.lang.String str2, @NotNull java.lang.String str3, java.lang.Long l) {
        ...
        if (c13241dEa != null) {
            ...
            c13241dEa.setDappType(3);
            c13241dEa.evaluateJavascript("window.aptos.sendError(" + c13241dEa.dNCPSb() + ",\"" + str2 + "\")", null);
    ...
    public void AEQbTJ(@NotNull java.lang.String str, @NotNull java.lang.String str2, @NotNull java.lang.String str3) {
        ...
        if (c13241dEa != null) {
            ...
            java.lang.String strOLrzqt = interfaceC9738bbJValues.OLrzqt(637L);
            if (C33129mqd.OLrzqt((java.lang.CharSequence) strOLrzqt)) {
                java.util.Map mapGEmmrt = C56424yEw.gEmmrt(C56390yDp.OLrzqt(WalletSearchRequest.SEARCH_SOURCE_ADDRESS, str2), C56390yDp.OLrzqt("publicKey", EIP1271Verifier.hexPrefix + strOLrzqt));
                c13241dEa.evaluateJavascript("window.aptos.sendResponse(" + c13241dEa.dNCPSb() + ",JSON.stringify(" + new Gson().toJson(mapGEmmrt) + "))", null);
                return;
            }
            java.util.Map mapGEmmrt2 = C56424yEw.gEmmrt(C56390yDp.OLrzqt(WalletSearchRequest.SEARCH_SOURCE_ADDRESS, str2), C56390yDp.OLrzqt("publicKey", ""));
            c13241dEa.evaluateJavascript("window.aptos.sendResponse(" + c13241dEa.dNCPSb() + ",JSON.stringify(" + new Gson().toJson(mapGEmmrt2) + "))", null);
        }
    }
