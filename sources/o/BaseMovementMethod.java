...
public final class BaseMovementMethod {
    public static final void OLrzqt(@NotNull InterfaceC5106Ey interfaceC5106Ey, @NotNull MessageQueue messageQueue) {
        ...
        ebEZpvd.AEQbTJ(c5101Et2, messageQueue.KWHzl());
        java.lang.String strEZpvd = messageQueue.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et3, strEZpvd);
        }
        ShellCommand shellCommandCopydefault = messageQueue.copydefault();
