...
public final class C22687hk implements BH<C15212e> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C15212e c15212e, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.GetTextDetectionOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C22475hg.OLrzqt(dt, c15212e)));
