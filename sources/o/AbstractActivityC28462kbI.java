...
public abstract class AbstractActivityC28462kbI extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC28462kbI() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.kbI.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC28462kbI.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.KWHzl = true;
        ((InterfaceC28533kca) aA_()).EZpvd((ActivityC28461kbH) C58163ywB.EZpvd(this));
    }
