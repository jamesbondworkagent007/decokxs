...
/* JADX INFO: renamed from: o.fMz, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes5.dex */
public abstract class AbstractActivityC17644fMz extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC17644fMz() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.fMz.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC17644fMz.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.AEQbTJ = true;
        ((fMJ) aA_()).AEQbTJ((fMM) C58163ywB.EZpvd(this));
    }
