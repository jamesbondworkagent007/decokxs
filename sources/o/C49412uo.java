...
import aws.sdk.kotlin.services.translate.model.ConflictException;
import aws.sdk.kotlin.services.translate.serde.ConflictExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.uo, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C49412uo implements BB<ConflictException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super ConflictException> continuation) throws java.lang.Throwable {
        ...
        ConflictException.Activity activity;
        ...
        if (i2 == 0) {
            ...
            ConflictException.Activity activity2 = new ConflictException.Activity();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            conflictExceptionDeserializer$deserialize$1.L$0 = activity2;
            ...
            activity = (ConflictException.Activity) conflictExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C49253ul.KWHzl(activity, bArr);
        }
        activity.OLrzqt();
