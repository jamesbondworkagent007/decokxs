...
public abstract class qHH extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.qHH.3
    ...
    public void AEQbTJ() {
        ...
        ((InterfaceC40076qIl) aA_()).OLrzqt((SearchActivity) C58163ywB.EZpvd(this));
    }
