...
public final class mRA {
    ...
    public static final java.lang.String EZpvd(java.lang.String str, @NotNull RoundingMode roundingMode, @NotNull C38307pTy c38307pTy, @NotNull DisplaySign displaySign, @NotNull java.util.Locale locale, boolean z, boolean z2) {
        ...
        if (AEQbTJ(java.lang.Double.valueOf(dAEQbTJ))) {
            return z ? "0.00" : "0";
        }
        ...
        if ((1.0E-12d <= dAEQbTJ && dAEQbTJ <= 1.0E-6d) || (-1.0E-6d <= dAEQbTJ && dAEQbTJ <= -1.0E-12d)) {
            return EZpvd(dAEQbTJ, roundingMode, c38307pTy, displaySign, locale, z2);
        }
    ...
    public static final boolean AEQbTJ(java.lang.Object obj) {
        return mRE.copydefault(obj, 0) || mRE.copydefault(obj, java.lang.Double.valueOf(AudioStats.AUDIO_AMPLITUDE_NONE));
    }
    ...
    public static final java.lang.String KWHzl(double d, RoundingMode roundingMode, C38307pTy c38307pTy, DisplaySign displaySign, java.util.Locale locale) {
        return KWHzl(pTB.KWHzl(C33129mqd.EZpvd(java.lang.Double.valueOf(d)), roundingMode, c38307pTy, displaySign, locale));
    }

    public static final java.lang.String EZpvd(double d, RoundingMode roundingMode, C38307pTy c38307pTy, DisplaySign displaySign, java.util.Locale locale, boolean z) {
        ...
        return KWHzl(strKWHzl);
    }

    public static final java.lang.String KWHzl(@NotNull final java.lang.String str) {
        Intrinsics.checkNotNullParameter(str, "");
        return StringsKt__StringsKt.OLrzqt(StringsKt__StringsKt.OLrzqt(new Regex("(\\.\\d*?[1-9]+)(0+)(\\d+)?").replace(str, new Function1() { // from class: o.mRC
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj) {
                return mRA.EZpvd(str, (MatchResult) obj);
            }
        }), '0'), '.');
    }

    public static final java.lang.CharSequence EZpvd(java.lang.String str, MatchResult matchResult) {
    ...
    public static final int AEQbTJ(@NotNull java.lang.String str, boolean z) {
        Intrinsics.checkNotNullParameter(str, "");
        for (kotlin.Pair<java.lang.Double, java.lang.Integer> pair : z ? AEQbTJ : EZpvd) {
            double dDoubleValue = pair.component1().doubleValue();
            int iIntValue = pair.component2().intValue();
            if (mRE.KWHzl(str, java.lang.Double.valueOf(dDoubleValue))) {
                return iIntValue;
            }
        }
        return 0;
    ...
    static {
        ...
        AEQbTJ = yDY.gEmmrt(pair, pair2, pair3, pair4, pair5, pair6, pair7, new kotlin.Pair(dValueOf8, 13));
