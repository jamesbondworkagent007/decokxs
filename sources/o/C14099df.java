...
public final class C14099df {
    public static final AdapterViewAnimator KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        AdapterViewAnimator.Application application = new AdapterViewAnimator.Application();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                application.KWHzl(C11647cW.copydefault(interfaceC5095En));
            } else {
