...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.NotAuthorizedExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes2.dex */
public final class CaptureResultExtras implements BB<NotAuthorizedException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super NotAuthorizedException> continuation) throws java.lang.Throwable {
        ...
        NotAuthorizedException.Activity activity;
        ...
        if (i2 == 0) {
            ...
            NotAuthorizedException.Activity activity2 = new NotAuthorizedException.Activity();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            notAuthorizedExceptionDeserializer$deserialize$1.L$0 = activity2;
            ...
            activity = (NotAuthorizedException.Activity) notAuthorizedExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            SyntheticKey.copydefault(activity, bArr);
        }
        activity.AEQbTJ();
