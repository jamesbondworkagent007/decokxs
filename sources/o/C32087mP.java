...
import aws.sdk.kotlin.services.textract.endpoints.internal.EndpointResolverAdapter$resolve$1;
...
public final class C32087mP implements BD {
    public final InterfaceC31925mJ.StateListAnimator KWHzl;

    public C32087mP(@NotNull InterfaceC31925mJ.StateListAnimator stateListAnimator) {
    ...
    */
    public java.lang.Object EZpvd(@NotNull BX bx, @NotNull Continuation<? super C57631ym> continuation) throws java.lang.Throwable {
        ...
        if (i2 == 0) {
            ...
            C32060mO c32060mOEZpvd = C32195mT.EZpvd(this.KWHzl, bx);
            InterfaceC32141mR interfaceC32141mRGEmmrt = this.KWHzl.gEmmrt();
            endpointResolverAdapter$resolve$1.label = 1;
            objResolveEndpoint = interfaceC32141mRGEmmrt.resolveEndpoint(c32060mOEZpvd, endpointResolverAdapter$resolve$1);
