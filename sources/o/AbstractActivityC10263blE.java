...
public abstract class AbstractActivityC10263blE extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC10263blE() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.blE.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC10263blE.this.AEQbTJ();
            }
        });
    }
    ...
    public void AEQbTJ() {
        ...
        ((InterfaceC10268blJ) aA_()).OLrzqt((ActivityC10272blN) C58163ywB.EZpvd(this));
    }
