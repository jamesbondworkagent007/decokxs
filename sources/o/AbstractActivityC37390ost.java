...
/* JADX INFO: renamed from: o.ost, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes16.dex */
public abstract class AbstractActivityC37390ost<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37390ost() {
        AYXKKw();
    }

    private void AYXKKw() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ost.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37390ost.this.djBIcL();
            }
        });
    }
    ...
    public void djBIcL() {
        ...
        this.OLrzqt = true;
        ((InterfaceC37435otl) aA_()).AEQbTJ((ActivityC37424ota) C58163ywB.EZpvd(this));
    }
