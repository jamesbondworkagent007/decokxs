...
/* JADX INFO: renamed from: o.wQy, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes11.dex */
public abstract class AbstractC52587wQy extends AbstractC52582wQt {
    public java.util.ArrayList<android.widget.TextView> ejfBZ;
    public java.util.ArrayList<android.widget.TextView> fJNWhG;
    public android.widget.TextView getNewProxyInstance;

    public final void setRightValueGravity(int i) {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractC52587wQy(@NotNull android.content.Context context) {
        super(context);
    ...
    public android.view.View OLrzqt(@NotNull android.view.ViewGroup viewGroup) {
        ...
        android.view.View viewInflate = android.view.LayoutInflater.from(getContext()).inflate(C48033uCm.Activity.OeawrHRnVkix, viewGroup, true);
        ...
        this.getNewProxyInstance = (android.widget.TextView) viewInflate.findViewById(C48033uCm.Application.allOf);
        this.fJNWhG = new java.util.ArrayList<>();
        this.ejfBZ = new java.util.ArrayList<>();
        java.util.ArrayList arrayList = this.fJNWhG;
    ...
    public final void setLeftTitleText(@NotNull java.util.List<java.lang.String> list) {
        ...
        while (true) {
            ...
            java.util.ArrayList<android.widget.TextView> arrayList2 = this.fJNWhG;
            if (arrayList2 == null) {
                Intrinsics.gEmmrt("");
                arrayList2 = null;
            }
            if (i < arrayList2.size()) {
                java.util.ArrayList<android.widget.TextView> arrayList3 = this.fJNWhG;
                if (arrayList3 == null) {
                    Intrinsics.gEmmrt("");
                } else {
        ...
        java.util.ArrayList<android.widget.TextView> arrayList4 = this.fJNWhG;
        if (arrayList4 == null) {
            Intrinsics.gEmmrt("");
        } else {
    ...
    public final void setRightValueText(@NotNull java.util.List<java.lang.String> list) {
        ...
        while (true) {
            ...
            java.lang.String str = (java.lang.String) next;
            java.util.ArrayList<android.widget.TextView> arrayList2 = this.ejfBZ;
            if (arrayList2 == null) {
                Intrinsics.gEmmrt("");
                arrayList2 = null;
            }
        ...
        java.util.ArrayList<android.widget.TextView> arrayList4 = this.ejfBZ;
        if (arrayList4 == null) {
            Intrinsics.gEmmrt("");
        } else {
            arrayList = arrayList4;
    ...
    private final void AEQbTJ(java.util.List<java.lang.Integer> list) {
        ...
        for (java.lang.Object obj : list) {
            ...
            java.util.ArrayList<android.widget.TextView> arrayList = this.ejfBZ;
            if (arrayList == null) {
                Intrinsics.gEmmrt("");
                arrayList = null;
            }
