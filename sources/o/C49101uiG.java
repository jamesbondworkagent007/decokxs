...
/* JADX INFO: renamed from: o.uiG, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes11.dex */
public final class C49101uiG extends AbstractC49096uiB {
    public static final C49101uiG copydefault = new C49101uiG();
    public static final SharePlatform valueOf = SharePlatform.DISCORD;
    public static java.lang.String djBIcL = "com.discord";
    public static java.util.List<java.lang.String> AEQbTJ = C56402yEa.EZpvd("com.discord.share.ShareActivity");
    ...
    public java.lang.CharSequence OLrzqt(@NotNull android.content.Context context) {
        ...
        return context.getResources().getString(C48931uew.Activity.gEmmrt);
    }

    @Override // o.InterfaceC49121uia
    public android.graphics.drawable.Drawable AEQbTJ(@NotNull android.content.Context context) {
        Intrinsics.checkNotNullParameter(context, "");
        return ContextCompat.getDrawable(context, C48894ueL.ActionBar.KWHzl);
    }
