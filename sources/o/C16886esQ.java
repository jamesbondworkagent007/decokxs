...
public class C16886esQ extends AbstractC16884esO {
    ...
    static {
        ...
        sparseIntArray.put(C13754dXa.ActionBar.zMXLsR, 1);
        sparseIntArray.put(C13754dXa.ActionBar.ReportDrawn, 2);
    }

    public C16886esQ(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, KWHzl, EZpvd));
    }

    public C16886esQ(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
