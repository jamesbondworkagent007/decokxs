...
public final class C38282pT implements BH<C35371nu> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C35371nu c35371nu, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.DetectDocumentTextOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C38390pX.OLrzqt(dt, c35371nu)));
