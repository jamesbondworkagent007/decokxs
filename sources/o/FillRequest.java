...
public final class FillRequest {
    public static final byte[] copydefault(DT dt, BeamShareData beamShareData) {
        EW ew = new EW();
        ...
        java.lang.String strEZpvd = beamShareData.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et, strEZpvd);
        }
        java.lang.String strAEQbTJ = beamShareData.AEQbTJ();
        if (strAEQbTJ != null) {
