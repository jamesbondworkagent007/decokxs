...
import aws.sdk.kotlin.services.textract.serde.ListTagsForResourceOperationDeserializer$deserialize$1;
import kotlin.KotlinNothingValueException;
import kotlin.coroutines.Continuation;
import o.C37450ou;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.rw, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C43797rw implements BB<C37450ou> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super C37450ou> continuation) throws java.lang.Throwable {
        ListTagsForResourceOperationDeserializer$deserialize$1 listTagsForResourceOperationDeserializer$deserialize$1;
        C37450ou.ActionBar actionBar;
        byte[] bArr;
        ...
        if (i2 != 0) {
            ...
            actionBar = (C37450ou.ActionBar) listTagsForResourceOperationDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(objCopydefault);
            bArr = (byte[]) objCopydefault;
            if (bArr != null) {
                C43744rv.EZpvd(actionBar, bArr);
            }
            actionBar.AEQbTJ();
        ...
        if (!zT.copydefault(interfaceC5039CjAEQbTJ.OLrzqt())) {
            ...
            if (C43744rv.copydefault(dt, c58859zS, listTagsForResourceOperationDeserializer$deserialize$1) == objCopydefault2) {
                return objCopydefault2;
            }
            throw new KotlinNothingValueException();
        }
        actionBar = new C37450ou.ActionBar();
        zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
        listTagsForResourceOperationDeserializer$deserialize$1.L$0 = actionBar;
