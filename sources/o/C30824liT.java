...
/* JADX INFO: renamed from: o.liT, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public final class C30824liT implements InterfaceC25317iuT {
    public DexAutoSlippageInfoParam AEQbTJ;
    public final AdvancedCustomMevPresetVM EZpvd;
    public AdvancedQuoteUiData copydefault;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final void EZpvd(AdvancedQuoteUiData advancedQuoteUiData, DexAutoSlippageInfoParam dexAutoSlippageInfoParam) {
        this.copydefault = advancedQuoteUiData;
        this.AEQbTJ = dexAutoSlippageInfoParam;
    }
    ...
    public C30824liT(@NotNull AdvancedCustomMevPresetVM advancedCustomMevPresetVM) {
        Intrinsics.checkNotNullParameter(advancedCustomMevPresetVM, "");
        this.EZpvd = advancedCustomMevPresetVM;
    }
    ...
    public void EZpvd(@NotNull C25301iuD c25301iuD) {
        ...
        if (slippageFeeTypeKWHzl != null) {
            this.EZpvd.KWHzl(java.lang.Integer.valueOf(slippageFeeTypeKWHzl.getValue()).intValue());
        }
        AdvancedCustomMevPresetVM advancedCustomMevPresetVM = this.EZpvd;
        if (c25301iuD.EZpvd() != InputStatus.ERROR && (strOLrzqt = c25301iuD.OLrzqt()) != null) {
            str = strOLrzqt;
        }
        advancedCustomMevPresetVM.copydefault(str);
        this.EZpvd.OLrzqt(c25301iuD.copydefault());
        this.EZpvd.OLrzqt(c25301iuD.AEQbTJ());
    }
}
