...
public final class C50211vG {
    public static final C45943tC KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        C45943tC.StateListAnimator stateListAnimator = new C45943tC.StateListAnimator();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                stateListAnimator.AEQbTJ(AbstractC46051tG.EZpvd.OLrzqt(stateListAnimatorEZpvd.fetchVPNInfo()));
            } else {
