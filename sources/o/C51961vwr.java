...
public final class C51961vwr extends ConstraintLayout {
    public float AEQbTJ;
    public float OLrzqt;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C51961vwr(@NotNull android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        if (numValueOf != null && numValueOf.intValue() == 0) {
            ...
            if (numValueOf != null && numValueOf.intValue() == 2) {
                ...
                while (true) {
                    ...
                    if (((childAt instanceof LineChart) || (childAt instanceof BarChart)) && AEQbTJ(childAt, motionEvent.getRawX(), motionEvent.getRawY())) {
                        z = true;
                        break;
                    }
                    i++;
    ...
    public final boolean AEQbTJ(@NotNull android.view.View view, float f, float f2) {
