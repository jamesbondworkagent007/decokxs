...
public abstract class uFX extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.uFX.1
    ...
    public void AEQbTJ() {
        ...
        this.KWHzl = true;
        ((InterfaceC48131uGc) aA_()).copydefault((uFV) C58163ywB.EZpvd(this));
    }
