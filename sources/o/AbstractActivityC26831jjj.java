...
/* JADX INFO: renamed from: o.jjj, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes6.dex */
public abstract class AbstractActivityC26831jjj extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC26831jjj() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.jjj.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC26831jjj.this.KWHzl();
            }
        });
    }
    ...
    public void KWHzl() {
        ...
        ((InterfaceC27004jmx) aA_()).AEQbTJ((InvestUniv3SubscribeActivity) C58163ywB.EZpvd(this));
    }
