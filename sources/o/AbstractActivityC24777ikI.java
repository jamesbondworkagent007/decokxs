...
public abstract class AbstractActivityC24777ikI extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC24777ikI() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ikI.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC24777ikI.this.KWHzl();
            }
        });
    }
    ...
    public void KWHzl() {
        ...
        this.OLrzqt = true;
        ((InterfaceC24788ikT) aA_()).copydefault((ActivityC24781ikM) C58163ywB.EZpvd(this));
    }
