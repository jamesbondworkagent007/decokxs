...
import aws.sdk.kotlin.services.comprehend.model.TooManyRequestsException;
import aws.sdk.kotlin.services.comprehend.serde.TooManyRequestsExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes21.dex */
public final class MagnificationSpec implements BB<TooManyRequestsException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super TooManyRequestsException> continuation) throws java.lang.Throwable {
        ...
        TooManyRequestsException.Activity activity;
        ...
        if (i2 == 0) {
            ...
            TooManyRequestsException.Activity activity2 = new TooManyRequestsException.Activity();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            tooManyRequestsExceptionDeserializer$deserialize$1.L$0 = activity2;
            ...
            activity = (TooManyRequestsException.Activity) tooManyRequestsExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            KeyboardShortcutGroup.copydefault(activity, bArr);
        }
        activity.AEQbTJ();
