...
public final class C41504qs implements BH<C34062nQ> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C34062nQ c34062nQ, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.GetAdapterVersionOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C41610qu.KWHzl(dt, c34062nQ)));
