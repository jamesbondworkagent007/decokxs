...
public abstract class AbstractActivityC37196opK extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37196opK() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.opK.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37196opK.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.EZpvd = true;
        ((InterfaceC37198opM) aA_()).OLrzqt((ActivityC37195opJ) C58163ywB.EZpvd(this));
    }
