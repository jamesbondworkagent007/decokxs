...
public final class Curve {
    public static final byte[] AEQbTJ(DT dt, WallpaperColors wallpaperColors) {
        EW ew = new EW();
        ...
        java.lang.String strCopydefault = wallpaperColors.copydefault();
        if (strCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et, strCopydefault);
        }
        java.lang.String strKWHzl = wallpaperColors.KWHzl();
        if (strKWHzl != null) {
