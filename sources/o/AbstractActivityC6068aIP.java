...
public abstract class AbstractActivityC6068aIP extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6068aIP() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aIP.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6068aIP.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.OLrzqt = true;
        ((InterfaceC6135aJd) aA_()).copydefault((PasskeyCrossDeviceVerifyActivity) C58163ywB.EZpvd(this));
    }
