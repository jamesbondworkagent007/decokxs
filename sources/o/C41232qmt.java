...
import com.okinc.market.discover.features.markets.sub.rank.spot.domain.GetMarketDiscoverSpotUpPosUseCase$onExecute$1;
...
/* JADX INFO: renamed from: o.qmt, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes9.dex */
public final class C41232qmt extends AbstractC49400uno<C41228qmp, java.util.List<? extends UpDownRank>> {
    ...
    /* JADX INFO: renamed from: o.qmt$Activity */
    ...
    @yCM
    public C41232qmt(@NotNull CoroutineDispatcher coroutineDispatcher, @NotNull C41662quz c41662quz, @NotNull C41446qqv c41446qqv) {
    ...
    /* JADX INFO: renamed from: o.qmt$TaskDescription */
    public static final class TaskDescription {
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] call: o.qmt.TaskDescription.<init>():void type: THIS */
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    ...
    */
    public java.lang.Object KWHzl(@NotNull C41228qmp c41228qmp, @NotNull Continuation<? super java.util.List<UpDownRank>> continuation) throws java.lang.Throwable {
        GetMarketDiscoverSpotUpPosUseCase$onExecute$1 getMarketDiscoverSpotUpPosUseCase$onExecute$1;
        PeriodEnum periodEnumAEQbTJ;
        C41232qmt c41232qmt;
        java.lang.String str;
        if (continuation instanceof GetMarketDiscoverSpotUpPosUseCase$onExecute$1) {
            getMarketDiscoverSpotUpPosUseCase$onExecute$1 = (GetMarketDiscoverSpotUpPosUseCase$onExecute$1) continuation;
            int i = getMarketDiscoverSpotUpPosUseCase$onExecute$1.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                getMarketDiscoverSpotUpPosUseCase$onExecute$1.label = i - Integer.MIN_VALUE;
            } else {
                getMarketDiscoverSpotUpPosUseCase$onExecute$1 = new GetMarketDiscoverSpotUpPosUseCase$onExecute$1(this, continuation);
            }
        }
        java.lang.Object objValueOf = getMarketDiscoverSpotUpPosUseCase$onExecute$1.result;
        java.lang.Object objCopydefault = C56442yFn.copydefault();
        int i2 = getMarketDiscoverSpotUpPosUseCase$onExecute$1.label;
        if (i2 == 0) {
            C56391yDq.AEQbTJ(objValueOf);
            ChargeGroupVo chargeGroupVoKWHzl = c41228qmp.KWHzl();
            periodEnumAEQbTJ = c41228qmp.AEQbTJ();
            java.lang.String key = chargeGroupVoKWHzl.OLrzqt().getKey();
            C41298qoF c41298qoF = C41298qoF.AEQbTJ;
            c41298qoF.EZpvd("GetMarketDiscoverSpotUpPosUseCase", "onExecute: rankType=" + key + ", period=" + periodEnumAEQbTJ);
            ...
            mapOLrzqt.put("rank", "0");
            if (periodEnumAEQbTJ != PeriodEnum.RANKING_PERIOD_1D) {
                mapOLrzqt.put(TypedValues.CycleType.S_WAVE_PERIOD, periodEnumAEQbTJ.getInputPara());
            }
            java.util.Map<java.lang.String, java.lang.String> mapAYXKKw = C56423yEv.AYXKKw(mapOLrzqt);
            c41298qoF.EZpvd("GetMarketDiscoverSpotUpPosUseCase", "Request params: " + mapAYXKKw);
            C41662quz c41662quz = this.copydefault;
            getMarketDiscoverSpotUpPosUseCase$onExecute$1.L$0 = this;
            getMarketDiscoverSpotUpPosUseCase$onExecute$1.L$1 = periodEnumAEQbTJ;
            getMarketDiscoverSpotUpPosUseCase$onExecute$1.L$2 = strAEQbTJ;
            getMarketDiscoverSpotUpPosUseCase$onExecute$1.label = 1;
            objValueOf = c41662quz.valueOf(mapAYXKKw, getMarketDiscoverSpotUpPosUseCase$onExecute$1);
            ...
            str = (java.lang.String) getMarketDiscoverSpotUpPosUseCase$onExecute$1.L$2;
            periodEnumAEQbTJ = (PeriodEnum) getMarketDiscoverSpotUpPosUseCase$onExecute$1.L$1;
            c41232qmt = (C41232qmt) getMarketDiscoverSpotUpPosUseCase$onExecute$1.L$0;
            C56391yDq.AEQbTJ(objValueOf);
        }
        java.util.List list = (java.util.List) objValueOf;
        if (list == null || list.isEmpty()) {
            C41298qoF.w$default(C41298qoF.AEQbTJ, "GetMarketDiscoverSpotUpPosUseCase", "HTTP response is empty or null", null, 4, null);
            return null;
        }
        ...
        if (list2 == null || list2.isEmpty()) {
            C41298qoF.w$default(C41298qoF.AEQbTJ, "GetMarketDiscoverSpotUpPosUseCase", "No data found for timezone: " + strKWHzl, null, 4, null);
            return null;
        }
        C41298qoF.AEQbTJ.EZpvd("GetMarketDiscoverSpotUpPosUseCase", "HTTP response received: " + list2.size() + " items");
        if (C27563jxZ.OLrzqt.AhwBna()) {
            c41232qmt.OLrzqt(list2, periodEnumAEQbTJ, str);
        }
        return list2;
    }

    private final void OLrzqt(java.util.List<UpDownRank> list, PeriodEnum periodEnum, java.lang.String str) {
        java.lang.Object objM7377constructorimpl;
        C41298qoF.AEQbTJ.EZpvd("GetMarketDiscoverSpotUpPosUseCase", "Start caching period tickers: " + list.size() + " items, period=" + periodEnum + ", zone=" + str);
        int i = 0;
        int i2 = 0;
        for (UpDownRank upDownRank : list) {
            try {
                Result.Application application = Result.Companion;
                PeriodTickersPo periodTickersPoKWHzl = KWHzl(this.AEQbTJ.AEQbTJ(upDownRank.getInstId()), upDownRank, periodEnum, str);
                if (periodTickersPoKWHzl != null) {
                    this.AEQbTJ.OLrzqt(upDownRank.getInstId(), periodTickersPoKWHzl);
                    i++;
                }
            ...
            if (thM7380exceptionOrNullimpl != null) {
                i2++;
                C41298qoF.AEQbTJ.AEQbTJ("GetMarketDiscoverSpotUpPosUseCase", "Failed to cache period ticker: " + upDownRank.getInstId(), thM7380exceptionOrNullimpl);
            }
        }
        C41298qoF.AEQbTJ.EZpvd("GetMarketDiscoverSpotUpPosUseCase", "Period tickers cached: success=" + i + ", failure=" + i2);
    }

    private final PeriodTickersPo KWHzl(PeriodTickersPo periodTickersPo, UpDownRank upDownRank, PeriodEnum periodEnum, java.lang.String str) {
        ...
        int i = Activity.OLrzqt[periodEnum.ordinal()];
        if (i == 1) {
