...
public abstract class AbstractActivityC32310mXg extends ActivityC36345oYi implements InterfaceC58208ywu {
    ...
    public AbstractActivityC32310mXg() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.mXg.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC32310mXg.this.AEQbTJ();
            }
        });
    }
    ...
    public void AEQbTJ() {
        ...
        this.OLrzqt = true;
        ((InterfaceC32317mXn) aA_()).AEQbTJ((ActivityC32309mXf) C58163ywB.EZpvd(this));
    }
