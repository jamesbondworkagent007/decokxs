...
/* JADX INFO: renamed from: o.ylE, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes17.dex */
public final class C57583ylE extends RecyclerView.ItemDecoration {
 ...
 A[MD:(int, boolean, boolean):void (m)] (LINE:7) call: o.ylE.<init>(int, boolean, boolean):void type: THIS */
    public /* synthetic */ C57583ylE(int i, boolean z, boolean z2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, (i2 & 2) != 0 ? true : z, (i2 & 4) != 0 ? true : z2);
    }

    public C57583ylE(int i, boolean z, boolean z2) {
        this.AEQbTJ = i;
        this.OLrzqt = z;
        this.KWHzl = z2;
    }
