...
public final class TimeFormatter {
    public static final IInterface AEQbTJ(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        IInterface.StateListAnimator stateListAnimator = new IInterface.StateListAnimator();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                stateListAnimator.EZpvd(NetworkViolation.KWHzl.AEQbTJ(stateListAnimatorEZpvd.fetchVPNInfo()));
            } else {
