...
public abstract class AbstractActivityC5884aEr extends AbstractActivityC33001moH implements InterfaceC58208ywu {
    ...
    public AbstractActivityC5884aEr() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aEr.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC5884aEr.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.EZpvd = true;
        ((InterfaceC5885aEs) aA_()).KWHzl((SendCrossDeviceVerificationRequestActivity) C58163ywB.EZpvd(this));
    }
