...
/* JADX INFO: renamed from: o.uiW, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes11.dex */
public final class C49117uiW extends AbstractC49096uiB {
    public static final C49117uiW AEQbTJ = new C49117uiW();
    public static final SharePlatform djBIcL = SharePlatform.WECHAT_MOMENTS;
    public static java.lang.String gEmmrt = "com.tencent.mm";
    public static java.util.List<java.lang.String> copydefault = C56402yEa.EZpvd("com.tencent.mm.ui.tools.ShareToTimeLineUI");
    ...
    public java.lang.CharSequence OLrzqt(@NotNull android.content.Context context) {
        ...
        return context.getResources().getString(C48931uew.Activity.copydefault);
    }

    @Override // o.InterfaceC49121uia
    public android.graphics.drawable.Drawable AEQbTJ(@NotNull android.content.Context context) {
        Intrinsics.checkNotNullParameter(context, "");
        return ContextCompat.getDrawable(context, C48894ueL.ActionBar.fARcdN);
    }
