...
import com.okinc.market.search.features.navigation.selection.ui.viewmodel.SelectionNavFuturesGroupViewModel;
...
public final class qQB extends AbstractC40298qQr {
    ...
    public qQB() {
        ...
        final InterfaceC56387yDm interfaceC56387yDmEZpvd = C56392yDr.EZpvd(LazyThreadSafetyMode.NONE, new Function0<ViewModelStoreOwner>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchFuturesGroupFragment$special$$inlined$parentViewModels$2
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        this.isConnected = FragmentViewModelLazyKt.createViewModelLazy(this, C56524yIo.AEQbTJ(SelectionNavFuturesGroupViewModel.class), new Function0<ViewModelStore>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchFuturesGroupFragment$special$$inlined$parentViewModels$3
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchFuturesGroupFragment$special$$inlined$parentViewModels$4
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchFuturesGroupFragment$special$$inlined$parentViewModels$5
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
    ...
    public NavSearchFuturesGroupViewModel AhwBna() {
        return (NavSearchFuturesGroupViewModel) this.isConnected.getValue();
    }
    ...
    public NavSearchFuturesPageVo OLrzqt(@NotNull CategoryGroupVo categoryGroupVo) {
        ...
        return new NavSearchFuturesPageVo(categoryGroupVo, new Function0() { // from class: o.qQD
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function0
            public final java.lang.Object invoke() {
                return qQB.isConnected();
            }
        });
    }

    public static final androidx.fragment.app.Fragment isConnected() {
        return new SelectionSearchFuturesListFragment();
    }
