...
public abstract class AbstractActivityC37613oxD<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37613oxD() {
        valueOf();
    }

    private void valueOf() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.oxD.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37613oxD.this.AYXKKw();
            }
        });
    }
    ...
    public void AYXKKw() {
        ...
        this.EZpvd = true;
        ((InterfaceC37631oxV) aA_()).copydefault((ActivityC37628oxS) C58163ywB.EZpvd(this));
    }
