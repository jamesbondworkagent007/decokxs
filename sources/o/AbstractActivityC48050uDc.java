...
public abstract class AbstractActivityC48050uDc extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC48050uDc() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.uDc.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC48050uDc.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.KWHzl = true;
        ((uDH) aA_()).AEQbTJ((ActivityC48073uDz) C58163ywB.EZpvd(this));
    }
