...
public final class pGP implements InterfaceC37953pGv {
    ...
    public kotlin.Pair<AbstractC36262oVg, java.lang.Boolean> AEQbTJ(@NotNull KlineIndicatorBean klineIndicatorBean) {
        ...
        oVO ovo = new oVO("VOLUME", indicatorBean.getMain());
        ovo.AkhnZx();
        ovo.fetchVPNInfo();
        com.okinc.kline.ui.view.model.Params params = indicatorBean.getParams();
        if (params != null && (out = params.getOut()) != null) {
            java.lang.String color = out.getColor();
            if (color != null && (parameterCopydefault = ovo.copydefault(0)) != null) {
                java.lang.String lowerCase = color.toLowerCase(java.util.Locale.ROOT);
                Intrinsics.checkNotNullExpressionValue(lowerCase, "");
                parameterCopydefault.setColorTemp(lowerCase);
            }
            java.lang.Double transparency = out.getTransparency();
            if (transparency != null) {
                double dDoubleValue = transparency.doubleValue();
                SPUtils.put(KWHzl("key_vol_transparency", indicatorBean.getMain()), java.lang.Integer.valueOf(C33129mqd.AhwBna(C33129mqd.mulS$default(java.lang.Double.valueOf(dDoubleValue), 255, null, null, null, 14, null))));
                if (indicatorBean.getMain()) {
                    C36246oUr.copydefault().values(C33129mqd.AhwBna(C33129mqd.mulS$default(java.lang.Double.valueOf(dDoubleValue), 255, null, null, null, 14, null)));
                } else {
                    C36246oUr.copydefault().AkhnZx(C33129mqd.AhwBna(C33129mqd.mulS$default(java.lang.Double.valueOf(dDoubleValue), 255, null, null, null, 14, null)));
                }
            }
        }
        ...
        if (params2 != null && (ma1 = params2.getMa1()) != null) {
            ...
            if (value != null) {
                ...
                Expression.Parameter parameterEZpvd = ovo.EZpvd(0);
                if (parameterEZpvd != null) {
                    parameterEZpvd.setTempValue(dDoubleValue2);
                }
            }
            Expression.Parameter parameterCopydefault2 = ovo.copydefault(1);
        ...
        if (params3 != null && (ma2 = params3.getMa2()) != null) {
            ...
            if (value2 != null) {
                ...
                Expression.Parameter parameterEZpvd2 = ovo.EZpvd(1);
                if (parameterEZpvd2 != null) {
                    parameterEZpvd2.setTempValue(dDoubleValue3);
                }
            }
            Expression.Parameter parameterCopydefault3 = ovo.copydefault(2);
        ...
        ovo.EZpvd();
        ovo.fJNWhG();
        java.lang.String strEjfBZ = ovo.ejfBZ();
        Intrinsics.checkNotNullExpressionValue(strEjfBZ, "");
        C36278oVw.KWHzl("ds0", KWHzl(strEjfBZ, indicatorBean.getMain()), ovo.AuCTel());
        ovo.copydefault();
        java.lang.String strEjfBZ2 = ovo.ejfBZ();
        Intrinsics.checkNotNullExpressionValue(strEjfBZ2, "");
        C36278oVw.copydefault("ds0", KWHzl(strEjfBZ2, indicatorBean.getMain()), new Gson().toJson(ovo.isConnected()));
        return new kotlin.Pair<>(ovo, java.lang.Boolean.valueOf(indicatorBean.getMain()));
    }
    ...
    public java.lang.String OLrzqt(@NotNull AbstractC36262oVg abstractC36262oVg, @NotNull IndicatorBean indicatorBean, boolean z) {
        ...
        if (params == null) {
            ...
            params.setMa1(EZpvd(java.lang.Double.valueOf(abstractC36262oVg.EZpvd(0).getValue()), abstractC36262oVg.copydefault(1)));
            params.setMa2(EZpvd(java.lang.Double.valueOf(abstractC36262oVg.EZpvd(1).getValue()), abstractC36262oVg.copydefault(2)));
        }
