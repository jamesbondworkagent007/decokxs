...
public abstract class AbstractActivityC30928lkR extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC30928lkR() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.lkR.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC30928lkR.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.EZpvd = true;
        ((InterfaceC31004llo) aA_()).OLrzqt((ActivityC31001lll) C58163ywB.EZpvd(this));
    }
