...
public final class C37985pI implements BH<C34947nm> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C34947nm c34947nm, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.textract.serde.CreateAdapterOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C37958pH.AEQbTJ(dt, c34947nm)));
