...
public final class C32569mg {
    public static final C12073cg EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        C12073cg.Application application = new C12073cg.Application();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                application.KWHzl(C20341gf.KWHzl(interfaceC5095En));
            } else {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    ...
                    while (actionBarKWHzl.EZpvd()) {
                        if (!actionBarKWHzl.copydefault()) {
                            ...
                            arrayList.add(AbstractC6211aL.EZpvd.KWHzl(actionBarKWHzl.fetchVPNInfo()));
                        }
                    }
