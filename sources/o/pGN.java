...
public final class pGN implements InterfaceC37953pGv {
    public final java.lang.String AEQbTJ = "TRIXIndicatorJsonManage";
    ...
    public kotlin.Pair<AbstractC36262oVg, java.lang.Boolean> AEQbTJ(@NotNull KlineIndicatorBean klineIndicatorBean) {
        ...
        if (params != null && (length = params.getLength()) != null && (value2 = length.getValue()) != null) {
            ...
            Expression.Parameter parameterEZpvd = ovn.EZpvd(0);
        ...
        if (params2 != null && (ma12 = params2.getMa1()) != null && (value = ma12.getValue()) != null) {
            ...
            Expression.Parameter parameterEZpvd2 = ovn.EZpvd(1);
        ...
        if (params3 != null && (out = params3.getOut()) != null && (parameterCopydefault2 = ovn.copydefault(0)) != null) {
            KWHzl(out, parameterCopydefault2);
        }
        com.okinc.kline.ui.view.model.Params params4 = indicatorBean.getParams();
        if (params4 != null && (ma1 = params4.getMa1()) != null && (parameterCopydefault = ovn.copydefault(1)) != null) {
            KWHzl(ma1, parameterCopydefault);
        }
        ovn.EZpvd();
        ovn.fJNWhG();
        java.lang.String strEjfBZ = ovn.ejfBZ();
        Intrinsics.checkNotNullExpressionValue(strEjfBZ, "");
        C36278oVw.KWHzl("ds0", KWHzl(strEjfBZ, indicatorBean.getMain()), ovn.AuCTel());
        ovn.copydefault();
        java.lang.String strEjfBZ2 = ovn.ejfBZ();
        Intrinsics.checkNotNullExpressionValue(strEjfBZ2, "");
        C36278oVw.copydefault("ds0", KWHzl(strEjfBZ2, indicatorBean.getMain()), new Gson().toJson(ovn.isConnected()));
        return new kotlin.Pair<>(ovn, java.lang.Boolean.valueOf(indicatorBean.getMain()));
    }
    ...
    public java.lang.String OLrzqt(@NotNull AbstractC36262oVg abstractC36262oVg, @NotNull IndicatorBean indicatorBean, boolean z) {
        ...
        if (params == null) {
            ...
            try {
                ...
                params.setMa1(AEQbTJ(java.lang.Double.valueOf(abstractC36262oVg.EZpvd(1).getValue()), abstractC36262oVg.copydefault(1)));
