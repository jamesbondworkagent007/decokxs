...
/* JADX INFO: renamed from: o.evY, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes5.dex */
public class C17053evY extends AbstractC17054evZ {
    ...
    static {
        ...
        sparseIntArray.put(C13754dXa.ActionBar.OeZisf, 1);
        sparseIntArray.put(C13754dXa.ActionBar.notifyNotificationWithChannel, 2);
        sparseIntArray.put(C13754dXa.ActionBar.aRClCA, 3);
    }

    public C17053evY(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, KWHzl, OLrzqt));
    }

    public C17053evY(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
