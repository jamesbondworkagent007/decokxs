...
public final class BurstHolder {
    public static final MediaRouteActionProvider KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        MediaRouteActionProvider.Application application = new MediaRouteActionProvider.Application();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                application.EZpvd(PublicKey.KWHzl(interfaceC5095En));
            } else {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    ...
                    if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault3) {
                        application.copydefault(PublicKey.KWHzl(interfaceC5095En));
                    } else {
                        int iCopydefault4 = c5101Et4.copydefault();
                        if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault4) {
                            application.OLrzqt(PublicKey.KWHzl(interfaceC5095En));
                        } else {
