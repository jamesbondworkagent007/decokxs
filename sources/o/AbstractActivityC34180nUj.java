...
/* JADX INFO: renamed from: o.nUj, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public abstract class AbstractActivityC34180nUj<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC34180nUj() {
        AhwBna();
    }

    private void AhwBna() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.nUj.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC34180nUj.this.valueOf();
            }
        });
    }
    ...
    public void valueOf() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC34192nUw) aA_()).OLrzqt((ActivityC34183nUn) C58163ywB.EZpvd(this));
    }
