...
public final class mRB {
    ...
    static {
        Gson gsonCreate = new GsonBuilder().registerTypeAdapter(JsonElement.class, new JsonDeserializer<JsonElement>() { // from class: com.okinc.dexkline.dexlogic.utils.JsonUtils$gson$1
        ...
        }).registerTypeAdapter(JsonElement.class, new JsonSerializer<JsonElement>() { // from class: com.okinc.dexkline.dexlogic.utils.JsonUtils$gson$2
