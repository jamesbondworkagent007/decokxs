...
/* JADX INFO: renamed from: o.iax, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public final class C24288iax extends android.widget.FrameLayout {
    ...
    public C24288iax(@NotNull android.content.Context context) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public C24288iax(@NotNull android.content.Context context, android.util.AttributeSet attributeSet) {
 ...
 A[MD:(android.content.Context, android.util.AttributeSet, int):void (m)] (LINE:41) call: o.iax.<init>(android.content.Context, android.util.AttributeSet, int):void type: THIS */
    public /* synthetic */ C24288iax(android.content.Context context, android.util.AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i2 & 2) != 0 ? null : attributeSet, (i2 & 4) != 0 ? 0 : i);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C24288iax(@NotNull android.content.Context context, android.util.AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        Intrinsics.checkNotNullParameter(context, "");
        int[] iArr = C23274hvD.LoaderManager.QfsBiF;
        ...
        this.OLrzqt = typedArrayObtainStyledAttributes.getBoolean(C23274hvD.LoaderManager.QbewEr, false);
        typedArrayObtainStyledAttributes.recycle();
        KWHzl();
    }

    public final void KWHzl(OrderDetailBean orderDetailBean) {
        java.util.ArrayList<hUT> arrayList = new java.util.ArrayList<>();
        if (orderDetailBean != null) {
            if (this.OLrzqt) {
                EZpvd(arrayList, orderDetailBean);
            } else {
                copydefault(arrayList, orderDetailBean);
            }
        }
    ...
    public final void EZpvd(java.util.ArrayList<hUT> arrayList, OrderDetailBean orderDetailBean) {
    ...
    public final void copydefault(java.util.ArrayList<hUT> arrayList, OrderDetailBean orderDetailBean) {
        java.lang.String name;
        hWF hwf = this.KWHzl;
        if (hwf != null) {
            hwf.setAddressValue(orderDetailBean.getFrom(), orderDetailBean.getFromChainId());
        }
        arrayList.add(new hUY(orderDetailBean, ItemType.ITEM_TYPE_CREATE_TIME.getValue()));
        ...
        arrayList.add(new hUY(orderDetailBean, ItemType.ITEM_TYPE_SWAP_TIME.getValue()));
        OrderDetailDefiPlatformInfo defiPlatformInfo = orderDetailBean.getDefiPlatformInfo();
        if (defiPlatformInfo != null && (name = defiPlatformInfo.getName()) != null && C33129mqd.OLrzqt((java.lang.CharSequence) name)) {
            arrayList.add(new hUY(orderDetailBean, ItemType.ITEM_TYPE_SWAP_DE_FI_PLATFORM.getValue()));
        }
        if (C33129mqd.OLrzqt((java.lang.CharSequence) orderDetailBean.getMevInfo())) {
            arrayList.add(new C22026hVd(orderDetailBean, ItemType.ITEM_TYPE_SWAP_MEV.getValue()));
    ...
    public final void KWHzl() {
        ...
        this.KWHzl = hwf;
        if (hwf != null) {
            hwf.setVisibility(true ^ this.OLrzqt ? 0 : 8);
        }
        ...
        if (recyclerView2 != null) {
            ...
            recyclerView2.addItemDecoration(new C24290iaz(C55298xhM.OLrzqt(24, context), this.OLrzqt));
        }
