...
import aws.sdk.kotlin.services.rekognition.serde.ListUsersOperationDeserializer$deserialize$1;
...
public final class C23833iL implements BB<Q> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super Q> continuation) throws java.lang.Throwable {
        ...
        if (i2 != 0) {
            ...
            actionBar = (Q.ActionBar) listUsersOperationDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(objCopydefault);
            bArr = (byte[]) objCopydefault;
            if (bArr != null) {
                C23806iK.AEQbTJ(actionBar, bArr);
            }
            actionBar.OLrzqt();
        ...
        if (!zT.copydefault(interfaceC5039CjAEQbTJ.OLrzqt())) {
            ...
            if (C23806iK.OLrzqt(dt, c58859zS, listUsersOperationDeserializer$deserialize$1) == objCopydefault2) {
                return objCopydefault2;
            }
            throw new KotlinNothingValueException();
        }
        actionBar = new Q.ActionBar();
        zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
        listUsersOperationDeserializer$deserialize$1.L$0 = actionBar;
