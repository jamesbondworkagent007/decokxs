...
import aws.sdk.kotlin.services.rekognition.model.ProvisionedThroughputExceededException;
import aws.sdk.kotlin.services.rekognition.serde.ProvisionedThroughputExceededExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.jx, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C27537jx implements BB<ProvisionedThroughputExceededException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super ProvisionedThroughputExceededException> continuation) throws java.lang.Throwable {
        ...
        ProvisionedThroughputExceededException.Activity activity;
        ...
        if (i2 == 0) {
            ...
            ProvisionedThroughputExceededException.Activity activity2 = new ProvisionedThroughputExceededException.Activity();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            provisionedThroughputExceededExceptionDeserializer$deserialize$1.L$0 = activity2;
            ...
            activity = (ProvisionedThroughputExceededException.Activity) provisionedThroughputExceededExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C27590jy.EZpvd(activity, bArr);
        }
        activity.KWHzl();
