...
public abstract class wGN<Binding extends ViewDataBinding, Presenter extends AbsPresenter> extends AbstractC54505xKx<Binding, Presenter> implements InterfaceC58208ywu {
    ...
    public void AYXKKw() {
        ...
        this.OLrzqt = true;
        ((InterfaceC52320wHa) aA_()).AEQbTJ((wGX) C58163ywB.EZpvd(this));
    }
