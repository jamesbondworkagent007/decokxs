...
import aws.sdk.kotlin.services.comprehend.serde.ListTagsForResourceOperationDeserializer$deserialize$1;
...
public final class ExceptionUtils implements BB<SystemHealthManager> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super SystemHealthManager> continuation) throws java.lang.Throwable {
        ListTagsForResourceOperationDeserializer$deserialize$1 listTagsForResourceOperationDeserializer$deserialize$1;
        SystemHealthManager.ActionBar actionBar;
        byte[] bArr;
        ...
        if (i2 != 0) {
            ...
            actionBar = (SystemHealthManager.ActionBar) listTagsForResourceOperationDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(objCopydefault);
            bArr = (byte[]) objCopydefault;
            if (bArr != null) {
                EventLog.KWHzl(actionBar, bArr);
            }
        ...
        if (!zT.copydefault(interfaceC5039CjAEQbTJ.OLrzqt())) {
            ...
            if (EventLog.AEQbTJ(dt, c58859zS, listTagsForResourceOperationDeserializer$deserialize$1) == objCopydefault2) {
                return objCopydefault2;
            }
            throw new KotlinNothingValueException();
        }
        actionBar = new SystemHealthManager.ActionBar();
