...
/* JADX INFO: renamed from: o.bki, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes18.dex */
public class C10240bki extends AbstractC10170bjR {
    ...
    public C10240bki(@NotNull android.content.Context context, @NotNull TxIdOrHashHistoryDetail txIdOrHashHistoryDetail) {
    ...
    private final AbstractC10168bjP OLrzqt(TxAssetChangeBean txAssetChangeBean) {
        ...
        if (C33129mqd.OLrzqt((java.lang.CharSequence) txAssetChangeBean.getNftId())) {
            ...
            return new AbstractC10168bjP.Activity(str2, str3, str4, " ", name == null ? "" : name, iCopydefault, fJNWhG().getCoinId(), null, false, MLKEMEngine.KyberPolyBytes, null);
        }
        ...
        java.lang.String str8 = protocolName == null ? "" : protocolName;
        java.lang.Long coinId = txAssetChangeBean.getCoinId();
        return new AbstractC10168bjP.TaskDescription(str5, str6, " ", str7, iCopydefault, false, false, 0, zUzCIH, false, str8, 0, coinId != null ? coinId.longValue() : -1L, OLrzqt(txAssetChangeBean.getCoinId()) && (hideTxType = fJNWhG().getHideTxType()) != null && hideTxType.intValue() == 0, 2784, null);
    }
}
