...
public final class C51334vl implements BH<C47647tu> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C47647tu c47647tu, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.ListLanguagesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C51440vn.copydefault(dt, c47647tu)));
