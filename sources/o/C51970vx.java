...
public final class C51970vx implements BH<C47859ty> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C47859ty c47859ty, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.ListTerminologiesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C50076vB.copydefault(dt, c47859ty)));
