...
public class C7273agi extends AbstractC7210afY {
    public static UnicodeSet AEQbTJ;
    ...
    static {
        OLrzqt.OLrzqt("[[:Khmer:]&[:LineBreak=SA:]]");
        OLrzqt.KWHzl();
        copydefault.OLrzqt("[[:Khmer:]&[:LineBreak=SA:]&[:M:]]");
        copydefault.KWHzl(32);
        AEQbTJ = new UnicodeSet(OLrzqt);
        KWHzl.EZpvd(6016, 6067);
        AEQbTJ.fetchVPNInfo(6098);
        copydefault.KWHzl();
        AEQbTJ.KWHzl();
        KWHzl.KWHzl();
        OLrzqt.AYXKKw();
    ...
    public C7273agi() throws java.io.IOException {
        AEQbTJ(OLrzqt);
        this.EZpvd = C7209afX.EZpvd("Khmr");
    }

    public boolean equals(java.lang.Object obj) {
        return obj instanceof C7273agi;
    }
    ...
    public boolean AEQbTJ(int i) {
        return C7223afl.copydefault(i, 4106) == 23;
    }
    ...
    */
    public int EZpvd(CharacterIterator characterIterator, int i, int i2, AbstractC7210afY.Activity activity) {
        ...
        while (true) {
            ...
            int i6 = i5 % 3;
            int iOLrzqt = applicationArr[i6].OLrzqt(characterIterator, this.EZpvd, i2);
            if (iOLrzqt == 1) {
                ...
                if (characterIterator.getIndex() < i2) {
                    ...
                    do {
                        int i7 = (i5 + 1) % 3;
                        if (applicationArr[i7].OLrzqt(characterIterator, this.EZpvd, i2) > 0) {
                            applicationArr[i6].KWHzl();
                            if (characterIterator.getIndex() >= i2) {
                                break;
                            }
                            while (true) {
                                if (applicationArr[(i5 + 2) % 3].OLrzqt(characterIterator, this.EZpvd, i2) > 0) {
                                    applicationArr[i6].KWHzl();
                                    z = true;
                                    break;
                                }
                        ...
                        if (characterIterator.getIndex() < i2 && iEZpvd < 3) {
                            i3 = i5 % 3;
                            if (applicationArr[i3].OLrzqt(characterIterator, this.EZpvd, i2) > 0 && (iEZpvd == 0 || applicationArr[i3].OLrzqt() < 3)) {
                                ...
                                while (true) {
                                    ...
                                    if (AEQbTJ.AEQbTJ(cCurrent) && KWHzl.AEQbTJ(cCurrent2)) {
                                        int iOLrzqt2 = applicationArr[(i5 + 1) % 3].OLrzqt(characterIterator, this.EZpvd, i2);
                        ...
                        while (true) {
                            ...
                            if (index < i2 || !copydefault.AEQbTJ(characterIterator.current())) {
                                break;
                            }
                            characterIterator.next();
                ...
                if (characterIterator.getIndex() < i2) {
                    i3 = i5 % 3;
                    if (applicationArr[i3].OLrzqt(characterIterator, this.EZpvd, i2) > 0) {
                        characterIterator.setIndex(index2 + iEZpvd);
                    }
                }
                while (true) {
