...
public final class UserInfo {
    public static final byte[] AEQbTJ(DT dt, IntegerRes integerRes) {
        EW ew = new EW();
        ...
        java.lang.String strCopydefault = integerRes.copydefault();
        if (strCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et, strCopydefault);
        }
        java.lang.String strOLrzqt = integerRes.OLrzqt();
        if (strOLrzqt != null) {
