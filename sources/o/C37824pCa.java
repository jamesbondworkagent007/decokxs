...
/* JADX INFO: renamed from: o.pCa, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes9.dex */
public final class C37824pCa extends ConstraintLayout {
    public int AEQbTJ;
    public float EZpvd;
    public float KWHzl;
    ...
    public C37824pCa(@NotNull android.content.Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "");
        this.OLrzqt = "PriceRecycleView";
        this.AEQbTJ = 1;
        EZpvd();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C37824pCa(@NotNull android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final android.graphics.drawable.Drawable copydefault() {
        ...
        float fEZpvd = C33052mpF.EZpvd(8, context);
