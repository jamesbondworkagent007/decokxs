...
public final class PendingHostUpdate implements BH<SecretKey> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull SecretKey secretKey, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.serde.AdminGetUserOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(BluetoothA2dp.AEQbTJ(dt, secretKey)));
