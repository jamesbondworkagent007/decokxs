...
public final class C24768ik implements BH<J> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull J j, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.ListDatasetLabelsOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C25138ir.AEQbTJ(dt, j)));
