...
import aws.sdk.kotlin.services.rekognition.model.AccessDeniedException;
import aws.sdk.kotlin.services.rekognition.serde.AccessDeniedExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.cJ, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C11297cJ implements BB<AccessDeniedException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super AccessDeniedException> continuation) throws java.lang.Throwable {
        ...
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C11216cG.KWHzl(stateListAnimator, bArr);
        }
