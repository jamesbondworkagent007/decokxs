...
public abstract class iVV extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.iVV.5
    ...
    public void OLrzqt() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC24132iWb) aA_()).copydefault((iVU) C58163ywB.EZpvd(this));
    }
