...
public final class C33061mpO {

    /* JADX INFO: renamed from: o.mpO$StateListAnimator */
    ...
    public static final java.lang.CharSequence OLrzqt(@NotNull java.lang.CharSequence charSequence, @NotNull java.lang.String[] strArr, int i, @NotNull MatchPattern matchPattern, boolean z, @NotNull Function1<? super java.util.List<java.lang.Object>, Unit> function1) {
        ...
        if (!(strArr.length == 0)) {
            for (java.lang.String str : strArr) {
                int i2 = StateListAnimator.copydefault[matchPattern.ordinal()];
                if (i2 == 1) {
    ...
    public static final java.lang.CharSequence KWHzl(@NotNull java.lang.CharSequence charSequence, @NotNull java.lang.String str, @NotNull Function1<? super java.util.List<java.lang.Object>, Unit> function1) {
        Intrinsics.checkNotNullParameter(charSequence, "");
        ...
        int iOLrzqt = StringsKt__StringsKt.OLrzqt(charSequence, str, 0, true);
        while (iOLrzqt >= 0 && iOLrzqt < charSequence.length()) {
            int length = str.length() + iOLrzqt;
            java.util.ArrayList arrayList = new java.util.ArrayList();
            function1.invoke(arrayList);
            java.util.Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                spannableString.setSpan(it.next(), iOLrzqt, length, 33);
            }
            iOLrzqt = StringsKt__StringsKt.OLrzqt(charSequence, str, length, true);
        }
        return spannableString;
    }
}
