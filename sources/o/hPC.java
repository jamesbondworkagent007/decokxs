...
public abstract class hPC<VB extends ViewBinding> extends AbstractC21846hOm<VB> implements InterfaceC58208ywu {
    ...
    public void AhwBna() {
        ...
        this.gEmmrt = true;
        ((hQJ) aA_()).KWHzl((MarketDetailFragment) C58163ywB.EZpvd(this));
    }
