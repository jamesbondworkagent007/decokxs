...
public class C32046mNm extends AbstractC32043mNj {
    ...
    static {
        ...
        sparseIntArray.put(C31976mKx.Activity.fARcdN, 2);
    }

    public C32046mNm(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, EZpvd, AEQbTJ));
    }

    public C32046mNm(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
