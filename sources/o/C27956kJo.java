...
public final class C27956kJo extends AbstractC59533zio<C27622jyf, Activity> {
    ...
    public C27956kJo(@NotNull Function1<? super android.view.View, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "");
        this.AEQbTJ = function1;
    }

    /* JADX INFO: renamed from: o.kJo$Activity */
    ...
    public Activity onCreateViewHolder(@NotNull android.view.LayoutInflater layoutInflater, @NotNull android.view.ViewGroup viewGroup) {
        ...
        android.view.View viewInflate = layoutInflater.inflate(qZH.ActionBar.invokespecialRtjmuc, viewGroup, false);
    ...
    public void onBindViewHolder(@NotNull Activity activity, @NotNull C27622jyf c27622jyf) {
        ...
        Intrinsics.checkNotNullParameter(c27622jyf, "");
        activity.itemView.setOnClickListener(new View.OnClickListener() { // from class: o.kJk
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // android.view.View.OnClickListener
            public final void onClick(android.view.View view) {
                C27956kJo.AEQbTJ(this.KWHzl, view);
            }
        });
    }

    public static final void AEQbTJ(C27956kJo c27956kJo, android.view.View view) {
        Function1<android.view.View, Unit> function1 = c27956kJo.AEQbTJ;
