...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.InternalErrorExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes2.dex */
public final class SQLiteTableLockedException implements BB<InternalErrorException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InternalErrorException> continuation) throws java.lang.Throwable {
        ...
        InternalErrorException.ActionBar actionBar;
        ...
        if (i2 == 0) {
            ...
            InternalErrorException.ActionBar actionBar2 = new InternalErrorException.ActionBar();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            internalErrorExceptionDeserializer$deserialize$1.L$0 = actionBar2;
            ...
            actionBar = (InternalErrorException.ActionBar) internalErrorExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            SqliteWrapper.KWHzl(actionBar, bArr);
        }
        actionBar.OLrzqt();
