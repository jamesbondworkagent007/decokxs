...
public class C50967veD<T> implements KSerializer<T> {
    ...
    public C50967veD(@NotNull KSerializer<T> kSerializer, Function0<? extends T> function0) {
    ...
    public T deserialize(@NotNull Decoder decoder) {
        ...
        try {
            ...
            Function0<T> function0 = this.AEQbTJ;
            if (function0 != null) {
