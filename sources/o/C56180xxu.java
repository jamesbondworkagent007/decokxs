...
public final class C56180xxu extends xKE<java.util.List<? extends StrategyResponse>> {
    public EditContractDcaReq OLrzqt;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final C56180xxu AEQbTJ(@NotNull EditContractDcaReq editContractDcaReq) {
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends StrategyResponse>>> EZpvd() {
        ...
        return bizApiService.cancelContractDcaManualOrder(editContractDcaReq);
    }
}
