...
public final class C49120uiZ extends AbstractC49096uiB {
    public static final C49120uiZ copydefault = new C49120uiZ();
    public static final SharePlatform gEmmrt = SharePlatform.VK;
    public static java.lang.String djBIcL = "com.vkontakte.android";
    public static java.util.List<java.lang.String> AEQbTJ = C56402yEa.EZpvd("com.vkontakte.android.sharing.SharingExternalActivity");
    ...
    public java.lang.CharSequence OLrzqt(@NotNull android.content.Context context) {
        ...
        return context.getResources().getString(C48931uew.Activity.zuBGHE);
    }

    @Override // o.InterfaceC49121uia
    public android.graphics.drawable.Drawable AEQbTJ(@NotNull android.content.Context context) {
        Intrinsics.checkNotNullParameter(context, "");
        return ContextCompat.getDrawable(context, C48894ueL.ActionBar.AuCTel);
    }
