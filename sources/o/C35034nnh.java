...
import com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$setListener$2;
import com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$startRefresh$1;
...
public final class C35034nnh extends AbstractC35036nnj implements InterfaceC49363unD, InterfaceC27808kEb, mAS {
    public Job AubY;
    ...
    public C35034nnh() {
        final Function0<androidx.fragment.app.Fragment> function0 = new Function0<androidx.fragment.app.Fragment>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$special$$inlined$viewModels$default$1
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        final InterfaceC56387yDm interfaceC56387yDmEZpvd = C56392yDr.EZpvd(LazyThreadSafetyMode.NONE, new Function0<ViewModelStoreOwner>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$special$$inlined$viewModels$default$2
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        this.zsXlph = FragmentViewModelLazyKt.createViewModelLazy(this, C56524yIo.AEQbTJ(MarketHomeFuturesRankingViewModel.class), new Function0<ViewModelStore>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$special$$inlined$viewModels$default$3
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$special$$inlined$viewModels$default$4
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$special$$inlined$viewModels$default$5
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
        ...
        this.getNewProxyInstance = C56392yDr.copydefault(new Function0() { // from class: o.nnn
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function0
            public final java.lang.Object invoke() {
                return C35034nnh.KWHzl(this.AEQbTJ);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final MarketHomeFuturesRankingViewModel AxsJAY() {
        return (MarketHomeFuturesRankingViewModel) this.zsXlph.getValue();
    }
    ...
    public static final C59534zip KWHzl(C35034nnh c35034nnh) {
        C59534zip c59534zip = new C59534zip();
        c59534zip.register(RankingHotCryptoVo.class, new C34980nmg());
        c59534zip.register(AbstractC55524xla.StateListAnimator.class, new C34986nmm(c35034nnh, qZH.ActionBar.invokespecialRtjmuc));
        return c59534zip;
    }
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        C46688tbr.registerTradeFragmentTrack$default(C46688tbr.KWHzl, this, "MarketHomeHotRankingFuturesFragment", new kotlin.Pair[0], null, 4, null);
    }
    ...
    public void onVisible() {
        ...
        if (view != null && view.isShown() && view.isAttachedToWindow()) {
            if (view.getGlobalVisibleRect(new android.graphics.Rect()) && view.getHeight() > 0 && C33129mqd.copydefault(java.lang.Float.valueOf(r1.height() / view.getHeight()), java.lang.Float.valueOf(0.5f)) && (interfaceC27808kEbEZpvd = C27807kEa.EZpvd(this)) != null) {
                interfaceC27808kEbEZpvd.copydefault("hot", "futures");
            }
        }
        ...
        childFragmentManager.setFragmentResultListener("REQUEST_CLICK_ARROW", this, new FragmentResultListener() { // from class: o.nnm
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // androidx.fragment.app.FragmentResultListener
            public final void onFragmentResult(java.lang.String str, android.os.Bundle bundle) {
                C35034nnh.copydefault(this.EZpvd, str, bundle);
            }
        });
    }

    public static final void copydefault(C35034nnh c35034nnh, java.lang.String str, android.os.Bundle bundle) {
        Intrinsics.checkNotNullParameter(str, "");
    ...
    public void initView(@NotNull android.view.View view, android.os.Bundle bundle) {
        ...
        qzyKWHzl.EZpvd.setAdapter(AuCTelauCTel());
        this.zLjUOn = qzyKWHzl;
        if (this.wlaJM) {
            return;
        }
        this.wlaJM = true;
    ...
    public void setListener() {
        collectLatestOnLifecycle(AxsJAY(), new MutablePropertyReference1Impl() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$setListener$1
        ...
        }, Lifecycle.State.CREATED, new MarketHomeHotRankingFuturesFragment$setListener$2(this, null));
        final java.lang.String[] strArr = {"event_home_page_refresh"};
        getLifecycle().addObserver(new DefaultLifecycleObserver() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$setListener$$inlined$repeatListenRxEventOnResume$1
            ...
            public void onResume(LifecycleOwner lifecycleOwner) {
                ...
                final C35034nnh c35034nnh = this;
                this.copydefault = abstractC58185ywXAEQbTJ.AEQbTJ(new InterfaceC58227yxM(new Function1<String, Unit>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$setListener$$inlined$repeatListenRxEventOnResume$1.2
                ...
                }) { // from class: o.jSA.TaskDescription
                ...
                }, new InterfaceC58227yxM(new Function1<Throwable, Unit>() { // from class: com.okinc.find_ui.ranking.hot.sub.MarketHomeHotRankingFuturesFragment$setListener$$inlined$repeatListenRxEventOnResume$1.1
    ...
    public boolean iwGUEr() {
        return AuCTelauCTel().getItems().isEmpty();
    }
    ...
    public final void zLjUOn() {
        ...
        this.AubY = BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner), null, null, new MarketHomeHotRankingFuturesFragment$startRefresh$1(this, null), 3, null);
    }
    ...
    public void copydefault(int i) {
        ...
        if (interfaceC27808kEbEZpvd != null) {
            interfaceC27808kEbEZpvd.OLrzqt("hot", "SWAP");
        }
        AEQbTJ(i);
    }
