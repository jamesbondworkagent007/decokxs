...
import aws.sdk.kotlin.runtime.auth.credentials.internal.sso.serde.ResourceNotFoundExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes.dex */
public final class InputEvent implements BB<ResourceNotFoundException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super ResourceNotFoundException> continuation) throws java.lang.Throwable {
        ...
        ResourceNotFoundException.StateListAnimator stateListAnimator;
        ...
        if (i2 == 0) {
            ...
            ResourceNotFoundException.StateListAnimator stateListAnimator2 = new ResourceNotFoundException.StateListAnimator();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            resourceNotFoundExceptionDeserializer$deserialize$1.L$0 = stateListAnimator2;
            ...
            stateListAnimator = (ResourceNotFoundException.StateListAnimator) resourceNotFoundExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            Gravity.KWHzl(stateListAnimator, bArr);
        }
