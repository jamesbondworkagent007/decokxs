...
public abstract class AbstractActivityC37125ont extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37125ont() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ont.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37125ont.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC37081onB) aA_()).KWHzl((OKIMAudioCallViewActivity) C58163ywB.EZpvd(this));
    }
