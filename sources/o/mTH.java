...
public final class mTH implements InterfaceC39509ptg {
    public static final mTH copydefault = new mTH();
    public static java.lang.String OLrzqt = "cedefi.MARKET_ChartTimeInterval";
    public static java.util.ArrayList<TimeIntervalItem> AEQbTJ = new java.util.ArrayList<>();
    public static java.lang.String KWHzl = "key_kline_cedefi_market_time_interval_list";
            ...
            try {
                ...
                if (arrayList.size() > 4) {
                    ...
                    for (java.lang.Object obj : arrayList) {
                        ...
                        if (i < 2) {
                            copydefault.KWHzl().add(timeIntervalItem);
                        }
                        i++;
                    }
                } else {
    ...
    public java.util.ArrayList<TimeIntervalItem> EZpvd() {
        return yDY.copydefault(new TimeIntervalItem(1, "index-candle1m", "candle1m", "mark-price-candle1m", "1min"), new TimeIntervalItem(15, "index-candle15m", "candle15m", "mark-price-candle15m", "15min"), new TimeIntervalItem(60, "index-candle1H", "candle1H", "mark-price-candle1H", "1hour"), new TimeIntervalItem(PsExtractor.VIDEO_STREAM_MASK, "index-candle4H", "candle4H", "mark-price-candle4H", "4hour"));
    }
