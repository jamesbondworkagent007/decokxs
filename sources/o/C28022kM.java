...
public final class C28022kM implements BH<C10099bi> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C10099bi c10099bi, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.StartFaceSearchOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C28049kN.OLrzqt(dt, c10099bi)));
