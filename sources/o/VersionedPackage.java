...
public final class VersionedPackage {
    public static final byte[] KWHzl(DT dt, InterpolatorRes interpolatorRes) {
        EW ew = new EW();
        ...
        java.lang.String strCopydefault = interpolatorRes.copydefault();
        if (strCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et, strCopydefault);
        }
        java.lang.String strOLrzqt = interpolatorRes.OLrzqt();
        if (strOLrzqt != null) {
