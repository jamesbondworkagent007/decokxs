...
public final class SQLiteCursorDriver {
    public static final byte[] OLrzqt(DT dt, AliasActivity aliasActivity) {
        EW ew = new EW();
        ...
        java.lang.String strAEQbTJ = aliasActivity.AEQbTJ();
        if (strAEQbTJ != null) {
            ebEZpvd.AEQbTJ(c5101Et, strAEQbTJ);
        }
        java.lang.String strEZpvd = aliasActivity.EZpvd();
        if (strEZpvd != null) {
