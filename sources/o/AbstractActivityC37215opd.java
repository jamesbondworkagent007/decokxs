...
public abstract class AbstractActivityC37215opd<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37215opd() {
        djBIcL();
    }

    private void djBIcL() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.opd.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37215opd.this.AhwBna();
            }
        });
    }
    ...
    public void AhwBna() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC37227opp) aA_()).EZpvd((ActivityC37218opg) C58163ywB.EZpvd(this));
    }
