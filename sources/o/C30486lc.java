...
public final class C30486lc implements BH<C10629bs> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C10629bs c10629bs, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.StartProjectVersionOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C30433lb.OLrzqt(dt, c10629bs)));
