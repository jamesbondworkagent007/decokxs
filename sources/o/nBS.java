...
public final class nBS extends oAE<OKPayMessage, nML> {
    public final java.lang.Integer OLrzqt = java.lang.Integer.valueOf(C35342ntX.AEQbTJ);
    public final int copydefault = C35399nuc.Dialog.DGUQLIekVPG;
    ...
    public /* synthetic */ void copydefault(oAC oac, C35254nrp c35254nrp, OKMessageContent oKMessageContent) {
        KWHzl((oAC<AbstractC44111sDt, nML>) oac, c35254nrp, (OKPayMessage) oKMessageContent);
    }
    ...
    public void KWHzl(@NotNull oAC<AbstractC44111sDt, nML> oac, @NotNull C35254nrp c35254nrp, @NotNull OKPayMessage oKPayMessage) {
        Intrinsics.checkNotNullParameter(oac, "");
        Intrinsics.checkNotNullParameter(c35254nrp, "");
        Intrinsics.checkNotNullParameter(oKPayMessage, "");
        super.copydefault(oac, c35254nrp, oKPayMessage);
        C33726nDo.EZpvd.copydefault(oac, c35254nrp, oKPayMessage, OKMessage.MessageDirection.RECEIVE);
