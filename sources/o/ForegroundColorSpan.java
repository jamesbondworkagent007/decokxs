...
public final class ForegroundColorSpan {
    public static final byte[] EZpvd(DT dt, final ServiceManager serviceManager) {
        EW ew = new EW();
        AbstractC5105Ex.LoaderManager loaderManager = AbstractC5105Ex.LoaderManager.KWHzl;
        C5101Et c5101Et = new C5101Et(loaderManager, new EX("DataAccessRoleArn"));
        C5101Et c5101Et2 = new C5101Et(loaderManager, new EX("ModelKmsKeyId"));
        C5101Et c5101Et3 = new C5101Et(loaderManager, new EX("ModelName"));
        C5101Et c5101Et4 = new C5101Et(loaderManager, new EX("SourceModelArn"));
        C5101Et c5101Et5 = new C5101Et(AbstractC5105Ex.Fragment.KWHzl, new EX("Tags"));
        C5101Et c5101Et6 = new C5101Et(loaderManager, new EX("VersionName"));
        ...
        java.lang.String strAEQbTJ = serviceManager.AEQbTJ();
        if (strAEQbTJ != null) {
            ebEZpvd.AEQbTJ(c5101Et, strAEQbTJ);
        }
        java.lang.String strEZpvd = serviceManager.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et2, strEZpvd);
        }
        java.lang.String strOLrzqt = serviceManager.OLrzqt();
        if (strOLrzqt != null) {
            ebEZpvd.AEQbTJ(c5101Et3, strOLrzqt);
        }
        java.lang.String strCopydefault = serviceManager.copydefault();
        if (strCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et4, strCopydefault);
        }
        if (serviceManager.KWHzl() != null) {
            ebEZpvd.EZpvd(c5101Et5, new Function1<InterfaceC5094Em, Unit>() { // from class: aws.sdk.kotlin.services.comprehend.serde.ImportModelOperationSerializerKt$serializeImportModelOperationBody$1$5
                ...
                /* JADX INFO: renamed from: aws.sdk.kotlin.services.comprehend.serde.ImportModelOperationSerializerKt$serializeImportModelOperationBody$1$5$1, reason: invalid class name */
                ...
                public final void invoke2(@NotNull InterfaceC5094Em interfaceC5094Em) {
                    ...
                    Iterator<PrinterDiscoverySession> it = serviceManager.KWHzl().iterator();
                    while (it.hasNext()) {
        ...
        java.lang.String strGEmmrt = serviceManager.gEmmrt();
        if (strGEmmrt != null) {
