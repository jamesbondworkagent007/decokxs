...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.LimitExceededExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes21.dex */
public final class Learner implements BB<LimitExceededException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super LimitExceededException> continuation) throws java.lang.Throwable {
        ...
        LimitExceededException.StateListAnimator stateListAnimator;
        ...
        if (i2 == 0) {
            ...
            LimitExceededException.StateListAnimator stateListAnimator2 = new LimitExceededException.StateListAnimator();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            limitExceededExceptionDeserializer$deserialize$1.L$0 = stateListAnimator2;
            ...
            stateListAnimator = (LimitExceededException.StateListAnimator) limitExceededExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            InstanceLearner.copydefault(stateListAnimator, bArr);
        }
