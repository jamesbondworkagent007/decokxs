...
public class oVB extends AbstractC36262oVg {
    public oVB(java.lang.String str) {
        super(str);
        ...
        EZpvd(parameter5);
        EZpvd(parameter6);
        OLrzqt(new Expression.Output("Acc. L/S", new Expression.IntentSender(), Expression.Output.Style.LINE, 17));
        OLrzqt(new Expression.Output("Net L/S", new Expression.IntentFilter(), Expression.Output.Style.LSA_STICK, 1));
        valueOf();
    }
