...
import aws.sdk.kotlin.services.textract.model.ResourceNotFoundException;
import aws.sdk.kotlin.services.textract.serde.ResourceNotFoundExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.rT, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C42442rT implements BB<ResourceNotFoundException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super ResourceNotFoundException> continuation) throws java.lang.Throwable {
        ...
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C42361rQ.EZpvd(application, bArr);
        }
        application.AEQbTJ();
