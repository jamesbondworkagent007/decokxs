...
public final class TextClassifierImplNative {
    public static final void copydefault(LanguageNotSupportedException.TaskDescription taskDescription, byte[] bArr) {
        EL el = new EL(bArr);
