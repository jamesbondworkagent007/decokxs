...
import aws.sdk.kotlin.services.comprehend.model.InvalidFilterException;
import aws.sdk.kotlin.services.comprehend.serde.InvalidFilterExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes21.dex */
public final class ImageSpan implements BB<InvalidFilterException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InvalidFilterException> continuation) throws java.lang.Throwable {
        ...
        InvalidFilterException.Application application;
        ...
        if (i2 == 0) {
            ...
            InvalidFilterException.Application application2 = new InvalidFilterException.Application();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            invalidFilterExceptionDeserializer$deserialize$1.L$0 = application2;
            ...
            application = (InvalidFilterException.Application) invalidFilterExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            LocaleSpan.KWHzl(application, bArr);
        }
        application.OLrzqt();
