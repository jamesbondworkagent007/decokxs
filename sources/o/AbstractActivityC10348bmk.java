...
public abstract class AbstractActivityC10348bmk extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC10348bmk() {
        EZpvd();
    }

    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.bmk.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC10348bmk.this.g_();
            }
        });
    }
    ...
    public void g_() {
        ...
        this.EZpvd = true;
        ((InterfaceC10313bmB) aA_()).copydefault((ActivityC10355bmr) C58163ywB.EZpvd(this));
    }
