...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.UntagResourceOperationDeserializer$deserialize$1;
...
public final class ContextHubMessage implements BB<SecurityLog> {
    /* JADX WARN: Removed duplicated region for block: B:7:0x0013  */
    @Override // o.BB
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super SecurityLog> continuation) throws java.lang.Throwable {
        ...
        if (i2 == 0) {
            ...
            if (!zT.copydefault(c58859zS.AEQbTJ().OLrzqt())) {
                ...
                if (ContextHubTransaction.OLrzqt(dt, c58859zS, untagResourceOperationDeserializer$deserialize$1) == objCopydefault) {
                    return objCopydefault;
                }
            } else {
                SecurityLog.Application application = new SecurityLog.Application();
                application.KWHzl();
