...
public abstract class AbstractActivityC6571aRp extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6571aRp() {
        KWHzl();
    }

    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aRp.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6571aRp.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC6578aRw) aA_()).EZpvd((ActivityC6573aRr) C58163ywB.EZpvd(this));
    }
