...
public class C7817aqw extends C7769aqA implements InterfaceC7410ajM, InterfaceC7408ajK, C7904asd.Application {
    private final C7808aqn backgroundDrawable;
    private final C7904asd viewClipHelper;
    private final C7907asg viewShadowHelper;

    public C7817aqw(android.content.Context context) {
        super(context);
        C7808aqn c7808aqn = new C7808aqn();
        this.backgroundDrawable = c7808aqn;
        c7808aqn.OLrzqt(false);
        this.viewClipHelper = new C7904asd(this);
    ...
    @Override // o.C7769aqA, android.view.View
    ...
    public void draw(android.graphics.Canvas canvas) {
        if (this.viewClipHelper.OLrzqt()) {
            this.viewClipHelper.AEQbTJ(canvas, (C7904asd.Application) this, false);
        } else {
            super.draw(canvas);
        }
    }
