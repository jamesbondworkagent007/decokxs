...
public final class C50697vY implements BH<C46429tU> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C46429tU c46429tU, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.TagResourceOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C52938wc.copydefault(dt, c46429tU)));
