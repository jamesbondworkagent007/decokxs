...
import aws.sdk.kotlin.services.rekognition.model.LimitExceededException;
import aws.sdk.kotlin.services.rekognition.serde.LimitExceededExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.ic, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C24344ic implements BB<LimitExceededException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super LimitExceededException> continuation) throws java.lang.Throwable {
        ...
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C24238ia.AEQbTJ(actionBar, bArr);
        }
        actionBar.KWHzl();
