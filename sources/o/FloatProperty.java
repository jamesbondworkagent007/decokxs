...
public final class FloatProperty implements BH<PidHealthStats> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull PidHealthStats pidHealthStats, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.comprehend.serde.ListTargetedSentimentDetectionJobsOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(FloatMath.EZpvd(dt, pidHealthStats)));
