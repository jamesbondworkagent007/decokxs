...
public final class GestureDetector {
    public static final byte[] KWHzl(DT dt, final PrinterInfo printerInfo) {
        EW ew = new EW();
        ...
        java.lang.String strEZpvd = printerInfo.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et, strEZpvd);
        }
        if (printerInfo.OLrzqt() != null) {
            ebEZpvd.EZpvd(c5101Et2, new Function1<InterfaceC5094Em, Unit>() { // from class: aws.sdk.kotlin.services.comprehend.serde.TagResourceOperationSerializerKt$serializeTagResourceOperationBody$1$2
                ...
                /* JADX INFO: renamed from: aws.sdk.kotlin.services.comprehend.serde.TagResourceOperationSerializerKt$serializeTagResourceOperationBody$1$2$1, reason: invalid class name */
                ...
                public final void invoke2(@NotNull InterfaceC5094Em interfaceC5094Em) {
                    ...
                    Iterator<PrinterDiscoverySession> it = printerInfo.OLrzqt().iterator();
                    while (it.hasNext()) {
