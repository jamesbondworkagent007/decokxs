...
public final class C49465up implements BH<C44524sT> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C44524sT c44524sT, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.CreateParallelDataOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C49518uq.OLrzqt(dt, c44524sT)));
