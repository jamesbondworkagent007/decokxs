...
import aws.sdk.kotlin.services.rekognition.model.InternalServerError;
import aws.sdk.kotlin.services.rekognition.serde.InternalServerErrorDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.hB, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C21482hB implements BB<InternalServerError> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InternalServerError> continuation) throws java.lang.Throwable {
        ...
        InternalServerError.ActionBar actionBar;
        ...
        if (i2 == 0) {
            ...
            InternalServerError.ActionBar actionBar2 = new InternalServerError.ActionBar();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            internalServerErrorDeserializer$deserialize$1.L$0 = actionBar2;
            ...
            actionBar = (InternalServerError.ActionBar) internalServerErrorDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C21509hC.OLrzqt(actionBar, bArr);
        }
        actionBar.KWHzl();
