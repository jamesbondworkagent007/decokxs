...
public abstract class AbstractActivityC34090nRa<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC34090nRa() {
        gEmmrt();
    }

    private void gEmmrt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.nRa.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC34090nRa.this.AhwBna();
            }
        });
    }
    ...
    public void AhwBna() {
        ...
        this.djBIcL = true;
        ((nQR) aA_()).OLrzqt((nQO) C58163ywB.EZpvd(this));
    }
