...
import aws.sdk.kotlin.services.translate.serde.ListTagsForResourceOperationDeserializer$deserialize$1;
...
public final class C51705vs implements BB<C47912tz> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super C47912tz> continuation) throws java.lang.Throwable {
        ListTagsForResourceOperationDeserializer$deserialize$1 listTagsForResourceOperationDeserializer$deserialize$1;
        C47912tz.Activity activity;
        byte[] bArr;
        ...
        if (i2 != 0) {
            ...
            activity = (C47912tz.Activity) listTagsForResourceOperationDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(objCopydefault);
            bArr = (byte[]) objCopydefault;
            if (bArr != null) {
                C51758vt.EZpvd(activity, bArr);
            }
            activity.KWHzl();
        ...
        if (!zT.copydefault(interfaceC5039CjAEQbTJ.OLrzqt())) {
            ...
            if (C51758vt.EZpvd(dt, c58859zS, listTagsForResourceOperationDeserializer$deserialize$1) == objCopydefault2) {
                return objCopydefault2;
            }
            throw new KotlinNothingValueException();
        }
        activity = new C47912tz.Activity();
        zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
        listTagsForResourceOperationDeserializer$deserialize$1.L$0 = activity;
