...
public abstract class AbstractActivityC29445ktl extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC29445ktl() {
        EZpvd();
    }

    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ktl.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC29445ktl.this.KWHzl();
            }
        });
    }
    ...
    public void KWHzl() {
        ...
        ((InterfaceC29448kto) aA_()).AEQbTJ((ActivityC29450ktq) C58163ywB.EZpvd(this));
    }
