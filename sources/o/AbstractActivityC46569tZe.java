...
public abstract class AbstractActivityC46569tZe extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC46569tZe() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.tZe.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC46569tZe.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.EZpvd = true;
        ((InterfaceC46573tZi) aA_()).EZpvd((ActivityC46568tZd) C58163ywB.EZpvd(this));
    }
