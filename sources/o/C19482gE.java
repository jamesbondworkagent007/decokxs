...
public final class C19482gE {
    public static final byte[] OLrzqt(DT dt, ToggleButton toggleButton) {
        EW ew = new EW();
        ...
        java.lang.String strOLrzqt = toggleButton.OLrzqt();
        if (strOLrzqt != null) {
            ebEZpvd.AEQbTJ(c5101Et, strOLrzqt);
        }
        java.lang.Integer numCopydefault = toggleButton.copydefault();
        if (numCopydefault != null) {
            ebEZpvd.OLrzqt(c5101Et2, numCopydefault.intValue());
        }
        java.lang.String strKWHzl = toggleButton.KWHzl();
        if (strKWHzl != null) {
