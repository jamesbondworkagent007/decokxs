...
/* JADX INFO: renamed from: o.nBd, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C33661nBd extends nAF<OKDeclinedPayMessage> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // o.AbstractC35703oAo
    public java.lang.Class<OKDeclinedPayMessage> KWHzl() {
        return OKDeclinedPayMessage.class;
    }
    ...
    public java.lang.CharSequence KWHzl(@NotNull android.content.Context context, @NotNull OKDeclinedPayMessage oKDeclinedPayMessage, @NotNull OKMessage oKMessage) {
        Intrinsics.checkNotNullParameter(context, "");
        Intrinsics.checkNotNullParameter(oKDeclinedPayMessage, "");
        Intrinsics.checkNotNullParameter(oKMessage, "");
        java.lang.String string = context.getString(C35399nuc.LoaderManager.flVtFt);
    ...
    public void KWHzl(@NotNull oGY<AbstractC34017nOi> ogy, @NotNull C35254nrp c35254nrp) {
        ...
        textView.setText(KWHzl(context, (OKDeclinedPayMessage) content, c35254nrp.OLrzqt()));
    }
}
