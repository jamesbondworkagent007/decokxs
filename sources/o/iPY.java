...
public abstract class iPY extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.iPY.4
    ...
    public void KWHzl() {
        ...
        ((iSH) aA_()).OLrzqt((InvestTransactionResultActivity) C58163ywB.EZpvd(this));
    }
