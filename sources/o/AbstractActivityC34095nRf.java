...
public abstract class AbstractActivityC34095nRf<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC34095nRf() {
        AhwBna();
    }

    private void AhwBna() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.nRf.4
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC34095nRf.this.gEmmrt();
            }
        });
    }
    ...
    public void gEmmrt() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC34108nRs) aA_()).copydefault((ActivityC34105nRp) C58163ywB.EZpvd(this));
    }
