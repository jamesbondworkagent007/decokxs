...
/* JADX INFO: renamed from: o.ort, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes16.dex */
public abstract class AbstractActivityC37337ort<T extends ViewDataBinding> extends AbstractActivityC33044moy<T> implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37337ort() {
        djBIcL();
    }

    private void djBIcL() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ort.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37337ort.this.AYXKKw();
            }
        });
    }
    ...
    public void AYXKKw() {
        ...
        this.OLrzqt = true;
        ((InterfaceC37324org) aA_()).KWHzl((ActivityC37326ori) C58163ywB.EZpvd(this));
    }
