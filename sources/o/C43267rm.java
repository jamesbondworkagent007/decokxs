...
import aws.sdk.kotlin.services.textract.model.LimitExceededException;
import aws.sdk.kotlin.services.textract.serde.LimitExceededExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.rm, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C43267rm implements BB<LimitExceededException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super LimitExceededException> continuation) throws java.lang.Throwable {
        ...
        LimitExceededException.Application application;
        ...
        if (i2 == 0) {
            ...
            LimitExceededException.Application application2 = new LimitExceededException.Application();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            limitExceededExceptionDeserializer$deserialize$1.L$0 = application2;
            ...
            application = (LimitExceededException.Application) limitExceededExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C43373ro.EZpvd(application, bArr);
        }
        application.KWHzl();
