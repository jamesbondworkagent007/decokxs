...
public final class mTS implements oKD {
    public final int AEQbTJ;
    public final MarketCoinDetailViewModel EZpvd;
    public final WeakReference<C36250oUv> KWHzl;
    ...
    public mTS(WeakReference<C36250oUv> weakReference, @NotNull MarketCoinDetailViewModel marketCoinDetailViewModel, int i, int i2) {
    ...
    public void OLrzqt(boolean z) {
        ...
        WeakReference<C36250oUv> weakReference2 = this.KWHzl;
        ...
        AEQbTJ(this.KWHzl);
        if (!z || (weakReference = this.KWHzl) == null || (c36250oUv = weakReference.get()) == null) {
            return;
        }
        c36250oUv.QKVWgx();
    }
    ...
    public void copydefault(boolean z) {
        C36250oUv c36250oUv;
        ChartViewOutSideConfig chartViewOutSideConfigAkhnZx;
        this.EZpvd.AEQbTJ("key_kline_market_show_current_order", java.lang.Boolean.valueOf(z), "dex_market");
        WeakReference<C36250oUv> weakReference = this.KWHzl;
    ...
    @Override // o.oKD
    public void KWHzl() {
        this.EZpvd.values().setValue(C56390yDp.OLrzqt(java.lang.Boolean.FALSE, java.lang.Integer.valueOf(this.AEQbTJ)));
    }
    ...
    public void EZpvd(float f) {
        ...
        c36250oUv.setMinimumHeight((int) (this.OLrzqt * (f + 1.0f)));
    }
    ...
    public void gEmmrt(boolean z) {
        ...
        C36250oUv c36250oUv2;
        ChartViewOutSideConfig chartViewOutSideConfigAkhnZx2;
        this.EZpvd.AEQbTJ("chart_spot_average", java.lang.Boolean.valueOf(z));
        WeakReference<C36250oUv> weakReference = this.KWHzl;
        if (weakReference != null && (c36250oUv2 = weakReference.get()) != null && (chartViewOutSideConfigAkhnZx2 = c36250oUv2.AkhnZx()) != null) {
    ...
    private final void AEQbTJ(WeakReference<C36250oUv> weakReference) {
        C36250oUv c36250oUv;
        C36250oUv c36250oUv2;
