...
public final class SliceMetrics {
    public static final byte[] KWHzl(DT dt, final EncryptedPrivateKeyInfo encryptedPrivateKeyInfo) {
        EW ew = new EW();
        ...
        if (encryptedPrivateKeyInfo.AEQbTJ() != null) {
            ebEZpvd.OLrzqt(c5101Et, new Function1<InterfaceC5097Ep, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.serde.AdminConfirmSignUpOperationSerializerKt$serializeAdminConfirmSignUpOperationBody$1$1
                ...
                public final void invoke2(@NotNull InterfaceC5097Ep interfaceC5097Ep) {
                    ...
                    for (Map.Entry<String, String> entry : encryptedPrivateKeyInfo.AEQbTJ().entrySet()) {
                        interfaceC5097Ep.KWHzl(entry.getKey(), entry.getValue());
                    }
                }
            });
        }
        java.lang.String strOLrzqt = encryptedPrivateKeyInfo.OLrzqt();
        if (strOLrzqt != null) {
            ebEZpvd.AEQbTJ(c5101Et2, strOLrzqt);
        }
        java.lang.String strEZpvd = encryptedPrivateKeyInfo.EZpvd();
        if (strEZpvd != null) {
