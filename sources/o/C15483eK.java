...
import aws.sdk.kotlin.services.rekognition.serde.DeleteUserOperationDeserializerKt$throwDeleteUserError$1;
import kotlin.coroutines.Continuation;

/* JADX INFO: renamed from: o.eK, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C15483eK {
                        ...
                        switch (strOLrzqt.hashCode()) {
                            case -1943616152:
                                if (strOLrzqt.equals("InternalServerError")) {
                                    ...
                                    objCopydefault = c21482hB.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case -727499650:
                                if (strOLrzqt.equals("ProvisionedThroughputExceededException")) {
                                    ...
                                    objCopydefault = c27537jx.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case -72198520:
                                if (strOLrzqt.equals("ThrottlingException")) {
                                    ...
                                    objCopydefault = c32385mb.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 122859728:
                                if (strOLrzqt.equals("AccessDeniedException")) {
                                    ...
                                    objCopydefault = c11297cJ.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1643655293:
                                if (strOLrzqt.equals("ConflictException")) {
                                    ...
                                    objCopydefault = c14258di.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1674340573:
                                if (strOLrzqt.equals("InvalidParameterException")) {
                                    ...
                                    objCopydefault = c21698hJ.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1762275249:
                                if (strOLrzqt.equals("IdempotentParameterMismatchException")) {
                                    ...
                                    objCopydefault = c23058hr.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1821306386:
                                if (strOLrzqt.equals("ResourceNotFoundException")) {
                                    ...
                                    objCopydefault = c26021jP.AEQbTJ(dt, c58859zSCopy$default, deleteUserOperationDeserializerKt$throwDeleteUserError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
