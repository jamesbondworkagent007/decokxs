...
/* JADX INFO: renamed from: o.nBk, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C33668nBk extends oAA<OKEmojiMessage, AbstractC33985nNd> {
    ...
    public /* synthetic */ void copydefault(oAC oac, C35254nrp c35254nrp, OKMessageContent oKMessageContent) {
        OLrzqt((oAC<AbstractC44112sDu, AbstractC33985nNd>) oac, c35254nrp, (OKEmojiMessage) oKMessageContent);
    }
    ...
    public void OLrzqt(@NotNull oAC<AbstractC44112sDu, AbstractC33985nNd> oac, @NotNull C35254nrp c35254nrp, @NotNull OKEmojiMessage oKEmojiMessage) {
    ...
    public boolean OLrzqt(@NotNull android.view.View view, int i, @NotNull C35254nrp c35254nrp, @NotNull OKEmojiMessage oKEmojiMessage, @NotNull ViewBinding viewBinding) {
        ...
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(DbNXlk()), null, null, new EmojiSendMessageViewProvider$onMessageContentViewLongClick$1(c35254nrp, this, viewBinding, null), 3, null);
        return true;
    }
}
