...
import aws.sdk.kotlin.services.comprehend.endpoints.internal.EndpointResolverAdapter$resolve$1;
...
public final class MobileLinkQualityInfo implements BD {
    public final LocalSocket.TaskDescription AEQbTJ;

    public MobileLinkQualityInfo(@NotNull LocalSocket.TaskDescription taskDescription) {
    ...
    */
    public java.lang.Object EZpvd(@NotNull BX bx, @NotNull Continuation<? super C57631ym> continuation) throws java.lang.Throwable {
        ...
        if (i2 == 0) {
            ...
            Network networkAEQbTJ = NetworkCapabilities.AEQbTJ(this.AEQbTJ, bx);
            NetworkAgent networkAgentAYXKKw = this.AEQbTJ.AYXKKw();
            endpointResolverAdapter$resolve$1.label = 1;
            objResolveEndpoint = networkAgentAYXKKw.resolveEndpoint(networkAEQbTJ, endpointResolverAdapter$resolve$1);
