...
public final class AccessoryFilter implements BH<BackupHelper> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull BackupHelper backupHelper, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.serde.UpdateUserAttributesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(SoundTriggerModule.OLrzqt(dt, backupHelper)));
