...
public final class C13753dX {
    public static final CursorTreeAdapter OLrzqt(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        CursorTreeAdapter.Activity activity = new CursorTreeAdapter.Activity();
