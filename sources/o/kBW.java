...
public abstract class kBW extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    private void KWHzl() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.kBW.3
    ...
    public void EZpvd() {
        ...
        this.KWHzl = true;
        ((InterfaceC27759kCh) aA_()).EZpvd((kBV) C58163ywB.EZpvd(this));
    }
