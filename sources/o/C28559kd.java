...
public final class C28559kd implements BH<C6370aO> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C6370aO c6370aO, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.SearchFacesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C28612ke.OLrzqt(dt, c6370aO)));
