...
public final class C56232xyt extends xKE<java.util.List<? extends BotCategoryConfig>> {
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends BotCategoryConfig>>> EZpvd() {
        return ((BizApiService) C43393roT.httpService$default(C56524yIo.AEQbTJ(BizApiService.class), null, 1, null)).getNewBotCategory();
    }
}
