...
public final class C56143xxJ extends xKE<java.util.List<? extends DcaTradeListResponse>> {
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends DcaTradeListResponse>>> EZpvd() {
        return ((BizApiService) C43393roT.httpService$default(C56524yIo.AEQbTJ(BizApiService.class), null, 1, null)).getContractDcaTradeList(this.copydefault, this.OLrzqt, this.EZpvd, this.KWHzl);
    }
}
