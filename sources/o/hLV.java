...
public abstract class hLV extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    private void EZpvd() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.hLV.5
    ...
    public void OLrzqt() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC21794hMo) aA_()).KWHzl((LimitOrderDetailActivity) C58163ywB.EZpvd(this));
    }
