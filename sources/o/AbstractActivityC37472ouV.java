...
public abstract class AbstractActivityC37472ouV extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC37472ouV() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.ouV.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC37472ouV.this.AEQbTJ();
            }
        });
    }
    ...
    public void AEQbTJ() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC37530ova) aA_()).OLrzqt((ActivityC37470ouT) C58163ywB.EZpvd(this));
    }
