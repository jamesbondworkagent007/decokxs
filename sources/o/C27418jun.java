...
public final class C27418jun extends LineChartRenderer {
    public int AEQbTJ;
    ...
    public C27418jun(@NotNull LineDataProvider lineDataProvider, @NotNull ChartAnimator chartAnimator, @NotNull ViewPortHandler viewPortHandler) {
    ...
    private final void copydefault(android.graphics.Canvas canvas, int i) {
        ...
        paint.setColor(i);
        paint.setMaskFilter(new BlurMaskFilter(C55298xhM.dp$default(20, (android.content.Context) null, 1, (java.lang.Object) null), BlurMaskFilter.Blur.SOLID));
