...
public final class C50157vE implements BH<C46024tF> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C46024tF c46024tF, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.ListTextTranslationJobsOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C50130vD.copydefault(dt, c46024tF)));
