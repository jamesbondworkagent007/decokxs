...
public final class ConsumerIrManager {
    public static final byte[] copydefault(DT dt, ContentProviderHolder contentProviderHolder) {
        EW ew = new EW();
        ...
        java.lang.Integer numAEQbTJ = contentProviderHolder.AEQbTJ();
        if (numAEQbTJ != null) {
            ebEZpvd.OLrzqt(c5101Et, numAEQbTJ.intValue());
        }
        java.lang.String strKWHzl = contentProviderHolder.KWHzl();
        if (strKWHzl != null) {
            ebEZpvd.AEQbTJ(c5101Et2, strKWHzl);
        }
        java.lang.String strEZpvd = contentProviderHolder.EZpvd();
        if (strEZpvd != null) {
