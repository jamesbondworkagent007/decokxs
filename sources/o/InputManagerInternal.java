...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.UnauthorizedExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes2.dex */
public final class InputManagerInternal implements BB<UnauthorizedException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super UnauthorizedException> continuation) throws java.lang.Throwable {
        ...
        UnauthorizedException.TaskDescription taskDescription;
        ...
        if (i2 == 0) {
            ...
            UnauthorizedException.TaskDescription taskDescription2 = new UnauthorizedException.TaskDescription();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            unauthorizedExceptionDeserializer$deserialize$1.L$0 = taskDescription2;
            ...
            taskDescription = (UnauthorizedException.TaskDescription) unauthorizedExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            InputManager.KWHzl(taskDescription, bArr);
        }
