...
public final class C23376hx implements BH<C29778l> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C29778l c29778l, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.IndexFacesOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C23270hv.copydefault(dt, c29778l)));
