...
public abstract class AbstractActivityC6627aSs extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6627aSs() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aSs.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6627aSs.this.KWHzl();
            }
        });
    }
    ...
    public void KWHzl() {
        ...
        this.EZpvd = true;
        ((InterfaceC6591aSI) aA_()).OLrzqt((ActivityC6629aSu) C58163ywB.EZpvd(this));
    }
