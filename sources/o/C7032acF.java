...
public final class C7032acF extends Trie2 {
    public static C7032acF AEQbTJ(java.nio.ByteBuffer byteBuffer) throws java.io.IOException {
        return (C7032acF) Trie2.OLrzqt(byteBuffer);
    }
    ...
    public final int OLrzqt(int i) {
        if (i >= 0) {
            ...
            if (i <= 65535) {
                char[] cArr2 = this.fetchVPNInfo;
                return cArr2[(cArr2[((i - 55296) >> 5) + 2048] << 2) + (i & 31)];
            }
            if (i < this.valueOf) {
                char[] cArr3 = this.fetchVPNInfo;
                return cArr3[(cArr3[cArr3[(i >> 11) + 2080] + ((i >> 5) & 63)] << 2) + (i & 31)];
            }
            if (i <= 1114111) {
                return this.fetchVPNInfo[this.gEmmrt];
            }
        }
        return this.djBIcL;
    }
    ...
    public int EZpvd() {
        return ((this.AhwBna.OLrzqt + this.KWHzl) * 2) + 16;
    }
        ...
        loop0: while (true) {
            ...
            if (i < 55296 || (i > 56319 && i <= 65535)) {
                ...
                if (i < 65535) {
                    ...
                    c = cArr[(i >> 11) + 2080];
                    c2 = cArr[((i >> 5) & 63) + c];
                } else if (i3 == this.fetchVPNInfo[this.gEmmrt]) {
                    i = i2;
                }
                i4 = c2 << 2;
            }
