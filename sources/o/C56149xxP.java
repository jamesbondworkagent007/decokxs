...
public final class C56149xxP extends xKE<java.util.List<? extends StrategyResponse>> {
    public EditContractDcaReq KWHzl;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final C56149xxP EZpvd(@NotNull EditContractDcaReq editContractDcaReq) {
        Intrinsics.checkNotNullParameter(editContractDcaReq, "");
        this.KWHzl = editContractDcaReq;
        return this;
    }
    ...
    public AbstractC58185ywX<ResponseData<java.util.List<? extends StrategyResponse>>> EZpvd() {
        ...
        EditContractDcaReq editContractDcaReq2 = this.KWHzl;
        if (editContractDcaReq2 == null) {
            Intrinsics.gEmmrt("");
        } else {
            editContractDcaReq = editContractDcaReq2;
        }
        return bizApiService.editContractDcaPrice(editContractDcaReq);
    }
}
