...
public final class C48047uD implements BH<C44582sX> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C44582sX c44582sX, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.DeleteTerminologyOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C48020uC.copydefault(dt, c44582sX)));
