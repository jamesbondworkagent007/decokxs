...
public final class oOB implements ViewBinding {
    ...
    public oOB(@androidx.annotation.NonNull LinearLayoutCompat linearLayoutCompat, @androidx.annotation.NonNull C55008xbo c55008xbo, @androidx.annotation.NonNull LinearLayoutCompat linearLayoutCompat2, @androidx.annotation.NonNull C55008xbo c55008xbo2, @androidx.annotation.NonNull C34646nfy c34646nfy, @androidx.annotation.NonNull AppCompatTextView appCompatTextView, @androidx.annotation.NonNull android.widget.TextView textView) {
        this.copydefault = linearLayoutCompat;
        this.KWHzl = c55008xbo;
        this.AEQbTJ = linearLayoutCompat2;
        this.EZpvd = c55008xbo2;
        this.OLrzqt = c34646nfy;
        this.AhwBna = appCompatTextView;
        this.valueOf = textView;
    }

    public static oOB AEQbTJ(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.Nullable android.view.ViewGroup viewGroup, boolean z) {
        android.view.View viewInflate = layoutInflater.inflate(C35964oKf.Application.DGUQLIOvDItG, viewGroup, false);
        if (z) {
    ...
    public static oOB EZpvd(@androidx.annotation.NonNull android.view.View view) {
                ...
                if (c55008xbo2 != null) {
                    ...
                    if (c34646nfy != null) {
                        ...
                        if (appCompatTextView != null) {
                            ...
                            if (textView != null) {
                                return new oOB((LinearLayoutCompat) view, c55008xbo, linearLayoutCompat, c55008xbo2, c34646nfy, appCompatTextView, textView);
                            }
                        }
                    }
                }
