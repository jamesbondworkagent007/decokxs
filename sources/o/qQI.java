...
public final class qQI extends AbstractC40300qQt {
    public final InterfaceC56387yDm KWHzl;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // o.C40321qRn
    ...
    public qQI() {
        ...
        final InterfaceC56387yDm interfaceC56387yDmEZpvd = C56392yDr.EZpvd(LazyThreadSafetyMode.NONE, new Function0<ViewModelStoreOwner>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchSpotGroupFragment$special$$inlined$parentViewModels$2
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        this.KWHzl = FragmentViewModelLazyKt.createViewModelLazy(this, C56524yIo.AEQbTJ(SelectionNavSpotGroupViewModel.class), new Function0<ViewModelStore>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchSpotGroupFragment$special$$inlined$parentViewModels$3
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchSpotGroupFragment$special$$inlined$parentViewModels$4
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.okinc.market.search.features.navigation.selection.ui.sub.SelectionNavSearchSpotGroupFragment$special$$inlined$parentViewModels$5
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
    ...
    public NavSearchSpotGroupViewModel EZpvd() {
        return (NavSearchSpotGroupViewModel) this.KWHzl.getValue();
    }

    @Override // o.C40321qRn
    public NavSearchSpotPageVo KWHzl(@NotNull CategoryGroupVo categoryGroupVo) {
        Intrinsics.checkNotNullParameter(categoryGroupVo, "");
        return new NavSearchSpotPageVo(categoryGroupVo, new Function0() { // from class: o.qQH
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function0
            public final java.lang.Object invoke() {
                return qQI.valueOf();
            }
        }, new Function0() { // from class: o.qQE
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function0
            public final java.lang.Object invoke() {
                return qQI.isConnected();
            }
        });
    }
    ...
    public static final androidx.fragment.app.Fragment valueOf() {
        return new SelectionSearchSpotListFragment();
    }
