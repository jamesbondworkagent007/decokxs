...
public class yCV {
    public static android.graphics.Bitmap OLrzqt(android.content.Context context, android.graphics.Bitmap bitmap, yCY ycy) throws java.lang.Throwable {
        ...
        android.graphics.Bitmap bitmapCreateBitmap = android.graphics.Bitmap.createBitmap(i3, i4, Bitmap.Config.ARGB_8888);
        android.graphics.Canvas canvas = new android.graphics.Canvas(bitmapCreateBitmap);
        float f = 1.0f / ycy.AEQbTJ;
        canvas.scale(f, f);
        android.graphics.Paint paint = new android.graphics.Paint();
        paint.setFlags(3);
        paint.setColorFilter(new PorterDuffColorFilter(ycy.copydefault, PorterDuff.Mode.SRC_ATOP));
        canvas.drawBitmap(bitmap, 0.0f, 0.0f, paint);
        try {
            bitmapCopydefault = copydefault(context, bitmapCreateBitmap, ycy.KWHzl);
        } catch (RSRuntimeException unused) {
            bitmapCopydefault = copydefault(bitmapCreateBitmap, ycy.KWHzl, true);
        }
        if (ycy.AEQbTJ == 1) {
            return bitmapCopydefault;
        }
        android.graphics.Bitmap bitmapCreateScaledBitmap = android.graphics.Bitmap.createScaledBitmap(bitmapCopydefault, ycy.OLrzqt, ycy.EZpvd, true);
    ...
    */
    public static android.graphics.Bitmap copydefault(android.content.Context context, android.graphics.Bitmap bitmap, int i) throws java.lang.Throwable {
    ...
    public static android.graphics.Bitmap copydefault(android.graphics.Bitmap bitmap, int i, boolean z) {
        int[] iArr;
        int i2 = i;
