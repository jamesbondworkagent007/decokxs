...
public final class C34594nez extends AbstractC5396Qc {
 ...
 A[MD:(boolean):void (m)] (LINE:11) call: o.nez.<init>(boolean):void type: THIS */
    public /* synthetic */ C34594nez(boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? false : z);
    }

    public C34594nez(boolean z) {
        this.OLrzqt = z;
    }
