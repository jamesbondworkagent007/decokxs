...
public final class pGT implements InterfaceC37953pGv {
    public final java.lang.String KWHzl = "VRIndicatorJsonManage";
    ...
    public kotlin.Pair<AbstractC36262oVg, java.lang.Boolean> AEQbTJ(@NotNull KlineIndicatorBean klineIndicatorBean) {
        ...
        if (params != null && (length = params.getLength()) != null && (value2 = length.getValue()) != null) {
            ...
            Expression.Parameter parameterEZpvd = ovr.EZpvd(0);
        ...
        if (params2 != null && (ma12 = params2.getMa1()) != null && (value = ma12.getValue()) != null) {
            ...
            Expression.Parameter parameterEZpvd2 = ovr.EZpvd(1);
        ...
        if (params3 != null && (out = params3.getOut()) != null && (parameterCopydefault2 = ovr.copydefault(0)) != null) {
            copydefault(out, parameterCopydefault2);
        }
        com.okinc.kline.ui.view.model.Params params4 = indicatorBean.getParams();
        if (params4 != null && (ma1 = params4.getMa1()) != null && (parameterCopydefault = ovr.copydefault(1)) != null) {
            copydefault(ma1, parameterCopydefault);
        }
        ovr.EZpvd();
        ovr.fJNWhG();
        java.lang.String strEjfBZ = ovr.ejfBZ();
        Intrinsics.checkNotNullExpressionValue(strEjfBZ, "");
        C36278oVw.KWHzl("ds0", EZpvd(strEjfBZ, indicatorBean.getMain()), ovr.AuCTel());
        ovr.copydefault();
        java.lang.String strEjfBZ2 = ovr.ejfBZ();
        Intrinsics.checkNotNullExpressionValue(strEjfBZ2, "");
        C36278oVw.copydefault("ds0", EZpvd(strEjfBZ2, indicatorBean.getMain()), new Gson().toJson(ovr.isConnected()));
        return new kotlin.Pair<>(ovr, java.lang.Boolean.valueOf(indicatorBean.getMain()));
    }
