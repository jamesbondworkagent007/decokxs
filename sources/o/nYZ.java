...
public final class nYZ extends AbstractC34300nYw<UpdateGroupNameMessage> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // o.AbstractC35703oAo
    public java.lang.Class<UpdateGroupNameMessage> KWHzl() {
        return UpdateGroupNameMessage.class;
    }
    ...
    public /* synthetic */ void AEQbTJ(oGY ogy, C35254nrp c35254nrp, OKGroupNotificationMessage oKGroupNotificationMessage) {
        OLrzqt((oGY<nLO>) ogy, c35254nrp, (UpdateGroupNameMessage) oKGroupNotificationMessage);
    }

    /* JADX DEBUG: Method merged with bridge method: KWHzl(Landroid/content/Context;Lcom/okinc/okimcore/model/im/OKMessageContent;Lcom/okinc/okimcore/model/im/OKMessage;)Ljava/lang/CharSequence; */
    @Override // o.AbstractC35703oAo
    /* JADX INFO: renamed from: OLrzqt, reason: merged with bridge method [inline-methods] */
    public java.lang.CharSequence KWHzl(@NotNull android.content.Context context, @NotNull UpdateGroupNameMessage updateGroupNameMessage, @NotNull OKMessage oKMessage) {
        Intrinsics.checkNotNullParameter(context, "");
        Intrinsics.checkNotNullParameter(updateGroupNameMessage, "");
        Intrinsics.checkNotNullParameter(oKMessage, "");
        return KWHzl(context, updateGroupNameMessage);
    }

    public void OLrzqt(@NotNull oGY<nLO> ogy, @NotNull C35254nrp c35254nrp, @NotNull UpdateGroupNameMessage updateGroupNameMessage) {
        Intrinsics.checkNotNullParameter(ogy, "");
        Intrinsics.checkNotNullParameter(c35254nrp, "");
        Intrinsics.checkNotNullParameter(updateGroupNameMessage, "");
        super.AEQbTJ(ogy, c35254nrp, updateGroupNameMessage);
        ...
        textView.setText(KWHzl(context, updateGroupNameMessage));
    }

    public final java.lang.CharSequence KWHzl(android.content.Context context, UpdateGroupNameMessage updateGroupNameMessage) {
        java.lang.String strCopydefault;
        java.lang.String operatorId;
        java.lang.String operatorId2;
        RelationInfo relationInfoKWHzl;
        boolean zOLrzqt = C33142mqq.EZpvd.OLrzqt();
        GroupSystemMessageInfo notifyInfo = updateGroupNameMessage.getNotifyInfo();
        GroupSystemMessageInfo notifyInfo2 = updateGroupNameMessage.getNotifyInfo();
        ...
        java.lang.String formattedString$default = C33069mpW.getFormattedString$default(resources, C35399nuc.LoaderManager.DLWbHP, (java.util.Map) null, 2, (java.lang.Object) null);
        android.content.res.Resources resources2 = context.getResources();
        Intrinsics.checkNotNullExpressionValue(resources2, "");
        int i = C35399nuc.LoaderManager.ffGIBT;
        ...
        GroupSystemMessageInfo notifyInfo3 = updateGroupNameMessage.getNotifyInfo();
