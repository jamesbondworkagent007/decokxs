...
/* JADX INFO: renamed from: o.hTb, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes6.dex */
public final class C21970hTb extends android.widget.FrameLayout {
    public float AEQbTJ;
    public int OLrzqt;
    public float copydefault;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C21970hTb(@NotNull android.content.Context context) {
        super(context);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C21970hTb(@NotNull android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    */
    public final boolean EZpvd(android.view.MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            float fAbs = java.lang.Math.abs(motionEvent.getX() - this.AEQbTJ);
