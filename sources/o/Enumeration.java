...
import aws.sdk.kotlin.services.cognitoidentity.serde.TagResourceOperationDeserializerKt$throwTagResourceError$1;
                        ...
                        switch (strOLrzqt.hashCode()) {
                            case -1416998079:
                                if (strOLrzqt.equals("NotAuthorizedException")) {
                                    ...
                                    objCopydefault = invalidKeySpecException.AEQbTJ(dt, c58859zSCopy$default, tagResourceOperationDeserializerKt$throwTagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 504305508:
                                if (strOLrzqt.equals("InternalErrorException")) {
                                    ...
                                    objCopydefault = watchable.AEQbTJ(dt, c58859zSCopy$default, tagResourceOperationDeserializerKt$throwTagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1384808312:
                                if (strOLrzqt.equals("TooManyRequestsException")) {
                                    ...
                                    objCopydefault = hashMap.AEQbTJ(dt, c58859zSCopy$default, tagResourceOperationDeserializerKt$throwTagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1674340573:
                                if (strOLrzqt.equals("InvalidParameterException")) {
                                    ...
                                    objCopydefault = generalSecurityException.AEQbTJ(dt, c58859zSCopy$default, tagResourceOperationDeserializerKt$throwTagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1821306386:
                                if (strOLrzqt.equals("ResourceNotFoundException")) {
                                    ...
                                    objCopydefault = rSAOtherPrimeInfo.AEQbTJ(dt, c58859zSCopy$default, tagResourceOperationDeserializerKt$throwTagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
