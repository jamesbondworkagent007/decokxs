...
public final class C40815qf {
    public static final C33738nE EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        C33738nE.StateListAnimator stateListAnimator = new C33738nE.StateListAnimator();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    stateListAnimator.AEQbTJ(C41080qk.AEQbTJ(interfaceC5095En));
                } else {
