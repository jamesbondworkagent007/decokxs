...
public class C33597mzU extends AbstractC33598mzV {
    ...
    public AbstractViewOnClickListenerC33585mzI<C33583mzG> EZpvd(@NotNull android.content.Context context, @NotNull android.view.ViewGroup viewGroup, boolean z) {
        ...
        android.view.View viewInflate = android.view.LayoutInflater.from(context).inflate(C32113mPz.Fragment.DbNXlk, viewGroup, false);
        Intrinsics.checkNotNullExpressionValue(viewInflate, "");
        return new Application(viewInflate, z);
    }

    /* JADX INFO: renamed from: o.mzU$Application */
    public static final class Application<B extends C33601mzY> extends AbstractViewOnClickListenerC33585mzI<B> {
        public android.widget.TextView AhwBna;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public Application(@NotNull android.view.View view, boolean z) {
            super(view, z);
            Intrinsics.checkNotNullParameter(view, "");
            android.view.View viewFindViewById = view.findViewById(C32113mPz.FragmentManager.getFieldNames);
