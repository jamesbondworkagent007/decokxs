...
public class C56922yXh {
    ...
    static {
        ...
        EZpvd = "true".equals(property);
    }

    private C56922yXh() {
    }

    public static void EZpvd(@NotNull byte[] bArr, int i) {
        if (bArr == null) {
            copydefault(4);
        }
    ...
    public static byte[] EZpvd(@NotNull java.lang.String[] strArr) {
        if (strArr == null) {
            copydefault(7);
        }
        if (strArr.length > 0 && !strArr[0].isEmpty()) {
            ...
            if (cCharAt == 0) {
                byte[] bArrCopydefault = C56927yXm.copydefault(KWHzl(strArr));
        ...
        byte[] bArrCopydefault2 = copydefault(strArr);
        EZpvd(bArrCopydefault2, 127);
        return copydefault(bArrCopydefault2);
    }

    public static java.lang.String[] KWHzl(@NotNull java.lang.String[] strArr) {
        if (strArr == null) {
            copydefault(9);
        }
    ...
    public static byte[] copydefault(@NotNull java.lang.String[] strArr) {
        if (strArr == null) {
            copydefault(11);
        }
        int length = 0;
    ...
    public static byte[] copydefault(@NotNull byte[] bArr) {
        if (bArr == null) {
            copydefault(13);
        }
        ...
        for (int i3 = 0; i3 < length; i3++) {
            int i4 = i + 1;
            int i5 = i2 + 1;
            bArr2[i3] = (byte) (((bArr[i] & UnsignedBytes.MAX_VALUE) >>> i2) + ((bArr[i4] & ((1 << i5) - 1)) << (7 - i2)));
            if (i2 == 6) {
                i += 2;
                i2 = 0;
            } else {
