...
public abstract class AbstractActivityC15827eWt extends AbstractActivityC33013moT implements InterfaceC58208ywu {
    ...
    public AbstractActivityC15827eWt() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.eWt.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC15827eWt.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        this.EZpvd = true;
        ((eVP) aA_()).copydefault((eVQ) C58163ywB.EZpvd(this));
    }
