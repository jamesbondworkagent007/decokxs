...
public abstract class AbstractActivityC6498aQV extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6498aQV() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aQV.2
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6498aQV.this.EZpvd();
            }
        });
    }
    ...
    public void EZpvd() {
        ...
        ((InterfaceC6560aRe) aA_()).EZpvd((PasskeySyncStepperActivity) C58163ywB.EZpvd(this));
    }
