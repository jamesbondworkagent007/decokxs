...
public final class C18949fs {
    public static final OverScroller EZpvd(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        OverScroller.Application application = new OverScroller.Application();
        ...
        while (true) {
            ...
            if (numOLrzqt == null || numOLrzqt.intValue() != iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    application.EZpvd(C18843fq.OLrzqt(interfaceC5095En));
