...
public final class kQU {
    ...
    public final java.util.List<PrioritySelectionBean> AEQbTJ(int i, MevInfoBean mevInfoBean, NonMevPriorityFeeInfo nonMevPriorityFeeInfo, boolean z, @NotNull java.lang.String str) {
        ...
        java.lang.String strCopydefault = copydefault(z, mevInfoBean, nonMevPriorityFeeInfo);
        if (z2) {
            str2 = "";
            arrayList = arrayList2;
            tokenCode$default = C23271hvA.formatTokenCode$default(C23271hvA.copydefault, copydefault(z, mevInfoBean, nonMevPriorityFeeInfo), true, null, false, str, null, 22, null);
        } else {
            tokenCode$default = "";
            str2 = tokenCode$default;
            arrayList = arrayList2;
        }
        arrayList.add(new PrioritySelectionBean(strAYXKKw, strCopydefault, z3, value, tokenCode$default, (java.lang.String) null, 32, (DefaultConstructorMarker) null));
        ...
        arrayList.add(new PrioritySelectionBean(strAYXKKw2, AEQbTJ(z, mevInfoBean, nonMevPriorityFeeInfo), i == priorityFeeType2.getValue(), priorityFeeType2.getValue(), !z2 ? str2 : C23271hvA.formatTokenCode$default(C23271hvA.copydefault, AEQbTJ(z, mevInfoBean, nonMevPriorityFeeInfo), true, null, false, str, null, 22, null), (java.lang.String) null, 32, (DefaultConstructorMarker) null));
        ...
        arrayList.add(new PrioritySelectionBean(strAYXKKw3, KWHzl(z, mevInfoBean, nonMevPriorityFeeInfo), i == priorityFeeType3.getValue(), priorityFeeType3.getValue(), !z2 ? str2 : C23271hvA.formatTokenCode$default(C23271hvA.copydefault, KWHzl(z, mevInfoBean, nonMevPriorityFeeInfo), true, null, false, str, null, 22, null), (java.lang.String) null, 32, (DefaultConstructorMarker) null));
        return arrayList;
    }
    ...
    */
    public final java.lang.String copydefault(boolean z, MevInfoBean mevInfoBean, NonMevPriorityFeeInfo nonMevPriorityFeeInfo) {
        java.lang.String marketPriority;
        if (z) {
            marketPriority = mevInfoBean != null ? mevInfoBean.getMarketPriority() : null;
        } else {
            marketPriority = nonMevPriorityFeeInfo != null ? nonMevPriorityFeeInfo.getMarketPriority() : null;
        }
    }
    ...
    */
    public final java.lang.String AEQbTJ(boolean z, MevInfoBean mevInfoBean, NonMevPriorityFeeInfo nonMevPriorityFeeInfo) {
        java.lang.String fastPriority;
        if (z) {
            fastPriority = mevInfoBean != null ? mevInfoBean.getFastPriority() : null;
        } else {
            fastPriority = nonMevPriorityFeeInfo != null ? nonMevPriorityFeeInfo.getFastPriority() : null;
        }
    }
    ...
    */
    public final java.lang.String KWHzl(boolean z, MevInfoBean mevInfoBean, NonMevPriorityFeeInfo nonMevPriorityFeeInfo) {
        java.lang.String turboPriority;
        if (z) {
            turboPriority = mevInfoBean != null ? mevInfoBean.getTurboPriority() : null;
        } else {
            turboPriority = nonMevPriorityFeeInfo != null ? nonMevPriorityFeeInfo.getTurboPriority() : null;
        }
    }
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final java.lang.String AYXKKw(boolean z, MevInfoBean mevInfoBean, NonMevPriorityFeeInfo nonMevPriorityFeeInfo) {
    ...
    public final java.lang.String AEQbTJ(@NotNull java.lang.String str, @NotNull java.lang.String str2, @NotNull java.lang.String str3, @NotNull java.lang.String str4, @NotNull java.lang.String str5) {
        Intrinsics.checkNotNullParameter(str, "");
