...
import aws.sdk.kotlin.services.cognitoidentity.serde.UntagResourceOperationDeserializer$deserialize$1;
...
public final class OfPrimitive implements BB<SecurityException> {
    /* JADX WARN: Removed duplicated region for block: B:7:0x0013  */
    @Override // o.BB
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super SecurityException> continuation) throws java.lang.Throwable {
        ...
        if (i2 == 0) {
            ...
            if (!zT.copydefault(c58859zS.AEQbTJ().OLrzqt())) {
                ...
                if (OfLong.EZpvd(dt, c58859zS, untagResourceOperationDeserializer$deserialize$1) == objCopydefault) {
                    return objCopydefault;
                }
            } else {
                SecurityException.Application application = new SecurityException.Application();
                application.EZpvd();
