...
public abstract class AbstractActivityC6032aHg extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6032aHg() {
        AEQbTJ();
    }

    private void AEQbTJ() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aHg.5
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6032aHg.this.OLrzqt();
            }
        });
    }
    ...
    public void OLrzqt() {
        ...
        this.AEQbTJ = true;
        ((InterfaceC6035aHj) aA_()).OLrzqt((PasskeyAuthenticateWithoutUiServiceActivity) C58163ywB.EZpvd(this));
    }
