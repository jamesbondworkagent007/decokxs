...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.TagResourceOperationDeserializer$deserialize$1;
...
public final class HdmiClient implements BB<DnsEvent> {
    /* JADX WARN: Removed duplicated region for block: B:7:0x0013  */
    @Override // o.BB
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super DnsEvent> continuation) throws java.lang.Throwable {
        ...
        if (i2 == 0) {
            ...
            if (!zT.copydefault(c58859zS.AEQbTJ().OLrzqt())) {
                ...
                if (FingerprintManager.KWHzl(dt, c58859zS, tagResourceOperationDeserializer$deserialize$1) == objCopydefault) {
                    return objCopydefault;
                }
            } else {
                DnsEvent.TaskDescription taskDescription = new DnsEvent.TaskDescription();
