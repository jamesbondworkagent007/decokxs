...
public class C16326ehn extends AbstractC16327eho {
    ...
    static {
        ...
        sparseIntArray.put(C13754dXa.ActionBar.getSessionActivity, 2);
    }

    public C16326ehn(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, AEQbTJ, EZpvd));
    }

    public C16326ehn(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
