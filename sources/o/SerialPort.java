...
import aws.sdk.kotlin.services.cognitoidentityprovider.serde.ListTagsForResourceOperationDeserializerKt$throwListTagsForResourceError$1;
...
public final class SerialPort {
    ...
    */
                        ...
                        switch (strOLrzqt.hashCode()) {
                            case -1416998079:
                                if (strOLrzqt.equals("NotAuthorizedException")) {
                                    ...
                                    objCopydefault = captureResultExtras.AEQbTJ(dt, c58859zSCopy$default, listTagsForResourceOperationDeserializerKt$throwListTagsForResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 504305508:
                                if (strOLrzqt.equals("InternalErrorException")) {
                                    ...
                                    objCopydefault = sQLiteTableLockedException.AEQbTJ(dt, c58859zSCopy$default, listTagsForResourceOperationDeserializerKt$throwListTagsForResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1384808312:
                                if (strOLrzqt.equals("TooManyRequestsException")) {
                                    ...
                                    objCopydefault = hdmiRecordListener.AEQbTJ(dt, c58859zSCopy$default, listTagsForResourceOperationDeserializerKt$throwListTagsForResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1674340573:
                                if (strOLrzqt.equals("InvalidParameterException")) {
                                    ...
                                    objCopydefault = ddmRegister.AEQbTJ(dt, c58859zSCopy$default, listTagsForResourceOperationDeserializerKt$throwListTagsForResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1821306386:
                                if (strOLrzqt.equals("ResourceNotFoundException")) {
                                    ...
                                    objCopydefault = requestQueue.AEQbTJ(dt, c58859zSCopy$default, listTagsForResourceOperationDeserializerKt$throwListTagsForResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
    ...
    public static final void AEQbTJ(FragmentManagerNonConfig.TaskDescription taskDescription, byte[] bArr) {
        EL el = new EL(bArr);
