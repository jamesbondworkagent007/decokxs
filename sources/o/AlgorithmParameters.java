...
public final class AlgorithmParameters {
    public static final Math KWHzl(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        Math.Activity activity = new Math.Activity();
        AbstractC5105Ex.LoaderManager loaderManager = AbstractC5105Ex.LoaderManager.KWHzl;
        C5101Et c5101Et = new C5101Et(loaderManager, new EX("IdentityPoolId"));
        C5101Et c5101Et2 = new C5101Et(loaderManager, new EX("IdentityPoolName"));
