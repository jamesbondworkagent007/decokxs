...
public final class LauncherIcons {
    public static final void OLrzqt(@NotNull InterfaceC5106Ey interfaceC5106Ey, @NotNull DiskWriteViolation diskWriteViolation) {
        ...
        java.lang.String strEZpvd = diskWriteViolation.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et, strEZpvd);
        }
        StatsDimensionsValue statsDimensionsValueAEQbTJ = diskWriteViolation.AEQbTJ();
        if (statsDimensionsValueAEQbTJ != null) {
            ebEZpvd.AEQbTJ(c5101Et2, statsDimensionsValueAEQbTJ.KWHzl());
        }
        C5173Hn c5173HnCopydefault = diskWriteViolation.copydefault();
        if (c5173HnCopydefault != null) {
            ebEZpvd.KWHzl(c5101Et4, c5173HnCopydefault, TimestampFormat.EPOCH_SECONDS);
        }
        C5173Hn c5173HnKWHzl = diskWriteViolation.KWHzl();
