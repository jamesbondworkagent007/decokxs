...
public abstract class AbstractActivityC6316aMz extends AbstractActivityC33041mov implements InterfaceC58208ywu {
    ...
    public AbstractActivityC6316aMz() {
        OLrzqt();
    }

    private void OLrzqt() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: o.aMz.3
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(android.content.Context context) {
                AbstractActivityC6316aMz.this.AEQbTJ();
            }
        });
    }
    ...
    public void AEQbTJ() {
        ...
        this.OLrzqt = true;
        ((InterfaceC6265aMA) aA_()).KWHzl((ActivityC6315aMy) C58163ywB.EZpvd(this));
    }
