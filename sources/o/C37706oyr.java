...
/* JADX INFO: renamed from: o.oyr, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C37706oyr extends nAF<OKRmVipWelcomeMessage> {
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    @Override // o.AbstractC35703oAo
    public java.lang.Class<OKRmVipWelcomeMessage> KWHzl() {
        return OKRmVipWelcomeMessage.class;
    }
    ...
    public java.lang.CharSequence KWHzl(@NotNull android.content.Context context, @NotNull OKRmVipWelcomeMessage oKRmVipWelcomeMessage, @NotNull OKMessage oKMessage) {
        Intrinsics.checkNotNullParameter(context, "");
        Intrinsics.checkNotNullParameter(oKRmVipWelcomeMessage, "");
        Intrinsics.checkNotNullParameter(oKMessage, "");
        return C33070mpX.AYXKKw(C35399nuc.LoaderManager.onPostMessage);
    }
    ...
    public void KWHzl(@NotNull oGY<AbstractC34017nOi> ogy, @NotNull C35254nrp c35254nrp) {
        ...
        ((AbstractC34017nOi) ogy.copydefault()).copydefault.setText(C33070mpX.AYXKKw(C35399nuc.LoaderManager.onPostMessage));
    }
}
