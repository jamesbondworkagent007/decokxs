...
public final class C47993uB implements BH<C46644tb> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C46644tb c46644tb, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.DescribeTextTranslationJobOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C48074uE.KWHzl(dt, c46644tb)));
