...
import aws.sdk.kotlin.services.translate.model.InvalidRequestException;
import aws.sdk.kotlin.services.translate.serde.InvalidRequestExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: renamed from: o.vd, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes21.dex */
public final class C50910vd implements BB<InvalidRequestException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InvalidRequestException> continuation) throws java.lang.Throwable {
        ...
        InvalidRequestException.ActionBar actionBar;
        ...
        if (i2 == 0) {
            ...
            InvalidRequestException.ActionBar actionBar2 = new InvalidRequestException.ActionBar();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            invalidRequestExceptionDeserializer$deserialize$1.L$0 = actionBar2;
            ...
            actionBar = (InvalidRequestException.ActionBar) invalidRequestExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            C51016vf.AEQbTJ(actionBar, bArr);
        }
        actionBar.KWHzl();
