...
public final class hMK extends AbstractC31189lpN<C21803hMx, hAA> {
 ...
 A[MD:(kotlin.jvm.functions.Function2<? super com.okinc.business.dexui.main.limitorder.orderdetail.adapter.DetailSection, ? super java.lang.Boolean, kotlin.Unit>):void (m)] (LINE:14) call: o.hMK.<init>(kotlin.jvm.functions.Function2):void type: THIS */
    public /* synthetic */ hMK(Function2 function2, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public hMK(Function2<? super DetailSection, ? super java.lang.Boolean, Unit> function2) {
    ...
    @Override // o.AbstractC31189lpN
    /* JADX INFO: renamed from: OLrzqt, reason: merged with bridge method [inline-methods] */
    public void KWHzl(@NotNull hAA haa, @NotNull final C21803hMx c21803hMx) {
        int i;
        Intrinsics.checkNotNullParameter(haa, "");
        Intrinsics.checkNotNullParameter(c21803hMx, "");
        super.KWHzl(haa, c21803hMx);
        android.widget.TextView textView = haa.KWHzl;
        int i2 = StateListAnimator.AEQbTJ[c21803hMx.copydefault().ordinal()];
        if (i2 == 1) {
        ...
        textView.setText(i);
        haa.copydefault.setImageDrawable(C33070mpX.KWHzl(c21803hMx.KWHzl() ? C52761wXj.TaskDescription.DNMMPQ : C52761wXj.TaskDescription.DCUTEIddSDPG));
        C25352ivB.OLrzqt(haa.copydefault, 350L, (Function1<? super android.view.View, Unit>) new Function1() { // from class: o.hMM
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
            @Override // kotlin.jvm.functions.Function1
            public final java.lang.Object invoke(java.lang.Object obj) {
                return hMK.EZpvd(this.KWHzl, c21803hMx, (android.view.View) obj);
            }
        });
    }

    public static final Unit EZpvd(hMK hmk, C21803hMx c21803hMx, android.view.View view) {
        Intrinsics.checkNotNullParameter(view, "");
        Function2<DetailSection, java.lang.Boolean, Unit> function2 = hmk.EZpvd;
        if (function2 != null) {
            function2.invoke(c21803hMx.copydefault(), java.lang.Boolean.valueOf(!c21803hMx.KWHzl()));
        }
