...
public final class iYY {
    ...
    public final C27367jtp copydefault(@NotNull DashboardTokenInfoDetail dashboardTokenInfoDetail) {
        ...
        return new C27367jtp(jOLrzqt, strAkhnZx, strDbNXlk, strFetchVPNInfo, strValues, jAEQbTJ, strEZpvd2, strKWHzl, listCopydefault, dashboardTokenInfoDetail.AhwBna(), dashboardTokenInfoDetail.djBIcL(), listAYXKKw, (dashboardAssetToken == null || (strEZpvd = dashboardAssetToken.EZpvd()) == null) ? "" : strEZpvd, dashboardTokenInfoDetail.isConnected(), UiDashboardTokenItemType.BORROW, c27586jxw.KWHzl(C33129mqd.EZpvd(dashboardTokenInfoDetail.fIwbmz()), (46 & 2) != 0 ? 2 : 0, (46 & 4) == 0 ? 0 : 2, (46 & 8) != 0 ? DisplaySign.AUTO : DisplaySign.EXCEPT_ZERO, (46 & 16) != 0 ? CurrencyDisplayStyle.CURRENCY_AMOUNT_ONLY : currencyDisplayStyle, (46 & 32) != 0 ? RoundingMode.DOWN : null), dashboardTokenInfoDetail.fIwbmz());
    }
}
