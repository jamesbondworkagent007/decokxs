...
public final class C30826liV implements InterfaceC25317iuT {
    public final AdvancedCustomSolPresetVM AEQbTJ;
    public DexAutoSlippageInfoParam EZpvd;
    public AdvancedQuoteUiData OLrzqt;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public final void OLrzqt(AdvancedQuoteUiData advancedQuoteUiData, DexAutoSlippageInfoParam dexAutoSlippageInfoParam) {
        this.OLrzqt = advancedQuoteUiData;
    ...
    public C30826liV(@NotNull AdvancedCustomSolPresetVM advancedCustomSolPresetVM) {
        Intrinsics.checkNotNullParameter(advancedCustomSolPresetVM, "");
        this.AEQbTJ = advancedCustomSolPresetVM;
    }
    ...
    public void EZpvd(@NotNull C25301iuD c25301iuD) {
        ...
        if (slippageFeeTypeKWHzl != null) {
            this.AEQbTJ.copydefault(java.lang.Integer.valueOf(slippageFeeTypeKWHzl.getValue()).intValue());
        }
        AdvancedCustomSolPresetVM advancedCustomSolPresetVM = this.AEQbTJ;
        if (c25301iuD.EZpvd() != InputStatus.ERROR && (strOLrzqt = c25301iuD.OLrzqt()) != null) {
            str = strOLrzqt;
        }
        advancedCustomSolPresetVM.copydefault(str);
        this.AEQbTJ.OLrzqt(c25301iuD.copydefault());
        this.AEQbTJ.OLrzqt(c25301iuD.AEQbTJ());
    }
}
