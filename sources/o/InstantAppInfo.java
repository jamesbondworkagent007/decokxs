...
public final class InstantAppInfo {
    public static final void KWHzl(@NotNull InterfaceC5106Ey interfaceC5106Ey, @NotNull AppIdInt appIdInt) {
        ...
        ebEZpvd.AEQbTJ(c5101Et2, appIdInt.AEQbTJ().OLrzqt());
        ebEZpvd.AEQbTJ(c5101Et, appIdInt.EZpvd());
        ebEZpvd.AEQbTJ();
    }
}
