...
public final class C42469rU {
    public static final C35742oC AEQbTJ(@NotNull InterfaceC5095En interfaceC5095En) {
        Intrinsics.checkNotNullParameter(interfaceC5095En, "");
        C35742oC.TaskDescription taskDescription = new C35742oC.TaskDescription();
        ...
        while (true) {
            ...
            if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault) {
                ...
                if (numOLrzqt != null && numOLrzqt.intValue() == iCopydefault2) {
                    taskDescription.copydefault(C41080qk.AEQbTJ(interfaceC5095En));
