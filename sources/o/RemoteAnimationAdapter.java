...
import aws.sdk.kotlin.services.comprehend.serde.UntagResourceOperationDeserializerKt$throwUntagResourceError$1;
                        ...
                        switch (strOLrzqt.hashCode()) {
                            case -2005002116:
                                if (strOLrzqt.equals("ConcurrentModificationException")) {
                                    KeymasterIntArgument keymasterIntArgument = new KeymasterIntArgument();
                                    ...
                                    objCopydefault = keymasterIntArgument.AEQbTJ(dt, c58859zSCopy$default, untagResourceOperationDeserializerKt$throwUntagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                                ...
                                break;
                            case 425187092:
                                if (strOLrzqt.equals("TooManyTagKeysException")) {
                                    InputQueue inputQueue = new InputQueue();
                                    untagResourceOperationDeserializerKt$throwUntagResourceError$1.L$0 = interfaceC5039CjEZpvd;
                                    untagResourceOperationDeserializerKt$throwUntagResourceError$1.L$1 = c56239xzCopydefault;
                                    untagResourceOperationDeserializerKt$throwUntagResourceError$1.label = 2;
                                    objCopydefault = inputQueue.AEQbTJ(dt, c58859zSCopy$default, untagResourceOperationDeserializerKt$throwUntagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 734598063:
                                if (strOLrzqt.equals("InternalServerException")) {
                                    ...
                                    objCopydefault = lineBackgroundSpan.AEQbTJ(dt, c58859zSCopy$default, untagResourceOperationDeserializerKt$throwUntagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1148038775:
                                if (strOLrzqt.equals("InvalidRequestException")) {
                                    ...
                                    objCopydefault = rasterizerSpan.AEQbTJ(dt, c58859zSCopy$default, untagResourceOperationDeserializerKt$throwUntagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
                            ...
                            case 1821306386:
                                if (strOLrzqt.equals("ResourceNotFoundException")) {
                                    ...
                                    objCopydefault = mergedConfiguration.AEQbTJ(dt, c58859zSCopy$default, untagResourceOperationDeserializerKt$throwUntagResourceError$1);
                                    if (objCopydefault == objCopydefault2) {
                                        return objCopydefault2;
                                    }
                                    c56239xz = c56239xzCopydefault;
