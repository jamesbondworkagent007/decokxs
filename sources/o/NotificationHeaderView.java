...
public final class NotificationHeaderView {
    public static final void KWHzl(@NotNull InterfaceC5106Ey interfaceC5106Ey, @NotNull LongitudinalReportingEncoder longitudinalReportingEncoder) {
        ...
        java.lang.String strEZpvd = longitudinalReportingEncoder.EZpvd();
        if (strEZpvd != null) {
            ebEZpvd.AEQbTJ(c5101Et, strEZpvd);
        }
        StatsDimensionsValue statsDimensionsValueCopydefault = longitudinalReportingEncoder.copydefault();
        if (statsDimensionsValueCopydefault != null) {
            ebEZpvd.AEQbTJ(c5101Et2, statsDimensionsValueCopydefault.KWHzl());
        }
        C5173Hn c5173HnOLrzqt = longitudinalReportingEncoder.OLrzqt();
        if (c5173HnOLrzqt != null) {
            ebEZpvd.KWHzl(c5101Et4, c5173HnOLrzqt, TimestampFormat.EPOCH_SECONDS);
        }
        C5173Hn c5173HnKWHzl = longitudinalReportingEncoder.KWHzl();
