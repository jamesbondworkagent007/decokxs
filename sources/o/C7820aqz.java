...
public class C7820aqz extends C7773aqE {
    public boolean valueOf;

    public C7820aqz(@androidx.annotation.NonNull android.content.Context context) {
        super(context);
    }
    ...
    @Override // o.C7773aqE, android.view.ViewGroup, android.view.View
