...
public class C47470tqe extends AbstractC47466tqa {
    ...
    static {
        ...
        sparseIntArray.put(C47315tni.TaskDescription.aJFbMH, 1);
        sparseIntArray.put(C47315tni.TaskDescription.zuBGHE, 2);
    }

    public C47470tqe(@androidx.annotation.Nullable DataBindingComponent dataBindingComponent, @androidx.annotation.NonNull android.view.View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, KWHzl, copydefault));
    }

    public C47470tqe(DataBindingComponent dataBindingComponent, android.view.View view, java.lang.Object[] objArr) {
