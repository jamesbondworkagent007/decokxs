...
public final class C17321fB implements BH<QuickContactBadge> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull QuickContactBadge quickContactBadge, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.DetectModerationLabelsOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C17348fC.copydefault(dt, quickContactBadge)));
