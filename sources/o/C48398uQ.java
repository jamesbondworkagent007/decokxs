...
public final class C48398uQ implements BH<C47174tl> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C47174tl c47174tl, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.GetTerminologyOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C48344uO.EZpvd(dt, c47174tl)));
