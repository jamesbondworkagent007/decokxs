...
public final class C47917tzE {
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:55:0x009b */
    ...
    public static final java.util.List<java.lang.Object> AEQbTJ(@NotNull java.util.List<? extends java.lang.Object> list, @NotNull java.util.List<? extends java.lang.Object> list2) {
        ...
        pUU.KWHzl("MineActivityContracts.kt", "mergeMineMessageList->exist:" + list.size() + " append:" + list2.size() + " append2:" + arrayList.size());
        return arrayList2;
    }
}
