...
import com.okinc.dexkline.market.features.coindetail.domain.CoinDetailUseCase$closeBanner$2;
import com.okinc.dexkline.market.features.coindetail.domain.CoinDetailUseCase$getNativeTokenPrice$1;
import com.okinc.dexkline.market.features.coindetail.domain.CoinDetailUseCase$getNativeTokenPricegIAlus$$inlined$dexRunCatching$1;
...
public final class mWE {
    ...
    public final mWJ EZpvd;
    public final InterfaceC32256mVg OLrzqt;

    @yCM
    public mWE(@NotNull InterfaceC32256mVg interfaceC32256mVg, @NotNull mWJ mwj, @NotNull CoroutineDispatcher coroutineDispatcher) {
        Intrinsics.checkNotNullParameter(interfaceC32256mVg, "");
        Intrinsics.checkNotNullParameter(mwj, "");
        Intrinsics.checkNotNullParameter(coroutineDispatcher, "");
        this.OLrzqt = interfaceC32256mVg;
        this.EZpvd = mwj;
        this.AEQbTJ = coroutineDispatcher;
    }

    public final java.lang.Object KWHzl(@NotNull java.lang.String str, @NotNull Continuation<? super Unit> continuation) {
        java.lang.Object objWithContext = BuildersKt.withContext(this.AEQbTJ, new CoinDetailUseCase$closeBanner$2(this, str, null), continuation);
    ...
    */
    public final java.lang.Object OLrzqt(@NotNull java.lang.String str, @NotNull Continuation<? super Result<mWC>> continuation) {
