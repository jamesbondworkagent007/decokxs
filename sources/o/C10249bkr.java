...
public final class C10249bkr extends AbstractC10170bjR {
    ...
    public C10249bkr(@NotNull android.content.Context context, @NotNull TxIdOrHashHistoryDetail txIdOrHashHistoryDetail) {
    ...
    private final AbstractC10168bjP EZpvd(TxAssetChangeBean txAssetChangeBean) {
        ...
        if (zOLrzqt) {
            ...
            return new AbstractC10168bjP.Activity(nftId, str2, str3, " ", str4, iTradeRiseDefault$default2, coinId, protocolName == null ? "" : protocolName, false, 256, null);
        }
        ...
        return new AbstractC10168bjP.TaskDescription(str5, str6, " ", name2 == null ? "" : name2, iTradeRiseDefault$default, false, false, 0, false, false, null, 0, 0L, false, 16352, null);
    }
}
