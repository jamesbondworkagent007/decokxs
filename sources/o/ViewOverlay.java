...
import aws.sdk.kotlin.runtime.auth.credentials.internal.ssooidc.serde.InvalidRequestExceptionDeserializer$deserialize$1;
import kotlin.coroutines.Continuation;
import org.jetbrains.annotations.NotNull;

/* JADX INFO: loaded from: classes.dex */
public final class ViewOverlay implements BB<InvalidRequestException> {
    ...
    */
    public java.lang.Object AEQbTJ(@NotNull DT dt, @NotNull C58859zS c58859zS, @NotNull Continuation<? super InvalidRequestException> continuation) throws java.lang.Throwable {
        ...
        InvalidRequestException.Activity activity;
        ...
        if (i2 == 0) {
            ...
            InvalidRequestException.Activity activity2 = new InvalidRequestException.Activity();
            zP zPVarEZpvd = interfaceC5039CjAEQbTJ.EZpvd();
            invalidRequestExceptionDeserializer$deserialize$1.L$0 = activity2;
            ...
            activity = (InvalidRequestException.Activity) invalidRequestExceptionDeserializer$deserialize$1.L$0;
            C56391yDq.AEQbTJ(obj);
        }
        byte[] bArr = (byte[]) obj;
        if (bArr != null) {
            LayoutParams.copydefault(activity, bArr);
        }
        activity.AEQbTJ();
