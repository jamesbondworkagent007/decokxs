...
public class XL {
    public static final XL OLrzqt;
    public static final java.util.Set<java.lang.String> copydefault;
    public java.util.Set<java.lang.String> KWHzl = copydefault;

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 0 */
    public static XL EZpvd() {
        return OLrzqt;
    }
    ...
    static {
        ...
        copydefault = Collections.unmodifiableSet(hashSet);
        OLrzqt = new XL();
    }

    public void copydefault(DeserializationContext deserializationContext, JavaType javaType, AbstractC5549Vz abstractC5549Vz) throws JsonMappingException {
        java.lang.Class<?> rawClass = javaType.getRawClass();
        java.lang.String name = rawClass.getName();
        if (!this.KWHzl.contains(name)) {
            if (rawClass.isInterface()) {
                return;
            }
            if (name.startsWith("org.springframework.")) {
                while (rawClass != null && rawClass != java.lang.Object.class) {
                    java.lang.String simpleName = rawClass.getSimpleName();
        ...
        deserializationContext.reportBadTypeDefinition(abstractC5549Vz, "Illegal type (%s) to deserialize: prevented for security reasons", name);
    }
}
