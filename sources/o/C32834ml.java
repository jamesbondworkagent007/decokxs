...
public final class C32834ml implements BH<C12654cr> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C12654cr c12654cr, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.rekognition.serde.UntagResourceOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C33046mp.KWHzl(dt, c12654cr)));
