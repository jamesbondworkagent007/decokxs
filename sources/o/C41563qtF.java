...
/* JADX INFO: renamed from: o.qtF, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes9.dex */
public final class C41563qtF<T> implements InterfaceC49405unt<kotlin.Pair<? extends java.util.List<? extends T>, ? extends Function1<? super T, ? extends CountDownInfo>>, kotlin.Pair<? extends java.util.List<? extends T>, ? extends java.util.List<? extends T>>> {
    @yCM
    public C41563qtF() {
    }
    ...
    public kotlin.Pair<java.util.List<T>, java.util.List<T>> OLrzqt(@NotNull kotlin.Pair<? extends java.util.List<? extends T>, ? extends Function1<? super T, CountDownInfo>> pair) {
        return (kotlin.Pair) InterfaceC49405unt.Activity.EZpvd(this, pair);
    }
    ...
    public kotlin.Pair<java.util.List<T>, java.util.List<T>> AEQbTJ(@NotNull kotlin.Pair<? extends java.util.List<? extends T>, ? extends Function1<? super T, CountDownInfo>> pair) {
        ...
        return C56390yDp.OLrzqt(CollectionsKt___CollectionsKt.EZpvd(list, new StateListAnimator(function1Component2)), (java.util.List) pair2.component2());
    }

    /* JADX INFO: renamed from: o.qtF$StateListAnimator */
    public static final class StateListAnimator<T> implements java.util.Comparator {
        ...
        public final int compare(T t, T t2) {
            long jValueOf;
            CountDownInfo countDownInfo = (CountDownInfo) this.copydefault.invoke(t);
            ...
            CountDownInfo countDownInfo2 = (CountDownInfo) this.copydefault.invoke(t2);
