...
public final class C16601emx implements ViewBinding {
    ...
    public static C16601emx OLrzqt(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.Nullable android.view.ViewGroup viewGroup, boolean z) {
        android.view.View viewInflate = layoutInflater.inflate(C13754dXa.TaskDescription.iKEqwx, viewGroup, false);
        if (z) {
    ...
    public static C16601emx OLrzqt(@androidx.annotation.NonNull android.view.View view) {
                                ...
                                if (guideline != null) {
                                    ...
                                    if (guideline2 != null) {
                                        ...
                                        if (constraintLayout != null) {
                                            i = C13754dXa.ActionBar.sendMetadata;
                                            AppCompatTextView appCompatTextView = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                            if (appCompatTextView != null) {
                                                i = C13754dXa.ActionBar.MediaSessionCompatMediaSessionImplBase;
                                                AppCompatTextView appCompatTextView2 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                if (appCompatTextView2 != null) {
                                                    i = C13754dXa.ActionBar.sendCaptioningEnabled;
                                                    AppCompatTextView appCompatTextView3 = (AppCompatTextView) ViewBindings.findChildViewById(view, i);
                                                    if (appCompatTextView3 != null) {
                                                        return new C16601emx((ConstraintLayout) view, c55173xeu, c55113xdn, c33604mzb, c33546myW, c33603mza, recyclerView, guideline, guideline2, constraintLayout, appCompatTextView, appCompatTextView2, appCompatTextView3);
                                                    }
                                                }
                                            }
                                        }
