...
public final class C49889ux implements BH<C46591ta> {
    ...
    public java.lang.Object KWHzl(@NotNull DT dt, @NotNull C46591ta c46591ta, @NotNull Continuation<? super C5036Cg> continuation) {
        C5036Cg c5036Cg = new C5036Cg();
        c5036Cg.KWHzl(HttpMethod.POST);
        C5034Ce.EZpvd(c5036Cg, new Function1<DL.Application, Unit>() { // from class: aws.sdk.kotlin.services.translate.serde.DeleteParallelDataOperationSerializer$serialize$2
        ...
        c5036Cg.EZpvd(zP.EZpvd.OLrzqt(C49783uv.copydefault(dt, c46591ta)));
