...
public final class FlowQuery$mapToOne$1$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public FlowQuery$mapToOne$1$1(AssistContent<? extends T> assistContent, Continuation<? super FlowQuery$mapToOne$1$1> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = Intent.AEQbTJ(assistContent, this);
